[Droom Google Location Plugin - v1.0.11](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLDetailsElement

# Interface: HTMLDetailsElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLDetailsElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLDetailsElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLDetailsElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLDetailsElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLDetailsElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLDetailsElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLDetailsElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLDetailsElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLDetailsElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLDetailsElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLDetailsElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLDetailsElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLDetailsElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLDetailsElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLDetailsElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLDetailsElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLDetailsElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLDetailsElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLDetailsElement.md#text_node)
- [accessKey](input._internal_.HTMLDetailsElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLDetailsElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLDetailsElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLDetailsElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLDetailsElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLDetailsElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLDetailsElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLDetailsElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLDetailsElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLDetailsElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLDetailsElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLDetailsElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLDetailsElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLDetailsElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLDetailsElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLDetailsElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLDetailsElement.md#arialevel)
- [ariaLive](input._internal_.HTMLDetailsElement.md#arialive)
- [ariaModal](input._internal_.HTMLDetailsElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLDetailsElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLDetailsElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLDetailsElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLDetailsElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLDetailsElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLDetailsElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLDetailsElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLDetailsElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLDetailsElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLDetailsElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLDetailsElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLDetailsElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLDetailsElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLDetailsElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLDetailsElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLDetailsElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLDetailsElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLDetailsElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLDetailsElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLDetailsElement.md#assignedslot)
- [attributes](input._internal_.HTMLDetailsElement.md#attributes)
- [autocapitalize](input._internal_.HTMLDetailsElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLDetailsElement.md#autofocus)
- [baseURI](input._internal_.HTMLDetailsElement.md#baseuri)
- [childElementCount](input._internal_.HTMLDetailsElement.md#childelementcount)
- [childNodes](input._internal_.HTMLDetailsElement.md#childnodes)
- [children](input._internal_.HTMLDetailsElement.md#children)
- [classList](input._internal_.HTMLDetailsElement.md#classlist)
- [className](input._internal_.HTMLDetailsElement.md#classname)
- [clientHeight](input._internal_.HTMLDetailsElement.md#clientheight)
- [clientLeft](input._internal_.HTMLDetailsElement.md#clientleft)
- [clientTop](input._internal_.HTMLDetailsElement.md#clienttop)
- [clientWidth](input._internal_.HTMLDetailsElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLDetailsElement.md#contenteditable)
- [dataset](input._internal_.HTMLDetailsElement.md#dataset)
- [dir](input._internal_.HTMLDetailsElement.md#dir)
- [draggable](input._internal_.HTMLDetailsElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLDetailsElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLDetailsElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLDetailsElement.md#firstelementchild)
- [hidden](input._internal_.HTMLDetailsElement.md#hidden)
- [id](input._internal_.HTMLDetailsElement.md#id)
- [innerHTML](input._internal_.HTMLDetailsElement.md#innerhtml)
- [innerText](input._internal_.HTMLDetailsElement.md#innertext)
- [inputMode](input._internal_.HTMLDetailsElement.md#inputmode)
- [isConnected](input._internal_.HTMLDetailsElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLDetailsElement.md#iscontenteditable)
- [lang](input._internal_.HTMLDetailsElement.md#lang)
- [lastChild](input._internal_.HTMLDetailsElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLDetailsElement.md#lastelementchild)
- [localName](input._internal_.HTMLDetailsElement.md#localname)
- [namespaceURI](input._internal_.HTMLDetailsElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLDetailsElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLDetailsElement.md#nextsibling)
- [nodeName](input._internal_.HTMLDetailsElement.md#nodename)
- [nodeType](input._internal_.HTMLDetailsElement.md#nodetype)
- [nodeValue](input._internal_.HTMLDetailsElement.md#nodevalue)
- [nonce](input._internal_.HTMLDetailsElement.md#nonce)
- [offsetHeight](input._internal_.HTMLDetailsElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLDetailsElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLDetailsElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLDetailsElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLDetailsElement.md#offsetwidth)
- [onabort](input._internal_.HTMLDetailsElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLDetailsElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLDetailsElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLDetailsElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLDetailsElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLDetailsElement.md#onauxclick)
- [onblur](input._internal_.HTMLDetailsElement.md#onblur)
- [oncanplay](input._internal_.HTMLDetailsElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLDetailsElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLDetailsElement.md#onchange)
- [onclick](input._internal_.HTMLDetailsElement.md#onclick)
- [onclose](input._internal_.HTMLDetailsElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLDetailsElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLDetailsElement.md#oncopy)
- [oncuechange](input._internal_.HTMLDetailsElement.md#oncuechange)
- [oncut](input._internal_.HTMLDetailsElement.md#oncut)
- [ondblclick](input._internal_.HTMLDetailsElement.md#ondblclick)
- [ondrag](input._internal_.HTMLDetailsElement.md#ondrag)
- [ondragend](input._internal_.HTMLDetailsElement.md#ondragend)
- [ondragenter](input._internal_.HTMLDetailsElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLDetailsElement.md#ondragleave)
- [ondragover](input._internal_.HTMLDetailsElement.md#ondragover)
- [ondragstart](input._internal_.HTMLDetailsElement.md#ondragstart)
- [ondrop](input._internal_.HTMLDetailsElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLDetailsElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLDetailsElement.md#onemptied)
- [onended](input._internal_.HTMLDetailsElement.md#onended)
- [onerror](input._internal_.HTMLDetailsElement.md#onerror)
- [onfocus](input._internal_.HTMLDetailsElement.md#onfocus)
- [onformdata](input._internal_.HTMLDetailsElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLDetailsElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLDetailsElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLDetailsElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLDetailsElement.md#oninput)
- [oninvalid](input._internal_.HTMLDetailsElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLDetailsElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLDetailsElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLDetailsElement.md#onkeyup)
- [onload](input._internal_.HTMLDetailsElement.md#onload)
- [onloadeddata](input._internal_.HTMLDetailsElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLDetailsElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLDetailsElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLDetailsElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLDetailsElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLDetailsElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLDetailsElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLDetailsElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLDetailsElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLDetailsElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLDetailsElement.md#onmouseup)
- [onpaste](input._internal_.HTMLDetailsElement.md#onpaste)
- [onpause](input._internal_.HTMLDetailsElement.md#onpause)
- [onplay](input._internal_.HTMLDetailsElement.md#onplay)
- [onplaying](input._internal_.HTMLDetailsElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLDetailsElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLDetailsElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLDetailsElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLDetailsElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLDetailsElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLDetailsElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLDetailsElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLDetailsElement.md#onpointerup)
- [onprogress](input._internal_.HTMLDetailsElement.md#onprogress)
- [onratechange](input._internal_.HTMLDetailsElement.md#onratechange)
- [onreset](input._internal_.HTMLDetailsElement.md#onreset)
- [onresize](input._internal_.HTMLDetailsElement.md#onresize)
- [onscroll](input._internal_.HTMLDetailsElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLDetailsElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLDetailsElement.md#onseeked)
- [onseeking](input._internal_.HTMLDetailsElement.md#onseeking)
- [onselect](input._internal_.HTMLDetailsElement.md#onselect)
- [onselectionchange](input._internal_.HTMLDetailsElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLDetailsElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLDetailsElement.md#onslotchange)
- [onstalled](input._internal_.HTMLDetailsElement.md#onstalled)
- [onsubmit](input._internal_.HTMLDetailsElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLDetailsElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLDetailsElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLDetailsElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLDetailsElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLDetailsElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLDetailsElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLDetailsElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLDetailsElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLDetailsElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLDetailsElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLDetailsElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLDetailsElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLDetailsElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLDetailsElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLDetailsElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLDetailsElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLDetailsElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLDetailsElement.md#onwheel)
- [open](input._internal_.HTMLDetailsElement.md#open)
- [outerHTML](input._internal_.HTMLDetailsElement.md#outerhtml)
- [outerText](input._internal_.HTMLDetailsElement.md#outertext)
- [ownerDocument](input._internal_.HTMLDetailsElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLDetailsElement.md#parentelement)
- [parentNode](input._internal_.HTMLDetailsElement.md#parentnode)
- [part](input._internal_.HTMLDetailsElement.md#part)
- [prefix](input._internal_.HTMLDetailsElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLDetailsElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLDetailsElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLDetailsElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLDetailsElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLDetailsElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLDetailsElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLDetailsElement.md#shadowroot)
- [slot](input._internal_.HTMLDetailsElement.md#slot)
- [spellcheck](input._internal_.HTMLDetailsElement.md#spellcheck)
- [style](input._internal_.HTMLDetailsElement.md#style)
- [tabIndex](input._internal_.HTMLDetailsElement.md#tabindex)
- [tagName](input._internal_.HTMLDetailsElement.md#tagname)
- [textContent](input._internal_.HTMLDetailsElement.md#textcontent)
- [title](input._internal_.HTMLDetailsElement.md#title)
- [translate](input._internal_.HTMLDetailsElement.md#translate)

### Methods

- [addEventListener](input._internal_.HTMLDetailsElement.md#addeventlistener)
- [after](input._internal_.HTMLDetailsElement.md#after)
- [animate](input._internal_.HTMLDetailsElement.md#animate)
- [append](input._internal_.HTMLDetailsElement.md#append)
- [appendChild](input._internal_.HTMLDetailsElement.md#appendchild)
- [attachInternals](input._internal_.HTMLDetailsElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLDetailsElement.md#attachshadow)
- [before](input._internal_.HTMLDetailsElement.md#before)
- [blur](input._internal_.HTMLDetailsElement.md#blur)
- [click](input._internal_.HTMLDetailsElement.md#click)
- [cloneNode](input._internal_.HTMLDetailsElement.md#clonenode)
- [closest](input._internal_.HTMLDetailsElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLDetailsElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLDetailsElement.md#contains)
- [dispatchEvent](input._internal_.HTMLDetailsElement.md#dispatchevent)
- [focus](input._internal_.HTMLDetailsElement.md#focus)
- [getAnimations](input._internal_.HTMLDetailsElement.md#getanimations)
- [getAttribute](input._internal_.HTMLDetailsElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLDetailsElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLDetailsElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLDetailsElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLDetailsElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLDetailsElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLDetailsElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLDetailsElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLDetailsElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLDetailsElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLDetailsElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLDetailsElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLDetailsElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLDetailsElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLDetailsElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLDetailsElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLDetailsElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLDetailsElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLDetailsElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLDetailsElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLDetailsElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLDetailsElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLDetailsElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLDetailsElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLDetailsElement.md#lookupprefix)
- [matches](input._internal_.HTMLDetailsElement.md#matches)
- [normalize](input._internal_.HTMLDetailsElement.md#normalize)
- [prepend](input._internal_.HTMLDetailsElement.md#prepend)
- [querySelector](input._internal_.HTMLDetailsElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLDetailsElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLDetailsElement.md#releasepointercapture)
- [remove](input._internal_.HTMLDetailsElement.md#remove)
- [removeAttribute](input._internal_.HTMLDetailsElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLDetailsElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLDetailsElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLDetailsElement.md#removechild)
- [removeEventListener](input._internal_.HTMLDetailsElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLDetailsElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLDetailsElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLDetailsElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLDetailsElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLDetailsElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLDetailsElement.md#scroll)
- [scrollBy](input._internal_.HTMLDetailsElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLDetailsElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLDetailsElement.md#scrollto)
- [setAttribute](input._internal_.HTMLDetailsElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLDetailsElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLDetailsElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLDetailsElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLDetailsElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLDetailsElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLDetailsElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLDetailsElement`](../modules/input._internal_.md#htmldetailselement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
