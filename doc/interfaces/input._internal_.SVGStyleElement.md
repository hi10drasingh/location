[Droom Google Location Plugin - v1.0.13](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGStyleElement

# Interface: SVGStyleElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGStyleElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGStyleElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGStyleElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGStyleElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGStyleElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGStyleElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGStyleElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGStyleElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGStyleElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGStyleElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGStyleElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGStyleElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGStyleElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGStyleElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGStyleElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGStyleElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGStyleElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGStyleElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGStyleElement.md#text_node)
- [ariaAtomic](input._internal_.SVGStyleElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGStyleElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGStyleElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGStyleElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGStyleElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGStyleElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGStyleElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGStyleElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGStyleElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGStyleElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGStyleElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGStyleElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGStyleElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGStyleElement.md#arialabel)
- [ariaLevel](input._internal_.SVGStyleElement.md#arialevel)
- [ariaLive](input._internal_.SVGStyleElement.md#arialive)
- [ariaModal](input._internal_.SVGStyleElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGStyleElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGStyleElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGStyleElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGStyleElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGStyleElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGStyleElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGStyleElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGStyleElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGStyleElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGStyleElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGStyleElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGStyleElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGStyleElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGStyleElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGStyleElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGStyleElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGStyleElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGStyleElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGStyleElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGStyleElement.md#assignedslot)
- [attributes](input._internal_.SVGStyleElement.md#attributes)
- [autofocus](input._internal_.SVGStyleElement.md#autofocus)
- [baseURI](input._internal_.SVGStyleElement.md#baseuri)
- [childElementCount](input._internal_.SVGStyleElement.md#childelementcount)
- [childNodes](input._internal_.SVGStyleElement.md#childnodes)
- [children](input._internal_.SVGStyleElement.md#children)
- [classList](input._internal_.SVGStyleElement.md#classlist)
- [className](input._internal_.SVGStyleElement.md#classname)
- [clientHeight](input._internal_.SVGStyleElement.md#clientheight)
- [clientLeft](input._internal_.SVGStyleElement.md#clientleft)
- [clientTop](input._internal_.SVGStyleElement.md#clienttop)
- [clientWidth](input._internal_.SVGStyleElement.md#clientwidth)
- [dataset](input._internal_.SVGStyleElement.md#dataset)
- [disabled](input._internal_.SVGStyleElement.md#disabled)
- [firstChild](input._internal_.SVGStyleElement.md#firstchild)
- [firstElementChild](input._internal_.SVGStyleElement.md#firstelementchild)
- [id](input._internal_.SVGStyleElement.md#id)
- [innerHTML](input._internal_.SVGStyleElement.md#innerhtml)
- [isConnected](input._internal_.SVGStyleElement.md#isconnected)
- [lastChild](input._internal_.SVGStyleElement.md#lastchild)
- [lastElementChild](input._internal_.SVGStyleElement.md#lastelementchild)
- [localName](input._internal_.SVGStyleElement.md#localname)
- [media](input._internal_.SVGStyleElement.md#media)
- [namespaceURI](input._internal_.SVGStyleElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGStyleElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGStyleElement.md#nextsibling)
- [nodeName](input._internal_.SVGStyleElement.md#nodename)
- [nodeType](input._internal_.SVGStyleElement.md#nodetype)
- [nodeValue](input._internal_.SVGStyleElement.md#nodevalue)
- [nonce](input._internal_.SVGStyleElement.md#nonce)
- [onabort](input._internal_.SVGStyleElement.md#onabort)
- [onanimationcancel](input._internal_.SVGStyleElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGStyleElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGStyleElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGStyleElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGStyleElement.md#onauxclick)
- [onblur](input._internal_.SVGStyleElement.md#onblur)
- [oncanplay](input._internal_.SVGStyleElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGStyleElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGStyleElement.md#onchange)
- [onclick](input._internal_.SVGStyleElement.md#onclick)
- [onclose](input._internal_.SVGStyleElement.md#onclose)
- [oncontextmenu](input._internal_.SVGStyleElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGStyleElement.md#oncopy)
- [oncuechange](input._internal_.SVGStyleElement.md#oncuechange)
- [oncut](input._internal_.SVGStyleElement.md#oncut)
- [ondblclick](input._internal_.SVGStyleElement.md#ondblclick)
- [ondrag](input._internal_.SVGStyleElement.md#ondrag)
- [ondragend](input._internal_.SVGStyleElement.md#ondragend)
- [ondragenter](input._internal_.SVGStyleElement.md#ondragenter)
- [ondragleave](input._internal_.SVGStyleElement.md#ondragleave)
- [ondragover](input._internal_.SVGStyleElement.md#ondragover)
- [ondragstart](input._internal_.SVGStyleElement.md#ondragstart)
- [ondrop](input._internal_.SVGStyleElement.md#ondrop)
- [ondurationchange](input._internal_.SVGStyleElement.md#ondurationchange)
- [onemptied](input._internal_.SVGStyleElement.md#onemptied)
- [onended](input._internal_.SVGStyleElement.md#onended)
- [onerror](input._internal_.SVGStyleElement.md#onerror)
- [onfocus](input._internal_.SVGStyleElement.md#onfocus)
- [onformdata](input._internal_.SVGStyleElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGStyleElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGStyleElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGStyleElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGStyleElement.md#oninput)
- [oninvalid](input._internal_.SVGStyleElement.md#oninvalid)
- [onkeydown](input._internal_.SVGStyleElement.md#onkeydown)
- [onkeypress](input._internal_.SVGStyleElement.md#onkeypress)
- [onkeyup](input._internal_.SVGStyleElement.md#onkeyup)
- [onload](input._internal_.SVGStyleElement.md#onload)
- [onloadeddata](input._internal_.SVGStyleElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGStyleElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGStyleElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGStyleElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGStyleElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGStyleElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGStyleElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGStyleElement.md#onmousemove)
- [onmouseout](input._internal_.SVGStyleElement.md#onmouseout)
- [onmouseover](input._internal_.SVGStyleElement.md#onmouseover)
- [onmouseup](input._internal_.SVGStyleElement.md#onmouseup)
- [onpaste](input._internal_.SVGStyleElement.md#onpaste)
- [onpause](input._internal_.SVGStyleElement.md#onpause)
- [onplay](input._internal_.SVGStyleElement.md#onplay)
- [onplaying](input._internal_.SVGStyleElement.md#onplaying)
- [onpointercancel](input._internal_.SVGStyleElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGStyleElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGStyleElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGStyleElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGStyleElement.md#onpointermove)
- [onpointerout](input._internal_.SVGStyleElement.md#onpointerout)
- [onpointerover](input._internal_.SVGStyleElement.md#onpointerover)
- [onpointerup](input._internal_.SVGStyleElement.md#onpointerup)
- [onprogress](input._internal_.SVGStyleElement.md#onprogress)
- [onratechange](input._internal_.SVGStyleElement.md#onratechange)
- [onreset](input._internal_.SVGStyleElement.md#onreset)
- [onresize](input._internal_.SVGStyleElement.md#onresize)
- [onscroll](input._internal_.SVGStyleElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGStyleElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGStyleElement.md#onseeked)
- [onseeking](input._internal_.SVGStyleElement.md#onseeking)
- [onselect](input._internal_.SVGStyleElement.md#onselect)
- [onselectionchange](input._internal_.SVGStyleElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGStyleElement.md#onselectstart)
- [onslotchange](input._internal_.SVGStyleElement.md#onslotchange)
- [onstalled](input._internal_.SVGStyleElement.md#onstalled)
- [onsubmit](input._internal_.SVGStyleElement.md#onsubmit)
- [onsuspend](input._internal_.SVGStyleElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGStyleElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGStyleElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGStyleElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGStyleElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGStyleElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGStyleElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGStyleElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGStyleElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGStyleElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGStyleElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGStyleElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGStyleElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGStyleElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGStyleElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGStyleElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGStyleElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGStyleElement.md#onwheel)
- [outerHTML](input._internal_.SVGStyleElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGStyleElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGStyleElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGStyleElement.md#parentelement)
- [parentNode](input._internal_.SVGStyleElement.md#parentnode)
- [part](input._internal_.SVGStyleElement.md#part)
- [prefix](input._internal_.SVGStyleElement.md#prefix)
- [previousElementSibling](input._internal_.SVGStyleElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGStyleElement.md#previoussibling)
- [scrollHeight](input._internal_.SVGStyleElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGStyleElement.md#scrollleft)
- [scrollTop](input._internal_.SVGStyleElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGStyleElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGStyleElement.md#shadowroot)
- [sheet](input._internal_.SVGStyleElement.md#sheet)
- [slot](input._internal_.SVGStyleElement.md#slot)
- [style](input._internal_.SVGStyleElement.md#style)
- [tabIndex](input._internal_.SVGStyleElement.md#tabindex)
- [tagName](input._internal_.SVGStyleElement.md#tagname)
- [textContent](input._internal_.SVGStyleElement.md#textcontent)
- [title](input._internal_.SVGStyleElement.md#title)
- [type](input._internal_.SVGStyleElement.md#type)
- [viewportElement](input._internal_.SVGStyleElement.md#viewportelement)

### Methods

- [addEventListener](input._internal_.SVGStyleElement.md#addeventlistener)
- [after](input._internal_.SVGStyleElement.md#after)
- [animate](input._internal_.SVGStyleElement.md#animate)
- [append](input._internal_.SVGStyleElement.md#append)
- [appendChild](input._internal_.SVGStyleElement.md#appendchild)
- [attachShadow](input._internal_.SVGStyleElement.md#attachshadow)
- [before](input._internal_.SVGStyleElement.md#before)
- [blur](input._internal_.SVGStyleElement.md#blur)
- [cloneNode](input._internal_.SVGStyleElement.md#clonenode)
- [closest](input._internal_.SVGStyleElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGStyleElement.md#comparedocumentposition)
- [contains](input._internal_.SVGStyleElement.md#contains)
- [dispatchEvent](input._internal_.SVGStyleElement.md#dispatchevent)
- [focus](input._internal_.SVGStyleElement.md#focus)
- [getAnimations](input._internal_.SVGStyleElement.md#getanimations)
- [getAttribute](input._internal_.SVGStyleElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGStyleElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGStyleElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGStyleElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGStyleElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.SVGStyleElement.md#getboundingclientrect)
- [getClientRects](input._internal_.SVGStyleElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGStyleElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGStyleElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGStyleElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGStyleElement.md#getrootnode)
- [hasAttribute](input._internal_.SVGStyleElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGStyleElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGStyleElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGStyleElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGStyleElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGStyleElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGStyleElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGStyleElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGStyleElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGStyleElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGStyleElement.md#isequalnode)
- [isSameNode](input._internal_.SVGStyleElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGStyleElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGStyleElement.md#lookupprefix)
- [matches](input._internal_.SVGStyleElement.md#matches)
- [normalize](input._internal_.SVGStyleElement.md#normalize)
- [prepend](input._internal_.SVGStyleElement.md#prepend)
- [querySelector](input._internal_.SVGStyleElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGStyleElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGStyleElement.md#releasepointercapture)
- [remove](input._internal_.SVGStyleElement.md#remove)
- [removeAttribute](input._internal_.SVGStyleElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGStyleElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGStyleElement.md#removeattributenode)
- [removeChild](input._internal_.SVGStyleElement.md#removechild)
- [removeEventListener](input._internal_.SVGStyleElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGStyleElement.md#replacechild)
- [replaceChildren](input._internal_.SVGStyleElement.md#replacechildren)
- [replaceWith](input._internal_.SVGStyleElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGStyleElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGStyleElement.md#requestpointerlock)
- [scroll](input._internal_.SVGStyleElement.md#scroll)
- [scrollBy](input._internal_.SVGStyleElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGStyleElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGStyleElement.md#scrollto)
- [setAttribute](input._internal_.SVGStyleElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGStyleElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGStyleElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGStyleElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGStyleElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGStyleElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGStyleElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGStyleElement`](../modules/input._internal_.md#svgstyleelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
