[Droom Google Location Plugin - v1.0.11](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLLinkElement

# Interface: HTMLLinkElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLLinkElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLLinkElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLLinkElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLLinkElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLLinkElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLLinkElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLLinkElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLLinkElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLLinkElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLLinkElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLLinkElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLLinkElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLLinkElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLLinkElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLLinkElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLLinkElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLLinkElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLLinkElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLLinkElement.md#text_node)
- [accessKey](input._internal_.HTMLLinkElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLLinkElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLLinkElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLLinkElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLLinkElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLLinkElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLLinkElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLLinkElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLLinkElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLLinkElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLLinkElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLLinkElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLLinkElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLLinkElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLLinkElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLLinkElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLLinkElement.md#arialevel)
- [ariaLive](input._internal_.HTMLLinkElement.md#arialive)
- [ariaModal](input._internal_.HTMLLinkElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLLinkElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLLinkElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLLinkElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLLinkElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLLinkElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLLinkElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLLinkElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLLinkElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLLinkElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLLinkElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLLinkElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLLinkElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLLinkElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLLinkElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLLinkElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLLinkElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLLinkElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLLinkElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLLinkElement.md#ariavaluetext)
- [as](input._internal_.HTMLLinkElement.md#as)
- [assignedSlot](input._internal_.HTMLLinkElement.md#assignedslot)
- [attributes](input._internal_.HTMLLinkElement.md#attributes)
- [autocapitalize](input._internal_.HTMLLinkElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLLinkElement.md#autofocus)
- [baseURI](input._internal_.HTMLLinkElement.md#baseuri)
- [charset](input._internal_.HTMLLinkElement.md#charset)
- [childElementCount](input._internal_.HTMLLinkElement.md#childelementcount)
- [childNodes](input._internal_.HTMLLinkElement.md#childnodes)
- [children](input._internal_.HTMLLinkElement.md#children)
- [classList](input._internal_.HTMLLinkElement.md#classlist)
- [className](input._internal_.HTMLLinkElement.md#classname)
- [clientHeight](input._internal_.HTMLLinkElement.md#clientheight)
- [clientLeft](input._internal_.HTMLLinkElement.md#clientleft)
- [clientTop](input._internal_.HTMLLinkElement.md#clienttop)
- [clientWidth](input._internal_.HTMLLinkElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLLinkElement.md#contenteditable)
- [crossOrigin](input._internal_.HTMLLinkElement.md#crossorigin)
- [dataset](input._internal_.HTMLLinkElement.md#dataset)
- [dir](input._internal_.HTMLLinkElement.md#dir)
- [disabled](input._internal_.HTMLLinkElement.md#disabled)
- [draggable](input._internal_.HTMLLinkElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLLinkElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLLinkElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLLinkElement.md#firstelementchild)
- [hidden](input._internal_.HTMLLinkElement.md#hidden)
- [href](input._internal_.HTMLLinkElement.md#href)
- [hreflang](input._internal_.HTMLLinkElement.md#hreflang)
- [id](input._internal_.HTMLLinkElement.md#id)
- [imageSizes](input._internal_.HTMLLinkElement.md#imagesizes)
- [imageSrcset](input._internal_.HTMLLinkElement.md#imagesrcset)
- [innerHTML](input._internal_.HTMLLinkElement.md#innerhtml)
- [innerText](input._internal_.HTMLLinkElement.md#innertext)
- [inputMode](input._internal_.HTMLLinkElement.md#inputmode)
- [integrity](input._internal_.HTMLLinkElement.md#integrity)
- [isConnected](input._internal_.HTMLLinkElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLLinkElement.md#iscontenteditable)
- [lang](input._internal_.HTMLLinkElement.md#lang)
- [lastChild](input._internal_.HTMLLinkElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLLinkElement.md#lastelementchild)
- [localName](input._internal_.HTMLLinkElement.md#localname)
- [media](input._internal_.HTMLLinkElement.md#media)
- [namespaceURI](input._internal_.HTMLLinkElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLLinkElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLLinkElement.md#nextsibling)
- [nodeName](input._internal_.HTMLLinkElement.md#nodename)
- [nodeType](input._internal_.HTMLLinkElement.md#nodetype)
- [nodeValue](input._internal_.HTMLLinkElement.md#nodevalue)
- [nonce](input._internal_.HTMLLinkElement.md#nonce)
- [offsetHeight](input._internal_.HTMLLinkElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLLinkElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLLinkElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLLinkElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLLinkElement.md#offsetwidth)
- [onabort](input._internal_.HTMLLinkElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLLinkElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLLinkElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLLinkElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLLinkElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLLinkElement.md#onauxclick)
- [onblur](input._internal_.HTMLLinkElement.md#onblur)
- [oncanplay](input._internal_.HTMLLinkElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLLinkElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLLinkElement.md#onchange)
- [onclick](input._internal_.HTMLLinkElement.md#onclick)
- [onclose](input._internal_.HTMLLinkElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLLinkElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLLinkElement.md#oncopy)
- [oncuechange](input._internal_.HTMLLinkElement.md#oncuechange)
- [oncut](input._internal_.HTMLLinkElement.md#oncut)
- [ondblclick](input._internal_.HTMLLinkElement.md#ondblclick)
- [ondrag](input._internal_.HTMLLinkElement.md#ondrag)
- [ondragend](input._internal_.HTMLLinkElement.md#ondragend)
- [ondragenter](input._internal_.HTMLLinkElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLLinkElement.md#ondragleave)
- [ondragover](input._internal_.HTMLLinkElement.md#ondragover)
- [ondragstart](input._internal_.HTMLLinkElement.md#ondragstart)
- [ondrop](input._internal_.HTMLLinkElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLLinkElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLLinkElement.md#onemptied)
- [onended](input._internal_.HTMLLinkElement.md#onended)
- [onerror](input._internal_.HTMLLinkElement.md#onerror)
- [onfocus](input._internal_.HTMLLinkElement.md#onfocus)
- [onformdata](input._internal_.HTMLLinkElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLLinkElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLLinkElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLLinkElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLLinkElement.md#oninput)
- [oninvalid](input._internal_.HTMLLinkElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLLinkElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLLinkElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLLinkElement.md#onkeyup)
- [onload](input._internal_.HTMLLinkElement.md#onload)
- [onloadeddata](input._internal_.HTMLLinkElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLLinkElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLLinkElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLLinkElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLLinkElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLLinkElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLLinkElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLLinkElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLLinkElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLLinkElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLLinkElement.md#onmouseup)
- [onpaste](input._internal_.HTMLLinkElement.md#onpaste)
- [onpause](input._internal_.HTMLLinkElement.md#onpause)
- [onplay](input._internal_.HTMLLinkElement.md#onplay)
- [onplaying](input._internal_.HTMLLinkElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLLinkElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLLinkElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLLinkElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLLinkElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLLinkElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLLinkElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLLinkElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLLinkElement.md#onpointerup)
- [onprogress](input._internal_.HTMLLinkElement.md#onprogress)
- [onratechange](input._internal_.HTMLLinkElement.md#onratechange)
- [onreset](input._internal_.HTMLLinkElement.md#onreset)
- [onresize](input._internal_.HTMLLinkElement.md#onresize)
- [onscroll](input._internal_.HTMLLinkElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLLinkElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLLinkElement.md#onseeked)
- [onseeking](input._internal_.HTMLLinkElement.md#onseeking)
- [onselect](input._internal_.HTMLLinkElement.md#onselect)
- [onselectionchange](input._internal_.HTMLLinkElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLLinkElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLLinkElement.md#onslotchange)
- [onstalled](input._internal_.HTMLLinkElement.md#onstalled)
- [onsubmit](input._internal_.HTMLLinkElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLLinkElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLLinkElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLLinkElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLLinkElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLLinkElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLLinkElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLLinkElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLLinkElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLLinkElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLLinkElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLLinkElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLLinkElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLLinkElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLLinkElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLLinkElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLLinkElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLLinkElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLLinkElement.md#onwheel)
- [outerHTML](input._internal_.HTMLLinkElement.md#outerhtml)
- [outerText](input._internal_.HTMLLinkElement.md#outertext)
- [ownerDocument](input._internal_.HTMLLinkElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLLinkElement.md#parentelement)
- [parentNode](input._internal_.HTMLLinkElement.md#parentnode)
- [part](input._internal_.HTMLLinkElement.md#part)
- [prefix](input._internal_.HTMLLinkElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLLinkElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLLinkElement.md#previoussibling)
- [referrerPolicy](input._internal_.HTMLLinkElement.md#referrerpolicy)
- [rel](input._internal_.HTMLLinkElement.md#rel)
- [relList](input._internal_.HTMLLinkElement.md#rellist)
- [rev](input._internal_.HTMLLinkElement.md#rev)
- [scrollHeight](input._internal_.HTMLLinkElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLLinkElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLLinkElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLLinkElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLLinkElement.md#shadowroot)
- [sheet](input._internal_.HTMLLinkElement.md#sheet)
- [sizes](input._internal_.HTMLLinkElement.md#sizes)
- [slot](input._internal_.HTMLLinkElement.md#slot)
- [spellcheck](input._internal_.HTMLLinkElement.md#spellcheck)
- [style](input._internal_.HTMLLinkElement.md#style)
- [tabIndex](input._internal_.HTMLLinkElement.md#tabindex)
- [tagName](input._internal_.HTMLLinkElement.md#tagname)
- [target](input._internal_.HTMLLinkElement.md#target)
- [textContent](input._internal_.HTMLLinkElement.md#textcontent)
- [title](input._internal_.HTMLLinkElement.md#title)
- [translate](input._internal_.HTMLLinkElement.md#translate)
- [type](input._internal_.HTMLLinkElement.md#type)

### Methods

- [addEventListener](input._internal_.HTMLLinkElement.md#addeventlistener)
- [after](input._internal_.HTMLLinkElement.md#after)
- [animate](input._internal_.HTMLLinkElement.md#animate)
- [append](input._internal_.HTMLLinkElement.md#append)
- [appendChild](input._internal_.HTMLLinkElement.md#appendchild)
- [attachInternals](input._internal_.HTMLLinkElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLLinkElement.md#attachshadow)
- [before](input._internal_.HTMLLinkElement.md#before)
- [blur](input._internal_.HTMLLinkElement.md#blur)
- [click](input._internal_.HTMLLinkElement.md#click)
- [cloneNode](input._internal_.HTMLLinkElement.md#clonenode)
- [closest](input._internal_.HTMLLinkElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLLinkElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLLinkElement.md#contains)
- [dispatchEvent](input._internal_.HTMLLinkElement.md#dispatchevent)
- [focus](input._internal_.HTMLLinkElement.md#focus)
- [getAnimations](input._internal_.HTMLLinkElement.md#getanimations)
- [getAttribute](input._internal_.HTMLLinkElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLLinkElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLLinkElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLLinkElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLLinkElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLLinkElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLLinkElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLLinkElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLLinkElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLLinkElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLLinkElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLLinkElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLLinkElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLLinkElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLLinkElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLLinkElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLLinkElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLLinkElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLLinkElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLLinkElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLLinkElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLLinkElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLLinkElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLLinkElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLLinkElement.md#lookupprefix)
- [matches](input._internal_.HTMLLinkElement.md#matches)
- [normalize](input._internal_.HTMLLinkElement.md#normalize)
- [prepend](input._internal_.HTMLLinkElement.md#prepend)
- [querySelector](input._internal_.HTMLLinkElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLLinkElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLLinkElement.md#releasepointercapture)
- [remove](input._internal_.HTMLLinkElement.md#remove)
- [removeAttribute](input._internal_.HTMLLinkElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLLinkElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLLinkElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLLinkElement.md#removechild)
- [removeEventListener](input._internal_.HTMLLinkElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLLinkElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLLinkElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLLinkElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLLinkElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLLinkElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLLinkElement.md#scroll)
- [scrollBy](input._internal_.HTMLLinkElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLLinkElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLLinkElement.md#scrollto)
- [setAttribute](input._internal_.HTMLLinkElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLLinkElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLLinkElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLLinkElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLLinkElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLLinkElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLLinkElement.md#webkitmatchesselector)
...
• `Readonly` **sizes**: [`DOMTokenList`](../modules/input._internal_.md#domtokenlist)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLLinkElement`](../modules/input._internal_.md#htmllinkelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
