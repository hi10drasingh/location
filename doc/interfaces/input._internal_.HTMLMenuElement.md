[Droom Google Location Plugin - v1.0.11](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLMenuElement

# Interface: HTMLMenuElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLMenuElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLMenuElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLMenuElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLMenuElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLMenuElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLMenuElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLMenuElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLMenuElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLMenuElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLMenuElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLMenuElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLMenuElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLMenuElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLMenuElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLMenuElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLMenuElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLMenuElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLMenuElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLMenuElement.md#text_node)
- [accessKey](input._internal_.HTMLMenuElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLMenuElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLMenuElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLMenuElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLMenuElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLMenuElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLMenuElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLMenuElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLMenuElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLMenuElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLMenuElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLMenuElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLMenuElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLMenuElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLMenuElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLMenuElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLMenuElement.md#arialevel)
- [ariaLive](input._internal_.HTMLMenuElement.md#arialive)
- [ariaModal](input._internal_.HTMLMenuElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLMenuElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLMenuElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLMenuElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLMenuElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLMenuElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLMenuElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLMenuElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLMenuElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLMenuElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLMenuElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLMenuElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLMenuElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLMenuElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLMenuElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLMenuElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLMenuElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLMenuElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLMenuElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLMenuElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLMenuElement.md#assignedslot)
- [attributes](input._internal_.HTMLMenuElement.md#attributes)
- [autocapitalize](input._internal_.HTMLMenuElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLMenuElement.md#autofocus)
- [baseURI](input._internal_.HTMLMenuElement.md#baseuri)
- [childElementCount](input._internal_.HTMLMenuElement.md#childelementcount)
- [childNodes](input._internal_.HTMLMenuElement.md#childnodes)
- [children](input._internal_.HTMLMenuElement.md#children)
- [classList](input._internal_.HTMLMenuElement.md#classlist)
- [className](input._internal_.HTMLMenuElement.md#classname)
- [clientHeight](input._internal_.HTMLMenuElement.md#clientheight)
- [clientLeft](input._internal_.HTMLMenuElement.md#clientleft)
- [clientTop](input._internal_.HTMLMenuElement.md#clienttop)
- [clientWidth](input._internal_.HTMLMenuElement.md#clientwidth)
- [compact](input._internal_.HTMLMenuElement.md#compact)
- [contentEditable](input._internal_.HTMLMenuElement.md#contenteditable)
- [dataset](input._internal_.HTMLMenuElement.md#dataset)
- [dir](input._internal_.HTMLMenuElement.md#dir)
- [draggable](input._internal_.HTMLMenuElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLMenuElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLMenuElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLMenuElement.md#firstelementchild)
- [hidden](input._internal_.HTMLMenuElement.md#hidden)
- [id](input._internal_.HTMLMenuElement.md#id)
- [innerHTML](input._internal_.HTMLMenuElement.md#innerhtml)
- [innerText](input._internal_.HTMLMenuElement.md#innertext)
- [inputMode](input._internal_.HTMLMenuElement.md#inputmode)
- [isConnected](input._internal_.HTMLMenuElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLMenuElement.md#iscontenteditable)
- [lang](input._internal_.HTMLMenuElement.md#lang)
- [lastChild](input._internal_.HTMLMenuElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLMenuElement.md#lastelementchild)
- [localName](input._internal_.HTMLMenuElement.md#localname)
- [namespaceURI](input._internal_.HTMLMenuElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLMenuElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLMenuElement.md#nextsibling)
- [nodeName](input._internal_.HTMLMenuElement.md#nodename)
- [nodeType](input._internal_.HTMLMenuElement.md#nodetype)
- [nodeValue](input._internal_.HTMLMenuElement.md#nodevalue)
- [nonce](input._internal_.HTMLMenuElement.md#nonce)
- [offsetHeight](input._internal_.HTMLMenuElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLMenuElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLMenuElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLMenuElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLMenuElement.md#offsetwidth)
- [onabort](input._internal_.HTMLMenuElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLMenuElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLMenuElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLMenuElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLMenuElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLMenuElement.md#onauxclick)
- [onblur](input._internal_.HTMLMenuElement.md#onblur)
- [oncanplay](input._internal_.HTMLMenuElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLMenuElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLMenuElement.md#onchange)
- [onclick](input._internal_.HTMLMenuElement.md#onclick)
- [onclose](input._internal_.HTMLMenuElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLMenuElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLMenuElement.md#oncopy)
- [oncuechange](input._internal_.HTMLMenuElement.md#oncuechange)
- [oncut](input._internal_.HTMLMenuElement.md#oncut)
- [ondblclick](input._internal_.HTMLMenuElement.md#ondblclick)
- [ondrag](input._internal_.HTMLMenuElement.md#ondrag)
- [ondragend](input._internal_.HTMLMenuElement.md#ondragend)
- [ondragenter](input._internal_.HTMLMenuElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLMenuElement.md#ondragleave)
- [ondragover](input._internal_.HTMLMenuElement.md#ondragover)
- [ondragstart](input._internal_.HTMLMenuElement.md#ondragstart)
- [ondrop](input._internal_.HTMLMenuElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLMenuElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLMenuElement.md#onemptied)
- [onended](input._internal_.HTMLMenuElement.md#onended)
- [onerror](input._internal_.HTMLMenuElement.md#onerror)
- [onfocus](input._internal_.HTMLMenuElement.md#onfocus)
- [onformdata](input._internal_.HTMLMenuElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLMenuElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLMenuElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLMenuElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLMenuElement.md#oninput)
- [oninvalid](input._internal_.HTMLMenuElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLMenuElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLMenuElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLMenuElement.md#onkeyup)
- [onload](input._internal_.HTMLMenuElement.md#onload)
- [onloadeddata](input._internal_.HTMLMenuElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLMenuElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLMenuElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLMenuElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLMenuElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLMenuElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLMenuElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLMenuElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLMenuElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLMenuElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLMenuElement.md#onmouseup)
- [onpaste](input._internal_.HTMLMenuElement.md#onpaste)
- [onpause](input._internal_.HTMLMenuElement.md#onpause)
- [onplay](input._internal_.HTMLMenuElement.md#onplay)
- [onplaying](input._internal_.HTMLMenuElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLMenuElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLMenuElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLMenuElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLMenuElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLMenuElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLMenuElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLMenuElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLMenuElement.md#onpointerup)
- [onprogress](input._internal_.HTMLMenuElement.md#onprogress)
- [onratechange](input._internal_.HTMLMenuElement.md#onratechange)
- [onreset](input._internal_.HTMLMenuElement.md#onreset)
- [onresize](input._internal_.HTMLMenuElement.md#onresize)
- [onscroll](input._internal_.HTMLMenuElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLMenuElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLMenuElement.md#onseeked)
- [onseeking](input._internal_.HTMLMenuElement.md#onseeking)
- [onselect](input._internal_.HTMLMenuElement.md#onselect)
- [onselectionchange](input._internal_.HTMLMenuElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLMenuElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLMenuElement.md#onslotchange)
- [onstalled](input._internal_.HTMLMenuElement.md#onstalled)
- [onsubmit](input._internal_.HTMLMenuElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLMenuElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLMenuElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLMenuElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLMenuElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLMenuElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLMenuElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLMenuElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLMenuElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLMenuElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLMenuElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLMenuElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLMenuElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLMenuElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLMenuElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLMenuElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLMenuElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLMenuElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLMenuElement.md#onwheel)
- [outerHTML](input._internal_.HTMLMenuElement.md#outerhtml)
- [outerText](input._internal_.HTMLMenuElement.md#outertext)
- [ownerDocument](input._internal_.HTMLMenuElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLMenuElement.md#parentelement)
- [parentNode](input._internal_.HTMLMenuElement.md#parentnode)
- [part](input._internal_.HTMLMenuElement.md#part)
- [prefix](input._internal_.HTMLMenuElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLMenuElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLMenuElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLMenuElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLMenuElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLMenuElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLMenuElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLMenuElement.md#shadowroot)
- [slot](input._internal_.HTMLMenuElement.md#slot)
- [spellcheck](input._internal_.HTMLMenuElement.md#spellcheck)
- [style](input._internal_.HTMLMenuElement.md#style)
- [tabIndex](input._internal_.HTMLMenuElement.md#tabindex)
- [tagName](input._internal_.HTMLMenuElement.md#tagname)
- [textContent](input._internal_.HTMLMenuElement.md#textcontent)
- [title](input._internal_.HTMLMenuElement.md#title)
- [translate](input._internal_.HTMLMenuElement.md#translate)

### Methods

- [addEventListener](input._internal_.HTMLMenuElement.md#addeventlistener)
- [after](input._internal_.HTMLMenuElement.md#after)
- [animate](input._internal_.HTMLMenuElement.md#animate)
- [append](input._internal_.HTMLMenuElement.md#append)
- [appendChild](input._internal_.HTMLMenuElement.md#appendchild)
- [attachInternals](input._internal_.HTMLMenuElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLMenuElement.md#attachshadow)
- [before](input._internal_.HTMLMenuElement.md#before)
- [blur](input._internal_.HTMLMenuElement.md#blur)
- [click](input._internal_.HTMLMenuElement.md#click)
- [cloneNode](input._internal_.HTMLMenuElement.md#clonenode)
- [closest](input._internal_.HTMLMenuElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLMenuElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLMenuElement.md#contains)
- [dispatchEvent](input._internal_.HTMLMenuElement.md#dispatchevent)
- [focus](input._internal_.HTMLMenuElement.md#focus)
- [getAnimations](input._internal_.HTMLMenuElement.md#getanimations)
- [getAttribute](input._internal_.HTMLMenuElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLMenuElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLMenuElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLMenuElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLMenuElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLMenuElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLMenuElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLMenuElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLMenuElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLMenuElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLMenuElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLMenuElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLMenuElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLMenuElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLMenuElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLMenuElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLMenuElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLMenuElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLMenuElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLMenuElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLMenuElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLMenuElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLMenuElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLMenuElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLMenuElement.md#lookupprefix)
- [matches](input._internal_.HTMLMenuElement.md#matches)
- [normalize](input._internal_.HTMLMenuElement.md#normalize)
- [prepend](input._internal_.HTMLMenuElement.md#prepend)
- [querySelector](input._internal_.HTMLMenuElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLMenuElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLMenuElement.md#releasepointercapture)
- [remove](input._internal_.HTMLMenuElement.md#remove)
- [removeAttribute](input._internal_.HTMLMenuElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLMenuElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLMenuElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLMenuElement.md#removechild)
- [removeEventListener](input._internal_.HTMLMenuElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLMenuElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLMenuElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLMenuElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLMenuElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLMenuElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLMenuElement.md#scroll)
- [scrollBy](input._internal_.HTMLMenuElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLMenuElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLMenuElement.md#scrollto)
- [setAttribute](input._internal_.HTMLMenuElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLMenuElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLMenuElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLMenuElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLMenuElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLMenuElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLMenuElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLMenuElement`](../modules/input._internal_.md#htmlmenuelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
