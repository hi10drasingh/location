[Droom Google Location Plugin - v1.0.11](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGClipPathElement

# Interface: SVGClipPathElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGClipPathElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGClipPathElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGClipPathElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGClipPathElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGClipPathElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGClipPathElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGClipPathElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGClipPathElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGClipPathElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGClipPathElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGClipPathElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGClipPathElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGClipPathElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGClipPathElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGClipPathElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGClipPathElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGClipPathElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGClipPathElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGClipPathElement.md#text_node)
- [ariaAtomic](input._internal_.SVGClipPathElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGClipPathElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGClipPathElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGClipPathElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGClipPathElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGClipPathElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGClipPathElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGClipPathElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGClipPathElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGClipPathElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGClipPathElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGClipPathElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGClipPathElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGClipPathElement.md#arialabel)
- [ariaLevel](input._internal_.SVGClipPathElement.md#arialevel)
- [ariaLive](input._internal_.SVGClipPathElement.md#arialive)
- [ariaModal](input._internal_.SVGClipPathElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGClipPathElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGClipPathElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGClipPathElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGClipPathElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGClipPathElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGClipPathElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGClipPathElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGClipPathElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGClipPathElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGClipPathElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGClipPathElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGClipPathElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGClipPathElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGClipPathElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGClipPathElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGClipPathElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGClipPathElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGClipPathElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGClipPathElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGClipPathElement.md#assignedslot)
- [attributes](input._internal_.SVGClipPathElement.md#attributes)
- [autofocus](input._internal_.SVGClipPathElement.md#autofocus)
- [baseURI](input._internal_.SVGClipPathElement.md#baseuri)
- [childElementCount](input._internal_.SVGClipPathElement.md#childelementcount)
- [childNodes](input._internal_.SVGClipPathElement.md#childnodes)
- [children](input._internal_.SVGClipPathElement.md#children)
- [classList](input._internal_.SVGClipPathElement.md#classlist)
- [className](input._internal_.SVGClipPathElement.md#classname)
- [clientHeight](input._internal_.SVGClipPathElement.md#clientheight)
- [clientLeft](input._internal_.SVGClipPathElement.md#clientleft)
- [clientTop](input._internal_.SVGClipPathElement.md#clienttop)
- [clientWidth](input._internal_.SVGClipPathElement.md#clientwidth)
- [clipPathUnits](input._internal_.SVGClipPathElement.md#clippathunits)
- [dataset](input._internal_.SVGClipPathElement.md#dataset)
- [firstChild](input._internal_.SVGClipPathElement.md#firstchild)
- [firstElementChild](input._internal_.SVGClipPathElement.md#firstelementchild)
- [id](input._internal_.SVGClipPathElement.md#id)
- [innerHTML](input._internal_.SVGClipPathElement.md#innerhtml)
- [isConnected](input._internal_.SVGClipPathElement.md#isconnected)
- [lastChild](input._internal_.SVGClipPathElement.md#lastchild)
- [lastElementChild](input._internal_.SVGClipPathElement.md#lastelementchild)
- [localName](input._internal_.SVGClipPathElement.md#localname)
- [namespaceURI](input._internal_.SVGClipPathElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGClipPathElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGClipPathElement.md#nextsibling)
- [nodeName](input._internal_.SVGClipPathElement.md#nodename)
- [nodeType](input._internal_.SVGClipPathElement.md#nodetype)
- [nodeValue](input._internal_.SVGClipPathElement.md#nodevalue)
- [nonce](input._internal_.SVGClipPathElement.md#nonce)
- [onabort](input._internal_.SVGClipPathElement.md#onabort)
- [onanimationcancel](input._internal_.SVGClipPathElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGClipPathElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGClipPathElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGClipPathElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGClipPathElement.md#onauxclick)
- [onblur](input._internal_.SVGClipPathElement.md#onblur)
- [oncanplay](input._internal_.SVGClipPathElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGClipPathElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGClipPathElement.md#onchange)
- [onclick](input._internal_.SVGClipPathElement.md#onclick)
- [onclose](input._internal_.SVGClipPathElement.md#onclose)
- [oncontextmenu](input._internal_.SVGClipPathElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGClipPathElement.md#oncopy)
- [oncuechange](input._internal_.SVGClipPathElement.md#oncuechange)
- [oncut](input._internal_.SVGClipPathElement.md#oncut)
- [ondblclick](input._internal_.SVGClipPathElement.md#ondblclick)
- [ondrag](input._internal_.SVGClipPathElement.md#ondrag)
- [ondragend](input._internal_.SVGClipPathElement.md#ondragend)
- [ondragenter](input._internal_.SVGClipPathElement.md#ondragenter)
- [ondragleave](input._internal_.SVGClipPathElement.md#ondragleave)
- [ondragover](input._internal_.SVGClipPathElement.md#ondragover)
- [ondragstart](input._internal_.SVGClipPathElement.md#ondragstart)
- [ondrop](input._internal_.SVGClipPathElement.md#ondrop)
- [ondurationchange](input._internal_.SVGClipPathElement.md#ondurationchange)
- [onemptied](input._internal_.SVGClipPathElement.md#onemptied)
- [onended](input._internal_.SVGClipPathElement.md#onended)
- [onerror](input._internal_.SVGClipPathElement.md#onerror)
- [onfocus](input._internal_.SVGClipPathElement.md#onfocus)
- [onformdata](input._internal_.SVGClipPathElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGClipPathElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGClipPathElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGClipPathElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGClipPathElement.md#oninput)
- [oninvalid](input._internal_.SVGClipPathElement.md#oninvalid)
- [onkeydown](input._internal_.SVGClipPathElement.md#onkeydown)
- [onkeypress](input._internal_.SVGClipPathElement.md#onkeypress)
- [onkeyup](input._internal_.SVGClipPathElement.md#onkeyup)
- [onload](input._internal_.SVGClipPathElement.md#onload)
- [onloadeddata](input._internal_.SVGClipPathElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGClipPathElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGClipPathElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGClipPathElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGClipPathElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGClipPathElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGClipPathElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGClipPathElement.md#onmousemove)
- [onmouseout](input._internal_.SVGClipPathElement.md#onmouseout)
- [onmouseover](input._internal_.SVGClipPathElement.md#onmouseover)
- [onmouseup](input._internal_.SVGClipPathElement.md#onmouseup)
- [onpaste](input._internal_.SVGClipPathElement.md#onpaste)
- [onpause](input._internal_.SVGClipPathElement.md#onpause)
- [onplay](input._internal_.SVGClipPathElement.md#onplay)
- [onplaying](input._internal_.SVGClipPathElement.md#onplaying)
- [onpointercancel](input._internal_.SVGClipPathElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGClipPathElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGClipPathElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGClipPathElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGClipPathElement.md#onpointermove)
- [onpointerout](input._internal_.SVGClipPathElement.md#onpointerout)
- [onpointerover](input._internal_.SVGClipPathElement.md#onpointerover)
- [onpointerup](input._internal_.SVGClipPathElement.md#onpointerup)
- [onprogress](input._internal_.SVGClipPathElement.md#onprogress)
- [onratechange](input._internal_.SVGClipPathElement.md#onratechange)
- [onreset](input._internal_.SVGClipPathElement.md#onreset)
- [onresize](input._internal_.SVGClipPathElement.md#onresize)
- [onscroll](input._internal_.SVGClipPathElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGClipPathElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGClipPathElement.md#onseeked)
- [onseeking](input._internal_.SVGClipPathElement.md#onseeking)
- [onselect](input._internal_.SVGClipPathElement.md#onselect)
- [onselectionchange](input._internal_.SVGClipPathElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGClipPathElement.md#onselectstart)
- [onslotchange](input._internal_.SVGClipPathElement.md#onslotchange)
- [onstalled](input._internal_.SVGClipPathElement.md#onstalled)
- [onsubmit](input._internal_.SVGClipPathElement.md#onsubmit)
- [onsuspend](input._internal_.SVGClipPathElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGClipPathElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGClipPathElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGClipPathElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGClipPathElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGClipPathElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGClipPathElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGClipPathElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGClipPathElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGClipPathElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGClipPathElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGClipPathElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGClipPathElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGClipPathElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGClipPathElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGClipPathElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGClipPathElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGClipPathElement.md#onwheel)
- [outerHTML](input._internal_.SVGClipPathElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGClipPathElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGClipPathElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGClipPathElement.md#parentelement)
- [parentNode](input._internal_.SVGClipPathElement.md#parentnode)
- [part](input._internal_.SVGClipPathElement.md#part)
- [prefix](input._internal_.SVGClipPathElement.md#prefix)
- [previousElementSibling](input._internal_.SVGClipPathElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGClipPathElement.md#previoussibling)
- [scrollHeight](input._internal_.SVGClipPathElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGClipPathElement.md#scrollleft)
- [scrollTop](input._internal_.SVGClipPathElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGClipPathElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGClipPathElement.md#shadowroot)
- [slot](input._internal_.SVGClipPathElement.md#slot)
- [style](input._internal_.SVGClipPathElement.md#style)
- [tabIndex](input._internal_.SVGClipPathElement.md#tabindex)
- [tagName](input._internal_.SVGClipPathElement.md#tagname)
- [textContent](input._internal_.SVGClipPathElement.md#textcontent)
- [transform](input._internal_.SVGClipPathElement.md#transform)
- [viewportElement](input._internal_.SVGClipPathElement.md#viewportelement)

### Methods

- [addEventListener](input._internal_.SVGClipPathElement.md#addeventlistener)
- [after](input._internal_.SVGClipPathElement.md#after)
- [animate](input._internal_.SVGClipPathElement.md#animate)
- [append](input._internal_.SVGClipPathElement.md#append)
- [appendChild](input._internal_.SVGClipPathElement.md#appendchild)
- [attachShadow](input._internal_.SVGClipPathElement.md#attachshadow)
- [before](input._internal_.SVGClipPathElement.md#before)
- [blur](input._internal_.SVGClipPathElement.md#blur)
- [cloneNode](input._internal_.SVGClipPathElement.md#clonenode)
- [closest](input._internal_.SVGClipPathElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGClipPathElement.md#comparedocumentposition)
- [contains](input._internal_.SVGClipPathElement.md#contains)
- [dispatchEvent](input._internal_.SVGClipPathElement.md#dispatchevent)
- [focus](input._internal_.SVGClipPathElement.md#focus)
- [getAnimations](input._internal_.SVGClipPathElement.md#getanimations)
- [getAttribute](input._internal_.SVGClipPathElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGClipPathElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGClipPathElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGClipPathElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGClipPathElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.SVGClipPathElement.md#getboundingclientrect)
- [getClientRects](input._internal_.SVGClipPathElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGClipPathElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGClipPathElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGClipPathElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGClipPathElement.md#getrootnode)
- [hasAttribute](input._internal_.SVGClipPathElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGClipPathElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGClipPathElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGClipPathElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGClipPathElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGClipPathElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGClipPathElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGClipPathElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGClipPathElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGClipPathElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGClipPathElement.md#isequalnode)
- [isSameNode](input._internal_.SVGClipPathElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGClipPathElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGClipPathElement.md#lookupprefix)
- [matches](input._internal_.SVGClipPathElement.md#matches)
- [normalize](input._internal_.SVGClipPathElement.md#normalize)
- [prepend](input._internal_.SVGClipPathElement.md#prepend)
- [querySelector](input._internal_.SVGClipPathElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGClipPathElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGClipPathElement.md#releasepointercapture)
- [remove](input._internal_.SVGClipPathElement.md#remove)
- [removeAttribute](input._internal_.SVGClipPathElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGClipPathElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGClipPathElement.md#removeattributenode)
- [removeChild](input._internal_.SVGClipPathElement.md#removechild)
- [removeEventListener](input._internal_.SVGClipPathElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGClipPathElement.md#replacechild)
- [replaceChildren](input._internal_.SVGClipPathElement.md#replacechildren)
- [replaceWith](input._internal_.SVGClipPathElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGClipPathElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGClipPathElement.md#requestpointerlock)
- [scroll](input._internal_.SVGClipPathElement.md#scroll)
- [scrollBy](input._internal_.SVGClipPathElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGClipPathElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGClipPathElement.md#scrollto)
- [setAttribute](input._internal_.SVGClipPathElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGClipPathElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGClipPathElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGClipPathElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGClipPathElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGClipPathElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGClipPathElement.md#webkitmatchesselector)
...
• `Readonly` **clipPathUnits**: [`SVGAnimatedEnumeration`](../modules/input._internal_.md#svganimatedenumeration)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGClipPathElement`](../modules/input._internal_.md#svgclippathelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
