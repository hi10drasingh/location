[Droom Google Location Plugin - v1.0.16](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGAElement

# Interface: SVGAElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGAElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGAElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGAElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGAElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGAElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGAElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGAElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGAElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGAElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGAElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGAElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGAElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGAElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGAElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGAElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGAElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGAElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGAElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGAElement.md#text_node)
- [ariaAtomic](input._internal_.SVGAElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGAElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGAElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGAElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGAElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGAElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGAElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGAElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGAElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGAElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGAElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGAElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGAElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGAElement.md#arialabel)
- [ariaLevel](input._internal_.SVGAElement.md#arialevel)
- [ariaLive](input._internal_.SVGAElement.md#arialive)
- [ariaModal](input._internal_.SVGAElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGAElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGAElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGAElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGAElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGAElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGAElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGAElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGAElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGAElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGAElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGAElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGAElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGAElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGAElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGAElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGAElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGAElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGAElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGAElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGAElement.md#assignedslot)
- [attributes](input._internal_.SVGAElement.md#attributes)
- [autofocus](input._internal_.SVGAElement.md#autofocus)
- [baseURI](input._internal_.SVGAElement.md#baseuri)
- [childElementCount](input._internal_.SVGAElement.md#childelementcount)
- [childNodes](input._internal_.SVGAElement.md#childnodes)
- [children](input._internal_.SVGAElement.md#children)
- [classList](input._internal_.SVGAElement.md#classlist)
- [className](input._internal_.SVGAElement.md#classname)
- [clientHeight](input._internal_.SVGAElement.md#clientheight)
- [clientLeft](input._internal_.SVGAElement.md#clientleft)
- [clientTop](input._internal_.SVGAElement.md#clienttop)
- [clientWidth](input._internal_.SVGAElement.md#clientwidth)
- [dataset](input._internal_.SVGAElement.md#dataset)
- [firstChild](input._internal_.SVGAElement.md#firstchild)
- [firstElementChild](input._internal_.SVGAElement.md#firstelementchild)
- [href](input._internal_.SVGAElement.md#href)
- [id](input._internal_.SVGAElement.md#id)
- [innerHTML](input._internal_.SVGAElement.md#innerhtml)
- [isConnected](input._internal_.SVGAElement.md#isconnected)
- [lastChild](input._internal_.SVGAElement.md#lastchild)
- [lastElementChild](input._internal_.SVGAElement.md#lastelementchild)
- [localName](input._internal_.SVGAElement.md#localname)
- [namespaceURI](input._internal_.SVGAElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGAElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGAElement.md#nextsibling)
- [nodeName](input._internal_.SVGAElement.md#nodename)
- [nodeType](input._internal_.SVGAElement.md#nodetype)
- [nodeValue](input._internal_.SVGAElement.md#nodevalue)
- [nonce](input._internal_.SVGAElement.md#nonce)
- [onabort](input._internal_.SVGAElement.md#onabort)
- [onanimationcancel](input._internal_.SVGAElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGAElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGAElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGAElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGAElement.md#onauxclick)
- [onblur](input._internal_.SVGAElement.md#onblur)
- [oncanplay](input._internal_.SVGAElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGAElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGAElement.md#onchange)
- [onclick](input._internal_.SVGAElement.md#onclick)
- [onclose](input._internal_.SVGAElement.md#onclose)
- [oncontextmenu](input._internal_.SVGAElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGAElement.md#oncopy)
- [oncuechange](input._internal_.SVGAElement.md#oncuechange)
- [oncut](input._internal_.SVGAElement.md#oncut)
- [ondblclick](input._internal_.SVGAElement.md#ondblclick)
- [ondrag](input._internal_.SVGAElement.md#ondrag)
- [ondragend](input._internal_.SVGAElement.md#ondragend)
- [ondragenter](input._internal_.SVGAElement.md#ondragenter)
- [ondragleave](input._internal_.SVGAElement.md#ondragleave)
- [ondragover](input._internal_.SVGAElement.md#ondragover)
- [ondragstart](input._internal_.SVGAElement.md#ondragstart)
- [ondrop](input._internal_.SVGAElement.md#ondrop)
- [ondurationchange](input._internal_.SVGAElement.md#ondurationchange)
- [onemptied](input._internal_.SVGAElement.md#onemptied)
- [onended](input._internal_.SVGAElement.md#onended)
- [onerror](input._internal_.SVGAElement.md#onerror)
- [onfocus](input._internal_.SVGAElement.md#onfocus)
- [onformdata](input._internal_.SVGAElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGAElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGAElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGAElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGAElement.md#oninput)
- [oninvalid](input._internal_.SVGAElement.md#oninvalid)
- [onkeydown](input._internal_.SVGAElement.md#onkeydown)
- [onkeypress](input._internal_.SVGAElement.md#onkeypress)
- [onkeyup](input._internal_.SVGAElement.md#onkeyup)
- [onload](input._internal_.SVGAElement.md#onload)
- [onloadeddata](input._internal_.SVGAElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGAElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGAElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGAElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGAElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGAElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGAElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGAElement.md#onmousemove)
- [onmouseout](input._internal_.SVGAElement.md#onmouseout)
- [onmouseover](input._internal_.SVGAElement.md#onmouseover)
- [onmouseup](input._internal_.SVGAElement.md#onmouseup)
- [onpaste](input._internal_.SVGAElement.md#onpaste)
- [onpause](input._internal_.SVGAElement.md#onpause)
- [onplay](input._internal_.SVGAElement.md#onplay)
- [onplaying](input._internal_.SVGAElement.md#onplaying)
- [onpointercancel](input._internal_.SVGAElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGAElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGAElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGAElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGAElement.md#onpointermove)
- [onpointerout](input._internal_.SVGAElement.md#onpointerout)
- [onpointerover](input._internal_.SVGAElement.md#onpointerover)
- [onpointerup](input._internal_.SVGAElement.md#onpointerup)
- [onprogress](input._internal_.SVGAElement.md#onprogress)
- [onratechange](input._internal_.SVGAElement.md#onratechange)
- [onreset](input._internal_.SVGAElement.md#onreset)
- [onresize](input._internal_.SVGAElement.md#onresize)
- [onscroll](input._internal_.SVGAElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGAElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGAElement.md#onseeked)
- [onseeking](input._internal_.SVGAElement.md#onseeking)
- [onselect](input._internal_.SVGAElement.md#onselect)
- [onselectionchange](input._internal_.SVGAElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGAElement.md#onselectstart)
- [onslotchange](input._internal_.SVGAElement.md#onslotchange)
- [onstalled](input._internal_.SVGAElement.md#onstalled)
- [onsubmit](input._internal_.SVGAElement.md#onsubmit)
- [onsuspend](input._internal_.SVGAElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGAElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGAElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGAElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGAElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGAElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGAElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGAElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGAElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGAElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGAElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGAElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGAElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGAElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGAElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGAElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGAElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGAElement.md#onwheel)
- [outerHTML](input._internal_.SVGAElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGAElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGAElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGAElement.md#parentelement)
- [parentNode](input._internal_.SVGAElement.md#parentnode)
- [part](input._internal_.SVGAElement.md#part)
- [prefix](input._internal_.SVGAElement.md#prefix)
- [previousElementSibling](input._internal_.SVGAElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGAElement.md#previoussibling)
- [rel](input._internal_.SVGAElement.md#rel)
- [relList](input._internal_.SVGAElement.md#rellist)
- [requiredExtensions](input._internal_.SVGAElement.md#requiredextensions)
- [scrollHeight](input._internal_.SVGAElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGAElement.md#scrollleft)
- [scrollTop](input._internal_.SVGAElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGAElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGAElement.md#shadowroot)
- [slot](input._internal_.SVGAElement.md#slot)
- [style](input._internal_.SVGAElement.md#style)
- [systemLanguage](input._internal_.SVGAElement.md#systemlanguage)
- [tabIndex](input._internal_.SVGAElement.md#tabindex)
- [tagName](input._internal_.SVGAElement.md#tagname)
- [target](input._internal_.SVGAElement.md#target)
- [textContent](input._internal_.SVGAElement.md#textcontent)
- [transform](input._internal_.SVGAElement.md#transform)
- [viewportElement](input._internal_.SVGAElement.md#viewportelement)

### Methods

- [addEventListener](input._internal_.SVGAElement.md#addeventlistener)
- [after](input._internal_.SVGAElement.md#after)
- [animate](input._internal_.SVGAElement.md#animate)
- [append](input._internal_.SVGAElement.md#append)
- [appendChild](input._internal_.SVGAElement.md#appendchild)
- [attachShadow](input._internal_.SVGAElement.md#attachshadow)
- [before](input._internal_.SVGAElement.md#before)
- [blur](input._internal_.SVGAElement.md#blur)
- [cloneNode](input._internal_.SVGAElement.md#clonenode)
- [closest](input._internal_.SVGAElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGAElement.md#comparedocumentposition)
- [contains](input._internal_.SVGAElement.md#contains)
- [dispatchEvent](input._internal_.SVGAElement.md#dispatchevent)
- [focus](input._internal_.SVGAElement.md#focus)
- [getAnimations](input._internal_.SVGAElement.md#getanimations)
- [getAttribute](input._internal_.SVGAElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGAElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGAElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGAElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGAElement.md#getattributenodens)
- [getBBox](input._internal_.SVGAElement.md#getbbox)
- [getBoundingClientRect](input._internal_.SVGAElement.md#getboundingclientrect)
- [getCTM](input._internal_.SVGAElement.md#getctm)
- [getClientRects](input._internal_.SVGAElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGAElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGAElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGAElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGAElement.md#getrootnode)
- [getScreenCTM](input._internal_.SVGAElement.md#getscreenctm)
- [hasAttribute](input._internal_.SVGAElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGAElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGAElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGAElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGAElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGAElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGAElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGAElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGAElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGAElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGAElement.md#isequalnode)
- [isSameNode](input._internal_.SVGAElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGAElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGAElement.md#lookupprefix)
- [matches](input._internal_.SVGAElement.md#matches)
- [normalize](input._internal_.SVGAElement.md#normalize)
- [prepend](input._internal_.SVGAElement.md#prepend)
- [querySelector](input._internal_.SVGAElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGAElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGAElement.md#releasepointercapture)
- [remove](input._internal_.SVGAElement.md#remove)
- [removeAttribute](input._internal_.SVGAElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGAElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGAElement.md#removeattributenode)
- [removeChild](input._internal_.SVGAElement.md#removechild)
- [removeEventListener](input._internal_.SVGAElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGAElement.md#replacechild)
- [replaceChildren](input._internal_.SVGAElement.md#replacechildren)
- [replaceWith](input._internal_.SVGAElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGAElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGAElement.md#requestpointerlock)
- [scroll](input._internal_.SVGAElement.md#scroll)
- [scrollBy](input._internal_.SVGAElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGAElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGAElement.md#scrollto)
- [setAttribute](input._internal_.SVGAElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGAElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGAElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGAElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGAElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGAElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGAElement.md#webkitmatchesselector)
...
• `Readonly` **target**: [`SVGAnimatedString`](../modules/input._internal_.md#svganimatedstring)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGAElement`](../modules/input._internal_.md#svgaelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
