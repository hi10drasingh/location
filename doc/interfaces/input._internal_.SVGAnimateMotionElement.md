[Droom Google Location Plugin - v1.0.15](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGAnimateMotionElement

# Interface: SVGAnimateMotionElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGAnimateMotionElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGAnimateMotionElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGAnimateMotionElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGAnimateMotionElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGAnimateMotionElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGAnimateMotionElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGAnimateMotionElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGAnimateMotionElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGAnimateMotionElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGAnimateMotionElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGAnimateMotionElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGAnimateMotionElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGAnimateMotionElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGAnimateMotionElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGAnimateMotionElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGAnimateMotionElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGAnimateMotionElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGAnimateMotionElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGAnimateMotionElement.md#text_node)
- [ariaAtomic](input._internal_.SVGAnimateMotionElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGAnimateMotionElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGAnimateMotionElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGAnimateMotionElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGAnimateMotionElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGAnimateMotionElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGAnimateMotionElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGAnimateMotionElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGAnimateMotionElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGAnimateMotionElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGAnimateMotionElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGAnimateMotionElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGAnimateMotionElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGAnimateMotionElement.md#arialabel)
- [ariaLevel](input._internal_.SVGAnimateMotionElement.md#arialevel)
- [ariaLive](input._internal_.SVGAnimateMotionElement.md#arialive)
- [ariaModal](input._internal_.SVGAnimateMotionElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGAnimateMotionElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGAnimateMotionElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGAnimateMotionElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGAnimateMotionElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGAnimateMotionElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGAnimateMotionElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGAnimateMotionElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGAnimateMotionElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGAnimateMotionElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGAnimateMotionElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGAnimateMotionElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGAnimateMotionElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGAnimateMotionElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGAnimateMotionElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGAnimateMotionElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGAnimateMotionElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGAnimateMotionElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGAnimateMotionElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGAnimateMotionElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGAnimateMotionElement.md#assignedslot)
- [attributes](input._internal_.SVGAnimateMotionElement.md#attributes)
- [autofocus](input._internal_.SVGAnimateMotionElement.md#autofocus)
- [baseURI](input._internal_.SVGAnimateMotionElement.md#baseuri)
- [childElementCount](input._internal_.SVGAnimateMotionElement.md#childelementcount)
- [childNodes](input._internal_.SVGAnimateMotionElement.md#childnodes)
- [children](input._internal_.SVGAnimateMotionElement.md#children)
- [classList](input._internal_.SVGAnimateMotionElement.md#classlist)
- [className](input._internal_.SVGAnimateMotionElement.md#classname)
- [clientHeight](input._internal_.SVGAnimateMotionElement.md#clientheight)
- [clientLeft](input._internal_.SVGAnimateMotionElement.md#clientleft)
- [clientTop](input._internal_.SVGAnimateMotionElement.md#clienttop)
- [clientWidth](input._internal_.SVGAnimateMotionElement.md#clientwidth)
- [dataset](input._internal_.SVGAnimateMotionElement.md#dataset)
- [firstChild](input._internal_.SVGAnimateMotionElement.md#firstchild)
- [firstElementChild](input._internal_.SVGAnimateMotionElement.md#firstelementchild)
- [id](input._internal_.SVGAnimateMotionElement.md#id)
- [innerHTML](input._internal_.SVGAnimateMotionElement.md#innerhtml)
- [isConnected](input._internal_.SVGAnimateMotionElement.md#isconnected)
- [lastChild](input._internal_.SVGAnimateMotionElement.md#lastchild)
- [lastElementChild](input._internal_.SVGAnimateMotionElement.md#lastelementchild)
- [localName](input._internal_.SVGAnimateMotionElement.md#localname)
- [namespaceURI](input._internal_.SVGAnimateMotionElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGAnimateMotionElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGAnimateMotionElement.md#nextsibling)
- [nodeName](input._internal_.SVGAnimateMotionElement.md#nodename)
- [nodeType](input._internal_.SVGAnimateMotionElement.md#nodetype)
- [nodeValue](input._internal_.SVGAnimateMotionElement.md#nodevalue)
- [nonce](input._internal_.SVGAnimateMotionElement.md#nonce)
- [onabort](input._internal_.SVGAnimateMotionElement.md#onabort)
- [onanimationcancel](input._internal_.SVGAnimateMotionElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGAnimateMotionElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGAnimateMotionElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGAnimateMotionElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGAnimateMotionElement.md#onauxclick)
- [onblur](input._internal_.SVGAnimateMotionElement.md#onblur)
- [oncanplay](input._internal_.SVGAnimateMotionElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGAnimateMotionElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGAnimateMotionElement.md#onchange)
- [onclick](input._internal_.SVGAnimateMotionElement.md#onclick)
- [onclose](input._internal_.SVGAnimateMotionElement.md#onclose)
- [oncontextmenu](input._internal_.SVGAnimateMotionElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGAnimateMotionElement.md#oncopy)
- [oncuechange](input._internal_.SVGAnimateMotionElement.md#oncuechange)
- [oncut](input._internal_.SVGAnimateMotionElement.md#oncut)
- [ondblclick](input._internal_.SVGAnimateMotionElement.md#ondblclick)
- [ondrag](input._internal_.SVGAnimateMotionElement.md#ondrag)
- [ondragend](input._internal_.SVGAnimateMotionElement.md#ondragend)
- [ondragenter](input._internal_.SVGAnimateMotionElement.md#ondragenter)
- [ondragleave](input._internal_.SVGAnimateMotionElement.md#ondragleave)
- [ondragover](input._internal_.SVGAnimateMotionElement.md#ondragover)
- [ondragstart](input._internal_.SVGAnimateMotionElement.md#ondragstart)
- [ondrop](input._internal_.SVGAnimateMotionElement.md#ondrop)
- [ondurationchange](input._internal_.SVGAnimateMotionElement.md#ondurationchange)
- [onemptied](input._internal_.SVGAnimateMotionElement.md#onemptied)
- [onended](input._internal_.SVGAnimateMotionElement.md#onended)
- [onerror](input._internal_.SVGAnimateMotionElement.md#onerror)
- [onfocus](input._internal_.SVGAnimateMotionElement.md#onfocus)
- [onformdata](input._internal_.SVGAnimateMotionElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGAnimateMotionElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGAnimateMotionElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGAnimateMotionElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGAnimateMotionElement.md#oninput)
- [oninvalid](input._internal_.SVGAnimateMotionElement.md#oninvalid)
- [onkeydown](input._internal_.SVGAnimateMotionElement.md#onkeydown)
- [onkeypress](input._internal_.SVGAnimateMotionElement.md#onkeypress)
- [onkeyup](input._internal_.SVGAnimateMotionElement.md#onkeyup)
- [onload](input._internal_.SVGAnimateMotionElement.md#onload)
- [onloadeddata](input._internal_.SVGAnimateMotionElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGAnimateMotionElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGAnimateMotionElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGAnimateMotionElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGAnimateMotionElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGAnimateMotionElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGAnimateMotionElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGAnimateMotionElement.md#onmousemove)
- [onmouseout](input._internal_.SVGAnimateMotionElement.md#onmouseout)
- [onmouseover](input._internal_.SVGAnimateMotionElement.md#onmouseover)
- [onmouseup](input._internal_.SVGAnimateMotionElement.md#onmouseup)
- [onpaste](input._internal_.SVGAnimateMotionElement.md#onpaste)
- [onpause](input._internal_.SVGAnimateMotionElement.md#onpause)
- [onplay](input._internal_.SVGAnimateMotionElement.md#onplay)
- [onplaying](input._internal_.SVGAnimateMotionElement.md#onplaying)
- [onpointercancel](input._internal_.SVGAnimateMotionElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGAnimateMotionElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGAnimateMotionElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGAnimateMotionElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGAnimateMotionElement.md#onpointermove)
- [onpointerout](input._internal_.SVGAnimateMotionElement.md#onpointerout)
- [onpointerover](input._internal_.SVGAnimateMotionElement.md#onpointerover)
- [onpointerup](input._internal_.SVGAnimateMotionElement.md#onpointerup)
- [onprogress](input._internal_.SVGAnimateMotionElement.md#onprogress)
- [onratechange](input._internal_.SVGAnimateMotionElement.md#onratechange)
- [onreset](input._internal_.SVGAnimateMotionElement.md#onreset)
- [onresize](input._internal_.SVGAnimateMotionElement.md#onresize)
- [onscroll](input._internal_.SVGAnimateMotionElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGAnimateMotionElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGAnimateMotionElement.md#onseeked)
- [onseeking](input._internal_.SVGAnimateMotionElement.md#onseeking)
- [onselect](input._internal_.SVGAnimateMotionElement.md#onselect)
- [onselectionchange](input._internal_.SVGAnimateMotionElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGAnimateMotionElement.md#onselectstart)
- [onslotchange](input._internal_.SVGAnimateMotionElement.md#onslotchange)
- [onstalled](input._internal_.SVGAnimateMotionElement.md#onstalled)
- [onsubmit](input._internal_.SVGAnimateMotionElement.md#onsubmit)
- [onsuspend](input._internal_.SVGAnimateMotionElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGAnimateMotionElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGAnimateMotionElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGAnimateMotionElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGAnimateMotionElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGAnimateMotionElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGAnimateMotionElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGAnimateMotionElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGAnimateMotionElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGAnimateMotionElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGAnimateMotionElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGAnimateMotionElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGAnimateMotionElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGAnimateMotionElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGAnimateMotionElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGAnimateMotionElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGAnimateMotionElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGAnimateMotionElement.md#onwheel)
- [outerHTML](input._internal_.SVGAnimateMotionElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGAnimateMotionElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGAnimateMotionElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGAnimateMotionElement.md#parentelement)
- [parentNode](input._internal_.SVGAnimateMotionElement.md#parentnode)
- [part](input._internal_.SVGAnimateMotionElement.md#part)
- [prefix](input._internal_.SVGAnimateMotionElement.md#prefix)
- [previousElementSibling](input._internal_.SVGAnimateMotionElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGAnimateMotionElement.md#previoussibling)
- [requiredExtensions](input._internal_.SVGAnimateMotionElement.md#requiredextensions)
- [scrollHeight](input._internal_.SVGAnimateMotionElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGAnimateMotionElement.md#scrollleft)
- [scrollTop](input._internal_.SVGAnimateMotionElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGAnimateMotionElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGAnimateMotionElement.md#shadowroot)
- [slot](input._internal_.SVGAnimateMotionElement.md#slot)
- [style](input._internal_.SVGAnimateMotionElement.md#style)
- [systemLanguage](input._internal_.SVGAnimateMotionElement.md#systemlanguage)
- [tabIndex](input._internal_.SVGAnimateMotionElement.md#tabindex)
- [tagName](input._internal_.SVGAnimateMotionElement.md#tagname)
- [targetElement](input._internal_.SVGAnimateMotionElement.md#targetelement)
- [textContent](input._internal_.SVGAnimateMotionElement.md#textcontent)
- [viewportElement](input._internal_.SVGAnimateMotionElement.md#viewportelement)

### Methods

- [addEventListener](input._internal_.SVGAnimateMotionElement.md#addeventlistener)
- [after](input._internal_.SVGAnimateMotionElement.md#after)
- [animate](input._internal_.SVGAnimateMotionElement.md#animate)
- [append](input._internal_.SVGAnimateMotionElement.md#append)
- [appendChild](input._internal_.SVGAnimateMotionElement.md#appendchild)
- [attachShadow](input._internal_.SVGAnimateMotionElement.md#attachshadow)
- [before](input._internal_.SVGAnimateMotionElement.md#before)
- [beginElement](input._internal_.SVGAnimateMotionElement.md#beginelement)
- [beginElementAt](input._internal_.SVGAnimateMotionElement.md#beginelementat)
- [blur](input._internal_.SVGAnimateMotionElement.md#blur)
- [cloneNode](input._internal_.SVGAnimateMotionElement.md#clonenode)
- [closest](input._internal_.SVGAnimateMotionElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGAnimateMotionElement.md#comparedocumentposition)
- [contains](input._internal_.SVGAnimateMotionElement.md#contains)
- [dispatchEvent](input._internal_.SVGAnimateMotionElement.md#dispatchevent)
- [endElement](input._internal_.SVGAnimateMotionElement.md#endelement)
- [endElementAt](input._internal_.SVGAnimateMotionElement.md#endelementat)
- [focus](input._internal_.SVGAnimateMotionElement.md#focus)
- [getAnimations](input._internal_.SVGAnimateMotionElement.md#getanimations)
- [getAttribute](input._internal_.SVGAnimateMotionElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGAnimateMotionElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGAnimateMotionElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGAnimateMotionElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGAnimateMotionElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.SVGAnimateMotionElement.md#getboundingclientrect)
- [getClientRects](input._internal_.SVGAnimateMotionElement.md#getclientrects)
- [getCurrentTime](input._internal_.SVGAnimateMotionElement.md#getcurrenttime)
- [getElementsByClassName](input._internal_.SVGAnimateMotionElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGAnimateMotionElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGAnimateMotionElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGAnimateMotionElement.md#getrootnode)
- [getSimpleDuration](input._internal_.SVGAnimateMotionElement.md#getsimpleduration)
- [getStartTime](input._internal_.SVGAnimateMotionElement.md#getstarttime)
- [hasAttribute](input._internal_.SVGAnimateMotionElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGAnimateMotionElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGAnimateMotionElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGAnimateMotionElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGAnimateMotionElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGAnimateMotionElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGAnimateMotionElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGAnimateMotionElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGAnimateMotionElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGAnimateMotionElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGAnimateMotionElement.md#isequalnode)
- [isSameNode](input._internal_.SVGAnimateMotionElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGAnimateMotionElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGAnimateMotionElement.md#lookupprefix)
- [matches](input._internal_.SVGAnimateMotionElement.md#matches)
- [normalize](input._internal_.SVGAnimateMotionElement.md#normalize)
- [prepend](input._internal_.SVGAnimateMotionElement.md#prepend)
- [querySelector](input._internal_.SVGAnimateMotionElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGAnimateMotionElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGAnimateMotionElement.md#releasepointercapture)
- [remove](input._internal_.SVGAnimateMotionElement.md#remove)
- [removeAttribute](input._internal_.SVGAnimateMotionElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGAnimateMotionElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGAnimateMotionElement.md#removeattributenode)
- [removeChild](input._internal_.SVGAnimateMotionElement.md#removechild)
- [removeEventListener](input._internal_.SVGAnimateMotionElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGAnimateMotionElement.md#replacechild)
- [replaceChildren](input._internal_.SVGAnimateMotionElement.md#replacechildren)
- [replaceWith](input._internal_.SVGAnimateMotionElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGAnimateMotionElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGAnimateMotionElement.md#requestpointerlock)
- [scroll](input._internal_.SVGAnimateMotionElement.md#scroll)
- [scrollBy](input._internal_.SVGAnimateMotionElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGAnimateMotionElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGAnimateMotionElement.md#scrollto)
- [setAttribute](input._internal_.SVGAnimateMotionElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGAnimateMotionElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGAnimateMotionElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGAnimateMotionElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGAnimateMotionElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGAnimateMotionElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGAnimateMotionElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGAnimateMotionElement`](../modules/input._internal_.md#svganimatemotionelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
