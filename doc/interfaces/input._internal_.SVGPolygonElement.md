[Droom Google Location Plugin - v1.0.11](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGPolygonElement

# Interface: SVGPolygonElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGPolygonElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGPolygonElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGPolygonElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGPolygonElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGPolygonElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGPolygonElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGPolygonElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGPolygonElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGPolygonElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGPolygonElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGPolygonElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGPolygonElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGPolygonElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGPolygonElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGPolygonElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGPolygonElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGPolygonElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGPolygonElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGPolygonElement.md#text_node)
- [animatedPoints](input._internal_.SVGPolygonElement.md#animatedpoints)
- [ariaAtomic](input._internal_.SVGPolygonElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGPolygonElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGPolygonElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGPolygonElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGPolygonElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGPolygonElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGPolygonElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGPolygonElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGPolygonElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGPolygonElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGPolygonElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGPolygonElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGPolygonElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGPolygonElement.md#arialabel)
- [ariaLevel](input._internal_.SVGPolygonElement.md#arialevel)
- [ariaLive](input._internal_.SVGPolygonElement.md#arialive)
- [ariaModal](input._internal_.SVGPolygonElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGPolygonElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGPolygonElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGPolygonElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGPolygonElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGPolygonElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGPolygonElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGPolygonElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGPolygonElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGPolygonElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGPolygonElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGPolygonElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGPolygonElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGPolygonElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGPolygonElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGPolygonElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGPolygonElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGPolygonElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGPolygonElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGPolygonElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGPolygonElement.md#assignedslot)
- [attributes](input._internal_.SVGPolygonElement.md#attributes)
- [autofocus](input._internal_.SVGPolygonElement.md#autofocus)
- [baseURI](input._internal_.SVGPolygonElement.md#baseuri)
- [childElementCount](input._internal_.SVGPolygonElement.md#childelementcount)
- [childNodes](input._internal_.SVGPolygonElement.md#childnodes)
- [children](input._internal_.SVGPolygonElement.md#children)
- [classList](input._internal_.SVGPolygonElement.md#classlist)
- [className](input._internal_.SVGPolygonElement.md#classname)
- [clientHeight](input._internal_.SVGPolygonElement.md#clientheight)
- [clientLeft](input._internal_.SVGPolygonElement.md#clientleft)
- [clientTop](input._internal_.SVGPolygonElement.md#clienttop)
- [clientWidth](input._internal_.SVGPolygonElement.md#clientwidth)
- [dataset](input._internal_.SVGPolygonElement.md#dataset)
- [firstChild](input._internal_.SVGPolygonElement.md#firstchild)
- [firstElementChild](input._internal_.SVGPolygonElement.md#firstelementchild)
- [id](input._internal_.SVGPolygonElement.md#id)
- [innerHTML](input._internal_.SVGPolygonElement.md#innerhtml)
- [isConnected](input._internal_.SVGPolygonElement.md#isconnected)
- [lastChild](input._internal_.SVGPolygonElement.md#lastchild)
- [lastElementChild](input._internal_.SVGPolygonElement.md#lastelementchild)
- [localName](input._internal_.SVGPolygonElement.md#localname)
- [namespaceURI](input._internal_.SVGPolygonElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGPolygonElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGPolygonElement.md#nextsibling)
- [nodeName](input._internal_.SVGPolygonElement.md#nodename)
- [nodeType](input._internal_.SVGPolygonElement.md#nodetype)
- [nodeValue](input._internal_.SVGPolygonElement.md#nodevalue)
- [nonce](input._internal_.SVGPolygonElement.md#nonce)
- [onabort](input._internal_.SVGPolygonElement.md#onabort)
- [onanimationcancel](input._internal_.SVGPolygonElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGPolygonElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGPolygonElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGPolygonElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGPolygonElement.md#onauxclick)
- [onblur](input._internal_.SVGPolygonElement.md#onblur)
- [oncanplay](input._internal_.SVGPolygonElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGPolygonElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGPolygonElement.md#onchange)
- [onclick](input._internal_.SVGPolygonElement.md#onclick)
- [onclose](input._internal_.SVGPolygonElement.md#onclose)
- [oncontextmenu](input._internal_.SVGPolygonElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGPolygonElement.md#oncopy)
- [oncuechange](input._internal_.SVGPolygonElement.md#oncuechange)
- [oncut](input._internal_.SVGPolygonElement.md#oncut)
- [ondblclick](input._internal_.SVGPolygonElement.md#ondblclick)
- [ondrag](input._internal_.SVGPolygonElement.md#ondrag)
- [ondragend](input._internal_.SVGPolygonElement.md#ondragend)
- [ondragenter](input._internal_.SVGPolygonElement.md#ondragenter)
- [ondragleave](input._internal_.SVGPolygonElement.md#ondragleave)
- [ondragover](input._internal_.SVGPolygonElement.md#ondragover)
- [ondragstart](input._internal_.SVGPolygonElement.md#ondragstart)
- [ondrop](input._internal_.SVGPolygonElement.md#ondrop)
- [ondurationchange](input._internal_.SVGPolygonElement.md#ondurationchange)
- [onemptied](input._internal_.SVGPolygonElement.md#onemptied)
- [onended](input._internal_.SVGPolygonElement.md#onended)
- [onerror](input._internal_.SVGPolygonElement.md#onerror)
- [onfocus](input._internal_.SVGPolygonElement.md#onfocus)
- [onformdata](input._internal_.SVGPolygonElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGPolygonElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGPolygonElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGPolygonElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGPolygonElement.md#oninput)
- [oninvalid](input._internal_.SVGPolygonElement.md#oninvalid)
- [onkeydown](input._internal_.SVGPolygonElement.md#onkeydown)
- [onkeypress](input._internal_.SVGPolygonElement.md#onkeypress)
- [onkeyup](input._internal_.SVGPolygonElement.md#onkeyup)
- [onload](input._internal_.SVGPolygonElement.md#onload)
- [onloadeddata](input._internal_.SVGPolygonElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGPolygonElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGPolygonElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGPolygonElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGPolygonElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGPolygonElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGPolygonElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGPolygonElement.md#onmousemove)
- [onmouseout](input._internal_.SVGPolygonElement.md#onmouseout)
- [onmouseover](input._internal_.SVGPolygonElement.md#onmouseover)
- [onmouseup](input._internal_.SVGPolygonElement.md#onmouseup)
- [onpaste](input._internal_.SVGPolygonElement.md#onpaste)
- [onpause](input._internal_.SVGPolygonElement.md#onpause)
- [onplay](input._internal_.SVGPolygonElement.md#onplay)
- [onplaying](input._internal_.SVGPolygonElement.md#onplaying)
- [onpointercancel](input._internal_.SVGPolygonElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGPolygonElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGPolygonElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGPolygonElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGPolygonElement.md#onpointermove)
- [onpointerout](input._internal_.SVGPolygonElement.md#onpointerout)
- [onpointerover](input._internal_.SVGPolygonElement.md#onpointerover)
- [onpointerup](input._internal_.SVGPolygonElement.md#onpointerup)
- [onprogress](input._internal_.SVGPolygonElement.md#onprogress)
- [onratechange](input._internal_.SVGPolygonElement.md#onratechange)
- [onreset](input._internal_.SVGPolygonElement.md#onreset)
- [onresize](input._internal_.SVGPolygonElement.md#onresize)
- [onscroll](input._internal_.SVGPolygonElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGPolygonElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGPolygonElement.md#onseeked)
- [onseeking](input._internal_.SVGPolygonElement.md#onseeking)
- [onselect](input._internal_.SVGPolygonElement.md#onselect)
- [onselectionchange](input._internal_.SVGPolygonElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGPolygonElement.md#onselectstart)
- [onslotchange](input._internal_.SVGPolygonElement.md#onslotchange)
- [onstalled](input._internal_.SVGPolygonElement.md#onstalled)
- [onsubmit](input._internal_.SVGPolygonElement.md#onsubmit)
- [onsuspend](input._internal_.SVGPolygonElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGPolygonElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGPolygonElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGPolygonElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGPolygonElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGPolygonElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGPolygonElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGPolygonElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGPolygonElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGPolygonElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGPolygonElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGPolygonElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGPolygonElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGPolygonElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGPolygonElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGPolygonElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGPolygonElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGPolygonElement.md#onwheel)
- [outerHTML](input._internal_.SVGPolygonElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGPolygonElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGPolygonElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGPolygonElement.md#parentelement)
- [parentNode](input._internal_.SVGPolygonElement.md#parentnode)
- [part](input._internal_.SVGPolygonElement.md#part)
- [pathLength](input._internal_.SVGPolygonElement.md#pathlength)
- [points](input._internal_.SVGPolygonElement.md#points)
- [prefix](input._internal_.SVGPolygonElement.md#prefix)
- [previousElementSibling](input._internal_.SVGPolygonElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGPolygonElement.md#previoussibling)
- [requiredExtensions](input._internal_.SVGPolygonElement.md#requiredextensions)
- [scrollHeight](input._internal_.SVGPolygonElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGPolygonElement.md#scrollleft)
- [scrollTop](input._internal_.SVGPolygonElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGPolygonElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGPolygonElement.md#shadowroot)
- [slot](input._internal_.SVGPolygonElement.md#slot)
- [style](input._internal_.SVGPolygonElement.md#style)
- [systemLanguage](input._internal_.SVGPolygonElement.md#systemlanguage)
- [tabIndex](input._internal_.SVGPolygonElement.md#tabindex)
- [tagName](input._internal_.SVGPolygonElement.md#tagname)
- [textContent](input._internal_.SVGPolygonElement.md#textcontent)
- [transform](input._internal_.SVGPolygonElement.md#transform)
- [viewportElement](input._internal_.SVGPolygonElement.md#viewportelement)

### Methods

- [addEventListener](input._internal_.SVGPolygonElement.md#addeventlistener)
- [after](input._internal_.SVGPolygonElement.md#after)
- [animate](input._internal_.SVGPolygonElement.md#animate)
- [append](input._internal_.SVGPolygonElement.md#append)
- [appendChild](input._internal_.SVGPolygonElement.md#appendchild)
- [attachShadow](input._internal_.SVGPolygonElement.md#attachshadow)
- [before](input._internal_.SVGPolygonElement.md#before)
- [blur](input._internal_.SVGPolygonElement.md#blur)
- [cloneNode](input._internal_.SVGPolygonElement.md#clonenode)
- [closest](input._internal_.SVGPolygonElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGPolygonElement.md#comparedocumentposition)
- [contains](input._internal_.SVGPolygonElement.md#contains)
- [dispatchEvent](input._internal_.SVGPolygonElement.md#dispatchevent)
- [focus](input._internal_.SVGPolygonElement.md#focus)
- [getAnimations](input._internal_.SVGPolygonElement.md#getanimations)
- [getAttribute](input._internal_.SVGPolygonElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGPolygonElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGPolygonElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGPolygonElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGPolygonElement.md#getattributenodens)
- [getBBox](input._internal_.SVGPolygonElement.md#getbbox)
- [getBoundingClientRect](input._internal_.SVGPolygonElement.md#getboundingclientrect)
- [getCTM](input._internal_.SVGPolygonElement.md#getctm)
- [getClientRects](input._internal_.SVGPolygonElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGPolygonElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGPolygonElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGPolygonElement.md#getelementsbytagnamens)
- [getPointAtLength](input._internal_.SVGPolygonElement.md#getpointatlength)
- [getRootNode](input._internal_.SVGPolygonElement.md#getrootnode)
- [getScreenCTM](input._internal_.SVGPolygonElement.md#getscreenctm)
- [getTotalLength](input._internal_.SVGPolygonElement.md#gettotallength)
- [hasAttribute](input._internal_.SVGPolygonElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGPolygonElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGPolygonElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGPolygonElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGPolygonElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGPolygonElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGPolygonElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGPolygonElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGPolygonElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGPolygonElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGPolygonElement.md#isequalnode)
- [isPointInFill](input._internal_.SVGPolygonElement.md#ispointinfill)
- [isPointInStroke](input._internal_.SVGPolygonElement.md#ispointinstroke)
- [isSameNode](input._internal_.SVGPolygonElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGPolygonElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGPolygonElement.md#lookupprefix)
- [matches](input._internal_.SVGPolygonElement.md#matches)
- [normalize](input._internal_.SVGPolygonElement.md#normalize)
- [prepend](input._internal_.SVGPolygonElement.md#prepend)
- [querySelector](input._internal_.SVGPolygonElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGPolygonElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGPolygonElement.md#releasepointercapture)
- [remove](input._internal_.SVGPolygonElement.md#remove)
- [removeAttribute](input._internal_.SVGPolygonElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGPolygonElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGPolygonElement.md#removeattributenode)
- [removeChild](input._internal_.SVGPolygonElement.md#removechild)
- [removeEventListener](input._internal_.SVGPolygonElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGPolygonElement.md#replacechild)
- [replaceChildren](input._internal_.SVGPolygonElement.md#replacechildren)
- [replaceWith](input._internal_.SVGPolygonElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGPolygonElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGPolygonElement.md#requestpointerlock)
- [scroll](input._internal_.SVGPolygonElement.md#scroll)
- [scrollBy](input._internal_.SVGPolygonElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGPolygonElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGPolygonElement.md#scrollto)
- [setAttribute](input._internal_.SVGPolygonElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGPolygonElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGPolygonElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGPolygonElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGPolygonElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGPolygonElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGPolygonElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGPolygonElement`](../modules/input._internal_.md#svgpolygonelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
