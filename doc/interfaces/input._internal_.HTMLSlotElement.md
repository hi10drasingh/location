[Droom Google Location Plugin - v1.0.16](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLSlotElement

# Interface: HTMLSlotElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLSlotElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLSlotElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLSlotElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLSlotElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLSlotElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLSlotElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLSlotElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLSlotElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLSlotElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLSlotElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLSlotElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLSlotElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLSlotElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLSlotElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLSlotElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLSlotElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLSlotElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLSlotElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLSlotElement.md#text_node)
- [accessKey](input._internal_.HTMLSlotElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLSlotElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLSlotElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLSlotElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLSlotElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLSlotElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLSlotElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLSlotElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLSlotElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLSlotElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLSlotElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLSlotElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLSlotElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLSlotElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLSlotElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLSlotElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLSlotElement.md#arialevel)
- [ariaLive](input._internal_.HTMLSlotElement.md#arialive)
- [ariaModal](input._internal_.HTMLSlotElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLSlotElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLSlotElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLSlotElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLSlotElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLSlotElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLSlotElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLSlotElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLSlotElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLSlotElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLSlotElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLSlotElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLSlotElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLSlotElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLSlotElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLSlotElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLSlotElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLSlotElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLSlotElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLSlotElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLSlotElement.md#assignedslot)
- [attributes](input._internal_.HTMLSlotElement.md#attributes)
- [autocapitalize](input._internal_.HTMLSlotElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLSlotElement.md#autofocus)
- [baseURI](input._internal_.HTMLSlotElement.md#baseuri)
- [childElementCount](input._internal_.HTMLSlotElement.md#childelementcount)
- [childNodes](input._internal_.HTMLSlotElement.md#childnodes)
- [children](input._internal_.HTMLSlotElement.md#children)
- [classList](input._internal_.HTMLSlotElement.md#classlist)
- [className](input._internal_.HTMLSlotElement.md#classname)
- [clientHeight](input._internal_.HTMLSlotElement.md#clientheight)
- [clientLeft](input._internal_.HTMLSlotElement.md#clientleft)
- [clientTop](input._internal_.HTMLSlotElement.md#clienttop)
- [clientWidth](input._internal_.HTMLSlotElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLSlotElement.md#contenteditable)
- [dataset](input._internal_.HTMLSlotElement.md#dataset)
- [dir](input._internal_.HTMLSlotElement.md#dir)
- [draggable](input._internal_.HTMLSlotElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLSlotElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLSlotElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLSlotElement.md#firstelementchild)
- [hidden](input._internal_.HTMLSlotElement.md#hidden)
- [id](input._internal_.HTMLSlotElement.md#id)
- [innerHTML](input._internal_.HTMLSlotElement.md#innerhtml)
- [innerText](input._internal_.HTMLSlotElement.md#innertext)
- [inputMode](input._internal_.HTMLSlotElement.md#inputmode)
- [isConnected](input._internal_.HTMLSlotElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLSlotElement.md#iscontenteditable)
- [lang](input._internal_.HTMLSlotElement.md#lang)
- [lastChild](input._internal_.HTMLSlotElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLSlotElement.md#lastelementchild)
- [localName](input._internal_.HTMLSlotElement.md#localname)
- [name](input._internal_.HTMLSlotElement.md#name)
- [namespaceURI](input._internal_.HTMLSlotElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLSlotElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLSlotElement.md#nextsibling)
- [nodeName](input._internal_.HTMLSlotElement.md#nodename)
- [nodeType](input._internal_.HTMLSlotElement.md#nodetype)
- [nodeValue](input._internal_.HTMLSlotElement.md#nodevalue)
- [nonce](input._internal_.HTMLSlotElement.md#nonce)
- [offsetHeight](input._internal_.HTMLSlotElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLSlotElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLSlotElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLSlotElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLSlotElement.md#offsetwidth)
- [onabort](input._internal_.HTMLSlotElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLSlotElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLSlotElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLSlotElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLSlotElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLSlotElement.md#onauxclick)
- [onblur](input._internal_.HTMLSlotElement.md#onblur)
- [oncanplay](input._internal_.HTMLSlotElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLSlotElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLSlotElement.md#onchange)
- [onclick](input._internal_.HTMLSlotElement.md#onclick)
- [onclose](input._internal_.HTMLSlotElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLSlotElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLSlotElement.md#oncopy)
- [oncuechange](input._internal_.HTMLSlotElement.md#oncuechange)
- [oncut](input._internal_.HTMLSlotElement.md#oncut)
- [ondblclick](input._internal_.HTMLSlotElement.md#ondblclick)
- [ondrag](input._internal_.HTMLSlotElement.md#ondrag)
- [ondragend](input._internal_.HTMLSlotElement.md#ondragend)
- [ondragenter](input._internal_.HTMLSlotElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLSlotElement.md#ondragleave)
- [ondragover](input._internal_.HTMLSlotElement.md#ondragover)
- [ondragstart](input._internal_.HTMLSlotElement.md#ondragstart)
- [ondrop](input._internal_.HTMLSlotElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLSlotElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLSlotElement.md#onemptied)
- [onended](input._internal_.HTMLSlotElement.md#onended)
- [onerror](input._internal_.HTMLSlotElement.md#onerror)
- [onfocus](input._internal_.HTMLSlotElement.md#onfocus)
- [onformdata](input._internal_.HTMLSlotElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLSlotElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLSlotElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLSlotElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLSlotElement.md#oninput)
- [oninvalid](input._internal_.HTMLSlotElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLSlotElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLSlotElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLSlotElement.md#onkeyup)
- [onload](input._internal_.HTMLSlotElement.md#onload)
- [onloadeddata](input._internal_.HTMLSlotElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLSlotElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLSlotElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLSlotElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLSlotElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLSlotElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLSlotElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLSlotElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLSlotElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLSlotElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLSlotElement.md#onmouseup)
- [onpaste](input._internal_.HTMLSlotElement.md#onpaste)
- [onpause](input._internal_.HTMLSlotElement.md#onpause)
- [onplay](input._internal_.HTMLSlotElement.md#onplay)
- [onplaying](input._internal_.HTMLSlotElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLSlotElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLSlotElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLSlotElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLSlotElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLSlotElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLSlotElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLSlotElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLSlotElement.md#onpointerup)
- [onprogress](input._internal_.HTMLSlotElement.md#onprogress)
- [onratechange](input._internal_.HTMLSlotElement.md#onratechange)
- [onreset](input._internal_.HTMLSlotElement.md#onreset)
- [onresize](input._internal_.HTMLSlotElement.md#onresize)
- [onscroll](input._internal_.HTMLSlotElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLSlotElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLSlotElement.md#onseeked)
- [onseeking](input._internal_.HTMLSlotElement.md#onseeking)
- [onselect](input._internal_.HTMLSlotElement.md#onselect)
- [onselectionchange](input._internal_.HTMLSlotElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLSlotElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLSlotElement.md#onslotchange)
- [onstalled](input._internal_.HTMLSlotElement.md#onstalled)
- [onsubmit](input._internal_.HTMLSlotElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLSlotElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLSlotElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLSlotElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLSlotElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLSlotElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLSlotElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLSlotElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLSlotElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLSlotElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLSlotElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLSlotElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLSlotElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLSlotElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLSlotElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLSlotElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLSlotElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLSlotElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLSlotElement.md#onwheel)
- [outerHTML](input._internal_.HTMLSlotElement.md#outerhtml)
- [outerText](input._internal_.HTMLSlotElement.md#outertext)
- [ownerDocument](input._internal_.HTMLSlotElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLSlotElement.md#parentelement)
- [parentNode](input._internal_.HTMLSlotElement.md#parentnode)
- [part](input._internal_.HTMLSlotElement.md#part)
- [prefix](input._internal_.HTMLSlotElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLSlotElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLSlotElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLSlotElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLSlotElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLSlotElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLSlotElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLSlotElement.md#shadowroot)
- [slot](input._internal_.HTMLSlotElement.md#slot)
- [spellcheck](input._internal_.HTMLSlotElement.md#spellcheck)
- [style](input._internal_.HTMLSlotElement.md#style)
- [tabIndex](input._internal_.HTMLSlotElement.md#tabindex)
- [tagName](input._internal_.HTMLSlotElement.md#tagname)
- [textContent](input._internal_.HTMLSlotElement.md#textcontent)
- [title](input._internal_.HTMLSlotElement.md#title)
- [translate](input._internal_.HTMLSlotElement.md#translate)

### Methods

- [addEventListener](input._internal_.HTMLSlotElement.md#addeventlistener)
- [after](input._internal_.HTMLSlotElement.md#after)
- [animate](input._internal_.HTMLSlotElement.md#animate)
- [append](input._internal_.HTMLSlotElement.md#append)
- [appendChild](input._internal_.HTMLSlotElement.md#appendchild)
- [assign](input._internal_.HTMLSlotElement.md#assign)
- [assignedElements](input._internal_.HTMLSlotElement.md#assignedelements)
- [assignedNodes](input._internal_.HTMLSlotElement.md#assignednodes)
- [attachInternals](input._internal_.HTMLSlotElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLSlotElement.md#attachshadow)
- [before](input._internal_.HTMLSlotElement.md#before)
- [blur](input._internal_.HTMLSlotElement.md#blur)
- [click](input._internal_.HTMLSlotElement.md#click)
- [cloneNode](input._internal_.HTMLSlotElement.md#clonenode)
- [closest](input._internal_.HTMLSlotElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLSlotElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLSlotElement.md#contains)
- [dispatchEvent](input._internal_.HTMLSlotElement.md#dispatchevent)
- [focus](input._internal_.HTMLSlotElement.md#focus)
- [getAnimations](input._internal_.HTMLSlotElement.md#getanimations)
- [getAttribute](input._internal_.HTMLSlotElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLSlotElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLSlotElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLSlotElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLSlotElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLSlotElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLSlotElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLSlotElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLSlotElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLSlotElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLSlotElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLSlotElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLSlotElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLSlotElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLSlotElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLSlotElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLSlotElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLSlotElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLSlotElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLSlotElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLSlotElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLSlotElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLSlotElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLSlotElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLSlotElement.md#lookupprefix)
- [matches](input._internal_.HTMLSlotElement.md#matches)
- [normalize](input._internal_.HTMLSlotElement.md#normalize)
- [prepend](input._internal_.HTMLSlotElement.md#prepend)
- [querySelector](input._internal_.HTMLSlotElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLSlotElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLSlotElement.md#releasepointercapture)
- [remove](input._internal_.HTMLSlotElement.md#remove)
- [removeAttribute](input._internal_.HTMLSlotElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLSlotElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLSlotElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLSlotElement.md#removechild)
- [removeEventListener](input._internal_.HTMLSlotElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLSlotElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLSlotElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLSlotElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLSlotElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLSlotElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLSlotElement.md#scroll)
- [scrollBy](input._internal_.HTMLSlotElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLSlotElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLSlotElement.md#scrollto)
- [setAttribute](input._internal_.HTMLSlotElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLSlotElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLSlotElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLSlotElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLSlotElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLSlotElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLSlotElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLSlotElement`](../modules/input._internal_.md#htmlslotelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
...
| Name | Type |
| :------ | :------ |
| `...nodes` | ([`Element`](../modules/input._internal_.md#element) \| [`Text`](../modules/input._internal_.md#text))[] |
...
▸ **assignedElements**(`options?`): [`Element`](../modules/input._internal_.md#element)[]

#### Parameters

| Name | Type |
| :------ | :------ |
| `options?` | [`AssignedNodesOptions`](input._internal_.AssignedNodesOptions.md) |
...
▸ **assignedNodes**(`options?`): [`Node`](../modules/input._internal_.md#node)[]
