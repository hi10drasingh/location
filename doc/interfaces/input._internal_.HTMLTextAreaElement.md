[Droom Google Location Plugin - v1.0.13](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLTextAreaElement

# Interface: HTMLTextAreaElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLTextAreaElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLTextAreaElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLTextAreaElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLTextAreaElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLTextAreaElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLTextAreaElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLTextAreaElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLTextAreaElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLTextAreaElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLTextAreaElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLTextAreaElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLTextAreaElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLTextAreaElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLTextAreaElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLTextAreaElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLTextAreaElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLTextAreaElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLTextAreaElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLTextAreaElement.md#text_node)
- [accessKey](input._internal_.HTMLTextAreaElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLTextAreaElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLTextAreaElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLTextAreaElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLTextAreaElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLTextAreaElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLTextAreaElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLTextAreaElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLTextAreaElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLTextAreaElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLTextAreaElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLTextAreaElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLTextAreaElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLTextAreaElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLTextAreaElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLTextAreaElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLTextAreaElement.md#arialevel)
- [ariaLive](input._internal_.HTMLTextAreaElement.md#arialive)
- [ariaModal](input._internal_.HTMLTextAreaElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLTextAreaElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLTextAreaElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLTextAreaElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLTextAreaElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLTextAreaElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLTextAreaElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLTextAreaElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLTextAreaElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLTextAreaElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLTextAreaElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLTextAreaElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLTextAreaElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLTextAreaElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLTextAreaElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLTextAreaElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLTextAreaElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLTextAreaElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLTextAreaElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLTextAreaElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLTextAreaElement.md#assignedslot)
- [attributes](input._internal_.HTMLTextAreaElement.md#attributes)
- [autocapitalize](input._internal_.HTMLTextAreaElement.md#autocapitalize)
- [autocomplete](input._internal_.HTMLTextAreaElement.md#autocomplete)
- [autofocus](input._internal_.HTMLTextAreaElement.md#autofocus)
- [baseURI](input._internal_.HTMLTextAreaElement.md#baseuri)
- [childElementCount](input._internal_.HTMLTextAreaElement.md#childelementcount)
- [childNodes](input._internal_.HTMLTextAreaElement.md#childnodes)
- [children](input._internal_.HTMLTextAreaElement.md#children)
- [classList](input._internal_.HTMLTextAreaElement.md#classlist)
- [className](input._internal_.HTMLTextAreaElement.md#classname)
- [clientHeight](input._internal_.HTMLTextAreaElement.md#clientheight)
- [clientLeft](input._internal_.HTMLTextAreaElement.md#clientleft)
- [clientTop](input._internal_.HTMLTextAreaElement.md#clienttop)
- [clientWidth](input._internal_.HTMLTextAreaElement.md#clientwidth)
- [cols](input._internal_.HTMLTextAreaElement.md#cols)
- [contentEditable](input._internal_.HTMLTextAreaElement.md#contenteditable)
- [dataset](input._internal_.HTMLTextAreaElement.md#dataset)
- [defaultValue](input._internal_.HTMLTextAreaElement.md#defaultvalue)
- [dir](input._internal_.HTMLTextAreaElement.md#dir)
- [dirName](input._internal_.HTMLTextAreaElement.md#dirname)
- [disabled](input._internal_.HTMLTextAreaElement.md#disabled)
- [draggable](input._internal_.HTMLTextAreaElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLTextAreaElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLTextAreaElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLTextAreaElement.md#firstelementchild)
- [form](input._internal_.HTMLTextAreaElement.md#form)
- [hidden](input._internal_.HTMLTextAreaElement.md#hidden)
- [id](input._internal_.HTMLTextAreaElement.md#id)
- [innerHTML](input._internal_.HTMLTextAreaElement.md#innerhtml)
- [innerText](input._internal_.HTMLTextAreaElement.md#innertext)
- [inputMode](input._internal_.HTMLTextAreaElement.md#inputmode)
- [isConnected](input._internal_.HTMLTextAreaElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLTextAreaElement.md#iscontenteditable)
- [labels](input._internal_.HTMLTextAreaElement.md#labels)
- [lang](input._internal_.HTMLTextAreaElement.md#lang)
- [lastChild](input._internal_.HTMLTextAreaElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLTextAreaElement.md#lastelementchild)
- [localName](input._internal_.HTMLTextAreaElement.md#localname)
- [maxLength](input._internal_.HTMLTextAreaElement.md#maxlength)
- [minLength](input._internal_.HTMLTextAreaElement.md#minlength)
- [name](input._internal_.HTMLTextAreaElement.md#name)
- [namespaceURI](input._internal_.HTMLTextAreaElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLTextAreaElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLTextAreaElement.md#nextsibling)
- [nodeName](input._internal_.HTMLTextAreaElement.md#nodename)
- [nodeType](input._internal_.HTMLTextAreaElement.md#nodetype)
- [nodeValue](input._internal_.HTMLTextAreaElement.md#nodevalue)
- [nonce](input._internal_.HTMLTextAreaElement.md#nonce)
- [offsetHeight](input._internal_.HTMLTextAreaElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLTextAreaElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLTextAreaElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLTextAreaElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLTextAreaElement.md#offsetwidth)
- [onabort](input._internal_.HTMLTextAreaElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLTextAreaElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLTextAreaElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLTextAreaElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLTextAreaElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLTextAreaElement.md#onauxclick)
- [onblur](input._internal_.HTMLTextAreaElement.md#onblur)
- [oncanplay](input._internal_.HTMLTextAreaElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLTextAreaElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLTextAreaElement.md#onchange)
- [onclick](input._internal_.HTMLTextAreaElement.md#onclick)
- [onclose](input._internal_.HTMLTextAreaElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLTextAreaElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLTextAreaElement.md#oncopy)
- [oncuechange](input._internal_.HTMLTextAreaElement.md#oncuechange)
- [oncut](input._internal_.HTMLTextAreaElement.md#oncut)
- [ondblclick](input._internal_.HTMLTextAreaElement.md#ondblclick)
- [ondrag](input._internal_.HTMLTextAreaElement.md#ondrag)
- [ondragend](input._internal_.HTMLTextAreaElement.md#ondragend)
- [ondragenter](input._internal_.HTMLTextAreaElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLTextAreaElement.md#ondragleave)
- [ondragover](input._internal_.HTMLTextAreaElement.md#ondragover)
- [ondragstart](input._internal_.HTMLTextAreaElement.md#ondragstart)
- [ondrop](input._internal_.HTMLTextAreaElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLTextAreaElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLTextAreaElement.md#onemptied)
- [onended](input._internal_.HTMLTextAreaElement.md#onended)
- [onerror](input._internal_.HTMLTextAreaElement.md#onerror)
- [onfocus](input._internal_.HTMLTextAreaElement.md#onfocus)
- [onformdata](input._internal_.HTMLTextAreaElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLTextAreaElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLTextAreaElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLTextAreaElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLTextAreaElement.md#oninput)
- [oninvalid](input._internal_.HTMLTextAreaElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLTextAreaElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLTextAreaElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLTextAreaElement.md#onkeyup)
- [onload](input._internal_.HTMLTextAreaElement.md#onload)
- [onloadeddata](input._internal_.HTMLTextAreaElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLTextAreaElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLTextAreaElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLTextAreaElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLTextAreaElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLTextAreaElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLTextAreaElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLTextAreaElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLTextAreaElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLTextAreaElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLTextAreaElement.md#onmouseup)
- [onpaste](input._internal_.HTMLTextAreaElement.md#onpaste)
- [onpause](input._internal_.HTMLTextAreaElement.md#onpause)
- [onplay](input._internal_.HTMLTextAreaElement.md#onplay)
- [onplaying](input._internal_.HTMLTextAreaElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLTextAreaElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLTextAreaElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLTextAreaElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLTextAreaElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLTextAreaElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLTextAreaElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLTextAreaElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLTextAreaElement.md#onpointerup)
- [onprogress](input._internal_.HTMLTextAreaElement.md#onprogress)
- [onratechange](input._internal_.HTMLTextAreaElement.md#onratechange)
- [onreset](input._internal_.HTMLTextAreaElement.md#onreset)
- [onresize](input._internal_.HTMLTextAreaElement.md#onresize)
- [onscroll](input._internal_.HTMLTextAreaElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLTextAreaElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLTextAreaElement.md#onseeked)
- [onseeking](input._internal_.HTMLTextAreaElement.md#onseeking)
- [onselect](input._internal_.HTMLTextAreaElement.md#onselect)
- [onselectionchange](input._internal_.HTMLTextAreaElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLTextAreaElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLTextAreaElement.md#onslotchange)
- [onstalled](input._internal_.HTMLTextAreaElement.md#onstalled)
- [onsubmit](input._internal_.HTMLTextAreaElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLTextAreaElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLTextAreaElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLTextAreaElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLTextAreaElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLTextAreaElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLTextAreaElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLTextAreaElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLTextAreaElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLTextAreaElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLTextAreaElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLTextAreaElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLTextAreaElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLTextAreaElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLTextAreaElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLTextAreaElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLTextAreaElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLTextAreaElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLTextAreaElement.md#onwheel)
- [outerHTML](input._internal_.HTMLTextAreaElement.md#outerhtml)
- [outerText](input._internal_.HTMLTextAreaElement.md#outertext)
- [ownerDocument](input._internal_.HTMLTextAreaElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLTextAreaElement.md#parentelement)
- [parentNode](input._internal_.HTMLTextAreaElement.md#parentnode)
- [part](input._internal_.HTMLTextAreaElement.md#part)
- [placeholder](input._internal_.HTMLTextAreaElement.md#placeholder)
- [prefix](input._internal_.HTMLTextAreaElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLTextAreaElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLTextAreaElement.md#previoussibling)
- [readOnly](input._internal_.HTMLTextAreaElement.md#readonly)
- [required](input._internal_.HTMLTextAreaElement.md#required)
- [rows](input._internal_.HTMLTextAreaElement.md#rows)
- [scrollHeight](input._internal_.HTMLTextAreaElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLTextAreaElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLTextAreaElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLTextAreaElement.md#scrollwidth)
- [selectionDirection](input._internal_.HTMLTextAreaElement.md#selectiondirection)
- [selectionEnd](input._internal_.HTMLTextAreaElement.md#selectionend)
- [selectionStart](input._internal_.HTMLTextAreaElement.md#selectionstart)
- [shadowRoot](input._internal_.HTMLTextAreaElement.md#shadowroot)
- [slot](input._internal_.HTMLTextAreaElement.md#slot)
- [spellcheck](input._internal_.HTMLTextAreaElement.md#spellcheck)
- [style](input._internal_.HTMLTextAreaElement.md#style)
- [tabIndex](input._internal_.HTMLTextAreaElement.md#tabindex)
- [tagName](input._internal_.HTMLTextAreaElement.md#tagname)
- [textContent](input._internal_.HTMLTextAreaElement.md#textcontent)
- [textLength](input._internal_.HTMLTextAreaElement.md#textlength)
- [title](input._internal_.HTMLTextAreaElement.md#title)
- [translate](input._internal_.HTMLTextAreaElement.md#translate)
- [type](input._internal_.HTMLTextAreaElement.md#type)
- [validationMessage](input._internal_.HTMLTextAreaElement.md#validationmessage)
- [validity](input._internal_.HTMLTextAreaElement.md#validity)
- [value](input._internal_.HTMLTextAreaElement.md#value)
- [willValidate](input._internal_.HTMLTextAreaElement.md#willvalidate)
- [wrap](input._internal_.HTMLTextAreaElement.md#wrap)

### Methods

- [addEventListener](input._internal_.HTMLTextAreaElement.md#addeventlistener)
- [after](input._internal_.HTMLTextAreaElement.md#after)
- [animate](input._internal_.HTMLTextAreaElement.md#animate)
- [append](input._internal_.HTMLTextAreaElement.md#append)
- [appendChild](input._internal_.HTMLTextAreaElement.md#appendchild)
- [attachInternals](input._internal_.HTMLTextAreaElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLTextAreaElement.md#attachshadow)
- [before](input._internal_.HTMLTextAreaElement.md#before)
- [blur](input._internal_.HTMLTextAreaElement.md#blur)
- [checkValidity](input._internal_.HTMLTextAreaElement.md#checkvalidity)
- [click](input._internal_.HTMLTextAreaElement.md#click)
- [cloneNode](input._internal_.HTMLTextAreaElement.md#clonenode)
- [closest](input._internal_.HTMLTextAreaElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLTextAreaElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLTextAreaElement.md#contains)
- [dispatchEvent](input._internal_.HTMLTextAreaElement.md#dispatchevent)
- [focus](input._internal_.HTMLTextAreaElement.md#focus)
- [getAnimations](input._internal_.HTMLTextAreaElement.md#getanimations)
- [getAttribute](input._internal_.HTMLTextAreaElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLTextAreaElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLTextAreaElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLTextAreaElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLTextAreaElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLTextAreaElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLTextAreaElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLTextAreaElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLTextAreaElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLTextAreaElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLTextAreaElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLTextAreaElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLTextAreaElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLTextAreaElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLTextAreaElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLTextAreaElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLTextAreaElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLTextAreaElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLTextAreaElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLTextAreaElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLTextAreaElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLTextAreaElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLTextAreaElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLTextAreaElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLTextAreaElement.md#lookupprefix)
- [matches](input._internal_.HTMLTextAreaElement.md#matches)
- [normalize](input._internal_.HTMLTextAreaElement.md#normalize)
- [prepend](input._internal_.HTMLTextAreaElement.md#prepend)
- [querySelector](input._internal_.HTMLTextAreaElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLTextAreaElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLTextAreaElement.md#releasepointercapture)
- [remove](input._internal_.HTMLTextAreaElement.md#remove)
- [removeAttribute](input._internal_.HTMLTextAreaElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLTextAreaElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLTextAreaElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLTextAreaElement.md#removechild)
- [removeEventListener](input._internal_.HTMLTextAreaElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLTextAreaElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLTextAreaElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLTextAreaElement.md#replacewith)
- [reportValidity](input._internal_.HTMLTextAreaElement.md#reportvalidity)
- [requestFullscreen](input._internal_.HTMLTextAreaElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLTextAreaElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLTextAreaElement.md#scroll)
- [scrollBy](input._internal_.HTMLTextAreaElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLTextAreaElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLTextAreaElement.md#scrollto)
- [select](input._internal_.HTMLTextAreaElement.md#select)
- [setAttribute](input._internal_.HTMLTextAreaElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLTextAreaElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLTextAreaElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLTextAreaElement.md#setattributenodens)
- [setCustomValidity](input._internal_.HTMLTextAreaElement.md#setcustomvalidity)
- [setPointerCapture](input._internal_.HTMLTextAreaElement.md#setpointercapture)
- [setRangeText](input._internal_.HTMLTextAreaElement.md#setrangetext)
- [setSelectionRange](input._internal_.HTMLTextAreaElement.md#setselectionrange)
- [toggleAttribute](input._internal_.HTMLTextAreaElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLTextAreaElement.md#webkitmatchesselector)
...
• `Readonly` **labels**: [`NodeListOf`](input._internal_.NodeListOf.md)<[`HTMLLabelElement`](../modules/input._internal_.md#htmllabelelement)\>
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLTextAreaElement`](../modules/input._internal_.md#htmltextareaelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
