[Droom Google Location Plugin - v1.0.16](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLMediaElement

# Interface: HTMLMediaElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLMediaElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLMediaElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLMediaElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLMediaElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLMediaElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLMediaElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLMediaElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLMediaElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLMediaElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLMediaElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLMediaElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLMediaElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLMediaElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLMediaElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLMediaElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLMediaElement.md#entity_reference_node)
- [HAVE\_CURRENT\_DATA](input._internal_.HTMLMediaElement.md#have_current_data)
- [HAVE\_ENOUGH\_DATA](input._internal_.HTMLMediaElement.md#have_enough_data)
- [HAVE\_FUTURE\_DATA](input._internal_.HTMLMediaElement.md#have_future_data)
- [HAVE\_METADATA](input._internal_.HTMLMediaElement.md#have_metadata)
- [HAVE\_NOTHING](input._internal_.HTMLMediaElement.md#have_nothing)
- [NETWORK\_EMPTY](input._internal_.HTMLMediaElement.md#network_empty)
- [NETWORK\_IDLE](input._internal_.HTMLMediaElement.md#network_idle)
- [NETWORK\_LOADING](input._internal_.HTMLMediaElement.md#network_loading)
- [NETWORK\_NO\_SOURCE](input._internal_.HTMLMediaElement.md#network_no_source)
- [NOTATION\_NODE](input._internal_.HTMLMediaElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLMediaElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLMediaElement.md#text_node)
- [accessKey](input._internal_.HTMLMediaElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLMediaElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLMediaElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLMediaElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLMediaElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLMediaElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLMediaElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLMediaElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLMediaElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLMediaElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLMediaElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLMediaElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLMediaElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLMediaElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLMediaElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLMediaElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLMediaElement.md#arialevel)
- [ariaLive](input._internal_.HTMLMediaElement.md#arialive)
- [ariaModal](input._internal_.HTMLMediaElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLMediaElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLMediaElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLMediaElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLMediaElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLMediaElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLMediaElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLMediaElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLMediaElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLMediaElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLMediaElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLMediaElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLMediaElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLMediaElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLMediaElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLMediaElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLMediaElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLMediaElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLMediaElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLMediaElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLMediaElement.md#assignedslot)
- [attributes](input._internal_.HTMLMediaElement.md#attributes)
- [autocapitalize](input._internal_.HTMLMediaElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLMediaElement.md#autofocus)
- [autoplay](input._internal_.HTMLMediaElement.md#autoplay)
- [baseURI](input._internal_.HTMLMediaElement.md#baseuri)
- [buffered](input._internal_.HTMLMediaElement.md#buffered)
- [childElementCount](input._internal_.HTMLMediaElement.md#childelementcount)
- [childNodes](input._internal_.HTMLMediaElement.md#childnodes)
- [children](input._internal_.HTMLMediaElement.md#children)
- [classList](input._internal_.HTMLMediaElement.md#classlist)
- [className](input._internal_.HTMLMediaElement.md#classname)
- [clientHeight](input._internal_.HTMLMediaElement.md#clientheight)
- [clientLeft](input._internal_.HTMLMediaElement.md#clientleft)
- [clientTop](input._internal_.HTMLMediaElement.md#clienttop)
- [clientWidth](input._internal_.HTMLMediaElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLMediaElement.md#contenteditable)
- [controls](input._internal_.HTMLMediaElement.md#controls)
- [crossOrigin](input._internal_.HTMLMediaElement.md#crossorigin)
- [currentSrc](input._internal_.HTMLMediaElement.md#currentsrc)
- [currentTime](input._internal_.HTMLMediaElement.md#currenttime)
- [dataset](input._internal_.HTMLMediaElement.md#dataset)
- [defaultMuted](input._internal_.HTMLMediaElement.md#defaultmuted)
- [defaultPlaybackRate](input._internal_.HTMLMediaElement.md#defaultplaybackrate)
- [dir](input._internal_.HTMLMediaElement.md#dir)
- [disableRemotePlayback](input._internal_.HTMLMediaElement.md#disableremoteplayback)
- [draggable](input._internal_.HTMLMediaElement.md#draggable)
- [duration](input._internal_.HTMLMediaElement.md#duration)
- [ended](input._internal_.HTMLMediaElement.md#ended)
- [enterKeyHint](input._internal_.HTMLMediaElement.md#enterkeyhint)
- [error](input._internal_.HTMLMediaElement.md#error)
- [firstChild](input._internal_.HTMLMediaElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLMediaElement.md#firstelementchild)
- [hidden](input._internal_.HTMLMediaElement.md#hidden)
- [id](input._internal_.HTMLMediaElement.md#id)
- [innerHTML](input._internal_.HTMLMediaElement.md#innerhtml)
- [innerText](input._internal_.HTMLMediaElement.md#innertext)
- [inputMode](input._internal_.HTMLMediaElement.md#inputmode)
- [isConnected](input._internal_.HTMLMediaElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLMediaElement.md#iscontenteditable)
- [lang](input._internal_.HTMLMediaElement.md#lang)
- [lastChild](input._internal_.HTMLMediaElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLMediaElement.md#lastelementchild)
- [localName](input._internal_.HTMLMediaElement.md#localname)
- [loop](input._internal_.HTMLMediaElement.md#loop)
- [mediaKeys](input._internal_.HTMLMediaElement.md#mediakeys)
- [muted](input._internal_.HTMLMediaElement.md#muted)
- [namespaceURI](input._internal_.HTMLMediaElement.md#namespaceuri)
- [networkState](input._internal_.HTMLMediaElement.md#networkstate)
- [nextElementSibling](input._internal_.HTMLMediaElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLMediaElement.md#nextsibling)
- [nodeName](input._internal_.HTMLMediaElement.md#nodename)
- [nodeType](input._internal_.HTMLMediaElement.md#nodetype)
- [nodeValue](input._internal_.HTMLMediaElement.md#nodevalue)
- [nonce](input._internal_.HTMLMediaElement.md#nonce)
- [offsetHeight](input._internal_.HTMLMediaElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLMediaElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLMediaElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLMediaElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLMediaElement.md#offsetwidth)
- [onabort](input._internal_.HTMLMediaElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLMediaElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLMediaElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLMediaElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLMediaElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLMediaElement.md#onauxclick)
- [onblur](input._internal_.HTMLMediaElement.md#onblur)
- [oncanplay](input._internal_.HTMLMediaElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLMediaElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLMediaElement.md#onchange)
- [onclick](input._internal_.HTMLMediaElement.md#onclick)
- [onclose](input._internal_.HTMLMediaElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLMediaElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLMediaElement.md#oncopy)
- [oncuechange](input._internal_.HTMLMediaElement.md#oncuechange)
- [oncut](input._internal_.HTMLMediaElement.md#oncut)
- [ondblclick](input._internal_.HTMLMediaElement.md#ondblclick)
- [ondrag](input._internal_.HTMLMediaElement.md#ondrag)
- [ondragend](input._internal_.HTMLMediaElement.md#ondragend)
- [ondragenter](input._internal_.HTMLMediaElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLMediaElement.md#ondragleave)
- [ondragover](input._internal_.HTMLMediaElement.md#ondragover)
- [ondragstart](input._internal_.HTMLMediaElement.md#ondragstart)
- [ondrop](input._internal_.HTMLMediaElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLMediaElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLMediaElement.md#onemptied)
- [onencrypted](input._internal_.HTMLMediaElement.md#onencrypted)
- [onended](input._internal_.HTMLMediaElement.md#onended)
- [onerror](input._internal_.HTMLMediaElement.md#onerror)
- [onfocus](input._internal_.HTMLMediaElement.md#onfocus)
- [onformdata](input._internal_.HTMLMediaElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLMediaElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLMediaElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLMediaElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLMediaElement.md#oninput)
- [oninvalid](input._internal_.HTMLMediaElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLMediaElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLMediaElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLMediaElement.md#onkeyup)
- [onload](input._internal_.HTMLMediaElement.md#onload)
- [onloadeddata](input._internal_.HTMLMediaElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLMediaElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLMediaElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLMediaElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLMediaElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLMediaElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLMediaElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLMediaElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLMediaElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLMediaElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLMediaElement.md#onmouseup)
- [onpaste](input._internal_.HTMLMediaElement.md#onpaste)
- [onpause](input._internal_.HTMLMediaElement.md#onpause)
- [onplay](input._internal_.HTMLMediaElement.md#onplay)
- [onplaying](input._internal_.HTMLMediaElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLMediaElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLMediaElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLMediaElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLMediaElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLMediaElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLMediaElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLMediaElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLMediaElement.md#onpointerup)
- [onprogress](input._internal_.HTMLMediaElement.md#onprogress)
- [onratechange](input._internal_.HTMLMediaElement.md#onratechange)
- [onreset](input._internal_.HTMLMediaElement.md#onreset)
- [onresize](input._internal_.HTMLMediaElement.md#onresize)
- [onscroll](input._internal_.HTMLMediaElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLMediaElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLMediaElement.md#onseeked)
- [onseeking](input._internal_.HTMLMediaElement.md#onseeking)
- [onselect](input._internal_.HTMLMediaElement.md#onselect)
- [onselectionchange](input._internal_.HTMLMediaElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLMediaElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLMediaElement.md#onslotchange)
- [onstalled](input._internal_.HTMLMediaElement.md#onstalled)
- [onsubmit](input._internal_.HTMLMediaElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLMediaElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLMediaElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLMediaElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLMediaElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLMediaElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLMediaElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLMediaElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLMediaElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLMediaElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLMediaElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLMediaElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLMediaElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLMediaElement.md#onwaiting)
- [onwaitingforkey](input._internal_.HTMLMediaElement.md#onwaitingforkey)
- [onwebkitanimationend](input._internal_.HTMLMediaElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLMediaElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLMediaElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLMediaElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLMediaElement.md#onwheel)
- [outerHTML](input._internal_.HTMLMediaElement.md#outerhtml)
- [outerText](input._internal_.HTMLMediaElement.md#outertext)
- [ownerDocument](input._internal_.HTMLMediaElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLMediaElement.md#parentelement)
- [parentNode](input._internal_.HTMLMediaElement.md#parentnode)
- [part](input._internal_.HTMLMediaElement.md#part)
- [paused](input._internal_.HTMLMediaElement.md#paused)
- [playbackRate](input._internal_.HTMLMediaElement.md#playbackrate)
- [played](input._internal_.HTMLMediaElement.md#played)
- [prefix](input._internal_.HTMLMediaElement.md#prefix)
- [preload](input._internal_.HTMLMediaElement.md#preload)
- [previousElementSibling](input._internal_.HTMLMediaElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLMediaElement.md#previoussibling)
- [readyState](input._internal_.HTMLMediaElement.md#readystate)
- [remote](input._internal_.HTMLMediaElement.md#remote)
- [scrollHeight](input._internal_.HTMLMediaElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLMediaElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLMediaElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLMediaElement.md#scrollwidth)
- [seekable](input._internal_.HTMLMediaElement.md#seekable)
- [seeking](input._internal_.HTMLMediaElement.md#seeking)
- [shadowRoot](input._internal_.HTMLMediaElement.md#shadowroot)
- [slot](input._internal_.HTMLMediaElement.md#slot)
- [spellcheck](input._internal_.HTMLMediaElement.md#spellcheck)
- [src](input._internal_.HTMLMediaElement.md#src)
- [srcObject](input._internal_.HTMLMediaElement.md#srcobject)
- [style](input._internal_.HTMLMediaElement.md#style)
- [tabIndex](input._internal_.HTMLMediaElement.md#tabindex)
- [tagName](input._internal_.HTMLMediaElement.md#tagname)
- [textContent](input._internal_.HTMLMediaElement.md#textcontent)
- [textTracks](input._internal_.HTMLMediaElement.md#texttracks)
- [title](input._internal_.HTMLMediaElement.md#title)
- [translate](input._internal_.HTMLMediaElement.md#translate)
- [volume](input._internal_.HTMLMediaElement.md#volume)

### Methods

- [addEventListener](input._internal_.HTMLMediaElement.md#addeventlistener)
- [addTextTrack](input._internal_.HTMLMediaElement.md#addtexttrack)
- [after](input._internal_.HTMLMediaElement.md#after)
- [animate](input._internal_.HTMLMediaElement.md#animate)
- [append](input._internal_.HTMLMediaElement.md#append)
- [appendChild](input._internal_.HTMLMediaElement.md#appendchild)
- [attachInternals](input._internal_.HTMLMediaElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLMediaElement.md#attachshadow)
- [before](input._internal_.HTMLMediaElement.md#before)
- [blur](input._internal_.HTMLMediaElement.md#blur)
- [canPlayType](input._internal_.HTMLMediaElement.md#canplaytype)
- [click](input._internal_.HTMLMediaElement.md#click)
- [cloneNode](input._internal_.HTMLMediaElement.md#clonenode)
- [closest](input._internal_.HTMLMediaElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLMediaElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLMediaElement.md#contains)
- [dispatchEvent](input._internal_.HTMLMediaElement.md#dispatchevent)
- [fastSeek](input._internal_.HTMLMediaElement.md#fastseek)
- [focus](input._internal_.HTMLMediaElement.md#focus)
- [getAnimations](input._internal_.HTMLMediaElement.md#getanimations)
- [getAttribute](input._internal_.HTMLMediaElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLMediaElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLMediaElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLMediaElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLMediaElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLMediaElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLMediaElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLMediaElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLMediaElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLMediaElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLMediaElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLMediaElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLMediaElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLMediaElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLMediaElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLMediaElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLMediaElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLMediaElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLMediaElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLMediaElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLMediaElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLMediaElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLMediaElement.md#issamenode)
- [load](input._internal_.HTMLMediaElement.md#load)
- [lookupNamespaceURI](input._internal_.HTMLMediaElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLMediaElement.md#lookupprefix)
- [matches](input._internal_.HTMLMediaElement.md#matches)
- [normalize](input._internal_.HTMLMediaElement.md#normalize)
- [pause](input._internal_.HTMLMediaElement.md#pause)
- [play](input._internal_.HTMLMediaElement.md#play)
- [prepend](input._internal_.HTMLMediaElement.md#prepend)
- [querySelector](input._internal_.HTMLMediaElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLMediaElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLMediaElement.md#releasepointercapture)
- [remove](input._internal_.HTMLMediaElement.md#remove)
- [removeAttribute](input._internal_.HTMLMediaElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLMediaElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLMediaElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLMediaElement.md#removechild)
- [removeEventListener](input._internal_.HTMLMediaElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLMediaElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLMediaElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLMediaElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLMediaElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLMediaElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLMediaElement.md#scroll)
- [scrollBy](input._internal_.HTMLMediaElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLMediaElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLMediaElement.md#scrollto)
- [setAttribute](input._internal_.HTMLMediaElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLMediaElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLMediaElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLMediaElement.md#setattributenodens)
- [setMediaKeys](input._internal_.HTMLMediaElement.md#setmediakeys)
- [setPointerCapture](input._internal_.HTMLMediaElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLMediaElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLMediaElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLMediaElement`](../modules/input._internal_.md#htmlmediaelement), `ev`: [`HTMLMediaElementEventMap`](input._internal_.HTMLMediaElementEventMap.md)[`K`]) => `any` |
...
| Name | Type |
| :------ | :------ |
| `mediaKeys` | ``null`` \| [`MediaKeys`](../modules/input._internal_.md#mediakeys) |
