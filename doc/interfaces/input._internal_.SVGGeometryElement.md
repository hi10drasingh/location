[Droom Google Location Plugin - v1.0.13](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGGeometryElement

# Interface: SVGGeometryElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGGeometryElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGGeometryElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGGeometryElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGGeometryElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGGeometryElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGGeometryElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGGeometryElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGGeometryElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGGeometryElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGGeometryElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGGeometryElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGGeometryElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGGeometryElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGGeometryElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGGeometryElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGGeometryElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGGeometryElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGGeometryElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGGeometryElement.md#text_node)
- [ariaAtomic](input._internal_.SVGGeometryElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGGeometryElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGGeometryElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGGeometryElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGGeometryElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGGeometryElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGGeometryElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGGeometryElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGGeometryElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGGeometryElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGGeometryElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGGeometryElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGGeometryElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGGeometryElement.md#arialabel)
- [ariaLevel](input._internal_.SVGGeometryElement.md#arialevel)
- [ariaLive](input._internal_.SVGGeometryElement.md#arialive)
- [ariaModal](input._internal_.SVGGeometryElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGGeometryElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGGeometryElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGGeometryElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGGeometryElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGGeometryElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGGeometryElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGGeometryElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGGeometryElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGGeometryElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGGeometryElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGGeometryElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGGeometryElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGGeometryElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGGeometryElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGGeometryElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGGeometryElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGGeometryElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGGeometryElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGGeometryElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGGeometryElement.md#assignedslot)
- [attributes](input._internal_.SVGGeometryElement.md#attributes)
- [autofocus](input._internal_.SVGGeometryElement.md#autofocus)
- [baseURI](input._internal_.SVGGeometryElement.md#baseuri)
- [childElementCount](input._internal_.SVGGeometryElement.md#childelementcount)
- [childNodes](input._internal_.SVGGeometryElement.md#childnodes)
- [children](input._internal_.SVGGeometryElement.md#children)
- [classList](input._internal_.SVGGeometryElement.md#classlist)
- [className](input._internal_.SVGGeometryElement.md#classname)
- [clientHeight](input._internal_.SVGGeometryElement.md#clientheight)
- [clientLeft](input._internal_.SVGGeometryElement.md#clientleft)
- [clientTop](input._internal_.SVGGeometryElement.md#clienttop)
- [clientWidth](input._internal_.SVGGeometryElement.md#clientwidth)
- [dataset](input._internal_.SVGGeometryElement.md#dataset)
- [firstChild](input._internal_.SVGGeometryElement.md#firstchild)
- [firstElementChild](input._internal_.SVGGeometryElement.md#firstelementchild)
- [id](input._internal_.SVGGeometryElement.md#id)
- [innerHTML](input._internal_.SVGGeometryElement.md#innerhtml)
- [isConnected](input._internal_.SVGGeometryElement.md#isconnected)
- [lastChild](input._internal_.SVGGeometryElement.md#lastchild)
- [lastElementChild](input._internal_.SVGGeometryElement.md#lastelementchild)
- [localName](input._internal_.SVGGeometryElement.md#localname)
- [namespaceURI](input._internal_.SVGGeometryElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGGeometryElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGGeometryElement.md#nextsibling)
- [nodeName](input._internal_.SVGGeometryElement.md#nodename)
- [nodeType](input._internal_.SVGGeometryElement.md#nodetype)
- [nodeValue](input._internal_.SVGGeometryElement.md#nodevalue)
- [nonce](input._internal_.SVGGeometryElement.md#nonce)
- [onabort](input._internal_.SVGGeometryElement.md#onabort)
- [onanimationcancel](input._internal_.SVGGeometryElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGGeometryElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGGeometryElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGGeometryElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGGeometryElement.md#onauxclick)
- [onblur](input._internal_.SVGGeometryElement.md#onblur)
- [oncanplay](input._internal_.SVGGeometryElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGGeometryElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGGeometryElement.md#onchange)
- [onclick](input._internal_.SVGGeometryElement.md#onclick)
- [onclose](input._internal_.SVGGeometryElement.md#onclose)
- [oncontextmenu](input._internal_.SVGGeometryElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGGeometryElement.md#oncopy)
- [oncuechange](input._internal_.SVGGeometryElement.md#oncuechange)
- [oncut](input._internal_.SVGGeometryElement.md#oncut)
- [ondblclick](input._internal_.SVGGeometryElement.md#ondblclick)
- [ondrag](input._internal_.SVGGeometryElement.md#ondrag)
- [ondragend](input._internal_.SVGGeometryElement.md#ondragend)
- [ondragenter](input._internal_.SVGGeometryElement.md#ondragenter)
- [ondragleave](input._internal_.SVGGeometryElement.md#ondragleave)
- [ondragover](input._internal_.SVGGeometryElement.md#ondragover)
- [ondragstart](input._internal_.SVGGeometryElement.md#ondragstart)
- [ondrop](input._internal_.SVGGeometryElement.md#ondrop)
- [ondurationchange](input._internal_.SVGGeometryElement.md#ondurationchange)
- [onemptied](input._internal_.SVGGeometryElement.md#onemptied)
- [onended](input._internal_.SVGGeometryElement.md#onended)
- [onerror](input._internal_.SVGGeometryElement.md#onerror)
- [onfocus](input._internal_.SVGGeometryElement.md#onfocus)
- [onformdata](input._internal_.SVGGeometryElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGGeometryElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGGeometryElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGGeometryElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGGeometryElement.md#oninput)
- [oninvalid](input._internal_.SVGGeometryElement.md#oninvalid)
- [onkeydown](input._internal_.SVGGeometryElement.md#onkeydown)
- [onkeypress](input._internal_.SVGGeometryElement.md#onkeypress)
- [onkeyup](input._internal_.SVGGeometryElement.md#onkeyup)
- [onload](input._internal_.SVGGeometryElement.md#onload)
- [onloadeddata](input._internal_.SVGGeometryElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGGeometryElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGGeometryElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGGeometryElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGGeometryElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGGeometryElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGGeometryElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGGeometryElement.md#onmousemove)
- [onmouseout](input._internal_.SVGGeometryElement.md#onmouseout)
- [onmouseover](input._internal_.SVGGeometryElement.md#onmouseover)
- [onmouseup](input._internal_.SVGGeometryElement.md#onmouseup)
- [onpaste](input._internal_.SVGGeometryElement.md#onpaste)
- [onpause](input._internal_.SVGGeometryElement.md#onpause)
- [onplay](input._internal_.SVGGeometryElement.md#onplay)
- [onplaying](input._internal_.SVGGeometryElement.md#onplaying)
- [onpointercancel](input._internal_.SVGGeometryElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGGeometryElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGGeometryElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGGeometryElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGGeometryElement.md#onpointermove)
- [onpointerout](input._internal_.SVGGeometryElement.md#onpointerout)
- [onpointerover](input._internal_.SVGGeometryElement.md#onpointerover)
- [onpointerup](input._internal_.SVGGeometryElement.md#onpointerup)
- [onprogress](input._internal_.SVGGeometryElement.md#onprogress)
- [onratechange](input._internal_.SVGGeometryElement.md#onratechange)
- [onreset](input._internal_.SVGGeometryElement.md#onreset)
- [onresize](input._internal_.SVGGeometryElement.md#onresize)
- [onscroll](input._internal_.SVGGeometryElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGGeometryElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGGeometryElement.md#onseeked)
- [onseeking](input._internal_.SVGGeometryElement.md#onseeking)
- [onselect](input._internal_.SVGGeometryElement.md#onselect)
- [onselectionchange](input._internal_.SVGGeometryElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGGeometryElement.md#onselectstart)
- [onslotchange](input._internal_.SVGGeometryElement.md#onslotchange)
- [onstalled](input._internal_.SVGGeometryElement.md#onstalled)
- [onsubmit](input._internal_.SVGGeometryElement.md#onsubmit)
- [onsuspend](input._internal_.SVGGeometryElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGGeometryElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGGeometryElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGGeometryElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGGeometryElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGGeometryElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGGeometryElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGGeometryElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGGeometryElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGGeometryElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGGeometryElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGGeometryElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGGeometryElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGGeometryElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGGeometryElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGGeometryElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGGeometryElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGGeometryElement.md#onwheel)
- [outerHTML](input._internal_.SVGGeometryElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGGeometryElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGGeometryElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGGeometryElement.md#parentelement)
- [parentNode](input._internal_.SVGGeometryElement.md#parentnode)
- [part](input._internal_.SVGGeometryElement.md#part)
- [pathLength](input._internal_.SVGGeometryElement.md#pathlength)
- [prefix](input._internal_.SVGGeometryElement.md#prefix)
- [previousElementSibling](input._internal_.SVGGeometryElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGGeometryElement.md#previoussibling)
- [requiredExtensions](input._internal_.SVGGeometryElement.md#requiredextensions)
- [scrollHeight](input._internal_.SVGGeometryElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGGeometryElement.md#scrollleft)
- [scrollTop](input._internal_.SVGGeometryElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGGeometryElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGGeometryElement.md#shadowroot)
- [slot](input._internal_.SVGGeometryElement.md#slot)
- [style](input._internal_.SVGGeometryElement.md#style)
- [systemLanguage](input._internal_.SVGGeometryElement.md#systemlanguage)
- [tabIndex](input._internal_.SVGGeometryElement.md#tabindex)
- [tagName](input._internal_.SVGGeometryElement.md#tagname)
- [textContent](input._internal_.SVGGeometryElement.md#textcontent)
- [transform](input._internal_.SVGGeometryElement.md#transform)
- [viewportElement](input._internal_.SVGGeometryElement.md#viewportelement)

### Methods

- [addEventListener](input._internal_.SVGGeometryElement.md#addeventlistener)
- [after](input._internal_.SVGGeometryElement.md#after)
- [animate](input._internal_.SVGGeometryElement.md#animate)
- [append](input._internal_.SVGGeometryElement.md#append)
- [appendChild](input._internal_.SVGGeometryElement.md#appendchild)
- [attachShadow](input._internal_.SVGGeometryElement.md#attachshadow)
- [before](input._internal_.SVGGeometryElement.md#before)
- [blur](input._internal_.SVGGeometryElement.md#blur)
- [cloneNode](input._internal_.SVGGeometryElement.md#clonenode)
- [closest](input._internal_.SVGGeometryElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGGeometryElement.md#comparedocumentposition)
- [contains](input._internal_.SVGGeometryElement.md#contains)
- [dispatchEvent](input._internal_.SVGGeometryElement.md#dispatchevent)
- [focus](input._internal_.SVGGeometryElement.md#focus)
- [getAnimations](input._internal_.SVGGeometryElement.md#getanimations)
- [getAttribute](input._internal_.SVGGeometryElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGGeometryElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGGeometryElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGGeometryElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGGeometryElement.md#getattributenodens)
- [getBBox](input._internal_.SVGGeometryElement.md#getbbox)
- [getBoundingClientRect](input._internal_.SVGGeometryElement.md#getboundingclientrect)
- [getCTM](input._internal_.SVGGeometryElement.md#getctm)
- [getClientRects](input._internal_.SVGGeometryElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGGeometryElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGGeometryElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGGeometryElement.md#getelementsbytagnamens)
- [getPointAtLength](input._internal_.SVGGeometryElement.md#getpointatlength)
- [getRootNode](input._internal_.SVGGeometryElement.md#getrootnode)
- [getScreenCTM](input._internal_.SVGGeometryElement.md#getscreenctm)
- [getTotalLength](input._internal_.SVGGeometryElement.md#gettotallength)
- [hasAttribute](input._internal_.SVGGeometryElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGGeometryElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGGeometryElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGGeometryElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGGeometryElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGGeometryElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGGeometryElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGGeometryElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGGeometryElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGGeometryElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGGeometryElement.md#isequalnode)
- [isPointInFill](input._internal_.SVGGeometryElement.md#ispointinfill)
- [isPointInStroke](input._internal_.SVGGeometryElement.md#ispointinstroke)
- [isSameNode](input._internal_.SVGGeometryElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGGeometryElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGGeometryElement.md#lookupprefix)
- [matches](input._internal_.SVGGeometryElement.md#matches)
- [normalize](input._internal_.SVGGeometryElement.md#normalize)
- [prepend](input._internal_.SVGGeometryElement.md#prepend)
- [querySelector](input._internal_.SVGGeometryElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGGeometryElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGGeometryElement.md#releasepointercapture)
- [remove](input._internal_.SVGGeometryElement.md#remove)
- [removeAttribute](input._internal_.SVGGeometryElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGGeometryElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGGeometryElement.md#removeattributenode)
- [removeChild](input._internal_.SVGGeometryElement.md#removechild)
- [removeEventListener](input._internal_.SVGGeometryElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGGeometryElement.md#replacechild)
- [replaceChildren](input._internal_.SVGGeometryElement.md#replacechildren)
- [replaceWith](input._internal_.SVGGeometryElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGGeometryElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGGeometryElement.md#requestpointerlock)
- [scroll](input._internal_.SVGGeometryElement.md#scroll)
- [scrollBy](input._internal_.SVGGeometryElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGGeometryElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGGeometryElement.md#scrollto)
- [setAttribute](input._internal_.SVGGeometryElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGGeometryElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGGeometryElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGGeometryElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGGeometryElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGGeometryElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGGeometryElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGGeometryElement`](../modules/input._internal_.md#svggeometryelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
