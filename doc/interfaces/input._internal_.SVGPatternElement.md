[Droom Google Location Plugin - v1.0.13](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGPatternElement

# Interface: SVGPatternElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGPatternElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGPatternElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGPatternElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGPatternElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGPatternElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGPatternElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGPatternElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGPatternElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGPatternElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGPatternElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGPatternElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGPatternElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGPatternElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGPatternElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGPatternElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGPatternElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGPatternElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGPatternElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGPatternElement.md#text_node)
- [ariaAtomic](input._internal_.SVGPatternElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGPatternElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGPatternElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGPatternElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGPatternElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGPatternElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGPatternElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGPatternElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGPatternElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGPatternElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGPatternElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGPatternElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGPatternElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGPatternElement.md#arialabel)
- [ariaLevel](input._internal_.SVGPatternElement.md#arialevel)
- [ariaLive](input._internal_.SVGPatternElement.md#arialive)
- [ariaModal](input._internal_.SVGPatternElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGPatternElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGPatternElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGPatternElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGPatternElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGPatternElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGPatternElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGPatternElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGPatternElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGPatternElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGPatternElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGPatternElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGPatternElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGPatternElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGPatternElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGPatternElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGPatternElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGPatternElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGPatternElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGPatternElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGPatternElement.md#assignedslot)
- [attributes](input._internal_.SVGPatternElement.md#attributes)
- [autofocus](input._internal_.SVGPatternElement.md#autofocus)
- [baseURI](input._internal_.SVGPatternElement.md#baseuri)
- [childElementCount](input._internal_.SVGPatternElement.md#childelementcount)
- [childNodes](input._internal_.SVGPatternElement.md#childnodes)
- [children](input._internal_.SVGPatternElement.md#children)
- [classList](input._internal_.SVGPatternElement.md#classlist)
- [className](input._internal_.SVGPatternElement.md#classname)
- [clientHeight](input._internal_.SVGPatternElement.md#clientheight)
- [clientLeft](input._internal_.SVGPatternElement.md#clientleft)
- [clientTop](input._internal_.SVGPatternElement.md#clienttop)
- [clientWidth](input._internal_.SVGPatternElement.md#clientwidth)
- [dataset](input._internal_.SVGPatternElement.md#dataset)
- [firstChild](input._internal_.SVGPatternElement.md#firstchild)
- [firstElementChild](input._internal_.SVGPatternElement.md#firstelementchild)
- [height](input._internal_.SVGPatternElement.md#height)
- [href](input._internal_.SVGPatternElement.md#href)
- [id](input._internal_.SVGPatternElement.md#id)
- [innerHTML](input._internal_.SVGPatternElement.md#innerhtml)
- [isConnected](input._internal_.SVGPatternElement.md#isconnected)
- [lastChild](input._internal_.SVGPatternElement.md#lastchild)
- [lastElementChild](input._internal_.SVGPatternElement.md#lastelementchild)
- [localName](input._internal_.SVGPatternElement.md#localname)
- [namespaceURI](input._internal_.SVGPatternElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGPatternElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGPatternElement.md#nextsibling)
- [nodeName](input._internal_.SVGPatternElement.md#nodename)
- [nodeType](input._internal_.SVGPatternElement.md#nodetype)
- [nodeValue](input._internal_.SVGPatternElement.md#nodevalue)
- [nonce](input._internal_.SVGPatternElement.md#nonce)
- [onabort](input._internal_.SVGPatternElement.md#onabort)
- [onanimationcancel](input._internal_.SVGPatternElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGPatternElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGPatternElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGPatternElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGPatternElement.md#onauxclick)
- [onblur](input._internal_.SVGPatternElement.md#onblur)
- [oncanplay](input._internal_.SVGPatternElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGPatternElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGPatternElement.md#onchange)
- [onclick](input._internal_.SVGPatternElement.md#onclick)
- [onclose](input._internal_.SVGPatternElement.md#onclose)
- [oncontextmenu](input._internal_.SVGPatternElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGPatternElement.md#oncopy)
- [oncuechange](input._internal_.SVGPatternElement.md#oncuechange)
- [oncut](input._internal_.SVGPatternElement.md#oncut)
- [ondblclick](input._internal_.SVGPatternElement.md#ondblclick)
- [ondrag](input._internal_.SVGPatternElement.md#ondrag)
- [ondragend](input._internal_.SVGPatternElement.md#ondragend)
- [ondragenter](input._internal_.SVGPatternElement.md#ondragenter)
- [ondragleave](input._internal_.SVGPatternElement.md#ondragleave)
- [ondragover](input._internal_.SVGPatternElement.md#ondragover)
- [ondragstart](input._internal_.SVGPatternElement.md#ondragstart)
- [ondrop](input._internal_.SVGPatternElement.md#ondrop)
- [ondurationchange](input._internal_.SVGPatternElement.md#ondurationchange)
- [onemptied](input._internal_.SVGPatternElement.md#onemptied)
- [onended](input._internal_.SVGPatternElement.md#onended)
- [onerror](input._internal_.SVGPatternElement.md#onerror)
- [onfocus](input._internal_.SVGPatternElement.md#onfocus)
- [onformdata](input._internal_.SVGPatternElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGPatternElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGPatternElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGPatternElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGPatternElement.md#oninput)
- [oninvalid](input._internal_.SVGPatternElement.md#oninvalid)
- [onkeydown](input._internal_.SVGPatternElement.md#onkeydown)
- [onkeypress](input._internal_.SVGPatternElement.md#onkeypress)
- [onkeyup](input._internal_.SVGPatternElement.md#onkeyup)
- [onload](input._internal_.SVGPatternElement.md#onload)
- [onloadeddata](input._internal_.SVGPatternElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGPatternElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGPatternElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGPatternElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGPatternElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGPatternElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGPatternElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGPatternElement.md#onmousemove)
- [onmouseout](input._internal_.SVGPatternElement.md#onmouseout)
- [onmouseover](input._internal_.SVGPatternElement.md#onmouseover)
- [onmouseup](input._internal_.SVGPatternElement.md#onmouseup)
- [onpaste](input._internal_.SVGPatternElement.md#onpaste)
- [onpause](input._internal_.SVGPatternElement.md#onpause)
- [onplay](input._internal_.SVGPatternElement.md#onplay)
- [onplaying](input._internal_.SVGPatternElement.md#onplaying)
- [onpointercancel](input._internal_.SVGPatternElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGPatternElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGPatternElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGPatternElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGPatternElement.md#onpointermove)
- [onpointerout](input._internal_.SVGPatternElement.md#onpointerout)
- [onpointerover](input._internal_.SVGPatternElement.md#onpointerover)
- [onpointerup](input._internal_.SVGPatternElement.md#onpointerup)
- [onprogress](input._internal_.SVGPatternElement.md#onprogress)
- [onratechange](input._internal_.SVGPatternElement.md#onratechange)
- [onreset](input._internal_.SVGPatternElement.md#onreset)
- [onresize](input._internal_.SVGPatternElement.md#onresize)
- [onscroll](input._internal_.SVGPatternElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGPatternElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGPatternElement.md#onseeked)
- [onseeking](input._internal_.SVGPatternElement.md#onseeking)
- [onselect](input._internal_.SVGPatternElement.md#onselect)
- [onselectionchange](input._internal_.SVGPatternElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGPatternElement.md#onselectstart)
- [onslotchange](input._internal_.SVGPatternElement.md#onslotchange)
- [onstalled](input._internal_.SVGPatternElement.md#onstalled)
- [onsubmit](input._internal_.SVGPatternElement.md#onsubmit)
- [onsuspend](input._internal_.SVGPatternElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGPatternElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGPatternElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGPatternElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGPatternElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGPatternElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGPatternElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGPatternElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGPatternElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGPatternElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGPatternElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGPatternElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGPatternElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGPatternElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGPatternElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGPatternElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGPatternElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGPatternElement.md#onwheel)
- [outerHTML](input._internal_.SVGPatternElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGPatternElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGPatternElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGPatternElement.md#parentelement)
- [parentNode](input._internal_.SVGPatternElement.md#parentnode)
- [part](input._internal_.SVGPatternElement.md#part)
- [patternContentUnits](input._internal_.SVGPatternElement.md#patterncontentunits)
- [patternTransform](input._internal_.SVGPatternElement.md#patterntransform)
- [patternUnits](input._internal_.SVGPatternElement.md#patternunits)
- [prefix](input._internal_.SVGPatternElement.md#prefix)
- [preserveAspectRatio](input._internal_.SVGPatternElement.md#preserveaspectratio)
- [previousElementSibling](input._internal_.SVGPatternElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGPatternElement.md#previoussibling)
- [scrollHeight](input._internal_.SVGPatternElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGPatternElement.md#scrollleft)
- [scrollTop](input._internal_.SVGPatternElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGPatternElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGPatternElement.md#shadowroot)
- [slot](input._internal_.SVGPatternElement.md#slot)
- [style](input._internal_.SVGPatternElement.md#style)
- [tabIndex](input._internal_.SVGPatternElement.md#tabindex)
- [tagName](input._internal_.SVGPatternElement.md#tagname)
- [textContent](input._internal_.SVGPatternElement.md#textcontent)
- [viewBox](input._internal_.SVGPatternElement.md#viewbox)
- [viewportElement](input._internal_.SVGPatternElement.md#viewportelement)
- [width](input._internal_.SVGPatternElement.md#width)
- [x](input._internal_.SVGPatternElement.md#x)
- [y](input._internal_.SVGPatternElement.md#y)

### Methods

- [addEventListener](input._internal_.SVGPatternElement.md#addeventlistener)
- [after](input._internal_.SVGPatternElement.md#after)
- [animate](input._internal_.SVGPatternElement.md#animate)
- [append](input._internal_.SVGPatternElement.md#append)
- [appendChild](input._internal_.SVGPatternElement.md#appendchild)
- [attachShadow](input._internal_.SVGPatternElement.md#attachshadow)
- [before](input._internal_.SVGPatternElement.md#before)
- [blur](input._internal_.SVGPatternElement.md#blur)
- [cloneNode](input._internal_.SVGPatternElement.md#clonenode)
- [closest](input._internal_.SVGPatternElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGPatternElement.md#comparedocumentposition)
- [contains](input._internal_.SVGPatternElement.md#contains)
- [dispatchEvent](input._internal_.SVGPatternElement.md#dispatchevent)
- [focus](input._internal_.SVGPatternElement.md#focus)
- [getAnimations](input._internal_.SVGPatternElement.md#getanimations)
- [getAttribute](input._internal_.SVGPatternElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGPatternElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGPatternElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGPatternElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGPatternElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.SVGPatternElement.md#getboundingclientrect)
- [getClientRects](input._internal_.SVGPatternElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGPatternElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGPatternElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGPatternElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGPatternElement.md#getrootnode)
- [hasAttribute](input._internal_.SVGPatternElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGPatternElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGPatternElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGPatternElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGPatternElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGPatternElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGPatternElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGPatternElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGPatternElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGPatternElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGPatternElement.md#isequalnode)
- [isSameNode](input._internal_.SVGPatternElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGPatternElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGPatternElement.md#lookupprefix)
- [matches](input._internal_.SVGPatternElement.md#matches)
- [normalize](input._internal_.SVGPatternElement.md#normalize)
- [prepend](input._internal_.SVGPatternElement.md#prepend)
- [querySelector](input._internal_.SVGPatternElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGPatternElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGPatternElement.md#releasepointercapture)
- [remove](input._internal_.SVGPatternElement.md#remove)
- [removeAttribute](input._internal_.SVGPatternElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGPatternElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGPatternElement.md#removeattributenode)
- [removeChild](input._internal_.SVGPatternElement.md#removechild)
- [removeEventListener](input._internal_.SVGPatternElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGPatternElement.md#replacechild)
- [replaceChildren](input._internal_.SVGPatternElement.md#replacechildren)
- [replaceWith](input._internal_.SVGPatternElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGPatternElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGPatternElement.md#requestpointerlock)
- [scroll](input._internal_.SVGPatternElement.md#scroll)
- [scrollBy](input._internal_.SVGPatternElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGPatternElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGPatternElement.md#scrollto)
- [setAttribute](input._internal_.SVGPatternElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGPatternElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGPatternElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGPatternElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGPatternElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGPatternElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGPatternElement.md#webkitmatchesselector)
...
• `Readonly` **patternContentUnits**: [`SVGAnimatedEnumeration`](../modules/input._internal_.md#svganimatedenumeration)
...
• `Readonly` **patternTransform**: [`SVGAnimatedTransformList`](../modules/input._internal_.md#svganimatedtransformlist)
...
• `Readonly` **patternUnits**: [`SVGAnimatedEnumeration`](../modules/input._internal_.md#svganimatedenumeration)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGPatternElement`](../modules/input._internal_.md#svgpatternelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
