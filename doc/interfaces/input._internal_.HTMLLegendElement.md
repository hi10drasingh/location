[Droom Google Location Plugin - v1.0.11](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLLegendElement

# Interface: HTMLLegendElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLLegendElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLLegendElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLLegendElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLLegendElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLLegendElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLLegendElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLLegendElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLLegendElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLLegendElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLLegendElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLLegendElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLLegendElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLLegendElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLLegendElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLLegendElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLLegendElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLLegendElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLLegendElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLLegendElement.md#text_node)
- [accessKey](input._internal_.HTMLLegendElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLLegendElement.md#accesskeylabel)
- [align](input._internal_.HTMLLegendElement.md#align)
- [ariaAtomic](input._internal_.HTMLLegendElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLLegendElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLLegendElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLLegendElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLLegendElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLLegendElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLLegendElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLLegendElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLLegendElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLLegendElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLLegendElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLLegendElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLLegendElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLLegendElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLLegendElement.md#arialevel)
- [ariaLive](input._internal_.HTMLLegendElement.md#arialive)
- [ariaModal](input._internal_.HTMLLegendElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLLegendElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLLegendElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLLegendElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLLegendElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLLegendElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLLegendElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLLegendElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLLegendElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLLegendElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLLegendElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLLegendElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLLegendElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLLegendElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLLegendElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLLegendElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLLegendElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLLegendElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLLegendElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLLegendElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLLegendElement.md#assignedslot)
- [attributes](input._internal_.HTMLLegendElement.md#attributes)
- [autocapitalize](input._internal_.HTMLLegendElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLLegendElement.md#autofocus)
- [baseURI](input._internal_.HTMLLegendElement.md#baseuri)
- [childElementCount](input._internal_.HTMLLegendElement.md#childelementcount)
- [childNodes](input._internal_.HTMLLegendElement.md#childnodes)
- [children](input._internal_.HTMLLegendElement.md#children)
- [classList](input._internal_.HTMLLegendElement.md#classlist)
- [className](input._internal_.HTMLLegendElement.md#classname)
- [clientHeight](input._internal_.HTMLLegendElement.md#clientheight)
- [clientLeft](input._internal_.HTMLLegendElement.md#clientleft)
- [clientTop](input._internal_.HTMLLegendElement.md#clienttop)
- [clientWidth](input._internal_.HTMLLegendElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLLegendElement.md#contenteditable)
- [dataset](input._internal_.HTMLLegendElement.md#dataset)
- [dir](input._internal_.HTMLLegendElement.md#dir)
- [draggable](input._internal_.HTMLLegendElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLLegendElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLLegendElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLLegendElement.md#firstelementchild)
- [form](input._internal_.HTMLLegendElement.md#form)
- [hidden](input._internal_.HTMLLegendElement.md#hidden)
- [id](input._internal_.HTMLLegendElement.md#id)
- [innerHTML](input._internal_.HTMLLegendElement.md#innerhtml)
- [innerText](input._internal_.HTMLLegendElement.md#innertext)
- [inputMode](input._internal_.HTMLLegendElement.md#inputmode)
- [isConnected](input._internal_.HTMLLegendElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLLegendElement.md#iscontenteditable)
- [lang](input._internal_.HTMLLegendElement.md#lang)
- [lastChild](input._internal_.HTMLLegendElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLLegendElement.md#lastelementchild)
- [localName](input._internal_.HTMLLegendElement.md#localname)
- [namespaceURI](input._internal_.HTMLLegendElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLLegendElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLLegendElement.md#nextsibling)
- [nodeName](input._internal_.HTMLLegendElement.md#nodename)
- [nodeType](input._internal_.HTMLLegendElement.md#nodetype)
- [nodeValue](input._internal_.HTMLLegendElement.md#nodevalue)
- [nonce](input._internal_.HTMLLegendElement.md#nonce)
- [offsetHeight](input._internal_.HTMLLegendElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLLegendElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLLegendElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLLegendElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLLegendElement.md#offsetwidth)
- [onabort](input._internal_.HTMLLegendElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLLegendElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLLegendElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLLegendElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLLegendElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLLegendElement.md#onauxclick)
- [onblur](input._internal_.HTMLLegendElement.md#onblur)
- [oncanplay](input._internal_.HTMLLegendElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLLegendElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLLegendElement.md#onchange)
- [onclick](input._internal_.HTMLLegendElement.md#onclick)
- [onclose](input._internal_.HTMLLegendElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLLegendElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLLegendElement.md#oncopy)
- [oncuechange](input._internal_.HTMLLegendElement.md#oncuechange)
- [oncut](input._internal_.HTMLLegendElement.md#oncut)
- [ondblclick](input._internal_.HTMLLegendElement.md#ondblclick)
- [ondrag](input._internal_.HTMLLegendElement.md#ondrag)
- [ondragend](input._internal_.HTMLLegendElement.md#ondragend)
- [ondragenter](input._internal_.HTMLLegendElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLLegendElement.md#ondragleave)
- [ondragover](input._internal_.HTMLLegendElement.md#ondragover)
- [ondragstart](input._internal_.HTMLLegendElement.md#ondragstart)
- [ondrop](input._internal_.HTMLLegendElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLLegendElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLLegendElement.md#onemptied)
- [onended](input._internal_.HTMLLegendElement.md#onended)
- [onerror](input._internal_.HTMLLegendElement.md#onerror)
- [onfocus](input._internal_.HTMLLegendElement.md#onfocus)
- [onformdata](input._internal_.HTMLLegendElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLLegendElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLLegendElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLLegendElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLLegendElement.md#oninput)
- [oninvalid](input._internal_.HTMLLegendElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLLegendElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLLegendElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLLegendElement.md#onkeyup)
- [onload](input._internal_.HTMLLegendElement.md#onload)
- [onloadeddata](input._internal_.HTMLLegendElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLLegendElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLLegendElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLLegendElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLLegendElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLLegendElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLLegendElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLLegendElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLLegendElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLLegendElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLLegendElement.md#onmouseup)
- [onpaste](input._internal_.HTMLLegendElement.md#onpaste)
- [onpause](input._internal_.HTMLLegendElement.md#onpause)
- [onplay](input._internal_.HTMLLegendElement.md#onplay)
- [onplaying](input._internal_.HTMLLegendElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLLegendElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLLegendElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLLegendElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLLegendElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLLegendElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLLegendElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLLegendElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLLegendElement.md#onpointerup)
- [onprogress](input._internal_.HTMLLegendElement.md#onprogress)
- [onratechange](input._internal_.HTMLLegendElement.md#onratechange)
- [onreset](input._internal_.HTMLLegendElement.md#onreset)
- [onresize](input._internal_.HTMLLegendElement.md#onresize)
- [onscroll](input._internal_.HTMLLegendElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLLegendElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLLegendElement.md#onseeked)
- [onseeking](input._internal_.HTMLLegendElement.md#onseeking)
- [onselect](input._internal_.HTMLLegendElement.md#onselect)
- [onselectionchange](input._internal_.HTMLLegendElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLLegendElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLLegendElement.md#onslotchange)
- [onstalled](input._internal_.HTMLLegendElement.md#onstalled)
- [onsubmit](input._internal_.HTMLLegendElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLLegendElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLLegendElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLLegendElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLLegendElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLLegendElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLLegendElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLLegendElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLLegendElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLLegendElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLLegendElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLLegendElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLLegendElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLLegendElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLLegendElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLLegendElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLLegendElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLLegendElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLLegendElement.md#onwheel)
- [outerHTML](input._internal_.HTMLLegendElement.md#outerhtml)
- [outerText](input._internal_.HTMLLegendElement.md#outertext)
- [ownerDocument](input._internal_.HTMLLegendElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLLegendElement.md#parentelement)
- [parentNode](input._internal_.HTMLLegendElement.md#parentnode)
- [part](input._internal_.HTMLLegendElement.md#part)
- [prefix](input._internal_.HTMLLegendElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLLegendElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLLegendElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLLegendElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLLegendElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLLegendElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLLegendElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLLegendElement.md#shadowroot)
- [slot](input._internal_.HTMLLegendElement.md#slot)
- [spellcheck](input._internal_.HTMLLegendElement.md#spellcheck)
- [style](input._internal_.HTMLLegendElement.md#style)
- [tabIndex](input._internal_.HTMLLegendElement.md#tabindex)
- [tagName](input._internal_.HTMLLegendElement.md#tagname)
- [textContent](input._internal_.HTMLLegendElement.md#textcontent)
- [title](input._internal_.HTMLLegendElement.md#title)
- [translate](input._internal_.HTMLLegendElement.md#translate)

### Methods

- [addEventListener](input._internal_.HTMLLegendElement.md#addeventlistener)
- [after](input._internal_.HTMLLegendElement.md#after)
- [animate](input._internal_.HTMLLegendElement.md#animate)
- [append](input._internal_.HTMLLegendElement.md#append)
- [appendChild](input._internal_.HTMLLegendElement.md#appendchild)
- [attachInternals](input._internal_.HTMLLegendElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLLegendElement.md#attachshadow)
- [before](input._internal_.HTMLLegendElement.md#before)
- [blur](input._internal_.HTMLLegendElement.md#blur)
- [click](input._internal_.HTMLLegendElement.md#click)
- [cloneNode](input._internal_.HTMLLegendElement.md#clonenode)
- [closest](input._internal_.HTMLLegendElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLLegendElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLLegendElement.md#contains)
- [dispatchEvent](input._internal_.HTMLLegendElement.md#dispatchevent)
- [focus](input._internal_.HTMLLegendElement.md#focus)
- [getAnimations](input._internal_.HTMLLegendElement.md#getanimations)
- [getAttribute](input._internal_.HTMLLegendElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLLegendElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLLegendElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLLegendElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLLegendElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLLegendElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLLegendElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLLegendElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLLegendElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLLegendElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLLegendElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLLegendElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLLegendElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLLegendElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLLegendElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLLegendElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLLegendElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLLegendElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLLegendElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLLegendElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLLegendElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLLegendElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLLegendElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLLegendElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLLegendElement.md#lookupprefix)
- [matches](input._internal_.HTMLLegendElement.md#matches)
- [normalize](input._internal_.HTMLLegendElement.md#normalize)
- [prepend](input._internal_.HTMLLegendElement.md#prepend)
- [querySelector](input._internal_.HTMLLegendElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLLegendElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLLegendElement.md#releasepointercapture)
- [remove](input._internal_.HTMLLegendElement.md#remove)
- [removeAttribute](input._internal_.HTMLLegendElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLLegendElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLLegendElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLLegendElement.md#removechild)
- [removeEventListener](input._internal_.HTMLLegendElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLLegendElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLLegendElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLLegendElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLLegendElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLLegendElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLLegendElement.md#scroll)
- [scrollBy](input._internal_.HTMLLegendElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLLegendElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLLegendElement.md#scrollto)
- [setAttribute](input._internal_.HTMLLegendElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLLegendElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLLegendElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLLegendElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLLegendElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLLegendElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLLegendElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLLegendElement`](../modules/input._internal_.md#htmllegendelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
