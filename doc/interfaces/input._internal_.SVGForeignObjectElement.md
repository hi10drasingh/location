[Droom Google Location Plugin - v1.0.16](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGForeignObjectElement

# Interface: SVGForeignObjectElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGForeignObjectElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGForeignObjectElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGForeignObjectElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGForeignObjectElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGForeignObjectElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGForeignObjectElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGForeignObjectElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGForeignObjectElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGForeignObjectElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGForeignObjectElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGForeignObjectElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGForeignObjectElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGForeignObjectElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGForeignObjectElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGForeignObjectElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGForeignObjectElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGForeignObjectElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGForeignObjectElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGForeignObjectElement.md#text_node)
- [ariaAtomic](input._internal_.SVGForeignObjectElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGForeignObjectElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGForeignObjectElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGForeignObjectElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGForeignObjectElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGForeignObjectElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGForeignObjectElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGForeignObjectElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGForeignObjectElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGForeignObjectElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGForeignObjectElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGForeignObjectElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGForeignObjectElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGForeignObjectElement.md#arialabel)
- [ariaLevel](input._internal_.SVGForeignObjectElement.md#arialevel)
- [ariaLive](input._internal_.SVGForeignObjectElement.md#arialive)
- [ariaModal](input._internal_.SVGForeignObjectElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGForeignObjectElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGForeignObjectElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGForeignObjectElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGForeignObjectElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGForeignObjectElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGForeignObjectElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGForeignObjectElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGForeignObjectElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGForeignObjectElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGForeignObjectElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGForeignObjectElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGForeignObjectElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGForeignObjectElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGForeignObjectElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGForeignObjectElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGForeignObjectElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGForeignObjectElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGForeignObjectElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGForeignObjectElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGForeignObjectElement.md#assignedslot)
- [attributes](input._internal_.SVGForeignObjectElement.md#attributes)
- [autofocus](input._internal_.SVGForeignObjectElement.md#autofocus)
- [baseURI](input._internal_.SVGForeignObjectElement.md#baseuri)
- [childElementCount](input._internal_.SVGForeignObjectElement.md#childelementcount)
- [childNodes](input._internal_.SVGForeignObjectElement.md#childnodes)
- [children](input._internal_.SVGForeignObjectElement.md#children)
- [classList](input._internal_.SVGForeignObjectElement.md#classlist)
- [className](input._internal_.SVGForeignObjectElement.md#classname)
- [clientHeight](input._internal_.SVGForeignObjectElement.md#clientheight)
- [clientLeft](input._internal_.SVGForeignObjectElement.md#clientleft)
- [clientTop](input._internal_.SVGForeignObjectElement.md#clienttop)
- [clientWidth](input._internal_.SVGForeignObjectElement.md#clientwidth)
- [dataset](input._internal_.SVGForeignObjectElement.md#dataset)
- [firstChild](input._internal_.SVGForeignObjectElement.md#firstchild)
- [firstElementChild](input._internal_.SVGForeignObjectElement.md#firstelementchild)
- [height](input._internal_.SVGForeignObjectElement.md#height)
- [id](input._internal_.SVGForeignObjectElement.md#id)
- [innerHTML](input._internal_.SVGForeignObjectElement.md#innerhtml)
- [isConnected](input._internal_.SVGForeignObjectElement.md#isconnected)
- [lastChild](input._internal_.SVGForeignObjectElement.md#lastchild)
- [lastElementChild](input._internal_.SVGForeignObjectElement.md#lastelementchild)
- [localName](input._internal_.SVGForeignObjectElement.md#localname)
- [namespaceURI](input._internal_.SVGForeignObjectElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGForeignObjectElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGForeignObjectElement.md#nextsibling)
- [nodeName](input._internal_.SVGForeignObjectElement.md#nodename)
- [nodeType](input._internal_.SVGForeignObjectElement.md#nodetype)
- [nodeValue](input._internal_.SVGForeignObjectElement.md#nodevalue)
- [nonce](input._internal_.SVGForeignObjectElement.md#nonce)
- [onabort](input._internal_.SVGForeignObjectElement.md#onabort)
- [onanimationcancel](input._internal_.SVGForeignObjectElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGForeignObjectElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGForeignObjectElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGForeignObjectElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGForeignObjectElement.md#onauxclick)
- [onblur](input._internal_.SVGForeignObjectElement.md#onblur)
- [oncanplay](input._internal_.SVGForeignObjectElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGForeignObjectElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGForeignObjectElement.md#onchange)
- [onclick](input._internal_.SVGForeignObjectElement.md#onclick)
- [onclose](input._internal_.SVGForeignObjectElement.md#onclose)
- [oncontextmenu](input._internal_.SVGForeignObjectElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGForeignObjectElement.md#oncopy)
- [oncuechange](input._internal_.SVGForeignObjectElement.md#oncuechange)
- [oncut](input._internal_.SVGForeignObjectElement.md#oncut)
- [ondblclick](input._internal_.SVGForeignObjectElement.md#ondblclick)
- [ondrag](input._internal_.SVGForeignObjectElement.md#ondrag)
- [ondragend](input._internal_.SVGForeignObjectElement.md#ondragend)
- [ondragenter](input._internal_.SVGForeignObjectElement.md#ondragenter)
- [ondragleave](input._internal_.SVGForeignObjectElement.md#ondragleave)
- [ondragover](input._internal_.SVGForeignObjectElement.md#ondragover)
- [ondragstart](input._internal_.SVGForeignObjectElement.md#ondragstart)
- [ondrop](input._internal_.SVGForeignObjectElement.md#ondrop)
- [ondurationchange](input._internal_.SVGForeignObjectElement.md#ondurationchange)
- [onemptied](input._internal_.SVGForeignObjectElement.md#onemptied)
- [onended](input._internal_.SVGForeignObjectElement.md#onended)
- [onerror](input._internal_.SVGForeignObjectElement.md#onerror)
- [onfocus](input._internal_.SVGForeignObjectElement.md#onfocus)
- [onformdata](input._internal_.SVGForeignObjectElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGForeignObjectElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGForeignObjectElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGForeignObjectElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGForeignObjectElement.md#oninput)
- [oninvalid](input._internal_.SVGForeignObjectElement.md#oninvalid)
- [onkeydown](input._internal_.SVGForeignObjectElement.md#onkeydown)
- [onkeypress](input._internal_.SVGForeignObjectElement.md#onkeypress)
- [onkeyup](input._internal_.SVGForeignObjectElement.md#onkeyup)
- [onload](input._internal_.SVGForeignObjectElement.md#onload)
- [onloadeddata](input._internal_.SVGForeignObjectElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGForeignObjectElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGForeignObjectElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGForeignObjectElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGForeignObjectElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGForeignObjectElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGForeignObjectElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGForeignObjectElement.md#onmousemove)
- [onmouseout](input._internal_.SVGForeignObjectElement.md#onmouseout)
- [onmouseover](input._internal_.SVGForeignObjectElement.md#onmouseover)
- [onmouseup](input._internal_.SVGForeignObjectElement.md#onmouseup)
- [onpaste](input._internal_.SVGForeignObjectElement.md#onpaste)
- [onpause](input._internal_.SVGForeignObjectElement.md#onpause)
- [onplay](input._internal_.SVGForeignObjectElement.md#onplay)
- [onplaying](input._internal_.SVGForeignObjectElement.md#onplaying)
- [onpointercancel](input._internal_.SVGForeignObjectElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGForeignObjectElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGForeignObjectElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGForeignObjectElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGForeignObjectElement.md#onpointermove)
- [onpointerout](input._internal_.SVGForeignObjectElement.md#onpointerout)
- [onpointerover](input._internal_.SVGForeignObjectElement.md#onpointerover)
- [onpointerup](input._internal_.SVGForeignObjectElement.md#onpointerup)
- [onprogress](input._internal_.SVGForeignObjectElement.md#onprogress)
- [onratechange](input._internal_.SVGForeignObjectElement.md#onratechange)
- [onreset](input._internal_.SVGForeignObjectElement.md#onreset)
- [onresize](input._internal_.SVGForeignObjectElement.md#onresize)
- [onscroll](input._internal_.SVGForeignObjectElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGForeignObjectElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGForeignObjectElement.md#onseeked)
- [onseeking](input._internal_.SVGForeignObjectElement.md#onseeking)
- [onselect](input._internal_.SVGForeignObjectElement.md#onselect)
- [onselectionchange](input._internal_.SVGForeignObjectElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGForeignObjectElement.md#onselectstart)
- [onslotchange](input._internal_.SVGForeignObjectElement.md#onslotchange)
- [onstalled](input._internal_.SVGForeignObjectElement.md#onstalled)
- [onsubmit](input._internal_.SVGForeignObjectElement.md#onsubmit)
- [onsuspend](input._internal_.SVGForeignObjectElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGForeignObjectElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGForeignObjectElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGForeignObjectElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGForeignObjectElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGForeignObjectElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGForeignObjectElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGForeignObjectElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGForeignObjectElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGForeignObjectElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGForeignObjectElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGForeignObjectElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGForeignObjectElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGForeignObjectElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGForeignObjectElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGForeignObjectElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGForeignObjectElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGForeignObjectElement.md#onwheel)
- [outerHTML](input._internal_.SVGForeignObjectElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGForeignObjectElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGForeignObjectElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGForeignObjectElement.md#parentelement)
- [parentNode](input._internal_.SVGForeignObjectElement.md#parentnode)
- [part](input._internal_.SVGForeignObjectElement.md#part)
- [prefix](input._internal_.SVGForeignObjectElement.md#prefix)
- [previousElementSibling](input._internal_.SVGForeignObjectElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGForeignObjectElement.md#previoussibling)
- [requiredExtensions](input._internal_.SVGForeignObjectElement.md#requiredextensions)
- [scrollHeight](input._internal_.SVGForeignObjectElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGForeignObjectElement.md#scrollleft)
- [scrollTop](input._internal_.SVGForeignObjectElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGForeignObjectElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGForeignObjectElement.md#shadowroot)
- [slot](input._internal_.SVGForeignObjectElement.md#slot)
- [style](input._internal_.SVGForeignObjectElement.md#style)
- [systemLanguage](input._internal_.SVGForeignObjectElement.md#systemlanguage)
- [tabIndex](input._internal_.SVGForeignObjectElement.md#tabindex)
- [tagName](input._internal_.SVGForeignObjectElement.md#tagname)
- [textContent](input._internal_.SVGForeignObjectElement.md#textcontent)
- [transform](input._internal_.SVGForeignObjectElement.md#transform)
- [viewportElement](input._internal_.SVGForeignObjectElement.md#viewportelement)
- [width](input._internal_.SVGForeignObjectElement.md#width)
- [x](input._internal_.SVGForeignObjectElement.md#x)
- [y](input._internal_.SVGForeignObjectElement.md#y)

### Methods

- [addEventListener](input._internal_.SVGForeignObjectElement.md#addeventlistener)
- [after](input._internal_.SVGForeignObjectElement.md#after)
- [animate](input._internal_.SVGForeignObjectElement.md#animate)
- [append](input._internal_.SVGForeignObjectElement.md#append)
- [appendChild](input._internal_.SVGForeignObjectElement.md#appendchild)
- [attachShadow](input._internal_.SVGForeignObjectElement.md#attachshadow)
- [before](input._internal_.SVGForeignObjectElement.md#before)
- [blur](input._internal_.SVGForeignObjectElement.md#blur)
- [cloneNode](input._internal_.SVGForeignObjectElement.md#clonenode)
- [closest](input._internal_.SVGForeignObjectElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGForeignObjectElement.md#comparedocumentposition)
- [contains](input._internal_.SVGForeignObjectElement.md#contains)
- [dispatchEvent](input._internal_.SVGForeignObjectElement.md#dispatchevent)
- [focus](input._internal_.SVGForeignObjectElement.md#focus)
- [getAnimations](input._internal_.SVGForeignObjectElement.md#getanimations)
- [getAttribute](input._internal_.SVGForeignObjectElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGForeignObjectElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGForeignObjectElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGForeignObjectElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGForeignObjectElement.md#getattributenodens)
- [getBBox](input._internal_.SVGForeignObjectElement.md#getbbox)
- [getBoundingClientRect](input._internal_.SVGForeignObjectElement.md#getboundingclientrect)
- [getCTM](input._internal_.SVGForeignObjectElement.md#getctm)
- [getClientRects](input._internal_.SVGForeignObjectElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGForeignObjectElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGForeignObjectElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGForeignObjectElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGForeignObjectElement.md#getrootnode)
- [getScreenCTM](input._internal_.SVGForeignObjectElement.md#getscreenctm)
- [hasAttribute](input._internal_.SVGForeignObjectElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGForeignObjectElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGForeignObjectElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGForeignObjectElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGForeignObjectElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGForeignObjectElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGForeignObjectElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGForeignObjectElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGForeignObjectElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGForeignObjectElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGForeignObjectElement.md#isequalnode)
- [isSameNode](input._internal_.SVGForeignObjectElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGForeignObjectElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGForeignObjectElement.md#lookupprefix)
- [matches](input._internal_.SVGForeignObjectElement.md#matches)
- [normalize](input._internal_.SVGForeignObjectElement.md#normalize)
- [prepend](input._internal_.SVGForeignObjectElement.md#prepend)
- [querySelector](input._internal_.SVGForeignObjectElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGForeignObjectElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGForeignObjectElement.md#releasepointercapture)
- [remove](input._internal_.SVGForeignObjectElement.md#remove)
- [removeAttribute](input._internal_.SVGForeignObjectElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGForeignObjectElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGForeignObjectElement.md#removeattributenode)
- [removeChild](input._internal_.SVGForeignObjectElement.md#removechild)
- [removeEventListener](input._internal_.SVGForeignObjectElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGForeignObjectElement.md#replacechild)
- [replaceChildren](input._internal_.SVGForeignObjectElement.md#replacechildren)
- [replaceWith](input._internal_.SVGForeignObjectElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGForeignObjectElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGForeignObjectElement.md#requestpointerlock)
- [scroll](input._internal_.SVGForeignObjectElement.md#scroll)
- [scrollBy](input._internal_.SVGForeignObjectElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGForeignObjectElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGForeignObjectElement.md#scrollto)
- [setAttribute](input._internal_.SVGForeignObjectElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGForeignObjectElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGForeignObjectElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGForeignObjectElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGForeignObjectElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGForeignObjectElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGForeignObjectElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGForeignObjectElement`](../modules/input._internal_.md#svgforeignobjectelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
