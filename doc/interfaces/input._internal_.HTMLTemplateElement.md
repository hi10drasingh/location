[Droom Google Location Plugin - v1.0.11](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLTemplateElement

# Interface: HTMLTemplateElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLTemplateElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLTemplateElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLTemplateElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLTemplateElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLTemplateElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLTemplateElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLTemplateElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLTemplateElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLTemplateElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLTemplateElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLTemplateElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLTemplateElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLTemplateElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLTemplateElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLTemplateElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLTemplateElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLTemplateElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLTemplateElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLTemplateElement.md#text_node)
- [accessKey](input._internal_.HTMLTemplateElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLTemplateElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLTemplateElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLTemplateElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLTemplateElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLTemplateElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLTemplateElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLTemplateElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLTemplateElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLTemplateElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLTemplateElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLTemplateElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLTemplateElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLTemplateElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLTemplateElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLTemplateElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLTemplateElement.md#arialevel)
- [ariaLive](input._internal_.HTMLTemplateElement.md#arialive)
- [ariaModal](input._internal_.HTMLTemplateElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLTemplateElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLTemplateElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLTemplateElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLTemplateElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLTemplateElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLTemplateElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLTemplateElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLTemplateElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLTemplateElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLTemplateElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLTemplateElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLTemplateElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLTemplateElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLTemplateElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLTemplateElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLTemplateElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLTemplateElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLTemplateElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLTemplateElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLTemplateElement.md#assignedslot)
- [attributes](input._internal_.HTMLTemplateElement.md#attributes)
- [autocapitalize](input._internal_.HTMLTemplateElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLTemplateElement.md#autofocus)
- [baseURI](input._internal_.HTMLTemplateElement.md#baseuri)
- [childElementCount](input._internal_.HTMLTemplateElement.md#childelementcount)
- [childNodes](input._internal_.HTMLTemplateElement.md#childnodes)
- [children](input._internal_.HTMLTemplateElement.md#children)
- [classList](input._internal_.HTMLTemplateElement.md#classlist)
- [className](input._internal_.HTMLTemplateElement.md#classname)
- [clientHeight](input._internal_.HTMLTemplateElement.md#clientheight)
- [clientLeft](input._internal_.HTMLTemplateElement.md#clientleft)
- [clientTop](input._internal_.HTMLTemplateElement.md#clienttop)
- [clientWidth](input._internal_.HTMLTemplateElement.md#clientwidth)
- [content](input._internal_.HTMLTemplateElement.md#content)
- [contentEditable](input._internal_.HTMLTemplateElement.md#contenteditable)
- [dataset](input._internal_.HTMLTemplateElement.md#dataset)
- [dir](input._internal_.HTMLTemplateElement.md#dir)
- [draggable](input._internal_.HTMLTemplateElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLTemplateElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLTemplateElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLTemplateElement.md#firstelementchild)
- [hidden](input._internal_.HTMLTemplateElement.md#hidden)
- [id](input._internal_.HTMLTemplateElement.md#id)
- [innerHTML](input._internal_.HTMLTemplateElement.md#innerhtml)
- [innerText](input._internal_.HTMLTemplateElement.md#innertext)
- [inputMode](input._internal_.HTMLTemplateElement.md#inputmode)
- [isConnected](input._internal_.HTMLTemplateElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLTemplateElement.md#iscontenteditable)
- [lang](input._internal_.HTMLTemplateElement.md#lang)
- [lastChild](input._internal_.HTMLTemplateElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLTemplateElement.md#lastelementchild)
- [localName](input._internal_.HTMLTemplateElement.md#localname)
- [namespaceURI](input._internal_.HTMLTemplateElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLTemplateElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLTemplateElement.md#nextsibling)
- [nodeName](input._internal_.HTMLTemplateElement.md#nodename)
- [nodeType](input._internal_.HTMLTemplateElement.md#nodetype)
- [nodeValue](input._internal_.HTMLTemplateElement.md#nodevalue)
- [nonce](input._internal_.HTMLTemplateElement.md#nonce)
- [offsetHeight](input._internal_.HTMLTemplateElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLTemplateElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLTemplateElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLTemplateElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLTemplateElement.md#offsetwidth)
- [onabort](input._internal_.HTMLTemplateElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLTemplateElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLTemplateElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLTemplateElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLTemplateElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLTemplateElement.md#onauxclick)
- [onblur](input._internal_.HTMLTemplateElement.md#onblur)
- [oncanplay](input._internal_.HTMLTemplateElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLTemplateElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLTemplateElement.md#onchange)
- [onclick](input._internal_.HTMLTemplateElement.md#onclick)
- [onclose](input._internal_.HTMLTemplateElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLTemplateElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLTemplateElement.md#oncopy)
- [oncuechange](input._internal_.HTMLTemplateElement.md#oncuechange)
- [oncut](input._internal_.HTMLTemplateElement.md#oncut)
- [ondblclick](input._internal_.HTMLTemplateElement.md#ondblclick)
- [ondrag](input._internal_.HTMLTemplateElement.md#ondrag)
- [ondragend](input._internal_.HTMLTemplateElement.md#ondragend)
- [ondragenter](input._internal_.HTMLTemplateElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLTemplateElement.md#ondragleave)
- [ondragover](input._internal_.HTMLTemplateElement.md#ondragover)
- [ondragstart](input._internal_.HTMLTemplateElement.md#ondragstart)
- [ondrop](input._internal_.HTMLTemplateElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLTemplateElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLTemplateElement.md#onemptied)
- [onended](input._internal_.HTMLTemplateElement.md#onended)
- [onerror](input._internal_.HTMLTemplateElement.md#onerror)
- [onfocus](input._internal_.HTMLTemplateElement.md#onfocus)
- [onformdata](input._internal_.HTMLTemplateElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLTemplateElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLTemplateElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLTemplateElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLTemplateElement.md#oninput)
- [oninvalid](input._internal_.HTMLTemplateElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLTemplateElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLTemplateElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLTemplateElement.md#onkeyup)
- [onload](input._internal_.HTMLTemplateElement.md#onload)
- [onloadeddata](input._internal_.HTMLTemplateElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLTemplateElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLTemplateElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLTemplateElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLTemplateElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLTemplateElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLTemplateElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLTemplateElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLTemplateElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLTemplateElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLTemplateElement.md#onmouseup)
- [onpaste](input._internal_.HTMLTemplateElement.md#onpaste)
- [onpause](input._internal_.HTMLTemplateElement.md#onpause)
- [onplay](input._internal_.HTMLTemplateElement.md#onplay)
- [onplaying](input._internal_.HTMLTemplateElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLTemplateElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLTemplateElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLTemplateElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLTemplateElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLTemplateElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLTemplateElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLTemplateElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLTemplateElement.md#onpointerup)
- [onprogress](input._internal_.HTMLTemplateElement.md#onprogress)
- [onratechange](input._internal_.HTMLTemplateElement.md#onratechange)
- [onreset](input._internal_.HTMLTemplateElement.md#onreset)
- [onresize](input._internal_.HTMLTemplateElement.md#onresize)
- [onscroll](input._internal_.HTMLTemplateElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLTemplateElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLTemplateElement.md#onseeked)
- [onseeking](input._internal_.HTMLTemplateElement.md#onseeking)
- [onselect](input._internal_.HTMLTemplateElement.md#onselect)
- [onselectionchange](input._internal_.HTMLTemplateElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLTemplateElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLTemplateElement.md#onslotchange)
- [onstalled](input._internal_.HTMLTemplateElement.md#onstalled)
- [onsubmit](input._internal_.HTMLTemplateElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLTemplateElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLTemplateElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLTemplateElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLTemplateElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLTemplateElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLTemplateElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLTemplateElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLTemplateElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLTemplateElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLTemplateElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLTemplateElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLTemplateElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLTemplateElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLTemplateElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLTemplateElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLTemplateElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLTemplateElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLTemplateElement.md#onwheel)
- [outerHTML](input._internal_.HTMLTemplateElement.md#outerhtml)
- [outerText](input._internal_.HTMLTemplateElement.md#outertext)
- [ownerDocument](input._internal_.HTMLTemplateElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLTemplateElement.md#parentelement)
- [parentNode](input._internal_.HTMLTemplateElement.md#parentnode)
- [part](input._internal_.HTMLTemplateElement.md#part)
- [prefix](input._internal_.HTMLTemplateElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLTemplateElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLTemplateElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLTemplateElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLTemplateElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLTemplateElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLTemplateElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLTemplateElement.md#shadowroot)
- [slot](input._internal_.HTMLTemplateElement.md#slot)
- [spellcheck](input._internal_.HTMLTemplateElement.md#spellcheck)
- [style](input._internal_.HTMLTemplateElement.md#style)
- [tabIndex](input._internal_.HTMLTemplateElement.md#tabindex)
- [tagName](input._internal_.HTMLTemplateElement.md#tagname)
- [textContent](input._internal_.HTMLTemplateElement.md#textcontent)
- [title](input._internal_.HTMLTemplateElement.md#title)
- [translate](input._internal_.HTMLTemplateElement.md#translate)

### Methods

- [addEventListener](input._internal_.HTMLTemplateElement.md#addeventlistener)
- [after](input._internal_.HTMLTemplateElement.md#after)
- [animate](input._internal_.HTMLTemplateElement.md#animate)
- [append](input._internal_.HTMLTemplateElement.md#append)
- [appendChild](input._internal_.HTMLTemplateElement.md#appendchild)
- [attachInternals](input._internal_.HTMLTemplateElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLTemplateElement.md#attachshadow)
- [before](input._internal_.HTMLTemplateElement.md#before)
- [blur](input._internal_.HTMLTemplateElement.md#blur)
- [click](input._internal_.HTMLTemplateElement.md#click)
- [cloneNode](input._internal_.HTMLTemplateElement.md#clonenode)
- [closest](input._internal_.HTMLTemplateElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLTemplateElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLTemplateElement.md#contains)
- [dispatchEvent](input._internal_.HTMLTemplateElement.md#dispatchevent)
- [focus](input._internal_.HTMLTemplateElement.md#focus)
- [getAnimations](input._internal_.HTMLTemplateElement.md#getanimations)
- [getAttribute](input._internal_.HTMLTemplateElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLTemplateElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLTemplateElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLTemplateElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLTemplateElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLTemplateElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLTemplateElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLTemplateElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLTemplateElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLTemplateElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLTemplateElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLTemplateElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLTemplateElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLTemplateElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLTemplateElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLTemplateElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLTemplateElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLTemplateElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLTemplateElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLTemplateElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLTemplateElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLTemplateElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLTemplateElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLTemplateElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLTemplateElement.md#lookupprefix)
- [matches](input._internal_.HTMLTemplateElement.md#matches)
- [normalize](input._internal_.HTMLTemplateElement.md#normalize)
- [prepend](input._internal_.HTMLTemplateElement.md#prepend)
- [querySelector](input._internal_.HTMLTemplateElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLTemplateElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLTemplateElement.md#releasepointercapture)
- [remove](input._internal_.HTMLTemplateElement.md#remove)
- [removeAttribute](input._internal_.HTMLTemplateElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLTemplateElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLTemplateElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLTemplateElement.md#removechild)
- [removeEventListener](input._internal_.HTMLTemplateElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLTemplateElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLTemplateElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLTemplateElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLTemplateElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLTemplateElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLTemplateElement.md#scroll)
- [scrollBy](input._internal_.HTMLTemplateElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLTemplateElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLTemplateElement.md#scrollto)
- [setAttribute](input._internal_.HTMLTemplateElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLTemplateElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLTemplateElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLTemplateElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLTemplateElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLTemplateElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLTemplateElement.md#webkitmatchesselector)
...
• `Readonly` **content**: [`DocumentFragment`](../modules/input._internal_.md#documentfragment)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLTemplateElement`](../modules/input._internal_.md#htmltemplateelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
