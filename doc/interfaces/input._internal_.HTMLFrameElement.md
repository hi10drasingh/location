[Droom Google Location Plugin - v1.0.11](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLFrameElement

# Interface: HTMLFrameElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLFrameElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLFrameElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLFrameElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLFrameElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLFrameElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLFrameElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLFrameElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLFrameElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLFrameElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLFrameElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLFrameElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLFrameElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLFrameElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLFrameElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLFrameElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLFrameElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLFrameElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLFrameElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLFrameElement.md#text_node)
- [accessKey](input._internal_.HTMLFrameElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLFrameElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLFrameElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLFrameElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLFrameElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLFrameElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLFrameElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLFrameElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLFrameElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLFrameElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLFrameElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLFrameElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLFrameElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLFrameElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLFrameElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLFrameElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLFrameElement.md#arialevel)
- [ariaLive](input._internal_.HTMLFrameElement.md#arialive)
- [ariaModal](input._internal_.HTMLFrameElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLFrameElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLFrameElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLFrameElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLFrameElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLFrameElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLFrameElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLFrameElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLFrameElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLFrameElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLFrameElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLFrameElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLFrameElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLFrameElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLFrameElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLFrameElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLFrameElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLFrameElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLFrameElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLFrameElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLFrameElement.md#assignedslot)
- [attributes](input._internal_.HTMLFrameElement.md#attributes)
- [autocapitalize](input._internal_.HTMLFrameElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLFrameElement.md#autofocus)
- [baseURI](input._internal_.HTMLFrameElement.md#baseuri)
- [childElementCount](input._internal_.HTMLFrameElement.md#childelementcount)
- [childNodes](input._internal_.HTMLFrameElement.md#childnodes)
- [children](input._internal_.HTMLFrameElement.md#children)
- [classList](input._internal_.HTMLFrameElement.md#classlist)
- [className](input._internal_.HTMLFrameElement.md#classname)
- [clientHeight](input._internal_.HTMLFrameElement.md#clientheight)
- [clientLeft](input._internal_.HTMLFrameElement.md#clientleft)
- [clientTop](input._internal_.HTMLFrameElement.md#clienttop)
- [clientWidth](input._internal_.HTMLFrameElement.md#clientwidth)
- [contentDocument](input._internal_.HTMLFrameElement.md#contentdocument)
- [contentEditable](input._internal_.HTMLFrameElement.md#contenteditable)
- [contentWindow](input._internal_.HTMLFrameElement.md#contentwindow)
- [dataset](input._internal_.HTMLFrameElement.md#dataset)
- [dir](input._internal_.HTMLFrameElement.md#dir)
- [draggable](input._internal_.HTMLFrameElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLFrameElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLFrameElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLFrameElement.md#firstelementchild)
- [frameBorder](input._internal_.HTMLFrameElement.md#frameborder)
- [hidden](input._internal_.HTMLFrameElement.md#hidden)
- [id](input._internal_.HTMLFrameElement.md#id)
- [innerHTML](input._internal_.HTMLFrameElement.md#innerhtml)
- [innerText](input._internal_.HTMLFrameElement.md#innertext)
- [inputMode](input._internal_.HTMLFrameElement.md#inputmode)
- [isConnected](input._internal_.HTMLFrameElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLFrameElement.md#iscontenteditable)
- [lang](input._internal_.HTMLFrameElement.md#lang)
- [lastChild](input._internal_.HTMLFrameElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLFrameElement.md#lastelementchild)
- [localName](input._internal_.HTMLFrameElement.md#localname)
- [longDesc](input._internal_.HTMLFrameElement.md#longdesc)
- [marginHeight](input._internal_.HTMLFrameElement.md#marginheight)
- [marginWidth](input._internal_.HTMLFrameElement.md#marginwidth)
- [name](input._internal_.HTMLFrameElement.md#name)
- [namespaceURI](input._internal_.HTMLFrameElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLFrameElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLFrameElement.md#nextsibling)
- [noResize](input._internal_.HTMLFrameElement.md#noresize)
- [nodeName](input._internal_.HTMLFrameElement.md#nodename)
- [nodeType](input._internal_.HTMLFrameElement.md#nodetype)
- [nodeValue](input._internal_.HTMLFrameElement.md#nodevalue)
- [nonce](input._internal_.HTMLFrameElement.md#nonce)
- [offsetHeight](input._internal_.HTMLFrameElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLFrameElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLFrameElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLFrameElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLFrameElement.md#offsetwidth)
- [onabort](input._internal_.HTMLFrameElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLFrameElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLFrameElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLFrameElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLFrameElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLFrameElement.md#onauxclick)
- [onblur](input._internal_.HTMLFrameElement.md#onblur)
- [oncanplay](input._internal_.HTMLFrameElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLFrameElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLFrameElement.md#onchange)
- [onclick](input._internal_.HTMLFrameElement.md#onclick)
- [onclose](input._internal_.HTMLFrameElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLFrameElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLFrameElement.md#oncopy)
- [oncuechange](input._internal_.HTMLFrameElement.md#oncuechange)
- [oncut](input._internal_.HTMLFrameElement.md#oncut)
- [ondblclick](input._internal_.HTMLFrameElement.md#ondblclick)
- [ondrag](input._internal_.HTMLFrameElement.md#ondrag)
- [ondragend](input._internal_.HTMLFrameElement.md#ondragend)
- [ondragenter](input._internal_.HTMLFrameElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLFrameElement.md#ondragleave)
- [ondragover](input._internal_.HTMLFrameElement.md#ondragover)
- [ondragstart](input._internal_.HTMLFrameElement.md#ondragstart)
- [ondrop](input._internal_.HTMLFrameElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLFrameElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLFrameElement.md#onemptied)
- [onended](input._internal_.HTMLFrameElement.md#onended)
- [onerror](input._internal_.HTMLFrameElement.md#onerror)
- [onfocus](input._internal_.HTMLFrameElement.md#onfocus)
- [onformdata](input._internal_.HTMLFrameElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLFrameElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLFrameElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLFrameElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLFrameElement.md#oninput)
- [oninvalid](input._internal_.HTMLFrameElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLFrameElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLFrameElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLFrameElement.md#onkeyup)
- [onload](input._internal_.HTMLFrameElement.md#onload)
- [onloadeddata](input._internal_.HTMLFrameElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLFrameElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLFrameElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLFrameElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLFrameElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLFrameElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLFrameElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLFrameElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLFrameElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLFrameElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLFrameElement.md#onmouseup)
- [onpaste](input._internal_.HTMLFrameElement.md#onpaste)
- [onpause](input._internal_.HTMLFrameElement.md#onpause)
- [onplay](input._internal_.HTMLFrameElement.md#onplay)
- [onplaying](input._internal_.HTMLFrameElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLFrameElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLFrameElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLFrameElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLFrameElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLFrameElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLFrameElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLFrameElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLFrameElement.md#onpointerup)
- [onprogress](input._internal_.HTMLFrameElement.md#onprogress)
- [onratechange](input._internal_.HTMLFrameElement.md#onratechange)
- [onreset](input._internal_.HTMLFrameElement.md#onreset)
- [onresize](input._internal_.HTMLFrameElement.md#onresize)
- [onscroll](input._internal_.HTMLFrameElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLFrameElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLFrameElement.md#onseeked)
- [onseeking](input._internal_.HTMLFrameElement.md#onseeking)
- [onselect](input._internal_.HTMLFrameElement.md#onselect)
- [onselectionchange](input._internal_.HTMLFrameElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLFrameElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLFrameElement.md#onslotchange)
- [onstalled](input._internal_.HTMLFrameElement.md#onstalled)
- [onsubmit](input._internal_.HTMLFrameElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLFrameElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLFrameElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLFrameElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLFrameElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLFrameElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLFrameElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLFrameElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLFrameElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLFrameElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLFrameElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLFrameElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLFrameElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLFrameElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLFrameElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLFrameElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLFrameElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLFrameElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLFrameElement.md#onwheel)
- [outerHTML](input._internal_.HTMLFrameElement.md#outerhtml)
- [outerText](input._internal_.HTMLFrameElement.md#outertext)
- [ownerDocument](input._internal_.HTMLFrameElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLFrameElement.md#parentelement)
- [parentNode](input._internal_.HTMLFrameElement.md#parentnode)
- [part](input._internal_.HTMLFrameElement.md#part)
- [prefix](input._internal_.HTMLFrameElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLFrameElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLFrameElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLFrameElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLFrameElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLFrameElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLFrameElement.md#scrollwidth)
- [scrolling](input._internal_.HTMLFrameElement.md#scrolling)
- [shadowRoot](input._internal_.HTMLFrameElement.md#shadowroot)
- [slot](input._internal_.HTMLFrameElement.md#slot)
- [spellcheck](input._internal_.HTMLFrameElement.md#spellcheck)
- [src](input._internal_.HTMLFrameElement.md#src)
- [style](input._internal_.HTMLFrameElement.md#style)
- [tabIndex](input._internal_.HTMLFrameElement.md#tabindex)
- [tagName](input._internal_.HTMLFrameElement.md#tagname)
- [textContent](input._internal_.HTMLFrameElement.md#textcontent)
- [title](input._internal_.HTMLFrameElement.md#title)
- [translate](input._internal_.HTMLFrameElement.md#translate)

### Methods

- [addEventListener](input._internal_.HTMLFrameElement.md#addeventlistener)
- [after](input._internal_.HTMLFrameElement.md#after)
- [animate](input._internal_.HTMLFrameElement.md#animate)
- [append](input._internal_.HTMLFrameElement.md#append)
- [appendChild](input._internal_.HTMLFrameElement.md#appendchild)
- [attachInternals](input._internal_.HTMLFrameElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLFrameElement.md#attachshadow)
- [before](input._internal_.HTMLFrameElement.md#before)
- [blur](input._internal_.HTMLFrameElement.md#blur)
- [click](input._internal_.HTMLFrameElement.md#click)
- [cloneNode](input._internal_.HTMLFrameElement.md#clonenode)
- [closest](input._internal_.HTMLFrameElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLFrameElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLFrameElement.md#contains)
- [dispatchEvent](input._internal_.HTMLFrameElement.md#dispatchevent)
- [focus](input._internal_.HTMLFrameElement.md#focus)
- [getAnimations](input._internal_.HTMLFrameElement.md#getanimations)
- [getAttribute](input._internal_.HTMLFrameElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLFrameElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLFrameElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLFrameElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLFrameElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLFrameElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLFrameElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLFrameElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLFrameElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLFrameElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLFrameElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLFrameElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLFrameElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLFrameElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLFrameElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLFrameElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLFrameElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLFrameElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLFrameElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLFrameElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLFrameElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLFrameElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLFrameElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLFrameElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLFrameElement.md#lookupprefix)
- [matches](input._internal_.HTMLFrameElement.md#matches)
- [normalize](input._internal_.HTMLFrameElement.md#normalize)
- [prepend](input._internal_.HTMLFrameElement.md#prepend)
- [querySelector](input._internal_.HTMLFrameElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLFrameElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLFrameElement.md#releasepointercapture)
- [remove](input._internal_.HTMLFrameElement.md#remove)
- [removeAttribute](input._internal_.HTMLFrameElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLFrameElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLFrameElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLFrameElement.md#removechild)
- [removeEventListener](input._internal_.HTMLFrameElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLFrameElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLFrameElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLFrameElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLFrameElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLFrameElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLFrameElement.md#scroll)
- [scrollBy](input._internal_.HTMLFrameElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLFrameElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLFrameElement.md#scrollto)
- [setAttribute](input._internal_.HTMLFrameElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLFrameElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLFrameElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLFrameElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLFrameElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLFrameElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLFrameElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLFrameElement`](../modules/input._internal_.md#htmlframeelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
