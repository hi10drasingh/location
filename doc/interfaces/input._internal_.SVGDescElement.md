[Droom Google Location Plugin - v1.0.16](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGDescElement

# Interface: SVGDescElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGDescElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGDescElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGDescElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGDescElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGDescElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGDescElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGDescElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGDescElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGDescElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGDescElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGDescElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGDescElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGDescElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGDescElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGDescElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGDescElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGDescElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGDescElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGDescElement.md#text_node)
- [ariaAtomic](input._internal_.SVGDescElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGDescElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGDescElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGDescElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGDescElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGDescElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGDescElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGDescElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGDescElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGDescElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGDescElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGDescElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGDescElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGDescElement.md#arialabel)
- [ariaLevel](input._internal_.SVGDescElement.md#arialevel)
- [ariaLive](input._internal_.SVGDescElement.md#arialive)
- [ariaModal](input._internal_.SVGDescElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGDescElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGDescElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGDescElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGDescElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGDescElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGDescElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGDescElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGDescElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGDescElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGDescElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGDescElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGDescElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGDescElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGDescElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGDescElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGDescElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGDescElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGDescElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGDescElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGDescElement.md#assignedslot)
- [attributes](input._internal_.SVGDescElement.md#attributes)
- [autofocus](input._internal_.SVGDescElement.md#autofocus)
- [baseURI](input._internal_.SVGDescElement.md#baseuri)
- [childElementCount](input._internal_.SVGDescElement.md#childelementcount)
- [childNodes](input._internal_.SVGDescElement.md#childnodes)
- [children](input._internal_.SVGDescElement.md#children)
- [classList](input._internal_.SVGDescElement.md#classlist)
- [className](input._internal_.SVGDescElement.md#classname)
- [clientHeight](input._internal_.SVGDescElement.md#clientheight)
- [clientLeft](input._internal_.SVGDescElement.md#clientleft)
- [clientTop](input._internal_.SVGDescElement.md#clienttop)
- [clientWidth](input._internal_.SVGDescElement.md#clientwidth)
- [dataset](input._internal_.SVGDescElement.md#dataset)
- [firstChild](input._internal_.SVGDescElement.md#firstchild)
- [firstElementChild](input._internal_.SVGDescElement.md#firstelementchild)
- [id](input._internal_.SVGDescElement.md#id)
- [innerHTML](input._internal_.SVGDescElement.md#innerhtml)
- [isConnected](input._internal_.SVGDescElement.md#isconnected)
- [lastChild](input._internal_.SVGDescElement.md#lastchild)
- [lastElementChild](input._internal_.SVGDescElement.md#lastelementchild)
- [localName](input._internal_.SVGDescElement.md#localname)
- [namespaceURI](input._internal_.SVGDescElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGDescElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGDescElement.md#nextsibling)
- [nodeName](input._internal_.SVGDescElement.md#nodename)
- [nodeType](input._internal_.SVGDescElement.md#nodetype)
- [nodeValue](input._internal_.SVGDescElement.md#nodevalue)
- [nonce](input._internal_.SVGDescElement.md#nonce)
- [onabort](input._internal_.SVGDescElement.md#onabort)
- [onanimationcancel](input._internal_.SVGDescElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGDescElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGDescElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGDescElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGDescElement.md#onauxclick)
- [onblur](input._internal_.SVGDescElement.md#onblur)
- [oncanplay](input._internal_.SVGDescElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGDescElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGDescElement.md#onchange)
- [onclick](input._internal_.SVGDescElement.md#onclick)
- [onclose](input._internal_.SVGDescElement.md#onclose)
- [oncontextmenu](input._internal_.SVGDescElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGDescElement.md#oncopy)
- [oncuechange](input._internal_.SVGDescElement.md#oncuechange)
- [oncut](input._internal_.SVGDescElement.md#oncut)
- [ondblclick](input._internal_.SVGDescElement.md#ondblclick)
- [ondrag](input._internal_.SVGDescElement.md#ondrag)
- [ondragend](input._internal_.SVGDescElement.md#ondragend)
- [ondragenter](input._internal_.SVGDescElement.md#ondragenter)
- [ondragleave](input._internal_.SVGDescElement.md#ondragleave)
- [ondragover](input._internal_.SVGDescElement.md#ondragover)
- [ondragstart](input._internal_.SVGDescElement.md#ondragstart)
- [ondrop](input._internal_.SVGDescElement.md#ondrop)
- [ondurationchange](input._internal_.SVGDescElement.md#ondurationchange)
- [onemptied](input._internal_.SVGDescElement.md#onemptied)
- [onended](input._internal_.SVGDescElement.md#onended)
- [onerror](input._internal_.SVGDescElement.md#onerror)
- [onfocus](input._internal_.SVGDescElement.md#onfocus)
- [onformdata](input._internal_.SVGDescElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGDescElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGDescElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGDescElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGDescElement.md#oninput)
- [oninvalid](input._internal_.SVGDescElement.md#oninvalid)
- [onkeydown](input._internal_.SVGDescElement.md#onkeydown)
- [onkeypress](input._internal_.SVGDescElement.md#onkeypress)
- [onkeyup](input._internal_.SVGDescElement.md#onkeyup)
- [onload](input._internal_.SVGDescElement.md#onload)
- [onloadeddata](input._internal_.SVGDescElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGDescElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGDescElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGDescElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGDescElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGDescElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGDescElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGDescElement.md#onmousemove)
- [onmouseout](input._internal_.SVGDescElement.md#onmouseout)
- [onmouseover](input._internal_.SVGDescElement.md#onmouseover)
- [onmouseup](input._internal_.SVGDescElement.md#onmouseup)
- [onpaste](input._internal_.SVGDescElement.md#onpaste)
- [onpause](input._internal_.SVGDescElement.md#onpause)
- [onplay](input._internal_.SVGDescElement.md#onplay)
- [onplaying](input._internal_.SVGDescElement.md#onplaying)
- [onpointercancel](input._internal_.SVGDescElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGDescElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGDescElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGDescElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGDescElement.md#onpointermove)
- [onpointerout](input._internal_.SVGDescElement.md#onpointerout)
- [onpointerover](input._internal_.SVGDescElement.md#onpointerover)
- [onpointerup](input._internal_.SVGDescElement.md#onpointerup)
- [onprogress](input._internal_.SVGDescElement.md#onprogress)
- [onratechange](input._internal_.SVGDescElement.md#onratechange)
- [onreset](input._internal_.SVGDescElement.md#onreset)
- [onresize](input._internal_.SVGDescElement.md#onresize)
- [onscroll](input._internal_.SVGDescElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGDescElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGDescElement.md#onseeked)
- [onseeking](input._internal_.SVGDescElement.md#onseeking)
- [onselect](input._internal_.SVGDescElement.md#onselect)
- [onselectionchange](input._internal_.SVGDescElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGDescElement.md#onselectstart)
- [onslotchange](input._internal_.SVGDescElement.md#onslotchange)
- [onstalled](input._internal_.SVGDescElement.md#onstalled)
- [onsubmit](input._internal_.SVGDescElement.md#onsubmit)
- [onsuspend](input._internal_.SVGDescElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGDescElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGDescElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGDescElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGDescElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGDescElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGDescElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGDescElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGDescElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGDescElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGDescElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGDescElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGDescElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGDescElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGDescElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGDescElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGDescElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGDescElement.md#onwheel)
- [outerHTML](input._internal_.SVGDescElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGDescElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGDescElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGDescElement.md#parentelement)
- [parentNode](input._internal_.SVGDescElement.md#parentnode)
- [part](input._internal_.SVGDescElement.md#part)
- [prefix](input._internal_.SVGDescElement.md#prefix)
- [previousElementSibling](input._internal_.SVGDescElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGDescElement.md#previoussibling)
- [scrollHeight](input._internal_.SVGDescElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGDescElement.md#scrollleft)
- [scrollTop](input._internal_.SVGDescElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGDescElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGDescElement.md#shadowroot)
- [slot](input._internal_.SVGDescElement.md#slot)
- [style](input._internal_.SVGDescElement.md#style)
- [tabIndex](input._internal_.SVGDescElement.md#tabindex)
- [tagName](input._internal_.SVGDescElement.md#tagname)
- [textContent](input._internal_.SVGDescElement.md#textcontent)
- [viewportElement](input._internal_.SVGDescElement.md#viewportelement)

### Methods

- [addEventListener](input._internal_.SVGDescElement.md#addeventlistener)
- [after](input._internal_.SVGDescElement.md#after)
- [animate](input._internal_.SVGDescElement.md#animate)
- [append](input._internal_.SVGDescElement.md#append)
- [appendChild](input._internal_.SVGDescElement.md#appendchild)
- [attachShadow](input._internal_.SVGDescElement.md#attachshadow)
- [before](input._internal_.SVGDescElement.md#before)
- [blur](input._internal_.SVGDescElement.md#blur)
- [cloneNode](input._internal_.SVGDescElement.md#clonenode)
- [closest](input._internal_.SVGDescElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGDescElement.md#comparedocumentposition)
- [contains](input._internal_.SVGDescElement.md#contains)
- [dispatchEvent](input._internal_.SVGDescElement.md#dispatchevent)
- [focus](input._internal_.SVGDescElement.md#focus)
- [getAnimations](input._internal_.SVGDescElement.md#getanimations)
- [getAttribute](input._internal_.SVGDescElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGDescElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGDescElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGDescElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGDescElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.SVGDescElement.md#getboundingclientrect)
- [getClientRects](input._internal_.SVGDescElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGDescElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGDescElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGDescElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGDescElement.md#getrootnode)
- [hasAttribute](input._internal_.SVGDescElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGDescElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGDescElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGDescElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGDescElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGDescElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGDescElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGDescElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGDescElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGDescElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGDescElement.md#isequalnode)
- [isSameNode](input._internal_.SVGDescElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGDescElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGDescElement.md#lookupprefix)
- [matches](input._internal_.SVGDescElement.md#matches)
- [normalize](input._internal_.SVGDescElement.md#normalize)
- [prepend](input._internal_.SVGDescElement.md#prepend)
- [querySelector](input._internal_.SVGDescElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGDescElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGDescElement.md#releasepointercapture)
- [remove](input._internal_.SVGDescElement.md#remove)
- [removeAttribute](input._internal_.SVGDescElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGDescElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGDescElement.md#removeattributenode)
- [removeChild](input._internal_.SVGDescElement.md#removechild)
- [removeEventListener](input._internal_.SVGDescElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGDescElement.md#replacechild)
- [replaceChildren](input._internal_.SVGDescElement.md#replacechildren)
- [replaceWith](input._internal_.SVGDescElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGDescElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGDescElement.md#requestpointerlock)
- [scroll](input._internal_.SVGDescElement.md#scroll)
- [scrollBy](input._internal_.SVGDescElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGDescElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGDescElement.md#scrollto)
- [setAttribute](input._internal_.SVGDescElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGDescElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGDescElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGDescElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGDescElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGDescElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGDescElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGDescElement`](../modules/input._internal_.md#svgdescelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
