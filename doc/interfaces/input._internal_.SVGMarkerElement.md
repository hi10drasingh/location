[Droom Google Location Plugin - v1.0.13](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGMarkerElement

# Interface: SVGMarkerElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGMarkerElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGMarkerElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGMarkerElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGMarkerElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGMarkerElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGMarkerElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGMarkerElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGMarkerElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGMarkerElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGMarkerElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGMarkerElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGMarkerElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGMarkerElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGMarkerElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGMarkerElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGMarkerElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGMarkerElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGMarkerElement.md#processing_instruction_node)
- [SVG\_MARKERUNITS\_STROKEWIDTH](input._internal_.SVGMarkerElement.md#svg_markerunits_strokewidth)
- [SVG\_MARKERUNITS\_UNKNOWN](input._internal_.SVGMarkerElement.md#svg_markerunits_unknown)
- [SVG\_MARKERUNITS\_USERSPACEONUSE](input._internal_.SVGMarkerElement.md#svg_markerunits_userspaceonuse)
- [SVG\_MARKER\_ORIENT\_ANGLE](input._internal_.SVGMarkerElement.md#svg_marker_orient_angle)
- [SVG\_MARKER\_ORIENT\_AUTO](input._internal_.SVGMarkerElement.md#svg_marker_orient_auto)
- [SVG\_MARKER\_ORIENT\_UNKNOWN](input._internal_.SVGMarkerElement.md#svg_marker_orient_unknown)
- [TEXT\_NODE](input._internal_.SVGMarkerElement.md#text_node)
- [ariaAtomic](input._internal_.SVGMarkerElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGMarkerElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGMarkerElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGMarkerElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGMarkerElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGMarkerElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGMarkerElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGMarkerElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGMarkerElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGMarkerElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGMarkerElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGMarkerElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGMarkerElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGMarkerElement.md#arialabel)
- [ariaLevel](input._internal_.SVGMarkerElement.md#arialevel)
- [ariaLive](input._internal_.SVGMarkerElement.md#arialive)
- [ariaModal](input._internal_.SVGMarkerElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGMarkerElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGMarkerElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGMarkerElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGMarkerElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGMarkerElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGMarkerElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGMarkerElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGMarkerElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGMarkerElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGMarkerElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGMarkerElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGMarkerElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGMarkerElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGMarkerElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGMarkerElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGMarkerElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGMarkerElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGMarkerElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGMarkerElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGMarkerElement.md#assignedslot)
- [attributes](input._internal_.SVGMarkerElement.md#attributes)
- [autofocus](input._internal_.SVGMarkerElement.md#autofocus)
- [baseURI](input._internal_.SVGMarkerElement.md#baseuri)
- [childElementCount](input._internal_.SVGMarkerElement.md#childelementcount)
- [childNodes](input._internal_.SVGMarkerElement.md#childnodes)
- [children](input._internal_.SVGMarkerElement.md#children)
- [classList](input._internal_.SVGMarkerElement.md#classlist)
- [className](input._internal_.SVGMarkerElement.md#classname)
- [clientHeight](input._internal_.SVGMarkerElement.md#clientheight)
- [clientLeft](input._internal_.SVGMarkerElement.md#clientleft)
- [clientTop](input._internal_.SVGMarkerElement.md#clienttop)
- [clientWidth](input._internal_.SVGMarkerElement.md#clientwidth)
- [dataset](input._internal_.SVGMarkerElement.md#dataset)
- [firstChild](input._internal_.SVGMarkerElement.md#firstchild)
- [firstElementChild](input._internal_.SVGMarkerElement.md#firstelementchild)
- [id](input._internal_.SVGMarkerElement.md#id)
- [innerHTML](input._internal_.SVGMarkerElement.md#innerhtml)
- [isConnected](input._internal_.SVGMarkerElement.md#isconnected)
- [lastChild](input._internal_.SVGMarkerElement.md#lastchild)
- [lastElementChild](input._internal_.SVGMarkerElement.md#lastelementchild)
- [localName](input._internal_.SVGMarkerElement.md#localname)
- [markerHeight](input._internal_.SVGMarkerElement.md#markerheight)
- [markerUnits](input._internal_.SVGMarkerElement.md#markerunits)
- [markerWidth](input._internal_.SVGMarkerElement.md#markerwidth)
- [namespaceURI](input._internal_.SVGMarkerElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGMarkerElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGMarkerElement.md#nextsibling)
- [nodeName](input._internal_.SVGMarkerElement.md#nodename)
- [nodeType](input._internal_.SVGMarkerElement.md#nodetype)
- [nodeValue](input._internal_.SVGMarkerElement.md#nodevalue)
- [nonce](input._internal_.SVGMarkerElement.md#nonce)
- [onabort](input._internal_.SVGMarkerElement.md#onabort)
- [onanimationcancel](input._internal_.SVGMarkerElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGMarkerElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGMarkerElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGMarkerElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGMarkerElement.md#onauxclick)
- [onblur](input._internal_.SVGMarkerElement.md#onblur)
- [oncanplay](input._internal_.SVGMarkerElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGMarkerElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGMarkerElement.md#onchange)
- [onclick](input._internal_.SVGMarkerElement.md#onclick)
- [onclose](input._internal_.SVGMarkerElement.md#onclose)
- [oncontextmenu](input._internal_.SVGMarkerElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGMarkerElement.md#oncopy)
- [oncuechange](input._internal_.SVGMarkerElement.md#oncuechange)
- [oncut](input._internal_.SVGMarkerElement.md#oncut)
- [ondblclick](input._internal_.SVGMarkerElement.md#ondblclick)
- [ondrag](input._internal_.SVGMarkerElement.md#ondrag)
- [ondragend](input._internal_.SVGMarkerElement.md#ondragend)
- [ondragenter](input._internal_.SVGMarkerElement.md#ondragenter)
- [ondragleave](input._internal_.SVGMarkerElement.md#ondragleave)
- [ondragover](input._internal_.SVGMarkerElement.md#ondragover)
- [ondragstart](input._internal_.SVGMarkerElement.md#ondragstart)
- [ondrop](input._internal_.SVGMarkerElement.md#ondrop)
- [ondurationchange](input._internal_.SVGMarkerElement.md#ondurationchange)
- [onemptied](input._internal_.SVGMarkerElement.md#onemptied)
- [onended](input._internal_.SVGMarkerElement.md#onended)
- [onerror](input._internal_.SVGMarkerElement.md#onerror)
- [onfocus](input._internal_.SVGMarkerElement.md#onfocus)
- [onformdata](input._internal_.SVGMarkerElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGMarkerElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGMarkerElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGMarkerElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGMarkerElement.md#oninput)
- [oninvalid](input._internal_.SVGMarkerElement.md#oninvalid)
- [onkeydown](input._internal_.SVGMarkerElement.md#onkeydown)
- [onkeypress](input._internal_.SVGMarkerElement.md#onkeypress)
- [onkeyup](input._internal_.SVGMarkerElement.md#onkeyup)
- [onload](input._internal_.SVGMarkerElement.md#onload)
- [onloadeddata](input._internal_.SVGMarkerElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGMarkerElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGMarkerElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGMarkerElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGMarkerElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGMarkerElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGMarkerElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGMarkerElement.md#onmousemove)
- [onmouseout](input._internal_.SVGMarkerElement.md#onmouseout)
- [onmouseover](input._internal_.SVGMarkerElement.md#onmouseover)
- [onmouseup](input._internal_.SVGMarkerElement.md#onmouseup)
- [onpaste](input._internal_.SVGMarkerElement.md#onpaste)
- [onpause](input._internal_.SVGMarkerElement.md#onpause)
- [onplay](input._internal_.SVGMarkerElement.md#onplay)
- [onplaying](input._internal_.SVGMarkerElement.md#onplaying)
- [onpointercancel](input._internal_.SVGMarkerElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGMarkerElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGMarkerElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGMarkerElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGMarkerElement.md#onpointermove)
- [onpointerout](input._internal_.SVGMarkerElement.md#onpointerout)
- [onpointerover](input._internal_.SVGMarkerElement.md#onpointerover)
- [onpointerup](input._internal_.SVGMarkerElement.md#onpointerup)
- [onprogress](input._internal_.SVGMarkerElement.md#onprogress)
- [onratechange](input._internal_.SVGMarkerElement.md#onratechange)
- [onreset](input._internal_.SVGMarkerElement.md#onreset)
- [onresize](input._internal_.SVGMarkerElement.md#onresize)
- [onscroll](input._internal_.SVGMarkerElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGMarkerElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGMarkerElement.md#onseeked)
- [onseeking](input._internal_.SVGMarkerElement.md#onseeking)
- [onselect](input._internal_.SVGMarkerElement.md#onselect)
- [onselectionchange](input._internal_.SVGMarkerElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGMarkerElement.md#onselectstart)
- [onslotchange](input._internal_.SVGMarkerElement.md#onslotchange)
- [onstalled](input._internal_.SVGMarkerElement.md#onstalled)
- [onsubmit](input._internal_.SVGMarkerElement.md#onsubmit)
- [onsuspend](input._internal_.SVGMarkerElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGMarkerElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGMarkerElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGMarkerElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGMarkerElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGMarkerElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGMarkerElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGMarkerElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGMarkerElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGMarkerElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGMarkerElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGMarkerElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGMarkerElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGMarkerElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGMarkerElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGMarkerElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGMarkerElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGMarkerElement.md#onwheel)
- [orientAngle](input._internal_.SVGMarkerElement.md#orientangle)
- [orientType](input._internal_.SVGMarkerElement.md#orienttype)
- [outerHTML](input._internal_.SVGMarkerElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGMarkerElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGMarkerElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGMarkerElement.md#parentelement)
- [parentNode](input._internal_.SVGMarkerElement.md#parentnode)
- [part](input._internal_.SVGMarkerElement.md#part)
- [prefix](input._internal_.SVGMarkerElement.md#prefix)
- [preserveAspectRatio](input._internal_.SVGMarkerElement.md#preserveaspectratio)
- [previousElementSibling](input._internal_.SVGMarkerElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGMarkerElement.md#previoussibling)
- [refX](input._internal_.SVGMarkerElement.md#refx)
- [refY](input._internal_.SVGMarkerElement.md#refy)
- [scrollHeight](input._internal_.SVGMarkerElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGMarkerElement.md#scrollleft)
- [scrollTop](input._internal_.SVGMarkerElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGMarkerElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGMarkerElement.md#shadowroot)
- [slot](input._internal_.SVGMarkerElement.md#slot)
- [style](input._internal_.SVGMarkerElement.md#style)
- [tabIndex](input._internal_.SVGMarkerElement.md#tabindex)
- [tagName](input._internal_.SVGMarkerElement.md#tagname)
- [textContent](input._internal_.SVGMarkerElement.md#textcontent)
- [viewBox](input._internal_.SVGMarkerElement.md#viewbox)
- [viewportElement](input._internal_.SVGMarkerElement.md#viewportelement)

### Methods

- [addEventListener](input._internal_.SVGMarkerElement.md#addeventlistener)
- [after](input._internal_.SVGMarkerElement.md#after)
- [animate](input._internal_.SVGMarkerElement.md#animate)
- [append](input._internal_.SVGMarkerElement.md#append)
- [appendChild](input._internal_.SVGMarkerElement.md#appendchild)
- [attachShadow](input._internal_.SVGMarkerElement.md#attachshadow)
- [before](input._internal_.SVGMarkerElement.md#before)
- [blur](input._internal_.SVGMarkerElement.md#blur)
- [cloneNode](input._internal_.SVGMarkerElement.md#clonenode)
- [closest](input._internal_.SVGMarkerElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGMarkerElement.md#comparedocumentposition)
- [contains](input._internal_.SVGMarkerElement.md#contains)
- [dispatchEvent](input._internal_.SVGMarkerElement.md#dispatchevent)
- [focus](input._internal_.SVGMarkerElement.md#focus)
- [getAnimations](input._internal_.SVGMarkerElement.md#getanimations)
- [getAttribute](input._internal_.SVGMarkerElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGMarkerElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGMarkerElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGMarkerElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGMarkerElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.SVGMarkerElement.md#getboundingclientrect)
- [getClientRects](input._internal_.SVGMarkerElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGMarkerElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGMarkerElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGMarkerElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGMarkerElement.md#getrootnode)
- [hasAttribute](input._internal_.SVGMarkerElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGMarkerElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGMarkerElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGMarkerElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGMarkerElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGMarkerElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGMarkerElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGMarkerElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGMarkerElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGMarkerElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGMarkerElement.md#isequalnode)
- [isSameNode](input._internal_.SVGMarkerElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGMarkerElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGMarkerElement.md#lookupprefix)
- [matches](input._internal_.SVGMarkerElement.md#matches)
- [normalize](input._internal_.SVGMarkerElement.md#normalize)
- [prepend](input._internal_.SVGMarkerElement.md#prepend)
- [querySelector](input._internal_.SVGMarkerElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGMarkerElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGMarkerElement.md#releasepointercapture)
- [remove](input._internal_.SVGMarkerElement.md#remove)
- [removeAttribute](input._internal_.SVGMarkerElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGMarkerElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGMarkerElement.md#removeattributenode)
- [removeChild](input._internal_.SVGMarkerElement.md#removechild)
- [removeEventListener](input._internal_.SVGMarkerElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGMarkerElement.md#replacechild)
- [replaceChildren](input._internal_.SVGMarkerElement.md#replacechildren)
- [replaceWith](input._internal_.SVGMarkerElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGMarkerElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGMarkerElement.md#requestpointerlock)
- [scroll](input._internal_.SVGMarkerElement.md#scroll)
- [scrollBy](input._internal_.SVGMarkerElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGMarkerElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGMarkerElement.md#scrollto)
- [setAttribute](input._internal_.SVGMarkerElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGMarkerElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGMarkerElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGMarkerElement.md#setattributenodens)
- [setOrientToAngle](input._internal_.SVGMarkerElement.md#setorienttoangle)
- [setOrientToAuto](input._internal_.SVGMarkerElement.md#setorienttoauto)
- [setPointerCapture](input._internal_.SVGMarkerElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGMarkerElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGMarkerElement.md#webkitmatchesselector)
...
• `Readonly` **markerHeight**: [`SVGAnimatedLength`](../modules/input._internal_.md#svganimatedlength)
...
• `Readonly` **markerUnits**: [`SVGAnimatedEnumeration`](../modules/input._internal_.md#svganimatedenumeration)
...
• `Readonly` **markerWidth**: [`SVGAnimatedLength`](../modules/input._internal_.md#svganimatedlength)
...
• `Readonly` **orientAngle**: [`SVGAnimatedAngle`](../modules/input._internal_.md#svganimatedangle)
...
• `Readonly` **orientType**: [`SVGAnimatedEnumeration`](../modules/input._internal_.md#svganimatedenumeration)
...
• `Readonly` **refX**: [`SVGAnimatedLength`](../modules/input._internal_.md#svganimatedlength)
...
• `Readonly` **refY**: [`SVGAnimatedLength`](../modules/input._internal_.md#svganimatedlength)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGMarkerElement`](../modules/input._internal_.md#svgmarkerelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
...
| Name | Type |
| :------ | :------ |
| `angle` | [`SVGAngle`](../modules/input._internal_.md#svgangle) |
