[Droom Google Location Plugin - v1.0.13](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLMapElement

# Interface: HTMLMapElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLMapElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLMapElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLMapElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLMapElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLMapElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLMapElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLMapElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLMapElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLMapElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLMapElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLMapElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLMapElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLMapElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLMapElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLMapElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLMapElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLMapElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLMapElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLMapElement.md#text_node)
- [accessKey](input._internal_.HTMLMapElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLMapElement.md#accesskeylabel)
- [areas](input._internal_.HTMLMapElement.md#areas)
- [ariaAtomic](input._internal_.HTMLMapElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLMapElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLMapElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLMapElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLMapElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLMapElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLMapElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLMapElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLMapElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLMapElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLMapElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLMapElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLMapElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLMapElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLMapElement.md#arialevel)
- [ariaLive](input._internal_.HTMLMapElement.md#arialive)
- [ariaModal](input._internal_.HTMLMapElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLMapElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLMapElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLMapElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLMapElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLMapElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLMapElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLMapElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLMapElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLMapElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLMapElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLMapElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLMapElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLMapElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLMapElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLMapElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLMapElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLMapElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLMapElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLMapElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLMapElement.md#assignedslot)
- [attributes](input._internal_.HTMLMapElement.md#attributes)
- [autocapitalize](input._internal_.HTMLMapElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLMapElement.md#autofocus)
- [baseURI](input._internal_.HTMLMapElement.md#baseuri)
- [childElementCount](input._internal_.HTMLMapElement.md#childelementcount)
- [childNodes](input._internal_.HTMLMapElement.md#childnodes)
- [children](input._internal_.HTMLMapElement.md#children)
- [classList](input._internal_.HTMLMapElement.md#classlist)
- [className](input._internal_.HTMLMapElement.md#classname)
- [clientHeight](input._internal_.HTMLMapElement.md#clientheight)
- [clientLeft](input._internal_.HTMLMapElement.md#clientleft)
- [clientTop](input._internal_.HTMLMapElement.md#clienttop)
- [clientWidth](input._internal_.HTMLMapElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLMapElement.md#contenteditable)
- [dataset](input._internal_.HTMLMapElement.md#dataset)
- [dir](input._internal_.HTMLMapElement.md#dir)
- [draggable](input._internal_.HTMLMapElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLMapElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLMapElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLMapElement.md#firstelementchild)
- [hidden](input._internal_.HTMLMapElement.md#hidden)
- [id](input._internal_.HTMLMapElement.md#id)
- [innerHTML](input._internal_.HTMLMapElement.md#innerhtml)
- [innerText](input._internal_.HTMLMapElement.md#innertext)
- [inputMode](input._internal_.HTMLMapElement.md#inputmode)
- [isConnected](input._internal_.HTMLMapElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLMapElement.md#iscontenteditable)
- [lang](input._internal_.HTMLMapElement.md#lang)
- [lastChild](input._internal_.HTMLMapElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLMapElement.md#lastelementchild)
- [localName](input._internal_.HTMLMapElement.md#localname)
- [name](input._internal_.HTMLMapElement.md#name)
- [namespaceURI](input._internal_.HTMLMapElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLMapElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLMapElement.md#nextsibling)
- [nodeName](input._internal_.HTMLMapElement.md#nodename)
- [nodeType](input._internal_.HTMLMapElement.md#nodetype)
- [nodeValue](input._internal_.HTMLMapElement.md#nodevalue)
- [nonce](input._internal_.HTMLMapElement.md#nonce)
- [offsetHeight](input._internal_.HTMLMapElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLMapElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLMapElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLMapElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLMapElement.md#offsetwidth)
- [onabort](input._internal_.HTMLMapElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLMapElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLMapElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLMapElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLMapElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLMapElement.md#onauxclick)
- [onblur](input._internal_.HTMLMapElement.md#onblur)
- [oncanplay](input._internal_.HTMLMapElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLMapElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLMapElement.md#onchange)
- [onclick](input._internal_.HTMLMapElement.md#onclick)
- [onclose](input._internal_.HTMLMapElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLMapElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLMapElement.md#oncopy)
- [oncuechange](input._internal_.HTMLMapElement.md#oncuechange)
- [oncut](input._internal_.HTMLMapElement.md#oncut)
- [ondblclick](input._internal_.HTMLMapElement.md#ondblclick)
- [ondrag](input._internal_.HTMLMapElement.md#ondrag)
- [ondragend](input._internal_.HTMLMapElement.md#ondragend)
- [ondragenter](input._internal_.HTMLMapElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLMapElement.md#ondragleave)
- [ondragover](input._internal_.HTMLMapElement.md#ondragover)
- [ondragstart](input._internal_.HTMLMapElement.md#ondragstart)
- [ondrop](input._internal_.HTMLMapElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLMapElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLMapElement.md#onemptied)
- [onended](input._internal_.HTMLMapElement.md#onended)
- [onerror](input._internal_.HTMLMapElement.md#onerror)
- [onfocus](input._internal_.HTMLMapElement.md#onfocus)
- [onformdata](input._internal_.HTMLMapElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLMapElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLMapElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLMapElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLMapElement.md#oninput)
- [oninvalid](input._internal_.HTMLMapElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLMapElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLMapElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLMapElement.md#onkeyup)
- [onload](input._internal_.HTMLMapElement.md#onload)
- [onloadeddata](input._internal_.HTMLMapElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLMapElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLMapElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLMapElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLMapElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLMapElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLMapElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLMapElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLMapElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLMapElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLMapElement.md#onmouseup)
- [onpaste](input._internal_.HTMLMapElement.md#onpaste)
- [onpause](input._internal_.HTMLMapElement.md#onpause)
- [onplay](input._internal_.HTMLMapElement.md#onplay)
- [onplaying](input._internal_.HTMLMapElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLMapElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLMapElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLMapElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLMapElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLMapElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLMapElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLMapElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLMapElement.md#onpointerup)
- [onprogress](input._internal_.HTMLMapElement.md#onprogress)
- [onratechange](input._internal_.HTMLMapElement.md#onratechange)
- [onreset](input._internal_.HTMLMapElement.md#onreset)
- [onresize](input._internal_.HTMLMapElement.md#onresize)
- [onscroll](input._internal_.HTMLMapElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLMapElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLMapElement.md#onseeked)
- [onseeking](input._internal_.HTMLMapElement.md#onseeking)
- [onselect](input._internal_.HTMLMapElement.md#onselect)
- [onselectionchange](input._internal_.HTMLMapElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLMapElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLMapElement.md#onslotchange)
- [onstalled](input._internal_.HTMLMapElement.md#onstalled)
- [onsubmit](input._internal_.HTMLMapElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLMapElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLMapElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLMapElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLMapElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLMapElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLMapElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLMapElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLMapElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLMapElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLMapElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLMapElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLMapElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLMapElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLMapElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLMapElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLMapElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLMapElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLMapElement.md#onwheel)
- [outerHTML](input._internal_.HTMLMapElement.md#outerhtml)
- [outerText](input._internal_.HTMLMapElement.md#outertext)
- [ownerDocument](input._internal_.HTMLMapElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLMapElement.md#parentelement)
- [parentNode](input._internal_.HTMLMapElement.md#parentnode)
- [part](input._internal_.HTMLMapElement.md#part)
- [prefix](input._internal_.HTMLMapElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLMapElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLMapElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLMapElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLMapElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLMapElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLMapElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLMapElement.md#shadowroot)
- [slot](input._internal_.HTMLMapElement.md#slot)
- [spellcheck](input._internal_.HTMLMapElement.md#spellcheck)
- [style](input._internal_.HTMLMapElement.md#style)
- [tabIndex](input._internal_.HTMLMapElement.md#tabindex)
- [tagName](input._internal_.HTMLMapElement.md#tagname)
- [textContent](input._internal_.HTMLMapElement.md#textcontent)
- [title](input._internal_.HTMLMapElement.md#title)
- [translate](input._internal_.HTMLMapElement.md#translate)

### Methods

- [addEventListener](input._internal_.HTMLMapElement.md#addeventlistener)
- [after](input._internal_.HTMLMapElement.md#after)
- [animate](input._internal_.HTMLMapElement.md#animate)
- [append](input._internal_.HTMLMapElement.md#append)
- [appendChild](input._internal_.HTMLMapElement.md#appendchild)
- [attachInternals](input._internal_.HTMLMapElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLMapElement.md#attachshadow)
- [before](input._internal_.HTMLMapElement.md#before)
- [blur](input._internal_.HTMLMapElement.md#blur)
- [click](input._internal_.HTMLMapElement.md#click)
- [cloneNode](input._internal_.HTMLMapElement.md#clonenode)
- [closest](input._internal_.HTMLMapElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLMapElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLMapElement.md#contains)
- [dispatchEvent](input._internal_.HTMLMapElement.md#dispatchevent)
- [focus](input._internal_.HTMLMapElement.md#focus)
- [getAnimations](input._internal_.HTMLMapElement.md#getanimations)
- [getAttribute](input._internal_.HTMLMapElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLMapElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLMapElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLMapElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLMapElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLMapElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLMapElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLMapElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLMapElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLMapElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLMapElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLMapElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLMapElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLMapElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLMapElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLMapElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLMapElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLMapElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLMapElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLMapElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLMapElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLMapElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLMapElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLMapElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLMapElement.md#lookupprefix)
- [matches](input._internal_.HTMLMapElement.md#matches)
- [normalize](input._internal_.HTMLMapElement.md#normalize)
- [prepend](input._internal_.HTMLMapElement.md#prepend)
- [querySelector](input._internal_.HTMLMapElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLMapElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLMapElement.md#releasepointercapture)
- [remove](input._internal_.HTMLMapElement.md#remove)
- [removeAttribute](input._internal_.HTMLMapElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLMapElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLMapElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLMapElement.md#removechild)
- [removeEventListener](input._internal_.HTMLMapElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLMapElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLMapElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLMapElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLMapElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLMapElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLMapElement.md#scroll)
- [scrollBy](input._internal_.HTMLMapElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLMapElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLMapElement.md#scrollto)
- [setAttribute](input._internal_.HTMLMapElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLMapElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLMapElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLMapElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLMapElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLMapElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLMapElement.md#webkitmatchesselector)
...
• `Readonly` **areas**: [`HTMLCollection`](../modules/input._internal_.md#htmlcollection)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLMapElement`](../modules/input._internal_.md#htmlmapelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
