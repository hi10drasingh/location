[Droom Google Location Plugin - v1.0.11](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLAnchorElement

# Interface: HTMLAnchorElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLAnchorElement
...
- [`HTMLHyperlinkElementUtils`](input._internal_.HTMLHyperlinkElementUtils.md)
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLAnchorElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLAnchorElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLAnchorElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLAnchorElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLAnchorElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLAnchorElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLAnchorElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLAnchorElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLAnchorElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLAnchorElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLAnchorElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLAnchorElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLAnchorElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLAnchorElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLAnchorElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLAnchorElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLAnchorElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLAnchorElement.md#text_node)
- [accessKey](input._internal_.HTMLAnchorElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLAnchorElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLAnchorElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLAnchorElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLAnchorElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLAnchorElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLAnchorElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLAnchorElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLAnchorElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLAnchorElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLAnchorElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLAnchorElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLAnchorElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLAnchorElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLAnchorElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLAnchorElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLAnchorElement.md#arialevel)
- [ariaLive](input._internal_.HTMLAnchorElement.md#arialive)
- [ariaModal](input._internal_.HTMLAnchorElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLAnchorElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLAnchorElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLAnchorElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLAnchorElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLAnchorElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLAnchorElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLAnchorElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLAnchorElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLAnchorElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLAnchorElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLAnchorElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLAnchorElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLAnchorElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLAnchorElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLAnchorElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLAnchorElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLAnchorElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLAnchorElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLAnchorElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLAnchorElement.md#assignedslot)
- [attributes](input._internal_.HTMLAnchorElement.md#attributes)
- [autocapitalize](input._internal_.HTMLAnchorElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLAnchorElement.md#autofocus)
- [baseURI](input._internal_.HTMLAnchorElement.md#baseuri)
- [charset](input._internal_.HTMLAnchorElement.md#charset)
- [childElementCount](input._internal_.HTMLAnchorElement.md#childelementcount)
- [childNodes](input._internal_.HTMLAnchorElement.md#childnodes)
- [children](input._internal_.HTMLAnchorElement.md#children)
- [classList](input._internal_.HTMLAnchorElement.md#classlist)
- [className](input._internal_.HTMLAnchorElement.md#classname)
- [clientHeight](input._internal_.HTMLAnchorElement.md#clientheight)
- [clientLeft](input._internal_.HTMLAnchorElement.md#clientleft)
- [clientTop](input._internal_.HTMLAnchorElement.md#clienttop)
- [clientWidth](input._internal_.HTMLAnchorElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLAnchorElement.md#contenteditable)
- [coords](input._internal_.HTMLAnchorElement.md#coords)
- [dataset](input._internal_.HTMLAnchorElement.md#dataset)
- [dir](input._internal_.HTMLAnchorElement.md#dir)
- [download](input._internal_.HTMLAnchorElement.md#download)
- [draggable](input._internal_.HTMLAnchorElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLAnchorElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLAnchorElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLAnchorElement.md#firstelementchild)
- [hash](input._internal_.HTMLAnchorElement.md#hash)
- [hidden](input._internal_.HTMLAnchorElement.md#hidden)
- [host](input._internal_.HTMLAnchorElement.md#host)
- [hostname](input._internal_.HTMLAnchorElement.md#hostname)
- [href](input._internal_.HTMLAnchorElement.md#href)
- [hreflang](input._internal_.HTMLAnchorElement.md#hreflang)
- [id](input._internal_.HTMLAnchorElement.md#id)
- [innerHTML](input._internal_.HTMLAnchorElement.md#innerhtml)
- [innerText](input._internal_.HTMLAnchorElement.md#innertext)
- [inputMode](input._internal_.HTMLAnchorElement.md#inputmode)
- [isConnected](input._internal_.HTMLAnchorElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLAnchorElement.md#iscontenteditable)
- [lang](input._internal_.HTMLAnchorElement.md#lang)
- [lastChild](input._internal_.HTMLAnchorElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLAnchorElement.md#lastelementchild)
- [localName](input._internal_.HTMLAnchorElement.md#localname)
- [name](input._internal_.HTMLAnchorElement.md#name)
- [namespaceURI](input._internal_.HTMLAnchorElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLAnchorElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLAnchorElement.md#nextsibling)
- [nodeName](input._internal_.HTMLAnchorElement.md#nodename)
- [nodeType](input._internal_.HTMLAnchorElement.md#nodetype)
- [nodeValue](input._internal_.HTMLAnchorElement.md#nodevalue)
- [nonce](input._internal_.HTMLAnchorElement.md#nonce)
- [offsetHeight](input._internal_.HTMLAnchorElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLAnchorElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLAnchorElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLAnchorElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLAnchorElement.md#offsetwidth)
- [onabort](input._internal_.HTMLAnchorElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLAnchorElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLAnchorElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLAnchorElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLAnchorElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLAnchorElement.md#onauxclick)
- [onblur](input._internal_.HTMLAnchorElement.md#onblur)
- [oncanplay](input._internal_.HTMLAnchorElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLAnchorElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLAnchorElement.md#onchange)
- [onclick](input._internal_.HTMLAnchorElement.md#onclick)
- [onclose](input._internal_.HTMLAnchorElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLAnchorElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLAnchorElement.md#oncopy)
- [oncuechange](input._internal_.HTMLAnchorElement.md#oncuechange)
- [oncut](input._internal_.HTMLAnchorElement.md#oncut)
- [ondblclick](input._internal_.HTMLAnchorElement.md#ondblclick)
- [ondrag](input._internal_.HTMLAnchorElement.md#ondrag)
- [ondragend](input._internal_.HTMLAnchorElement.md#ondragend)
- [ondragenter](input._internal_.HTMLAnchorElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLAnchorElement.md#ondragleave)
- [ondragover](input._internal_.HTMLAnchorElement.md#ondragover)
- [ondragstart](input._internal_.HTMLAnchorElement.md#ondragstart)
- [ondrop](input._internal_.HTMLAnchorElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLAnchorElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLAnchorElement.md#onemptied)
- [onended](input._internal_.HTMLAnchorElement.md#onended)
- [onerror](input._internal_.HTMLAnchorElement.md#onerror)
- [onfocus](input._internal_.HTMLAnchorElement.md#onfocus)
- [onformdata](input._internal_.HTMLAnchorElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLAnchorElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLAnchorElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLAnchorElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLAnchorElement.md#oninput)
- [oninvalid](input._internal_.HTMLAnchorElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLAnchorElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLAnchorElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLAnchorElement.md#onkeyup)
- [onload](input._internal_.HTMLAnchorElement.md#onload)
- [onloadeddata](input._internal_.HTMLAnchorElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLAnchorElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLAnchorElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLAnchorElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLAnchorElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLAnchorElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLAnchorElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLAnchorElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLAnchorElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLAnchorElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLAnchorElement.md#onmouseup)
- [onpaste](input._internal_.HTMLAnchorElement.md#onpaste)
- [onpause](input._internal_.HTMLAnchorElement.md#onpause)
- [onplay](input._internal_.HTMLAnchorElement.md#onplay)
- [onplaying](input._internal_.HTMLAnchorElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLAnchorElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLAnchorElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLAnchorElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLAnchorElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLAnchorElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLAnchorElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLAnchorElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLAnchorElement.md#onpointerup)
- [onprogress](input._internal_.HTMLAnchorElement.md#onprogress)
- [onratechange](input._internal_.HTMLAnchorElement.md#onratechange)
- [onreset](input._internal_.HTMLAnchorElement.md#onreset)
- [onresize](input._internal_.HTMLAnchorElement.md#onresize)
- [onscroll](input._internal_.HTMLAnchorElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLAnchorElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLAnchorElement.md#onseeked)
- [onseeking](input._internal_.HTMLAnchorElement.md#onseeking)
- [onselect](input._internal_.HTMLAnchorElement.md#onselect)
- [onselectionchange](input._internal_.HTMLAnchorElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLAnchorElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLAnchorElement.md#onslotchange)
- [onstalled](input._internal_.HTMLAnchorElement.md#onstalled)
- [onsubmit](input._internal_.HTMLAnchorElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLAnchorElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLAnchorElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLAnchorElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLAnchorElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLAnchorElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLAnchorElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLAnchorElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLAnchorElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLAnchorElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLAnchorElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLAnchorElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLAnchorElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLAnchorElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLAnchorElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLAnchorElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLAnchorElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLAnchorElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLAnchorElement.md#onwheel)
- [origin](input._internal_.HTMLAnchorElement.md#origin)
- [outerHTML](input._internal_.HTMLAnchorElement.md#outerhtml)
- [outerText](input._internal_.HTMLAnchorElement.md#outertext)
- [ownerDocument](input._internal_.HTMLAnchorElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLAnchorElement.md#parentelement)
- [parentNode](input._internal_.HTMLAnchorElement.md#parentnode)
- [part](input._internal_.HTMLAnchorElement.md#part)
- [password](input._internal_.HTMLAnchorElement.md#password)
- [pathname](input._internal_.HTMLAnchorElement.md#pathname)
- [ping](input._internal_.HTMLAnchorElement.md#ping)
- [port](input._internal_.HTMLAnchorElement.md#port)
- [prefix](input._internal_.HTMLAnchorElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLAnchorElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLAnchorElement.md#previoussibling)
- [protocol](input._internal_.HTMLAnchorElement.md#protocol)
- [referrerPolicy](input._internal_.HTMLAnchorElement.md#referrerpolicy)
- [rel](input._internal_.HTMLAnchorElement.md#rel)
- [relList](input._internal_.HTMLAnchorElement.md#rellist)
- [rev](input._internal_.HTMLAnchorElement.md#rev)
- [scrollHeight](input._internal_.HTMLAnchorElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLAnchorElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLAnchorElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLAnchorElement.md#scrollwidth)
- [search](input._internal_.HTMLAnchorElement.md#search)
- [shadowRoot](input._internal_.HTMLAnchorElement.md#shadowroot)
- [shape](input._internal_.HTMLAnchorElement.md#shape)
- [slot](input._internal_.HTMLAnchorElement.md#slot)
- [spellcheck](input._internal_.HTMLAnchorElement.md#spellcheck)
- [style](input._internal_.HTMLAnchorElement.md#style)
- [tabIndex](input._internal_.HTMLAnchorElement.md#tabindex)
- [tagName](input._internal_.HTMLAnchorElement.md#tagname)
- [target](input._internal_.HTMLAnchorElement.md#target)
- [text](input._internal_.HTMLAnchorElement.md#text)
- [textContent](input._internal_.HTMLAnchorElement.md#textcontent)
- [title](input._internal_.HTMLAnchorElement.md#title)
- [translate](input._internal_.HTMLAnchorElement.md#translate)
- [type](input._internal_.HTMLAnchorElement.md#type)
- [username](input._internal_.HTMLAnchorElement.md#username)

### Methods

- [addEventListener](input._internal_.HTMLAnchorElement.md#addeventlistener)
- [after](input._internal_.HTMLAnchorElement.md#after)
- [animate](input._internal_.HTMLAnchorElement.md#animate)
- [append](input._internal_.HTMLAnchorElement.md#append)
- [appendChild](input._internal_.HTMLAnchorElement.md#appendchild)
- [attachInternals](input._internal_.HTMLAnchorElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLAnchorElement.md#attachshadow)
- [before](input._internal_.HTMLAnchorElement.md#before)
- [blur](input._internal_.HTMLAnchorElement.md#blur)
- [click](input._internal_.HTMLAnchorElement.md#click)
- [cloneNode](input._internal_.HTMLAnchorElement.md#clonenode)
- [closest](input._internal_.HTMLAnchorElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLAnchorElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLAnchorElement.md#contains)
- [dispatchEvent](input._internal_.HTMLAnchorElement.md#dispatchevent)
- [focus](input._internal_.HTMLAnchorElement.md#focus)
- [getAnimations](input._internal_.HTMLAnchorElement.md#getanimations)
- [getAttribute](input._internal_.HTMLAnchorElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLAnchorElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLAnchorElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLAnchorElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLAnchorElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLAnchorElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLAnchorElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLAnchorElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLAnchorElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLAnchorElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLAnchorElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLAnchorElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLAnchorElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLAnchorElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLAnchorElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLAnchorElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLAnchorElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLAnchorElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLAnchorElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLAnchorElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLAnchorElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLAnchorElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLAnchorElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLAnchorElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLAnchorElement.md#lookupprefix)
- [matches](input._internal_.HTMLAnchorElement.md#matches)
- [normalize](input._internal_.HTMLAnchorElement.md#normalize)
- [prepend](input._internal_.HTMLAnchorElement.md#prepend)
- [querySelector](input._internal_.HTMLAnchorElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLAnchorElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLAnchorElement.md#releasepointercapture)
- [remove](input._internal_.HTMLAnchorElement.md#remove)
- [removeAttribute](input._internal_.HTMLAnchorElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLAnchorElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLAnchorElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLAnchorElement.md#removechild)
- [removeEventListener](input._internal_.HTMLAnchorElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLAnchorElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLAnchorElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLAnchorElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLAnchorElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLAnchorElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLAnchorElement.md#scroll)
- [scrollBy](input._internal_.HTMLAnchorElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLAnchorElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLAnchorElement.md#scrollto)
- [setAttribute](input._internal_.HTMLAnchorElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLAnchorElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLAnchorElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLAnchorElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLAnchorElement.md#setpointercapture)
- [toString](input._internal_.HTMLAnchorElement.md#tostring)
- [toggleAttribute](input._internal_.HTMLAnchorElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLAnchorElement.md#webkitmatchesselector)
...
[HTMLHyperlinkElementUtils](input._internal_.HTMLHyperlinkElementUtils.md).[hash](input._internal_.HTMLHyperlinkElementUtils.md#hash)
...
[HTMLHyperlinkElementUtils](input._internal_.HTMLHyperlinkElementUtils.md).[host](input._internal_.HTMLHyperlinkElementUtils.md#host)
...
[HTMLHyperlinkElementUtils](input._internal_.HTMLHyperlinkElementUtils.md).[hostname](input._internal_.HTMLHyperlinkElementUtils.md#hostname)
...
[HTMLHyperlinkElementUtils](input._internal_.HTMLHyperlinkElementUtils.md).[href](input._internal_.HTMLHyperlinkElementUtils.md#href)
...
[HTMLHyperlinkElementUtils](input._internal_.HTMLHyperlinkElementUtils.md).[origin](input._internal_.HTMLHyperlinkElementUtils.md#origin)
...
[HTMLHyperlinkElementUtils](input._internal_.HTMLHyperlinkElementUtils.md).[password](input._internal_.HTMLHyperlinkElementUtils.md#password)
...
[HTMLHyperlinkElementUtils](input._internal_.HTMLHyperlinkElementUtils.md).[pathname](input._internal_.HTMLHyperlinkElementUtils.md#pathname)
...
[HTMLHyperlinkElementUtils](input._internal_.HTMLHyperlinkElementUtils.md).[port](input._internal_.HTMLHyperlinkElementUtils.md#port)
...
[HTMLHyperlinkElementUtils](input._internal_.HTMLHyperlinkElementUtils.md).[protocol](input._internal_.HTMLHyperlinkElementUtils.md#protocol)
...
• `Readonly` **relList**: [`DOMTokenList`](../modules/input._internal_.md#domtokenlist)
...
[HTMLHyperlinkElementUtils](input._internal_.HTMLHyperlinkElementUtils.md).[search](input._internal_.HTMLHyperlinkElementUtils.md#search)
...
[HTMLHyperlinkElementUtils](input._internal_.HTMLHyperlinkElementUtils.md).[username](input._internal_.HTMLHyperlinkElementUtils.md#username)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLAnchorElement`](../modules/input._internal_.md#htmlanchorelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
...
[HTMLHyperlinkElementUtils](input._internal_.HTMLHyperlinkElementUtils.md).[toString](input._internal_.HTMLHyperlinkElementUtils.md#tostring)
