[Droom Google Location Plugin - v1.0.15](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLHeadElement

# Interface: HTMLHeadElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLHeadElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLHeadElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLHeadElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLHeadElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLHeadElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLHeadElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLHeadElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLHeadElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLHeadElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLHeadElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLHeadElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLHeadElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLHeadElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLHeadElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLHeadElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLHeadElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLHeadElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLHeadElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLHeadElement.md#text_node)
- [accessKey](input._internal_.HTMLHeadElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLHeadElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLHeadElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLHeadElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLHeadElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLHeadElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLHeadElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLHeadElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLHeadElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLHeadElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLHeadElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLHeadElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLHeadElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLHeadElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLHeadElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLHeadElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLHeadElement.md#arialevel)
- [ariaLive](input._internal_.HTMLHeadElement.md#arialive)
- [ariaModal](input._internal_.HTMLHeadElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLHeadElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLHeadElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLHeadElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLHeadElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLHeadElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLHeadElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLHeadElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLHeadElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLHeadElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLHeadElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLHeadElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLHeadElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLHeadElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLHeadElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLHeadElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLHeadElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLHeadElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLHeadElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLHeadElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLHeadElement.md#assignedslot)
- [attributes](input._internal_.HTMLHeadElement.md#attributes)
- [autocapitalize](input._internal_.HTMLHeadElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLHeadElement.md#autofocus)
- [baseURI](input._internal_.HTMLHeadElement.md#baseuri)
- [childElementCount](input._internal_.HTMLHeadElement.md#childelementcount)
- [childNodes](input._internal_.HTMLHeadElement.md#childnodes)
- [children](input._internal_.HTMLHeadElement.md#children)
- [classList](input._internal_.HTMLHeadElement.md#classlist)
- [className](input._internal_.HTMLHeadElement.md#classname)
- [clientHeight](input._internal_.HTMLHeadElement.md#clientheight)
- [clientLeft](input._internal_.HTMLHeadElement.md#clientleft)
- [clientTop](input._internal_.HTMLHeadElement.md#clienttop)
- [clientWidth](input._internal_.HTMLHeadElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLHeadElement.md#contenteditable)
- [dataset](input._internal_.HTMLHeadElement.md#dataset)
- [dir](input._internal_.HTMLHeadElement.md#dir)
- [draggable](input._internal_.HTMLHeadElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLHeadElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLHeadElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLHeadElement.md#firstelementchild)
- [hidden](input._internal_.HTMLHeadElement.md#hidden)
- [id](input._internal_.HTMLHeadElement.md#id)
- [innerHTML](input._internal_.HTMLHeadElement.md#innerhtml)
- [innerText](input._internal_.HTMLHeadElement.md#innertext)
- [inputMode](input._internal_.HTMLHeadElement.md#inputmode)
- [isConnected](input._internal_.HTMLHeadElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLHeadElement.md#iscontenteditable)
- [lang](input._internal_.HTMLHeadElement.md#lang)
- [lastChild](input._internal_.HTMLHeadElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLHeadElement.md#lastelementchild)
- [localName](input._internal_.HTMLHeadElement.md#localname)
- [namespaceURI](input._internal_.HTMLHeadElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLHeadElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLHeadElement.md#nextsibling)
- [nodeName](input._internal_.HTMLHeadElement.md#nodename)
- [nodeType](input._internal_.HTMLHeadElement.md#nodetype)
- [nodeValue](input._internal_.HTMLHeadElement.md#nodevalue)
- [nonce](input._internal_.HTMLHeadElement.md#nonce)
- [offsetHeight](input._internal_.HTMLHeadElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLHeadElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLHeadElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLHeadElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLHeadElement.md#offsetwidth)
- [onabort](input._internal_.HTMLHeadElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLHeadElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLHeadElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLHeadElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLHeadElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLHeadElement.md#onauxclick)
- [onblur](input._internal_.HTMLHeadElement.md#onblur)
- [oncanplay](input._internal_.HTMLHeadElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLHeadElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLHeadElement.md#onchange)
- [onclick](input._internal_.HTMLHeadElement.md#onclick)
- [onclose](input._internal_.HTMLHeadElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLHeadElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLHeadElement.md#oncopy)
- [oncuechange](input._internal_.HTMLHeadElement.md#oncuechange)
- [oncut](input._internal_.HTMLHeadElement.md#oncut)
- [ondblclick](input._internal_.HTMLHeadElement.md#ondblclick)
- [ondrag](input._internal_.HTMLHeadElement.md#ondrag)
- [ondragend](input._internal_.HTMLHeadElement.md#ondragend)
- [ondragenter](input._internal_.HTMLHeadElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLHeadElement.md#ondragleave)
- [ondragover](input._internal_.HTMLHeadElement.md#ondragover)
- [ondragstart](input._internal_.HTMLHeadElement.md#ondragstart)
- [ondrop](input._internal_.HTMLHeadElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLHeadElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLHeadElement.md#onemptied)
- [onended](input._internal_.HTMLHeadElement.md#onended)
- [onerror](input._internal_.HTMLHeadElement.md#onerror)
- [onfocus](input._internal_.HTMLHeadElement.md#onfocus)
- [onformdata](input._internal_.HTMLHeadElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLHeadElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLHeadElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLHeadElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLHeadElement.md#oninput)
- [oninvalid](input._internal_.HTMLHeadElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLHeadElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLHeadElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLHeadElement.md#onkeyup)
- [onload](input._internal_.HTMLHeadElement.md#onload)
- [onloadeddata](input._internal_.HTMLHeadElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLHeadElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLHeadElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLHeadElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLHeadElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLHeadElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLHeadElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLHeadElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLHeadElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLHeadElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLHeadElement.md#onmouseup)
- [onpaste](input._internal_.HTMLHeadElement.md#onpaste)
- [onpause](input._internal_.HTMLHeadElement.md#onpause)
- [onplay](input._internal_.HTMLHeadElement.md#onplay)
- [onplaying](input._internal_.HTMLHeadElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLHeadElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLHeadElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLHeadElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLHeadElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLHeadElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLHeadElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLHeadElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLHeadElement.md#onpointerup)
- [onprogress](input._internal_.HTMLHeadElement.md#onprogress)
- [onratechange](input._internal_.HTMLHeadElement.md#onratechange)
- [onreset](input._internal_.HTMLHeadElement.md#onreset)
- [onresize](input._internal_.HTMLHeadElement.md#onresize)
- [onscroll](input._internal_.HTMLHeadElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLHeadElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLHeadElement.md#onseeked)
- [onseeking](input._internal_.HTMLHeadElement.md#onseeking)
- [onselect](input._internal_.HTMLHeadElement.md#onselect)
- [onselectionchange](input._internal_.HTMLHeadElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLHeadElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLHeadElement.md#onslotchange)
- [onstalled](input._internal_.HTMLHeadElement.md#onstalled)
- [onsubmit](input._internal_.HTMLHeadElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLHeadElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLHeadElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLHeadElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLHeadElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLHeadElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLHeadElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLHeadElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLHeadElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLHeadElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLHeadElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLHeadElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLHeadElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLHeadElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLHeadElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLHeadElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLHeadElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLHeadElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLHeadElement.md#onwheel)
- [outerHTML](input._internal_.HTMLHeadElement.md#outerhtml)
- [outerText](input._internal_.HTMLHeadElement.md#outertext)
- [ownerDocument](input._internal_.HTMLHeadElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLHeadElement.md#parentelement)
- [parentNode](input._internal_.HTMLHeadElement.md#parentnode)
- [part](input._internal_.HTMLHeadElement.md#part)
- [prefix](input._internal_.HTMLHeadElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLHeadElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLHeadElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLHeadElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLHeadElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLHeadElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLHeadElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLHeadElement.md#shadowroot)
- [slot](input._internal_.HTMLHeadElement.md#slot)
- [spellcheck](input._internal_.HTMLHeadElement.md#spellcheck)
- [style](input._internal_.HTMLHeadElement.md#style)
- [tabIndex](input._internal_.HTMLHeadElement.md#tabindex)
- [tagName](input._internal_.HTMLHeadElement.md#tagname)
- [textContent](input._internal_.HTMLHeadElement.md#textcontent)
- [title](input._internal_.HTMLHeadElement.md#title)
- [translate](input._internal_.HTMLHeadElement.md#translate)

### Methods

- [addEventListener](input._internal_.HTMLHeadElement.md#addeventlistener)
- [after](input._internal_.HTMLHeadElement.md#after)
- [animate](input._internal_.HTMLHeadElement.md#animate)
- [append](input._internal_.HTMLHeadElement.md#append)
- [appendChild](input._internal_.HTMLHeadElement.md#appendchild)
- [attachInternals](input._internal_.HTMLHeadElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLHeadElement.md#attachshadow)
- [before](input._internal_.HTMLHeadElement.md#before)
- [blur](input._internal_.HTMLHeadElement.md#blur)
- [click](input._internal_.HTMLHeadElement.md#click)
- [cloneNode](input._internal_.HTMLHeadElement.md#clonenode)
- [closest](input._internal_.HTMLHeadElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLHeadElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLHeadElement.md#contains)
- [dispatchEvent](input._internal_.HTMLHeadElement.md#dispatchevent)
- [focus](input._internal_.HTMLHeadElement.md#focus)
- [getAnimations](input._internal_.HTMLHeadElement.md#getanimations)
- [getAttribute](input._internal_.HTMLHeadElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLHeadElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLHeadElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLHeadElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLHeadElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLHeadElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLHeadElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLHeadElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLHeadElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLHeadElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLHeadElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLHeadElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLHeadElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLHeadElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLHeadElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLHeadElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLHeadElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLHeadElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLHeadElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLHeadElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLHeadElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLHeadElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLHeadElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLHeadElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLHeadElement.md#lookupprefix)
- [matches](input._internal_.HTMLHeadElement.md#matches)
- [normalize](input._internal_.HTMLHeadElement.md#normalize)
- [prepend](input._internal_.HTMLHeadElement.md#prepend)
- [querySelector](input._internal_.HTMLHeadElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLHeadElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLHeadElement.md#releasepointercapture)
- [remove](input._internal_.HTMLHeadElement.md#remove)
- [removeAttribute](input._internal_.HTMLHeadElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLHeadElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLHeadElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLHeadElement.md#removechild)
- [removeEventListener](input._internal_.HTMLHeadElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLHeadElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLHeadElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLHeadElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLHeadElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLHeadElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLHeadElement.md#scroll)
- [scrollBy](input._internal_.HTMLHeadElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLHeadElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLHeadElement.md#scrollto)
- [setAttribute](input._internal_.HTMLHeadElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLHeadElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLHeadElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLHeadElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLHeadElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLHeadElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLHeadElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLHeadElement`](../modules/input._internal_.md#htmlheadelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
