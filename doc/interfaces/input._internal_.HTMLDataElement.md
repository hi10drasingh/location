[Droom Google Location Plugin - v1.0.15](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLDataElement

# Interface: HTMLDataElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLDataElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLDataElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLDataElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLDataElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLDataElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLDataElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLDataElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLDataElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLDataElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLDataElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLDataElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLDataElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLDataElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLDataElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLDataElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLDataElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLDataElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLDataElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLDataElement.md#text_node)
- [accessKey](input._internal_.HTMLDataElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLDataElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLDataElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLDataElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLDataElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLDataElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLDataElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLDataElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLDataElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLDataElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLDataElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLDataElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLDataElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLDataElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLDataElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLDataElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLDataElement.md#arialevel)
- [ariaLive](input._internal_.HTMLDataElement.md#arialive)
- [ariaModal](input._internal_.HTMLDataElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLDataElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLDataElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLDataElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLDataElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLDataElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLDataElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLDataElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLDataElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLDataElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLDataElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLDataElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLDataElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLDataElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLDataElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLDataElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLDataElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLDataElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLDataElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLDataElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLDataElement.md#assignedslot)
- [attributes](input._internal_.HTMLDataElement.md#attributes)
- [autocapitalize](input._internal_.HTMLDataElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLDataElement.md#autofocus)
- [baseURI](input._internal_.HTMLDataElement.md#baseuri)
- [childElementCount](input._internal_.HTMLDataElement.md#childelementcount)
- [childNodes](input._internal_.HTMLDataElement.md#childnodes)
- [children](input._internal_.HTMLDataElement.md#children)
- [classList](input._internal_.HTMLDataElement.md#classlist)
- [className](input._internal_.HTMLDataElement.md#classname)
- [clientHeight](input._internal_.HTMLDataElement.md#clientheight)
- [clientLeft](input._internal_.HTMLDataElement.md#clientleft)
- [clientTop](input._internal_.HTMLDataElement.md#clienttop)
- [clientWidth](input._internal_.HTMLDataElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLDataElement.md#contenteditable)
- [dataset](input._internal_.HTMLDataElement.md#dataset)
- [dir](input._internal_.HTMLDataElement.md#dir)
- [draggable](input._internal_.HTMLDataElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLDataElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLDataElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLDataElement.md#firstelementchild)
- [hidden](input._internal_.HTMLDataElement.md#hidden)
- [id](input._internal_.HTMLDataElement.md#id)
- [innerHTML](input._internal_.HTMLDataElement.md#innerhtml)
- [innerText](input._internal_.HTMLDataElement.md#innertext)
- [inputMode](input._internal_.HTMLDataElement.md#inputmode)
- [isConnected](input._internal_.HTMLDataElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLDataElement.md#iscontenteditable)
- [lang](input._internal_.HTMLDataElement.md#lang)
- [lastChild](input._internal_.HTMLDataElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLDataElement.md#lastelementchild)
- [localName](input._internal_.HTMLDataElement.md#localname)
- [namespaceURI](input._internal_.HTMLDataElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLDataElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLDataElement.md#nextsibling)
- [nodeName](input._internal_.HTMLDataElement.md#nodename)
- [nodeType](input._internal_.HTMLDataElement.md#nodetype)
- [nodeValue](input._internal_.HTMLDataElement.md#nodevalue)
- [nonce](input._internal_.HTMLDataElement.md#nonce)
- [offsetHeight](input._internal_.HTMLDataElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLDataElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLDataElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLDataElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLDataElement.md#offsetwidth)
- [onabort](input._internal_.HTMLDataElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLDataElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLDataElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLDataElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLDataElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLDataElement.md#onauxclick)
- [onblur](input._internal_.HTMLDataElement.md#onblur)
- [oncanplay](input._internal_.HTMLDataElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLDataElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLDataElement.md#onchange)
- [onclick](input._internal_.HTMLDataElement.md#onclick)
- [onclose](input._internal_.HTMLDataElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLDataElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLDataElement.md#oncopy)
- [oncuechange](input._internal_.HTMLDataElement.md#oncuechange)
- [oncut](input._internal_.HTMLDataElement.md#oncut)
- [ondblclick](input._internal_.HTMLDataElement.md#ondblclick)
- [ondrag](input._internal_.HTMLDataElement.md#ondrag)
- [ondragend](input._internal_.HTMLDataElement.md#ondragend)
- [ondragenter](input._internal_.HTMLDataElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLDataElement.md#ondragleave)
- [ondragover](input._internal_.HTMLDataElement.md#ondragover)
- [ondragstart](input._internal_.HTMLDataElement.md#ondragstart)
- [ondrop](input._internal_.HTMLDataElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLDataElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLDataElement.md#onemptied)
- [onended](input._internal_.HTMLDataElement.md#onended)
- [onerror](input._internal_.HTMLDataElement.md#onerror)
- [onfocus](input._internal_.HTMLDataElement.md#onfocus)
- [onformdata](input._internal_.HTMLDataElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLDataElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLDataElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLDataElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLDataElement.md#oninput)
- [oninvalid](input._internal_.HTMLDataElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLDataElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLDataElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLDataElement.md#onkeyup)
- [onload](input._internal_.HTMLDataElement.md#onload)
- [onloadeddata](input._internal_.HTMLDataElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLDataElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLDataElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLDataElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLDataElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLDataElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLDataElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLDataElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLDataElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLDataElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLDataElement.md#onmouseup)
- [onpaste](input._internal_.HTMLDataElement.md#onpaste)
- [onpause](input._internal_.HTMLDataElement.md#onpause)
- [onplay](input._internal_.HTMLDataElement.md#onplay)
- [onplaying](input._internal_.HTMLDataElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLDataElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLDataElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLDataElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLDataElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLDataElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLDataElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLDataElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLDataElement.md#onpointerup)
- [onprogress](input._internal_.HTMLDataElement.md#onprogress)
- [onratechange](input._internal_.HTMLDataElement.md#onratechange)
- [onreset](input._internal_.HTMLDataElement.md#onreset)
- [onresize](input._internal_.HTMLDataElement.md#onresize)
- [onscroll](input._internal_.HTMLDataElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLDataElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLDataElement.md#onseeked)
- [onseeking](input._internal_.HTMLDataElement.md#onseeking)
- [onselect](input._internal_.HTMLDataElement.md#onselect)
- [onselectionchange](input._internal_.HTMLDataElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLDataElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLDataElement.md#onslotchange)
- [onstalled](input._internal_.HTMLDataElement.md#onstalled)
- [onsubmit](input._internal_.HTMLDataElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLDataElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLDataElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLDataElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLDataElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLDataElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLDataElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLDataElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLDataElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLDataElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLDataElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLDataElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLDataElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLDataElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLDataElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLDataElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLDataElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLDataElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLDataElement.md#onwheel)
- [outerHTML](input._internal_.HTMLDataElement.md#outerhtml)
- [outerText](input._internal_.HTMLDataElement.md#outertext)
- [ownerDocument](input._internal_.HTMLDataElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLDataElement.md#parentelement)
- [parentNode](input._internal_.HTMLDataElement.md#parentnode)
- [part](input._internal_.HTMLDataElement.md#part)
- [prefix](input._internal_.HTMLDataElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLDataElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLDataElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLDataElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLDataElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLDataElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLDataElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLDataElement.md#shadowroot)
- [slot](input._internal_.HTMLDataElement.md#slot)
- [spellcheck](input._internal_.HTMLDataElement.md#spellcheck)
- [style](input._internal_.HTMLDataElement.md#style)
- [tabIndex](input._internal_.HTMLDataElement.md#tabindex)
- [tagName](input._internal_.HTMLDataElement.md#tagname)
- [textContent](input._internal_.HTMLDataElement.md#textcontent)
- [title](input._internal_.HTMLDataElement.md#title)
- [translate](input._internal_.HTMLDataElement.md#translate)
- [value](input._internal_.HTMLDataElement.md#value)

### Methods

- [addEventListener](input._internal_.HTMLDataElement.md#addeventlistener)
- [after](input._internal_.HTMLDataElement.md#after)
- [animate](input._internal_.HTMLDataElement.md#animate)
- [append](input._internal_.HTMLDataElement.md#append)
- [appendChild](input._internal_.HTMLDataElement.md#appendchild)
- [attachInternals](input._internal_.HTMLDataElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLDataElement.md#attachshadow)
- [before](input._internal_.HTMLDataElement.md#before)
- [blur](input._internal_.HTMLDataElement.md#blur)
- [click](input._internal_.HTMLDataElement.md#click)
- [cloneNode](input._internal_.HTMLDataElement.md#clonenode)
- [closest](input._internal_.HTMLDataElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLDataElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLDataElement.md#contains)
- [dispatchEvent](input._internal_.HTMLDataElement.md#dispatchevent)
- [focus](input._internal_.HTMLDataElement.md#focus)
- [getAnimations](input._internal_.HTMLDataElement.md#getanimations)
- [getAttribute](input._internal_.HTMLDataElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLDataElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLDataElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLDataElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLDataElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLDataElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLDataElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLDataElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLDataElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLDataElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLDataElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLDataElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLDataElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLDataElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLDataElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLDataElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLDataElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLDataElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLDataElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLDataElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLDataElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLDataElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLDataElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLDataElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLDataElement.md#lookupprefix)
- [matches](input._internal_.HTMLDataElement.md#matches)
- [normalize](input._internal_.HTMLDataElement.md#normalize)
- [prepend](input._internal_.HTMLDataElement.md#prepend)
- [querySelector](input._internal_.HTMLDataElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLDataElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLDataElement.md#releasepointercapture)
- [remove](input._internal_.HTMLDataElement.md#remove)
- [removeAttribute](input._internal_.HTMLDataElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLDataElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLDataElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLDataElement.md#removechild)
- [removeEventListener](input._internal_.HTMLDataElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLDataElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLDataElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLDataElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLDataElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLDataElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLDataElement.md#scroll)
- [scrollBy](input._internal_.HTMLDataElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLDataElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLDataElement.md#scrollto)
- [setAttribute](input._internal_.HTMLDataElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLDataElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLDataElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLDataElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLDataElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLDataElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLDataElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLDataElement`](../modules/input._internal_.md#htmldataelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
