[Droom Google Location Plugin - v1.0.16](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGDefsElement

# Interface: SVGDefsElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGDefsElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGDefsElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGDefsElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGDefsElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGDefsElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGDefsElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGDefsElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGDefsElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGDefsElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGDefsElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGDefsElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGDefsElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGDefsElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGDefsElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGDefsElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGDefsElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGDefsElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGDefsElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGDefsElement.md#text_node)
- [ariaAtomic](input._internal_.SVGDefsElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGDefsElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGDefsElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGDefsElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGDefsElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGDefsElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGDefsElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGDefsElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGDefsElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGDefsElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGDefsElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGDefsElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGDefsElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGDefsElement.md#arialabel)
- [ariaLevel](input._internal_.SVGDefsElement.md#arialevel)
- [ariaLive](input._internal_.SVGDefsElement.md#arialive)
- [ariaModal](input._internal_.SVGDefsElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGDefsElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGDefsElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGDefsElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGDefsElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGDefsElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGDefsElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGDefsElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGDefsElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGDefsElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGDefsElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGDefsElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGDefsElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGDefsElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGDefsElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGDefsElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGDefsElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGDefsElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGDefsElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGDefsElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGDefsElement.md#assignedslot)
- [attributes](input._internal_.SVGDefsElement.md#attributes)
- [autofocus](input._internal_.SVGDefsElement.md#autofocus)
- [baseURI](input._internal_.SVGDefsElement.md#baseuri)
- [childElementCount](input._internal_.SVGDefsElement.md#childelementcount)
- [childNodes](input._internal_.SVGDefsElement.md#childnodes)
- [children](input._internal_.SVGDefsElement.md#children)
- [classList](input._internal_.SVGDefsElement.md#classlist)
- [className](input._internal_.SVGDefsElement.md#classname)
- [clientHeight](input._internal_.SVGDefsElement.md#clientheight)
- [clientLeft](input._internal_.SVGDefsElement.md#clientleft)
- [clientTop](input._internal_.SVGDefsElement.md#clienttop)
- [clientWidth](input._internal_.SVGDefsElement.md#clientwidth)
- [dataset](input._internal_.SVGDefsElement.md#dataset)
- [firstChild](input._internal_.SVGDefsElement.md#firstchild)
- [firstElementChild](input._internal_.SVGDefsElement.md#firstelementchild)
- [id](input._internal_.SVGDefsElement.md#id)
- [innerHTML](input._internal_.SVGDefsElement.md#innerhtml)
- [isConnected](input._internal_.SVGDefsElement.md#isconnected)
- [lastChild](input._internal_.SVGDefsElement.md#lastchild)
- [lastElementChild](input._internal_.SVGDefsElement.md#lastelementchild)
- [localName](input._internal_.SVGDefsElement.md#localname)
- [namespaceURI](input._internal_.SVGDefsElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGDefsElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGDefsElement.md#nextsibling)
- [nodeName](input._internal_.SVGDefsElement.md#nodename)
- [nodeType](input._internal_.SVGDefsElement.md#nodetype)
- [nodeValue](input._internal_.SVGDefsElement.md#nodevalue)
- [nonce](input._internal_.SVGDefsElement.md#nonce)
- [onabort](input._internal_.SVGDefsElement.md#onabort)
- [onanimationcancel](input._internal_.SVGDefsElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGDefsElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGDefsElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGDefsElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGDefsElement.md#onauxclick)
- [onblur](input._internal_.SVGDefsElement.md#onblur)
- [oncanplay](input._internal_.SVGDefsElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGDefsElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGDefsElement.md#onchange)
- [onclick](input._internal_.SVGDefsElement.md#onclick)
- [onclose](input._internal_.SVGDefsElement.md#onclose)
- [oncontextmenu](input._internal_.SVGDefsElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGDefsElement.md#oncopy)
- [oncuechange](input._internal_.SVGDefsElement.md#oncuechange)
- [oncut](input._internal_.SVGDefsElement.md#oncut)
- [ondblclick](input._internal_.SVGDefsElement.md#ondblclick)
- [ondrag](input._internal_.SVGDefsElement.md#ondrag)
- [ondragend](input._internal_.SVGDefsElement.md#ondragend)
- [ondragenter](input._internal_.SVGDefsElement.md#ondragenter)
- [ondragleave](input._internal_.SVGDefsElement.md#ondragleave)
- [ondragover](input._internal_.SVGDefsElement.md#ondragover)
- [ondragstart](input._internal_.SVGDefsElement.md#ondragstart)
- [ondrop](input._internal_.SVGDefsElement.md#ondrop)
- [ondurationchange](input._internal_.SVGDefsElement.md#ondurationchange)
- [onemptied](input._internal_.SVGDefsElement.md#onemptied)
- [onended](input._internal_.SVGDefsElement.md#onended)
- [onerror](input._internal_.SVGDefsElement.md#onerror)
- [onfocus](input._internal_.SVGDefsElement.md#onfocus)
- [onformdata](input._internal_.SVGDefsElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGDefsElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGDefsElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGDefsElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGDefsElement.md#oninput)
- [oninvalid](input._internal_.SVGDefsElement.md#oninvalid)
- [onkeydown](input._internal_.SVGDefsElement.md#onkeydown)
- [onkeypress](input._internal_.SVGDefsElement.md#onkeypress)
- [onkeyup](input._internal_.SVGDefsElement.md#onkeyup)
- [onload](input._internal_.SVGDefsElement.md#onload)
- [onloadeddata](input._internal_.SVGDefsElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGDefsElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGDefsElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGDefsElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGDefsElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGDefsElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGDefsElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGDefsElement.md#onmousemove)
- [onmouseout](input._internal_.SVGDefsElement.md#onmouseout)
- [onmouseover](input._internal_.SVGDefsElement.md#onmouseover)
- [onmouseup](input._internal_.SVGDefsElement.md#onmouseup)
- [onpaste](input._internal_.SVGDefsElement.md#onpaste)
- [onpause](input._internal_.SVGDefsElement.md#onpause)
- [onplay](input._internal_.SVGDefsElement.md#onplay)
- [onplaying](input._internal_.SVGDefsElement.md#onplaying)
- [onpointercancel](input._internal_.SVGDefsElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGDefsElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGDefsElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGDefsElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGDefsElement.md#onpointermove)
- [onpointerout](input._internal_.SVGDefsElement.md#onpointerout)
- [onpointerover](input._internal_.SVGDefsElement.md#onpointerover)
- [onpointerup](input._internal_.SVGDefsElement.md#onpointerup)
- [onprogress](input._internal_.SVGDefsElement.md#onprogress)
- [onratechange](input._internal_.SVGDefsElement.md#onratechange)
- [onreset](input._internal_.SVGDefsElement.md#onreset)
- [onresize](input._internal_.SVGDefsElement.md#onresize)
- [onscroll](input._internal_.SVGDefsElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGDefsElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGDefsElement.md#onseeked)
- [onseeking](input._internal_.SVGDefsElement.md#onseeking)
- [onselect](input._internal_.SVGDefsElement.md#onselect)
- [onselectionchange](input._internal_.SVGDefsElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGDefsElement.md#onselectstart)
- [onslotchange](input._internal_.SVGDefsElement.md#onslotchange)
- [onstalled](input._internal_.SVGDefsElement.md#onstalled)
- [onsubmit](input._internal_.SVGDefsElement.md#onsubmit)
- [onsuspend](input._internal_.SVGDefsElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGDefsElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGDefsElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGDefsElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGDefsElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGDefsElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGDefsElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGDefsElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGDefsElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGDefsElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGDefsElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGDefsElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGDefsElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGDefsElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGDefsElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGDefsElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGDefsElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGDefsElement.md#onwheel)
- [outerHTML](input._internal_.SVGDefsElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGDefsElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGDefsElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGDefsElement.md#parentelement)
- [parentNode](input._internal_.SVGDefsElement.md#parentnode)
- [part](input._internal_.SVGDefsElement.md#part)
- [prefix](input._internal_.SVGDefsElement.md#prefix)
- [previousElementSibling](input._internal_.SVGDefsElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGDefsElement.md#previoussibling)
- [requiredExtensions](input._internal_.SVGDefsElement.md#requiredextensions)
- [scrollHeight](input._internal_.SVGDefsElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGDefsElement.md#scrollleft)
- [scrollTop](input._internal_.SVGDefsElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGDefsElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGDefsElement.md#shadowroot)
- [slot](input._internal_.SVGDefsElement.md#slot)
- [style](input._internal_.SVGDefsElement.md#style)
- [systemLanguage](input._internal_.SVGDefsElement.md#systemlanguage)
- [tabIndex](input._internal_.SVGDefsElement.md#tabindex)
- [tagName](input._internal_.SVGDefsElement.md#tagname)
- [textContent](input._internal_.SVGDefsElement.md#textcontent)
- [transform](input._internal_.SVGDefsElement.md#transform)
- [viewportElement](input._internal_.SVGDefsElement.md#viewportelement)

### Methods

- [addEventListener](input._internal_.SVGDefsElement.md#addeventlistener)
- [after](input._internal_.SVGDefsElement.md#after)
- [animate](input._internal_.SVGDefsElement.md#animate)
- [append](input._internal_.SVGDefsElement.md#append)
- [appendChild](input._internal_.SVGDefsElement.md#appendchild)
- [attachShadow](input._internal_.SVGDefsElement.md#attachshadow)
- [before](input._internal_.SVGDefsElement.md#before)
- [blur](input._internal_.SVGDefsElement.md#blur)
- [cloneNode](input._internal_.SVGDefsElement.md#clonenode)
- [closest](input._internal_.SVGDefsElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGDefsElement.md#comparedocumentposition)
- [contains](input._internal_.SVGDefsElement.md#contains)
- [dispatchEvent](input._internal_.SVGDefsElement.md#dispatchevent)
- [focus](input._internal_.SVGDefsElement.md#focus)
- [getAnimations](input._internal_.SVGDefsElement.md#getanimations)
- [getAttribute](input._internal_.SVGDefsElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGDefsElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGDefsElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGDefsElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGDefsElement.md#getattributenodens)
- [getBBox](input._internal_.SVGDefsElement.md#getbbox)
- [getBoundingClientRect](input._internal_.SVGDefsElement.md#getboundingclientrect)
- [getCTM](input._internal_.SVGDefsElement.md#getctm)
- [getClientRects](input._internal_.SVGDefsElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGDefsElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGDefsElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGDefsElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGDefsElement.md#getrootnode)
- [getScreenCTM](input._internal_.SVGDefsElement.md#getscreenctm)
- [hasAttribute](input._internal_.SVGDefsElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGDefsElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGDefsElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGDefsElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGDefsElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGDefsElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGDefsElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGDefsElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGDefsElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGDefsElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGDefsElement.md#isequalnode)
- [isSameNode](input._internal_.SVGDefsElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGDefsElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGDefsElement.md#lookupprefix)
- [matches](input._internal_.SVGDefsElement.md#matches)
- [normalize](input._internal_.SVGDefsElement.md#normalize)
- [prepend](input._internal_.SVGDefsElement.md#prepend)
- [querySelector](input._internal_.SVGDefsElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGDefsElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGDefsElement.md#releasepointercapture)
- [remove](input._internal_.SVGDefsElement.md#remove)
- [removeAttribute](input._internal_.SVGDefsElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGDefsElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGDefsElement.md#removeattributenode)
- [removeChild](input._internal_.SVGDefsElement.md#removechild)
- [removeEventListener](input._internal_.SVGDefsElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGDefsElement.md#replacechild)
- [replaceChildren](input._internal_.SVGDefsElement.md#replacechildren)
- [replaceWith](input._internal_.SVGDefsElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGDefsElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGDefsElement.md#requestpointerlock)
- [scroll](input._internal_.SVGDefsElement.md#scroll)
- [scrollBy](input._internal_.SVGDefsElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGDefsElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGDefsElement.md#scrollto)
- [setAttribute](input._internal_.SVGDefsElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGDefsElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGDefsElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGDefsElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGDefsElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGDefsElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGDefsElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGDefsElement`](../modules/input._internal_.md#svgdefselement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
