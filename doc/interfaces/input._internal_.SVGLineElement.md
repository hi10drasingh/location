[Droom Google Location Plugin - v1.0.11](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGLineElement

# Interface: SVGLineElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGLineElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGLineElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGLineElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGLineElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGLineElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGLineElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGLineElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGLineElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGLineElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGLineElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGLineElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGLineElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGLineElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGLineElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGLineElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGLineElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGLineElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGLineElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGLineElement.md#text_node)
- [ariaAtomic](input._internal_.SVGLineElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGLineElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGLineElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGLineElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGLineElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGLineElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGLineElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGLineElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGLineElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGLineElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGLineElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGLineElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGLineElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGLineElement.md#arialabel)
- [ariaLevel](input._internal_.SVGLineElement.md#arialevel)
- [ariaLive](input._internal_.SVGLineElement.md#arialive)
- [ariaModal](input._internal_.SVGLineElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGLineElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGLineElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGLineElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGLineElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGLineElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGLineElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGLineElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGLineElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGLineElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGLineElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGLineElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGLineElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGLineElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGLineElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGLineElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGLineElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGLineElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGLineElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGLineElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGLineElement.md#assignedslot)
- [attributes](input._internal_.SVGLineElement.md#attributes)
- [autofocus](input._internal_.SVGLineElement.md#autofocus)
- [baseURI](input._internal_.SVGLineElement.md#baseuri)
- [childElementCount](input._internal_.SVGLineElement.md#childelementcount)
- [childNodes](input._internal_.SVGLineElement.md#childnodes)
- [children](input._internal_.SVGLineElement.md#children)
- [classList](input._internal_.SVGLineElement.md#classlist)
- [className](input._internal_.SVGLineElement.md#classname)
- [clientHeight](input._internal_.SVGLineElement.md#clientheight)
- [clientLeft](input._internal_.SVGLineElement.md#clientleft)
- [clientTop](input._internal_.SVGLineElement.md#clienttop)
- [clientWidth](input._internal_.SVGLineElement.md#clientwidth)
- [dataset](input._internal_.SVGLineElement.md#dataset)
- [firstChild](input._internal_.SVGLineElement.md#firstchild)
- [firstElementChild](input._internal_.SVGLineElement.md#firstelementchild)
- [id](input._internal_.SVGLineElement.md#id)
- [innerHTML](input._internal_.SVGLineElement.md#innerhtml)
- [isConnected](input._internal_.SVGLineElement.md#isconnected)
- [lastChild](input._internal_.SVGLineElement.md#lastchild)
- [lastElementChild](input._internal_.SVGLineElement.md#lastelementchild)
- [localName](input._internal_.SVGLineElement.md#localname)
- [namespaceURI](input._internal_.SVGLineElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGLineElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGLineElement.md#nextsibling)
- [nodeName](input._internal_.SVGLineElement.md#nodename)
- [nodeType](input._internal_.SVGLineElement.md#nodetype)
- [nodeValue](input._internal_.SVGLineElement.md#nodevalue)
- [nonce](input._internal_.SVGLineElement.md#nonce)
- [onabort](input._internal_.SVGLineElement.md#onabort)
- [onanimationcancel](input._internal_.SVGLineElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGLineElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGLineElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGLineElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGLineElement.md#onauxclick)
- [onblur](input._internal_.SVGLineElement.md#onblur)
- [oncanplay](input._internal_.SVGLineElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGLineElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGLineElement.md#onchange)
- [onclick](input._internal_.SVGLineElement.md#onclick)
- [onclose](input._internal_.SVGLineElement.md#onclose)
- [oncontextmenu](input._internal_.SVGLineElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGLineElement.md#oncopy)
- [oncuechange](input._internal_.SVGLineElement.md#oncuechange)
- [oncut](input._internal_.SVGLineElement.md#oncut)
- [ondblclick](input._internal_.SVGLineElement.md#ondblclick)
- [ondrag](input._internal_.SVGLineElement.md#ondrag)
- [ondragend](input._internal_.SVGLineElement.md#ondragend)
- [ondragenter](input._internal_.SVGLineElement.md#ondragenter)
- [ondragleave](input._internal_.SVGLineElement.md#ondragleave)
- [ondragover](input._internal_.SVGLineElement.md#ondragover)
- [ondragstart](input._internal_.SVGLineElement.md#ondragstart)
- [ondrop](input._internal_.SVGLineElement.md#ondrop)
- [ondurationchange](input._internal_.SVGLineElement.md#ondurationchange)
- [onemptied](input._internal_.SVGLineElement.md#onemptied)
- [onended](input._internal_.SVGLineElement.md#onended)
- [onerror](input._internal_.SVGLineElement.md#onerror)
- [onfocus](input._internal_.SVGLineElement.md#onfocus)
- [onformdata](input._internal_.SVGLineElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGLineElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGLineElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGLineElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGLineElement.md#oninput)
- [oninvalid](input._internal_.SVGLineElement.md#oninvalid)
- [onkeydown](input._internal_.SVGLineElement.md#onkeydown)
- [onkeypress](input._internal_.SVGLineElement.md#onkeypress)
- [onkeyup](input._internal_.SVGLineElement.md#onkeyup)
- [onload](input._internal_.SVGLineElement.md#onload)
- [onloadeddata](input._internal_.SVGLineElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGLineElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGLineElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGLineElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGLineElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGLineElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGLineElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGLineElement.md#onmousemove)
- [onmouseout](input._internal_.SVGLineElement.md#onmouseout)
- [onmouseover](input._internal_.SVGLineElement.md#onmouseover)
- [onmouseup](input._internal_.SVGLineElement.md#onmouseup)
- [onpaste](input._internal_.SVGLineElement.md#onpaste)
- [onpause](input._internal_.SVGLineElement.md#onpause)
- [onplay](input._internal_.SVGLineElement.md#onplay)
- [onplaying](input._internal_.SVGLineElement.md#onplaying)
- [onpointercancel](input._internal_.SVGLineElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGLineElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGLineElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGLineElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGLineElement.md#onpointermove)
- [onpointerout](input._internal_.SVGLineElement.md#onpointerout)
- [onpointerover](input._internal_.SVGLineElement.md#onpointerover)
- [onpointerup](input._internal_.SVGLineElement.md#onpointerup)
- [onprogress](input._internal_.SVGLineElement.md#onprogress)
- [onratechange](input._internal_.SVGLineElement.md#onratechange)
- [onreset](input._internal_.SVGLineElement.md#onreset)
- [onresize](input._internal_.SVGLineElement.md#onresize)
- [onscroll](input._internal_.SVGLineElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGLineElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGLineElement.md#onseeked)
- [onseeking](input._internal_.SVGLineElement.md#onseeking)
- [onselect](input._internal_.SVGLineElement.md#onselect)
- [onselectionchange](input._internal_.SVGLineElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGLineElement.md#onselectstart)
- [onslotchange](input._internal_.SVGLineElement.md#onslotchange)
- [onstalled](input._internal_.SVGLineElement.md#onstalled)
- [onsubmit](input._internal_.SVGLineElement.md#onsubmit)
- [onsuspend](input._internal_.SVGLineElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGLineElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGLineElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGLineElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGLineElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGLineElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGLineElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGLineElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGLineElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGLineElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGLineElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGLineElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGLineElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGLineElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGLineElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGLineElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGLineElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGLineElement.md#onwheel)
- [outerHTML](input._internal_.SVGLineElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGLineElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGLineElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGLineElement.md#parentelement)
- [parentNode](input._internal_.SVGLineElement.md#parentnode)
- [part](input._internal_.SVGLineElement.md#part)
- [pathLength](input._internal_.SVGLineElement.md#pathlength)
- [prefix](input._internal_.SVGLineElement.md#prefix)
- [previousElementSibling](input._internal_.SVGLineElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGLineElement.md#previoussibling)
- [requiredExtensions](input._internal_.SVGLineElement.md#requiredextensions)
- [scrollHeight](input._internal_.SVGLineElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGLineElement.md#scrollleft)
- [scrollTop](input._internal_.SVGLineElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGLineElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGLineElement.md#shadowroot)
- [slot](input._internal_.SVGLineElement.md#slot)
- [style](input._internal_.SVGLineElement.md#style)
- [systemLanguage](input._internal_.SVGLineElement.md#systemlanguage)
- [tabIndex](input._internal_.SVGLineElement.md#tabindex)
- [tagName](input._internal_.SVGLineElement.md#tagname)
- [textContent](input._internal_.SVGLineElement.md#textcontent)
- [transform](input._internal_.SVGLineElement.md#transform)
- [viewportElement](input._internal_.SVGLineElement.md#viewportelement)
- [x1](input._internal_.SVGLineElement.md#x1)
- [x2](input._internal_.SVGLineElement.md#x2)
- [y1](input._internal_.SVGLineElement.md#y1)
- [y2](input._internal_.SVGLineElement.md#y2)

### Methods

- [addEventListener](input._internal_.SVGLineElement.md#addeventlistener)
- [after](input._internal_.SVGLineElement.md#after)
- [animate](input._internal_.SVGLineElement.md#animate)
- [append](input._internal_.SVGLineElement.md#append)
- [appendChild](input._internal_.SVGLineElement.md#appendchild)
- [attachShadow](input._internal_.SVGLineElement.md#attachshadow)
- [before](input._internal_.SVGLineElement.md#before)
- [blur](input._internal_.SVGLineElement.md#blur)
- [cloneNode](input._internal_.SVGLineElement.md#clonenode)
- [closest](input._internal_.SVGLineElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGLineElement.md#comparedocumentposition)
- [contains](input._internal_.SVGLineElement.md#contains)
- [dispatchEvent](input._internal_.SVGLineElement.md#dispatchevent)
- [focus](input._internal_.SVGLineElement.md#focus)
- [getAnimations](input._internal_.SVGLineElement.md#getanimations)
- [getAttribute](input._internal_.SVGLineElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGLineElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGLineElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGLineElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGLineElement.md#getattributenodens)
- [getBBox](input._internal_.SVGLineElement.md#getbbox)
- [getBoundingClientRect](input._internal_.SVGLineElement.md#getboundingclientrect)
- [getCTM](input._internal_.SVGLineElement.md#getctm)
- [getClientRects](input._internal_.SVGLineElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGLineElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGLineElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGLineElement.md#getelementsbytagnamens)
- [getPointAtLength](input._internal_.SVGLineElement.md#getpointatlength)
- [getRootNode](input._internal_.SVGLineElement.md#getrootnode)
- [getScreenCTM](input._internal_.SVGLineElement.md#getscreenctm)
- [getTotalLength](input._internal_.SVGLineElement.md#gettotallength)
- [hasAttribute](input._internal_.SVGLineElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGLineElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGLineElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGLineElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGLineElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGLineElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGLineElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGLineElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGLineElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGLineElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGLineElement.md#isequalnode)
- [isPointInFill](input._internal_.SVGLineElement.md#ispointinfill)
- [isPointInStroke](input._internal_.SVGLineElement.md#ispointinstroke)
- [isSameNode](input._internal_.SVGLineElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGLineElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGLineElement.md#lookupprefix)
- [matches](input._internal_.SVGLineElement.md#matches)
- [normalize](input._internal_.SVGLineElement.md#normalize)
- [prepend](input._internal_.SVGLineElement.md#prepend)
- [querySelector](input._internal_.SVGLineElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGLineElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGLineElement.md#releasepointercapture)
- [remove](input._internal_.SVGLineElement.md#remove)
- [removeAttribute](input._internal_.SVGLineElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGLineElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGLineElement.md#removeattributenode)
- [removeChild](input._internal_.SVGLineElement.md#removechild)
- [removeEventListener](input._internal_.SVGLineElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGLineElement.md#replacechild)
- [replaceChildren](input._internal_.SVGLineElement.md#replacechildren)
- [replaceWith](input._internal_.SVGLineElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGLineElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGLineElement.md#requestpointerlock)
- [scroll](input._internal_.SVGLineElement.md#scroll)
- [scrollBy](input._internal_.SVGLineElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGLineElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGLineElement.md#scrollto)
- [setAttribute](input._internal_.SVGLineElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGLineElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGLineElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGLineElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGLineElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGLineElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGLineElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGLineElement`](../modules/input._internal_.md#svglineelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
