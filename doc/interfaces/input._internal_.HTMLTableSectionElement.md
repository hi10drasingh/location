[Droom Google Location Plugin - v1.0.13](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLTableSectionElement

# Interface: HTMLTableSectionElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLTableSectionElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLTableSectionElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLTableSectionElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLTableSectionElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLTableSectionElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLTableSectionElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLTableSectionElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLTableSectionElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLTableSectionElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLTableSectionElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLTableSectionElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLTableSectionElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLTableSectionElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLTableSectionElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLTableSectionElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLTableSectionElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLTableSectionElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLTableSectionElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLTableSectionElement.md#text_node)
- [accessKey](input._internal_.HTMLTableSectionElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLTableSectionElement.md#accesskeylabel)
- [align](input._internal_.HTMLTableSectionElement.md#align)
- [ariaAtomic](input._internal_.HTMLTableSectionElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLTableSectionElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLTableSectionElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLTableSectionElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLTableSectionElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLTableSectionElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLTableSectionElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLTableSectionElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLTableSectionElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLTableSectionElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLTableSectionElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLTableSectionElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLTableSectionElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLTableSectionElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLTableSectionElement.md#arialevel)
- [ariaLive](input._internal_.HTMLTableSectionElement.md#arialive)
- [ariaModal](input._internal_.HTMLTableSectionElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLTableSectionElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLTableSectionElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLTableSectionElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLTableSectionElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLTableSectionElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLTableSectionElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLTableSectionElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLTableSectionElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLTableSectionElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLTableSectionElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLTableSectionElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLTableSectionElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLTableSectionElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLTableSectionElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLTableSectionElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLTableSectionElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLTableSectionElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLTableSectionElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLTableSectionElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLTableSectionElement.md#assignedslot)
- [attributes](input._internal_.HTMLTableSectionElement.md#attributes)
- [autocapitalize](input._internal_.HTMLTableSectionElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLTableSectionElement.md#autofocus)
- [baseURI](input._internal_.HTMLTableSectionElement.md#baseuri)
- [ch](input._internal_.HTMLTableSectionElement.md#ch)
- [chOff](input._internal_.HTMLTableSectionElement.md#choff)
- [childElementCount](input._internal_.HTMLTableSectionElement.md#childelementcount)
- [childNodes](input._internal_.HTMLTableSectionElement.md#childnodes)
- [children](input._internal_.HTMLTableSectionElement.md#children)
- [classList](input._internal_.HTMLTableSectionElement.md#classlist)
- [className](input._internal_.HTMLTableSectionElement.md#classname)
- [clientHeight](input._internal_.HTMLTableSectionElement.md#clientheight)
- [clientLeft](input._internal_.HTMLTableSectionElement.md#clientleft)
- [clientTop](input._internal_.HTMLTableSectionElement.md#clienttop)
- [clientWidth](input._internal_.HTMLTableSectionElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLTableSectionElement.md#contenteditable)
- [dataset](input._internal_.HTMLTableSectionElement.md#dataset)
- [dir](input._internal_.HTMLTableSectionElement.md#dir)
- [draggable](input._internal_.HTMLTableSectionElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLTableSectionElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLTableSectionElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLTableSectionElement.md#firstelementchild)
- [hidden](input._internal_.HTMLTableSectionElement.md#hidden)
- [id](input._internal_.HTMLTableSectionElement.md#id)
- [innerHTML](input._internal_.HTMLTableSectionElement.md#innerhtml)
- [innerText](input._internal_.HTMLTableSectionElement.md#innertext)
- [inputMode](input._internal_.HTMLTableSectionElement.md#inputmode)
- [isConnected](input._internal_.HTMLTableSectionElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLTableSectionElement.md#iscontenteditable)
- [lang](input._internal_.HTMLTableSectionElement.md#lang)
- [lastChild](input._internal_.HTMLTableSectionElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLTableSectionElement.md#lastelementchild)
- [localName](input._internal_.HTMLTableSectionElement.md#localname)
- [namespaceURI](input._internal_.HTMLTableSectionElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLTableSectionElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLTableSectionElement.md#nextsibling)
- [nodeName](input._internal_.HTMLTableSectionElement.md#nodename)
- [nodeType](input._internal_.HTMLTableSectionElement.md#nodetype)
- [nodeValue](input._internal_.HTMLTableSectionElement.md#nodevalue)
- [nonce](input._internal_.HTMLTableSectionElement.md#nonce)
- [offsetHeight](input._internal_.HTMLTableSectionElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLTableSectionElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLTableSectionElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLTableSectionElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLTableSectionElement.md#offsetwidth)
- [onabort](input._internal_.HTMLTableSectionElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLTableSectionElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLTableSectionElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLTableSectionElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLTableSectionElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLTableSectionElement.md#onauxclick)
- [onblur](input._internal_.HTMLTableSectionElement.md#onblur)
- [oncanplay](input._internal_.HTMLTableSectionElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLTableSectionElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLTableSectionElement.md#onchange)
- [onclick](input._internal_.HTMLTableSectionElement.md#onclick)
- [onclose](input._internal_.HTMLTableSectionElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLTableSectionElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLTableSectionElement.md#oncopy)
- [oncuechange](input._internal_.HTMLTableSectionElement.md#oncuechange)
- [oncut](input._internal_.HTMLTableSectionElement.md#oncut)
- [ondblclick](input._internal_.HTMLTableSectionElement.md#ondblclick)
- [ondrag](input._internal_.HTMLTableSectionElement.md#ondrag)
- [ondragend](input._internal_.HTMLTableSectionElement.md#ondragend)
- [ondragenter](input._internal_.HTMLTableSectionElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLTableSectionElement.md#ondragleave)
- [ondragover](input._internal_.HTMLTableSectionElement.md#ondragover)
- [ondragstart](input._internal_.HTMLTableSectionElement.md#ondragstart)
- [ondrop](input._internal_.HTMLTableSectionElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLTableSectionElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLTableSectionElement.md#onemptied)
- [onended](input._internal_.HTMLTableSectionElement.md#onended)
- [onerror](input._internal_.HTMLTableSectionElement.md#onerror)
- [onfocus](input._internal_.HTMLTableSectionElement.md#onfocus)
- [onformdata](input._internal_.HTMLTableSectionElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLTableSectionElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLTableSectionElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLTableSectionElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLTableSectionElement.md#oninput)
- [oninvalid](input._internal_.HTMLTableSectionElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLTableSectionElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLTableSectionElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLTableSectionElement.md#onkeyup)
- [onload](input._internal_.HTMLTableSectionElement.md#onload)
- [onloadeddata](input._internal_.HTMLTableSectionElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLTableSectionElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLTableSectionElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLTableSectionElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLTableSectionElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLTableSectionElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLTableSectionElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLTableSectionElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLTableSectionElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLTableSectionElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLTableSectionElement.md#onmouseup)
- [onpaste](input._internal_.HTMLTableSectionElement.md#onpaste)
- [onpause](input._internal_.HTMLTableSectionElement.md#onpause)
- [onplay](input._internal_.HTMLTableSectionElement.md#onplay)
- [onplaying](input._internal_.HTMLTableSectionElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLTableSectionElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLTableSectionElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLTableSectionElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLTableSectionElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLTableSectionElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLTableSectionElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLTableSectionElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLTableSectionElement.md#onpointerup)
- [onprogress](input._internal_.HTMLTableSectionElement.md#onprogress)
- [onratechange](input._internal_.HTMLTableSectionElement.md#onratechange)
- [onreset](input._internal_.HTMLTableSectionElement.md#onreset)
- [onresize](input._internal_.HTMLTableSectionElement.md#onresize)
- [onscroll](input._internal_.HTMLTableSectionElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLTableSectionElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLTableSectionElement.md#onseeked)
- [onseeking](input._internal_.HTMLTableSectionElement.md#onseeking)
- [onselect](input._internal_.HTMLTableSectionElement.md#onselect)
- [onselectionchange](input._internal_.HTMLTableSectionElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLTableSectionElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLTableSectionElement.md#onslotchange)
- [onstalled](input._internal_.HTMLTableSectionElement.md#onstalled)
- [onsubmit](input._internal_.HTMLTableSectionElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLTableSectionElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLTableSectionElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLTableSectionElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLTableSectionElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLTableSectionElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLTableSectionElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLTableSectionElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLTableSectionElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLTableSectionElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLTableSectionElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLTableSectionElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLTableSectionElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLTableSectionElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLTableSectionElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLTableSectionElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLTableSectionElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLTableSectionElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLTableSectionElement.md#onwheel)
- [outerHTML](input._internal_.HTMLTableSectionElement.md#outerhtml)
- [outerText](input._internal_.HTMLTableSectionElement.md#outertext)
- [ownerDocument](input._internal_.HTMLTableSectionElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLTableSectionElement.md#parentelement)
- [parentNode](input._internal_.HTMLTableSectionElement.md#parentnode)
- [part](input._internal_.HTMLTableSectionElement.md#part)
- [prefix](input._internal_.HTMLTableSectionElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLTableSectionElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLTableSectionElement.md#previoussibling)
- [rows](input._internal_.HTMLTableSectionElement.md#rows)
- [scrollHeight](input._internal_.HTMLTableSectionElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLTableSectionElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLTableSectionElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLTableSectionElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLTableSectionElement.md#shadowroot)
- [slot](input._internal_.HTMLTableSectionElement.md#slot)
- [spellcheck](input._internal_.HTMLTableSectionElement.md#spellcheck)
- [style](input._internal_.HTMLTableSectionElement.md#style)
- [tabIndex](input._internal_.HTMLTableSectionElement.md#tabindex)
- [tagName](input._internal_.HTMLTableSectionElement.md#tagname)
- [textContent](input._internal_.HTMLTableSectionElement.md#textcontent)
- [title](input._internal_.HTMLTableSectionElement.md#title)
- [translate](input._internal_.HTMLTableSectionElement.md#translate)
- [vAlign](input._internal_.HTMLTableSectionElement.md#valign)

### Methods

- [addEventListener](input._internal_.HTMLTableSectionElement.md#addeventlistener)
- [after](input._internal_.HTMLTableSectionElement.md#after)
- [animate](input._internal_.HTMLTableSectionElement.md#animate)
- [append](input._internal_.HTMLTableSectionElement.md#append)
- [appendChild](input._internal_.HTMLTableSectionElement.md#appendchild)
- [attachInternals](input._internal_.HTMLTableSectionElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLTableSectionElement.md#attachshadow)
- [before](input._internal_.HTMLTableSectionElement.md#before)
- [blur](input._internal_.HTMLTableSectionElement.md#blur)
- [click](input._internal_.HTMLTableSectionElement.md#click)
- [cloneNode](input._internal_.HTMLTableSectionElement.md#clonenode)
- [closest](input._internal_.HTMLTableSectionElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLTableSectionElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLTableSectionElement.md#contains)
- [deleteRow](input._internal_.HTMLTableSectionElement.md#deleterow)
- [dispatchEvent](input._internal_.HTMLTableSectionElement.md#dispatchevent)
- [focus](input._internal_.HTMLTableSectionElement.md#focus)
- [getAnimations](input._internal_.HTMLTableSectionElement.md#getanimations)
- [getAttribute](input._internal_.HTMLTableSectionElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLTableSectionElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLTableSectionElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLTableSectionElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLTableSectionElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLTableSectionElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLTableSectionElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLTableSectionElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLTableSectionElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLTableSectionElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLTableSectionElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLTableSectionElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLTableSectionElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLTableSectionElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLTableSectionElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLTableSectionElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLTableSectionElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLTableSectionElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLTableSectionElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLTableSectionElement.md#insertbefore)
- [insertRow](input._internal_.HTMLTableSectionElement.md#insertrow)
- [isDefaultNamespace](input._internal_.HTMLTableSectionElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLTableSectionElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLTableSectionElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLTableSectionElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLTableSectionElement.md#lookupprefix)
- [matches](input._internal_.HTMLTableSectionElement.md#matches)
- [normalize](input._internal_.HTMLTableSectionElement.md#normalize)
- [prepend](input._internal_.HTMLTableSectionElement.md#prepend)
- [querySelector](input._internal_.HTMLTableSectionElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLTableSectionElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLTableSectionElement.md#releasepointercapture)
- [remove](input._internal_.HTMLTableSectionElement.md#remove)
- [removeAttribute](input._internal_.HTMLTableSectionElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLTableSectionElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLTableSectionElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLTableSectionElement.md#removechild)
- [removeEventListener](input._internal_.HTMLTableSectionElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLTableSectionElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLTableSectionElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLTableSectionElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLTableSectionElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLTableSectionElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLTableSectionElement.md#scroll)
- [scrollBy](input._internal_.HTMLTableSectionElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLTableSectionElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLTableSectionElement.md#scrollto)
- [setAttribute](input._internal_.HTMLTableSectionElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLTableSectionElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLTableSectionElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLTableSectionElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLTableSectionElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLTableSectionElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLTableSectionElement.md#webkitmatchesselector)
...
• `Readonly` **rows**: [`HTMLCollectionOf`](input._internal_.HTMLCollectionOf.md)<[`HTMLTableRowElement`](../modules/input._internal_.md#htmltablerowelement)\>
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLTableSectionElement`](../modules/input._internal_.md#htmltablesectionelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
...
▸ **insertRow**(`index?`): [`HTMLTableRowElement`](../modules/input._internal_.md#htmltablerowelement)
...
[`HTMLTableRowElement`](../modules/input._internal_.md#htmltablerowelement)
