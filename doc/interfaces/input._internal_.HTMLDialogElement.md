[Droom Google Location Plugin - v1.0.16](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLDialogElement

# Interface: HTMLDialogElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLDialogElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLDialogElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLDialogElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLDialogElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLDialogElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLDialogElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLDialogElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLDialogElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLDialogElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLDialogElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLDialogElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLDialogElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLDialogElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLDialogElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLDialogElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLDialogElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLDialogElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLDialogElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLDialogElement.md#text_node)
- [accessKey](input._internal_.HTMLDialogElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLDialogElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLDialogElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLDialogElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLDialogElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLDialogElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLDialogElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLDialogElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLDialogElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLDialogElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLDialogElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLDialogElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLDialogElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLDialogElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLDialogElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLDialogElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLDialogElement.md#arialevel)
- [ariaLive](input._internal_.HTMLDialogElement.md#arialive)
- [ariaModal](input._internal_.HTMLDialogElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLDialogElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLDialogElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLDialogElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLDialogElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLDialogElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLDialogElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLDialogElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLDialogElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLDialogElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLDialogElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLDialogElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLDialogElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLDialogElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLDialogElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLDialogElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLDialogElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLDialogElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLDialogElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLDialogElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLDialogElement.md#assignedslot)
- [attributes](input._internal_.HTMLDialogElement.md#attributes)
- [autocapitalize](input._internal_.HTMLDialogElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLDialogElement.md#autofocus)
- [baseURI](input._internal_.HTMLDialogElement.md#baseuri)
- [childElementCount](input._internal_.HTMLDialogElement.md#childelementcount)
- [childNodes](input._internal_.HTMLDialogElement.md#childnodes)
- [children](input._internal_.HTMLDialogElement.md#children)
- [classList](input._internal_.HTMLDialogElement.md#classlist)
- [className](input._internal_.HTMLDialogElement.md#classname)
- [clientHeight](input._internal_.HTMLDialogElement.md#clientheight)
- [clientLeft](input._internal_.HTMLDialogElement.md#clientleft)
- [clientTop](input._internal_.HTMLDialogElement.md#clienttop)
- [clientWidth](input._internal_.HTMLDialogElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLDialogElement.md#contenteditable)
- [dataset](input._internal_.HTMLDialogElement.md#dataset)
- [dir](input._internal_.HTMLDialogElement.md#dir)
- [draggable](input._internal_.HTMLDialogElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLDialogElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLDialogElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLDialogElement.md#firstelementchild)
- [hidden](input._internal_.HTMLDialogElement.md#hidden)
- [id](input._internal_.HTMLDialogElement.md#id)
- [innerHTML](input._internal_.HTMLDialogElement.md#innerhtml)
- [innerText](input._internal_.HTMLDialogElement.md#innertext)
- [inputMode](input._internal_.HTMLDialogElement.md#inputmode)
- [isConnected](input._internal_.HTMLDialogElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLDialogElement.md#iscontenteditable)
- [lang](input._internal_.HTMLDialogElement.md#lang)
- [lastChild](input._internal_.HTMLDialogElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLDialogElement.md#lastelementchild)
- [localName](input._internal_.HTMLDialogElement.md#localname)
- [namespaceURI](input._internal_.HTMLDialogElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLDialogElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLDialogElement.md#nextsibling)
- [nodeName](input._internal_.HTMLDialogElement.md#nodename)
- [nodeType](input._internal_.HTMLDialogElement.md#nodetype)
- [nodeValue](input._internal_.HTMLDialogElement.md#nodevalue)
- [nonce](input._internal_.HTMLDialogElement.md#nonce)
- [offsetHeight](input._internal_.HTMLDialogElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLDialogElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLDialogElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLDialogElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLDialogElement.md#offsetwidth)
- [onabort](input._internal_.HTMLDialogElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLDialogElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLDialogElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLDialogElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLDialogElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLDialogElement.md#onauxclick)
- [onblur](input._internal_.HTMLDialogElement.md#onblur)
- [oncanplay](input._internal_.HTMLDialogElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLDialogElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLDialogElement.md#onchange)
- [onclick](input._internal_.HTMLDialogElement.md#onclick)
- [onclose](input._internal_.HTMLDialogElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLDialogElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLDialogElement.md#oncopy)
- [oncuechange](input._internal_.HTMLDialogElement.md#oncuechange)
- [oncut](input._internal_.HTMLDialogElement.md#oncut)
- [ondblclick](input._internal_.HTMLDialogElement.md#ondblclick)
- [ondrag](input._internal_.HTMLDialogElement.md#ondrag)
- [ondragend](input._internal_.HTMLDialogElement.md#ondragend)
- [ondragenter](input._internal_.HTMLDialogElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLDialogElement.md#ondragleave)
- [ondragover](input._internal_.HTMLDialogElement.md#ondragover)
- [ondragstart](input._internal_.HTMLDialogElement.md#ondragstart)
- [ondrop](input._internal_.HTMLDialogElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLDialogElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLDialogElement.md#onemptied)
- [onended](input._internal_.HTMLDialogElement.md#onended)
- [onerror](input._internal_.HTMLDialogElement.md#onerror)
- [onfocus](input._internal_.HTMLDialogElement.md#onfocus)
- [onformdata](input._internal_.HTMLDialogElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLDialogElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLDialogElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLDialogElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLDialogElement.md#oninput)
- [oninvalid](input._internal_.HTMLDialogElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLDialogElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLDialogElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLDialogElement.md#onkeyup)
- [onload](input._internal_.HTMLDialogElement.md#onload)
- [onloadeddata](input._internal_.HTMLDialogElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLDialogElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLDialogElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLDialogElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLDialogElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLDialogElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLDialogElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLDialogElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLDialogElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLDialogElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLDialogElement.md#onmouseup)
- [onpaste](input._internal_.HTMLDialogElement.md#onpaste)
- [onpause](input._internal_.HTMLDialogElement.md#onpause)
- [onplay](input._internal_.HTMLDialogElement.md#onplay)
- [onplaying](input._internal_.HTMLDialogElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLDialogElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLDialogElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLDialogElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLDialogElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLDialogElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLDialogElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLDialogElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLDialogElement.md#onpointerup)
- [onprogress](input._internal_.HTMLDialogElement.md#onprogress)
- [onratechange](input._internal_.HTMLDialogElement.md#onratechange)
- [onreset](input._internal_.HTMLDialogElement.md#onreset)
- [onresize](input._internal_.HTMLDialogElement.md#onresize)
- [onscroll](input._internal_.HTMLDialogElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLDialogElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLDialogElement.md#onseeked)
- [onseeking](input._internal_.HTMLDialogElement.md#onseeking)
- [onselect](input._internal_.HTMLDialogElement.md#onselect)
- [onselectionchange](input._internal_.HTMLDialogElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLDialogElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLDialogElement.md#onslotchange)
- [onstalled](input._internal_.HTMLDialogElement.md#onstalled)
- [onsubmit](input._internal_.HTMLDialogElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLDialogElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLDialogElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLDialogElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLDialogElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLDialogElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLDialogElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLDialogElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLDialogElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLDialogElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLDialogElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLDialogElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLDialogElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLDialogElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLDialogElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLDialogElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLDialogElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLDialogElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLDialogElement.md#onwheel)
- [open](input._internal_.HTMLDialogElement.md#open)
- [outerHTML](input._internal_.HTMLDialogElement.md#outerhtml)
- [outerText](input._internal_.HTMLDialogElement.md#outertext)
- [ownerDocument](input._internal_.HTMLDialogElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLDialogElement.md#parentelement)
- [parentNode](input._internal_.HTMLDialogElement.md#parentnode)
- [part](input._internal_.HTMLDialogElement.md#part)
- [prefix](input._internal_.HTMLDialogElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLDialogElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLDialogElement.md#previoussibling)
- [returnValue](input._internal_.HTMLDialogElement.md#returnvalue)
- [scrollHeight](input._internal_.HTMLDialogElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLDialogElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLDialogElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLDialogElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLDialogElement.md#shadowroot)
- [slot](input._internal_.HTMLDialogElement.md#slot)
- [spellcheck](input._internal_.HTMLDialogElement.md#spellcheck)
- [style](input._internal_.HTMLDialogElement.md#style)
- [tabIndex](input._internal_.HTMLDialogElement.md#tabindex)
- [tagName](input._internal_.HTMLDialogElement.md#tagname)
- [textContent](input._internal_.HTMLDialogElement.md#textcontent)
- [title](input._internal_.HTMLDialogElement.md#title)
- [translate](input._internal_.HTMLDialogElement.md#translate)

### Methods

- [addEventListener](input._internal_.HTMLDialogElement.md#addeventlistener)
- [after](input._internal_.HTMLDialogElement.md#after)
- [animate](input._internal_.HTMLDialogElement.md#animate)
- [append](input._internal_.HTMLDialogElement.md#append)
- [appendChild](input._internal_.HTMLDialogElement.md#appendchild)
- [attachInternals](input._internal_.HTMLDialogElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLDialogElement.md#attachshadow)
- [before](input._internal_.HTMLDialogElement.md#before)
- [blur](input._internal_.HTMLDialogElement.md#blur)
- [click](input._internal_.HTMLDialogElement.md#click)
- [cloneNode](input._internal_.HTMLDialogElement.md#clonenode)
- [close](input._internal_.HTMLDialogElement.md#close)
- [closest](input._internal_.HTMLDialogElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLDialogElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLDialogElement.md#contains)
- [dispatchEvent](input._internal_.HTMLDialogElement.md#dispatchevent)
- [focus](input._internal_.HTMLDialogElement.md#focus)
- [getAnimations](input._internal_.HTMLDialogElement.md#getanimations)
- [getAttribute](input._internal_.HTMLDialogElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLDialogElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLDialogElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLDialogElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLDialogElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLDialogElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLDialogElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLDialogElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLDialogElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLDialogElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLDialogElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLDialogElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLDialogElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLDialogElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLDialogElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLDialogElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLDialogElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLDialogElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLDialogElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLDialogElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLDialogElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLDialogElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLDialogElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLDialogElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLDialogElement.md#lookupprefix)
- [matches](input._internal_.HTMLDialogElement.md#matches)
- [normalize](input._internal_.HTMLDialogElement.md#normalize)
- [prepend](input._internal_.HTMLDialogElement.md#prepend)
- [querySelector](input._internal_.HTMLDialogElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLDialogElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLDialogElement.md#releasepointercapture)
- [remove](input._internal_.HTMLDialogElement.md#remove)
- [removeAttribute](input._internal_.HTMLDialogElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLDialogElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLDialogElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLDialogElement.md#removechild)
- [removeEventListener](input._internal_.HTMLDialogElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLDialogElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLDialogElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLDialogElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLDialogElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLDialogElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLDialogElement.md#scroll)
- [scrollBy](input._internal_.HTMLDialogElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLDialogElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLDialogElement.md#scrollto)
- [setAttribute](input._internal_.HTMLDialogElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLDialogElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLDialogElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLDialogElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLDialogElement.md#setpointercapture)
- [show](input._internal_.HTMLDialogElement.md#show)
- [showModal](input._internal_.HTMLDialogElement.md#showmodal)
- [toggleAttribute](input._internal_.HTMLDialogElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLDialogElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLDialogElement`](../modules/input._internal_.md#htmldialogelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
