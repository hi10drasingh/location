[Droom Google Location Plugin - v1.0.15](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLImageElement

# Interface: HTMLImageElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLImageElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLImageElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLImageElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLImageElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLImageElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLImageElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLImageElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLImageElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLImageElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLImageElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLImageElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLImageElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLImageElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLImageElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLImageElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLImageElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLImageElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLImageElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLImageElement.md#text_node)
- [accessKey](input._internal_.HTMLImageElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLImageElement.md#accesskeylabel)
- [align](input._internal_.HTMLImageElement.md#align)
- [alt](input._internal_.HTMLImageElement.md#alt)
- [ariaAtomic](input._internal_.HTMLImageElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLImageElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLImageElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLImageElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLImageElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLImageElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLImageElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLImageElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLImageElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLImageElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLImageElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLImageElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLImageElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLImageElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLImageElement.md#arialevel)
- [ariaLive](input._internal_.HTMLImageElement.md#arialive)
- [ariaModal](input._internal_.HTMLImageElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLImageElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLImageElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLImageElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLImageElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLImageElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLImageElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLImageElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLImageElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLImageElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLImageElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLImageElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLImageElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLImageElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLImageElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLImageElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLImageElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLImageElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLImageElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLImageElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLImageElement.md#assignedslot)
- [attributes](input._internal_.HTMLImageElement.md#attributes)
- [autocapitalize](input._internal_.HTMLImageElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLImageElement.md#autofocus)
- [baseURI](input._internal_.HTMLImageElement.md#baseuri)
- [border](input._internal_.HTMLImageElement.md#border)
- [childElementCount](input._internal_.HTMLImageElement.md#childelementcount)
- [childNodes](input._internal_.HTMLImageElement.md#childnodes)
- [children](input._internal_.HTMLImageElement.md#children)
- [classList](input._internal_.HTMLImageElement.md#classlist)
- [className](input._internal_.HTMLImageElement.md#classname)
- [clientHeight](input._internal_.HTMLImageElement.md#clientheight)
- [clientLeft](input._internal_.HTMLImageElement.md#clientleft)
- [clientTop](input._internal_.HTMLImageElement.md#clienttop)
- [clientWidth](input._internal_.HTMLImageElement.md#clientwidth)
- [complete](input._internal_.HTMLImageElement.md#complete)
- [contentEditable](input._internal_.HTMLImageElement.md#contenteditable)
- [crossOrigin](input._internal_.HTMLImageElement.md#crossorigin)
- [currentSrc](input._internal_.HTMLImageElement.md#currentsrc)
- [dataset](input._internal_.HTMLImageElement.md#dataset)
- [decoding](input._internal_.HTMLImageElement.md#decoding)
- [dir](input._internal_.HTMLImageElement.md#dir)
- [draggable](input._internal_.HTMLImageElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLImageElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLImageElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLImageElement.md#firstelementchild)
- [height](input._internal_.HTMLImageElement.md#height)
- [hidden](input._internal_.HTMLImageElement.md#hidden)
- [hspace](input._internal_.HTMLImageElement.md#hspace)
- [id](input._internal_.HTMLImageElement.md#id)
- [innerHTML](input._internal_.HTMLImageElement.md#innerhtml)
- [innerText](input._internal_.HTMLImageElement.md#innertext)
- [inputMode](input._internal_.HTMLImageElement.md#inputmode)
- [isConnected](input._internal_.HTMLImageElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLImageElement.md#iscontenteditable)
- [isMap](input._internal_.HTMLImageElement.md#ismap)
- [lang](input._internal_.HTMLImageElement.md#lang)
- [lastChild](input._internal_.HTMLImageElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLImageElement.md#lastelementchild)
- [loading](input._internal_.HTMLImageElement.md#loading)
- [localName](input._internal_.HTMLImageElement.md#localname)
- [longDesc](input._internal_.HTMLImageElement.md#longdesc)
- [lowsrc](input._internal_.HTMLImageElement.md#lowsrc)
- [name](input._internal_.HTMLImageElement.md#name)
- [namespaceURI](input._internal_.HTMLImageElement.md#namespaceuri)
- [naturalHeight](input._internal_.HTMLImageElement.md#naturalheight)
- [naturalWidth](input._internal_.HTMLImageElement.md#naturalwidth)
- [nextElementSibling](input._internal_.HTMLImageElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLImageElement.md#nextsibling)
- [nodeName](input._internal_.HTMLImageElement.md#nodename)
- [nodeType](input._internal_.HTMLImageElement.md#nodetype)
- [nodeValue](input._internal_.HTMLImageElement.md#nodevalue)
- [nonce](input._internal_.HTMLImageElement.md#nonce)
- [offsetHeight](input._internal_.HTMLImageElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLImageElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLImageElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLImageElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLImageElement.md#offsetwidth)
- [onabort](input._internal_.HTMLImageElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLImageElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLImageElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLImageElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLImageElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLImageElement.md#onauxclick)
- [onblur](input._internal_.HTMLImageElement.md#onblur)
- [oncanplay](input._internal_.HTMLImageElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLImageElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLImageElement.md#onchange)
- [onclick](input._internal_.HTMLImageElement.md#onclick)
- [onclose](input._internal_.HTMLImageElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLImageElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLImageElement.md#oncopy)
- [oncuechange](input._internal_.HTMLImageElement.md#oncuechange)
- [oncut](input._internal_.HTMLImageElement.md#oncut)
- [ondblclick](input._internal_.HTMLImageElement.md#ondblclick)
- [ondrag](input._internal_.HTMLImageElement.md#ondrag)
- [ondragend](input._internal_.HTMLImageElement.md#ondragend)
- [ondragenter](input._internal_.HTMLImageElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLImageElement.md#ondragleave)
- [ondragover](input._internal_.HTMLImageElement.md#ondragover)
- [ondragstart](input._internal_.HTMLImageElement.md#ondragstart)
- [ondrop](input._internal_.HTMLImageElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLImageElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLImageElement.md#onemptied)
- [onended](input._internal_.HTMLImageElement.md#onended)
- [onerror](input._internal_.HTMLImageElement.md#onerror)
- [onfocus](input._internal_.HTMLImageElement.md#onfocus)
- [onformdata](input._internal_.HTMLImageElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLImageElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLImageElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLImageElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLImageElement.md#oninput)
- [oninvalid](input._internal_.HTMLImageElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLImageElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLImageElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLImageElement.md#onkeyup)
- [onload](input._internal_.HTMLImageElement.md#onload)
- [onloadeddata](input._internal_.HTMLImageElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLImageElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLImageElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLImageElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLImageElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLImageElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLImageElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLImageElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLImageElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLImageElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLImageElement.md#onmouseup)
- [onpaste](input._internal_.HTMLImageElement.md#onpaste)
- [onpause](input._internal_.HTMLImageElement.md#onpause)
- [onplay](input._internal_.HTMLImageElement.md#onplay)
- [onplaying](input._internal_.HTMLImageElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLImageElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLImageElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLImageElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLImageElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLImageElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLImageElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLImageElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLImageElement.md#onpointerup)
- [onprogress](input._internal_.HTMLImageElement.md#onprogress)
- [onratechange](input._internal_.HTMLImageElement.md#onratechange)
- [onreset](input._internal_.HTMLImageElement.md#onreset)
- [onresize](input._internal_.HTMLImageElement.md#onresize)
- [onscroll](input._internal_.HTMLImageElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLImageElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLImageElement.md#onseeked)
- [onseeking](input._internal_.HTMLImageElement.md#onseeking)
- [onselect](input._internal_.HTMLImageElement.md#onselect)
- [onselectionchange](input._internal_.HTMLImageElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLImageElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLImageElement.md#onslotchange)
- [onstalled](input._internal_.HTMLImageElement.md#onstalled)
- [onsubmit](input._internal_.HTMLImageElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLImageElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLImageElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLImageElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLImageElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLImageElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLImageElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLImageElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLImageElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLImageElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLImageElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLImageElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLImageElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLImageElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLImageElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLImageElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLImageElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLImageElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLImageElement.md#onwheel)
- [outerHTML](input._internal_.HTMLImageElement.md#outerhtml)
- [outerText](input._internal_.HTMLImageElement.md#outertext)
- [ownerDocument](input._internal_.HTMLImageElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLImageElement.md#parentelement)
- [parentNode](input._internal_.HTMLImageElement.md#parentnode)
- [part](input._internal_.HTMLImageElement.md#part)
- [prefix](input._internal_.HTMLImageElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLImageElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLImageElement.md#previoussibling)
- [referrerPolicy](input._internal_.HTMLImageElement.md#referrerpolicy)
- [scrollHeight](input._internal_.HTMLImageElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLImageElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLImageElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLImageElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLImageElement.md#shadowroot)
- [sizes](input._internal_.HTMLImageElement.md#sizes)
- [slot](input._internal_.HTMLImageElement.md#slot)
- [spellcheck](input._internal_.HTMLImageElement.md#spellcheck)
- [src](input._internal_.HTMLImageElement.md#src)
- [srcset](input._internal_.HTMLImageElement.md#srcset)
- [style](input._internal_.HTMLImageElement.md#style)
- [tabIndex](input._internal_.HTMLImageElement.md#tabindex)
- [tagName](input._internal_.HTMLImageElement.md#tagname)
- [textContent](input._internal_.HTMLImageElement.md#textcontent)
- [title](input._internal_.HTMLImageElement.md#title)
- [translate](input._internal_.HTMLImageElement.md#translate)
- [useMap](input._internal_.HTMLImageElement.md#usemap)
- [vspace](input._internal_.HTMLImageElement.md#vspace)
- [width](input._internal_.HTMLImageElement.md#width)
- [x](input._internal_.HTMLImageElement.md#x)
- [y](input._internal_.HTMLImageElement.md#y)

### Methods

- [addEventListener](input._internal_.HTMLImageElement.md#addeventlistener)
- [after](input._internal_.HTMLImageElement.md#after)
- [animate](input._internal_.HTMLImageElement.md#animate)
- [append](input._internal_.HTMLImageElement.md#append)
- [appendChild](input._internal_.HTMLImageElement.md#appendchild)
- [attachInternals](input._internal_.HTMLImageElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLImageElement.md#attachshadow)
- [before](input._internal_.HTMLImageElement.md#before)
- [blur](input._internal_.HTMLImageElement.md#blur)
- [click](input._internal_.HTMLImageElement.md#click)
- [cloneNode](input._internal_.HTMLImageElement.md#clonenode)
- [closest](input._internal_.HTMLImageElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLImageElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLImageElement.md#contains)
- [decode](input._internal_.HTMLImageElement.md#decode)
- [dispatchEvent](input._internal_.HTMLImageElement.md#dispatchevent)
- [focus](input._internal_.HTMLImageElement.md#focus)
- [getAnimations](input._internal_.HTMLImageElement.md#getanimations)
- [getAttribute](input._internal_.HTMLImageElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLImageElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLImageElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLImageElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLImageElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLImageElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLImageElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLImageElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLImageElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLImageElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLImageElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLImageElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLImageElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLImageElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLImageElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLImageElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLImageElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLImageElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLImageElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLImageElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLImageElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLImageElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLImageElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLImageElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLImageElement.md#lookupprefix)
- [matches](input._internal_.HTMLImageElement.md#matches)
- [normalize](input._internal_.HTMLImageElement.md#normalize)
- [prepend](input._internal_.HTMLImageElement.md#prepend)
- [querySelector](input._internal_.HTMLImageElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLImageElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLImageElement.md#releasepointercapture)
- [remove](input._internal_.HTMLImageElement.md#remove)
- [removeAttribute](input._internal_.HTMLImageElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLImageElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLImageElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLImageElement.md#removechild)
- [removeEventListener](input._internal_.HTMLImageElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLImageElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLImageElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLImageElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLImageElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLImageElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLImageElement.md#scroll)
- [scrollBy](input._internal_.HTMLImageElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLImageElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLImageElement.md#scrollto)
- [setAttribute](input._internal_.HTMLImageElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLImageElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLImageElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLImageElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLImageElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLImageElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLImageElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLImageElement`](../modules/input._internal_.md#htmlimageelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
