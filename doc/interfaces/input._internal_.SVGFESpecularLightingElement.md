[Droom Google Location Plugin - v1.0.16](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGFESpecularLightingElement

# Interface: SVGFESpecularLightingElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGFESpecularLightingElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGFESpecularLightingElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGFESpecularLightingElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGFESpecularLightingElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGFESpecularLightingElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGFESpecularLightingElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGFESpecularLightingElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGFESpecularLightingElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGFESpecularLightingElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGFESpecularLightingElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGFESpecularLightingElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGFESpecularLightingElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGFESpecularLightingElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGFESpecularLightingElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGFESpecularLightingElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGFESpecularLightingElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGFESpecularLightingElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGFESpecularLightingElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGFESpecularLightingElement.md#text_node)
- [ariaAtomic](input._internal_.SVGFESpecularLightingElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGFESpecularLightingElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGFESpecularLightingElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGFESpecularLightingElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGFESpecularLightingElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGFESpecularLightingElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGFESpecularLightingElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGFESpecularLightingElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGFESpecularLightingElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGFESpecularLightingElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGFESpecularLightingElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGFESpecularLightingElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGFESpecularLightingElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGFESpecularLightingElement.md#arialabel)
- [ariaLevel](input._internal_.SVGFESpecularLightingElement.md#arialevel)
- [ariaLive](input._internal_.SVGFESpecularLightingElement.md#arialive)
- [ariaModal](input._internal_.SVGFESpecularLightingElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGFESpecularLightingElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGFESpecularLightingElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGFESpecularLightingElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGFESpecularLightingElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGFESpecularLightingElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGFESpecularLightingElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGFESpecularLightingElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGFESpecularLightingElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGFESpecularLightingElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGFESpecularLightingElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGFESpecularLightingElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGFESpecularLightingElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGFESpecularLightingElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGFESpecularLightingElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGFESpecularLightingElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGFESpecularLightingElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGFESpecularLightingElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGFESpecularLightingElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGFESpecularLightingElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGFESpecularLightingElement.md#assignedslot)
- [attributes](input._internal_.SVGFESpecularLightingElement.md#attributes)
- [autofocus](input._internal_.SVGFESpecularLightingElement.md#autofocus)
- [baseURI](input._internal_.SVGFESpecularLightingElement.md#baseuri)
- [childElementCount](input._internal_.SVGFESpecularLightingElement.md#childelementcount)
- [childNodes](input._internal_.SVGFESpecularLightingElement.md#childnodes)
- [children](input._internal_.SVGFESpecularLightingElement.md#children)
- [classList](input._internal_.SVGFESpecularLightingElement.md#classlist)
- [className](input._internal_.SVGFESpecularLightingElement.md#classname)
- [clientHeight](input._internal_.SVGFESpecularLightingElement.md#clientheight)
- [clientLeft](input._internal_.SVGFESpecularLightingElement.md#clientleft)
- [clientTop](input._internal_.SVGFESpecularLightingElement.md#clienttop)
- [clientWidth](input._internal_.SVGFESpecularLightingElement.md#clientwidth)
- [dataset](input._internal_.SVGFESpecularLightingElement.md#dataset)
- [firstChild](input._internal_.SVGFESpecularLightingElement.md#firstchild)
- [firstElementChild](input._internal_.SVGFESpecularLightingElement.md#firstelementchild)
- [height](input._internal_.SVGFESpecularLightingElement.md#height)
- [id](input._internal_.SVGFESpecularLightingElement.md#id)
- [in1](input._internal_.SVGFESpecularLightingElement.md#in1)
- [innerHTML](input._internal_.SVGFESpecularLightingElement.md#innerhtml)
- [isConnected](input._internal_.SVGFESpecularLightingElement.md#isconnected)
- [kernelUnitLengthX](input._internal_.SVGFESpecularLightingElement.md#kernelunitlengthx)
- [kernelUnitLengthY](input._internal_.SVGFESpecularLightingElement.md#kernelunitlengthy)
- [lastChild](input._internal_.SVGFESpecularLightingElement.md#lastchild)
- [lastElementChild](input._internal_.SVGFESpecularLightingElement.md#lastelementchild)
- [localName](input._internal_.SVGFESpecularLightingElement.md#localname)
- [namespaceURI](input._internal_.SVGFESpecularLightingElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGFESpecularLightingElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGFESpecularLightingElement.md#nextsibling)
- [nodeName](input._internal_.SVGFESpecularLightingElement.md#nodename)
- [nodeType](input._internal_.SVGFESpecularLightingElement.md#nodetype)
- [nodeValue](input._internal_.SVGFESpecularLightingElement.md#nodevalue)
- [nonce](input._internal_.SVGFESpecularLightingElement.md#nonce)
- [onabort](input._internal_.SVGFESpecularLightingElement.md#onabort)
- [onanimationcancel](input._internal_.SVGFESpecularLightingElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGFESpecularLightingElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGFESpecularLightingElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGFESpecularLightingElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGFESpecularLightingElement.md#onauxclick)
- [onblur](input._internal_.SVGFESpecularLightingElement.md#onblur)
- [oncanplay](input._internal_.SVGFESpecularLightingElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGFESpecularLightingElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGFESpecularLightingElement.md#onchange)
- [onclick](input._internal_.SVGFESpecularLightingElement.md#onclick)
- [onclose](input._internal_.SVGFESpecularLightingElement.md#onclose)
- [oncontextmenu](input._internal_.SVGFESpecularLightingElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGFESpecularLightingElement.md#oncopy)
- [oncuechange](input._internal_.SVGFESpecularLightingElement.md#oncuechange)
- [oncut](input._internal_.SVGFESpecularLightingElement.md#oncut)
- [ondblclick](input._internal_.SVGFESpecularLightingElement.md#ondblclick)
- [ondrag](input._internal_.SVGFESpecularLightingElement.md#ondrag)
- [ondragend](input._internal_.SVGFESpecularLightingElement.md#ondragend)
- [ondragenter](input._internal_.SVGFESpecularLightingElement.md#ondragenter)
- [ondragleave](input._internal_.SVGFESpecularLightingElement.md#ondragleave)
- [ondragover](input._internal_.SVGFESpecularLightingElement.md#ondragover)
- [ondragstart](input._internal_.SVGFESpecularLightingElement.md#ondragstart)
- [ondrop](input._internal_.SVGFESpecularLightingElement.md#ondrop)
- [ondurationchange](input._internal_.SVGFESpecularLightingElement.md#ondurationchange)
- [onemptied](input._internal_.SVGFESpecularLightingElement.md#onemptied)
- [onended](input._internal_.SVGFESpecularLightingElement.md#onended)
- [onerror](input._internal_.SVGFESpecularLightingElement.md#onerror)
- [onfocus](input._internal_.SVGFESpecularLightingElement.md#onfocus)
- [onformdata](input._internal_.SVGFESpecularLightingElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGFESpecularLightingElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGFESpecularLightingElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGFESpecularLightingElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGFESpecularLightingElement.md#oninput)
- [oninvalid](input._internal_.SVGFESpecularLightingElement.md#oninvalid)
- [onkeydown](input._internal_.SVGFESpecularLightingElement.md#onkeydown)
- [onkeypress](input._internal_.SVGFESpecularLightingElement.md#onkeypress)
- [onkeyup](input._internal_.SVGFESpecularLightingElement.md#onkeyup)
- [onload](input._internal_.SVGFESpecularLightingElement.md#onload)
- [onloadeddata](input._internal_.SVGFESpecularLightingElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGFESpecularLightingElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGFESpecularLightingElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGFESpecularLightingElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGFESpecularLightingElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGFESpecularLightingElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGFESpecularLightingElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGFESpecularLightingElement.md#onmousemove)
- [onmouseout](input._internal_.SVGFESpecularLightingElement.md#onmouseout)
- [onmouseover](input._internal_.SVGFESpecularLightingElement.md#onmouseover)
- [onmouseup](input._internal_.SVGFESpecularLightingElement.md#onmouseup)
- [onpaste](input._internal_.SVGFESpecularLightingElement.md#onpaste)
- [onpause](input._internal_.SVGFESpecularLightingElement.md#onpause)
- [onplay](input._internal_.SVGFESpecularLightingElement.md#onplay)
- [onplaying](input._internal_.SVGFESpecularLightingElement.md#onplaying)
- [onpointercancel](input._internal_.SVGFESpecularLightingElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGFESpecularLightingElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGFESpecularLightingElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGFESpecularLightingElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGFESpecularLightingElement.md#onpointermove)
- [onpointerout](input._internal_.SVGFESpecularLightingElement.md#onpointerout)
- [onpointerover](input._internal_.SVGFESpecularLightingElement.md#onpointerover)
- [onpointerup](input._internal_.SVGFESpecularLightingElement.md#onpointerup)
- [onprogress](input._internal_.SVGFESpecularLightingElement.md#onprogress)
- [onratechange](input._internal_.SVGFESpecularLightingElement.md#onratechange)
- [onreset](input._internal_.SVGFESpecularLightingElement.md#onreset)
- [onresize](input._internal_.SVGFESpecularLightingElement.md#onresize)
- [onscroll](input._internal_.SVGFESpecularLightingElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGFESpecularLightingElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGFESpecularLightingElement.md#onseeked)
- [onseeking](input._internal_.SVGFESpecularLightingElement.md#onseeking)
- [onselect](input._internal_.SVGFESpecularLightingElement.md#onselect)
- [onselectionchange](input._internal_.SVGFESpecularLightingElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGFESpecularLightingElement.md#onselectstart)
- [onslotchange](input._internal_.SVGFESpecularLightingElement.md#onslotchange)
- [onstalled](input._internal_.SVGFESpecularLightingElement.md#onstalled)
- [onsubmit](input._internal_.SVGFESpecularLightingElement.md#onsubmit)
- [onsuspend](input._internal_.SVGFESpecularLightingElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGFESpecularLightingElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGFESpecularLightingElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGFESpecularLightingElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGFESpecularLightingElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGFESpecularLightingElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGFESpecularLightingElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGFESpecularLightingElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGFESpecularLightingElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGFESpecularLightingElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGFESpecularLightingElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGFESpecularLightingElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGFESpecularLightingElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGFESpecularLightingElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGFESpecularLightingElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGFESpecularLightingElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGFESpecularLightingElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGFESpecularLightingElement.md#onwheel)
- [outerHTML](input._internal_.SVGFESpecularLightingElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGFESpecularLightingElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGFESpecularLightingElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGFESpecularLightingElement.md#parentelement)
- [parentNode](input._internal_.SVGFESpecularLightingElement.md#parentnode)
- [part](input._internal_.SVGFESpecularLightingElement.md#part)
- [prefix](input._internal_.SVGFESpecularLightingElement.md#prefix)
- [previousElementSibling](input._internal_.SVGFESpecularLightingElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGFESpecularLightingElement.md#previoussibling)
- [result](input._internal_.SVGFESpecularLightingElement.md#result)
- [scrollHeight](input._internal_.SVGFESpecularLightingElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGFESpecularLightingElement.md#scrollleft)
- [scrollTop](input._internal_.SVGFESpecularLightingElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGFESpecularLightingElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGFESpecularLightingElement.md#shadowroot)
- [slot](input._internal_.SVGFESpecularLightingElement.md#slot)
- [specularConstant](input._internal_.SVGFESpecularLightingElement.md#specularconstant)
- [specularExponent](input._internal_.SVGFESpecularLightingElement.md#specularexponent)
- [style](input._internal_.SVGFESpecularLightingElement.md#style)
- [surfaceScale](input._internal_.SVGFESpecularLightingElement.md#surfacescale)
- [tabIndex](input._internal_.SVGFESpecularLightingElement.md#tabindex)
- [tagName](input._internal_.SVGFESpecularLightingElement.md#tagname)
- [textContent](input._internal_.SVGFESpecularLightingElement.md#textcontent)
- [viewportElement](input._internal_.SVGFESpecularLightingElement.md#viewportelement)
- [width](input._internal_.SVGFESpecularLightingElement.md#width)
- [x](input._internal_.SVGFESpecularLightingElement.md#x)
- [y](input._internal_.SVGFESpecularLightingElement.md#y)

### Methods

- [addEventListener](input._internal_.SVGFESpecularLightingElement.md#addeventlistener)
- [after](input._internal_.SVGFESpecularLightingElement.md#after)
- [animate](input._internal_.SVGFESpecularLightingElement.md#animate)
- [append](input._internal_.SVGFESpecularLightingElement.md#append)
- [appendChild](input._internal_.SVGFESpecularLightingElement.md#appendchild)
- [attachShadow](input._internal_.SVGFESpecularLightingElement.md#attachshadow)
- [before](input._internal_.SVGFESpecularLightingElement.md#before)
- [blur](input._internal_.SVGFESpecularLightingElement.md#blur)
- [cloneNode](input._internal_.SVGFESpecularLightingElement.md#clonenode)
- [closest](input._internal_.SVGFESpecularLightingElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGFESpecularLightingElement.md#comparedocumentposition)
- [contains](input._internal_.SVGFESpecularLightingElement.md#contains)
- [dispatchEvent](input._internal_.SVGFESpecularLightingElement.md#dispatchevent)
- [focus](input._internal_.SVGFESpecularLightingElement.md#focus)
- [getAnimations](input._internal_.SVGFESpecularLightingElement.md#getanimations)
- [getAttribute](input._internal_.SVGFESpecularLightingElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGFESpecularLightingElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGFESpecularLightingElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGFESpecularLightingElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGFESpecularLightingElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.SVGFESpecularLightingElement.md#getboundingclientrect)
- [getClientRects](input._internal_.SVGFESpecularLightingElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGFESpecularLightingElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGFESpecularLightingElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGFESpecularLightingElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGFESpecularLightingElement.md#getrootnode)
- [hasAttribute](input._internal_.SVGFESpecularLightingElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGFESpecularLightingElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGFESpecularLightingElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGFESpecularLightingElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGFESpecularLightingElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGFESpecularLightingElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGFESpecularLightingElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGFESpecularLightingElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGFESpecularLightingElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGFESpecularLightingElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGFESpecularLightingElement.md#isequalnode)
- [isSameNode](input._internal_.SVGFESpecularLightingElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGFESpecularLightingElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGFESpecularLightingElement.md#lookupprefix)
- [matches](input._internal_.SVGFESpecularLightingElement.md#matches)
- [normalize](input._internal_.SVGFESpecularLightingElement.md#normalize)
- [prepend](input._internal_.SVGFESpecularLightingElement.md#prepend)
- [querySelector](input._internal_.SVGFESpecularLightingElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGFESpecularLightingElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGFESpecularLightingElement.md#releasepointercapture)
- [remove](input._internal_.SVGFESpecularLightingElement.md#remove)
- [removeAttribute](input._internal_.SVGFESpecularLightingElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGFESpecularLightingElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGFESpecularLightingElement.md#removeattributenode)
- [removeChild](input._internal_.SVGFESpecularLightingElement.md#removechild)
- [removeEventListener](input._internal_.SVGFESpecularLightingElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGFESpecularLightingElement.md#replacechild)
- [replaceChildren](input._internal_.SVGFESpecularLightingElement.md#replacechildren)
- [replaceWith](input._internal_.SVGFESpecularLightingElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGFESpecularLightingElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGFESpecularLightingElement.md#requestpointerlock)
- [scroll](input._internal_.SVGFESpecularLightingElement.md#scroll)
- [scrollBy](input._internal_.SVGFESpecularLightingElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGFESpecularLightingElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGFESpecularLightingElement.md#scrollto)
- [setAttribute](input._internal_.SVGFESpecularLightingElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGFESpecularLightingElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGFESpecularLightingElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGFESpecularLightingElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGFESpecularLightingElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGFESpecularLightingElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGFESpecularLightingElement.md#webkitmatchesselector)
...
• `Readonly` **specularConstant**: [`SVGAnimatedNumber`](../modules/input._internal_.md#svganimatednumber)
...
• `Readonly` **specularExponent**: [`SVGAnimatedNumber`](../modules/input._internal_.md#svganimatednumber)
...
• `Readonly` **surfaceScale**: [`SVGAnimatedNumber`](../modules/input._internal_.md#svganimatednumber)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGFESpecularLightingElement`](../modules/input._internal_.md#svgfespecularlightingelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
