[Droom Google Location Plugin - v1.0.10](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLObjectElement

# Interface: HTMLObjectElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLObjectElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLObjectElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLObjectElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLObjectElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLObjectElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLObjectElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLObjectElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLObjectElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLObjectElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLObjectElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLObjectElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLObjectElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLObjectElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLObjectElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLObjectElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLObjectElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLObjectElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLObjectElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLObjectElement.md#text_node)
- [accessKey](input._internal_.HTMLObjectElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLObjectElement.md#accesskeylabel)
- [align](input._internal_.HTMLObjectElement.md#align)
- [archive](input._internal_.HTMLObjectElement.md#archive)
- [ariaAtomic](input._internal_.HTMLObjectElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLObjectElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLObjectElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLObjectElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLObjectElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLObjectElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLObjectElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLObjectElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLObjectElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLObjectElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLObjectElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLObjectElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLObjectElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLObjectElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLObjectElement.md#arialevel)
- [ariaLive](input._internal_.HTMLObjectElement.md#arialive)
- [ariaModal](input._internal_.HTMLObjectElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLObjectElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLObjectElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLObjectElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLObjectElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLObjectElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLObjectElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLObjectElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLObjectElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLObjectElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLObjectElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLObjectElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLObjectElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLObjectElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLObjectElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLObjectElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLObjectElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLObjectElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLObjectElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLObjectElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLObjectElement.md#assignedslot)
- [attributes](input._internal_.HTMLObjectElement.md#attributes)
- [autocapitalize](input._internal_.HTMLObjectElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLObjectElement.md#autofocus)
- [baseURI](input._internal_.HTMLObjectElement.md#baseuri)
- [border](input._internal_.HTMLObjectElement.md#border)
- [childElementCount](input._internal_.HTMLObjectElement.md#childelementcount)
- [childNodes](input._internal_.HTMLObjectElement.md#childnodes)
- [children](input._internal_.HTMLObjectElement.md#children)
- [classList](input._internal_.HTMLObjectElement.md#classlist)
- [className](input._internal_.HTMLObjectElement.md#classname)
- [clientHeight](input._internal_.HTMLObjectElement.md#clientheight)
- [clientLeft](input._internal_.HTMLObjectElement.md#clientleft)
- [clientTop](input._internal_.HTMLObjectElement.md#clienttop)
- [clientWidth](input._internal_.HTMLObjectElement.md#clientwidth)
- [code](input._internal_.HTMLObjectElement.md#code)
- [codeBase](input._internal_.HTMLObjectElement.md#codebase)
- [codeType](input._internal_.HTMLObjectElement.md#codetype)
- [contentDocument](input._internal_.HTMLObjectElement.md#contentdocument)
- [contentEditable](input._internal_.HTMLObjectElement.md#contenteditable)
- [contentWindow](input._internal_.HTMLObjectElement.md#contentwindow)
- [data](input._internal_.HTMLObjectElement.md#data)
- [dataset](input._internal_.HTMLObjectElement.md#dataset)
- [declare](input._internal_.HTMLObjectElement.md#declare)
- [dir](input._internal_.HTMLObjectElement.md#dir)
- [draggable](input._internal_.HTMLObjectElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLObjectElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLObjectElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLObjectElement.md#firstelementchild)
- [form](input._internal_.HTMLObjectElement.md#form)
- [height](input._internal_.HTMLObjectElement.md#height)
- [hidden](input._internal_.HTMLObjectElement.md#hidden)
- [hspace](input._internal_.HTMLObjectElement.md#hspace)
- [id](input._internal_.HTMLObjectElement.md#id)
- [innerHTML](input._internal_.HTMLObjectElement.md#innerhtml)
- [innerText](input._internal_.HTMLObjectElement.md#innertext)
- [inputMode](input._internal_.HTMLObjectElement.md#inputmode)
- [isConnected](input._internal_.HTMLObjectElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLObjectElement.md#iscontenteditable)
- [lang](input._internal_.HTMLObjectElement.md#lang)
- [lastChild](input._internal_.HTMLObjectElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLObjectElement.md#lastelementchild)
- [localName](input._internal_.HTMLObjectElement.md#localname)
- [name](input._internal_.HTMLObjectElement.md#name)
- [namespaceURI](input._internal_.HTMLObjectElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLObjectElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLObjectElement.md#nextsibling)
- [nodeName](input._internal_.HTMLObjectElement.md#nodename)
- [nodeType](input._internal_.HTMLObjectElement.md#nodetype)
- [nodeValue](input._internal_.HTMLObjectElement.md#nodevalue)
- [nonce](input._internal_.HTMLObjectElement.md#nonce)
- [offsetHeight](input._internal_.HTMLObjectElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLObjectElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLObjectElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLObjectElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLObjectElement.md#offsetwidth)
- [onabort](input._internal_.HTMLObjectElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLObjectElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLObjectElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLObjectElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLObjectElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLObjectElement.md#onauxclick)
- [onblur](input._internal_.HTMLObjectElement.md#onblur)
- [oncanplay](input._internal_.HTMLObjectElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLObjectElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLObjectElement.md#onchange)
- [onclick](input._internal_.HTMLObjectElement.md#onclick)
- [onclose](input._internal_.HTMLObjectElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLObjectElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLObjectElement.md#oncopy)
- [oncuechange](input._internal_.HTMLObjectElement.md#oncuechange)
- [oncut](input._internal_.HTMLObjectElement.md#oncut)
- [ondblclick](input._internal_.HTMLObjectElement.md#ondblclick)
- [ondrag](input._internal_.HTMLObjectElement.md#ondrag)
- [ondragend](input._internal_.HTMLObjectElement.md#ondragend)
- [ondragenter](input._internal_.HTMLObjectElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLObjectElement.md#ondragleave)
- [ondragover](input._internal_.HTMLObjectElement.md#ondragover)
- [ondragstart](input._internal_.HTMLObjectElement.md#ondragstart)
- [ondrop](input._internal_.HTMLObjectElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLObjectElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLObjectElement.md#onemptied)
- [onended](input._internal_.HTMLObjectElement.md#onended)
- [onerror](input._internal_.HTMLObjectElement.md#onerror)
- [onfocus](input._internal_.HTMLObjectElement.md#onfocus)
- [onformdata](input._internal_.HTMLObjectElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLObjectElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLObjectElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLObjectElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLObjectElement.md#oninput)
- [oninvalid](input._internal_.HTMLObjectElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLObjectElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLObjectElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLObjectElement.md#onkeyup)
- [onload](input._internal_.HTMLObjectElement.md#onload)
- [onloadeddata](input._internal_.HTMLObjectElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLObjectElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLObjectElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLObjectElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLObjectElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLObjectElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLObjectElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLObjectElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLObjectElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLObjectElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLObjectElement.md#onmouseup)
- [onpaste](input._internal_.HTMLObjectElement.md#onpaste)
- [onpause](input._internal_.HTMLObjectElement.md#onpause)
- [onplay](input._internal_.HTMLObjectElement.md#onplay)
- [onplaying](input._internal_.HTMLObjectElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLObjectElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLObjectElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLObjectElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLObjectElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLObjectElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLObjectElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLObjectElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLObjectElement.md#onpointerup)
- [onprogress](input._internal_.HTMLObjectElement.md#onprogress)
- [onratechange](input._internal_.HTMLObjectElement.md#onratechange)
- [onreset](input._internal_.HTMLObjectElement.md#onreset)
- [onresize](input._internal_.HTMLObjectElement.md#onresize)
- [onscroll](input._internal_.HTMLObjectElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLObjectElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLObjectElement.md#onseeked)
- [onseeking](input._internal_.HTMLObjectElement.md#onseeking)
- [onselect](input._internal_.HTMLObjectElement.md#onselect)
- [onselectionchange](input._internal_.HTMLObjectElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLObjectElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLObjectElement.md#onslotchange)
- [onstalled](input._internal_.HTMLObjectElement.md#onstalled)
- [onsubmit](input._internal_.HTMLObjectElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLObjectElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLObjectElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLObjectElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLObjectElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLObjectElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLObjectElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLObjectElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLObjectElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLObjectElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLObjectElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLObjectElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLObjectElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLObjectElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLObjectElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLObjectElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLObjectElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLObjectElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLObjectElement.md#onwheel)
- [outerHTML](input._internal_.HTMLObjectElement.md#outerhtml)
- [outerText](input._internal_.HTMLObjectElement.md#outertext)
- [ownerDocument](input._internal_.HTMLObjectElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLObjectElement.md#parentelement)
- [parentNode](input._internal_.HTMLObjectElement.md#parentnode)
- [part](input._internal_.HTMLObjectElement.md#part)
- [prefix](input._internal_.HTMLObjectElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLObjectElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLObjectElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLObjectElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLObjectElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLObjectElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLObjectElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLObjectElement.md#shadowroot)
- [slot](input._internal_.HTMLObjectElement.md#slot)
- [spellcheck](input._internal_.HTMLObjectElement.md#spellcheck)
- [standby](input._internal_.HTMLObjectElement.md#standby)
- [style](input._internal_.HTMLObjectElement.md#style)
- [tabIndex](input._internal_.HTMLObjectElement.md#tabindex)
- [tagName](input._internal_.HTMLObjectElement.md#tagname)
- [textContent](input._internal_.HTMLObjectElement.md#textcontent)
- [title](input._internal_.HTMLObjectElement.md#title)
- [translate](input._internal_.HTMLObjectElement.md#translate)
- [type](input._internal_.HTMLObjectElement.md#type)
- [useMap](input._internal_.HTMLObjectElement.md#usemap)
- [validationMessage](input._internal_.HTMLObjectElement.md#validationmessage)
- [validity](input._internal_.HTMLObjectElement.md#validity)
- [vspace](input._internal_.HTMLObjectElement.md#vspace)
- [width](input._internal_.HTMLObjectElement.md#width)
- [willValidate](input._internal_.HTMLObjectElement.md#willvalidate)

### Methods

- [addEventListener](input._internal_.HTMLObjectElement.md#addeventlistener)
- [after](input._internal_.HTMLObjectElement.md#after)
- [animate](input._internal_.HTMLObjectElement.md#animate)
- [append](input._internal_.HTMLObjectElement.md#append)
- [appendChild](input._internal_.HTMLObjectElement.md#appendchild)
- [attachInternals](input._internal_.HTMLObjectElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLObjectElement.md#attachshadow)
- [before](input._internal_.HTMLObjectElement.md#before)
- [blur](input._internal_.HTMLObjectElement.md#blur)
- [checkValidity](input._internal_.HTMLObjectElement.md#checkvalidity)
- [click](input._internal_.HTMLObjectElement.md#click)
- [cloneNode](input._internal_.HTMLObjectElement.md#clonenode)
- [closest](input._internal_.HTMLObjectElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLObjectElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLObjectElement.md#contains)
- [dispatchEvent](input._internal_.HTMLObjectElement.md#dispatchevent)
- [focus](input._internal_.HTMLObjectElement.md#focus)
- [getAnimations](input._internal_.HTMLObjectElement.md#getanimations)
- [getAttribute](input._internal_.HTMLObjectElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLObjectElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLObjectElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLObjectElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLObjectElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLObjectElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLObjectElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLObjectElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLObjectElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLObjectElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLObjectElement.md#getrootnode)
- [getSVGDocument](input._internal_.HTMLObjectElement.md#getsvgdocument)
- [hasAttribute](input._internal_.HTMLObjectElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLObjectElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLObjectElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLObjectElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLObjectElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLObjectElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLObjectElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLObjectElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLObjectElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLObjectElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLObjectElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLObjectElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLObjectElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLObjectElement.md#lookupprefix)
- [matches](input._internal_.HTMLObjectElement.md#matches)
- [normalize](input._internal_.HTMLObjectElement.md#normalize)
- [prepend](input._internal_.HTMLObjectElement.md#prepend)
- [querySelector](input._internal_.HTMLObjectElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLObjectElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLObjectElement.md#releasepointercapture)
- [remove](input._internal_.HTMLObjectElement.md#remove)
- [removeAttribute](input._internal_.HTMLObjectElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLObjectElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLObjectElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLObjectElement.md#removechild)
- [removeEventListener](input._internal_.HTMLObjectElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLObjectElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLObjectElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLObjectElement.md#replacewith)
- [reportValidity](input._internal_.HTMLObjectElement.md#reportvalidity)
- [requestFullscreen](input._internal_.HTMLObjectElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLObjectElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLObjectElement.md#scroll)
- [scrollBy](input._internal_.HTMLObjectElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLObjectElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLObjectElement.md#scrollto)
- [setAttribute](input._internal_.HTMLObjectElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLObjectElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLObjectElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLObjectElement.md#setattributenodens)
- [setCustomValidity](input._internal_.HTMLObjectElement.md#setcustomvalidity)
- [setPointerCapture](input._internal_.HTMLObjectElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLObjectElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLObjectElement.md#webkitmatchesselector)
...
• `Readonly` **contentDocument**: ``null`` \| [`Document`](../modules/input._internal_.md#document)
...
• `Readonly` **contentWindow**: ``null`` \| [`Window`](../modules/input._internal_.md#window)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLObjectElement`](../modules/input._internal_.md#htmlobjectelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
...
▸ **getSVGDocument**(): ``null`` \| [`Document`](../modules/input._internal_.md#document)

#### Returns

``null`` \| [`Document`](../modules/input._internal_.md#document)
