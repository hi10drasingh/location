[Droom Google Location Plugin - v1.0.15](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGGElement

# Interface: SVGGElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGGElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGGElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGGElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGGElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGGElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGGElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGGElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGGElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGGElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGGElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGGElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGGElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGGElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGGElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGGElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGGElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGGElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGGElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGGElement.md#text_node)
- [ariaAtomic](input._internal_.SVGGElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGGElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGGElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGGElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGGElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGGElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGGElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGGElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGGElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGGElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGGElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGGElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGGElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGGElement.md#arialabel)
- [ariaLevel](input._internal_.SVGGElement.md#arialevel)
- [ariaLive](input._internal_.SVGGElement.md#arialive)
- [ariaModal](input._internal_.SVGGElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGGElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGGElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGGElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGGElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGGElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGGElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGGElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGGElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGGElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGGElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGGElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGGElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGGElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGGElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGGElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGGElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGGElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGGElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGGElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGGElement.md#assignedslot)
- [attributes](input._internal_.SVGGElement.md#attributes)
- [autofocus](input._internal_.SVGGElement.md#autofocus)
- [baseURI](input._internal_.SVGGElement.md#baseuri)
- [childElementCount](input._internal_.SVGGElement.md#childelementcount)
- [childNodes](input._internal_.SVGGElement.md#childnodes)
- [children](input._internal_.SVGGElement.md#children)
- [classList](input._internal_.SVGGElement.md#classlist)
- [className](input._internal_.SVGGElement.md#classname)
- [clientHeight](input._internal_.SVGGElement.md#clientheight)
- [clientLeft](input._internal_.SVGGElement.md#clientleft)
- [clientTop](input._internal_.SVGGElement.md#clienttop)
- [clientWidth](input._internal_.SVGGElement.md#clientwidth)
- [dataset](input._internal_.SVGGElement.md#dataset)
- [firstChild](input._internal_.SVGGElement.md#firstchild)
- [firstElementChild](input._internal_.SVGGElement.md#firstelementchild)
- [id](input._internal_.SVGGElement.md#id)
- [innerHTML](input._internal_.SVGGElement.md#innerhtml)
- [isConnected](input._internal_.SVGGElement.md#isconnected)
- [lastChild](input._internal_.SVGGElement.md#lastchild)
- [lastElementChild](input._internal_.SVGGElement.md#lastelementchild)
- [localName](input._internal_.SVGGElement.md#localname)
- [namespaceURI](input._internal_.SVGGElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGGElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGGElement.md#nextsibling)
- [nodeName](input._internal_.SVGGElement.md#nodename)
- [nodeType](input._internal_.SVGGElement.md#nodetype)
- [nodeValue](input._internal_.SVGGElement.md#nodevalue)
- [nonce](input._internal_.SVGGElement.md#nonce)
- [onabort](input._internal_.SVGGElement.md#onabort)
- [onanimationcancel](input._internal_.SVGGElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGGElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGGElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGGElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGGElement.md#onauxclick)
- [onblur](input._internal_.SVGGElement.md#onblur)
- [oncanplay](input._internal_.SVGGElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGGElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGGElement.md#onchange)
- [onclick](input._internal_.SVGGElement.md#onclick)
- [onclose](input._internal_.SVGGElement.md#onclose)
- [oncontextmenu](input._internal_.SVGGElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGGElement.md#oncopy)
- [oncuechange](input._internal_.SVGGElement.md#oncuechange)
- [oncut](input._internal_.SVGGElement.md#oncut)
- [ondblclick](input._internal_.SVGGElement.md#ondblclick)
- [ondrag](input._internal_.SVGGElement.md#ondrag)
- [ondragend](input._internal_.SVGGElement.md#ondragend)
- [ondragenter](input._internal_.SVGGElement.md#ondragenter)
- [ondragleave](input._internal_.SVGGElement.md#ondragleave)
- [ondragover](input._internal_.SVGGElement.md#ondragover)
- [ondragstart](input._internal_.SVGGElement.md#ondragstart)
- [ondrop](input._internal_.SVGGElement.md#ondrop)
- [ondurationchange](input._internal_.SVGGElement.md#ondurationchange)
- [onemptied](input._internal_.SVGGElement.md#onemptied)
- [onended](input._internal_.SVGGElement.md#onended)
- [onerror](input._internal_.SVGGElement.md#onerror)
- [onfocus](input._internal_.SVGGElement.md#onfocus)
- [onformdata](input._internal_.SVGGElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGGElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGGElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGGElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGGElement.md#oninput)
- [oninvalid](input._internal_.SVGGElement.md#oninvalid)
- [onkeydown](input._internal_.SVGGElement.md#onkeydown)
- [onkeypress](input._internal_.SVGGElement.md#onkeypress)
- [onkeyup](input._internal_.SVGGElement.md#onkeyup)
- [onload](input._internal_.SVGGElement.md#onload)
- [onloadeddata](input._internal_.SVGGElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGGElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGGElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGGElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGGElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGGElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGGElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGGElement.md#onmousemove)
- [onmouseout](input._internal_.SVGGElement.md#onmouseout)
- [onmouseover](input._internal_.SVGGElement.md#onmouseover)
- [onmouseup](input._internal_.SVGGElement.md#onmouseup)
- [onpaste](input._internal_.SVGGElement.md#onpaste)
- [onpause](input._internal_.SVGGElement.md#onpause)
- [onplay](input._internal_.SVGGElement.md#onplay)
- [onplaying](input._internal_.SVGGElement.md#onplaying)
- [onpointercancel](input._internal_.SVGGElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGGElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGGElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGGElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGGElement.md#onpointermove)
- [onpointerout](input._internal_.SVGGElement.md#onpointerout)
- [onpointerover](input._internal_.SVGGElement.md#onpointerover)
- [onpointerup](input._internal_.SVGGElement.md#onpointerup)
- [onprogress](input._internal_.SVGGElement.md#onprogress)
- [onratechange](input._internal_.SVGGElement.md#onratechange)
- [onreset](input._internal_.SVGGElement.md#onreset)
- [onresize](input._internal_.SVGGElement.md#onresize)
- [onscroll](input._internal_.SVGGElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGGElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGGElement.md#onseeked)
- [onseeking](input._internal_.SVGGElement.md#onseeking)
- [onselect](input._internal_.SVGGElement.md#onselect)
- [onselectionchange](input._internal_.SVGGElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGGElement.md#onselectstart)
- [onslotchange](input._internal_.SVGGElement.md#onslotchange)
- [onstalled](input._internal_.SVGGElement.md#onstalled)
- [onsubmit](input._internal_.SVGGElement.md#onsubmit)
- [onsuspend](input._internal_.SVGGElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGGElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGGElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGGElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGGElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGGElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGGElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGGElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGGElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGGElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGGElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGGElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGGElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGGElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGGElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGGElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGGElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGGElement.md#onwheel)
- [outerHTML](input._internal_.SVGGElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGGElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGGElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGGElement.md#parentelement)
- [parentNode](input._internal_.SVGGElement.md#parentnode)
- [part](input._internal_.SVGGElement.md#part)
- [prefix](input._internal_.SVGGElement.md#prefix)
- [previousElementSibling](input._internal_.SVGGElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGGElement.md#previoussibling)
- [requiredExtensions](input._internal_.SVGGElement.md#requiredextensions)
- [scrollHeight](input._internal_.SVGGElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGGElement.md#scrollleft)
- [scrollTop](input._internal_.SVGGElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGGElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGGElement.md#shadowroot)
- [slot](input._internal_.SVGGElement.md#slot)
- [style](input._internal_.SVGGElement.md#style)
- [systemLanguage](input._internal_.SVGGElement.md#systemlanguage)
- [tabIndex](input._internal_.SVGGElement.md#tabindex)
- [tagName](input._internal_.SVGGElement.md#tagname)
- [textContent](input._internal_.SVGGElement.md#textcontent)
- [transform](input._internal_.SVGGElement.md#transform)
- [viewportElement](input._internal_.SVGGElement.md#viewportelement)

### Methods

- [addEventListener](input._internal_.SVGGElement.md#addeventlistener)
- [after](input._internal_.SVGGElement.md#after)
- [animate](input._internal_.SVGGElement.md#animate)
- [append](input._internal_.SVGGElement.md#append)
- [appendChild](input._internal_.SVGGElement.md#appendchild)
- [attachShadow](input._internal_.SVGGElement.md#attachshadow)
- [before](input._internal_.SVGGElement.md#before)
- [blur](input._internal_.SVGGElement.md#blur)
- [cloneNode](input._internal_.SVGGElement.md#clonenode)
- [closest](input._internal_.SVGGElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGGElement.md#comparedocumentposition)
- [contains](input._internal_.SVGGElement.md#contains)
- [dispatchEvent](input._internal_.SVGGElement.md#dispatchevent)
- [focus](input._internal_.SVGGElement.md#focus)
- [getAnimations](input._internal_.SVGGElement.md#getanimations)
- [getAttribute](input._internal_.SVGGElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGGElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGGElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGGElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGGElement.md#getattributenodens)
- [getBBox](input._internal_.SVGGElement.md#getbbox)
- [getBoundingClientRect](input._internal_.SVGGElement.md#getboundingclientrect)
- [getCTM](input._internal_.SVGGElement.md#getctm)
- [getClientRects](input._internal_.SVGGElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGGElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGGElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGGElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGGElement.md#getrootnode)
- [getScreenCTM](input._internal_.SVGGElement.md#getscreenctm)
- [hasAttribute](input._internal_.SVGGElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGGElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGGElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGGElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGGElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGGElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGGElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGGElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGGElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGGElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGGElement.md#isequalnode)
- [isSameNode](input._internal_.SVGGElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGGElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGGElement.md#lookupprefix)
- [matches](input._internal_.SVGGElement.md#matches)
- [normalize](input._internal_.SVGGElement.md#normalize)
- [prepend](input._internal_.SVGGElement.md#prepend)
- [querySelector](input._internal_.SVGGElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGGElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGGElement.md#releasepointercapture)
- [remove](input._internal_.SVGGElement.md#remove)
- [removeAttribute](input._internal_.SVGGElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGGElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGGElement.md#removeattributenode)
- [removeChild](input._internal_.SVGGElement.md#removechild)
- [removeEventListener](input._internal_.SVGGElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGGElement.md#replacechild)
- [replaceChildren](input._internal_.SVGGElement.md#replacechildren)
- [replaceWith](input._internal_.SVGGElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGGElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGGElement.md#requestpointerlock)
- [scroll](input._internal_.SVGGElement.md#scroll)
- [scrollBy](input._internal_.SVGGElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGGElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGGElement.md#scrollto)
- [setAttribute](input._internal_.SVGGElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGGElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGGElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGGElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGGElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGGElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGGElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGGElement`](../modules/input._internal_.md#svggelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
