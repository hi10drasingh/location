[Droom Google Location Plugin - v1.0.16](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGFEDistantLightElement

# Interface: SVGFEDistantLightElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGFEDistantLightElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGFEDistantLightElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGFEDistantLightElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGFEDistantLightElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGFEDistantLightElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGFEDistantLightElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGFEDistantLightElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGFEDistantLightElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGFEDistantLightElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGFEDistantLightElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGFEDistantLightElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGFEDistantLightElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGFEDistantLightElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGFEDistantLightElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGFEDistantLightElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGFEDistantLightElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGFEDistantLightElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGFEDistantLightElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGFEDistantLightElement.md#text_node)
- [ariaAtomic](input._internal_.SVGFEDistantLightElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGFEDistantLightElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGFEDistantLightElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGFEDistantLightElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGFEDistantLightElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGFEDistantLightElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGFEDistantLightElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGFEDistantLightElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGFEDistantLightElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGFEDistantLightElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGFEDistantLightElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGFEDistantLightElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGFEDistantLightElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGFEDistantLightElement.md#arialabel)
- [ariaLevel](input._internal_.SVGFEDistantLightElement.md#arialevel)
- [ariaLive](input._internal_.SVGFEDistantLightElement.md#arialive)
- [ariaModal](input._internal_.SVGFEDistantLightElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGFEDistantLightElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGFEDistantLightElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGFEDistantLightElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGFEDistantLightElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGFEDistantLightElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGFEDistantLightElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGFEDistantLightElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGFEDistantLightElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGFEDistantLightElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGFEDistantLightElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGFEDistantLightElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGFEDistantLightElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGFEDistantLightElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGFEDistantLightElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGFEDistantLightElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGFEDistantLightElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGFEDistantLightElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGFEDistantLightElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGFEDistantLightElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGFEDistantLightElement.md#assignedslot)
- [attributes](input._internal_.SVGFEDistantLightElement.md#attributes)
- [autofocus](input._internal_.SVGFEDistantLightElement.md#autofocus)
- [azimuth](input._internal_.SVGFEDistantLightElement.md#azimuth)
- [baseURI](input._internal_.SVGFEDistantLightElement.md#baseuri)
- [childElementCount](input._internal_.SVGFEDistantLightElement.md#childelementcount)
- [childNodes](input._internal_.SVGFEDistantLightElement.md#childnodes)
- [children](input._internal_.SVGFEDistantLightElement.md#children)
- [classList](input._internal_.SVGFEDistantLightElement.md#classlist)
- [className](input._internal_.SVGFEDistantLightElement.md#classname)
- [clientHeight](input._internal_.SVGFEDistantLightElement.md#clientheight)
- [clientLeft](input._internal_.SVGFEDistantLightElement.md#clientleft)
- [clientTop](input._internal_.SVGFEDistantLightElement.md#clienttop)
- [clientWidth](input._internal_.SVGFEDistantLightElement.md#clientwidth)
- [dataset](input._internal_.SVGFEDistantLightElement.md#dataset)
- [elevation](input._internal_.SVGFEDistantLightElement.md#elevation)
- [firstChild](input._internal_.SVGFEDistantLightElement.md#firstchild)
- [firstElementChild](input._internal_.SVGFEDistantLightElement.md#firstelementchild)
- [id](input._internal_.SVGFEDistantLightElement.md#id)
- [innerHTML](input._internal_.SVGFEDistantLightElement.md#innerhtml)
- [isConnected](input._internal_.SVGFEDistantLightElement.md#isconnected)
- [lastChild](input._internal_.SVGFEDistantLightElement.md#lastchild)
- [lastElementChild](input._internal_.SVGFEDistantLightElement.md#lastelementchild)
- [localName](input._internal_.SVGFEDistantLightElement.md#localname)
- [namespaceURI](input._internal_.SVGFEDistantLightElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGFEDistantLightElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGFEDistantLightElement.md#nextsibling)
- [nodeName](input._internal_.SVGFEDistantLightElement.md#nodename)
- [nodeType](input._internal_.SVGFEDistantLightElement.md#nodetype)
- [nodeValue](input._internal_.SVGFEDistantLightElement.md#nodevalue)
- [nonce](input._internal_.SVGFEDistantLightElement.md#nonce)
- [onabort](input._internal_.SVGFEDistantLightElement.md#onabort)
- [onanimationcancel](input._internal_.SVGFEDistantLightElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGFEDistantLightElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGFEDistantLightElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGFEDistantLightElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGFEDistantLightElement.md#onauxclick)
- [onblur](input._internal_.SVGFEDistantLightElement.md#onblur)
- [oncanplay](input._internal_.SVGFEDistantLightElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGFEDistantLightElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGFEDistantLightElement.md#onchange)
- [onclick](input._internal_.SVGFEDistantLightElement.md#onclick)
- [onclose](input._internal_.SVGFEDistantLightElement.md#onclose)
- [oncontextmenu](input._internal_.SVGFEDistantLightElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGFEDistantLightElement.md#oncopy)
- [oncuechange](input._internal_.SVGFEDistantLightElement.md#oncuechange)
- [oncut](input._internal_.SVGFEDistantLightElement.md#oncut)
- [ondblclick](input._internal_.SVGFEDistantLightElement.md#ondblclick)
- [ondrag](input._internal_.SVGFEDistantLightElement.md#ondrag)
- [ondragend](input._internal_.SVGFEDistantLightElement.md#ondragend)
- [ondragenter](input._internal_.SVGFEDistantLightElement.md#ondragenter)
- [ondragleave](input._internal_.SVGFEDistantLightElement.md#ondragleave)
- [ondragover](input._internal_.SVGFEDistantLightElement.md#ondragover)
- [ondragstart](input._internal_.SVGFEDistantLightElement.md#ondragstart)
- [ondrop](input._internal_.SVGFEDistantLightElement.md#ondrop)
- [ondurationchange](input._internal_.SVGFEDistantLightElement.md#ondurationchange)
- [onemptied](input._internal_.SVGFEDistantLightElement.md#onemptied)
- [onended](input._internal_.SVGFEDistantLightElement.md#onended)
- [onerror](input._internal_.SVGFEDistantLightElement.md#onerror)
- [onfocus](input._internal_.SVGFEDistantLightElement.md#onfocus)
- [onformdata](input._internal_.SVGFEDistantLightElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGFEDistantLightElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGFEDistantLightElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGFEDistantLightElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGFEDistantLightElement.md#oninput)
- [oninvalid](input._internal_.SVGFEDistantLightElement.md#oninvalid)
- [onkeydown](input._internal_.SVGFEDistantLightElement.md#onkeydown)
- [onkeypress](input._internal_.SVGFEDistantLightElement.md#onkeypress)
- [onkeyup](input._internal_.SVGFEDistantLightElement.md#onkeyup)
- [onload](input._internal_.SVGFEDistantLightElement.md#onload)
- [onloadeddata](input._internal_.SVGFEDistantLightElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGFEDistantLightElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGFEDistantLightElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGFEDistantLightElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGFEDistantLightElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGFEDistantLightElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGFEDistantLightElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGFEDistantLightElement.md#onmousemove)
- [onmouseout](input._internal_.SVGFEDistantLightElement.md#onmouseout)
- [onmouseover](input._internal_.SVGFEDistantLightElement.md#onmouseover)
- [onmouseup](input._internal_.SVGFEDistantLightElement.md#onmouseup)
- [onpaste](input._internal_.SVGFEDistantLightElement.md#onpaste)
- [onpause](input._internal_.SVGFEDistantLightElement.md#onpause)
- [onplay](input._internal_.SVGFEDistantLightElement.md#onplay)
- [onplaying](input._internal_.SVGFEDistantLightElement.md#onplaying)
- [onpointercancel](input._internal_.SVGFEDistantLightElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGFEDistantLightElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGFEDistantLightElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGFEDistantLightElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGFEDistantLightElement.md#onpointermove)
- [onpointerout](input._internal_.SVGFEDistantLightElement.md#onpointerout)
- [onpointerover](input._internal_.SVGFEDistantLightElement.md#onpointerover)
- [onpointerup](input._internal_.SVGFEDistantLightElement.md#onpointerup)
- [onprogress](input._internal_.SVGFEDistantLightElement.md#onprogress)
- [onratechange](input._internal_.SVGFEDistantLightElement.md#onratechange)
- [onreset](input._internal_.SVGFEDistantLightElement.md#onreset)
- [onresize](input._internal_.SVGFEDistantLightElement.md#onresize)
- [onscroll](input._internal_.SVGFEDistantLightElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGFEDistantLightElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGFEDistantLightElement.md#onseeked)
- [onseeking](input._internal_.SVGFEDistantLightElement.md#onseeking)
- [onselect](input._internal_.SVGFEDistantLightElement.md#onselect)
- [onselectionchange](input._internal_.SVGFEDistantLightElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGFEDistantLightElement.md#onselectstart)
- [onslotchange](input._internal_.SVGFEDistantLightElement.md#onslotchange)
- [onstalled](input._internal_.SVGFEDistantLightElement.md#onstalled)
- [onsubmit](input._internal_.SVGFEDistantLightElement.md#onsubmit)
- [onsuspend](input._internal_.SVGFEDistantLightElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGFEDistantLightElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGFEDistantLightElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGFEDistantLightElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGFEDistantLightElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGFEDistantLightElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGFEDistantLightElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGFEDistantLightElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGFEDistantLightElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGFEDistantLightElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGFEDistantLightElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGFEDistantLightElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGFEDistantLightElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGFEDistantLightElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGFEDistantLightElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGFEDistantLightElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGFEDistantLightElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGFEDistantLightElement.md#onwheel)
- [outerHTML](input._internal_.SVGFEDistantLightElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGFEDistantLightElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGFEDistantLightElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGFEDistantLightElement.md#parentelement)
- [parentNode](input._internal_.SVGFEDistantLightElement.md#parentnode)
- [part](input._internal_.SVGFEDistantLightElement.md#part)
- [prefix](input._internal_.SVGFEDistantLightElement.md#prefix)
- [previousElementSibling](input._internal_.SVGFEDistantLightElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGFEDistantLightElement.md#previoussibling)
- [scrollHeight](input._internal_.SVGFEDistantLightElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGFEDistantLightElement.md#scrollleft)
- [scrollTop](input._internal_.SVGFEDistantLightElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGFEDistantLightElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGFEDistantLightElement.md#shadowroot)
- [slot](input._internal_.SVGFEDistantLightElement.md#slot)
- [style](input._internal_.SVGFEDistantLightElement.md#style)
- [tabIndex](input._internal_.SVGFEDistantLightElement.md#tabindex)
- [tagName](input._internal_.SVGFEDistantLightElement.md#tagname)
- [textContent](input._internal_.SVGFEDistantLightElement.md#textcontent)
- [viewportElement](input._internal_.SVGFEDistantLightElement.md#viewportelement)

### Methods

- [addEventListener](input._internal_.SVGFEDistantLightElement.md#addeventlistener)
- [after](input._internal_.SVGFEDistantLightElement.md#after)
- [animate](input._internal_.SVGFEDistantLightElement.md#animate)
- [append](input._internal_.SVGFEDistantLightElement.md#append)
- [appendChild](input._internal_.SVGFEDistantLightElement.md#appendchild)
- [attachShadow](input._internal_.SVGFEDistantLightElement.md#attachshadow)
- [before](input._internal_.SVGFEDistantLightElement.md#before)
- [blur](input._internal_.SVGFEDistantLightElement.md#blur)
- [cloneNode](input._internal_.SVGFEDistantLightElement.md#clonenode)
- [closest](input._internal_.SVGFEDistantLightElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGFEDistantLightElement.md#comparedocumentposition)
- [contains](input._internal_.SVGFEDistantLightElement.md#contains)
- [dispatchEvent](input._internal_.SVGFEDistantLightElement.md#dispatchevent)
- [focus](input._internal_.SVGFEDistantLightElement.md#focus)
- [getAnimations](input._internal_.SVGFEDistantLightElement.md#getanimations)
- [getAttribute](input._internal_.SVGFEDistantLightElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGFEDistantLightElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGFEDistantLightElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGFEDistantLightElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGFEDistantLightElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.SVGFEDistantLightElement.md#getboundingclientrect)
- [getClientRects](input._internal_.SVGFEDistantLightElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGFEDistantLightElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGFEDistantLightElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGFEDistantLightElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGFEDistantLightElement.md#getrootnode)
- [hasAttribute](input._internal_.SVGFEDistantLightElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGFEDistantLightElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGFEDistantLightElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGFEDistantLightElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGFEDistantLightElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGFEDistantLightElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGFEDistantLightElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGFEDistantLightElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGFEDistantLightElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGFEDistantLightElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGFEDistantLightElement.md#isequalnode)
- [isSameNode](input._internal_.SVGFEDistantLightElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGFEDistantLightElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGFEDistantLightElement.md#lookupprefix)
- [matches](input._internal_.SVGFEDistantLightElement.md#matches)
- [normalize](input._internal_.SVGFEDistantLightElement.md#normalize)
- [prepend](input._internal_.SVGFEDistantLightElement.md#prepend)
- [querySelector](input._internal_.SVGFEDistantLightElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGFEDistantLightElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGFEDistantLightElement.md#releasepointercapture)
- [remove](input._internal_.SVGFEDistantLightElement.md#remove)
- [removeAttribute](input._internal_.SVGFEDistantLightElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGFEDistantLightElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGFEDistantLightElement.md#removeattributenode)
- [removeChild](input._internal_.SVGFEDistantLightElement.md#removechild)
- [removeEventListener](input._internal_.SVGFEDistantLightElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGFEDistantLightElement.md#replacechild)
- [replaceChildren](input._internal_.SVGFEDistantLightElement.md#replacechildren)
- [replaceWith](input._internal_.SVGFEDistantLightElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGFEDistantLightElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGFEDistantLightElement.md#requestpointerlock)
- [scroll](input._internal_.SVGFEDistantLightElement.md#scroll)
- [scrollBy](input._internal_.SVGFEDistantLightElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGFEDistantLightElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGFEDistantLightElement.md#scrollto)
- [setAttribute](input._internal_.SVGFEDistantLightElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGFEDistantLightElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGFEDistantLightElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGFEDistantLightElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGFEDistantLightElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGFEDistantLightElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGFEDistantLightElement.md#webkitmatchesselector)
...
• `Readonly` **azimuth**: [`SVGAnimatedNumber`](../modules/input._internal_.md#svganimatednumber)
...
• `Readonly` **elevation**: [`SVGAnimatedNumber`](../modules/input._internal_.md#svganimatednumber)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGFEDistantLightElement`](../modules/input._internal_.md#svgfedistantlightelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
