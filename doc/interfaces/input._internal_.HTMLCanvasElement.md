[Droom Google Location Plugin - v1.0.11](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLCanvasElement

# Interface: HTMLCanvasElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLCanvasElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLCanvasElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLCanvasElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLCanvasElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLCanvasElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLCanvasElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLCanvasElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLCanvasElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLCanvasElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLCanvasElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLCanvasElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLCanvasElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLCanvasElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLCanvasElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLCanvasElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLCanvasElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLCanvasElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLCanvasElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLCanvasElement.md#text_node)
- [accessKey](input._internal_.HTMLCanvasElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLCanvasElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLCanvasElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLCanvasElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLCanvasElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLCanvasElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLCanvasElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLCanvasElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLCanvasElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLCanvasElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLCanvasElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLCanvasElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLCanvasElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLCanvasElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLCanvasElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLCanvasElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLCanvasElement.md#arialevel)
- [ariaLive](input._internal_.HTMLCanvasElement.md#arialive)
- [ariaModal](input._internal_.HTMLCanvasElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLCanvasElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLCanvasElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLCanvasElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLCanvasElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLCanvasElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLCanvasElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLCanvasElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLCanvasElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLCanvasElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLCanvasElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLCanvasElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLCanvasElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLCanvasElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLCanvasElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLCanvasElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLCanvasElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLCanvasElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLCanvasElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLCanvasElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLCanvasElement.md#assignedslot)
- [attributes](input._internal_.HTMLCanvasElement.md#attributes)
- [autocapitalize](input._internal_.HTMLCanvasElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLCanvasElement.md#autofocus)
- [baseURI](input._internal_.HTMLCanvasElement.md#baseuri)
- [childElementCount](input._internal_.HTMLCanvasElement.md#childelementcount)
- [childNodes](input._internal_.HTMLCanvasElement.md#childnodes)
- [children](input._internal_.HTMLCanvasElement.md#children)
- [classList](input._internal_.HTMLCanvasElement.md#classlist)
- [className](input._internal_.HTMLCanvasElement.md#classname)
- [clientHeight](input._internal_.HTMLCanvasElement.md#clientheight)
- [clientLeft](input._internal_.HTMLCanvasElement.md#clientleft)
- [clientTop](input._internal_.HTMLCanvasElement.md#clienttop)
- [clientWidth](input._internal_.HTMLCanvasElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLCanvasElement.md#contenteditable)
- [dataset](input._internal_.HTMLCanvasElement.md#dataset)
- [dir](input._internal_.HTMLCanvasElement.md#dir)
- [draggable](input._internal_.HTMLCanvasElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLCanvasElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLCanvasElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLCanvasElement.md#firstelementchild)
- [height](input._internal_.HTMLCanvasElement.md#height)
- [hidden](input._internal_.HTMLCanvasElement.md#hidden)
- [id](input._internal_.HTMLCanvasElement.md#id)
- [innerHTML](input._internal_.HTMLCanvasElement.md#innerhtml)
- [innerText](input._internal_.HTMLCanvasElement.md#innertext)
- [inputMode](input._internal_.HTMLCanvasElement.md#inputmode)
- [isConnected](input._internal_.HTMLCanvasElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLCanvasElement.md#iscontenteditable)
- [lang](input._internal_.HTMLCanvasElement.md#lang)
- [lastChild](input._internal_.HTMLCanvasElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLCanvasElement.md#lastelementchild)
- [localName](input._internal_.HTMLCanvasElement.md#localname)
- [namespaceURI](input._internal_.HTMLCanvasElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLCanvasElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLCanvasElement.md#nextsibling)
- [nodeName](input._internal_.HTMLCanvasElement.md#nodename)
- [nodeType](input._internal_.HTMLCanvasElement.md#nodetype)
- [nodeValue](input._internal_.HTMLCanvasElement.md#nodevalue)
- [nonce](input._internal_.HTMLCanvasElement.md#nonce)
- [offsetHeight](input._internal_.HTMLCanvasElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLCanvasElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLCanvasElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLCanvasElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLCanvasElement.md#offsetwidth)
- [onabort](input._internal_.HTMLCanvasElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLCanvasElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLCanvasElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLCanvasElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLCanvasElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLCanvasElement.md#onauxclick)
- [onblur](input._internal_.HTMLCanvasElement.md#onblur)
- [oncanplay](input._internal_.HTMLCanvasElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLCanvasElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLCanvasElement.md#onchange)
- [onclick](input._internal_.HTMLCanvasElement.md#onclick)
- [onclose](input._internal_.HTMLCanvasElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLCanvasElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLCanvasElement.md#oncopy)
- [oncuechange](input._internal_.HTMLCanvasElement.md#oncuechange)
- [oncut](input._internal_.HTMLCanvasElement.md#oncut)
- [ondblclick](input._internal_.HTMLCanvasElement.md#ondblclick)
- [ondrag](input._internal_.HTMLCanvasElement.md#ondrag)
- [ondragend](input._internal_.HTMLCanvasElement.md#ondragend)
- [ondragenter](input._internal_.HTMLCanvasElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLCanvasElement.md#ondragleave)
- [ondragover](input._internal_.HTMLCanvasElement.md#ondragover)
- [ondragstart](input._internal_.HTMLCanvasElement.md#ondragstart)
- [ondrop](input._internal_.HTMLCanvasElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLCanvasElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLCanvasElement.md#onemptied)
- [onended](input._internal_.HTMLCanvasElement.md#onended)
- [onerror](input._internal_.HTMLCanvasElement.md#onerror)
- [onfocus](input._internal_.HTMLCanvasElement.md#onfocus)
- [onformdata](input._internal_.HTMLCanvasElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLCanvasElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLCanvasElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLCanvasElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLCanvasElement.md#oninput)
- [oninvalid](input._internal_.HTMLCanvasElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLCanvasElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLCanvasElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLCanvasElement.md#onkeyup)
- [onload](input._internal_.HTMLCanvasElement.md#onload)
- [onloadeddata](input._internal_.HTMLCanvasElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLCanvasElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLCanvasElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLCanvasElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLCanvasElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLCanvasElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLCanvasElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLCanvasElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLCanvasElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLCanvasElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLCanvasElement.md#onmouseup)
- [onpaste](input._internal_.HTMLCanvasElement.md#onpaste)
- [onpause](input._internal_.HTMLCanvasElement.md#onpause)
- [onplay](input._internal_.HTMLCanvasElement.md#onplay)
- [onplaying](input._internal_.HTMLCanvasElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLCanvasElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLCanvasElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLCanvasElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLCanvasElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLCanvasElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLCanvasElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLCanvasElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLCanvasElement.md#onpointerup)
- [onprogress](input._internal_.HTMLCanvasElement.md#onprogress)
- [onratechange](input._internal_.HTMLCanvasElement.md#onratechange)
- [onreset](input._internal_.HTMLCanvasElement.md#onreset)
- [onresize](input._internal_.HTMLCanvasElement.md#onresize)
- [onscroll](input._internal_.HTMLCanvasElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLCanvasElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLCanvasElement.md#onseeked)
- [onseeking](input._internal_.HTMLCanvasElement.md#onseeking)
- [onselect](input._internal_.HTMLCanvasElement.md#onselect)
- [onselectionchange](input._internal_.HTMLCanvasElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLCanvasElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLCanvasElement.md#onslotchange)
- [onstalled](input._internal_.HTMLCanvasElement.md#onstalled)
- [onsubmit](input._internal_.HTMLCanvasElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLCanvasElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLCanvasElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLCanvasElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLCanvasElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLCanvasElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLCanvasElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLCanvasElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLCanvasElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLCanvasElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLCanvasElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLCanvasElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLCanvasElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLCanvasElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLCanvasElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLCanvasElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLCanvasElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLCanvasElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLCanvasElement.md#onwheel)
- [outerHTML](input._internal_.HTMLCanvasElement.md#outerhtml)
- [outerText](input._internal_.HTMLCanvasElement.md#outertext)
- [ownerDocument](input._internal_.HTMLCanvasElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLCanvasElement.md#parentelement)
- [parentNode](input._internal_.HTMLCanvasElement.md#parentnode)
- [part](input._internal_.HTMLCanvasElement.md#part)
- [prefix](input._internal_.HTMLCanvasElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLCanvasElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLCanvasElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLCanvasElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLCanvasElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLCanvasElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLCanvasElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLCanvasElement.md#shadowroot)
- [slot](input._internal_.HTMLCanvasElement.md#slot)
- [spellcheck](input._internal_.HTMLCanvasElement.md#spellcheck)
- [style](input._internal_.HTMLCanvasElement.md#style)
- [tabIndex](input._internal_.HTMLCanvasElement.md#tabindex)
- [tagName](input._internal_.HTMLCanvasElement.md#tagname)
- [textContent](input._internal_.HTMLCanvasElement.md#textcontent)
- [title](input._internal_.HTMLCanvasElement.md#title)
- [translate](input._internal_.HTMLCanvasElement.md#translate)
- [width](input._internal_.HTMLCanvasElement.md#width)

### Methods

- [addEventListener](input._internal_.HTMLCanvasElement.md#addeventlistener)
- [after](input._internal_.HTMLCanvasElement.md#after)
- [animate](input._internal_.HTMLCanvasElement.md#animate)
- [append](input._internal_.HTMLCanvasElement.md#append)
- [appendChild](input._internal_.HTMLCanvasElement.md#appendchild)
- [attachInternals](input._internal_.HTMLCanvasElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLCanvasElement.md#attachshadow)
- [before](input._internal_.HTMLCanvasElement.md#before)
- [blur](input._internal_.HTMLCanvasElement.md#blur)
- [captureStream](input._internal_.HTMLCanvasElement.md#capturestream)
- [click](input._internal_.HTMLCanvasElement.md#click)
- [cloneNode](input._internal_.HTMLCanvasElement.md#clonenode)
- [closest](input._internal_.HTMLCanvasElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLCanvasElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLCanvasElement.md#contains)
- [dispatchEvent](input._internal_.HTMLCanvasElement.md#dispatchevent)
- [focus](input._internal_.HTMLCanvasElement.md#focus)
- [getAnimations](input._internal_.HTMLCanvasElement.md#getanimations)
- [getAttribute](input._internal_.HTMLCanvasElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLCanvasElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLCanvasElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLCanvasElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLCanvasElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLCanvasElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLCanvasElement.md#getclientrects)
- [getContext](input._internal_.HTMLCanvasElement.md#getcontext)
- [getElementsByClassName](input._internal_.HTMLCanvasElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLCanvasElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLCanvasElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLCanvasElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLCanvasElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLCanvasElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLCanvasElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLCanvasElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLCanvasElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLCanvasElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLCanvasElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLCanvasElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLCanvasElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLCanvasElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLCanvasElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLCanvasElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLCanvasElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLCanvasElement.md#lookupprefix)
- [matches](input._internal_.HTMLCanvasElement.md#matches)
- [normalize](input._internal_.HTMLCanvasElement.md#normalize)
- [prepend](input._internal_.HTMLCanvasElement.md#prepend)
- [querySelector](input._internal_.HTMLCanvasElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLCanvasElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLCanvasElement.md#releasepointercapture)
- [remove](input._internal_.HTMLCanvasElement.md#remove)
- [removeAttribute](input._internal_.HTMLCanvasElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLCanvasElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLCanvasElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLCanvasElement.md#removechild)
- [removeEventListener](input._internal_.HTMLCanvasElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLCanvasElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLCanvasElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLCanvasElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLCanvasElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLCanvasElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLCanvasElement.md#scroll)
- [scrollBy](input._internal_.HTMLCanvasElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLCanvasElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLCanvasElement.md#scrollto)
- [setAttribute](input._internal_.HTMLCanvasElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLCanvasElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLCanvasElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLCanvasElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLCanvasElement.md#setpointercapture)
- [toBlob](input._internal_.HTMLCanvasElement.md#toblob)
- [toDataURL](input._internal_.HTMLCanvasElement.md#todataurl)
- [toggleAttribute](input._internal_.HTMLCanvasElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLCanvasElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLCanvasElement`](../modules/input._internal_.md#htmlcanvaselement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
...
▸ **captureStream**(`frameRequestRate?`): [`MediaStream`](../modules/input._internal_.md#mediastream)
...
▸ **getContext**(`contextId`, `options?`): ``null`` \| [`CanvasRenderingContext2D`](../modules/input._internal_.md#canvasrenderingcontext2d)
...
| `options?` | [`CanvasRenderingContext2DSettings`](input._internal_.CanvasRenderingContext2DSettings.md) | - |

#### Returns

``null`` \| [`CanvasRenderingContext2D`](../modules/input._internal_.md#canvasrenderingcontext2d)

#### Defined in

node_modules/typescript/lib/lib.dom.d.ts:6163

▸ **getContext**(`contextId`, `options?`): ``null`` \| [`ImageBitmapRenderingContext`](../modules/input._internal_.md#imagebitmaprenderingcontext)
...
| `options?` | [`ImageBitmapRenderingContextSettings`](input._internal_.ImageBitmapRenderingContextSettings.md) |

#### Returns

``null`` \| [`ImageBitmapRenderingContext`](../modules/input._internal_.md#imagebitmaprenderingcontext)

#### Defined in

node_modules/typescript/lib/lib.dom.d.ts:6164

▸ **getContext**(`contextId`, `options?`): ``null`` \| [`WebGLRenderingContext`](../modules/input._internal_.md#webglrenderingcontext)
...
| :------ | :------ |
| `contextId` | ``"webgl"`` |
| `options?` | [`WebGLContextAttributes`](input._internal_.WebGLContextAttributes.md) |

#### Returns

``null`` \| [`WebGLRenderingContext`](../modules/input._internal_.md#webglrenderingcontext)

#### Defined in

node_modules/typescript/lib/lib.dom.d.ts:6165

▸ **getContext**(`contextId`, `options?`): ``null`` \| [`WebGL2RenderingContext`](../modules/input._internal_.md#webgl2renderingcontext)
...
``null`` \| [`WebGL2RenderingContext`](../modules/input._internal_.md#webgl2renderingcontext)

#### Defined in

node_modules/typescript/lib/lib.dom.d.ts:6166

▸ **getContext**(`contextId`, `options?`): ``null`` \| [`RenderingContext`](../modules/input._internal_.md#renderingcontext)
...
``null`` \| [`RenderingContext`](../modules/input._internal_.md#renderingcontext)
...
| Name | Type |
| :------ | :------ |
| `callback` | [`BlobCallback`](input._internal_.BlobCallback.md) |
| `type?` | `string` |
| `quality?` | `any` |
