[Droom Google Location Plugin - v1.0.10](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLOptGroupElement

# Interface: HTMLOptGroupElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLOptGroupElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLOptGroupElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLOptGroupElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLOptGroupElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLOptGroupElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLOptGroupElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLOptGroupElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLOptGroupElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLOptGroupElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLOptGroupElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLOptGroupElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLOptGroupElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLOptGroupElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLOptGroupElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLOptGroupElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLOptGroupElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLOptGroupElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLOptGroupElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLOptGroupElement.md#text_node)
- [accessKey](input._internal_.HTMLOptGroupElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLOptGroupElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLOptGroupElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLOptGroupElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLOptGroupElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLOptGroupElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLOptGroupElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLOptGroupElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLOptGroupElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLOptGroupElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLOptGroupElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLOptGroupElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLOptGroupElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLOptGroupElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLOptGroupElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLOptGroupElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLOptGroupElement.md#arialevel)
- [ariaLive](input._internal_.HTMLOptGroupElement.md#arialive)
- [ariaModal](input._internal_.HTMLOptGroupElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLOptGroupElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLOptGroupElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLOptGroupElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLOptGroupElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLOptGroupElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLOptGroupElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLOptGroupElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLOptGroupElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLOptGroupElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLOptGroupElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLOptGroupElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLOptGroupElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLOptGroupElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLOptGroupElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLOptGroupElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLOptGroupElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLOptGroupElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLOptGroupElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLOptGroupElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLOptGroupElement.md#assignedslot)
- [attributes](input._internal_.HTMLOptGroupElement.md#attributes)
- [autocapitalize](input._internal_.HTMLOptGroupElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLOptGroupElement.md#autofocus)
- [baseURI](input._internal_.HTMLOptGroupElement.md#baseuri)
- [childElementCount](input._internal_.HTMLOptGroupElement.md#childelementcount)
- [childNodes](input._internal_.HTMLOptGroupElement.md#childnodes)
- [children](input._internal_.HTMLOptGroupElement.md#children)
- [classList](input._internal_.HTMLOptGroupElement.md#classlist)
- [className](input._internal_.HTMLOptGroupElement.md#classname)
- [clientHeight](input._internal_.HTMLOptGroupElement.md#clientheight)
- [clientLeft](input._internal_.HTMLOptGroupElement.md#clientleft)
- [clientTop](input._internal_.HTMLOptGroupElement.md#clienttop)
- [clientWidth](input._internal_.HTMLOptGroupElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLOptGroupElement.md#contenteditable)
- [dataset](input._internal_.HTMLOptGroupElement.md#dataset)
- [dir](input._internal_.HTMLOptGroupElement.md#dir)
- [disabled](input._internal_.HTMLOptGroupElement.md#disabled)
- [draggable](input._internal_.HTMLOptGroupElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLOptGroupElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLOptGroupElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLOptGroupElement.md#firstelementchild)
- [hidden](input._internal_.HTMLOptGroupElement.md#hidden)
- [id](input._internal_.HTMLOptGroupElement.md#id)
- [innerHTML](input._internal_.HTMLOptGroupElement.md#innerhtml)
- [innerText](input._internal_.HTMLOptGroupElement.md#innertext)
- [inputMode](input._internal_.HTMLOptGroupElement.md#inputmode)
- [isConnected](input._internal_.HTMLOptGroupElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLOptGroupElement.md#iscontenteditable)
- [label](input._internal_.HTMLOptGroupElement.md#label)
- [lang](input._internal_.HTMLOptGroupElement.md#lang)
- [lastChild](input._internal_.HTMLOptGroupElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLOptGroupElement.md#lastelementchild)
- [localName](input._internal_.HTMLOptGroupElement.md#localname)
- [namespaceURI](input._internal_.HTMLOptGroupElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLOptGroupElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLOptGroupElement.md#nextsibling)
- [nodeName](input._internal_.HTMLOptGroupElement.md#nodename)
- [nodeType](input._internal_.HTMLOptGroupElement.md#nodetype)
- [nodeValue](input._internal_.HTMLOptGroupElement.md#nodevalue)
- [nonce](input._internal_.HTMLOptGroupElement.md#nonce)
- [offsetHeight](input._internal_.HTMLOptGroupElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLOptGroupElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLOptGroupElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLOptGroupElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLOptGroupElement.md#offsetwidth)
- [onabort](input._internal_.HTMLOptGroupElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLOptGroupElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLOptGroupElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLOptGroupElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLOptGroupElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLOptGroupElement.md#onauxclick)
- [onblur](input._internal_.HTMLOptGroupElement.md#onblur)
- [oncanplay](input._internal_.HTMLOptGroupElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLOptGroupElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLOptGroupElement.md#onchange)
- [onclick](input._internal_.HTMLOptGroupElement.md#onclick)
- [onclose](input._internal_.HTMLOptGroupElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLOptGroupElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLOptGroupElement.md#oncopy)
- [oncuechange](input._internal_.HTMLOptGroupElement.md#oncuechange)
- [oncut](input._internal_.HTMLOptGroupElement.md#oncut)
- [ondblclick](input._internal_.HTMLOptGroupElement.md#ondblclick)
- [ondrag](input._internal_.HTMLOptGroupElement.md#ondrag)
- [ondragend](input._internal_.HTMLOptGroupElement.md#ondragend)
- [ondragenter](input._internal_.HTMLOptGroupElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLOptGroupElement.md#ondragleave)
- [ondragover](input._internal_.HTMLOptGroupElement.md#ondragover)
- [ondragstart](input._internal_.HTMLOptGroupElement.md#ondragstart)
- [ondrop](input._internal_.HTMLOptGroupElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLOptGroupElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLOptGroupElement.md#onemptied)
- [onended](input._internal_.HTMLOptGroupElement.md#onended)
- [onerror](input._internal_.HTMLOptGroupElement.md#onerror)
- [onfocus](input._internal_.HTMLOptGroupElement.md#onfocus)
- [onformdata](input._internal_.HTMLOptGroupElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLOptGroupElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLOptGroupElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLOptGroupElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLOptGroupElement.md#oninput)
- [oninvalid](input._internal_.HTMLOptGroupElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLOptGroupElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLOptGroupElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLOptGroupElement.md#onkeyup)
- [onload](input._internal_.HTMLOptGroupElement.md#onload)
- [onloadeddata](input._internal_.HTMLOptGroupElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLOptGroupElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLOptGroupElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLOptGroupElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLOptGroupElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLOptGroupElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLOptGroupElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLOptGroupElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLOptGroupElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLOptGroupElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLOptGroupElement.md#onmouseup)
- [onpaste](input._internal_.HTMLOptGroupElement.md#onpaste)
- [onpause](input._internal_.HTMLOptGroupElement.md#onpause)
- [onplay](input._internal_.HTMLOptGroupElement.md#onplay)
- [onplaying](input._internal_.HTMLOptGroupElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLOptGroupElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLOptGroupElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLOptGroupElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLOptGroupElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLOptGroupElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLOptGroupElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLOptGroupElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLOptGroupElement.md#onpointerup)
- [onprogress](input._internal_.HTMLOptGroupElement.md#onprogress)
- [onratechange](input._internal_.HTMLOptGroupElement.md#onratechange)
- [onreset](input._internal_.HTMLOptGroupElement.md#onreset)
- [onresize](input._internal_.HTMLOptGroupElement.md#onresize)
- [onscroll](input._internal_.HTMLOptGroupElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLOptGroupElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLOptGroupElement.md#onseeked)
- [onseeking](input._internal_.HTMLOptGroupElement.md#onseeking)
- [onselect](input._internal_.HTMLOptGroupElement.md#onselect)
- [onselectionchange](input._internal_.HTMLOptGroupElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLOptGroupElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLOptGroupElement.md#onslotchange)
- [onstalled](input._internal_.HTMLOptGroupElement.md#onstalled)
- [onsubmit](input._internal_.HTMLOptGroupElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLOptGroupElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLOptGroupElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLOptGroupElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLOptGroupElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLOptGroupElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLOptGroupElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLOptGroupElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLOptGroupElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLOptGroupElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLOptGroupElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLOptGroupElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLOptGroupElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLOptGroupElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLOptGroupElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLOptGroupElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLOptGroupElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLOptGroupElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLOptGroupElement.md#onwheel)
- [outerHTML](input._internal_.HTMLOptGroupElement.md#outerhtml)
- [outerText](input._internal_.HTMLOptGroupElement.md#outertext)
- [ownerDocument](input._internal_.HTMLOptGroupElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLOptGroupElement.md#parentelement)
- [parentNode](input._internal_.HTMLOptGroupElement.md#parentnode)
- [part](input._internal_.HTMLOptGroupElement.md#part)
- [prefix](input._internal_.HTMLOptGroupElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLOptGroupElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLOptGroupElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLOptGroupElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLOptGroupElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLOptGroupElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLOptGroupElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLOptGroupElement.md#shadowroot)
- [slot](input._internal_.HTMLOptGroupElement.md#slot)
- [spellcheck](input._internal_.HTMLOptGroupElement.md#spellcheck)
- [style](input._internal_.HTMLOptGroupElement.md#style)
- [tabIndex](input._internal_.HTMLOptGroupElement.md#tabindex)
- [tagName](input._internal_.HTMLOptGroupElement.md#tagname)
- [textContent](input._internal_.HTMLOptGroupElement.md#textcontent)
- [title](input._internal_.HTMLOptGroupElement.md#title)
- [translate](input._internal_.HTMLOptGroupElement.md#translate)

### Methods

- [addEventListener](input._internal_.HTMLOptGroupElement.md#addeventlistener)
- [after](input._internal_.HTMLOptGroupElement.md#after)
- [animate](input._internal_.HTMLOptGroupElement.md#animate)
- [append](input._internal_.HTMLOptGroupElement.md#append)
- [appendChild](input._internal_.HTMLOptGroupElement.md#appendchild)
- [attachInternals](input._internal_.HTMLOptGroupElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLOptGroupElement.md#attachshadow)
- [before](input._internal_.HTMLOptGroupElement.md#before)
- [blur](input._internal_.HTMLOptGroupElement.md#blur)
- [click](input._internal_.HTMLOptGroupElement.md#click)
- [cloneNode](input._internal_.HTMLOptGroupElement.md#clonenode)
- [closest](input._internal_.HTMLOptGroupElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLOptGroupElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLOptGroupElement.md#contains)
- [dispatchEvent](input._internal_.HTMLOptGroupElement.md#dispatchevent)
- [focus](input._internal_.HTMLOptGroupElement.md#focus)
- [getAnimations](input._internal_.HTMLOptGroupElement.md#getanimations)
- [getAttribute](input._internal_.HTMLOptGroupElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLOptGroupElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLOptGroupElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLOptGroupElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLOptGroupElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLOptGroupElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLOptGroupElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLOptGroupElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLOptGroupElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLOptGroupElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLOptGroupElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLOptGroupElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLOptGroupElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLOptGroupElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLOptGroupElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLOptGroupElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLOptGroupElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLOptGroupElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLOptGroupElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLOptGroupElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLOptGroupElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLOptGroupElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLOptGroupElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLOptGroupElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLOptGroupElement.md#lookupprefix)
- [matches](input._internal_.HTMLOptGroupElement.md#matches)
- [normalize](input._internal_.HTMLOptGroupElement.md#normalize)
- [prepend](input._internal_.HTMLOptGroupElement.md#prepend)
- [querySelector](input._internal_.HTMLOptGroupElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLOptGroupElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLOptGroupElement.md#releasepointercapture)
- [remove](input._internal_.HTMLOptGroupElement.md#remove)
- [removeAttribute](input._internal_.HTMLOptGroupElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLOptGroupElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLOptGroupElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLOptGroupElement.md#removechild)
- [removeEventListener](input._internal_.HTMLOptGroupElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLOptGroupElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLOptGroupElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLOptGroupElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLOptGroupElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLOptGroupElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLOptGroupElement.md#scroll)
- [scrollBy](input._internal_.HTMLOptGroupElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLOptGroupElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLOptGroupElement.md#scrollto)
- [setAttribute](input._internal_.HTMLOptGroupElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLOptGroupElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLOptGroupElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLOptGroupElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLOptGroupElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLOptGroupElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLOptGroupElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLOptGroupElement`](../modules/input._internal_.md#htmloptgroupelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
