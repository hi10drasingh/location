[Droom Google Location Plugin - v1.0.16](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGFEPointLightElement

# Interface: SVGFEPointLightElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGFEPointLightElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGFEPointLightElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGFEPointLightElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGFEPointLightElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGFEPointLightElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGFEPointLightElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGFEPointLightElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGFEPointLightElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGFEPointLightElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGFEPointLightElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGFEPointLightElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGFEPointLightElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGFEPointLightElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGFEPointLightElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGFEPointLightElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGFEPointLightElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGFEPointLightElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGFEPointLightElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGFEPointLightElement.md#text_node)
- [ariaAtomic](input._internal_.SVGFEPointLightElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGFEPointLightElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGFEPointLightElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGFEPointLightElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGFEPointLightElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGFEPointLightElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGFEPointLightElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGFEPointLightElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGFEPointLightElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGFEPointLightElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGFEPointLightElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGFEPointLightElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGFEPointLightElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGFEPointLightElement.md#arialabel)
- [ariaLevel](input._internal_.SVGFEPointLightElement.md#arialevel)
- [ariaLive](input._internal_.SVGFEPointLightElement.md#arialive)
- [ariaModal](input._internal_.SVGFEPointLightElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGFEPointLightElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGFEPointLightElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGFEPointLightElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGFEPointLightElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGFEPointLightElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGFEPointLightElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGFEPointLightElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGFEPointLightElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGFEPointLightElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGFEPointLightElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGFEPointLightElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGFEPointLightElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGFEPointLightElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGFEPointLightElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGFEPointLightElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGFEPointLightElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGFEPointLightElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGFEPointLightElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGFEPointLightElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGFEPointLightElement.md#assignedslot)
- [attributes](input._internal_.SVGFEPointLightElement.md#attributes)
- [autofocus](input._internal_.SVGFEPointLightElement.md#autofocus)
- [baseURI](input._internal_.SVGFEPointLightElement.md#baseuri)
- [childElementCount](input._internal_.SVGFEPointLightElement.md#childelementcount)
- [childNodes](input._internal_.SVGFEPointLightElement.md#childnodes)
- [children](input._internal_.SVGFEPointLightElement.md#children)
- [classList](input._internal_.SVGFEPointLightElement.md#classlist)
- [className](input._internal_.SVGFEPointLightElement.md#classname)
- [clientHeight](input._internal_.SVGFEPointLightElement.md#clientheight)
- [clientLeft](input._internal_.SVGFEPointLightElement.md#clientleft)
- [clientTop](input._internal_.SVGFEPointLightElement.md#clienttop)
- [clientWidth](input._internal_.SVGFEPointLightElement.md#clientwidth)
- [dataset](input._internal_.SVGFEPointLightElement.md#dataset)
- [firstChild](input._internal_.SVGFEPointLightElement.md#firstchild)
- [firstElementChild](input._internal_.SVGFEPointLightElement.md#firstelementchild)
- [id](input._internal_.SVGFEPointLightElement.md#id)
- [innerHTML](input._internal_.SVGFEPointLightElement.md#innerhtml)
- [isConnected](input._internal_.SVGFEPointLightElement.md#isconnected)
- [lastChild](input._internal_.SVGFEPointLightElement.md#lastchild)
- [lastElementChild](input._internal_.SVGFEPointLightElement.md#lastelementchild)
- [localName](input._internal_.SVGFEPointLightElement.md#localname)
- [namespaceURI](input._internal_.SVGFEPointLightElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGFEPointLightElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGFEPointLightElement.md#nextsibling)
- [nodeName](input._internal_.SVGFEPointLightElement.md#nodename)
- [nodeType](input._internal_.SVGFEPointLightElement.md#nodetype)
- [nodeValue](input._internal_.SVGFEPointLightElement.md#nodevalue)
- [nonce](input._internal_.SVGFEPointLightElement.md#nonce)
- [onabort](input._internal_.SVGFEPointLightElement.md#onabort)
- [onanimationcancel](input._internal_.SVGFEPointLightElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGFEPointLightElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGFEPointLightElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGFEPointLightElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGFEPointLightElement.md#onauxclick)
- [onblur](input._internal_.SVGFEPointLightElement.md#onblur)
- [oncanplay](input._internal_.SVGFEPointLightElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGFEPointLightElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGFEPointLightElement.md#onchange)
- [onclick](input._internal_.SVGFEPointLightElement.md#onclick)
- [onclose](input._internal_.SVGFEPointLightElement.md#onclose)
- [oncontextmenu](input._internal_.SVGFEPointLightElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGFEPointLightElement.md#oncopy)
- [oncuechange](input._internal_.SVGFEPointLightElement.md#oncuechange)
- [oncut](input._internal_.SVGFEPointLightElement.md#oncut)
- [ondblclick](input._internal_.SVGFEPointLightElement.md#ondblclick)
- [ondrag](input._internal_.SVGFEPointLightElement.md#ondrag)
- [ondragend](input._internal_.SVGFEPointLightElement.md#ondragend)
- [ondragenter](input._internal_.SVGFEPointLightElement.md#ondragenter)
- [ondragleave](input._internal_.SVGFEPointLightElement.md#ondragleave)
- [ondragover](input._internal_.SVGFEPointLightElement.md#ondragover)
- [ondragstart](input._internal_.SVGFEPointLightElement.md#ondragstart)
- [ondrop](input._internal_.SVGFEPointLightElement.md#ondrop)
- [ondurationchange](input._internal_.SVGFEPointLightElement.md#ondurationchange)
- [onemptied](input._internal_.SVGFEPointLightElement.md#onemptied)
- [onended](input._internal_.SVGFEPointLightElement.md#onended)
- [onerror](input._internal_.SVGFEPointLightElement.md#onerror)
- [onfocus](input._internal_.SVGFEPointLightElement.md#onfocus)
- [onformdata](input._internal_.SVGFEPointLightElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGFEPointLightElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGFEPointLightElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGFEPointLightElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGFEPointLightElement.md#oninput)
- [oninvalid](input._internal_.SVGFEPointLightElement.md#oninvalid)
- [onkeydown](input._internal_.SVGFEPointLightElement.md#onkeydown)
- [onkeypress](input._internal_.SVGFEPointLightElement.md#onkeypress)
- [onkeyup](input._internal_.SVGFEPointLightElement.md#onkeyup)
- [onload](input._internal_.SVGFEPointLightElement.md#onload)
- [onloadeddata](input._internal_.SVGFEPointLightElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGFEPointLightElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGFEPointLightElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGFEPointLightElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGFEPointLightElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGFEPointLightElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGFEPointLightElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGFEPointLightElement.md#onmousemove)
- [onmouseout](input._internal_.SVGFEPointLightElement.md#onmouseout)
- [onmouseover](input._internal_.SVGFEPointLightElement.md#onmouseover)
- [onmouseup](input._internal_.SVGFEPointLightElement.md#onmouseup)
- [onpaste](input._internal_.SVGFEPointLightElement.md#onpaste)
- [onpause](input._internal_.SVGFEPointLightElement.md#onpause)
- [onplay](input._internal_.SVGFEPointLightElement.md#onplay)
- [onplaying](input._internal_.SVGFEPointLightElement.md#onplaying)
- [onpointercancel](input._internal_.SVGFEPointLightElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGFEPointLightElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGFEPointLightElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGFEPointLightElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGFEPointLightElement.md#onpointermove)
- [onpointerout](input._internal_.SVGFEPointLightElement.md#onpointerout)
- [onpointerover](input._internal_.SVGFEPointLightElement.md#onpointerover)
- [onpointerup](input._internal_.SVGFEPointLightElement.md#onpointerup)
- [onprogress](input._internal_.SVGFEPointLightElement.md#onprogress)
- [onratechange](input._internal_.SVGFEPointLightElement.md#onratechange)
- [onreset](input._internal_.SVGFEPointLightElement.md#onreset)
- [onresize](input._internal_.SVGFEPointLightElement.md#onresize)
- [onscroll](input._internal_.SVGFEPointLightElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGFEPointLightElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGFEPointLightElement.md#onseeked)
- [onseeking](input._internal_.SVGFEPointLightElement.md#onseeking)
- [onselect](input._internal_.SVGFEPointLightElement.md#onselect)
- [onselectionchange](input._internal_.SVGFEPointLightElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGFEPointLightElement.md#onselectstart)
- [onslotchange](input._internal_.SVGFEPointLightElement.md#onslotchange)
- [onstalled](input._internal_.SVGFEPointLightElement.md#onstalled)
- [onsubmit](input._internal_.SVGFEPointLightElement.md#onsubmit)
- [onsuspend](input._internal_.SVGFEPointLightElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGFEPointLightElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGFEPointLightElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGFEPointLightElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGFEPointLightElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGFEPointLightElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGFEPointLightElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGFEPointLightElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGFEPointLightElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGFEPointLightElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGFEPointLightElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGFEPointLightElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGFEPointLightElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGFEPointLightElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGFEPointLightElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGFEPointLightElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGFEPointLightElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGFEPointLightElement.md#onwheel)
- [outerHTML](input._internal_.SVGFEPointLightElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGFEPointLightElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGFEPointLightElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGFEPointLightElement.md#parentelement)
- [parentNode](input._internal_.SVGFEPointLightElement.md#parentnode)
- [part](input._internal_.SVGFEPointLightElement.md#part)
- [prefix](input._internal_.SVGFEPointLightElement.md#prefix)
- [previousElementSibling](input._internal_.SVGFEPointLightElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGFEPointLightElement.md#previoussibling)
- [scrollHeight](input._internal_.SVGFEPointLightElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGFEPointLightElement.md#scrollleft)
- [scrollTop](input._internal_.SVGFEPointLightElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGFEPointLightElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGFEPointLightElement.md#shadowroot)
- [slot](input._internal_.SVGFEPointLightElement.md#slot)
- [style](input._internal_.SVGFEPointLightElement.md#style)
- [tabIndex](input._internal_.SVGFEPointLightElement.md#tabindex)
- [tagName](input._internal_.SVGFEPointLightElement.md#tagname)
- [textContent](input._internal_.SVGFEPointLightElement.md#textcontent)
- [viewportElement](input._internal_.SVGFEPointLightElement.md#viewportelement)
- [x](input._internal_.SVGFEPointLightElement.md#x)
- [y](input._internal_.SVGFEPointLightElement.md#y)
- [z](input._internal_.SVGFEPointLightElement.md#z)

### Methods

- [addEventListener](input._internal_.SVGFEPointLightElement.md#addeventlistener)
- [after](input._internal_.SVGFEPointLightElement.md#after)
- [animate](input._internal_.SVGFEPointLightElement.md#animate)
- [append](input._internal_.SVGFEPointLightElement.md#append)
- [appendChild](input._internal_.SVGFEPointLightElement.md#appendchild)
- [attachShadow](input._internal_.SVGFEPointLightElement.md#attachshadow)
- [before](input._internal_.SVGFEPointLightElement.md#before)
- [blur](input._internal_.SVGFEPointLightElement.md#blur)
- [cloneNode](input._internal_.SVGFEPointLightElement.md#clonenode)
- [closest](input._internal_.SVGFEPointLightElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGFEPointLightElement.md#comparedocumentposition)
- [contains](input._internal_.SVGFEPointLightElement.md#contains)
- [dispatchEvent](input._internal_.SVGFEPointLightElement.md#dispatchevent)
- [focus](input._internal_.SVGFEPointLightElement.md#focus)
- [getAnimations](input._internal_.SVGFEPointLightElement.md#getanimations)
- [getAttribute](input._internal_.SVGFEPointLightElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGFEPointLightElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGFEPointLightElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGFEPointLightElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGFEPointLightElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.SVGFEPointLightElement.md#getboundingclientrect)
- [getClientRects](input._internal_.SVGFEPointLightElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGFEPointLightElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGFEPointLightElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGFEPointLightElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGFEPointLightElement.md#getrootnode)
- [hasAttribute](input._internal_.SVGFEPointLightElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGFEPointLightElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGFEPointLightElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGFEPointLightElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGFEPointLightElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGFEPointLightElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGFEPointLightElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGFEPointLightElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGFEPointLightElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGFEPointLightElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGFEPointLightElement.md#isequalnode)
- [isSameNode](input._internal_.SVGFEPointLightElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGFEPointLightElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGFEPointLightElement.md#lookupprefix)
- [matches](input._internal_.SVGFEPointLightElement.md#matches)
- [normalize](input._internal_.SVGFEPointLightElement.md#normalize)
- [prepend](input._internal_.SVGFEPointLightElement.md#prepend)
- [querySelector](input._internal_.SVGFEPointLightElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGFEPointLightElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGFEPointLightElement.md#releasepointercapture)
- [remove](input._internal_.SVGFEPointLightElement.md#remove)
- [removeAttribute](input._internal_.SVGFEPointLightElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGFEPointLightElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGFEPointLightElement.md#removeattributenode)
- [removeChild](input._internal_.SVGFEPointLightElement.md#removechild)
- [removeEventListener](input._internal_.SVGFEPointLightElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGFEPointLightElement.md#replacechild)
- [replaceChildren](input._internal_.SVGFEPointLightElement.md#replacechildren)
- [replaceWith](input._internal_.SVGFEPointLightElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGFEPointLightElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGFEPointLightElement.md#requestpointerlock)
- [scroll](input._internal_.SVGFEPointLightElement.md#scroll)
- [scrollBy](input._internal_.SVGFEPointLightElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGFEPointLightElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGFEPointLightElement.md#scrollto)
- [setAttribute](input._internal_.SVGFEPointLightElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGFEPointLightElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGFEPointLightElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGFEPointLightElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGFEPointLightElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGFEPointLightElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGFEPointLightElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGFEPointLightElement`](../modules/input._internal_.md#svgfepointlightelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
