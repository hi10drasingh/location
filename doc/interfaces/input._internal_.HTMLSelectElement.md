[Droom Google Location Plugin - v1.0.10](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLSelectElement

# Interface: HTMLSelectElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLSelectElement
...
▪ [name: `number`]: [`HTMLOptionElement`](../modules/input._internal_.md#htmloptionelement) \| [`HTMLOptGroupElement`](../modules/input._internal_.md#htmloptgroupelement)

## Table of contents

### Properties

- [ATTRIBUTE\_NODE](input._internal_.HTMLSelectElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLSelectElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLSelectElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLSelectElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLSelectElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLSelectElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLSelectElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLSelectElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLSelectElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLSelectElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLSelectElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLSelectElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLSelectElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLSelectElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLSelectElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLSelectElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLSelectElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLSelectElement.md#text_node)
- [accessKey](input._internal_.HTMLSelectElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLSelectElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLSelectElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLSelectElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLSelectElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLSelectElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLSelectElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLSelectElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLSelectElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLSelectElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLSelectElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLSelectElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLSelectElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLSelectElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLSelectElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLSelectElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLSelectElement.md#arialevel)
- [ariaLive](input._internal_.HTMLSelectElement.md#arialive)
- [ariaModal](input._internal_.HTMLSelectElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLSelectElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLSelectElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLSelectElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLSelectElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLSelectElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLSelectElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLSelectElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLSelectElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLSelectElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLSelectElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLSelectElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLSelectElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLSelectElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLSelectElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLSelectElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLSelectElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLSelectElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLSelectElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLSelectElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLSelectElement.md#assignedslot)
- [attributes](input._internal_.HTMLSelectElement.md#attributes)
- [autocapitalize](input._internal_.HTMLSelectElement.md#autocapitalize)
- [autocomplete](input._internal_.HTMLSelectElement.md#autocomplete)
- [autofocus](input._internal_.HTMLSelectElement.md#autofocus)
- [baseURI](input._internal_.HTMLSelectElement.md#baseuri)
- [childElementCount](input._internal_.HTMLSelectElement.md#childelementcount)
- [childNodes](input._internal_.HTMLSelectElement.md#childnodes)
- [children](input._internal_.HTMLSelectElement.md#children)
- [classList](input._internal_.HTMLSelectElement.md#classlist)
- [className](input._internal_.HTMLSelectElement.md#classname)
- [clientHeight](input._internal_.HTMLSelectElement.md#clientheight)
- [clientLeft](input._internal_.HTMLSelectElement.md#clientleft)
- [clientTop](input._internal_.HTMLSelectElement.md#clienttop)
- [clientWidth](input._internal_.HTMLSelectElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLSelectElement.md#contenteditable)
- [dataset](input._internal_.HTMLSelectElement.md#dataset)
- [dir](input._internal_.HTMLSelectElement.md#dir)
- [disabled](input._internal_.HTMLSelectElement.md#disabled)
- [draggable](input._internal_.HTMLSelectElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLSelectElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLSelectElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLSelectElement.md#firstelementchild)
- [form](input._internal_.HTMLSelectElement.md#form)
- [hidden](input._internal_.HTMLSelectElement.md#hidden)
- [id](input._internal_.HTMLSelectElement.md#id)
- [innerHTML](input._internal_.HTMLSelectElement.md#innerhtml)
- [innerText](input._internal_.HTMLSelectElement.md#innertext)
- [inputMode](input._internal_.HTMLSelectElement.md#inputmode)
- [isConnected](input._internal_.HTMLSelectElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLSelectElement.md#iscontenteditable)
- [labels](input._internal_.HTMLSelectElement.md#labels)
- [lang](input._internal_.HTMLSelectElement.md#lang)
- [lastChild](input._internal_.HTMLSelectElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLSelectElement.md#lastelementchild)
- [length](input._internal_.HTMLSelectElement.md#length)
- [localName](input._internal_.HTMLSelectElement.md#localname)
- [multiple](input._internal_.HTMLSelectElement.md#multiple)
- [name](input._internal_.HTMLSelectElement.md#name)
- [namespaceURI](input._internal_.HTMLSelectElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLSelectElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLSelectElement.md#nextsibling)
- [nodeName](input._internal_.HTMLSelectElement.md#nodename)
- [nodeType](input._internal_.HTMLSelectElement.md#nodetype)
- [nodeValue](input._internal_.HTMLSelectElement.md#nodevalue)
- [nonce](input._internal_.HTMLSelectElement.md#nonce)
- [offsetHeight](input._internal_.HTMLSelectElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLSelectElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLSelectElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLSelectElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLSelectElement.md#offsetwidth)
- [onabort](input._internal_.HTMLSelectElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLSelectElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLSelectElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLSelectElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLSelectElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLSelectElement.md#onauxclick)
- [onblur](input._internal_.HTMLSelectElement.md#onblur)
- [oncanplay](input._internal_.HTMLSelectElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLSelectElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLSelectElement.md#onchange)
- [onclick](input._internal_.HTMLSelectElement.md#onclick)
- [onclose](input._internal_.HTMLSelectElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLSelectElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLSelectElement.md#oncopy)
- [oncuechange](input._internal_.HTMLSelectElement.md#oncuechange)
- [oncut](input._internal_.HTMLSelectElement.md#oncut)
- [ondblclick](input._internal_.HTMLSelectElement.md#ondblclick)
- [ondrag](input._internal_.HTMLSelectElement.md#ondrag)
- [ondragend](input._internal_.HTMLSelectElement.md#ondragend)
- [ondragenter](input._internal_.HTMLSelectElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLSelectElement.md#ondragleave)
- [ondragover](input._internal_.HTMLSelectElement.md#ondragover)
- [ondragstart](input._internal_.HTMLSelectElement.md#ondragstart)
- [ondrop](input._internal_.HTMLSelectElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLSelectElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLSelectElement.md#onemptied)
- [onended](input._internal_.HTMLSelectElement.md#onended)
- [onerror](input._internal_.HTMLSelectElement.md#onerror)
- [onfocus](input._internal_.HTMLSelectElement.md#onfocus)
- [onformdata](input._internal_.HTMLSelectElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLSelectElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLSelectElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLSelectElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLSelectElement.md#oninput)
- [oninvalid](input._internal_.HTMLSelectElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLSelectElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLSelectElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLSelectElement.md#onkeyup)
- [onload](input._internal_.HTMLSelectElement.md#onload)
- [onloadeddata](input._internal_.HTMLSelectElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLSelectElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLSelectElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLSelectElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLSelectElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLSelectElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLSelectElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLSelectElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLSelectElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLSelectElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLSelectElement.md#onmouseup)
- [onpaste](input._internal_.HTMLSelectElement.md#onpaste)
- [onpause](input._internal_.HTMLSelectElement.md#onpause)
- [onplay](input._internal_.HTMLSelectElement.md#onplay)
- [onplaying](input._internal_.HTMLSelectElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLSelectElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLSelectElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLSelectElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLSelectElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLSelectElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLSelectElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLSelectElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLSelectElement.md#onpointerup)
- [onprogress](input._internal_.HTMLSelectElement.md#onprogress)
- [onratechange](input._internal_.HTMLSelectElement.md#onratechange)
- [onreset](input._internal_.HTMLSelectElement.md#onreset)
- [onresize](input._internal_.HTMLSelectElement.md#onresize)
- [onscroll](input._internal_.HTMLSelectElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLSelectElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLSelectElement.md#onseeked)
- [onseeking](input._internal_.HTMLSelectElement.md#onseeking)
- [onselect](input._internal_.HTMLSelectElement.md#onselect)
- [onselectionchange](input._internal_.HTMLSelectElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLSelectElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLSelectElement.md#onslotchange)
- [onstalled](input._internal_.HTMLSelectElement.md#onstalled)
- [onsubmit](input._internal_.HTMLSelectElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLSelectElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLSelectElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLSelectElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLSelectElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLSelectElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLSelectElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLSelectElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLSelectElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLSelectElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLSelectElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLSelectElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLSelectElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLSelectElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLSelectElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLSelectElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLSelectElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLSelectElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLSelectElement.md#onwheel)
- [options](input._internal_.HTMLSelectElement.md#options)
- [outerHTML](input._internal_.HTMLSelectElement.md#outerhtml)
- [outerText](input._internal_.HTMLSelectElement.md#outertext)
- [ownerDocument](input._internal_.HTMLSelectElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLSelectElement.md#parentelement)
- [parentNode](input._internal_.HTMLSelectElement.md#parentnode)
- [part](input._internal_.HTMLSelectElement.md#part)
- [prefix](input._internal_.HTMLSelectElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLSelectElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLSelectElement.md#previoussibling)
- [required](input._internal_.HTMLSelectElement.md#required)
- [scrollHeight](input._internal_.HTMLSelectElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLSelectElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLSelectElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLSelectElement.md#scrollwidth)
- [selectedIndex](input._internal_.HTMLSelectElement.md#selectedindex)
- [selectedOptions](input._internal_.HTMLSelectElement.md#selectedoptions)
- [shadowRoot](input._internal_.HTMLSelectElement.md#shadowroot)
- [size](input._internal_.HTMLSelectElement.md#size)
- [slot](input._internal_.HTMLSelectElement.md#slot)
- [spellcheck](input._internal_.HTMLSelectElement.md#spellcheck)
- [style](input._internal_.HTMLSelectElement.md#style)
- [tabIndex](input._internal_.HTMLSelectElement.md#tabindex)
- [tagName](input._internal_.HTMLSelectElement.md#tagname)
- [textContent](input._internal_.HTMLSelectElement.md#textcontent)
- [title](input._internal_.HTMLSelectElement.md#title)
- [translate](input._internal_.HTMLSelectElement.md#translate)
- [type](input._internal_.HTMLSelectElement.md#type)
- [validationMessage](input._internal_.HTMLSelectElement.md#validationmessage)
- [validity](input._internal_.HTMLSelectElement.md#validity)
- [value](input._internal_.HTMLSelectElement.md#value)
- [willValidate](input._internal_.HTMLSelectElement.md#willvalidate)

### Methods

- [add](input._internal_.HTMLSelectElement.md#add)
- [addEventListener](input._internal_.HTMLSelectElement.md#addeventlistener)
- [after](input._internal_.HTMLSelectElement.md#after)
- [animate](input._internal_.HTMLSelectElement.md#animate)
- [append](input._internal_.HTMLSelectElement.md#append)
- [appendChild](input._internal_.HTMLSelectElement.md#appendchild)
- [attachInternals](input._internal_.HTMLSelectElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLSelectElement.md#attachshadow)
- [before](input._internal_.HTMLSelectElement.md#before)
- [blur](input._internal_.HTMLSelectElement.md#blur)
- [checkValidity](input._internal_.HTMLSelectElement.md#checkvalidity)
- [click](input._internal_.HTMLSelectElement.md#click)
- [cloneNode](input._internal_.HTMLSelectElement.md#clonenode)
- [closest](input._internal_.HTMLSelectElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLSelectElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLSelectElement.md#contains)
- [dispatchEvent](input._internal_.HTMLSelectElement.md#dispatchevent)
- [focus](input._internal_.HTMLSelectElement.md#focus)
- [getAnimations](input._internal_.HTMLSelectElement.md#getanimations)
- [getAttribute](input._internal_.HTMLSelectElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLSelectElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLSelectElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLSelectElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLSelectElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLSelectElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLSelectElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLSelectElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLSelectElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLSelectElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLSelectElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLSelectElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLSelectElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLSelectElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLSelectElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLSelectElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLSelectElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLSelectElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLSelectElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLSelectElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLSelectElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLSelectElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLSelectElement.md#issamenode)
- [item](input._internal_.HTMLSelectElement.md#item)
- [lookupNamespaceURI](input._internal_.HTMLSelectElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLSelectElement.md#lookupprefix)
- [matches](input._internal_.HTMLSelectElement.md#matches)
- [namedItem](input._internal_.HTMLSelectElement.md#nameditem)
- [normalize](input._internal_.HTMLSelectElement.md#normalize)
- [prepend](input._internal_.HTMLSelectElement.md#prepend)
- [querySelector](input._internal_.HTMLSelectElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLSelectElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLSelectElement.md#releasepointercapture)
- [remove](input._internal_.HTMLSelectElement.md#remove)
- [removeAttribute](input._internal_.HTMLSelectElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLSelectElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLSelectElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLSelectElement.md#removechild)
- [removeEventListener](input._internal_.HTMLSelectElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLSelectElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLSelectElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLSelectElement.md#replacewith)
- [reportValidity](input._internal_.HTMLSelectElement.md#reportvalidity)
- [requestFullscreen](input._internal_.HTMLSelectElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLSelectElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLSelectElement.md#scroll)
- [scrollBy](input._internal_.HTMLSelectElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLSelectElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLSelectElement.md#scrollto)
- [setAttribute](input._internal_.HTMLSelectElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLSelectElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLSelectElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLSelectElement.md#setattributenodens)
- [setCustomValidity](input._internal_.HTMLSelectElement.md#setcustomvalidity)
- [setPointerCapture](input._internal_.HTMLSelectElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLSelectElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLSelectElement.md#webkitmatchesselector)
...
node_modules/typescript/lib/lib.dom.d.ts:7743
...
node_modules/typescript/lib/lib.dom.d.ts:7750
...
node_modules/typescript/lib/lib.dom.d.ts:7752
...
• `Readonly` **options**: [`HTMLOptionsCollection`](../modules/input._internal_.md#htmloptionscollection)
...
• `Readonly` **selectedOptions**: [`HTMLCollectionOf`](input._internal_.HTMLCollectionOf.md)<[`HTMLOptionElement`](../modules/input._internal_.md#htmloptionelement)\>
...
| :------ | :------ | :------ |
| `element` | [`HTMLOptGroupElement`](../modules/input._internal_.md#htmloptgroupelement) \| [`HTMLOptionElement`](../modules/input._internal_.md#htmloptionelement) | Variant of type Number that specifies the index position in the collection where the element is placed. If no value is given, the method places the element at the end of the collection. |
| `before?` | ``null`` \| `number` \| [`HTMLElement`](../modules/input._internal_.md#htmlelement) | Variant of type Object that specifies an element to insert before, or null to append the object to the collection. |
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLSelectElement`](../modules/input._internal_.md#htmlselectelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
...
node_modules/typescript/lib/lib.dom.d.ts:7790
...
node_modules/typescript/lib/lib.dom.d.ts:7796
