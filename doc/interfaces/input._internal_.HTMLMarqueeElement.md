[Droom Google Location Plugin - v1.0.11](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLMarqueeElement

# Interface: HTMLMarqueeElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLMarqueeElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLMarqueeElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLMarqueeElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLMarqueeElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLMarqueeElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLMarqueeElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLMarqueeElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLMarqueeElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLMarqueeElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLMarqueeElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLMarqueeElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLMarqueeElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLMarqueeElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLMarqueeElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLMarqueeElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLMarqueeElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLMarqueeElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLMarqueeElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLMarqueeElement.md#text_node)
- [accessKey](input._internal_.HTMLMarqueeElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLMarqueeElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLMarqueeElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLMarqueeElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLMarqueeElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLMarqueeElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLMarqueeElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLMarqueeElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLMarqueeElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLMarqueeElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLMarqueeElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLMarqueeElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLMarqueeElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLMarqueeElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLMarqueeElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLMarqueeElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLMarqueeElement.md#arialevel)
- [ariaLive](input._internal_.HTMLMarqueeElement.md#arialive)
- [ariaModal](input._internal_.HTMLMarqueeElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLMarqueeElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLMarqueeElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLMarqueeElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLMarqueeElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLMarqueeElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLMarqueeElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLMarqueeElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLMarqueeElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLMarqueeElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLMarqueeElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLMarqueeElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLMarqueeElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLMarqueeElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLMarqueeElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLMarqueeElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLMarqueeElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLMarqueeElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLMarqueeElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLMarqueeElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLMarqueeElement.md#assignedslot)
- [attributes](input._internal_.HTMLMarqueeElement.md#attributes)
- [autocapitalize](input._internal_.HTMLMarqueeElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLMarqueeElement.md#autofocus)
- [baseURI](input._internal_.HTMLMarqueeElement.md#baseuri)
- [behavior](input._internal_.HTMLMarqueeElement.md#behavior)
- [bgColor](input._internal_.HTMLMarqueeElement.md#bgcolor)
- [childElementCount](input._internal_.HTMLMarqueeElement.md#childelementcount)
- [childNodes](input._internal_.HTMLMarqueeElement.md#childnodes)
- [children](input._internal_.HTMLMarqueeElement.md#children)
- [classList](input._internal_.HTMLMarqueeElement.md#classlist)
- [className](input._internal_.HTMLMarqueeElement.md#classname)
- [clientHeight](input._internal_.HTMLMarqueeElement.md#clientheight)
- [clientLeft](input._internal_.HTMLMarqueeElement.md#clientleft)
- [clientTop](input._internal_.HTMLMarqueeElement.md#clienttop)
- [clientWidth](input._internal_.HTMLMarqueeElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLMarqueeElement.md#contenteditable)
- [dataset](input._internal_.HTMLMarqueeElement.md#dataset)
- [dir](input._internal_.HTMLMarqueeElement.md#dir)
- [direction](input._internal_.HTMLMarqueeElement.md#direction)
- [draggable](input._internal_.HTMLMarqueeElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLMarqueeElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLMarqueeElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLMarqueeElement.md#firstelementchild)
- [height](input._internal_.HTMLMarqueeElement.md#height)
- [hidden](input._internal_.HTMLMarqueeElement.md#hidden)
- [hspace](input._internal_.HTMLMarqueeElement.md#hspace)
- [id](input._internal_.HTMLMarqueeElement.md#id)
- [innerHTML](input._internal_.HTMLMarqueeElement.md#innerhtml)
- [innerText](input._internal_.HTMLMarqueeElement.md#innertext)
- [inputMode](input._internal_.HTMLMarqueeElement.md#inputmode)
- [isConnected](input._internal_.HTMLMarqueeElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLMarqueeElement.md#iscontenteditable)
- [lang](input._internal_.HTMLMarqueeElement.md#lang)
- [lastChild](input._internal_.HTMLMarqueeElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLMarqueeElement.md#lastelementchild)
- [localName](input._internal_.HTMLMarqueeElement.md#localname)
- [loop](input._internal_.HTMLMarqueeElement.md#loop)
- [namespaceURI](input._internal_.HTMLMarqueeElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLMarqueeElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLMarqueeElement.md#nextsibling)
- [nodeName](input._internal_.HTMLMarqueeElement.md#nodename)
- [nodeType](input._internal_.HTMLMarqueeElement.md#nodetype)
- [nodeValue](input._internal_.HTMLMarqueeElement.md#nodevalue)
- [nonce](input._internal_.HTMLMarqueeElement.md#nonce)
- [offsetHeight](input._internal_.HTMLMarqueeElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLMarqueeElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLMarqueeElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLMarqueeElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLMarqueeElement.md#offsetwidth)
- [onabort](input._internal_.HTMLMarqueeElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLMarqueeElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLMarqueeElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLMarqueeElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLMarqueeElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLMarqueeElement.md#onauxclick)
- [onblur](input._internal_.HTMLMarqueeElement.md#onblur)
- [oncanplay](input._internal_.HTMLMarqueeElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLMarqueeElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLMarqueeElement.md#onchange)
- [onclick](input._internal_.HTMLMarqueeElement.md#onclick)
- [onclose](input._internal_.HTMLMarqueeElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLMarqueeElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLMarqueeElement.md#oncopy)
- [oncuechange](input._internal_.HTMLMarqueeElement.md#oncuechange)
- [oncut](input._internal_.HTMLMarqueeElement.md#oncut)
- [ondblclick](input._internal_.HTMLMarqueeElement.md#ondblclick)
- [ondrag](input._internal_.HTMLMarqueeElement.md#ondrag)
- [ondragend](input._internal_.HTMLMarqueeElement.md#ondragend)
- [ondragenter](input._internal_.HTMLMarqueeElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLMarqueeElement.md#ondragleave)
- [ondragover](input._internal_.HTMLMarqueeElement.md#ondragover)
- [ondragstart](input._internal_.HTMLMarqueeElement.md#ondragstart)
- [ondrop](input._internal_.HTMLMarqueeElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLMarqueeElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLMarqueeElement.md#onemptied)
- [onended](input._internal_.HTMLMarqueeElement.md#onended)
- [onerror](input._internal_.HTMLMarqueeElement.md#onerror)
- [onfocus](input._internal_.HTMLMarqueeElement.md#onfocus)
- [onformdata](input._internal_.HTMLMarqueeElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLMarqueeElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLMarqueeElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLMarqueeElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLMarqueeElement.md#oninput)
- [oninvalid](input._internal_.HTMLMarqueeElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLMarqueeElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLMarqueeElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLMarqueeElement.md#onkeyup)
- [onload](input._internal_.HTMLMarqueeElement.md#onload)
- [onloadeddata](input._internal_.HTMLMarqueeElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLMarqueeElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLMarqueeElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLMarqueeElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLMarqueeElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLMarqueeElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLMarqueeElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLMarqueeElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLMarqueeElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLMarqueeElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLMarqueeElement.md#onmouseup)
- [onpaste](input._internal_.HTMLMarqueeElement.md#onpaste)
- [onpause](input._internal_.HTMLMarqueeElement.md#onpause)
- [onplay](input._internal_.HTMLMarqueeElement.md#onplay)
- [onplaying](input._internal_.HTMLMarqueeElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLMarqueeElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLMarqueeElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLMarqueeElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLMarqueeElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLMarqueeElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLMarqueeElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLMarqueeElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLMarqueeElement.md#onpointerup)
- [onprogress](input._internal_.HTMLMarqueeElement.md#onprogress)
- [onratechange](input._internal_.HTMLMarqueeElement.md#onratechange)
- [onreset](input._internal_.HTMLMarqueeElement.md#onreset)
- [onresize](input._internal_.HTMLMarqueeElement.md#onresize)
- [onscroll](input._internal_.HTMLMarqueeElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLMarqueeElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLMarqueeElement.md#onseeked)
- [onseeking](input._internal_.HTMLMarqueeElement.md#onseeking)
- [onselect](input._internal_.HTMLMarqueeElement.md#onselect)
- [onselectionchange](input._internal_.HTMLMarqueeElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLMarqueeElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLMarqueeElement.md#onslotchange)
- [onstalled](input._internal_.HTMLMarqueeElement.md#onstalled)
- [onsubmit](input._internal_.HTMLMarqueeElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLMarqueeElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLMarqueeElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLMarqueeElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLMarqueeElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLMarqueeElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLMarqueeElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLMarqueeElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLMarqueeElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLMarqueeElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLMarqueeElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLMarqueeElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLMarqueeElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLMarqueeElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLMarqueeElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLMarqueeElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLMarqueeElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLMarqueeElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLMarqueeElement.md#onwheel)
- [outerHTML](input._internal_.HTMLMarqueeElement.md#outerhtml)
- [outerText](input._internal_.HTMLMarqueeElement.md#outertext)
- [ownerDocument](input._internal_.HTMLMarqueeElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLMarqueeElement.md#parentelement)
- [parentNode](input._internal_.HTMLMarqueeElement.md#parentnode)
- [part](input._internal_.HTMLMarqueeElement.md#part)
- [prefix](input._internal_.HTMLMarqueeElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLMarqueeElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLMarqueeElement.md#previoussibling)
- [scrollAmount](input._internal_.HTMLMarqueeElement.md#scrollamount)
- [scrollDelay](input._internal_.HTMLMarqueeElement.md#scrolldelay)
- [scrollHeight](input._internal_.HTMLMarqueeElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLMarqueeElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLMarqueeElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLMarqueeElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLMarqueeElement.md#shadowroot)
- [slot](input._internal_.HTMLMarqueeElement.md#slot)
- [spellcheck](input._internal_.HTMLMarqueeElement.md#spellcheck)
- [style](input._internal_.HTMLMarqueeElement.md#style)
- [tabIndex](input._internal_.HTMLMarqueeElement.md#tabindex)
- [tagName](input._internal_.HTMLMarqueeElement.md#tagname)
- [textContent](input._internal_.HTMLMarqueeElement.md#textcontent)
- [title](input._internal_.HTMLMarqueeElement.md#title)
- [translate](input._internal_.HTMLMarqueeElement.md#translate)
- [trueSpeed](input._internal_.HTMLMarqueeElement.md#truespeed)
- [vspace](input._internal_.HTMLMarqueeElement.md#vspace)
- [width](input._internal_.HTMLMarqueeElement.md#width)

### Methods

- [addEventListener](input._internal_.HTMLMarqueeElement.md#addeventlistener)
- [after](input._internal_.HTMLMarqueeElement.md#after)
- [animate](input._internal_.HTMLMarqueeElement.md#animate)
- [append](input._internal_.HTMLMarqueeElement.md#append)
- [appendChild](input._internal_.HTMLMarqueeElement.md#appendchild)
- [attachInternals](input._internal_.HTMLMarqueeElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLMarqueeElement.md#attachshadow)
- [before](input._internal_.HTMLMarqueeElement.md#before)
- [blur](input._internal_.HTMLMarqueeElement.md#blur)
- [click](input._internal_.HTMLMarqueeElement.md#click)
- [cloneNode](input._internal_.HTMLMarqueeElement.md#clonenode)
- [closest](input._internal_.HTMLMarqueeElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLMarqueeElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLMarqueeElement.md#contains)
- [dispatchEvent](input._internal_.HTMLMarqueeElement.md#dispatchevent)
- [focus](input._internal_.HTMLMarqueeElement.md#focus)
- [getAnimations](input._internal_.HTMLMarqueeElement.md#getanimations)
- [getAttribute](input._internal_.HTMLMarqueeElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLMarqueeElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLMarqueeElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLMarqueeElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLMarqueeElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLMarqueeElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLMarqueeElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLMarqueeElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLMarqueeElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLMarqueeElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLMarqueeElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLMarqueeElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLMarqueeElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLMarqueeElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLMarqueeElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLMarqueeElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLMarqueeElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLMarqueeElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLMarqueeElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLMarqueeElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLMarqueeElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLMarqueeElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLMarqueeElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLMarqueeElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLMarqueeElement.md#lookupprefix)
- [matches](input._internal_.HTMLMarqueeElement.md#matches)
- [normalize](input._internal_.HTMLMarqueeElement.md#normalize)
- [prepend](input._internal_.HTMLMarqueeElement.md#prepend)
- [querySelector](input._internal_.HTMLMarqueeElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLMarqueeElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLMarqueeElement.md#releasepointercapture)
- [remove](input._internal_.HTMLMarqueeElement.md#remove)
- [removeAttribute](input._internal_.HTMLMarqueeElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLMarqueeElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLMarqueeElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLMarqueeElement.md#removechild)
- [removeEventListener](input._internal_.HTMLMarqueeElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLMarqueeElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLMarqueeElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLMarqueeElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLMarqueeElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLMarqueeElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLMarqueeElement.md#scroll)
- [scrollBy](input._internal_.HTMLMarqueeElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLMarqueeElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLMarqueeElement.md#scrollto)
- [setAttribute](input._internal_.HTMLMarqueeElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLMarqueeElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLMarqueeElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLMarqueeElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLMarqueeElement.md#setpointercapture)
- [start](input._internal_.HTMLMarqueeElement.md#start)
- [stop](input._internal_.HTMLMarqueeElement.md#stop)
- [toggleAttribute](input._internal_.HTMLMarqueeElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLMarqueeElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLMarqueeElement`](../modules/input._internal_.md#htmlmarqueeelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
