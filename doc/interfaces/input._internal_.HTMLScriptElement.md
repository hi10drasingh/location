[Droom Google Location Plugin - v1.0.10](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLScriptElement

# Interface: HTMLScriptElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLScriptElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLScriptElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLScriptElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLScriptElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLScriptElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLScriptElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLScriptElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLScriptElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLScriptElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLScriptElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLScriptElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLScriptElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLScriptElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLScriptElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLScriptElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLScriptElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLScriptElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLScriptElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLScriptElement.md#text_node)
- [accessKey](input._internal_.HTMLScriptElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLScriptElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLScriptElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLScriptElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLScriptElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLScriptElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLScriptElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLScriptElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLScriptElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLScriptElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLScriptElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLScriptElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLScriptElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLScriptElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLScriptElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLScriptElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLScriptElement.md#arialevel)
- [ariaLive](input._internal_.HTMLScriptElement.md#arialive)
- [ariaModal](input._internal_.HTMLScriptElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLScriptElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLScriptElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLScriptElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLScriptElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLScriptElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLScriptElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLScriptElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLScriptElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLScriptElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLScriptElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLScriptElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLScriptElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLScriptElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLScriptElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLScriptElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLScriptElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLScriptElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLScriptElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLScriptElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLScriptElement.md#assignedslot)
- [async](input._internal_.HTMLScriptElement.md#async)
- [attributes](input._internal_.HTMLScriptElement.md#attributes)
- [autocapitalize](input._internal_.HTMLScriptElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLScriptElement.md#autofocus)
- [baseURI](input._internal_.HTMLScriptElement.md#baseuri)
- [charset](input._internal_.HTMLScriptElement.md#charset)
- [childElementCount](input._internal_.HTMLScriptElement.md#childelementcount)
- [childNodes](input._internal_.HTMLScriptElement.md#childnodes)
- [children](input._internal_.HTMLScriptElement.md#children)
- [classList](input._internal_.HTMLScriptElement.md#classlist)
- [className](input._internal_.HTMLScriptElement.md#classname)
- [clientHeight](input._internal_.HTMLScriptElement.md#clientheight)
- [clientLeft](input._internal_.HTMLScriptElement.md#clientleft)
- [clientTop](input._internal_.HTMLScriptElement.md#clienttop)
- [clientWidth](input._internal_.HTMLScriptElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLScriptElement.md#contenteditable)
- [crossOrigin](input._internal_.HTMLScriptElement.md#crossorigin)
- [dataset](input._internal_.HTMLScriptElement.md#dataset)
- [defer](input._internal_.HTMLScriptElement.md#defer)
- [dir](input._internal_.HTMLScriptElement.md#dir)
- [draggable](input._internal_.HTMLScriptElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLScriptElement.md#enterkeyhint)
- [event](input._internal_.HTMLScriptElement.md#event)
- [firstChild](input._internal_.HTMLScriptElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLScriptElement.md#firstelementchild)
- [hidden](input._internal_.HTMLScriptElement.md#hidden)
- [htmlFor](input._internal_.HTMLScriptElement.md#htmlfor)
- [id](input._internal_.HTMLScriptElement.md#id)
- [innerHTML](input._internal_.HTMLScriptElement.md#innerhtml)
- [innerText](input._internal_.HTMLScriptElement.md#innertext)
- [inputMode](input._internal_.HTMLScriptElement.md#inputmode)
- [integrity](input._internal_.HTMLScriptElement.md#integrity)
- [isConnected](input._internal_.HTMLScriptElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLScriptElement.md#iscontenteditable)
- [lang](input._internal_.HTMLScriptElement.md#lang)
- [lastChild](input._internal_.HTMLScriptElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLScriptElement.md#lastelementchild)
- [localName](input._internal_.HTMLScriptElement.md#localname)
- [namespaceURI](input._internal_.HTMLScriptElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLScriptElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLScriptElement.md#nextsibling)
- [noModule](input._internal_.HTMLScriptElement.md#nomodule)
- [nodeName](input._internal_.HTMLScriptElement.md#nodename)
- [nodeType](input._internal_.HTMLScriptElement.md#nodetype)
- [nodeValue](input._internal_.HTMLScriptElement.md#nodevalue)
- [nonce](input._internal_.HTMLScriptElement.md#nonce)
- [offsetHeight](input._internal_.HTMLScriptElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLScriptElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLScriptElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLScriptElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLScriptElement.md#offsetwidth)
- [onabort](input._internal_.HTMLScriptElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLScriptElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLScriptElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLScriptElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLScriptElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLScriptElement.md#onauxclick)
- [onblur](input._internal_.HTMLScriptElement.md#onblur)
- [oncanplay](input._internal_.HTMLScriptElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLScriptElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLScriptElement.md#onchange)
- [onclick](input._internal_.HTMLScriptElement.md#onclick)
- [onclose](input._internal_.HTMLScriptElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLScriptElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLScriptElement.md#oncopy)
- [oncuechange](input._internal_.HTMLScriptElement.md#oncuechange)
- [oncut](input._internal_.HTMLScriptElement.md#oncut)
- [ondblclick](input._internal_.HTMLScriptElement.md#ondblclick)
- [ondrag](input._internal_.HTMLScriptElement.md#ondrag)
- [ondragend](input._internal_.HTMLScriptElement.md#ondragend)
- [ondragenter](input._internal_.HTMLScriptElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLScriptElement.md#ondragleave)
- [ondragover](input._internal_.HTMLScriptElement.md#ondragover)
- [ondragstart](input._internal_.HTMLScriptElement.md#ondragstart)
- [ondrop](input._internal_.HTMLScriptElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLScriptElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLScriptElement.md#onemptied)
- [onended](input._internal_.HTMLScriptElement.md#onended)
- [onerror](input._internal_.HTMLScriptElement.md#onerror)
- [onfocus](input._internal_.HTMLScriptElement.md#onfocus)
- [onformdata](input._internal_.HTMLScriptElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLScriptElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLScriptElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLScriptElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLScriptElement.md#oninput)
- [oninvalid](input._internal_.HTMLScriptElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLScriptElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLScriptElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLScriptElement.md#onkeyup)
- [onload](input._internal_.HTMLScriptElement.md#onload)
- [onloadeddata](input._internal_.HTMLScriptElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLScriptElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLScriptElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLScriptElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLScriptElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLScriptElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLScriptElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLScriptElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLScriptElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLScriptElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLScriptElement.md#onmouseup)
- [onpaste](input._internal_.HTMLScriptElement.md#onpaste)
- [onpause](input._internal_.HTMLScriptElement.md#onpause)
- [onplay](input._internal_.HTMLScriptElement.md#onplay)
- [onplaying](input._internal_.HTMLScriptElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLScriptElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLScriptElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLScriptElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLScriptElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLScriptElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLScriptElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLScriptElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLScriptElement.md#onpointerup)
- [onprogress](input._internal_.HTMLScriptElement.md#onprogress)
- [onratechange](input._internal_.HTMLScriptElement.md#onratechange)
- [onreset](input._internal_.HTMLScriptElement.md#onreset)
- [onresize](input._internal_.HTMLScriptElement.md#onresize)
- [onscroll](input._internal_.HTMLScriptElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLScriptElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLScriptElement.md#onseeked)
- [onseeking](input._internal_.HTMLScriptElement.md#onseeking)
- [onselect](input._internal_.HTMLScriptElement.md#onselect)
- [onselectionchange](input._internal_.HTMLScriptElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLScriptElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLScriptElement.md#onslotchange)
- [onstalled](input._internal_.HTMLScriptElement.md#onstalled)
- [onsubmit](input._internal_.HTMLScriptElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLScriptElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLScriptElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLScriptElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLScriptElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLScriptElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLScriptElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLScriptElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLScriptElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLScriptElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLScriptElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLScriptElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLScriptElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLScriptElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLScriptElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLScriptElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLScriptElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLScriptElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLScriptElement.md#onwheel)
- [outerHTML](input._internal_.HTMLScriptElement.md#outerhtml)
- [outerText](input._internal_.HTMLScriptElement.md#outertext)
- [ownerDocument](input._internal_.HTMLScriptElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLScriptElement.md#parentelement)
- [parentNode](input._internal_.HTMLScriptElement.md#parentnode)
- [part](input._internal_.HTMLScriptElement.md#part)
- [prefix](input._internal_.HTMLScriptElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLScriptElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLScriptElement.md#previoussibling)
- [referrerPolicy](input._internal_.HTMLScriptElement.md#referrerpolicy)
- [scrollHeight](input._internal_.HTMLScriptElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLScriptElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLScriptElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLScriptElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLScriptElement.md#shadowroot)
- [slot](input._internal_.HTMLScriptElement.md#slot)
- [spellcheck](input._internal_.HTMLScriptElement.md#spellcheck)
- [src](input._internal_.HTMLScriptElement.md#src)
- [style](input._internal_.HTMLScriptElement.md#style)
- [tabIndex](input._internal_.HTMLScriptElement.md#tabindex)
- [tagName](input._internal_.HTMLScriptElement.md#tagname)
- [text](input._internal_.HTMLScriptElement.md#text)
- [textContent](input._internal_.HTMLScriptElement.md#textcontent)
- [title](input._internal_.HTMLScriptElement.md#title)
- [translate](input._internal_.HTMLScriptElement.md#translate)
- [type](input._internal_.HTMLScriptElement.md#type)

### Methods

- [addEventListener](input._internal_.HTMLScriptElement.md#addeventlistener)
- [after](input._internal_.HTMLScriptElement.md#after)
- [animate](input._internal_.HTMLScriptElement.md#animate)
- [append](input._internal_.HTMLScriptElement.md#append)
- [appendChild](input._internal_.HTMLScriptElement.md#appendchild)
- [attachInternals](input._internal_.HTMLScriptElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLScriptElement.md#attachshadow)
- [before](input._internal_.HTMLScriptElement.md#before)
- [blur](input._internal_.HTMLScriptElement.md#blur)
- [click](input._internal_.HTMLScriptElement.md#click)
- [cloneNode](input._internal_.HTMLScriptElement.md#clonenode)
- [closest](input._internal_.HTMLScriptElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLScriptElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLScriptElement.md#contains)
- [dispatchEvent](input._internal_.HTMLScriptElement.md#dispatchevent)
- [focus](input._internal_.HTMLScriptElement.md#focus)
- [getAnimations](input._internal_.HTMLScriptElement.md#getanimations)
- [getAttribute](input._internal_.HTMLScriptElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLScriptElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLScriptElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLScriptElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLScriptElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLScriptElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLScriptElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLScriptElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLScriptElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLScriptElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLScriptElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLScriptElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLScriptElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLScriptElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLScriptElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLScriptElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLScriptElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLScriptElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLScriptElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLScriptElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLScriptElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLScriptElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLScriptElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLScriptElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLScriptElement.md#lookupprefix)
- [matches](input._internal_.HTMLScriptElement.md#matches)
- [normalize](input._internal_.HTMLScriptElement.md#normalize)
- [prepend](input._internal_.HTMLScriptElement.md#prepend)
- [querySelector](input._internal_.HTMLScriptElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLScriptElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLScriptElement.md#releasepointercapture)
- [remove](input._internal_.HTMLScriptElement.md#remove)
- [removeAttribute](input._internal_.HTMLScriptElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLScriptElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLScriptElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLScriptElement.md#removechild)
- [removeEventListener](input._internal_.HTMLScriptElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLScriptElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLScriptElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLScriptElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLScriptElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLScriptElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLScriptElement.md#scroll)
- [scrollBy](input._internal_.HTMLScriptElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLScriptElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLScriptElement.md#scrollto)
- [setAttribute](input._internal_.HTMLScriptElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLScriptElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLScriptElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLScriptElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLScriptElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLScriptElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLScriptElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLScriptElement`](../modules/input._internal_.md#htmlscriptelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
