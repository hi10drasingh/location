[Droom Google Location Plugin - v1.0.10](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGFEColorMatrixElement

# Interface: SVGFEColorMatrixElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGFEColorMatrixElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGFEColorMatrixElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGFEColorMatrixElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGFEColorMatrixElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGFEColorMatrixElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGFEColorMatrixElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGFEColorMatrixElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGFEColorMatrixElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGFEColorMatrixElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGFEColorMatrixElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGFEColorMatrixElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGFEColorMatrixElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGFEColorMatrixElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGFEColorMatrixElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGFEColorMatrixElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGFEColorMatrixElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGFEColorMatrixElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGFEColorMatrixElement.md#processing_instruction_node)
- [SVG\_FECOLORMATRIX\_TYPE\_HUEROTATE](input._internal_.SVGFEColorMatrixElement.md#svg_fecolormatrix_type_huerotate)
- [SVG\_FECOLORMATRIX\_TYPE\_LUMINANCETOALPHA](input._internal_.SVGFEColorMatrixElement.md#svg_fecolormatrix_type_luminancetoalpha)
- [SVG\_FECOLORMATRIX\_TYPE\_MATRIX](input._internal_.SVGFEColorMatrixElement.md#svg_fecolormatrix_type_matrix)
- [SVG\_FECOLORMATRIX\_TYPE\_SATURATE](input._internal_.SVGFEColorMatrixElement.md#svg_fecolormatrix_type_saturate)
- [SVG\_FECOLORMATRIX\_TYPE\_UNKNOWN](input._internal_.SVGFEColorMatrixElement.md#svg_fecolormatrix_type_unknown)
- [TEXT\_NODE](input._internal_.SVGFEColorMatrixElement.md#text_node)
- [ariaAtomic](input._internal_.SVGFEColorMatrixElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGFEColorMatrixElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGFEColorMatrixElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGFEColorMatrixElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGFEColorMatrixElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGFEColorMatrixElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGFEColorMatrixElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGFEColorMatrixElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGFEColorMatrixElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGFEColorMatrixElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGFEColorMatrixElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGFEColorMatrixElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGFEColorMatrixElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGFEColorMatrixElement.md#arialabel)
- [ariaLevel](input._internal_.SVGFEColorMatrixElement.md#arialevel)
- [ariaLive](input._internal_.SVGFEColorMatrixElement.md#arialive)
- [ariaModal](input._internal_.SVGFEColorMatrixElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGFEColorMatrixElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGFEColorMatrixElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGFEColorMatrixElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGFEColorMatrixElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGFEColorMatrixElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGFEColorMatrixElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGFEColorMatrixElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGFEColorMatrixElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGFEColorMatrixElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGFEColorMatrixElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGFEColorMatrixElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGFEColorMatrixElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGFEColorMatrixElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGFEColorMatrixElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGFEColorMatrixElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGFEColorMatrixElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGFEColorMatrixElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGFEColorMatrixElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGFEColorMatrixElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGFEColorMatrixElement.md#assignedslot)
- [attributes](input._internal_.SVGFEColorMatrixElement.md#attributes)
- [autofocus](input._internal_.SVGFEColorMatrixElement.md#autofocus)
- [baseURI](input._internal_.SVGFEColorMatrixElement.md#baseuri)
- [childElementCount](input._internal_.SVGFEColorMatrixElement.md#childelementcount)
- [childNodes](input._internal_.SVGFEColorMatrixElement.md#childnodes)
- [children](input._internal_.SVGFEColorMatrixElement.md#children)
- [classList](input._internal_.SVGFEColorMatrixElement.md#classlist)
- [className](input._internal_.SVGFEColorMatrixElement.md#classname)
- [clientHeight](input._internal_.SVGFEColorMatrixElement.md#clientheight)
- [clientLeft](input._internal_.SVGFEColorMatrixElement.md#clientleft)
- [clientTop](input._internal_.SVGFEColorMatrixElement.md#clienttop)
- [clientWidth](input._internal_.SVGFEColorMatrixElement.md#clientwidth)
- [dataset](input._internal_.SVGFEColorMatrixElement.md#dataset)
- [firstChild](input._internal_.SVGFEColorMatrixElement.md#firstchild)
- [firstElementChild](input._internal_.SVGFEColorMatrixElement.md#firstelementchild)
- [height](input._internal_.SVGFEColorMatrixElement.md#height)
- [id](input._internal_.SVGFEColorMatrixElement.md#id)
- [in1](input._internal_.SVGFEColorMatrixElement.md#in1)
- [innerHTML](input._internal_.SVGFEColorMatrixElement.md#innerhtml)
- [isConnected](input._internal_.SVGFEColorMatrixElement.md#isconnected)
- [lastChild](input._internal_.SVGFEColorMatrixElement.md#lastchild)
- [lastElementChild](input._internal_.SVGFEColorMatrixElement.md#lastelementchild)
- [localName](input._internal_.SVGFEColorMatrixElement.md#localname)
- [namespaceURI](input._internal_.SVGFEColorMatrixElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGFEColorMatrixElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGFEColorMatrixElement.md#nextsibling)
- [nodeName](input._internal_.SVGFEColorMatrixElement.md#nodename)
- [nodeType](input._internal_.SVGFEColorMatrixElement.md#nodetype)
- [nodeValue](input._internal_.SVGFEColorMatrixElement.md#nodevalue)
- [nonce](input._internal_.SVGFEColorMatrixElement.md#nonce)
- [onabort](input._internal_.SVGFEColorMatrixElement.md#onabort)
- [onanimationcancel](input._internal_.SVGFEColorMatrixElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGFEColorMatrixElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGFEColorMatrixElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGFEColorMatrixElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGFEColorMatrixElement.md#onauxclick)
- [onblur](input._internal_.SVGFEColorMatrixElement.md#onblur)
- [oncanplay](input._internal_.SVGFEColorMatrixElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGFEColorMatrixElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGFEColorMatrixElement.md#onchange)
- [onclick](input._internal_.SVGFEColorMatrixElement.md#onclick)
- [onclose](input._internal_.SVGFEColorMatrixElement.md#onclose)
- [oncontextmenu](input._internal_.SVGFEColorMatrixElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGFEColorMatrixElement.md#oncopy)
- [oncuechange](input._internal_.SVGFEColorMatrixElement.md#oncuechange)
- [oncut](input._internal_.SVGFEColorMatrixElement.md#oncut)
- [ondblclick](input._internal_.SVGFEColorMatrixElement.md#ondblclick)
- [ondrag](input._internal_.SVGFEColorMatrixElement.md#ondrag)
- [ondragend](input._internal_.SVGFEColorMatrixElement.md#ondragend)
- [ondragenter](input._internal_.SVGFEColorMatrixElement.md#ondragenter)
- [ondragleave](input._internal_.SVGFEColorMatrixElement.md#ondragleave)
- [ondragover](input._internal_.SVGFEColorMatrixElement.md#ondragover)
- [ondragstart](input._internal_.SVGFEColorMatrixElement.md#ondragstart)
- [ondrop](input._internal_.SVGFEColorMatrixElement.md#ondrop)
- [ondurationchange](input._internal_.SVGFEColorMatrixElement.md#ondurationchange)
- [onemptied](input._internal_.SVGFEColorMatrixElement.md#onemptied)
- [onended](input._internal_.SVGFEColorMatrixElement.md#onended)
- [onerror](input._internal_.SVGFEColorMatrixElement.md#onerror)
- [onfocus](input._internal_.SVGFEColorMatrixElement.md#onfocus)
- [onformdata](input._internal_.SVGFEColorMatrixElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGFEColorMatrixElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGFEColorMatrixElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGFEColorMatrixElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGFEColorMatrixElement.md#oninput)
- [oninvalid](input._internal_.SVGFEColorMatrixElement.md#oninvalid)
- [onkeydown](input._internal_.SVGFEColorMatrixElement.md#onkeydown)
- [onkeypress](input._internal_.SVGFEColorMatrixElement.md#onkeypress)
- [onkeyup](input._internal_.SVGFEColorMatrixElement.md#onkeyup)
- [onload](input._internal_.SVGFEColorMatrixElement.md#onload)
- [onloadeddata](input._internal_.SVGFEColorMatrixElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGFEColorMatrixElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGFEColorMatrixElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGFEColorMatrixElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGFEColorMatrixElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGFEColorMatrixElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGFEColorMatrixElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGFEColorMatrixElement.md#onmousemove)
- [onmouseout](input._internal_.SVGFEColorMatrixElement.md#onmouseout)
- [onmouseover](input._internal_.SVGFEColorMatrixElement.md#onmouseover)
- [onmouseup](input._internal_.SVGFEColorMatrixElement.md#onmouseup)
- [onpaste](input._internal_.SVGFEColorMatrixElement.md#onpaste)
- [onpause](input._internal_.SVGFEColorMatrixElement.md#onpause)
- [onplay](input._internal_.SVGFEColorMatrixElement.md#onplay)
- [onplaying](input._internal_.SVGFEColorMatrixElement.md#onplaying)
- [onpointercancel](input._internal_.SVGFEColorMatrixElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGFEColorMatrixElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGFEColorMatrixElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGFEColorMatrixElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGFEColorMatrixElement.md#onpointermove)
- [onpointerout](input._internal_.SVGFEColorMatrixElement.md#onpointerout)
- [onpointerover](input._internal_.SVGFEColorMatrixElement.md#onpointerover)
- [onpointerup](input._internal_.SVGFEColorMatrixElement.md#onpointerup)
- [onprogress](input._internal_.SVGFEColorMatrixElement.md#onprogress)
- [onratechange](input._internal_.SVGFEColorMatrixElement.md#onratechange)
- [onreset](input._internal_.SVGFEColorMatrixElement.md#onreset)
- [onresize](input._internal_.SVGFEColorMatrixElement.md#onresize)
- [onscroll](input._internal_.SVGFEColorMatrixElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGFEColorMatrixElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGFEColorMatrixElement.md#onseeked)
- [onseeking](input._internal_.SVGFEColorMatrixElement.md#onseeking)
- [onselect](input._internal_.SVGFEColorMatrixElement.md#onselect)
- [onselectionchange](input._internal_.SVGFEColorMatrixElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGFEColorMatrixElement.md#onselectstart)
- [onslotchange](input._internal_.SVGFEColorMatrixElement.md#onslotchange)
- [onstalled](input._internal_.SVGFEColorMatrixElement.md#onstalled)
- [onsubmit](input._internal_.SVGFEColorMatrixElement.md#onsubmit)
- [onsuspend](input._internal_.SVGFEColorMatrixElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGFEColorMatrixElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGFEColorMatrixElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGFEColorMatrixElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGFEColorMatrixElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGFEColorMatrixElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGFEColorMatrixElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGFEColorMatrixElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGFEColorMatrixElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGFEColorMatrixElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGFEColorMatrixElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGFEColorMatrixElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGFEColorMatrixElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGFEColorMatrixElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGFEColorMatrixElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGFEColorMatrixElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGFEColorMatrixElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGFEColorMatrixElement.md#onwheel)
- [outerHTML](input._internal_.SVGFEColorMatrixElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGFEColorMatrixElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGFEColorMatrixElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGFEColorMatrixElement.md#parentelement)
- [parentNode](input._internal_.SVGFEColorMatrixElement.md#parentnode)
- [part](input._internal_.SVGFEColorMatrixElement.md#part)
- [prefix](input._internal_.SVGFEColorMatrixElement.md#prefix)
- [previousElementSibling](input._internal_.SVGFEColorMatrixElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGFEColorMatrixElement.md#previoussibling)
- [result](input._internal_.SVGFEColorMatrixElement.md#result)
- [scrollHeight](input._internal_.SVGFEColorMatrixElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGFEColorMatrixElement.md#scrollleft)
- [scrollTop](input._internal_.SVGFEColorMatrixElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGFEColorMatrixElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGFEColorMatrixElement.md#shadowroot)
- [slot](input._internal_.SVGFEColorMatrixElement.md#slot)
- [style](input._internal_.SVGFEColorMatrixElement.md#style)
- [tabIndex](input._internal_.SVGFEColorMatrixElement.md#tabindex)
- [tagName](input._internal_.SVGFEColorMatrixElement.md#tagname)
- [textContent](input._internal_.SVGFEColorMatrixElement.md#textcontent)
- [type](input._internal_.SVGFEColorMatrixElement.md#type)
- [values](input._internal_.SVGFEColorMatrixElement.md#values)
- [viewportElement](input._internal_.SVGFEColorMatrixElement.md#viewportelement)
- [width](input._internal_.SVGFEColorMatrixElement.md#width)
- [x](input._internal_.SVGFEColorMatrixElement.md#x)
- [y](input._internal_.SVGFEColorMatrixElement.md#y)

### Methods

- [addEventListener](input._internal_.SVGFEColorMatrixElement.md#addeventlistener)
- [after](input._internal_.SVGFEColorMatrixElement.md#after)
- [animate](input._internal_.SVGFEColorMatrixElement.md#animate)
- [append](input._internal_.SVGFEColorMatrixElement.md#append)
- [appendChild](input._internal_.SVGFEColorMatrixElement.md#appendchild)
- [attachShadow](input._internal_.SVGFEColorMatrixElement.md#attachshadow)
- [before](input._internal_.SVGFEColorMatrixElement.md#before)
- [blur](input._internal_.SVGFEColorMatrixElement.md#blur)
- [cloneNode](input._internal_.SVGFEColorMatrixElement.md#clonenode)
- [closest](input._internal_.SVGFEColorMatrixElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGFEColorMatrixElement.md#comparedocumentposition)
- [contains](input._internal_.SVGFEColorMatrixElement.md#contains)
- [dispatchEvent](input._internal_.SVGFEColorMatrixElement.md#dispatchevent)
- [focus](input._internal_.SVGFEColorMatrixElement.md#focus)
- [getAnimations](input._internal_.SVGFEColorMatrixElement.md#getanimations)
- [getAttribute](input._internal_.SVGFEColorMatrixElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGFEColorMatrixElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGFEColorMatrixElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGFEColorMatrixElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGFEColorMatrixElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.SVGFEColorMatrixElement.md#getboundingclientrect)
- [getClientRects](input._internal_.SVGFEColorMatrixElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGFEColorMatrixElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGFEColorMatrixElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGFEColorMatrixElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGFEColorMatrixElement.md#getrootnode)
- [hasAttribute](input._internal_.SVGFEColorMatrixElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGFEColorMatrixElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGFEColorMatrixElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGFEColorMatrixElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGFEColorMatrixElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGFEColorMatrixElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGFEColorMatrixElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGFEColorMatrixElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGFEColorMatrixElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGFEColorMatrixElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGFEColorMatrixElement.md#isequalnode)
- [isSameNode](input._internal_.SVGFEColorMatrixElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGFEColorMatrixElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGFEColorMatrixElement.md#lookupprefix)
- [matches](input._internal_.SVGFEColorMatrixElement.md#matches)
- [normalize](input._internal_.SVGFEColorMatrixElement.md#normalize)
- [prepend](input._internal_.SVGFEColorMatrixElement.md#prepend)
- [querySelector](input._internal_.SVGFEColorMatrixElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGFEColorMatrixElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGFEColorMatrixElement.md#releasepointercapture)
- [remove](input._internal_.SVGFEColorMatrixElement.md#remove)
- [removeAttribute](input._internal_.SVGFEColorMatrixElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGFEColorMatrixElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGFEColorMatrixElement.md#removeattributenode)
- [removeChild](input._internal_.SVGFEColorMatrixElement.md#removechild)
- [removeEventListener](input._internal_.SVGFEColorMatrixElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGFEColorMatrixElement.md#replacechild)
- [replaceChildren](input._internal_.SVGFEColorMatrixElement.md#replacechildren)
- [replaceWith](input._internal_.SVGFEColorMatrixElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGFEColorMatrixElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGFEColorMatrixElement.md#requestpointerlock)
- [scroll](input._internal_.SVGFEColorMatrixElement.md#scroll)
- [scrollBy](input._internal_.SVGFEColorMatrixElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGFEColorMatrixElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGFEColorMatrixElement.md#scrollto)
- [setAttribute](input._internal_.SVGFEColorMatrixElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGFEColorMatrixElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGFEColorMatrixElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGFEColorMatrixElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGFEColorMatrixElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGFEColorMatrixElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGFEColorMatrixElement.md#webkitmatchesselector)
...
• `Readonly` **values**: [`SVGAnimatedNumberList`](../modules/input._internal_.md#svganimatednumberlist)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGFEColorMatrixElement`](../modules/input._internal_.md#svgfecolormatrixelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
