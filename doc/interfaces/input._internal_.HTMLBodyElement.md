[Droom Google Location Plugin - v1.0.10](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLBodyElement

# Interface: HTMLBodyElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLBodyElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLBodyElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLBodyElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLBodyElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLBodyElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLBodyElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLBodyElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLBodyElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLBodyElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLBodyElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLBodyElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLBodyElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLBodyElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLBodyElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLBodyElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLBodyElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLBodyElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLBodyElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLBodyElement.md#text_node)
- [aLink](input._internal_.HTMLBodyElement.md#alink)
- [accessKey](input._internal_.HTMLBodyElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLBodyElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLBodyElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLBodyElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLBodyElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLBodyElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLBodyElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLBodyElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLBodyElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLBodyElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLBodyElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLBodyElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLBodyElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLBodyElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLBodyElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLBodyElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLBodyElement.md#arialevel)
- [ariaLive](input._internal_.HTMLBodyElement.md#arialive)
- [ariaModal](input._internal_.HTMLBodyElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLBodyElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLBodyElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLBodyElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLBodyElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLBodyElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLBodyElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLBodyElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLBodyElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLBodyElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLBodyElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLBodyElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLBodyElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLBodyElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLBodyElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLBodyElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLBodyElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLBodyElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLBodyElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLBodyElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLBodyElement.md#assignedslot)
- [attributes](input._internal_.HTMLBodyElement.md#attributes)
- [autocapitalize](input._internal_.HTMLBodyElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLBodyElement.md#autofocus)
- [background](input._internal_.HTMLBodyElement.md#background)
- [baseURI](input._internal_.HTMLBodyElement.md#baseuri)
- [bgColor](input._internal_.HTMLBodyElement.md#bgcolor)
- [childElementCount](input._internal_.HTMLBodyElement.md#childelementcount)
- [childNodes](input._internal_.HTMLBodyElement.md#childnodes)
- [children](input._internal_.HTMLBodyElement.md#children)
- [classList](input._internal_.HTMLBodyElement.md#classlist)
- [className](input._internal_.HTMLBodyElement.md#classname)
- [clientHeight](input._internal_.HTMLBodyElement.md#clientheight)
- [clientLeft](input._internal_.HTMLBodyElement.md#clientleft)
- [clientTop](input._internal_.HTMLBodyElement.md#clienttop)
- [clientWidth](input._internal_.HTMLBodyElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLBodyElement.md#contenteditable)
- [dataset](input._internal_.HTMLBodyElement.md#dataset)
- [dir](input._internal_.HTMLBodyElement.md#dir)
- [draggable](input._internal_.HTMLBodyElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLBodyElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLBodyElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLBodyElement.md#firstelementchild)
- [hidden](input._internal_.HTMLBodyElement.md#hidden)
- [id](input._internal_.HTMLBodyElement.md#id)
- [innerHTML](input._internal_.HTMLBodyElement.md#innerhtml)
- [innerText](input._internal_.HTMLBodyElement.md#innertext)
- [inputMode](input._internal_.HTMLBodyElement.md#inputmode)
- [isConnected](input._internal_.HTMLBodyElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLBodyElement.md#iscontenteditable)
- [lang](input._internal_.HTMLBodyElement.md#lang)
- [lastChild](input._internal_.HTMLBodyElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLBodyElement.md#lastelementchild)
- [link](input._internal_.HTMLBodyElement.md#link)
- [localName](input._internal_.HTMLBodyElement.md#localname)
- [namespaceURI](input._internal_.HTMLBodyElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLBodyElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLBodyElement.md#nextsibling)
- [nodeName](input._internal_.HTMLBodyElement.md#nodename)
- [nodeType](input._internal_.HTMLBodyElement.md#nodetype)
- [nodeValue](input._internal_.HTMLBodyElement.md#nodevalue)
- [nonce](input._internal_.HTMLBodyElement.md#nonce)
- [offsetHeight](input._internal_.HTMLBodyElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLBodyElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLBodyElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLBodyElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLBodyElement.md#offsetwidth)
- [onabort](input._internal_.HTMLBodyElement.md#onabort)
- [onafterprint](input._internal_.HTMLBodyElement.md#onafterprint)
- [onanimationcancel](input._internal_.HTMLBodyElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLBodyElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLBodyElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLBodyElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLBodyElement.md#onauxclick)
- [onbeforeprint](input._internal_.HTMLBodyElement.md#onbeforeprint)
- [onbeforeunload](input._internal_.HTMLBodyElement.md#onbeforeunload)
- [onblur](input._internal_.HTMLBodyElement.md#onblur)
- [oncanplay](input._internal_.HTMLBodyElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLBodyElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLBodyElement.md#onchange)
- [onclick](input._internal_.HTMLBodyElement.md#onclick)
- [onclose](input._internal_.HTMLBodyElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLBodyElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLBodyElement.md#oncopy)
- [oncuechange](input._internal_.HTMLBodyElement.md#oncuechange)
- [oncut](input._internal_.HTMLBodyElement.md#oncut)
- [ondblclick](input._internal_.HTMLBodyElement.md#ondblclick)
- [ondrag](input._internal_.HTMLBodyElement.md#ondrag)
- [ondragend](input._internal_.HTMLBodyElement.md#ondragend)
- [ondragenter](input._internal_.HTMLBodyElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLBodyElement.md#ondragleave)
- [ondragover](input._internal_.HTMLBodyElement.md#ondragover)
- [ondragstart](input._internal_.HTMLBodyElement.md#ondragstart)
- [ondrop](input._internal_.HTMLBodyElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLBodyElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLBodyElement.md#onemptied)
- [onended](input._internal_.HTMLBodyElement.md#onended)
- [onerror](input._internal_.HTMLBodyElement.md#onerror)
- [onfocus](input._internal_.HTMLBodyElement.md#onfocus)
- [onformdata](input._internal_.HTMLBodyElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLBodyElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLBodyElement.md#onfullscreenerror)
- [ongamepadconnected](input._internal_.HTMLBodyElement.md#ongamepadconnected)
- [ongamepaddisconnected](input._internal_.HTMLBodyElement.md#ongamepaddisconnected)
- [ongotpointercapture](input._internal_.HTMLBodyElement.md#ongotpointercapture)
- [onhashchange](input._internal_.HTMLBodyElement.md#onhashchange)
- [oninput](input._internal_.HTMLBodyElement.md#oninput)
- [oninvalid](input._internal_.HTMLBodyElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLBodyElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLBodyElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLBodyElement.md#onkeyup)
- [onlanguagechange](input._internal_.HTMLBodyElement.md#onlanguagechange)
- [onload](input._internal_.HTMLBodyElement.md#onload)
- [onloadeddata](input._internal_.HTMLBodyElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLBodyElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLBodyElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLBodyElement.md#onlostpointercapture)
- [onmessage](input._internal_.HTMLBodyElement.md#onmessage)
- [onmessageerror](input._internal_.HTMLBodyElement.md#onmessageerror)
- [onmousedown](input._internal_.HTMLBodyElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLBodyElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLBodyElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLBodyElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLBodyElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLBodyElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLBodyElement.md#onmouseup)
- [onoffline](input._internal_.HTMLBodyElement.md#onoffline)
- [ononline](input._internal_.HTMLBodyElement.md#ononline)
- [onorientationchange](input._internal_.HTMLBodyElement.md#onorientationchange)
- [onpagehide](input._internal_.HTMLBodyElement.md#onpagehide)
- [onpageshow](input._internal_.HTMLBodyElement.md#onpageshow)
- [onpaste](input._internal_.HTMLBodyElement.md#onpaste)
- [onpause](input._internal_.HTMLBodyElement.md#onpause)
- [onplay](input._internal_.HTMLBodyElement.md#onplay)
- [onplaying](input._internal_.HTMLBodyElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLBodyElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLBodyElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLBodyElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLBodyElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLBodyElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLBodyElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLBodyElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLBodyElement.md#onpointerup)
- [onpopstate](input._internal_.HTMLBodyElement.md#onpopstate)
- [onprogress](input._internal_.HTMLBodyElement.md#onprogress)
- [onratechange](input._internal_.HTMLBodyElement.md#onratechange)
- [onrejectionhandled](input._internal_.HTMLBodyElement.md#onrejectionhandled)
- [onreset](input._internal_.HTMLBodyElement.md#onreset)
- [onresize](input._internal_.HTMLBodyElement.md#onresize)
- [onscroll](input._internal_.HTMLBodyElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLBodyElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLBodyElement.md#onseeked)
- [onseeking](input._internal_.HTMLBodyElement.md#onseeking)
- [onselect](input._internal_.HTMLBodyElement.md#onselect)
- [onselectionchange](input._internal_.HTMLBodyElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLBodyElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLBodyElement.md#onslotchange)
- [onstalled](input._internal_.HTMLBodyElement.md#onstalled)
- [onstorage](input._internal_.HTMLBodyElement.md#onstorage)
- [onsubmit](input._internal_.HTMLBodyElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLBodyElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLBodyElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLBodyElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLBodyElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLBodyElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLBodyElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLBodyElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLBodyElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLBodyElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLBodyElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLBodyElement.md#ontransitionstart)
- [onunhandledrejection](input._internal_.HTMLBodyElement.md#onunhandledrejection)
- [onunload](input._internal_.HTMLBodyElement.md#onunload)
- [onvolumechange](input._internal_.HTMLBodyElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLBodyElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLBodyElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLBodyElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLBodyElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLBodyElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLBodyElement.md#onwheel)
- [outerHTML](input._internal_.HTMLBodyElement.md#outerhtml)
- [outerText](input._internal_.HTMLBodyElement.md#outertext)
- [ownerDocument](input._internal_.HTMLBodyElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLBodyElement.md#parentelement)
- [parentNode](input._internal_.HTMLBodyElement.md#parentnode)
- [part](input._internal_.HTMLBodyElement.md#part)
- [prefix](input._internal_.HTMLBodyElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLBodyElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLBodyElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLBodyElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLBodyElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLBodyElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLBodyElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLBodyElement.md#shadowroot)
- [slot](input._internal_.HTMLBodyElement.md#slot)
- [spellcheck](input._internal_.HTMLBodyElement.md#spellcheck)
- [style](input._internal_.HTMLBodyElement.md#style)
- [tabIndex](input._internal_.HTMLBodyElement.md#tabindex)
- [tagName](input._internal_.HTMLBodyElement.md#tagname)
- [text](input._internal_.HTMLBodyElement.md#text)
- [textContent](input._internal_.HTMLBodyElement.md#textcontent)
- [title](input._internal_.HTMLBodyElement.md#title)
- [translate](input._internal_.HTMLBodyElement.md#translate)
- [vLink](input._internal_.HTMLBodyElement.md#vlink)

### Methods

- [addEventListener](input._internal_.HTMLBodyElement.md#addeventlistener)
- [after](input._internal_.HTMLBodyElement.md#after)
- [animate](input._internal_.HTMLBodyElement.md#animate)
- [append](input._internal_.HTMLBodyElement.md#append)
- [appendChild](input._internal_.HTMLBodyElement.md#appendchild)
- [attachInternals](input._internal_.HTMLBodyElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLBodyElement.md#attachshadow)
- [before](input._internal_.HTMLBodyElement.md#before)
- [blur](input._internal_.HTMLBodyElement.md#blur)
- [click](input._internal_.HTMLBodyElement.md#click)
- [cloneNode](input._internal_.HTMLBodyElement.md#clonenode)
- [closest](input._internal_.HTMLBodyElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLBodyElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLBodyElement.md#contains)
- [dispatchEvent](input._internal_.HTMLBodyElement.md#dispatchevent)
- [focus](input._internal_.HTMLBodyElement.md#focus)
- [getAnimations](input._internal_.HTMLBodyElement.md#getanimations)
- [getAttribute](input._internal_.HTMLBodyElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLBodyElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLBodyElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLBodyElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLBodyElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLBodyElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLBodyElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLBodyElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLBodyElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLBodyElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLBodyElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLBodyElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLBodyElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLBodyElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLBodyElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLBodyElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLBodyElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLBodyElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLBodyElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLBodyElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLBodyElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLBodyElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLBodyElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLBodyElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLBodyElement.md#lookupprefix)
- [matches](input._internal_.HTMLBodyElement.md#matches)
- [normalize](input._internal_.HTMLBodyElement.md#normalize)
- [prepend](input._internal_.HTMLBodyElement.md#prepend)
- [querySelector](input._internal_.HTMLBodyElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLBodyElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLBodyElement.md#releasepointercapture)
- [remove](input._internal_.HTMLBodyElement.md#remove)
- [removeAttribute](input._internal_.HTMLBodyElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLBodyElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLBodyElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLBodyElement.md#removechild)
- [removeEventListener](input._internal_.HTMLBodyElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLBodyElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLBodyElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLBodyElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLBodyElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLBodyElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLBodyElement.md#scroll)
- [scrollBy](input._internal_.HTMLBodyElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLBodyElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLBodyElement.md#scrollto)
- [setAttribute](input._internal_.HTMLBodyElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLBodyElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLBodyElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLBodyElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLBodyElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLBodyElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLBodyElement.md#webkitmatchesselector)
...
• **onorientationchange**: ``null`` \| (`this`: [`HTMLBodyElement`](../modules/input._internal_.md#htmlbodyelement), `ev`: [`Event`](../modules/input._internal_.md#event)) => `any`
...
| Name | Type |
| :------ | :------ |
| `K` | extends keyof [`HTMLBodyElementEventMap`](input._internal_.HTMLBodyElementEventMap.md) |
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLBodyElement`](../modules/input._internal_.md#htmlbodyelement), `ev`: [`HTMLBodyElementEventMap`](input._internal_.HTMLBodyElementEventMap.md)[`K`]) => `any` |
