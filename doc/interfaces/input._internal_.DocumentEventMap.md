[Droom Google Location Plugin - v1.0.13](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / DocumentEventMap

# Interface: DocumentEventMap

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).DocumentEventMap
...
- [DOMContentLoaded](input._internal_.DocumentEventMap.md#domcontentloaded)
- [abort](input._internal_.DocumentEventMap.md#abort)
- [animationcancel](input._internal_.DocumentEventMap.md#animationcancel)
- [animationend](input._internal_.DocumentEventMap.md#animationend)
- [animationiteration](input._internal_.DocumentEventMap.md#animationiteration)
- [animationstart](input._internal_.DocumentEventMap.md#animationstart)
- [auxclick](input._internal_.DocumentEventMap.md#auxclick)
- [beforeinput](input._internal_.DocumentEventMap.md#beforeinput)
- [blur](input._internal_.DocumentEventMap.md#blur)
- [canplay](input._internal_.DocumentEventMap.md#canplay)
- [canplaythrough](input._internal_.DocumentEventMap.md#canplaythrough)
- [change](input._internal_.DocumentEventMap.md#change)
- [click](input._internal_.DocumentEventMap.md#click)
- [close](input._internal_.DocumentEventMap.md#close)
- [compositionend](input._internal_.DocumentEventMap.md#compositionend)
- [compositionstart](input._internal_.DocumentEventMap.md#compositionstart)
- [compositionupdate](input._internal_.DocumentEventMap.md#compositionupdate)
- [contextmenu](input._internal_.DocumentEventMap.md#contextmenu)
- [copy](input._internal_.DocumentEventMap.md#copy)
- [cuechange](input._internal_.DocumentEventMap.md#cuechange)
- [cut](input._internal_.DocumentEventMap.md#cut)
- [dblclick](input._internal_.DocumentEventMap.md#dblclick)
- [drag](input._internal_.DocumentEventMap.md#drag)
- [dragend](input._internal_.DocumentEventMap.md#dragend)
- [dragenter](input._internal_.DocumentEventMap.md#dragenter)
- [dragleave](input._internal_.DocumentEventMap.md#dragleave)
- [dragover](input._internal_.DocumentEventMap.md#dragover)
- [dragstart](input._internal_.DocumentEventMap.md#dragstart)
- [drop](input._internal_.DocumentEventMap.md#drop)
- [durationchange](input._internal_.DocumentEventMap.md#durationchange)
- [emptied](input._internal_.DocumentEventMap.md#emptied)
- [ended](input._internal_.DocumentEventMap.md#ended)
- [error](input._internal_.DocumentEventMap.md#error)
- [focus](input._internal_.DocumentEventMap.md#focus)
- [focusin](input._internal_.DocumentEventMap.md#focusin)
- [focusout](input._internal_.DocumentEventMap.md#focusout)
- [formdata](input._internal_.DocumentEventMap.md#formdata)
- [fullscreenchange](input._internal_.DocumentEventMap.md#fullscreenchange)
- [fullscreenerror](input._internal_.DocumentEventMap.md#fullscreenerror)
- [gotpointercapture](input._internal_.DocumentEventMap.md#gotpointercapture)
- [input](input._internal_.DocumentEventMap.md#input)
- [invalid](input._internal_.DocumentEventMap.md#invalid)
- [keydown](input._internal_.DocumentEventMap.md#keydown)
- [keypress](input._internal_.DocumentEventMap.md#keypress)
- [keyup](input._internal_.DocumentEventMap.md#keyup)
- [load](input._internal_.DocumentEventMap.md#load)
- [loadeddata](input._internal_.DocumentEventMap.md#loadeddata)
- [loadedmetadata](input._internal_.DocumentEventMap.md#loadedmetadata)
- [loadstart](input._internal_.DocumentEventMap.md#loadstart)
- [lostpointercapture](input._internal_.DocumentEventMap.md#lostpointercapture)
- [mousedown](input._internal_.DocumentEventMap.md#mousedown)
- [mouseenter](input._internal_.DocumentEventMap.md#mouseenter)
- [mouseleave](input._internal_.DocumentEventMap.md#mouseleave)
- [mousemove](input._internal_.DocumentEventMap.md#mousemove)
- [mouseout](input._internal_.DocumentEventMap.md#mouseout)
- [mouseover](input._internal_.DocumentEventMap.md#mouseover)
- [mouseup](input._internal_.DocumentEventMap.md#mouseup)
- [paste](input._internal_.DocumentEventMap.md#paste)
- [pause](input._internal_.DocumentEventMap.md#pause)
- [play](input._internal_.DocumentEventMap.md#play)
- [playing](input._internal_.DocumentEventMap.md#playing)
- [pointercancel](input._internal_.DocumentEventMap.md#pointercancel)
- [pointerdown](input._internal_.DocumentEventMap.md#pointerdown)
- [pointerenter](input._internal_.DocumentEventMap.md#pointerenter)
- [pointerleave](input._internal_.DocumentEventMap.md#pointerleave)
- [pointerlockchange](input._internal_.DocumentEventMap.md#pointerlockchange)
- [pointerlockerror](input._internal_.DocumentEventMap.md#pointerlockerror)
- [pointermove](input._internal_.DocumentEventMap.md#pointermove)
- [pointerout](input._internal_.DocumentEventMap.md#pointerout)
- [pointerover](input._internal_.DocumentEventMap.md#pointerover)
- [pointerup](input._internal_.DocumentEventMap.md#pointerup)
- [progress](input._internal_.DocumentEventMap.md#progress)
- [ratechange](input._internal_.DocumentEventMap.md#ratechange)
- [readystatechange](input._internal_.DocumentEventMap.md#readystatechange)
- [reset](input._internal_.DocumentEventMap.md#reset)
- [resize](input._internal_.DocumentEventMap.md#resize)
- [scroll](input._internal_.DocumentEventMap.md#scroll)
- [securitypolicyviolation](input._internal_.DocumentEventMap.md#securitypolicyviolation)
- [seeked](input._internal_.DocumentEventMap.md#seeked)
- [seeking](input._internal_.DocumentEventMap.md#seeking)
- [select](input._internal_.DocumentEventMap.md#select)
- [selectionchange](input._internal_.DocumentEventMap.md#selectionchange)
- [selectstart](input._internal_.DocumentEventMap.md#selectstart)
- [slotchange](input._internal_.DocumentEventMap.md#slotchange)
- [stalled](input._internal_.DocumentEventMap.md#stalled)
- [submit](input._internal_.DocumentEventMap.md#submit)
- [suspend](input._internal_.DocumentEventMap.md#suspend)
- [timeupdate](input._internal_.DocumentEventMap.md#timeupdate)
- [toggle](input._internal_.DocumentEventMap.md#toggle)
- [touchcancel](input._internal_.DocumentEventMap.md#touchcancel)
- [touchend](input._internal_.DocumentEventMap.md#touchend)
- [touchmove](input._internal_.DocumentEventMap.md#touchmove)
- [touchstart](input._internal_.DocumentEventMap.md#touchstart)
- [transitioncancel](input._internal_.DocumentEventMap.md#transitioncancel)
- [transitionend](input._internal_.DocumentEventMap.md#transitionend)
- [transitionrun](input._internal_.DocumentEventMap.md#transitionrun)
- [transitionstart](input._internal_.DocumentEventMap.md#transitionstart)
- [visibilitychange](input._internal_.DocumentEventMap.md#visibilitychange)
- [volumechange](input._internal_.DocumentEventMap.md#volumechange)
- [waiting](input._internal_.DocumentEventMap.md#waiting)
- [webkitanimationend](input._internal_.DocumentEventMap.md#webkitanimationend)
- [webkitanimationiteration](input._internal_.DocumentEventMap.md#webkitanimationiteration)
- [webkitanimationstart](input._internal_.DocumentEventMap.md#webkitanimationstart)
- [webkittransitionend](input._internal_.DocumentEventMap.md#webkittransitionend)
- [wheel](input._internal_.DocumentEventMap.md#wheel)
...
[GlobalEventHandlersEventMap](input._internal_.GlobalEventHandlersEventMap.md).[dragstart](input._internal_.GlobalEventHandlersEventMap.md#dragstart)
...
• **pointerlockchange**: [`Event`](../modules/input._internal_.md#event)
...
• **pointerlockerror**: [`Event`](../modules/input._internal_.md#event)
...
[GlobalEventHandlersEventMap](input._internal_.GlobalEventHandlersEventMap.md).[pointermove](input._internal_.GlobalEventHandlersEventMap.md#pointermove)
...
• **readystatechange**: [`Event`](../modules/input._internal_.md#event)
...
• **visibilitychange**: [`Event`](../modules/input._internal_.md#event)
