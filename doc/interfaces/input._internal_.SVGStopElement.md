[Droom Google Location Plugin - v1.0.13](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGStopElement

# Interface: SVGStopElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGStopElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGStopElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGStopElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGStopElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGStopElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGStopElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGStopElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGStopElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGStopElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGStopElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGStopElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGStopElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGStopElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGStopElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGStopElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGStopElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGStopElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGStopElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGStopElement.md#text_node)
- [ariaAtomic](input._internal_.SVGStopElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGStopElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGStopElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGStopElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGStopElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGStopElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGStopElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGStopElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGStopElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGStopElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGStopElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGStopElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGStopElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGStopElement.md#arialabel)
- [ariaLevel](input._internal_.SVGStopElement.md#arialevel)
- [ariaLive](input._internal_.SVGStopElement.md#arialive)
- [ariaModal](input._internal_.SVGStopElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGStopElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGStopElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGStopElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGStopElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGStopElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGStopElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGStopElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGStopElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGStopElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGStopElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGStopElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGStopElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGStopElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGStopElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGStopElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGStopElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGStopElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGStopElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGStopElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGStopElement.md#assignedslot)
- [attributes](input._internal_.SVGStopElement.md#attributes)
- [autofocus](input._internal_.SVGStopElement.md#autofocus)
- [baseURI](input._internal_.SVGStopElement.md#baseuri)
- [childElementCount](input._internal_.SVGStopElement.md#childelementcount)
- [childNodes](input._internal_.SVGStopElement.md#childnodes)
- [children](input._internal_.SVGStopElement.md#children)
- [classList](input._internal_.SVGStopElement.md#classlist)
- [className](input._internal_.SVGStopElement.md#classname)
- [clientHeight](input._internal_.SVGStopElement.md#clientheight)
- [clientLeft](input._internal_.SVGStopElement.md#clientleft)
- [clientTop](input._internal_.SVGStopElement.md#clienttop)
- [clientWidth](input._internal_.SVGStopElement.md#clientwidth)
- [dataset](input._internal_.SVGStopElement.md#dataset)
- [firstChild](input._internal_.SVGStopElement.md#firstchild)
- [firstElementChild](input._internal_.SVGStopElement.md#firstelementchild)
- [id](input._internal_.SVGStopElement.md#id)
- [innerHTML](input._internal_.SVGStopElement.md#innerhtml)
- [isConnected](input._internal_.SVGStopElement.md#isconnected)
- [lastChild](input._internal_.SVGStopElement.md#lastchild)
- [lastElementChild](input._internal_.SVGStopElement.md#lastelementchild)
- [localName](input._internal_.SVGStopElement.md#localname)
- [namespaceURI](input._internal_.SVGStopElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGStopElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGStopElement.md#nextsibling)
- [nodeName](input._internal_.SVGStopElement.md#nodename)
- [nodeType](input._internal_.SVGStopElement.md#nodetype)
- [nodeValue](input._internal_.SVGStopElement.md#nodevalue)
- [nonce](input._internal_.SVGStopElement.md#nonce)
- [offset](input._internal_.SVGStopElement.md#offset)
- [onabort](input._internal_.SVGStopElement.md#onabort)
- [onanimationcancel](input._internal_.SVGStopElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGStopElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGStopElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGStopElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGStopElement.md#onauxclick)
- [onblur](input._internal_.SVGStopElement.md#onblur)
- [oncanplay](input._internal_.SVGStopElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGStopElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGStopElement.md#onchange)
- [onclick](input._internal_.SVGStopElement.md#onclick)
- [onclose](input._internal_.SVGStopElement.md#onclose)
- [oncontextmenu](input._internal_.SVGStopElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGStopElement.md#oncopy)
- [oncuechange](input._internal_.SVGStopElement.md#oncuechange)
- [oncut](input._internal_.SVGStopElement.md#oncut)
- [ondblclick](input._internal_.SVGStopElement.md#ondblclick)
- [ondrag](input._internal_.SVGStopElement.md#ondrag)
- [ondragend](input._internal_.SVGStopElement.md#ondragend)
- [ondragenter](input._internal_.SVGStopElement.md#ondragenter)
- [ondragleave](input._internal_.SVGStopElement.md#ondragleave)
- [ondragover](input._internal_.SVGStopElement.md#ondragover)
- [ondragstart](input._internal_.SVGStopElement.md#ondragstart)
- [ondrop](input._internal_.SVGStopElement.md#ondrop)
- [ondurationchange](input._internal_.SVGStopElement.md#ondurationchange)
- [onemptied](input._internal_.SVGStopElement.md#onemptied)
- [onended](input._internal_.SVGStopElement.md#onended)
- [onerror](input._internal_.SVGStopElement.md#onerror)
- [onfocus](input._internal_.SVGStopElement.md#onfocus)
- [onformdata](input._internal_.SVGStopElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGStopElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGStopElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGStopElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGStopElement.md#oninput)
- [oninvalid](input._internal_.SVGStopElement.md#oninvalid)
- [onkeydown](input._internal_.SVGStopElement.md#onkeydown)
- [onkeypress](input._internal_.SVGStopElement.md#onkeypress)
- [onkeyup](input._internal_.SVGStopElement.md#onkeyup)
- [onload](input._internal_.SVGStopElement.md#onload)
- [onloadeddata](input._internal_.SVGStopElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGStopElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGStopElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGStopElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGStopElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGStopElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGStopElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGStopElement.md#onmousemove)
- [onmouseout](input._internal_.SVGStopElement.md#onmouseout)
- [onmouseover](input._internal_.SVGStopElement.md#onmouseover)
- [onmouseup](input._internal_.SVGStopElement.md#onmouseup)
- [onpaste](input._internal_.SVGStopElement.md#onpaste)
- [onpause](input._internal_.SVGStopElement.md#onpause)
- [onplay](input._internal_.SVGStopElement.md#onplay)
- [onplaying](input._internal_.SVGStopElement.md#onplaying)
- [onpointercancel](input._internal_.SVGStopElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGStopElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGStopElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGStopElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGStopElement.md#onpointermove)
- [onpointerout](input._internal_.SVGStopElement.md#onpointerout)
- [onpointerover](input._internal_.SVGStopElement.md#onpointerover)
- [onpointerup](input._internal_.SVGStopElement.md#onpointerup)
- [onprogress](input._internal_.SVGStopElement.md#onprogress)
- [onratechange](input._internal_.SVGStopElement.md#onratechange)
- [onreset](input._internal_.SVGStopElement.md#onreset)
- [onresize](input._internal_.SVGStopElement.md#onresize)
- [onscroll](input._internal_.SVGStopElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGStopElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGStopElement.md#onseeked)
- [onseeking](input._internal_.SVGStopElement.md#onseeking)
- [onselect](input._internal_.SVGStopElement.md#onselect)
- [onselectionchange](input._internal_.SVGStopElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGStopElement.md#onselectstart)
- [onslotchange](input._internal_.SVGStopElement.md#onslotchange)
- [onstalled](input._internal_.SVGStopElement.md#onstalled)
- [onsubmit](input._internal_.SVGStopElement.md#onsubmit)
- [onsuspend](input._internal_.SVGStopElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGStopElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGStopElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGStopElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGStopElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGStopElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGStopElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGStopElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGStopElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGStopElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGStopElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGStopElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGStopElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGStopElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGStopElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGStopElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGStopElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGStopElement.md#onwheel)
- [outerHTML](input._internal_.SVGStopElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGStopElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGStopElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGStopElement.md#parentelement)
- [parentNode](input._internal_.SVGStopElement.md#parentnode)
- [part](input._internal_.SVGStopElement.md#part)
- [prefix](input._internal_.SVGStopElement.md#prefix)
- [previousElementSibling](input._internal_.SVGStopElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGStopElement.md#previoussibling)
- [scrollHeight](input._internal_.SVGStopElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGStopElement.md#scrollleft)
- [scrollTop](input._internal_.SVGStopElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGStopElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGStopElement.md#shadowroot)
- [slot](input._internal_.SVGStopElement.md#slot)
- [style](input._internal_.SVGStopElement.md#style)
- [tabIndex](input._internal_.SVGStopElement.md#tabindex)
- [tagName](input._internal_.SVGStopElement.md#tagname)
- [textContent](input._internal_.SVGStopElement.md#textcontent)
- [viewportElement](input._internal_.SVGStopElement.md#viewportelement)

### Methods

- [addEventListener](input._internal_.SVGStopElement.md#addeventlistener)
- [after](input._internal_.SVGStopElement.md#after)
- [animate](input._internal_.SVGStopElement.md#animate)
- [append](input._internal_.SVGStopElement.md#append)
- [appendChild](input._internal_.SVGStopElement.md#appendchild)
- [attachShadow](input._internal_.SVGStopElement.md#attachshadow)
- [before](input._internal_.SVGStopElement.md#before)
- [blur](input._internal_.SVGStopElement.md#blur)
- [cloneNode](input._internal_.SVGStopElement.md#clonenode)
- [closest](input._internal_.SVGStopElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGStopElement.md#comparedocumentposition)
- [contains](input._internal_.SVGStopElement.md#contains)
- [dispatchEvent](input._internal_.SVGStopElement.md#dispatchevent)
- [focus](input._internal_.SVGStopElement.md#focus)
- [getAnimations](input._internal_.SVGStopElement.md#getanimations)
- [getAttribute](input._internal_.SVGStopElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGStopElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGStopElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGStopElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGStopElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.SVGStopElement.md#getboundingclientrect)
- [getClientRects](input._internal_.SVGStopElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGStopElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGStopElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGStopElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGStopElement.md#getrootnode)
- [hasAttribute](input._internal_.SVGStopElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGStopElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGStopElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGStopElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGStopElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGStopElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGStopElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGStopElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGStopElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGStopElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGStopElement.md#isequalnode)
- [isSameNode](input._internal_.SVGStopElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGStopElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGStopElement.md#lookupprefix)
- [matches](input._internal_.SVGStopElement.md#matches)
- [normalize](input._internal_.SVGStopElement.md#normalize)
- [prepend](input._internal_.SVGStopElement.md#prepend)
- [querySelector](input._internal_.SVGStopElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGStopElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGStopElement.md#releasepointercapture)
- [remove](input._internal_.SVGStopElement.md#remove)
- [removeAttribute](input._internal_.SVGStopElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGStopElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGStopElement.md#removeattributenode)
- [removeChild](input._internal_.SVGStopElement.md#removechild)
- [removeEventListener](input._internal_.SVGStopElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGStopElement.md#replacechild)
- [replaceChildren](input._internal_.SVGStopElement.md#replacechildren)
- [replaceWith](input._internal_.SVGStopElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGStopElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGStopElement.md#requestpointerlock)
- [scroll](input._internal_.SVGStopElement.md#scroll)
- [scrollBy](input._internal_.SVGStopElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGStopElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGStopElement.md#scrollto)
- [setAttribute](input._internal_.SVGStopElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGStopElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGStopElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGStopElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGStopElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGStopElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGStopElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGStopElement`](../modules/input._internal_.md#svgstopelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
