[Droom Google Location Plugin - v1.0.13](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGFEMorphologyElement

# Interface: SVGFEMorphologyElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGFEMorphologyElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGFEMorphologyElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGFEMorphologyElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGFEMorphologyElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGFEMorphologyElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGFEMorphologyElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGFEMorphologyElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGFEMorphologyElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGFEMorphologyElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGFEMorphologyElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGFEMorphologyElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGFEMorphologyElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGFEMorphologyElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGFEMorphologyElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGFEMorphologyElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGFEMorphologyElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGFEMorphologyElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGFEMorphologyElement.md#processing_instruction_node)
- [SVG\_MORPHOLOGY\_OPERATOR\_DILATE](input._internal_.SVGFEMorphologyElement.md#svg_morphology_operator_dilate)
- [SVG\_MORPHOLOGY\_OPERATOR\_ERODE](input._internal_.SVGFEMorphologyElement.md#svg_morphology_operator_erode)
- [SVG\_MORPHOLOGY\_OPERATOR\_UNKNOWN](input._internal_.SVGFEMorphologyElement.md#svg_morphology_operator_unknown)
- [TEXT\_NODE](input._internal_.SVGFEMorphologyElement.md#text_node)
- [ariaAtomic](input._internal_.SVGFEMorphologyElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGFEMorphologyElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGFEMorphologyElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGFEMorphologyElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGFEMorphologyElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGFEMorphologyElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGFEMorphologyElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGFEMorphologyElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGFEMorphologyElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGFEMorphologyElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGFEMorphologyElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGFEMorphologyElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGFEMorphologyElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGFEMorphologyElement.md#arialabel)
- [ariaLevel](input._internal_.SVGFEMorphologyElement.md#arialevel)
- [ariaLive](input._internal_.SVGFEMorphologyElement.md#arialive)
- [ariaModal](input._internal_.SVGFEMorphologyElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGFEMorphologyElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGFEMorphologyElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGFEMorphologyElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGFEMorphologyElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGFEMorphologyElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGFEMorphologyElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGFEMorphologyElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGFEMorphologyElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGFEMorphologyElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGFEMorphologyElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGFEMorphologyElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGFEMorphologyElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGFEMorphologyElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGFEMorphologyElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGFEMorphologyElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGFEMorphologyElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGFEMorphologyElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGFEMorphologyElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGFEMorphologyElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGFEMorphologyElement.md#assignedslot)
- [attributes](input._internal_.SVGFEMorphologyElement.md#attributes)
- [autofocus](input._internal_.SVGFEMorphologyElement.md#autofocus)
- [baseURI](input._internal_.SVGFEMorphologyElement.md#baseuri)
- [childElementCount](input._internal_.SVGFEMorphologyElement.md#childelementcount)
- [childNodes](input._internal_.SVGFEMorphologyElement.md#childnodes)
- [children](input._internal_.SVGFEMorphologyElement.md#children)
- [classList](input._internal_.SVGFEMorphologyElement.md#classlist)
- [className](input._internal_.SVGFEMorphologyElement.md#classname)
- [clientHeight](input._internal_.SVGFEMorphologyElement.md#clientheight)
- [clientLeft](input._internal_.SVGFEMorphologyElement.md#clientleft)
- [clientTop](input._internal_.SVGFEMorphologyElement.md#clienttop)
- [clientWidth](input._internal_.SVGFEMorphologyElement.md#clientwidth)
- [dataset](input._internal_.SVGFEMorphologyElement.md#dataset)
- [firstChild](input._internal_.SVGFEMorphologyElement.md#firstchild)
- [firstElementChild](input._internal_.SVGFEMorphologyElement.md#firstelementchild)
- [height](input._internal_.SVGFEMorphologyElement.md#height)
- [id](input._internal_.SVGFEMorphologyElement.md#id)
- [in1](input._internal_.SVGFEMorphologyElement.md#in1)
- [innerHTML](input._internal_.SVGFEMorphologyElement.md#innerhtml)
- [isConnected](input._internal_.SVGFEMorphologyElement.md#isconnected)
- [lastChild](input._internal_.SVGFEMorphologyElement.md#lastchild)
- [lastElementChild](input._internal_.SVGFEMorphologyElement.md#lastelementchild)
- [localName](input._internal_.SVGFEMorphologyElement.md#localname)
- [namespaceURI](input._internal_.SVGFEMorphologyElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGFEMorphologyElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGFEMorphologyElement.md#nextsibling)
- [nodeName](input._internal_.SVGFEMorphologyElement.md#nodename)
- [nodeType](input._internal_.SVGFEMorphologyElement.md#nodetype)
- [nodeValue](input._internal_.SVGFEMorphologyElement.md#nodevalue)
- [nonce](input._internal_.SVGFEMorphologyElement.md#nonce)
- [onabort](input._internal_.SVGFEMorphologyElement.md#onabort)
- [onanimationcancel](input._internal_.SVGFEMorphologyElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGFEMorphologyElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGFEMorphologyElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGFEMorphologyElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGFEMorphologyElement.md#onauxclick)
- [onblur](input._internal_.SVGFEMorphologyElement.md#onblur)
- [oncanplay](input._internal_.SVGFEMorphologyElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGFEMorphologyElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGFEMorphologyElement.md#onchange)
- [onclick](input._internal_.SVGFEMorphologyElement.md#onclick)
- [onclose](input._internal_.SVGFEMorphologyElement.md#onclose)
- [oncontextmenu](input._internal_.SVGFEMorphologyElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGFEMorphologyElement.md#oncopy)
- [oncuechange](input._internal_.SVGFEMorphologyElement.md#oncuechange)
- [oncut](input._internal_.SVGFEMorphologyElement.md#oncut)
- [ondblclick](input._internal_.SVGFEMorphologyElement.md#ondblclick)
- [ondrag](input._internal_.SVGFEMorphologyElement.md#ondrag)
- [ondragend](input._internal_.SVGFEMorphologyElement.md#ondragend)
- [ondragenter](input._internal_.SVGFEMorphologyElement.md#ondragenter)
- [ondragleave](input._internal_.SVGFEMorphologyElement.md#ondragleave)
- [ondragover](input._internal_.SVGFEMorphologyElement.md#ondragover)
- [ondragstart](input._internal_.SVGFEMorphologyElement.md#ondragstart)
- [ondrop](input._internal_.SVGFEMorphologyElement.md#ondrop)
- [ondurationchange](input._internal_.SVGFEMorphologyElement.md#ondurationchange)
- [onemptied](input._internal_.SVGFEMorphologyElement.md#onemptied)
- [onended](input._internal_.SVGFEMorphologyElement.md#onended)
- [onerror](input._internal_.SVGFEMorphologyElement.md#onerror)
- [onfocus](input._internal_.SVGFEMorphologyElement.md#onfocus)
- [onformdata](input._internal_.SVGFEMorphologyElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGFEMorphologyElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGFEMorphologyElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGFEMorphologyElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGFEMorphologyElement.md#oninput)
- [oninvalid](input._internal_.SVGFEMorphologyElement.md#oninvalid)
- [onkeydown](input._internal_.SVGFEMorphologyElement.md#onkeydown)
- [onkeypress](input._internal_.SVGFEMorphologyElement.md#onkeypress)
- [onkeyup](input._internal_.SVGFEMorphologyElement.md#onkeyup)
- [onload](input._internal_.SVGFEMorphologyElement.md#onload)
- [onloadeddata](input._internal_.SVGFEMorphologyElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGFEMorphologyElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGFEMorphologyElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGFEMorphologyElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGFEMorphologyElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGFEMorphologyElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGFEMorphologyElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGFEMorphologyElement.md#onmousemove)
- [onmouseout](input._internal_.SVGFEMorphologyElement.md#onmouseout)
- [onmouseover](input._internal_.SVGFEMorphologyElement.md#onmouseover)
- [onmouseup](input._internal_.SVGFEMorphologyElement.md#onmouseup)
- [onpaste](input._internal_.SVGFEMorphologyElement.md#onpaste)
- [onpause](input._internal_.SVGFEMorphologyElement.md#onpause)
- [onplay](input._internal_.SVGFEMorphologyElement.md#onplay)
- [onplaying](input._internal_.SVGFEMorphologyElement.md#onplaying)
- [onpointercancel](input._internal_.SVGFEMorphologyElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGFEMorphologyElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGFEMorphologyElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGFEMorphologyElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGFEMorphologyElement.md#onpointermove)
- [onpointerout](input._internal_.SVGFEMorphologyElement.md#onpointerout)
- [onpointerover](input._internal_.SVGFEMorphologyElement.md#onpointerover)
- [onpointerup](input._internal_.SVGFEMorphologyElement.md#onpointerup)
- [onprogress](input._internal_.SVGFEMorphologyElement.md#onprogress)
- [onratechange](input._internal_.SVGFEMorphologyElement.md#onratechange)
- [onreset](input._internal_.SVGFEMorphologyElement.md#onreset)
- [onresize](input._internal_.SVGFEMorphologyElement.md#onresize)
- [onscroll](input._internal_.SVGFEMorphologyElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGFEMorphologyElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGFEMorphologyElement.md#onseeked)
- [onseeking](input._internal_.SVGFEMorphologyElement.md#onseeking)
- [onselect](input._internal_.SVGFEMorphologyElement.md#onselect)
- [onselectionchange](input._internal_.SVGFEMorphologyElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGFEMorphologyElement.md#onselectstart)
- [onslotchange](input._internal_.SVGFEMorphologyElement.md#onslotchange)
- [onstalled](input._internal_.SVGFEMorphologyElement.md#onstalled)
- [onsubmit](input._internal_.SVGFEMorphologyElement.md#onsubmit)
- [onsuspend](input._internal_.SVGFEMorphologyElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGFEMorphologyElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGFEMorphologyElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGFEMorphologyElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGFEMorphologyElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGFEMorphologyElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGFEMorphologyElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGFEMorphologyElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGFEMorphologyElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGFEMorphologyElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGFEMorphologyElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGFEMorphologyElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGFEMorphologyElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGFEMorphologyElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGFEMorphologyElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGFEMorphologyElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGFEMorphologyElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGFEMorphologyElement.md#onwheel)
- [operator](input._internal_.SVGFEMorphologyElement.md#operator)
- [outerHTML](input._internal_.SVGFEMorphologyElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGFEMorphologyElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGFEMorphologyElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGFEMorphologyElement.md#parentelement)
- [parentNode](input._internal_.SVGFEMorphologyElement.md#parentnode)
- [part](input._internal_.SVGFEMorphologyElement.md#part)
- [prefix](input._internal_.SVGFEMorphologyElement.md#prefix)
- [previousElementSibling](input._internal_.SVGFEMorphologyElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGFEMorphologyElement.md#previoussibling)
- [radiusX](input._internal_.SVGFEMorphologyElement.md#radiusx)
- [radiusY](input._internal_.SVGFEMorphologyElement.md#radiusy)
- [result](input._internal_.SVGFEMorphologyElement.md#result)
- [scrollHeight](input._internal_.SVGFEMorphologyElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGFEMorphologyElement.md#scrollleft)
- [scrollTop](input._internal_.SVGFEMorphologyElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGFEMorphologyElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGFEMorphologyElement.md#shadowroot)
- [slot](input._internal_.SVGFEMorphologyElement.md#slot)
- [style](input._internal_.SVGFEMorphologyElement.md#style)
- [tabIndex](input._internal_.SVGFEMorphologyElement.md#tabindex)
- [tagName](input._internal_.SVGFEMorphologyElement.md#tagname)
- [textContent](input._internal_.SVGFEMorphologyElement.md#textcontent)
- [viewportElement](input._internal_.SVGFEMorphologyElement.md#viewportelement)
- [width](input._internal_.SVGFEMorphologyElement.md#width)
- [x](input._internal_.SVGFEMorphologyElement.md#x)
- [y](input._internal_.SVGFEMorphologyElement.md#y)

### Methods

- [addEventListener](input._internal_.SVGFEMorphologyElement.md#addeventlistener)
- [after](input._internal_.SVGFEMorphologyElement.md#after)
- [animate](input._internal_.SVGFEMorphologyElement.md#animate)
- [append](input._internal_.SVGFEMorphologyElement.md#append)
- [appendChild](input._internal_.SVGFEMorphologyElement.md#appendchild)
- [attachShadow](input._internal_.SVGFEMorphologyElement.md#attachshadow)
- [before](input._internal_.SVGFEMorphologyElement.md#before)
- [blur](input._internal_.SVGFEMorphologyElement.md#blur)
- [cloneNode](input._internal_.SVGFEMorphologyElement.md#clonenode)
- [closest](input._internal_.SVGFEMorphologyElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGFEMorphologyElement.md#comparedocumentposition)
- [contains](input._internal_.SVGFEMorphologyElement.md#contains)
- [dispatchEvent](input._internal_.SVGFEMorphologyElement.md#dispatchevent)
- [focus](input._internal_.SVGFEMorphologyElement.md#focus)
- [getAnimations](input._internal_.SVGFEMorphologyElement.md#getanimations)
- [getAttribute](input._internal_.SVGFEMorphologyElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGFEMorphologyElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGFEMorphologyElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGFEMorphologyElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGFEMorphologyElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.SVGFEMorphologyElement.md#getboundingclientrect)
- [getClientRects](input._internal_.SVGFEMorphologyElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGFEMorphologyElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGFEMorphologyElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGFEMorphologyElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGFEMorphologyElement.md#getrootnode)
- [hasAttribute](input._internal_.SVGFEMorphologyElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGFEMorphologyElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGFEMorphologyElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGFEMorphologyElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGFEMorphologyElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGFEMorphologyElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGFEMorphologyElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGFEMorphologyElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGFEMorphologyElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGFEMorphologyElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGFEMorphologyElement.md#isequalnode)
- [isSameNode](input._internal_.SVGFEMorphologyElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGFEMorphologyElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGFEMorphologyElement.md#lookupprefix)
- [matches](input._internal_.SVGFEMorphologyElement.md#matches)
- [normalize](input._internal_.SVGFEMorphologyElement.md#normalize)
- [prepend](input._internal_.SVGFEMorphologyElement.md#prepend)
- [querySelector](input._internal_.SVGFEMorphologyElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGFEMorphologyElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGFEMorphologyElement.md#releasepointercapture)
- [remove](input._internal_.SVGFEMorphologyElement.md#remove)
- [removeAttribute](input._internal_.SVGFEMorphologyElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGFEMorphologyElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGFEMorphologyElement.md#removeattributenode)
- [removeChild](input._internal_.SVGFEMorphologyElement.md#removechild)
- [removeEventListener](input._internal_.SVGFEMorphologyElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGFEMorphologyElement.md#replacechild)
- [replaceChildren](input._internal_.SVGFEMorphologyElement.md#replacechildren)
- [replaceWith](input._internal_.SVGFEMorphologyElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGFEMorphologyElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGFEMorphologyElement.md#requestpointerlock)
- [scroll](input._internal_.SVGFEMorphologyElement.md#scroll)
- [scrollBy](input._internal_.SVGFEMorphologyElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGFEMorphologyElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGFEMorphologyElement.md#scrollto)
- [setAttribute](input._internal_.SVGFEMorphologyElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGFEMorphologyElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGFEMorphologyElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGFEMorphologyElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGFEMorphologyElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGFEMorphologyElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGFEMorphologyElement.md#webkitmatchesselector)
...
• `Readonly` **radiusX**: [`SVGAnimatedNumber`](../modules/input._internal_.md#svganimatednumber)
...
• `Readonly` **radiusY**: [`SVGAnimatedNumber`](../modules/input._internal_.md#svganimatednumber)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGFEMorphologyElement`](../modules/input._internal_.md#svgfemorphologyelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
