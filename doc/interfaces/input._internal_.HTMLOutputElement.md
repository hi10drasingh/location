[Droom Google Location Plugin - v1.0.11](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLOutputElement

# Interface: HTMLOutputElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLOutputElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLOutputElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLOutputElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLOutputElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLOutputElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLOutputElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLOutputElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLOutputElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLOutputElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLOutputElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLOutputElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLOutputElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLOutputElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLOutputElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLOutputElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLOutputElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLOutputElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLOutputElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLOutputElement.md#text_node)
- [accessKey](input._internal_.HTMLOutputElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLOutputElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLOutputElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLOutputElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLOutputElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLOutputElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLOutputElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLOutputElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLOutputElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLOutputElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLOutputElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLOutputElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLOutputElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLOutputElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLOutputElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLOutputElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLOutputElement.md#arialevel)
- [ariaLive](input._internal_.HTMLOutputElement.md#arialive)
- [ariaModal](input._internal_.HTMLOutputElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLOutputElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLOutputElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLOutputElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLOutputElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLOutputElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLOutputElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLOutputElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLOutputElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLOutputElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLOutputElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLOutputElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLOutputElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLOutputElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLOutputElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLOutputElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLOutputElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLOutputElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLOutputElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLOutputElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLOutputElement.md#assignedslot)
- [attributes](input._internal_.HTMLOutputElement.md#attributes)
- [autocapitalize](input._internal_.HTMLOutputElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLOutputElement.md#autofocus)
- [baseURI](input._internal_.HTMLOutputElement.md#baseuri)
- [childElementCount](input._internal_.HTMLOutputElement.md#childelementcount)
- [childNodes](input._internal_.HTMLOutputElement.md#childnodes)
- [children](input._internal_.HTMLOutputElement.md#children)
- [classList](input._internal_.HTMLOutputElement.md#classlist)
- [className](input._internal_.HTMLOutputElement.md#classname)
- [clientHeight](input._internal_.HTMLOutputElement.md#clientheight)
- [clientLeft](input._internal_.HTMLOutputElement.md#clientleft)
- [clientTop](input._internal_.HTMLOutputElement.md#clienttop)
- [clientWidth](input._internal_.HTMLOutputElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLOutputElement.md#contenteditable)
- [dataset](input._internal_.HTMLOutputElement.md#dataset)
- [defaultValue](input._internal_.HTMLOutputElement.md#defaultvalue)
- [dir](input._internal_.HTMLOutputElement.md#dir)
- [draggable](input._internal_.HTMLOutputElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLOutputElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLOutputElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLOutputElement.md#firstelementchild)
- [form](input._internal_.HTMLOutputElement.md#form)
- [hidden](input._internal_.HTMLOutputElement.md#hidden)
- [htmlFor](input._internal_.HTMLOutputElement.md#htmlfor)
- [id](input._internal_.HTMLOutputElement.md#id)
- [innerHTML](input._internal_.HTMLOutputElement.md#innerhtml)
- [innerText](input._internal_.HTMLOutputElement.md#innertext)
- [inputMode](input._internal_.HTMLOutputElement.md#inputmode)
- [isConnected](input._internal_.HTMLOutputElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLOutputElement.md#iscontenteditable)
- [labels](input._internal_.HTMLOutputElement.md#labels)
- [lang](input._internal_.HTMLOutputElement.md#lang)
- [lastChild](input._internal_.HTMLOutputElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLOutputElement.md#lastelementchild)
- [localName](input._internal_.HTMLOutputElement.md#localname)
- [name](input._internal_.HTMLOutputElement.md#name)
- [namespaceURI](input._internal_.HTMLOutputElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLOutputElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLOutputElement.md#nextsibling)
- [nodeName](input._internal_.HTMLOutputElement.md#nodename)
- [nodeType](input._internal_.HTMLOutputElement.md#nodetype)
- [nodeValue](input._internal_.HTMLOutputElement.md#nodevalue)
- [nonce](input._internal_.HTMLOutputElement.md#nonce)
- [offsetHeight](input._internal_.HTMLOutputElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLOutputElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLOutputElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLOutputElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLOutputElement.md#offsetwidth)
- [onabort](input._internal_.HTMLOutputElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLOutputElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLOutputElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLOutputElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLOutputElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLOutputElement.md#onauxclick)
- [onblur](input._internal_.HTMLOutputElement.md#onblur)
- [oncanplay](input._internal_.HTMLOutputElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLOutputElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLOutputElement.md#onchange)
- [onclick](input._internal_.HTMLOutputElement.md#onclick)
- [onclose](input._internal_.HTMLOutputElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLOutputElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLOutputElement.md#oncopy)
- [oncuechange](input._internal_.HTMLOutputElement.md#oncuechange)
- [oncut](input._internal_.HTMLOutputElement.md#oncut)
- [ondblclick](input._internal_.HTMLOutputElement.md#ondblclick)
- [ondrag](input._internal_.HTMLOutputElement.md#ondrag)
- [ondragend](input._internal_.HTMLOutputElement.md#ondragend)
- [ondragenter](input._internal_.HTMLOutputElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLOutputElement.md#ondragleave)
- [ondragover](input._internal_.HTMLOutputElement.md#ondragover)
- [ondragstart](input._internal_.HTMLOutputElement.md#ondragstart)
- [ondrop](input._internal_.HTMLOutputElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLOutputElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLOutputElement.md#onemptied)
- [onended](input._internal_.HTMLOutputElement.md#onended)
- [onerror](input._internal_.HTMLOutputElement.md#onerror)
- [onfocus](input._internal_.HTMLOutputElement.md#onfocus)
- [onformdata](input._internal_.HTMLOutputElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLOutputElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLOutputElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLOutputElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLOutputElement.md#oninput)
- [oninvalid](input._internal_.HTMLOutputElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLOutputElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLOutputElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLOutputElement.md#onkeyup)
- [onload](input._internal_.HTMLOutputElement.md#onload)
- [onloadeddata](input._internal_.HTMLOutputElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLOutputElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLOutputElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLOutputElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLOutputElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLOutputElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLOutputElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLOutputElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLOutputElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLOutputElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLOutputElement.md#onmouseup)
- [onpaste](input._internal_.HTMLOutputElement.md#onpaste)
- [onpause](input._internal_.HTMLOutputElement.md#onpause)
- [onplay](input._internal_.HTMLOutputElement.md#onplay)
- [onplaying](input._internal_.HTMLOutputElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLOutputElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLOutputElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLOutputElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLOutputElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLOutputElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLOutputElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLOutputElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLOutputElement.md#onpointerup)
- [onprogress](input._internal_.HTMLOutputElement.md#onprogress)
- [onratechange](input._internal_.HTMLOutputElement.md#onratechange)
- [onreset](input._internal_.HTMLOutputElement.md#onreset)
- [onresize](input._internal_.HTMLOutputElement.md#onresize)
- [onscroll](input._internal_.HTMLOutputElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLOutputElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLOutputElement.md#onseeked)
- [onseeking](input._internal_.HTMLOutputElement.md#onseeking)
- [onselect](input._internal_.HTMLOutputElement.md#onselect)
- [onselectionchange](input._internal_.HTMLOutputElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLOutputElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLOutputElement.md#onslotchange)
- [onstalled](input._internal_.HTMLOutputElement.md#onstalled)
- [onsubmit](input._internal_.HTMLOutputElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLOutputElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLOutputElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLOutputElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLOutputElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLOutputElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLOutputElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLOutputElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLOutputElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLOutputElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLOutputElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLOutputElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLOutputElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLOutputElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLOutputElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLOutputElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLOutputElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLOutputElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLOutputElement.md#onwheel)
- [outerHTML](input._internal_.HTMLOutputElement.md#outerhtml)
- [outerText](input._internal_.HTMLOutputElement.md#outertext)
- [ownerDocument](input._internal_.HTMLOutputElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLOutputElement.md#parentelement)
- [parentNode](input._internal_.HTMLOutputElement.md#parentnode)
- [part](input._internal_.HTMLOutputElement.md#part)
- [prefix](input._internal_.HTMLOutputElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLOutputElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLOutputElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLOutputElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLOutputElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLOutputElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLOutputElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLOutputElement.md#shadowroot)
- [slot](input._internal_.HTMLOutputElement.md#slot)
- [spellcheck](input._internal_.HTMLOutputElement.md#spellcheck)
- [style](input._internal_.HTMLOutputElement.md#style)
- [tabIndex](input._internal_.HTMLOutputElement.md#tabindex)
- [tagName](input._internal_.HTMLOutputElement.md#tagname)
- [textContent](input._internal_.HTMLOutputElement.md#textcontent)
- [title](input._internal_.HTMLOutputElement.md#title)
- [translate](input._internal_.HTMLOutputElement.md#translate)
- [type](input._internal_.HTMLOutputElement.md#type)
- [validationMessage](input._internal_.HTMLOutputElement.md#validationmessage)
- [validity](input._internal_.HTMLOutputElement.md#validity)
- [value](input._internal_.HTMLOutputElement.md#value)
- [willValidate](input._internal_.HTMLOutputElement.md#willvalidate)

### Methods

- [addEventListener](input._internal_.HTMLOutputElement.md#addeventlistener)
- [after](input._internal_.HTMLOutputElement.md#after)
- [animate](input._internal_.HTMLOutputElement.md#animate)
- [append](input._internal_.HTMLOutputElement.md#append)
- [appendChild](input._internal_.HTMLOutputElement.md#appendchild)
- [attachInternals](input._internal_.HTMLOutputElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLOutputElement.md#attachshadow)
- [before](input._internal_.HTMLOutputElement.md#before)
- [blur](input._internal_.HTMLOutputElement.md#blur)
- [checkValidity](input._internal_.HTMLOutputElement.md#checkvalidity)
- [click](input._internal_.HTMLOutputElement.md#click)
- [cloneNode](input._internal_.HTMLOutputElement.md#clonenode)
- [closest](input._internal_.HTMLOutputElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLOutputElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLOutputElement.md#contains)
- [dispatchEvent](input._internal_.HTMLOutputElement.md#dispatchevent)
- [focus](input._internal_.HTMLOutputElement.md#focus)
- [getAnimations](input._internal_.HTMLOutputElement.md#getanimations)
- [getAttribute](input._internal_.HTMLOutputElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLOutputElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLOutputElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLOutputElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLOutputElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLOutputElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLOutputElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLOutputElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLOutputElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLOutputElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLOutputElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLOutputElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLOutputElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLOutputElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLOutputElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLOutputElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLOutputElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLOutputElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLOutputElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLOutputElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLOutputElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLOutputElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLOutputElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLOutputElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLOutputElement.md#lookupprefix)
- [matches](input._internal_.HTMLOutputElement.md#matches)
- [normalize](input._internal_.HTMLOutputElement.md#normalize)
- [prepend](input._internal_.HTMLOutputElement.md#prepend)
- [querySelector](input._internal_.HTMLOutputElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLOutputElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLOutputElement.md#releasepointercapture)
- [remove](input._internal_.HTMLOutputElement.md#remove)
- [removeAttribute](input._internal_.HTMLOutputElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLOutputElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLOutputElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLOutputElement.md#removechild)
- [removeEventListener](input._internal_.HTMLOutputElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLOutputElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLOutputElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLOutputElement.md#replacewith)
- [reportValidity](input._internal_.HTMLOutputElement.md#reportvalidity)
- [requestFullscreen](input._internal_.HTMLOutputElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLOutputElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLOutputElement.md#scroll)
- [scrollBy](input._internal_.HTMLOutputElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLOutputElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLOutputElement.md#scrollto)
- [setAttribute](input._internal_.HTMLOutputElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLOutputElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLOutputElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLOutputElement.md#setattributenodens)
- [setCustomValidity](input._internal_.HTMLOutputElement.md#setcustomvalidity)
- [setPointerCapture](input._internal_.HTMLOutputElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLOutputElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLOutputElement.md#webkitmatchesselector)
...
• `Readonly` **htmlFor**: [`DOMTokenList`](../modules/input._internal_.md#domtokenlist)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLOutputElement`](../modules/input._internal_.md#htmloutputelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
