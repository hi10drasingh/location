[Droom Google Location Plugin - v1.0.11](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLSpanElement

# Interface: HTMLSpanElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLSpanElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLSpanElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLSpanElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLSpanElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLSpanElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLSpanElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLSpanElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLSpanElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLSpanElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLSpanElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLSpanElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLSpanElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLSpanElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLSpanElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLSpanElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLSpanElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLSpanElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLSpanElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLSpanElement.md#text_node)
- [accessKey](input._internal_.HTMLSpanElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLSpanElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLSpanElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLSpanElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLSpanElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLSpanElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLSpanElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLSpanElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLSpanElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLSpanElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLSpanElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLSpanElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLSpanElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLSpanElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLSpanElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLSpanElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLSpanElement.md#arialevel)
- [ariaLive](input._internal_.HTMLSpanElement.md#arialive)
- [ariaModal](input._internal_.HTMLSpanElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLSpanElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLSpanElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLSpanElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLSpanElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLSpanElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLSpanElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLSpanElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLSpanElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLSpanElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLSpanElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLSpanElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLSpanElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLSpanElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLSpanElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLSpanElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLSpanElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLSpanElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLSpanElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLSpanElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLSpanElement.md#assignedslot)
- [attributes](input._internal_.HTMLSpanElement.md#attributes)
- [autocapitalize](input._internal_.HTMLSpanElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLSpanElement.md#autofocus)
- [baseURI](input._internal_.HTMLSpanElement.md#baseuri)
- [childElementCount](input._internal_.HTMLSpanElement.md#childelementcount)
- [childNodes](input._internal_.HTMLSpanElement.md#childnodes)
- [children](input._internal_.HTMLSpanElement.md#children)
- [classList](input._internal_.HTMLSpanElement.md#classlist)
- [className](input._internal_.HTMLSpanElement.md#classname)
- [clientHeight](input._internal_.HTMLSpanElement.md#clientheight)
- [clientLeft](input._internal_.HTMLSpanElement.md#clientleft)
- [clientTop](input._internal_.HTMLSpanElement.md#clienttop)
- [clientWidth](input._internal_.HTMLSpanElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLSpanElement.md#contenteditable)
- [dataset](input._internal_.HTMLSpanElement.md#dataset)
- [dir](input._internal_.HTMLSpanElement.md#dir)
- [draggable](input._internal_.HTMLSpanElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLSpanElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLSpanElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLSpanElement.md#firstelementchild)
- [hidden](input._internal_.HTMLSpanElement.md#hidden)
- [id](input._internal_.HTMLSpanElement.md#id)
- [innerHTML](input._internal_.HTMLSpanElement.md#innerhtml)
- [innerText](input._internal_.HTMLSpanElement.md#innertext)
- [inputMode](input._internal_.HTMLSpanElement.md#inputmode)
- [isConnected](input._internal_.HTMLSpanElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLSpanElement.md#iscontenteditable)
- [lang](input._internal_.HTMLSpanElement.md#lang)
- [lastChild](input._internal_.HTMLSpanElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLSpanElement.md#lastelementchild)
- [localName](input._internal_.HTMLSpanElement.md#localname)
- [namespaceURI](input._internal_.HTMLSpanElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLSpanElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLSpanElement.md#nextsibling)
- [nodeName](input._internal_.HTMLSpanElement.md#nodename)
- [nodeType](input._internal_.HTMLSpanElement.md#nodetype)
- [nodeValue](input._internal_.HTMLSpanElement.md#nodevalue)
- [nonce](input._internal_.HTMLSpanElement.md#nonce)
- [offsetHeight](input._internal_.HTMLSpanElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLSpanElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLSpanElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLSpanElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLSpanElement.md#offsetwidth)
- [onabort](input._internal_.HTMLSpanElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLSpanElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLSpanElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLSpanElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLSpanElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLSpanElement.md#onauxclick)
- [onblur](input._internal_.HTMLSpanElement.md#onblur)
- [oncanplay](input._internal_.HTMLSpanElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLSpanElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLSpanElement.md#onchange)
- [onclick](input._internal_.HTMLSpanElement.md#onclick)
- [onclose](input._internal_.HTMLSpanElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLSpanElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLSpanElement.md#oncopy)
- [oncuechange](input._internal_.HTMLSpanElement.md#oncuechange)
- [oncut](input._internal_.HTMLSpanElement.md#oncut)
- [ondblclick](input._internal_.HTMLSpanElement.md#ondblclick)
- [ondrag](input._internal_.HTMLSpanElement.md#ondrag)
- [ondragend](input._internal_.HTMLSpanElement.md#ondragend)
- [ondragenter](input._internal_.HTMLSpanElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLSpanElement.md#ondragleave)
- [ondragover](input._internal_.HTMLSpanElement.md#ondragover)
- [ondragstart](input._internal_.HTMLSpanElement.md#ondragstart)
- [ondrop](input._internal_.HTMLSpanElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLSpanElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLSpanElement.md#onemptied)
- [onended](input._internal_.HTMLSpanElement.md#onended)
- [onerror](input._internal_.HTMLSpanElement.md#onerror)
- [onfocus](input._internal_.HTMLSpanElement.md#onfocus)
- [onformdata](input._internal_.HTMLSpanElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLSpanElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLSpanElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLSpanElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLSpanElement.md#oninput)
- [oninvalid](input._internal_.HTMLSpanElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLSpanElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLSpanElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLSpanElement.md#onkeyup)
- [onload](input._internal_.HTMLSpanElement.md#onload)
- [onloadeddata](input._internal_.HTMLSpanElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLSpanElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLSpanElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLSpanElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLSpanElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLSpanElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLSpanElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLSpanElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLSpanElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLSpanElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLSpanElement.md#onmouseup)
- [onpaste](input._internal_.HTMLSpanElement.md#onpaste)
- [onpause](input._internal_.HTMLSpanElement.md#onpause)
- [onplay](input._internal_.HTMLSpanElement.md#onplay)
- [onplaying](input._internal_.HTMLSpanElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLSpanElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLSpanElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLSpanElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLSpanElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLSpanElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLSpanElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLSpanElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLSpanElement.md#onpointerup)
- [onprogress](input._internal_.HTMLSpanElement.md#onprogress)
- [onratechange](input._internal_.HTMLSpanElement.md#onratechange)
- [onreset](input._internal_.HTMLSpanElement.md#onreset)
- [onresize](input._internal_.HTMLSpanElement.md#onresize)
- [onscroll](input._internal_.HTMLSpanElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLSpanElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLSpanElement.md#onseeked)
- [onseeking](input._internal_.HTMLSpanElement.md#onseeking)
- [onselect](input._internal_.HTMLSpanElement.md#onselect)
- [onselectionchange](input._internal_.HTMLSpanElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLSpanElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLSpanElement.md#onslotchange)
- [onstalled](input._internal_.HTMLSpanElement.md#onstalled)
- [onsubmit](input._internal_.HTMLSpanElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLSpanElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLSpanElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLSpanElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLSpanElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLSpanElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLSpanElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLSpanElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLSpanElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLSpanElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLSpanElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLSpanElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLSpanElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLSpanElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLSpanElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLSpanElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLSpanElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLSpanElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLSpanElement.md#onwheel)
- [outerHTML](input._internal_.HTMLSpanElement.md#outerhtml)
- [outerText](input._internal_.HTMLSpanElement.md#outertext)
- [ownerDocument](input._internal_.HTMLSpanElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLSpanElement.md#parentelement)
- [parentNode](input._internal_.HTMLSpanElement.md#parentnode)
- [part](input._internal_.HTMLSpanElement.md#part)
- [prefix](input._internal_.HTMLSpanElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLSpanElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLSpanElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLSpanElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLSpanElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLSpanElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLSpanElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLSpanElement.md#shadowroot)
- [slot](input._internal_.HTMLSpanElement.md#slot)
- [spellcheck](input._internal_.HTMLSpanElement.md#spellcheck)
- [style](input._internal_.HTMLSpanElement.md#style)
- [tabIndex](input._internal_.HTMLSpanElement.md#tabindex)
- [tagName](input._internal_.HTMLSpanElement.md#tagname)
- [textContent](input._internal_.HTMLSpanElement.md#textcontent)
- [title](input._internal_.HTMLSpanElement.md#title)
- [translate](input._internal_.HTMLSpanElement.md#translate)

### Methods

- [addEventListener](input._internal_.HTMLSpanElement.md#addeventlistener)
- [after](input._internal_.HTMLSpanElement.md#after)
- [animate](input._internal_.HTMLSpanElement.md#animate)
- [append](input._internal_.HTMLSpanElement.md#append)
- [appendChild](input._internal_.HTMLSpanElement.md#appendchild)
- [attachInternals](input._internal_.HTMLSpanElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLSpanElement.md#attachshadow)
- [before](input._internal_.HTMLSpanElement.md#before)
- [blur](input._internal_.HTMLSpanElement.md#blur)
- [click](input._internal_.HTMLSpanElement.md#click)
- [cloneNode](input._internal_.HTMLSpanElement.md#clonenode)
- [closest](input._internal_.HTMLSpanElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLSpanElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLSpanElement.md#contains)
- [dispatchEvent](input._internal_.HTMLSpanElement.md#dispatchevent)
- [focus](input._internal_.HTMLSpanElement.md#focus)
- [getAnimations](input._internal_.HTMLSpanElement.md#getanimations)
- [getAttribute](input._internal_.HTMLSpanElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLSpanElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLSpanElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLSpanElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLSpanElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLSpanElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLSpanElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLSpanElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLSpanElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLSpanElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLSpanElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLSpanElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLSpanElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLSpanElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLSpanElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLSpanElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLSpanElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLSpanElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLSpanElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLSpanElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLSpanElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLSpanElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLSpanElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLSpanElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLSpanElement.md#lookupprefix)
- [matches](input._internal_.HTMLSpanElement.md#matches)
- [normalize](input._internal_.HTMLSpanElement.md#normalize)
- [prepend](input._internal_.HTMLSpanElement.md#prepend)
- [querySelector](input._internal_.HTMLSpanElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLSpanElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLSpanElement.md#releasepointercapture)
- [remove](input._internal_.HTMLSpanElement.md#remove)
- [removeAttribute](input._internal_.HTMLSpanElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLSpanElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLSpanElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLSpanElement.md#removechild)
- [removeEventListener](input._internal_.HTMLSpanElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLSpanElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLSpanElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLSpanElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLSpanElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLSpanElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLSpanElement.md#scroll)
- [scrollBy](input._internal_.HTMLSpanElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLSpanElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLSpanElement.md#scrollto)
- [setAttribute](input._internal_.HTMLSpanElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLSpanElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLSpanElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLSpanElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLSpanElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLSpanElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLSpanElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLSpanElement`](../modules/input._internal_.md#htmlspanelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
