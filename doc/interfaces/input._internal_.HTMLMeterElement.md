[Droom Google Location Plugin - v1.0.13](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLMeterElement

# Interface: HTMLMeterElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLMeterElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLMeterElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLMeterElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLMeterElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLMeterElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLMeterElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLMeterElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLMeterElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLMeterElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLMeterElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLMeterElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLMeterElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLMeterElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLMeterElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLMeterElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLMeterElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLMeterElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLMeterElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLMeterElement.md#text_node)
- [accessKey](input._internal_.HTMLMeterElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLMeterElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLMeterElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLMeterElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLMeterElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLMeterElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLMeterElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLMeterElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLMeterElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLMeterElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLMeterElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLMeterElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLMeterElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLMeterElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLMeterElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLMeterElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLMeterElement.md#arialevel)
- [ariaLive](input._internal_.HTMLMeterElement.md#arialive)
- [ariaModal](input._internal_.HTMLMeterElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLMeterElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLMeterElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLMeterElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLMeterElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLMeterElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLMeterElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLMeterElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLMeterElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLMeterElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLMeterElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLMeterElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLMeterElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLMeterElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLMeterElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLMeterElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLMeterElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLMeterElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLMeterElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLMeterElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLMeterElement.md#assignedslot)
- [attributes](input._internal_.HTMLMeterElement.md#attributes)
- [autocapitalize](input._internal_.HTMLMeterElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLMeterElement.md#autofocus)
- [baseURI](input._internal_.HTMLMeterElement.md#baseuri)
- [childElementCount](input._internal_.HTMLMeterElement.md#childelementcount)
- [childNodes](input._internal_.HTMLMeterElement.md#childnodes)
- [children](input._internal_.HTMLMeterElement.md#children)
- [classList](input._internal_.HTMLMeterElement.md#classlist)
- [className](input._internal_.HTMLMeterElement.md#classname)
- [clientHeight](input._internal_.HTMLMeterElement.md#clientheight)
- [clientLeft](input._internal_.HTMLMeterElement.md#clientleft)
- [clientTop](input._internal_.HTMLMeterElement.md#clienttop)
- [clientWidth](input._internal_.HTMLMeterElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLMeterElement.md#contenteditable)
- [dataset](input._internal_.HTMLMeterElement.md#dataset)
- [dir](input._internal_.HTMLMeterElement.md#dir)
- [draggable](input._internal_.HTMLMeterElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLMeterElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLMeterElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLMeterElement.md#firstelementchild)
- [hidden](input._internal_.HTMLMeterElement.md#hidden)
- [high](input._internal_.HTMLMeterElement.md#high)
- [id](input._internal_.HTMLMeterElement.md#id)
- [innerHTML](input._internal_.HTMLMeterElement.md#innerhtml)
- [innerText](input._internal_.HTMLMeterElement.md#innertext)
- [inputMode](input._internal_.HTMLMeterElement.md#inputmode)
- [isConnected](input._internal_.HTMLMeterElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLMeterElement.md#iscontenteditable)
- [labels](input._internal_.HTMLMeterElement.md#labels)
- [lang](input._internal_.HTMLMeterElement.md#lang)
- [lastChild](input._internal_.HTMLMeterElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLMeterElement.md#lastelementchild)
- [localName](input._internal_.HTMLMeterElement.md#localname)
- [low](input._internal_.HTMLMeterElement.md#low)
- [max](input._internal_.HTMLMeterElement.md#max)
- [min](input._internal_.HTMLMeterElement.md#min)
- [namespaceURI](input._internal_.HTMLMeterElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLMeterElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLMeterElement.md#nextsibling)
- [nodeName](input._internal_.HTMLMeterElement.md#nodename)
- [nodeType](input._internal_.HTMLMeterElement.md#nodetype)
- [nodeValue](input._internal_.HTMLMeterElement.md#nodevalue)
- [nonce](input._internal_.HTMLMeterElement.md#nonce)
- [offsetHeight](input._internal_.HTMLMeterElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLMeterElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLMeterElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLMeterElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLMeterElement.md#offsetwidth)
- [onabort](input._internal_.HTMLMeterElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLMeterElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLMeterElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLMeterElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLMeterElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLMeterElement.md#onauxclick)
- [onblur](input._internal_.HTMLMeterElement.md#onblur)
- [oncanplay](input._internal_.HTMLMeterElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLMeterElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLMeterElement.md#onchange)
- [onclick](input._internal_.HTMLMeterElement.md#onclick)
- [onclose](input._internal_.HTMLMeterElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLMeterElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLMeterElement.md#oncopy)
- [oncuechange](input._internal_.HTMLMeterElement.md#oncuechange)
- [oncut](input._internal_.HTMLMeterElement.md#oncut)
- [ondblclick](input._internal_.HTMLMeterElement.md#ondblclick)
- [ondrag](input._internal_.HTMLMeterElement.md#ondrag)
- [ondragend](input._internal_.HTMLMeterElement.md#ondragend)
- [ondragenter](input._internal_.HTMLMeterElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLMeterElement.md#ondragleave)
- [ondragover](input._internal_.HTMLMeterElement.md#ondragover)
- [ondragstart](input._internal_.HTMLMeterElement.md#ondragstart)
- [ondrop](input._internal_.HTMLMeterElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLMeterElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLMeterElement.md#onemptied)
- [onended](input._internal_.HTMLMeterElement.md#onended)
- [onerror](input._internal_.HTMLMeterElement.md#onerror)
- [onfocus](input._internal_.HTMLMeterElement.md#onfocus)
- [onformdata](input._internal_.HTMLMeterElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLMeterElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLMeterElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLMeterElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLMeterElement.md#oninput)
- [oninvalid](input._internal_.HTMLMeterElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLMeterElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLMeterElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLMeterElement.md#onkeyup)
- [onload](input._internal_.HTMLMeterElement.md#onload)
- [onloadeddata](input._internal_.HTMLMeterElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLMeterElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLMeterElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLMeterElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLMeterElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLMeterElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLMeterElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLMeterElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLMeterElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLMeterElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLMeterElement.md#onmouseup)
- [onpaste](input._internal_.HTMLMeterElement.md#onpaste)
- [onpause](input._internal_.HTMLMeterElement.md#onpause)
- [onplay](input._internal_.HTMLMeterElement.md#onplay)
- [onplaying](input._internal_.HTMLMeterElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLMeterElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLMeterElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLMeterElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLMeterElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLMeterElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLMeterElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLMeterElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLMeterElement.md#onpointerup)
- [onprogress](input._internal_.HTMLMeterElement.md#onprogress)
- [onratechange](input._internal_.HTMLMeterElement.md#onratechange)
- [onreset](input._internal_.HTMLMeterElement.md#onreset)
- [onresize](input._internal_.HTMLMeterElement.md#onresize)
- [onscroll](input._internal_.HTMLMeterElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLMeterElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLMeterElement.md#onseeked)
- [onseeking](input._internal_.HTMLMeterElement.md#onseeking)
- [onselect](input._internal_.HTMLMeterElement.md#onselect)
- [onselectionchange](input._internal_.HTMLMeterElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLMeterElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLMeterElement.md#onslotchange)
- [onstalled](input._internal_.HTMLMeterElement.md#onstalled)
- [onsubmit](input._internal_.HTMLMeterElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLMeterElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLMeterElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLMeterElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLMeterElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLMeterElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLMeterElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLMeterElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLMeterElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLMeterElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLMeterElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLMeterElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLMeterElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLMeterElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLMeterElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLMeterElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLMeterElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLMeterElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLMeterElement.md#onwheel)
- [optimum](input._internal_.HTMLMeterElement.md#optimum)
- [outerHTML](input._internal_.HTMLMeterElement.md#outerhtml)
- [outerText](input._internal_.HTMLMeterElement.md#outertext)
- [ownerDocument](input._internal_.HTMLMeterElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLMeterElement.md#parentelement)
- [parentNode](input._internal_.HTMLMeterElement.md#parentnode)
- [part](input._internal_.HTMLMeterElement.md#part)
- [prefix](input._internal_.HTMLMeterElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLMeterElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLMeterElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLMeterElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLMeterElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLMeterElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLMeterElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLMeterElement.md#shadowroot)
- [slot](input._internal_.HTMLMeterElement.md#slot)
- [spellcheck](input._internal_.HTMLMeterElement.md#spellcheck)
- [style](input._internal_.HTMLMeterElement.md#style)
- [tabIndex](input._internal_.HTMLMeterElement.md#tabindex)
- [tagName](input._internal_.HTMLMeterElement.md#tagname)
- [textContent](input._internal_.HTMLMeterElement.md#textcontent)
- [title](input._internal_.HTMLMeterElement.md#title)
- [translate](input._internal_.HTMLMeterElement.md#translate)
- [value](input._internal_.HTMLMeterElement.md#value)

### Methods

- [addEventListener](input._internal_.HTMLMeterElement.md#addeventlistener)
- [after](input._internal_.HTMLMeterElement.md#after)
- [animate](input._internal_.HTMLMeterElement.md#animate)
- [append](input._internal_.HTMLMeterElement.md#append)
- [appendChild](input._internal_.HTMLMeterElement.md#appendchild)
- [attachInternals](input._internal_.HTMLMeterElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLMeterElement.md#attachshadow)
- [before](input._internal_.HTMLMeterElement.md#before)
- [blur](input._internal_.HTMLMeterElement.md#blur)
- [click](input._internal_.HTMLMeterElement.md#click)
- [cloneNode](input._internal_.HTMLMeterElement.md#clonenode)
- [closest](input._internal_.HTMLMeterElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLMeterElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLMeterElement.md#contains)
- [dispatchEvent](input._internal_.HTMLMeterElement.md#dispatchevent)
- [focus](input._internal_.HTMLMeterElement.md#focus)
- [getAnimations](input._internal_.HTMLMeterElement.md#getanimations)
- [getAttribute](input._internal_.HTMLMeterElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLMeterElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLMeterElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLMeterElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLMeterElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLMeterElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLMeterElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLMeterElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLMeterElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLMeterElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLMeterElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLMeterElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLMeterElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLMeterElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLMeterElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLMeterElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLMeterElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLMeterElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLMeterElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLMeterElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLMeterElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLMeterElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLMeterElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLMeterElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLMeterElement.md#lookupprefix)
- [matches](input._internal_.HTMLMeterElement.md#matches)
- [normalize](input._internal_.HTMLMeterElement.md#normalize)
- [prepend](input._internal_.HTMLMeterElement.md#prepend)
- [querySelector](input._internal_.HTMLMeterElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLMeterElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLMeterElement.md#releasepointercapture)
- [remove](input._internal_.HTMLMeterElement.md#remove)
- [removeAttribute](input._internal_.HTMLMeterElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLMeterElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLMeterElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLMeterElement.md#removechild)
- [removeEventListener](input._internal_.HTMLMeterElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLMeterElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLMeterElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLMeterElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLMeterElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLMeterElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLMeterElement.md#scroll)
- [scrollBy](input._internal_.HTMLMeterElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLMeterElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLMeterElement.md#scrollto)
- [setAttribute](input._internal_.HTMLMeterElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLMeterElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLMeterElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLMeterElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLMeterElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLMeterElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLMeterElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLMeterElement`](../modules/input._internal_.md#htmlmeterelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
