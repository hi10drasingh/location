[Droom Google Location Plugin - v1.0.10](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGFESpotLightElement

# Interface: SVGFESpotLightElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGFESpotLightElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGFESpotLightElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGFESpotLightElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGFESpotLightElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGFESpotLightElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGFESpotLightElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGFESpotLightElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGFESpotLightElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGFESpotLightElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGFESpotLightElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGFESpotLightElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGFESpotLightElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGFESpotLightElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGFESpotLightElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGFESpotLightElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGFESpotLightElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGFESpotLightElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGFESpotLightElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGFESpotLightElement.md#text_node)
- [ariaAtomic](input._internal_.SVGFESpotLightElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGFESpotLightElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGFESpotLightElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGFESpotLightElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGFESpotLightElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGFESpotLightElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGFESpotLightElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGFESpotLightElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGFESpotLightElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGFESpotLightElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGFESpotLightElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGFESpotLightElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGFESpotLightElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGFESpotLightElement.md#arialabel)
- [ariaLevel](input._internal_.SVGFESpotLightElement.md#arialevel)
- [ariaLive](input._internal_.SVGFESpotLightElement.md#arialive)
- [ariaModal](input._internal_.SVGFESpotLightElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGFESpotLightElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGFESpotLightElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGFESpotLightElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGFESpotLightElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGFESpotLightElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGFESpotLightElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGFESpotLightElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGFESpotLightElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGFESpotLightElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGFESpotLightElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGFESpotLightElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGFESpotLightElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGFESpotLightElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGFESpotLightElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGFESpotLightElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGFESpotLightElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGFESpotLightElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGFESpotLightElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGFESpotLightElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGFESpotLightElement.md#assignedslot)
- [attributes](input._internal_.SVGFESpotLightElement.md#attributes)
- [autofocus](input._internal_.SVGFESpotLightElement.md#autofocus)
- [baseURI](input._internal_.SVGFESpotLightElement.md#baseuri)
- [childElementCount](input._internal_.SVGFESpotLightElement.md#childelementcount)
- [childNodes](input._internal_.SVGFESpotLightElement.md#childnodes)
- [children](input._internal_.SVGFESpotLightElement.md#children)
- [classList](input._internal_.SVGFESpotLightElement.md#classlist)
- [className](input._internal_.SVGFESpotLightElement.md#classname)
- [clientHeight](input._internal_.SVGFESpotLightElement.md#clientheight)
- [clientLeft](input._internal_.SVGFESpotLightElement.md#clientleft)
- [clientTop](input._internal_.SVGFESpotLightElement.md#clienttop)
- [clientWidth](input._internal_.SVGFESpotLightElement.md#clientwidth)
- [dataset](input._internal_.SVGFESpotLightElement.md#dataset)
- [firstChild](input._internal_.SVGFESpotLightElement.md#firstchild)
- [firstElementChild](input._internal_.SVGFESpotLightElement.md#firstelementchild)
- [id](input._internal_.SVGFESpotLightElement.md#id)
- [innerHTML](input._internal_.SVGFESpotLightElement.md#innerhtml)
- [isConnected](input._internal_.SVGFESpotLightElement.md#isconnected)
- [lastChild](input._internal_.SVGFESpotLightElement.md#lastchild)
- [lastElementChild](input._internal_.SVGFESpotLightElement.md#lastelementchild)
- [limitingConeAngle](input._internal_.SVGFESpotLightElement.md#limitingconeangle)
- [localName](input._internal_.SVGFESpotLightElement.md#localname)
- [namespaceURI](input._internal_.SVGFESpotLightElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGFESpotLightElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGFESpotLightElement.md#nextsibling)
- [nodeName](input._internal_.SVGFESpotLightElement.md#nodename)
- [nodeType](input._internal_.SVGFESpotLightElement.md#nodetype)
- [nodeValue](input._internal_.SVGFESpotLightElement.md#nodevalue)
- [nonce](input._internal_.SVGFESpotLightElement.md#nonce)
- [onabort](input._internal_.SVGFESpotLightElement.md#onabort)
- [onanimationcancel](input._internal_.SVGFESpotLightElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGFESpotLightElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGFESpotLightElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGFESpotLightElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGFESpotLightElement.md#onauxclick)
- [onblur](input._internal_.SVGFESpotLightElement.md#onblur)
- [oncanplay](input._internal_.SVGFESpotLightElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGFESpotLightElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGFESpotLightElement.md#onchange)
- [onclick](input._internal_.SVGFESpotLightElement.md#onclick)
- [onclose](input._internal_.SVGFESpotLightElement.md#onclose)
- [oncontextmenu](input._internal_.SVGFESpotLightElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGFESpotLightElement.md#oncopy)
- [oncuechange](input._internal_.SVGFESpotLightElement.md#oncuechange)
- [oncut](input._internal_.SVGFESpotLightElement.md#oncut)
- [ondblclick](input._internal_.SVGFESpotLightElement.md#ondblclick)
- [ondrag](input._internal_.SVGFESpotLightElement.md#ondrag)
- [ondragend](input._internal_.SVGFESpotLightElement.md#ondragend)
- [ondragenter](input._internal_.SVGFESpotLightElement.md#ondragenter)
- [ondragleave](input._internal_.SVGFESpotLightElement.md#ondragleave)
- [ondragover](input._internal_.SVGFESpotLightElement.md#ondragover)
- [ondragstart](input._internal_.SVGFESpotLightElement.md#ondragstart)
- [ondrop](input._internal_.SVGFESpotLightElement.md#ondrop)
- [ondurationchange](input._internal_.SVGFESpotLightElement.md#ondurationchange)
- [onemptied](input._internal_.SVGFESpotLightElement.md#onemptied)
- [onended](input._internal_.SVGFESpotLightElement.md#onended)
- [onerror](input._internal_.SVGFESpotLightElement.md#onerror)
- [onfocus](input._internal_.SVGFESpotLightElement.md#onfocus)
- [onformdata](input._internal_.SVGFESpotLightElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGFESpotLightElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGFESpotLightElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGFESpotLightElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGFESpotLightElement.md#oninput)
- [oninvalid](input._internal_.SVGFESpotLightElement.md#oninvalid)
- [onkeydown](input._internal_.SVGFESpotLightElement.md#onkeydown)
- [onkeypress](input._internal_.SVGFESpotLightElement.md#onkeypress)
- [onkeyup](input._internal_.SVGFESpotLightElement.md#onkeyup)
- [onload](input._internal_.SVGFESpotLightElement.md#onload)
- [onloadeddata](input._internal_.SVGFESpotLightElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGFESpotLightElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGFESpotLightElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGFESpotLightElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGFESpotLightElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGFESpotLightElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGFESpotLightElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGFESpotLightElement.md#onmousemove)
- [onmouseout](input._internal_.SVGFESpotLightElement.md#onmouseout)
- [onmouseover](input._internal_.SVGFESpotLightElement.md#onmouseover)
- [onmouseup](input._internal_.SVGFESpotLightElement.md#onmouseup)
- [onpaste](input._internal_.SVGFESpotLightElement.md#onpaste)
- [onpause](input._internal_.SVGFESpotLightElement.md#onpause)
- [onplay](input._internal_.SVGFESpotLightElement.md#onplay)
- [onplaying](input._internal_.SVGFESpotLightElement.md#onplaying)
- [onpointercancel](input._internal_.SVGFESpotLightElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGFESpotLightElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGFESpotLightElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGFESpotLightElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGFESpotLightElement.md#onpointermove)
- [onpointerout](input._internal_.SVGFESpotLightElement.md#onpointerout)
- [onpointerover](input._internal_.SVGFESpotLightElement.md#onpointerover)
- [onpointerup](input._internal_.SVGFESpotLightElement.md#onpointerup)
- [onprogress](input._internal_.SVGFESpotLightElement.md#onprogress)
- [onratechange](input._internal_.SVGFESpotLightElement.md#onratechange)
- [onreset](input._internal_.SVGFESpotLightElement.md#onreset)
- [onresize](input._internal_.SVGFESpotLightElement.md#onresize)
- [onscroll](input._internal_.SVGFESpotLightElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGFESpotLightElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGFESpotLightElement.md#onseeked)
- [onseeking](input._internal_.SVGFESpotLightElement.md#onseeking)
- [onselect](input._internal_.SVGFESpotLightElement.md#onselect)
- [onselectionchange](input._internal_.SVGFESpotLightElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGFESpotLightElement.md#onselectstart)
- [onslotchange](input._internal_.SVGFESpotLightElement.md#onslotchange)
- [onstalled](input._internal_.SVGFESpotLightElement.md#onstalled)
- [onsubmit](input._internal_.SVGFESpotLightElement.md#onsubmit)
- [onsuspend](input._internal_.SVGFESpotLightElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGFESpotLightElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGFESpotLightElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGFESpotLightElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGFESpotLightElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGFESpotLightElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGFESpotLightElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGFESpotLightElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGFESpotLightElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGFESpotLightElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGFESpotLightElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGFESpotLightElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGFESpotLightElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGFESpotLightElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGFESpotLightElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGFESpotLightElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGFESpotLightElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGFESpotLightElement.md#onwheel)
- [outerHTML](input._internal_.SVGFESpotLightElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGFESpotLightElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGFESpotLightElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGFESpotLightElement.md#parentelement)
- [parentNode](input._internal_.SVGFESpotLightElement.md#parentnode)
- [part](input._internal_.SVGFESpotLightElement.md#part)
- [pointsAtX](input._internal_.SVGFESpotLightElement.md#pointsatx)
- [pointsAtY](input._internal_.SVGFESpotLightElement.md#pointsaty)
- [pointsAtZ](input._internal_.SVGFESpotLightElement.md#pointsatz)
- [prefix](input._internal_.SVGFESpotLightElement.md#prefix)
- [previousElementSibling](input._internal_.SVGFESpotLightElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGFESpotLightElement.md#previoussibling)
- [scrollHeight](input._internal_.SVGFESpotLightElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGFESpotLightElement.md#scrollleft)
- [scrollTop](input._internal_.SVGFESpotLightElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGFESpotLightElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGFESpotLightElement.md#shadowroot)
- [slot](input._internal_.SVGFESpotLightElement.md#slot)
- [specularExponent](input._internal_.SVGFESpotLightElement.md#specularexponent)
- [style](input._internal_.SVGFESpotLightElement.md#style)
- [tabIndex](input._internal_.SVGFESpotLightElement.md#tabindex)
- [tagName](input._internal_.SVGFESpotLightElement.md#tagname)
- [textContent](input._internal_.SVGFESpotLightElement.md#textcontent)
- [viewportElement](input._internal_.SVGFESpotLightElement.md#viewportelement)
- [x](input._internal_.SVGFESpotLightElement.md#x)
- [y](input._internal_.SVGFESpotLightElement.md#y)
- [z](input._internal_.SVGFESpotLightElement.md#z)

### Methods

- [addEventListener](input._internal_.SVGFESpotLightElement.md#addeventlistener)
- [after](input._internal_.SVGFESpotLightElement.md#after)
- [animate](input._internal_.SVGFESpotLightElement.md#animate)
- [append](input._internal_.SVGFESpotLightElement.md#append)
- [appendChild](input._internal_.SVGFESpotLightElement.md#appendchild)
- [attachShadow](input._internal_.SVGFESpotLightElement.md#attachshadow)
- [before](input._internal_.SVGFESpotLightElement.md#before)
- [blur](input._internal_.SVGFESpotLightElement.md#blur)
- [cloneNode](input._internal_.SVGFESpotLightElement.md#clonenode)
- [closest](input._internal_.SVGFESpotLightElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGFESpotLightElement.md#comparedocumentposition)
- [contains](input._internal_.SVGFESpotLightElement.md#contains)
- [dispatchEvent](input._internal_.SVGFESpotLightElement.md#dispatchevent)
- [focus](input._internal_.SVGFESpotLightElement.md#focus)
- [getAnimations](input._internal_.SVGFESpotLightElement.md#getanimations)
- [getAttribute](input._internal_.SVGFESpotLightElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGFESpotLightElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGFESpotLightElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGFESpotLightElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGFESpotLightElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.SVGFESpotLightElement.md#getboundingclientrect)
- [getClientRects](input._internal_.SVGFESpotLightElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGFESpotLightElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGFESpotLightElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGFESpotLightElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGFESpotLightElement.md#getrootnode)
- [hasAttribute](input._internal_.SVGFESpotLightElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGFESpotLightElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGFESpotLightElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGFESpotLightElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGFESpotLightElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGFESpotLightElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGFESpotLightElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGFESpotLightElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGFESpotLightElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGFESpotLightElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGFESpotLightElement.md#isequalnode)
- [isSameNode](input._internal_.SVGFESpotLightElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGFESpotLightElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGFESpotLightElement.md#lookupprefix)
- [matches](input._internal_.SVGFESpotLightElement.md#matches)
- [normalize](input._internal_.SVGFESpotLightElement.md#normalize)
- [prepend](input._internal_.SVGFESpotLightElement.md#prepend)
- [querySelector](input._internal_.SVGFESpotLightElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGFESpotLightElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGFESpotLightElement.md#releasepointercapture)
- [remove](input._internal_.SVGFESpotLightElement.md#remove)
- [removeAttribute](input._internal_.SVGFESpotLightElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGFESpotLightElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGFESpotLightElement.md#removeattributenode)
- [removeChild](input._internal_.SVGFESpotLightElement.md#removechild)
- [removeEventListener](input._internal_.SVGFESpotLightElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGFESpotLightElement.md#replacechild)
- [replaceChildren](input._internal_.SVGFESpotLightElement.md#replacechildren)
- [replaceWith](input._internal_.SVGFESpotLightElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGFESpotLightElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGFESpotLightElement.md#requestpointerlock)
- [scroll](input._internal_.SVGFESpotLightElement.md#scroll)
- [scrollBy](input._internal_.SVGFESpotLightElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGFESpotLightElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGFESpotLightElement.md#scrollto)
- [setAttribute](input._internal_.SVGFESpotLightElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGFESpotLightElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGFESpotLightElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGFESpotLightElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGFESpotLightElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGFESpotLightElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGFESpotLightElement.md#webkitmatchesselector)
...
• `Readonly` **limitingConeAngle**: [`SVGAnimatedNumber`](../modules/input._internal_.md#svganimatednumber)
...
• `Readonly` **pointsAtX**: [`SVGAnimatedNumber`](../modules/input._internal_.md#svganimatednumber)
...
• `Readonly` **pointsAtY**: [`SVGAnimatedNumber`](../modules/input._internal_.md#svganimatednumber)
...
• `Readonly` **pointsAtZ**: [`SVGAnimatedNumber`](../modules/input._internal_.md#svganimatednumber)
...
• `Readonly` **x**: [`SVGAnimatedNumber`](../modules/input._internal_.md#svganimatednumber)
...
• `Readonly` **y**: [`SVGAnimatedNumber`](../modules/input._internal_.md#svganimatednumber)
...
• `Readonly` **z**: [`SVGAnimatedNumber`](../modules/input._internal_.md#svganimatednumber)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGFESpotLightElement`](../modules/input._internal_.md#svgfespotlightelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
