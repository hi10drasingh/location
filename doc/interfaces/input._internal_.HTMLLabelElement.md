[Droom Google Location Plugin - v1.0.15](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLLabelElement

# Interface: HTMLLabelElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLLabelElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLLabelElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLLabelElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLLabelElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLLabelElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLLabelElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLLabelElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLLabelElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLLabelElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLLabelElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLLabelElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLLabelElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLLabelElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLLabelElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLLabelElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLLabelElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLLabelElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLLabelElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLLabelElement.md#text_node)
- [accessKey](input._internal_.HTMLLabelElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLLabelElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLLabelElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLLabelElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLLabelElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLLabelElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLLabelElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLLabelElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLLabelElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLLabelElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLLabelElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLLabelElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLLabelElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLLabelElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLLabelElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLLabelElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLLabelElement.md#arialevel)
- [ariaLive](input._internal_.HTMLLabelElement.md#arialive)
- [ariaModal](input._internal_.HTMLLabelElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLLabelElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLLabelElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLLabelElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLLabelElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLLabelElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLLabelElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLLabelElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLLabelElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLLabelElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLLabelElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLLabelElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLLabelElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLLabelElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLLabelElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLLabelElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLLabelElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLLabelElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLLabelElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLLabelElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLLabelElement.md#assignedslot)
- [attributes](input._internal_.HTMLLabelElement.md#attributes)
- [autocapitalize](input._internal_.HTMLLabelElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLLabelElement.md#autofocus)
- [baseURI](input._internal_.HTMLLabelElement.md#baseuri)
- [childElementCount](input._internal_.HTMLLabelElement.md#childelementcount)
- [childNodes](input._internal_.HTMLLabelElement.md#childnodes)
- [children](input._internal_.HTMLLabelElement.md#children)
- [classList](input._internal_.HTMLLabelElement.md#classlist)
- [className](input._internal_.HTMLLabelElement.md#classname)
- [clientHeight](input._internal_.HTMLLabelElement.md#clientheight)
- [clientLeft](input._internal_.HTMLLabelElement.md#clientleft)
- [clientTop](input._internal_.HTMLLabelElement.md#clienttop)
- [clientWidth](input._internal_.HTMLLabelElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLLabelElement.md#contenteditable)
- [control](input._internal_.HTMLLabelElement.md#control)
- [dataset](input._internal_.HTMLLabelElement.md#dataset)
- [dir](input._internal_.HTMLLabelElement.md#dir)
- [draggable](input._internal_.HTMLLabelElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLLabelElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLLabelElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLLabelElement.md#firstelementchild)
- [form](input._internal_.HTMLLabelElement.md#form)
- [hidden](input._internal_.HTMLLabelElement.md#hidden)
- [htmlFor](input._internal_.HTMLLabelElement.md#htmlfor)
- [id](input._internal_.HTMLLabelElement.md#id)
- [innerHTML](input._internal_.HTMLLabelElement.md#innerhtml)
- [innerText](input._internal_.HTMLLabelElement.md#innertext)
- [inputMode](input._internal_.HTMLLabelElement.md#inputmode)
- [isConnected](input._internal_.HTMLLabelElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLLabelElement.md#iscontenteditable)
- [lang](input._internal_.HTMLLabelElement.md#lang)
- [lastChild](input._internal_.HTMLLabelElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLLabelElement.md#lastelementchild)
- [localName](input._internal_.HTMLLabelElement.md#localname)
- [namespaceURI](input._internal_.HTMLLabelElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLLabelElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLLabelElement.md#nextsibling)
- [nodeName](input._internal_.HTMLLabelElement.md#nodename)
- [nodeType](input._internal_.HTMLLabelElement.md#nodetype)
- [nodeValue](input._internal_.HTMLLabelElement.md#nodevalue)
- [nonce](input._internal_.HTMLLabelElement.md#nonce)
- [offsetHeight](input._internal_.HTMLLabelElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLLabelElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLLabelElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLLabelElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLLabelElement.md#offsetwidth)
- [onabort](input._internal_.HTMLLabelElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLLabelElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLLabelElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLLabelElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLLabelElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLLabelElement.md#onauxclick)
- [onblur](input._internal_.HTMLLabelElement.md#onblur)
- [oncanplay](input._internal_.HTMLLabelElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLLabelElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLLabelElement.md#onchange)
- [onclick](input._internal_.HTMLLabelElement.md#onclick)
- [onclose](input._internal_.HTMLLabelElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLLabelElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLLabelElement.md#oncopy)
- [oncuechange](input._internal_.HTMLLabelElement.md#oncuechange)
- [oncut](input._internal_.HTMLLabelElement.md#oncut)
- [ondblclick](input._internal_.HTMLLabelElement.md#ondblclick)
- [ondrag](input._internal_.HTMLLabelElement.md#ondrag)
- [ondragend](input._internal_.HTMLLabelElement.md#ondragend)
- [ondragenter](input._internal_.HTMLLabelElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLLabelElement.md#ondragleave)
- [ondragover](input._internal_.HTMLLabelElement.md#ondragover)
- [ondragstart](input._internal_.HTMLLabelElement.md#ondragstart)
- [ondrop](input._internal_.HTMLLabelElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLLabelElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLLabelElement.md#onemptied)
- [onended](input._internal_.HTMLLabelElement.md#onended)
- [onerror](input._internal_.HTMLLabelElement.md#onerror)
- [onfocus](input._internal_.HTMLLabelElement.md#onfocus)
- [onformdata](input._internal_.HTMLLabelElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLLabelElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLLabelElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLLabelElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLLabelElement.md#oninput)
- [oninvalid](input._internal_.HTMLLabelElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLLabelElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLLabelElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLLabelElement.md#onkeyup)
- [onload](input._internal_.HTMLLabelElement.md#onload)
- [onloadeddata](input._internal_.HTMLLabelElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLLabelElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLLabelElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLLabelElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLLabelElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLLabelElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLLabelElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLLabelElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLLabelElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLLabelElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLLabelElement.md#onmouseup)
- [onpaste](input._internal_.HTMLLabelElement.md#onpaste)
- [onpause](input._internal_.HTMLLabelElement.md#onpause)
- [onplay](input._internal_.HTMLLabelElement.md#onplay)
- [onplaying](input._internal_.HTMLLabelElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLLabelElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLLabelElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLLabelElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLLabelElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLLabelElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLLabelElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLLabelElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLLabelElement.md#onpointerup)
- [onprogress](input._internal_.HTMLLabelElement.md#onprogress)
- [onratechange](input._internal_.HTMLLabelElement.md#onratechange)
- [onreset](input._internal_.HTMLLabelElement.md#onreset)
- [onresize](input._internal_.HTMLLabelElement.md#onresize)
- [onscroll](input._internal_.HTMLLabelElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLLabelElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLLabelElement.md#onseeked)
- [onseeking](input._internal_.HTMLLabelElement.md#onseeking)
- [onselect](input._internal_.HTMLLabelElement.md#onselect)
- [onselectionchange](input._internal_.HTMLLabelElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLLabelElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLLabelElement.md#onslotchange)
- [onstalled](input._internal_.HTMLLabelElement.md#onstalled)
- [onsubmit](input._internal_.HTMLLabelElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLLabelElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLLabelElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLLabelElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLLabelElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLLabelElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLLabelElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLLabelElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLLabelElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLLabelElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLLabelElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLLabelElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLLabelElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLLabelElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLLabelElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLLabelElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLLabelElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLLabelElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLLabelElement.md#onwheel)
- [outerHTML](input._internal_.HTMLLabelElement.md#outerhtml)
- [outerText](input._internal_.HTMLLabelElement.md#outertext)
- [ownerDocument](input._internal_.HTMLLabelElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLLabelElement.md#parentelement)
- [parentNode](input._internal_.HTMLLabelElement.md#parentnode)
- [part](input._internal_.HTMLLabelElement.md#part)
- [prefix](input._internal_.HTMLLabelElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLLabelElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLLabelElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLLabelElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLLabelElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLLabelElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLLabelElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLLabelElement.md#shadowroot)
- [slot](input._internal_.HTMLLabelElement.md#slot)
- [spellcheck](input._internal_.HTMLLabelElement.md#spellcheck)
- [style](input._internal_.HTMLLabelElement.md#style)
- [tabIndex](input._internal_.HTMLLabelElement.md#tabindex)
- [tagName](input._internal_.HTMLLabelElement.md#tagname)
- [textContent](input._internal_.HTMLLabelElement.md#textcontent)
- [title](input._internal_.HTMLLabelElement.md#title)
- [translate](input._internal_.HTMLLabelElement.md#translate)

### Methods

- [addEventListener](input._internal_.HTMLLabelElement.md#addeventlistener)
- [after](input._internal_.HTMLLabelElement.md#after)
- [animate](input._internal_.HTMLLabelElement.md#animate)
- [append](input._internal_.HTMLLabelElement.md#append)
- [appendChild](input._internal_.HTMLLabelElement.md#appendchild)
- [attachInternals](input._internal_.HTMLLabelElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLLabelElement.md#attachshadow)
- [before](input._internal_.HTMLLabelElement.md#before)
- [blur](input._internal_.HTMLLabelElement.md#blur)
- [click](input._internal_.HTMLLabelElement.md#click)
- [cloneNode](input._internal_.HTMLLabelElement.md#clonenode)
- [closest](input._internal_.HTMLLabelElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLLabelElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLLabelElement.md#contains)
- [dispatchEvent](input._internal_.HTMLLabelElement.md#dispatchevent)
- [focus](input._internal_.HTMLLabelElement.md#focus)
- [getAnimations](input._internal_.HTMLLabelElement.md#getanimations)
- [getAttribute](input._internal_.HTMLLabelElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLLabelElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLLabelElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLLabelElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLLabelElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLLabelElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLLabelElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLLabelElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLLabelElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLLabelElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLLabelElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLLabelElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLLabelElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLLabelElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLLabelElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLLabelElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLLabelElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLLabelElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLLabelElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLLabelElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLLabelElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLLabelElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLLabelElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLLabelElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLLabelElement.md#lookupprefix)
- [matches](input._internal_.HTMLLabelElement.md#matches)
- [normalize](input._internal_.HTMLLabelElement.md#normalize)
- [prepend](input._internal_.HTMLLabelElement.md#prepend)
- [querySelector](input._internal_.HTMLLabelElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLLabelElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLLabelElement.md#releasepointercapture)
- [remove](input._internal_.HTMLLabelElement.md#remove)
- [removeAttribute](input._internal_.HTMLLabelElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLLabelElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLLabelElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLLabelElement.md#removechild)
- [removeEventListener](input._internal_.HTMLLabelElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLLabelElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLLabelElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLLabelElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLLabelElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLLabelElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLLabelElement.md#scroll)
- [scrollBy](input._internal_.HTMLLabelElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLLabelElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLLabelElement.md#scrollto)
- [setAttribute](input._internal_.HTMLLabelElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLLabelElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLLabelElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLLabelElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLLabelElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLLabelElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLLabelElement.md#webkitmatchesselector)
...
• `Readonly` **control**: ``null`` \| [`HTMLElement`](../modules/input._internal_.md#htmlelement)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLLabelElement`](../modules/input._internal_.md#htmllabelelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
