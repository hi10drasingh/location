[Droom Google Location Plugin - v1.0.13](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGGraphicsElement

# Interface: SVGGraphicsElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGGraphicsElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGGraphicsElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGGraphicsElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGGraphicsElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGGraphicsElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGGraphicsElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGGraphicsElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGGraphicsElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGGraphicsElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGGraphicsElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGGraphicsElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGGraphicsElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGGraphicsElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGGraphicsElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGGraphicsElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGGraphicsElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGGraphicsElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGGraphicsElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGGraphicsElement.md#text_node)
- [ariaAtomic](input._internal_.SVGGraphicsElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGGraphicsElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGGraphicsElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGGraphicsElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGGraphicsElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGGraphicsElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGGraphicsElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGGraphicsElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGGraphicsElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGGraphicsElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGGraphicsElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGGraphicsElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGGraphicsElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGGraphicsElement.md#arialabel)
- [ariaLevel](input._internal_.SVGGraphicsElement.md#arialevel)
- [ariaLive](input._internal_.SVGGraphicsElement.md#arialive)
- [ariaModal](input._internal_.SVGGraphicsElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGGraphicsElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGGraphicsElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGGraphicsElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGGraphicsElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGGraphicsElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGGraphicsElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGGraphicsElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGGraphicsElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGGraphicsElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGGraphicsElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGGraphicsElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGGraphicsElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGGraphicsElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGGraphicsElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGGraphicsElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGGraphicsElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGGraphicsElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGGraphicsElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGGraphicsElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGGraphicsElement.md#assignedslot)
- [attributes](input._internal_.SVGGraphicsElement.md#attributes)
- [autofocus](input._internal_.SVGGraphicsElement.md#autofocus)
- [baseURI](input._internal_.SVGGraphicsElement.md#baseuri)
- [childElementCount](input._internal_.SVGGraphicsElement.md#childelementcount)
- [childNodes](input._internal_.SVGGraphicsElement.md#childnodes)
- [children](input._internal_.SVGGraphicsElement.md#children)
- [classList](input._internal_.SVGGraphicsElement.md#classlist)
- [className](input._internal_.SVGGraphicsElement.md#classname)
- [clientHeight](input._internal_.SVGGraphicsElement.md#clientheight)
- [clientLeft](input._internal_.SVGGraphicsElement.md#clientleft)
- [clientTop](input._internal_.SVGGraphicsElement.md#clienttop)
- [clientWidth](input._internal_.SVGGraphicsElement.md#clientwidth)
- [dataset](input._internal_.SVGGraphicsElement.md#dataset)
- [firstChild](input._internal_.SVGGraphicsElement.md#firstchild)
- [firstElementChild](input._internal_.SVGGraphicsElement.md#firstelementchild)
- [id](input._internal_.SVGGraphicsElement.md#id)
- [innerHTML](input._internal_.SVGGraphicsElement.md#innerhtml)
- [isConnected](input._internal_.SVGGraphicsElement.md#isconnected)
- [lastChild](input._internal_.SVGGraphicsElement.md#lastchild)
- [lastElementChild](input._internal_.SVGGraphicsElement.md#lastelementchild)
- [localName](input._internal_.SVGGraphicsElement.md#localname)
- [namespaceURI](input._internal_.SVGGraphicsElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGGraphicsElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGGraphicsElement.md#nextsibling)
- [nodeName](input._internal_.SVGGraphicsElement.md#nodename)
- [nodeType](input._internal_.SVGGraphicsElement.md#nodetype)
- [nodeValue](input._internal_.SVGGraphicsElement.md#nodevalue)
- [nonce](input._internal_.SVGGraphicsElement.md#nonce)
- [onabort](input._internal_.SVGGraphicsElement.md#onabort)
- [onanimationcancel](input._internal_.SVGGraphicsElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGGraphicsElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGGraphicsElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGGraphicsElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGGraphicsElement.md#onauxclick)
- [onblur](input._internal_.SVGGraphicsElement.md#onblur)
- [oncanplay](input._internal_.SVGGraphicsElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGGraphicsElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGGraphicsElement.md#onchange)
- [onclick](input._internal_.SVGGraphicsElement.md#onclick)
- [onclose](input._internal_.SVGGraphicsElement.md#onclose)
- [oncontextmenu](input._internal_.SVGGraphicsElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGGraphicsElement.md#oncopy)
- [oncuechange](input._internal_.SVGGraphicsElement.md#oncuechange)
- [oncut](input._internal_.SVGGraphicsElement.md#oncut)
- [ondblclick](input._internal_.SVGGraphicsElement.md#ondblclick)
- [ondrag](input._internal_.SVGGraphicsElement.md#ondrag)
- [ondragend](input._internal_.SVGGraphicsElement.md#ondragend)
- [ondragenter](input._internal_.SVGGraphicsElement.md#ondragenter)
- [ondragleave](input._internal_.SVGGraphicsElement.md#ondragleave)
- [ondragover](input._internal_.SVGGraphicsElement.md#ondragover)
- [ondragstart](input._internal_.SVGGraphicsElement.md#ondragstart)
- [ondrop](input._internal_.SVGGraphicsElement.md#ondrop)
- [ondurationchange](input._internal_.SVGGraphicsElement.md#ondurationchange)
- [onemptied](input._internal_.SVGGraphicsElement.md#onemptied)
- [onended](input._internal_.SVGGraphicsElement.md#onended)
- [onerror](input._internal_.SVGGraphicsElement.md#onerror)
- [onfocus](input._internal_.SVGGraphicsElement.md#onfocus)
- [onformdata](input._internal_.SVGGraphicsElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGGraphicsElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGGraphicsElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGGraphicsElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGGraphicsElement.md#oninput)
- [oninvalid](input._internal_.SVGGraphicsElement.md#oninvalid)
- [onkeydown](input._internal_.SVGGraphicsElement.md#onkeydown)
- [onkeypress](input._internal_.SVGGraphicsElement.md#onkeypress)
- [onkeyup](input._internal_.SVGGraphicsElement.md#onkeyup)
- [onload](input._internal_.SVGGraphicsElement.md#onload)
- [onloadeddata](input._internal_.SVGGraphicsElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGGraphicsElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGGraphicsElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGGraphicsElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGGraphicsElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGGraphicsElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGGraphicsElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGGraphicsElement.md#onmousemove)
- [onmouseout](input._internal_.SVGGraphicsElement.md#onmouseout)
- [onmouseover](input._internal_.SVGGraphicsElement.md#onmouseover)
- [onmouseup](input._internal_.SVGGraphicsElement.md#onmouseup)
- [onpaste](input._internal_.SVGGraphicsElement.md#onpaste)
- [onpause](input._internal_.SVGGraphicsElement.md#onpause)
- [onplay](input._internal_.SVGGraphicsElement.md#onplay)
- [onplaying](input._internal_.SVGGraphicsElement.md#onplaying)
- [onpointercancel](input._internal_.SVGGraphicsElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGGraphicsElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGGraphicsElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGGraphicsElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGGraphicsElement.md#onpointermove)
- [onpointerout](input._internal_.SVGGraphicsElement.md#onpointerout)
- [onpointerover](input._internal_.SVGGraphicsElement.md#onpointerover)
- [onpointerup](input._internal_.SVGGraphicsElement.md#onpointerup)
- [onprogress](input._internal_.SVGGraphicsElement.md#onprogress)
- [onratechange](input._internal_.SVGGraphicsElement.md#onratechange)
- [onreset](input._internal_.SVGGraphicsElement.md#onreset)
- [onresize](input._internal_.SVGGraphicsElement.md#onresize)
- [onscroll](input._internal_.SVGGraphicsElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGGraphicsElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGGraphicsElement.md#onseeked)
- [onseeking](input._internal_.SVGGraphicsElement.md#onseeking)
- [onselect](input._internal_.SVGGraphicsElement.md#onselect)
- [onselectionchange](input._internal_.SVGGraphicsElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGGraphicsElement.md#onselectstart)
- [onslotchange](input._internal_.SVGGraphicsElement.md#onslotchange)
- [onstalled](input._internal_.SVGGraphicsElement.md#onstalled)
- [onsubmit](input._internal_.SVGGraphicsElement.md#onsubmit)
- [onsuspend](input._internal_.SVGGraphicsElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGGraphicsElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGGraphicsElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGGraphicsElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGGraphicsElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGGraphicsElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGGraphicsElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGGraphicsElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGGraphicsElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGGraphicsElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGGraphicsElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGGraphicsElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGGraphicsElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGGraphicsElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGGraphicsElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGGraphicsElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGGraphicsElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGGraphicsElement.md#onwheel)
- [outerHTML](input._internal_.SVGGraphicsElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGGraphicsElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGGraphicsElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGGraphicsElement.md#parentelement)
- [parentNode](input._internal_.SVGGraphicsElement.md#parentnode)
- [part](input._internal_.SVGGraphicsElement.md#part)
- [prefix](input._internal_.SVGGraphicsElement.md#prefix)
- [previousElementSibling](input._internal_.SVGGraphicsElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGGraphicsElement.md#previoussibling)
- [requiredExtensions](input._internal_.SVGGraphicsElement.md#requiredextensions)
- [scrollHeight](input._internal_.SVGGraphicsElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGGraphicsElement.md#scrollleft)
- [scrollTop](input._internal_.SVGGraphicsElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGGraphicsElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGGraphicsElement.md#shadowroot)
- [slot](input._internal_.SVGGraphicsElement.md#slot)
- [style](input._internal_.SVGGraphicsElement.md#style)
- [systemLanguage](input._internal_.SVGGraphicsElement.md#systemlanguage)
- [tabIndex](input._internal_.SVGGraphicsElement.md#tabindex)
- [tagName](input._internal_.SVGGraphicsElement.md#tagname)
- [textContent](input._internal_.SVGGraphicsElement.md#textcontent)
- [transform](input._internal_.SVGGraphicsElement.md#transform)
- [viewportElement](input._internal_.SVGGraphicsElement.md#viewportelement)

### Methods

- [addEventListener](input._internal_.SVGGraphicsElement.md#addeventlistener)
- [after](input._internal_.SVGGraphicsElement.md#after)
- [animate](input._internal_.SVGGraphicsElement.md#animate)
- [append](input._internal_.SVGGraphicsElement.md#append)
- [appendChild](input._internal_.SVGGraphicsElement.md#appendchild)
- [attachShadow](input._internal_.SVGGraphicsElement.md#attachshadow)
- [before](input._internal_.SVGGraphicsElement.md#before)
- [blur](input._internal_.SVGGraphicsElement.md#blur)
- [cloneNode](input._internal_.SVGGraphicsElement.md#clonenode)
- [closest](input._internal_.SVGGraphicsElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGGraphicsElement.md#comparedocumentposition)
- [contains](input._internal_.SVGGraphicsElement.md#contains)
- [dispatchEvent](input._internal_.SVGGraphicsElement.md#dispatchevent)
- [focus](input._internal_.SVGGraphicsElement.md#focus)
- [getAnimations](input._internal_.SVGGraphicsElement.md#getanimations)
- [getAttribute](input._internal_.SVGGraphicsElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGGraphicsElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGGraphicsElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGGraphicsElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGGraphicsElement.md#getattributenodens)
- [getBBox](input._internal_.SVGGraphicsElement.md#getbbox)
- [getBoundingClientRect](input._internal_.SVGGraphicsElement.md#getboundingclientrect)
- [getCTM](input._internal_.SVGGraphicsElement.md#getctm)
- [getClientRects](input._internal_.SVGGraphicsElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGGraphicsElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGGraphicsElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGGraphicsElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGGraphicsElement.md#getrootnode)
- [getScreenCTM](input._internal_.SVGGraphicsElement.md#getscreenctm)
- [hasAttribute](input._internal_.SVGGraphicsElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGGraphicsElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGGraphicsElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGGraphicsElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGGraphicsElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGGraphicsElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGGraphicsElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGGraphicsElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGGraphicsElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGGraphicsElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGGraphicsElement.md#isequalnode)
- [isSameNode](input._internal_.SVGGraphicsElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGGraphicsElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGGraphicsElement.md#lookupprefix)
- [matches](input._internal_.SVGGraphicsElement.md#matches)
- [normalize](input._internal_.SVGGraphicsElement.md#normalize)
- [prepend](input._internal_.SVGGraphicsElement.md#prepend)
- [querySelector](input._internal_.SVGGraphicsElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGGraphicsElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGGraphicsElement.md#releasepointercapture)
- [remove](input._internal_.SVGGraphicsElement.md#remove)
- [removeAttribute](input._internal_.SVGGraphicsElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGGraphicsElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGGraphicsElement.md#removeattributenode)
- [removeChild](input._internal_.SVGGraphicsElement.md#removechild)
- [removeEventListener](input._internal_.SVGGraphicsElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGGraphicsElement.md#replacechild)
- [replaceChildren](input._internal_.SVGGraphicsElement.md#replacechildren)
- [replaceWith](input._internal_.SVGGraphicsElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGGraphicsElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGGraphicsElement.md#requestpointerlock)
- [scroll](input._internal_.SVGGraphicsElement.md#scroll)
- [scrollBy](input._internal_.SVGGraphicsElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGGraphicsElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGGraphicsElement.md#scrollto)
- [setAttribute](input._internal_.SVGGraphicsElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGGraphicsElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGGraphicsElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGGraphicsElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGGraphicsElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGGraphicsElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGGraphicsElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGGraphicsElement`](../modules/input._internal_.md#svggraphicselement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
