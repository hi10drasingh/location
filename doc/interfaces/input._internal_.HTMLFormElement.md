[Droom Google Location Plugin - v1.0.16](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLFormElement

# Interface: HTMLFormElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLFormElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLFormElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLFormElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLFormElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLFormElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLFormElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLFormElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLFormElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLFormElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLFormElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLFormElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLFormElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLFormElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLFormElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLFormElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLFormElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLFormElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLFormElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLFormElement.md#text_node)
- [acceptCharset](input._internal_.HTMLFormElement.md#acceptcharset)
- [accessKey](input._internal_.HTMLFormElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLFormElement.md#accesskeylabel)
- [action](input._internal_.HTMLFormElement.md#action)
- [ariaAtomic](input._internal_.HTMLFormElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLFormElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLFormElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLFormElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLFormElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLFormElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLFormElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLFormElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLFormElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLFormElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLFormElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLFormElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLFormElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLFormElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLFormElement.md#arialevel)
- [ariaLive](input._internal_.HTMLFormElement.md#arialive)
- [ariaModal](input._internal_.HTMLFormElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLFormElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLFormElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLFormElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLFormElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLFormElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLFormElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLFormElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLFormElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLFormElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLFormElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLFormElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLFormElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLFormElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLFormElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLFormElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLFormElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLFormElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLFormElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLFormElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLFormElement.md#assignedslot)
- [attributes](input._internal_.HTMLFormElement.md#attributes)
- [autocapitalize](input._internal_.HTMLFormElement.md#autocapitalize)
- [autocomplete](input._internal_.HTMLFormElement.md#autocomplete)
- [autofocus](input._internal_.HTMLFormElement.md#autofocus)
- [baseURI](input._internal_.HTMLFormElement.md#baseuri)
- [childElementCount](input._internal_.HTMLFormElement.md#childelementcount)
- [childNodes](input._internal_.HTMLFormElement.md#childnodes)
- [children](input._internal_.HTMLFormElement.md#children)
- [classList](input._internal_.HTMLFormElement.md#classlist)
- [className](input._internal_.HTMLFormElement.md#classname)
- [clientHeight](input._internal_.HTMLFormElement.md#clientheight)
- [clientLeft](input._internal_.HTMLFormElement.md#clientleft)
- [clientTop](input._internal_.HTMLFormElement.md#clienttop)
- [clientWidth](input._internal_.HTMLFormElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLFormElement.md#contenteditable)
- [dataset](input._internal_.HTMLFormElement.md#dataset)
- [dir](input._internal_.HTMLFormElement.md#dir)
- [draggable](input._internal_.HTMLFormElement.md#draggable)
- [elements](input._internal_.HTMLFormElement.md#elements)
- [encoding](input._internal_.HTMLFormElement.md#encoding)
- [enctype](input._internal_.HTMLFormElement.md#enctype)
- [enterKeyHint](input._internal_.HTMLFormElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLFormElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLFormElement.md#firstelementchild)
- [hidden](input._internal_.HTMLFormElement.md#hidden)
- [id](input._internal_.HTMLFormElement.md#id)
- [innerHTML](input._internal_.HTMLFormElement.md#innerhtml)
- [innerText](input._internal_.HTMLFormElement.md#innertext)
- [inputMode](input._internal_.HTMLFormElement.md#inputmode)
- [isConnected](input._internal_.HTMLFormElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLFormElement.md#iscontenteditable)
- [lang](input._internal_.HTMLFormElement.md#lang)
- [lastChild](input._internal_.HTMLFormElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLFormElement.md#lastelementchild)
- [length](input._internal_.HTMLFormElement.md#length)
- [localName](input._internal_.HTMLFormElement.md#localname)
- [method](input._internal_.HTMLFormElement.md#method)
- [name](input._internal_.HTMLFormElement.md#name)
- [namespaceURI](input._internal_.HTMLFormElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLFormElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLFormElement.md#nextsibling)
- [noValidate](input._internal_.HTMLFormElement.md#novalidate)
- [nodeName](input._internal_.HTMLFormElement.md#nodename)
- [nodeType](input._internal_.HTMLFormElement.md#nodetype)
- [nodeValue](input._internal_.HTMLFormElement.md#nodevalue)
- [nonce](input._internal_.HTMLFormElement.md#nonce)
- [offsetHeight](input._internal_.HTMLFormElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLFormElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLFormElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLFormElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLFormElement.md#offsetwidth)
- [onabort](input._internal_.HTMLFormElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLFormElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLFormElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLFormElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLFormElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLFormElement.md#onauxclick)
- [onblur](input._internal_.HTMLFormElement.md#onblur)
- [oncanplay](input._internal_.HTMLFormElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLFormElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLFormElement.md#onchange)
- [onclick](input._internal_.HTMLFormElement.md#onclick)
- [onclose](input._internal_.HTMLFormElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLFormElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLFormElement.md#oncopy)
- [oncuechange](input._internal_.HTMLFormElement.md#oncuechange)
- [oncut](input._internal_.HTMLFormElement.md#oncut)
- [ondblclick](input._internal_.HTMLFormElement.md#ondblclick)
- [ondrag](input._internal_.HTMLFormElement.md#ondrag)
- [ondragend](input._internal_.HTMLFormElement.md#ondragend)
- [ondragenter](input._internal_.HTMLFormElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLFormElement.md#ondragleave)
- [ondragover](input._internal_.HTMLFormElement.md#ondragover)
- [ondragstart](input._internal_.HTMLFormElement.md#ondragstart)
- [ondrop](input._internal_.HTMLFormElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLFormElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLFormElement.md#onemptied)
- [onended](input._internal_.HTMLFormElement.md#onended)
- [onerror](input._internal_.HTMLFormElement.md#onerror)
- [onfocus](input._internal_.HTMLFormElement.md#onfocus)
- [onformdata](input._internal_.HTMLFormElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLFormElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLFormElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLFormElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLFormElement.md#oninput)
- [oninvalid](input._internal_.HTMLFormElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLFormElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLFormElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLFormElement.md#onkeyup)
- [onload](input._internal_.HTMLFormElement.md#onload)
- [onloadeddata](input._internal_.HTMLFormElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLFormElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLFormElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLFormElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLFormElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLFormElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLFormElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLFormElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLFormElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLFormElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLFormElement.md#onmouseup)
- [onpaste](input._internal_.HTMLFormElement.md#onpaste)
- [onpause](input._internal_.HTMLFormElement.md#onpause)
- [onplay](input._internal_.HTMLFormElement.md#onplay)
- [onplaying](input._internal_.HTMLFormElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLFormElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLFormElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLFormElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLFormElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLFormElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLFormElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLFormElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLFormElement.md#onpointerup)
- [onprogress](input._internal_.HTMLFormElement.md#onprogress)
- [onratechange](input._internal_.HTMLFormElement.md#onratechange)
- [onreset](input._internal_.HTMLFormElement.md#onreset)
- [onresize](input._internal_.HTMLFormElement.md#onresize)
- [onscroll](input._internal_.HTMLFormElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLFormElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLFormElement.md#onseeked)
- [onseeking](input._internal_.HTMLFormElement.md#onseeking)
- [onselect](input._internal_.HTMLFormElement.md#onselect)
- [onselectionchange](input._internal_.HTMLFormElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLFormElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLFormElement.md#onslotchange)
- [onstalled](input._internal_.HTMLFormElement.md#onstalled)
- [onsubmit](input._internal_.HTMLFormElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLFormElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLFormElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLFormElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLFormElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLFormElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLFormElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLFormElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLFormElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLFormElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLFormElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLFormElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLFormElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLFormElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLFormElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLFormElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLFormElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLFormElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLFormElement.md#onwheel)
- [outerHTML](input._internal_.HTMLFormElement.md#outerhtml)
- [outerText](input._internal_.HTMLFormElement.md#outertext)
- [ownerDocument](input._internal_.HTMLFormElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLFormElement.md#parentelement)
- [parentNode](input._internal_.HTMLFormElement.md#parentnode)
- [part](input._internal_.HTMLFormElement.md#part)
- [prefix](input._internal_.HTMLFormElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLFormElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLFormElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLFormElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLFormElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLFormElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLFormElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLFormElement.md#shadowroot)
- [slot](input._internal_.HTMLFormElement.md#slot)
- [spellcheck](input._internal_.HTMLFormElement.md#spellcheck)
- [style](input._internal_.HTMLFormElement.md#style)
- [tabIndex](input._internal_.HTMLFormElement.md#tabindex)
- [tagName](input._internal_.HTMLFormElement.md#tagname)
- [target](input._internal_.HTMLFormElement.md#target)
- [textContent](input._internal_.HTMLFormElement.md#textcontent)
- [title](input._internal_.HTMLFormElement.md#title)
- [translate](input._internal_.HTMLFormElement.md#translate)

### Methods

- [addEventListener](input._internal_.HTMLFormElement.md#addeventlistener)
- [after](input._internal_.HTMLFormElement.md#after)
- [animate](input._internal_.HTMLFormElement.md#animate)
- [append](input._internal_.HTMLFormElement.md#append)
- [appendChild](input._internal_.HTMLFormElement.md#appendchild)
- [attachInternals](input._internal_.HTMLFormElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLFormElement.md#attachshadow)
- [before](input._internal_.HTMLFormElement.md#before)
- [blur](input._internal_.HTMLFormElement.md#blur)
- [checkValidity](input._internal_.HTMLFormElement.md#checkvalidity)
- [click](input._internal_.HTMLFormElement.md#click)
- [cloneNode](input._internal_.HTMLFormElement.md#clonenode)
- [closest](input._internal_.HTMLFormElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLFormElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLFormElement.md#contains)
- [dispatchEvent](input._internal_.HTMLFormElement.md#dispatchevent)
- [focus](input._internal_.HTMLFormElement.md#focus)
- [getAnimations](input._internal_.HTMLFormElement.md#getanimations)
- [getAttribute](input._internal_.HTMLFormElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLFormElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLFormElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLFormElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLFormElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLFormElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLFormElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLFormElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLFormElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLFormElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLFormElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLFormElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLFormElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLFormElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLFormElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLFormElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLFormElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLFormElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLFormElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLFormElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLFormElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLFormElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLFormElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLFormElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLFormElement.md#lookupprefix)
- [matches](input._internal_.HTMLFormElement.md#matches)
- [normalize](input._internal_.HTMLFormElement.md#normalize)
- [prepend](input._internal_.HTMLFormElement.md#prepend)
- [querySelector](input._internal_.HTMLFormElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLFormElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLFormElement.md#releasepointercapture)
- [remove](input._internal_.HTMLFormElement.md#remove)
- [removeAttribute](input._internal_.HTMLFormElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLFormElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLFormElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLFormElement.md#removechild)
- [removeEventListener](input._internal_.HTMLFormElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLFormElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLFormElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLFormElement.md#replacewith)
- [reportValidity](input._internal_.HTMLFormElement.md#reportvalidity)
- [requestFullscreen](input._internal_.HTMLFormElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLFormElement.md#requestpointerlock)
- [requestSubmit](input._internal_.HTMLFormElement.md#requestsubmit)
- [reset](input._internal_.HTMLFormElement.md#reset)
- [scroll](input._internal_.HTMLFormElement.md#scroll)
- [scrollBy](input._internal_.HTMLFormElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLFormElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLFormElement.md#scrollto)
- [setAttribute](input._internal_.HTMLFormElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLFormElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLFormElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLFormElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLFormElement.md#setpointercapture)
- [submit](input._internal_.HTMLFormElement.md#submit)
- [toggleAttribute](input._internal_.HTMLFormElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLFormElement.md#webkitmatchesselector)
...
node_modules/typescript/lib/lib.dom.d.ts:6480
...
node_modules/typescript/lib/lib.dom.d.ts:6482
...
node_modules/typescript/lib/lib.dom.d.ts:6484
...
• `Readonly` **elements**: [`HTMLFormControlsCollection`](../modules/input._internal_.md#htmlformcontrolscollection)

Retrieves a collection, in source order, of all controls in a given form.

#### Defined in

node_modules/typescript/lib/lib.dom.d.ts:6486
...
node_modules/typescript/lib/lib.dom.d.ts:6488
...
node_modules/typescript/lib/lib.dom.d.ts:6490
...
node_modules/typescript/lib/lib.dom.d.ts:6492
...
node_modules/typescript/lib/lib.dom.d.ts:6494
...
node_modules/typescript/lib/lib.dom.d.ts:6496
...
node_modules/typescript/lib/lib.dom.d.ts:6498
...
node_modules/typescript/lib/lib.dom.d.ts:6500
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLFormElement`](../modules/input._internal_.md#htmlformelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
...
node_modules/typescript/lib/lib.dom.d.ts:6509
...
node_modules/typescript/lib/lib.dom.d.ts:6510
...
node_modules/typescript/lib/lib.dom.d.ts:6502
...
node_modules/typescript/lib/lib.dom.d.ts:6511
...
node_modules/typescript/lib/lib.dom.d.ts:6512
...
node_modules/typescript/lib/lib.dom.d.ts:6503
...
▸ **requestSubmit**(`submitter?`): `void`

#### Parameters

| Name | Type |
| :------ | :------ |
| `submitter?` | ``null`` \| [`HTMLElement`](../modules/input._internal_.md#htmlelement) |
...
node_modules/typescript/lib/lib.dom.d.ts:6504
...
node_modules/typescript/lib/lib.dom.d.ts:6506
...
node_modules/typescript/lib/lib.dom.d.ts:6508
