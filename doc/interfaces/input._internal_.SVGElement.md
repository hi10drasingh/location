[Droom Google Location Plugin - v1.0.16](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGElement

# Interface: SVGElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGElement.md#text_node)
- [ariaAtomic](input._internal_.SVGElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGElement.md#arialabel)
- [ariaLevel](input._internal_.SVGElement.md#arialevel)
- [ariaLive](input._internal_.SVGElement.md#arialive)
- [ariaModal](input._internal_.SVGElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGElement.md#assignedslot)
- [attributes](input._internal_.SVGElement.md#attributes)
- [autofocus](input._internal_.SVGElement.md#autofocus)
- [baseURI](input._internal_.SVGElement.md#baseuri)
- [childElementCount](input._internal_.SVGElement.md#childelementcount)
- [childNodes](input._internal_.SVGElement.md#childnodes)
- [children](input._internal_.SVGElement.md#children)
- [classList](input._internal_.SVGElement.md#classlist)
- [className](input._internal_.SVGElement.md#classname)
- [clientHeight](input._internal_.SVGElement.md#clientheight)
- [clientLeft](input._internal_.SVGElement.md#clientleft)
- [clientTop](input._internal_.SVGElement.md#clienttop)
- [clientWidth](input._internal_.SVGElement.md#clientwidth)
- [dataset](input._internal_.SVGElement.md#dataset)
- [firstChild](input._internal_.SVGElement.md#firstchild)
- [firstElementChild](input._internal_.SVGElement.md#firstelementchild)
- [id](input._internal_.SVGElement.md#id)
- [innerHTML](input._internal_.SVGElement.md#innerhtml)
- [isConnected](input._internal_.SVGElement.md#isconnected)
- [lastChild](input._internal_.SVGElement.md#lastchild)
- [lastElementChild](input._internal_.SVGElement.md#lastelementchild)
- [localName](input._internal_.SVGElement.md#localname)
- [namespaceURI](input._internal_.SVGElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGElement.md#nextsibling)
- [nodeName](input._internal_.SVGElement.md#nodename)
- [nodeType](input._internal_.SVGElement.md#nodetype)
- [nodeValue](input._internal_.SVGElement.md#nodevalue)
- [nonce](input._internal_.SVGElement.md#nonce)
- [onabort](input._internal_.SVGElement.md#onabort)
- [onanimationcancel](input._internal_.SVGElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGElement.md#onauxclick)
- [onblur](input._internal_.SVGElement.md#onblur)
- [oncanplay](input._internal_.SVGElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGElement.md#onchange)
- [onclick](input._internal_.SVGElement.md#onclick)
- [onclose](input._internal_.SVGElement.md#onclose)
- [oncontextmenu](input._internal_.SVGElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGElement.md#oncopy)
- [oncuechange](input._internal_.SVGElement.md#oncuechange)
- [oncut](input._internal_.SVGElement.md#oncut)
- [ondblclick](input._internal_.SVGElement.md#ondblclick)
- [ondrag](input._internal_.SVGElement.md#ondrag)
- [ondragend](input._internal_.SVGElement.md#ondragend)
- [ondragenter](input._internal_.SVGElement.md#ondragenter)
- [ondragleave](input._internal_.SVGElement.md#ondragleave)
- [ondragover](input._internal_.SVGElement.md#ondragover)
- [ondragstart](input._internal_.SVGElement.md#ondragstart)
- [ondrop](input._internal_.SVGElement.md#ondrop)
- [ondurationchange](input._internal_.SVGElement.md#ondurationchange)
- [onemptied](input._internal_.SVGElement.md#onemptied)
- [onended](input._internal_.SVGElement.md#onended)
- [onerror](input._internal_.SVGElement.md#onerror)
- [onfocus](input._internal_.SVGElement.md#onfocus)
- [onformdata](input._internal_.SVGElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGElement.md#oninput)
- [oninvalid](input._internal_.SVGElement.md#oninvalid)
- [onkeydown](input._internal_.SVGElement.md#onkeydown)
- [onkeypress](input._internal_.SVGElement.md#onkeypress)
- [onkeyup](input._internal_.SVGElement.md#onkeyup)
- [onload](input._internal_.SVGElement.md#onload)
- [onloadeddata](input._internal_.SVGElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGElement.md#onmousemove)
- [onmouseout](input._internal_.SVGElement.md#onmouseout)
- [onmouseover](input._internal_.SVGElement.md#onmouseover)
- [onmouseup](input._internal_.SVGElement.md#onmouseup)
- [onpaste](input._internal_.SVGElement.md#onpaste)
- [onpause](input._internal_.SVGElement.md#onpause)
- [onplay](input._internal_.SVGElement.md#onplay)
- [onplaying](input._internal_.SVGElement.md#onplaying)
- [onpointercancel](input._internal_.SVGElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGElement.md#onpointermove)
- [onpointerout](input._internal_.SVGElement.md#onpointerout)
- [onpointerover](input._internal_.SVGElement.md#onpointerover)
- [onpointerup](input._internal_.SVGElement.md#onpointerup)
- [onprogress](input._internal_.SVGElement.md#onprogress)
- [onratechange](input._internal_.SVGElement.md#onratechange)
- [onreset](input._internal_.SVGElement.md#onreset)
- [onresize](input._internal_.SVGElement.md#onresize)
- [onscroll](input._internal_.SVGElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGElement.md#onseeked)
- [onseeking](input._internal_.SVGElement.md#onseeking)
- [onselect](input._internal_.SVGElement.md#onselect)
- [onselectionchange](input._internal_.SVGElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGElement.md#onselectstart)
- [onslotchange](input._internal_.SVGElement.md#onslotchange)
- [onstalled](input._internal_.SVGElement.md#onstalled)
- [onsubmit](input._internal_.SVGElement.md#onsubmit)
- [onsuspend](input._internal_.SVGElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGElement.md#onwheel)
- [outerHTML](input._internal_.SVGElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGElement.md#parentelement)
- [parentNode](input._internal_.SVGElement.md#parentnode)
- [part](input._internal_.SVGElement.md#part)
- [prefix](input._internal_.SVGElement.md#prefix)
- [previousElementSibling](input._internal_.SVGElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGElement.md#previoussibling)
- [scrollHeight](input._internal_.SVGElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGElement.md#scrollleft)
- [scrollTop](input._internal_.SVGElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGElement.md#shadowroot)
- [slot](input._internal_.SVGElement.md#slot)
- [style](input._internal_.SVGElement.md#style)
- [tabIndex](input._internal_.SVGElement.md#tabindex)
- [tagName](input._internal_.SVGElement.md#tagname)
- [textContent](input._internal_.SVGElement.md#textcontent)
- [viewportElement](input._internal_.SVGElement.md#viewportelement)

### Methods

- [addEventListener](input._internal_.SVGElement.md#addeventlistener)
- [after](input._internal_.SVGElement.md#after)
- [animate](input._internal_.SVGElement.md#animate)
- [append](input._internal_.SVGElement.md#append)
- [appendChild](input._internal_.SVGElement.md#appendchild)
- [attachShadow](input._internal_.SVGElement.md#attachshadow)
- [before](input._internal_.SVGElement.md#before)
- [blur](input._internal_.SVGElement.md#blur)
- [cloneNode](input._internal_.SVGElement.md#clonenode)
- [closest](input._internal_.SVGElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGElement.md#comparedocumentposition)
- [contains](input._internal_.SVGElement.md#contains)
- [dispatchEvent](input._internal_.SVGElement.md#dispatchevent)
- [focus](input._internal_.SVGElement.md#focus)
- [getAnimations](input._internal_.SVGElement.md#getanimations)
- [getAttribute](input._internal_.SVGElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.SVGElement.md#getboundingclientrect)
- [getClientRects](input._internal_.SVGElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGElement.md#getrootnode)
- [hasAttribute](input._internal_.SVGElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGElement.md#isequalnode)
- [isSameNode](input._internal_.SVGElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGElement.md#lookupprefix)
- [matches](input._internal_.SVGElement.md#matches)
- [normalize](input._internal_.SVGElement.md#normalize)
- [prepend](input._internal_.SVGElement.md#prepend)
- [querySelector](input._internal_.SVGElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGElement.md#releasepointercapture)
- [remove](input._internal_.SVGElement.md#remove)
- [removeAttribute](input._internal_.SVGElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGElement.md#removeattributenode)
- [removeChild](input._internal_.SVGElement.md#removechild)
- [removeEventListener](input._internal_.SVGElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGElement.md#replacechild)
- [replaceChildren](input._internal_.SVGElement.md#replacechildren)
- [replaceWith](input._internal_.SVGElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGElement.md#requestpointerlock)
- [scroll](input._internal_.SVGElement.md#scroll)
- [scrollBy](input._internal_.SVGElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGElement.md#scrollto)
- [setAttribute](input._internal_.SVGElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGElement`](../modules/input._internal_.md#svgelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
