[Droom Google Location Plugin - v1.0.11](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLOptionElement

# Interface: HTMLOptionElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLOptionElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLOptionElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLOptionElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLOptionElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLOptionElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLOptionElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLOptionElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLOptionElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLOptionElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLOptionElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLOptionElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLOptionElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLOptionElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLOptionElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLOptionElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLOptionElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLOptionElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLOptionElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLOptionElement.md#text_node)
- [accessKey](input._internal_.HTMLOptionElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLOptionElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLOptionElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLOptionElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLOptionElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLOptionElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLOptionElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLOptionElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLOptionElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLOptionElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLOptionElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLOptionElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLOptionElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLOptionElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLOptionElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLOptionElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLOptionElement.md#arialevel)
- [ariaLive](input._internal_.HTMLOptionElement.md#arialive)
- [ariaModal](input._internal_.HTMLOptionElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLOptionElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLOptionElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLOptionElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLOptionElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLOptionElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLOptionElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLOptionElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLOptionElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLOptionElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLOptionElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLOptionElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLOptionElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLOptionElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLOptionElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLOptionElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLOptionElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLOptionElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLOptionElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLOptionElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLOptionElement.md#assignedslot)
- [attributes](input._internal_.HTMLOptionElement.md#attributes)
- [autocapitalize](input._internal_.HTMLOptionElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLOptionElement.md#autofocus)
- [baseURI](input._internal_.HTMLOptionElement.md#baseuri)
- [childElementCount](input._internal_.HTMLOptionElement.md#childelementcount)
- [childNodes](input._internal_.HTMLOptionElement.md#childnodes)
- [children](input._internal_.HTMLOptionElement.md#children)
- [classList](input._internal_.HTMLOptionElement.md#classlist)
- [className](input._internal_.HTMLOptionElement.md#classname)
- [clientHeight](input._internal_.HTMLOptionElement.md#clientheight)
- [clientLeft](input._internal_.HTMLOptionElement.md#clientleft)
- [clientTop](input._internal_.HTMLOptionElement.md#clienttop)
- [clientWidth](input._internal_.HTMLOptionElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLOptionElement.md#contenteditable)
- [dataset](input._internal_.HTMLOptionElement.md#dataset)
- [defaultSelected](input._internal_.HTMLOptionElement.md#defaultselected)
- [dir](input._internal_.HTMLOptionElement.md#dir)
- [disabled](input._internal_.HTMLOptionElement.md#disabled)
- [draggable](input._internal_.HTMLOptionElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLOptionElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLOptionElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLOptionElement.md#firstelementchild)
- [form](input._internal_.HTMLOptionElement.md#form)
- [hidden](input._internal_.HTMLOptionElement.md#hidden)
- [id](input._internal_.HTMLOptionElement.md#id)
- [index](input._internal_.HTMLOptionElement.md#index)
- [innerHTML](input._internal_.HTMLOptionElement.md#innerhtml)
- [innerText](input._internal_.HTMLOptionElement.md#innertext)
- [inputMode](input._internal_.HTMLOptionElement.md#inputmode)
- [isConnected](input._internal_.HTMLOptionElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLOptionElement.md#iscontenteditable)
- [label](input._internal_.HTMLOptionElement.md#label)
- [lang](input._internal_.HTMLOptionElement.md#lang)
- [lastChild](input._internal_.HTMLOptionElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLOptionElement.md#lastelementchild)
- [localName](input._internal_.HTMLOptionElement.md#localname)
- [namespaceURI](input._internal_.HTMLOptionElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLOptionElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLOptionElement.md#nextsibling)
- [nodeName](input._internal_.HTMLOptionElement.md#nodename)
- [nodeType](input._internal_.HTMLOptionElement.md#nodetype)
- [nodeValue](input._internal_.HTMLOptionElement.md#nodevalue)
- [nonce](input._internal_.HTMLOptionElement.md#nonce)
- [offsetHeight](input._internal_.HTMLOptionElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLOptionElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLOptionElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLOptionElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLOptionElement.md#offsetwidth)
- [onabort](input._internal_.HTMLOptionElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLOptionElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLOptionElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLOptionElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLOptionElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLOptionElement.md#onauxclick)
- [onblur](input._internal_.HTMLOptionElement.md#onblur)
- [oncanplay](input._internal_.HTMLOptionElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLOptionElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLOptionElement.md#onchange)
- [onclick](input._internal_.HTMLOptionElement.md#onclick)
- [onclose](input._internal_.HTMLOptionElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLOptionElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLOptionElement.md#oncopy)
- [oncuechange](input._internal_.HTMLOptionElement.md#oncuechange)
- [oncut](input._internal_.HTMLOptionElement.md#oncut)
- [ondblclick](input._internal_.HTMLOptionElement.md#ondblclick)
- [ondrag](input._internal_.HTMLOptionElement.md#ondrag)
- [ondragend](input._internal_.HTMLOptionElement.md#ondragend)
- [ondragenter](input._internal_.HTMLOptionElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLOptionElement.md#ondragleave)
- [ondragover](input._internal_.HTMLOptionElement.md#ondragover)
- [ondragstart](input._internal_.HTMLOptionElement.md#ondragstart)
- [ondrop](input._internal_.HTMLOptionElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLOptionElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLOptionElement.md#onemptied)
- [onended](input._internal_.HTMLOptionElement.md#onended)
- [onerror](input._internal_.HTMLOptionElement.md#onerror)
- [onfocus](input._internal_.HTMLOptionElement.md#onfocus)
- [onformdata](input._internal_.HTMLOptionElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLOptionElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLOptionElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLOptionElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLOptionElement.md#oninput)
- [oninvalid](input._internal_.HTMLOptionElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLOptionElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLOptionElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLOptionElement.md#onkeyup)
- [onload](input._internal_.HTMLOptionElement.md#onload)
- [onloadeddata](input._internal_.HTMLOptionElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLOptionElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLOptionElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLOptionElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLOptionElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLOptionElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLOptionElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLOptionElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLOptionElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLOptionElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLOptionElement.md#onmouseup)
- [onpaste](input._internal_.HTMLOptionElement.md#onpaste)
- [onpause](input._internal_.HTMLOptionElement.md#onpause)
- [onplay](input._internal_.HTMLOptionElement.md#onplay)
- [onplaying](input._internal_.HTMLOptionElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLOptionElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLOptionElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLOptionElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLOptionElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLOptionElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLOptionElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLOptionElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLOptionElement.md#onpointerup)
- [onprogress](input._internal_.HTMLOptionElement.md#onprogress)
- [onratechange](input._internal_.HTMLOptionElement.md#onratechange)
- [onreset](input._internal_.HTMLOptionElement.md#onreset)
- [onresize](input._internal_.HTMLOptionElement.md#onresize)
- [onscroll](input._internal_.HTMLOptionElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLOptionElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLOptionElement.md#onseeked)
- [onseeking](input._internal_.HTMLOptionElement.md#onseeking)
- [onselect](input._internal_.HTMLOptionElement.md#onselect)
- [onselectionchange](input._internal_.HTMLOptionElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLOptionElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLOptionElement.md#onslotchange)
- [onstalled](input._internal_.HTMLOptionElement.md#onstalled)
- [onsubmit](input._internal_.HTMLOptionElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLOptionElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLOptionElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLOptionElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLOptionElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLOptionElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLOptionElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLOptionElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLOptionElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLOptionElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLOptionElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLOptionElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLOptionElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLOptionElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLOptionElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLOptionElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLOptionElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLOptionElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLOptionElement.md#onwheel)
- [outerHTML](input._internal_.HTMLOptionElement.md#outerhtml)
- [outerText](input._internal_.HTMLOptionElement.md#outertext)
- [ownerDocument](input._internal_.HTMLOptionElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLOptionElement.md#parentelement)
- [parentNode](input._internal_.HTMLOptionElement.md#parentnode)
- [part](input._internal_.HTMLOptionElement.md#part)
- [prefix](input._internal_.HTMLOptionElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLOptionElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLOptionElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLOptionElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLOptionElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLOptionElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLOptionElement.md#scrollwidth)
- [selected](input._internal_.HTMLOptionElement.md#selected)
- [shadowRoot](input._internal_.HTMLOptionElement.md#shadowroot)
- [slot](input._internal_.HTMLOptionElement.md#slot)
- [spellcheck](input._internal_.HTMLOptionElement.md#spellcheck)
- [style](input._internal_.HTMLOptionElement.md#style)
- [tabIndex](input._internal_.HTMLOptionElement.md#tabindex)
- [tagName](input._internal_.HTMLOptionElement.md#tagname)
- [text](input._internal_.HTMLOptionElement.md#text)
- [textContent](input._internal_.HTMLOptionElement.md#textcontent)
- [title](input._internal_.HTMLOptionElement.md#title)
- [translate](input._internal_.HTMLOptionElement.md#translate)
- [value](input._internal_.HTMLOptionElement.md#value)

### Methods

- [addEventListener](input._internal_.HTMLOptionElement.md#addeventlistener)
- [after](input._internal_.HTMLOptionElement.md#after)
- [animate](input._internal_.HTMLOptionElement.md#animate)
- [append](input._internal_.HTMLOptionElement.md#append)
- [appendChild](input._internal_.HTMLOptionElement.md#appendchild)
- [attachInternals](input._internal_.HTMLOptionElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLOptionElement.md#attachshadow)
- [before](input._internal_.HTMLOptionElement.md#before)
- [blur](input._internal_.HTMLOptionElement.md#blur)
- [click](input._internal_.HTMLOptionElement.md#click)
- [cloneNode](input._internal_.HTMLOptionElement.md#clonenode)
- [closest](input._internal_.HTMLOptionElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLOptionElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLOptionElement.md#contains)
- [dispatchEvent](input._internal_.HTMLOptionElement.md#dispatchevent)
- [focus](input._internal_.HTMLOptionElement.md#focus)
- [getAnimations](input._internal_.HTMLOptionElement.md#getanimations)
- [getAttribute](input._internal_.HTMLOptionElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLOptionElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLOptionElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLOptionElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLOptionElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLOptionElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLOptionElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLOptionElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLOptionElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLOptionElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLOptionElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLOptionElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLOptionElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLOptionElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLOptionElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLOptionElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLOptionElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLOptionElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLOptionElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLOptionElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLOptionElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLOptionElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLOptionElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLOptionElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLOptionElement.md#lookupprefix)
- [matches](input._internal_.HTMLOptionElement.md#matches)
- [normalize](input._internal_.HTMLOptionElement.md#normalize)
- [prepend](input._internal_.HTMLOptionElement.md#prepend)
- [querySelector](input._internal_.HTMLOptionElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLOptionElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLOptionElement.md#releasepointercapture)
- [remove](input._internal_.HTMLOptionElement.md#remove)
- [removeAttribute](input._internal_.HTMLOptionElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLOptionElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLOptionElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLOptionElement.md#removechild)
- [removeEventListener](input._internal_.HTMLOptionElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLOptionElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLOptionElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLOptionElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLOptionElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLOptionElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLOptionElement.md#scroll)
- [scrollBy](input._internal_.HTMLOptionElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLOptionElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLOptionElement.md#scrollto)
- [setAttribute](input._internal_.HTMLOptionElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLOptionElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLOptionElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLOptionElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLOptionElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLOptionElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLOptionElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLOptionElement`](../modules/input._internal_.md#htmloptionelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
