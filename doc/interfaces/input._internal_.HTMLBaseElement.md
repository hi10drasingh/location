[Droom Google Location Plugin - v1.0.10](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLBaseElement

# Interface: HTMLBaseElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLBaseElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLBaseElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLBaseElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLBaseElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLBaseElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLBaseElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLBaseElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLBaseElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLBaseElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLBaseElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLBaseElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLBaseElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLBaseElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLBaseElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLBaseElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLBaseElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLBaseElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLBaseElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLBaseElement.md#text_node)
- [accessKey](input._internal_.HTMLBaseElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLBaseElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLBaseElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLBaseElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLBaseElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLBaseElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLBaseElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLBaseElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLBaseElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLBaseElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLBaseElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLBaseElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLBaseElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLBaseElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLBaseElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLBaseElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLBaseElement.md#arialevel)
- [ariaLive](input._internal_.HTMLBaseElement.md#arialive)
- [ariaModal](input._internal_.HTMLBaseElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLBaseElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLBaseElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLBaseElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLBaseElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLBaseElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLBaseElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLBaseElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLBaseElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLBaseElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLBaseElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLBaseElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLBaseElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLBaseElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLBaseElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLBaseElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLBaseElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLBaseElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLBaseElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLBaseElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLBaseElement.md#assignedslot)
- [attributes](input._internal_.HTMLBaseElement.md#attributes)
- [autocapitalize](input._internal_.HTMLBaseElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLBaseElement.md#autofocus)
- [baseURI](input._internal_.HTMLBaseElement.md#baseuri)
- [childElementCount](input._internal_.HTMLBaseElement.md#childelementcount)
- [childNodes](input._internal_.HTMLBaseElement.md#childnodes)
- [children](input._internal_.HTMLBaseElement.md#children)
- [classList](input._internal_.HTMLBaseElement.md#classlist)
- [className](input._internal_.HTMLBaseElement.md#classname)
- [clientHeight](input._internal_.HTMLBaseElement.md#clientheight)
- [clientLeft](input._internal_.HTMLBaseElement.md#clientleft)
- [clientTop](input._internal_.HTMLBaseElement.md#clienttop)
- [clientWidth](input._internal_.HTMLBaseElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLBaseElement.md#contenteditable)
- [dataset](input._internal_.HTMLBaseElement.md#dataset)
- [dir](input._internal_.HTMLBaseElement.md#dir)
- [draggable](input._internal_.HTMLBaseElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLBaseElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLBaseElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLBaseElement.md#firstelementchild)
- [hidden](input._internal_.HTMLBaseElement.md#hidden)
- [href](input._internal_.HTMLBaseElement.md#href)
- [id](input._internal_.HTMLBaseElement.md#id)
- [innerHTML](input._internal_.HTMLBaseElement.md#innerhtml)
- [innerText](input._internal_.HTMLBaseElement.md#innertext)
- [inputMode](input._internal_.HTMLBaseElement.md#inputmode)
- [isConnected](input._internal_.HTMLBaseElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLBaseElement.md#iscontenteditable)
- [lang](input._internal_.HTMLBaseElement.md#lang)
- [lastChild](input._internal_.HTMLBaseElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLBaseElement.md#lastelementchild)
- [localName](input._internal_.HTMLBaseElement.md#localname)
- [namespaceURI](input._internal_.HTMLBaseElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLBaseElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLBaseElement.md#nextsibling)
- [nodeName](input._internal_.HTMLBaseElement.md#nodename)
- [nodeType](input._internal_.HTMLBaseElement.md#nodetype)
- [nodeValue](input._internal_.HTMLBaseElement.md#nodevalue)
- [nonce](input._internal_.HTMLBaseElement.md#nonce)
- [offsetHeight](input._internal_.HTMLBaseElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLBaseElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLBaseElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLBaseElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLBaseElement.md#offsetwidth)
- [onabort](input._internal_.HTMLBaseElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLBaseElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLBaseElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLBaseElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLBaseElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLBaseElement.md#onauxclick)
- [onblur](input._internal_.HTMLBaseElement.md#onblur)
- [oncanplay](input._internal_.HTMLBaseElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLBaseElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLBaseElement.md#onchange)
- [onclick](input._internal_.HTMLBaseElement.md#onclick)
- [onclose](input._internal_.HTMLBaseElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLBaseElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLBaseElement.md#oncopy)
- [oncuechange](input._internal_.HTMLBaseElement.md#oncuechange)
- [oncut](input._internal_.HTMLBaseElement.md#oncut)
- [ondblclick](input._internal_.HTMLBaseElement.md#ondblclick)
- [ondrag](input._internal_.HTMLBaseElement.md#ondrag)
- [ondragend](input._internal_.HTMLBaseElement.md#ondragend)
- [ondragenter](input._internal_.HTMLBaseElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLBaseElement.md#ondragleave)
- [ondragover](input._internal_.HTMLBaseElement.md#ondragover)
- [ondragstart](input._internal_.HTMLBaseElement.md#ondragstart)
- [ondrop](input._internal_.HTMLBaseElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLBaseElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLBaseElement.md#onemptied)
- [onended](input._internal_.HTMLBaseElement.md#onended)
- [onerror](input._internal_.HTMLBaseElement.md#onerror)
- [onfocus](input._internal_.HTMLBaseElement.md#onfocus)
- [onformdata](input._internal_.HTMLBaseElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLBaseElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLBaseElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLBaseElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLBaseElement.md#oninput)
- [oninvalid](input._internal_.HTMLBaseElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLBaseElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLBaseElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLBaseElement.md#onkeyup)
- [onload](input._internal_.HTMLBaseElement.md#onload)
- [onloadeddata](input._internal_.HTMLBaseElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLBaseElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLBaseElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLBaseElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLBaseElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLBaseElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLBaseElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLBaseElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLBaseElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLBaseElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLBaseElement.md#onmouseup)
- [onpaste](input._internal_.HTMLBaseElement.md#onpaste)
- [onpause](input._internal_.HTMLBaseElement.md#onpause)
- [onplay](input._internal_.HTMLBaseElement.md#onplay)
- [onplaying](input._internal_.HTMLBaseElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLBaseElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLBaseElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLBaseElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLBaseElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLBaseElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLBaseElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLBaseElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLBaseElement.md#onpointerup)
- [onprogress](input._internal_.HTMLBaseElement.md#onprogress)
- [onratechange](input._internal_.HTMLBaseElement.md#onratechange)
- [onreset](input._internal_.HTMLBaseElement.md#onreset)
- [onresize](input._internal_.HTMLBaseElement.md#onresize)
- [onscroll](input._internal_.HTMLBaseElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLBaseElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLBaseElement.md#onseeked)
- [onseeking](input._internal_.HTMLBaseElement.md#onseeking)
- [onselect](input._internal_.HTMLBaseElement.md#onselect)
- [onselectionchange](input._internal_.HTMLBaseElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLBaseElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLBaseElement.md#onslotchange)
- [onstalled](input._internal_.HTMLBaseElement.md#onstalled)
- [onsubmit](input._internal_.HTMLBaseElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLBaseElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLBaseElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLBaseElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLBaseElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLBaseElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLBaseElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLBaseElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLBaseElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLBaseElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLBaseElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLBaseElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLBaseElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLBaseElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLBaseElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLBaseElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLBaseElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLBaseElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLBaseElement.md#onwheel)
- [outerHTML](input._internal_.HTMLBaseElement.md#outerhtml)
- [outerText](input._internal_.HTMLBaseElement.md#outertext)
- [ownerDocument](input._internal_.HTMLBaseElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLBaseElement.md#parentelement)
- [parentNode](input._internal_.HTMLBaseElement.md#parentnode)
- [part](input._internal_.HTMLBaseElement.md#part)
- [prefix](input._internal_.HTMLBaseElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLBaseElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLBaseElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLBaseElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLBaseElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLBaseElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLBaseElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLBaseElement.md#shadowroot)
- [slot](input._internal_.HTMLBaseElement.md#slot)
- [spellcheck](input._internal_.HTMLBaseElement.md#spellcheck)
- [style](input._internal_.HTMLBaseElement.md#style)
- [tabIndex](input._internal_.HTMLBaseElement.md#tabindex)
- [tagName](input._internal_.HTMLBaseElement.md#tagname)
- [target](input._internal_.HTMLBaseElement.md#target)
- [textContent](input._internal_.HTMLBaseElement.md#textcontent)
- [title](input._internal_.HTMLBaseElement.md#title)
- [translate](input._internal_.HTMLBaseElement.md#translate)

### Methods

- [addEventListener](input._internal_.HTMLBaseElement.md#addeventlistener)
- [after](input._internal_.HTMLBaseElement.md#after)
- [animate](input._internal_.HTMLBaseElement.md#animate)
- [append](input._internal_.HTMLBaseElement.md#append)
- [appendChild](input._internal_.HTMLBaseElement.md#appendchild)
- [attachInternals](input._internal_.HTMLBaseElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLBaseElement.md#attachshadow)
- [before](input._internal_.HTMLBaseElement.md#before)
- [blur](input._internal_.HTMLBaseElement.md#blur)
- [click](input._internal_.HTMLBaseElement.md#click)
- [cloneNode](input._internal_.HTMLBaseElement.md#clonenode)
- [closest](input._internal_.HTMLBaseElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLBaseElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLBaseElement.md#contains)
- [dispatchEvent](input._internal_.HTMLBaseElement.md#dispatchevent)
- [focus](input._internal_.HTMLBaseElement.md#focus)
- [getAnimations](input._internal_.HTMLBaseElement.md#getanimations)
- [getAttribute](input._internal_.HTMLBaseElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLBaseElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLBaseElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLBaseElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLBaseElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLBaseElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLBaseElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLBaseElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLBaseElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLBaseElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLBaseElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLBaseElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLBaseElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLBaseElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLBaseElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLBaseElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLBaseElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLBaseElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLBaseElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLBaseElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLBaseElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLBaseElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLBaseElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLBaseElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLBaseElement.md#lookupprefix)
- [matches](input._internal_.HTMLBaseElement.md#matches)
- [normalize](input._internal_.HTMLBaseElement.md#normalize)
- [prepend](input._internal_.HTMLBaseElement.md#prepend)
- [querySelector](input._internal_.HTMLBaseElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLBaseElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLBaseElement.md#releasepointercapture)
- [remove](input._internal_.HTMLBaseElement.md#remove)
- [removeAttribute](input._internal_.HTMLBaseElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLBaseElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLBaseElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLBaseElement.md#removechild)
- [removeEventListener](input._internal_.HTMLBaseElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLBaseElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLBaseElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLBaseElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLBaseElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLBaseElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLBaseElement.md#scroll)
- [scrollBy](input._internal_.HTMLBaseElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLBaseElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLBaseElement.md#scrollto)
- [setAttribute](input._internal_.HTMLBaseElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLBaseElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLBaseElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLBaseElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLBaseElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLBaseElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLBaseElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLBaseElement`](../modules/input._internal_.md#htmlbaseelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
