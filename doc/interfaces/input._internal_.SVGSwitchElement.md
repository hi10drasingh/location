[Droom Google Location Plugin - v1.0.16](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGSwitchElement

# Interface: SVGSwitchElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGSwitchElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGSwitchElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGSwitchElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGSwitchElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGSwitchElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGSwitchElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGSwitchElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGSwitchElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGSwitchElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGSwitchElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGSwitchElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGSwitchElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGSwitchElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGSwitchElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGSwitchElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGSwitchElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGSwitchElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGSwitchElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGSwitchElement.md#text_node)
- [ariaAtomic](input._internal_.SVGSwitchElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGSwitchElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGSwitchElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGSwitchElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGSwitchElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGSwitchElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGSwitchElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGSwitchElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGSwitchElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGSwitchElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGSwitchElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGSwitchElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGSwitchElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGSwitchElement.md#arialabel)
- [ariaLevel](input._internal_.SVGSwitchElement.md#arialevel)
- [ariaLive](input._internal_.SVGSwitchElement.md#arialive)
- [ariaModal](input._internal_.SVGSwitchElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGSwitchElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGSwitchElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGSwitchElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGSwitchElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGSwitchElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGSwitchElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGSwitchElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGSwitchElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGSwitchElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGSwitchElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGSwitchElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGSwitchElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGSwitchElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGSwitchElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGSwitchElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGSwitchElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGSwitchElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGSwitchElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGSwitchElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGSwitchElement.md#assignedslot)
- [attributes](input._internal_.SVGSwitchElement.md#attributes)
- [autofocus](input._internal_.SVGSwitchElement.md#autofocus)
- [baseURI](input._internal_.SVGSwitchElement.md#baseuri)
- [childElementCount](input._internal_.SVGSwitchElement.md#childelementcount)
- [childNodes](input._internal_.SVGSwitchElement.md#childnodes)
- [children](input._internal_.SVGSwitchElement.md#children)
- [classList](input._internal_.SVGSwitchElement.md#classlist)
- [className](input._internal_.SVGSwitchElement.md#classname)
- [clientHeight](input._internal_.SVGSwitchElement.md#clientheight)
- [clientLeft](input._internal_.SVGSwitchElement.md#clientleft)
- [clientTop](input._internal_.SVGSwitchElement.md#clienttop)
- [clientWidth](input._internal_.SVGSwitchElement.md#clientwidth)
- [dataset](input._internal_.SVGSwitchElement.md#dataset)
- [firstChild](input._internal_.SVGSwitchElement.md#firstchild)
- [firstElementChild](input._internal_.SVGSwitchElement.md#firstelementchild)
- [id](input._internal_.SVGSwitchElement.md#id)
- [innerHTML](input._internal_.SVGSwitchElement.md#innerhtml)
- [isConnected](input._internal_.SVGSwitchElement.md#isconnected)
- [lastChild](input._internal_.SVGSwitchElement.md#lastchild)
- [lastElementChild](input._internal_.SVGSwitchElement.md#lastelementchild)
- [localName](input._internal_.SVGSwitchElement.md#localname)
- [namespaceURI](input._internal_.SVGSwitchElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGSwitchElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGSwitchElement.md#nextsibling)
- [nodeName](input._internal_.SVGSwitchElement.md#nodename)
- [nodeType](input._internal_.SVGSwitchElement.md#nodetype)
- [nodeValue](input._internal_.SVGSwitchElement.md#nodevalue)
- [nonce](input._internal_.SVGSwitchElement.md#nonce)
- [onabort](input._internal_.SVGSwitchElement.md#onabort)
- [onanimationcancel](input._internal_.SVGSwitchElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGSwitchElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGSwitchElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGSwitchElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGSwitchElement.md#onauxclick)
- [onblur](input._internal_.SVGSwitchElement.md#onblur)
- [oncanplay](input._internal_.SVGSwitchElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGSwitchElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGSwitchElement.md#onchange)
- [onclick](input._internal_.SVGSwitchElement.md#onclick)
- [onclose](input._internal_.SVGSwitchElement.md#onclose)
- [oncontextmenu](input._internal_.SVGSwitchElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGSwitchElement.md#oncopy)
- [oncuechange](input._internal_.SVGSwitchElement.md#oncuechange)
- [oncut](input._internal_.SVGSwitchElement.md#oncut)
- [ondblclick](input._internal_.SVGSwitchElement.md#ondblclick)
- [ondrag](input._internal_.SVGSwitchElement.md#ondrag)
- [ondragend](input._internal_.SVGSwitchElement.md#ondragend)
- [ondragenter](input._internal_.SVGSwitchElement.md#ondragenter)
- [ondragleave](input._internal_.SVGSwitchElement.md#ondragleave)
- [ondragover](input._internal_.SVGSwitchElement.md#ondragover)
- [ondragstart](input._internal_.SVGSwitchElement.md#ondragstart)
- [ondrop](input._internal_.SVGSwitchElement.md#ondrop)
- [ondurationchange](input._internal_.SVGSwitchElement.md#ondurationchange)
- [onemptied](input._internal_.SVGSwitchElement.md#onemptied)
- [onended](input._internal_.SVGSwitchElement.md#onended)
- [onerror](input._internal_.SVGSwitchElement.md#onerror)
- [onfocus](input._internal_.SVGSwitchElement.md#onfocus)
- [onformdata](input._internal_.SVGSwitchElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGSwitchElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGSwitchElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGSwitchElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGSwitchElement.md#oninput)
- [oninvalid](input._internal_.SVGSwitchElement.md#oninvalid)
- [onkeydown](input._internal_.SVGSwitchElement.md#onkeydown)
- [onkeypress](input._internal_.SVGSwitchElement.md#onkeypress)
- [onkeyup](input._internal_.SVGSwitchElement.md#onkeyup)
- [onload](input._internal_.SVGSwitchElement.md#onload)
- [onloadeddata](input._internal_.SVGSwitchElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGSwitchElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGSwitchElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGSwitchElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGSwitchElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGSwitchElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGSwitchElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGSwitchElement.md#onmousemove)
- [onmouseout](input._internal_.SVGSwitchElement.md#onmouseout)
- [onmouseover](input._internal_.SVGSwitchElement.md#onmouseover)
- [onmouseup](input._internal_.SVGSwitchElement.md#onmouseup)
- [onpaste](input._internal_.SVGSwitchElement.md#onpaste)
- [onpause](input._internal_.SVGSwitchElement.md#onpause)
- [onplay](input._internal_.SVGSwitchElement.md#onplay)
- [onplaying](input._internal_.SVGSwitchElement.md#onplaying)
- [onpointercancel](input._internal_.SVGSwitchElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGSwitchElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGSwitchElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGSwitchElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGSwitchElement.md#onpointermove)
- [onpointerout](input._internal_.SVGSwitchElement.md#onpointerout)
- [onpointerover](input._internal_.SVGSwitchElement.md#onpointerover)
- [onpointerup](input._internal_.SVGSwitchElement.md#onpointerup)
- [onprogress](input._internal_.SVGSwitchElement.md#onprogress)
- [onratechange](input._internal_.SVGSwitchElement.md#onratechange)
- [onreset](input._internal_.SVGSwitchElement.md#onreset)
- [onresize](input._internal_.SVGSwitchElement.md#onresize)
- [onscroll](input._internal_.SVGSwitchElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGSwitchElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGSwitchElement.md#onseeked)
- [onseeking](input._internal_.SVGSwitchElement.md#onseeking)
- [onselect](input._internal_.SVGSwitchElement.md#onselect)
- [onselectionchange](input._internal_.SVGSwitchElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGSwitchElement.md#onselectstart)
- [onslotchange](input._internal_.SVGSwitchElement.md#onslotchange)
- [onstalled](input._internal_.SVGSwitchElement.md#onstalled)
- [onsubmit](input._internal_.SVGSwitchElement.md#onsubmit)
- [onsuspend](input._internal_.SVGSwitchElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGSwitchElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGSwitchElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGSwitchElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGSwitchElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGSwitchElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGSwitchElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGSwitchElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGSwitchElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGSwitchElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGSwitchElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGSwitchElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGSwitchElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGSwitchElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGSwitchElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGSwitchElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGSwitchElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGSwitchElement.md#onwheel)
- [outerHTML](input._internal_.SVGSwitchElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGSwitchElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGSwitchElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGSwitchElement.md#parentelement)
- [parentNode](input._internal_.SVGSwitchElement.md#parentnode)
- [part](input._internal_.SVGSwitchElement.md#part)
- [prefix](input._internal_.SVGSwitchElement.md#prefix)
- [previousElementSibling](input._internal_.SVGSwitchElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGSwitchElement.md#previoussibling)
- [requiredExtensions](input._internal_.SVGSwitchElement.md#requiredextensions)
- [scrollHeight](input._internal_.SVGSwitchElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGSwitchElement.md#scrollleft)
- [scrollTop](input._internal_.SVGSwitchElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGSwitchElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGSwitchElement.md#shadowroot)
- [slot](input._internal_.SVGSwitchElement.md#slot)
- [style](input._internal_.SVGSwitchElement.md#style)
- [systemLanguage](input._internal_.SVGSwitchElement.md#systemlanguage)
- [tabIndex](input._internal_.SVGSwitchElement.md#tabindex)
- [tagName](input._internal_.SVGSwitchElement.md#tagname)
- [textContent](input._internal_.SVGSwitchElement.md#textcontent)
- [transform](input._internal_.SVGSwitchElement.md#transform)
- [viewportElement](input._internal_.SVGSwitchElement.md#viewportelement)

### Methods

- [addEventListener](input._internal_.SVGSwitchElement.md#addeventlistener)
- [after](input._internal_.SVGSwitchElement.md#after)
- [animate](input._internal_.SVGSwitchElement.md#animate)
- [append](input._internal_.SVGSwitchElement.md#append)
- [appendChild](input._internal_.SVGSwitchElement.md#appendchild)
- [attachShadow](input._internal_.SVGSwitchElement.md#attachshadow)
- [before](input._internal_.SVGSwitchElement.md#before)
- [blur](input._internal_.SVGSwitchElement.md#blur)
- [cloneNode](input._internal_.SVGSwitchElement.md#clonenode)
- [closest](input._internal_.SVGSwitchElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGSwitchElement.md#comparedocumentposition)
- [contains](input._internal_.SVGSwitchElement.md#contains)
- [dispatchEvent](input._internal_.SVGSwitchElement.md#dispatchevent)
- [focus](input._internal_.SVGSwitchElement.md#focus)
- [getAnimations](input._internal_.SVGSwitchElement.md#getanimations)
- [getAttribute](input._internal_.SVGSwitchElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGSwitchElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGSwitchElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGSwitchElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGSwitchElement.md#getattributenodens)
- [getBBox](input._internal_.SVGSwitchElement.md#getbbox)
- [getBoundingClientRect](input._internal_.SVGSwitchElement.md#getboundingclientrect)
- [getCTM](input._internal_.SVGSwitchElement.md#getctm)
- [getClientRects](input._internal_.SVGSwitchElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGSwitchElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGSwitchElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGSwitchElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGSwitchElement.md#getrootnode)
- [getScreenCTM](input._internal_.SVGSwitchElement.md#getscreenctm)
- [hasAttribute](input._internal_.SVGSwitchElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGSwitchElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGSwitchElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGSwitchElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGSwitchElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGSwitchElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGSwitchElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGSwitchElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGSwitchElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGSwitchElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGSwitchElement.md#isequalnode)
- [isSameNode](input._internal_.SVGSwitchElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGSwitchElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGSwitchElement.md#lookupprefix)
- [matches](input._internal_.SVGSwitchElement.md#matches)
- [normalize](input._internal_.SVGSwitchElement.md#normalize)
- [prepend](input._internal_.SVGSwitchElement.md#prepend)
- [querySelector](input._internal_.SVGSwitchElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGSwitchElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGSwitchElement.md#releasepointercapture)
- [remove](input._internal_.SVGSwitchElement.md#remove)
- [removeAttribute](input._internal_.SVGSwitchElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGSwitchElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGSwitchElement.md#removeattributenode)
- [removeChild](input._internal_.SVGSwitchElement.md#removechild)
- [removeEventListener](input._internal_.SVGSwitchElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGSwitchElement.md#replacechild)
- [replaceChildren](input._internal_.SVGSwitchElement.md#replacechildren)
- [replaceWith](input._internal_.SVGSwitchElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGSwitchElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGSwitchElement.md#requestpointerlock)
- [scroll](input._internal_.SVGSwitchElement.md#scroll)
- [scrollBy](input._internal_.SVGSwitchElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGSwitchElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGSwitchElement.md#scrollto)
- [setAttribute](input._internal_.SVGSwitchElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGSwitchElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGSwitchElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGSwitchElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGSwitchElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGSwitchElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGSwitchElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGSwitchElement`](../modules/input._internal_.md#svgswitchelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
