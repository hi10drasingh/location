[Droom Google Location Plugin - v1.0.11](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGAnimateElement

# Interface: SVGAnimateElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGAnimateElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGAnimateElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGAnimateElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGAnimateElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGAnimateElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGAnimateElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGAnimateElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGAnimateElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGAnimateElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGAnimateElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGAnimateElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGAnimateElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGAnimateElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGAnimateElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGAnimateElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGAnimateElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGAnimateElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGAnimateElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGAnimateElement.md#text_node)
- [ariaAtomic](input._internal_.SVGAnimateElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGAnimateElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGAnimateElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGAnimateElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGAnimateElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGAnimateElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGAnimateElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGAnimateElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGAnimateElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGAnimateElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGAnimateElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGAnimateElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGAnimateElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGAnimateElement.md#arialabel)
- [ariaLevel](input._internal_.SVGAnimateElement.md#arialevel)
- [ariaLive](input._internal_.SVGAnimateElement.md#arialive)
- [ariaModal](input._internal_.SVGAnimateElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGAnimateElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGAnimateElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGAnimateElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGAnimateElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGAnimateElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGAnimateElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGAnimateElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGAnimateElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGAnimateElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGAnimateElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGAnimateElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGAnimateElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGAnimateElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGAnimateElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGAnimateElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGAnimateElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGAnimateElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGAnimateElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGAnimateElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGAnimateElement.md#assignedslot)
- [attributes](input._internal_.SVGAnimateElement.md#attributes)
- [autofocus](input._internal_.SVGAnimateElement.md#autofocus)
- [baseURI](input._internal_.SVGAnimateElement.md#baseuri)
- [childElementCount](input._internal_.SVGAnimateElement.md#childelementcount)
- [childNodes](input._internal_.SVGAnimateElement.md#childnodes)
- [children](input._internal_.SVGAnimateElement.md#children)
- [classList](input._internal_.SVGAnimateElement.md#classlist)
- [className](input._internal_.SVGAnimateElement.md#classname)
- [clientHeight](input._internal_.SVGAnimateElement.md#clientheight)
- [clientLeft](input._internal_.SVGAnimateElement.md#clientleft)
- [clientTop](input._internal_.SVGAnimateElement.md#clienttop)
- [clientWidth](input._internal_.SVGAnimateElement.md#clientwidth)
- [dataset](input._internal_.SVGAnimateElement.md#dataset)
- [firstChild](input._internal_.SVGAnimateElement.md#firstchild)
- [firstElementChild](input._internal_.SVGAnimateElement.md#firstelementchild)
- [id](input._internal_.SVGAnimateElement.md#id)
- [innerHTML](input._internal_.SVGAnimateElement.md#innerhtml)
- [isConnected](input._internal_.SVGAnimateElement.md#isconnected)
- [lastChild](input._internal_.SVGAnimateElement.md#lastchild)
- [lastElementChild](input._internal_.SVGAnimateElement.md#lastelementchild)
- [localName](input._internal_.SVGAnimateElement.md#localname)
- [namespaceURI](input._internal_.SVGAnimateElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGAnimateElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGAnimateElement.md#nextsibling)
- [nodeName](input._internal_.SVGAnimateElement.md#nodename)
- [nodeType](input._internal_.SVGAnimateElement.md#nodetype)
- [nodeValue](input._internal_.SVGAnimateElement.md#nodevalue)
- [nonce](input._internal_.SVGAnimateElement.md#nonce)
- [onabort](input._internal_.SVGAnimateElement.md#onabort)
- [onanimationcancel](input._internal_.SVGAnimateElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGAnimateElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGAnimateElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGAnimateElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGAnimateElement.md#onauxclick)
- [onblur](input._internal_.SVGAnimateElement.md#onblur)
- [oncanplay](input._internal_.SVGAnimateElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGAnimateElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGAnimateElement.md#onchange)
- [onclick](input._internal_.SVGAnimateElement.md#onclick)
- [onclose](input._internal_.SVGAnimateElement.md#onclose)
- [oncontextmenu](input._internal_.SVGAnimateElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGAnimateElement.md#oncopy)
- [oncuechange](input._internal_.SVGAnimateElement.md#oncuechange)
- [oncut](input._internal_.SVGAnimateElement.md#oncut)
- [ondblclick](input._internal_.SVGAnimateElement.md#ondblclick)
- [ondrag](input._internal_.SVGAnimateElement.md#ondrag)
- [ondragend](input._internal_.SVGAnimateElement.md#ondragend)
- [ondragenter](input._internal_.SVGAnimateElement.md#ondragenter)
- [ondragleave](input._internal_.SVGAnimateElement.md#ondragleave)
- [ondragover](input._internal_.SVGAnimateElement.md#ondragover)
- [ondragstart](input._internal_.SVGAnimateElement.md#ondragstart)
- [ondrop](input._internal_.SVGAnimateElement.md#ondrop)
- [ondurationchange](input._internal_.SVGAnimateElement.md#ondurationchange)
- [onemptied](input._internal_.SVGAnimateElement.md#onemptied)
- [onended](input._internal_.SVGAnimateElement.md#onended)
- [onerror](input._internal_.SVGAnimateElement.md#onerror)
- [onfocus](input._internal_.SVGAnimateElement.md#onfocus)
- [onformdata](input._internal_.SVGAnimateElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGAnimateElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGAnimateElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGAnimateElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGAnimateElement.md#oninput)
- [oninvalid](input._internal_.SVGAnimateElement.md#oninvalid)
- [onkeydown](input._internal_.SVGAnimateElement.md#onkeydown)
- [onkeypress](input._internal_.SVGAnimateElement.md#onkeypress)
- [onkeyup](input._internal_.SVGAnimateElement.md#onkeyup)
- [onload](input._internal_.SVGAnimateElement.md#onload)
- [onloadeddata](input._internal_.SVGAnimateElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGAnimateElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGAnimateElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGAnimateElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGAnimateElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGAnimateElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGAnimateElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGAnimateElement.md#onmousemove)
- [onmouseout](input._internal_.SVGAnimateElement.md#onmouseout)
- [onmouseover](input._internal_.SVGAnimateElement.md#onmouseover)
- [onmouseup](input._internal_.SVGAnimateElement.md#onmouseup)
- [onpaste](input._internal_.SVGAnimateElement.md#onpaste)
- [onpause](input._internal_.SVGAnimateElement.md#onpause)
- [onplay](input._internal_.SVGAnimateElement.md#onplay)
- [onplaying](input._internal_.SVGAnimateElement.md#onplaying)
- [onpointercancel](input._internal_.SVGAnimateElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGAnimateElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGAnimateElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGAnimateElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGAnimateElement.md#onpointermove)
- [onpointerout](input._internal_.SVGAnimateElement.md#onpointerout)
- [onpointerover](input._internal_.SVGAnimateElement.md#onpointerover)
- [onpointerup](input._internal_.SVGAnimateElement.md#onpointerup)
- [onprogress](input._internal_.SVGAnimateElement.md#onprogress)
- [onratechange](input._internal_.SVGAnimateElement.md#onratechange)
- [onreset](input._internal_.SVGAnimateElement.md#onreset)
- [onresize](input._internal_.SVGAnimateElement.md#onresize)
- [onscroll](input._internal_.SVGAnimateElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGAnimateElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGAnimateElement.md#onseeked)
- [onseeking](input._internal_.SVGAnimateElement.md#onseeking)
- [onselect](input._internal_.SVGAnimateElement.md#onselect)
- [onselectionchange](input._internal_.SVGAnimateElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGAnimateElement.md#onselectstart)
- [onslotchange](input._internal_.SVGAnimateElement.md#onslotchange)
- [onstalled](input._internal_.SVGAnimateElement.md#onstalled)
- [onsubmit](input._internal_.SVGAnimateElement.md#onsubmit)
- [onsuspend](input._internal_.SVGAnimateElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGAnimateElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGAnimateElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGAnimateElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGAnimateElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGAnimateElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGAnimateElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGAnimateElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGAnimateElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGAnimateElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGAnimateElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGAnimateElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGAnimateElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGAnimateElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGAnimateElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGAnimateElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGAnimateElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGAnimateElement.md#onwheel)
- [outerHTML](input._internal_.SVGAnimateElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGAnimateElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGAnimateElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGAnimateElement.md#parentelement)
- [parentNode](input._internal_.SVGAnimateElement.md#parentnode)
- [part](input._internal_.SVGAnimateElement.md#part)
- [prefix](input._internal_.SVGAnimateElement.md#prefix)
- [previousElementSibling](input._internal_.SVGAnimateElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGAnimateElement.md#previoussibling)
- [requiredExtensions](input._internal_.SVGAnimateElement.md#requiredextensions)
- [scrollHeight](input._internal_.SVGAnimateElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGAnimateElement.md#scrollleft)
- [scrollTop](input._internal_.SVGAnimateElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGAnimateElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGAnimateElement.md#shadowroot)
- [slot](input._internal_.SVGAnimateElement.md#slot)
- [style](input._internal_.SVGAnimateElement.md#style)
- [systemLanguage](input._internal_.SVGAnimateElement.md#systemlanguage)
- [tabIndex](input._internal_.SVGAnimateElement.md#tabindex)
- [tagName](input._internal_.SVGAnimateElement.md#tagname)
- [targetElement](input._internal_.SVGAnimateElement.md#targetelement)
- [textContent](input._internal_.SVGAnimateElement.md#textcontent)
- [viewportElement](input._internal_.SVGAnimateElement.md#viewportelement)

### Methods

- [addEventListener](input._internal_.SVGAnimateElement.md#addeventlistener)
- [after](input._internal_.SVGAnimateElement.md#after)
- [animate](input._internal_.SVGAnimateElement.md#animate)
- [append](input._internal_.SVGAnimateElement.md#append)
- [appendChild](input._internal_.SVGAnimateElement.md#appendchild)
- [attachShadow](input._internal_.SVGAnimateElement.md#attachshadow)
- [before](input._internal_.SVGAnimateElement.md#before)
- [beginElement](input._internal_.SVGAnimateElement.md#beginelement)
- [beginElementAt](input._internal_.SVGAnimateElement.md#beginelementat)
- [blur](input._internal_.SVGAnimateElement.md#blur)
- [cloneNode](input._internal_.SVGAnimateElement.md#clonenode)
- [closest](input._internal_.SVGAnimateElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGAnimateElement.md#comparedocumentposition)
- [contains](input._internal_.SVGAnimateElement.md#contains)
- [dispatchEvent](input._internal_.SVGAnimateElement.md#dispatchevent)
- [endElement](input._internal_.SVGAnimateElement.md#endelement)
- [endElementAt](input._internal_.SVGAnimateElement.md#endelementat)
- [focus](input._internal_.SVGAnimateElement.md#focus)
- [getAnimations](input._internal_.SVGAnimateElement.md#getanimations)
- [getAttribute](input._internal_.SVGAnimateElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGAnimateElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGAnimateElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGAnimateElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGAnimateElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.SVGAnimateElement.md#getboundingclientrect)
- [getClientRects](input._internal_.SVGAnimateElement.md#getclientrects)
- [getCurrentTime](input._internal_.SVGAnimateElement.md#getcurrenttime)
- [getElementsByClassName](input._internal_.SVGAnimateElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGAnimateElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGAnimateElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGAnimateElement.md#getrootnode)
- [getSimpleDuration](input._internal_.SVGAnimateElement.md#getsimpleduration)
- [getStartTime](input._internal_.SVGAnimateElement.md#getstarttime)
- [hasAttribute](input._internal_.SVGAnimateElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGAnimateElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGAnimateElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGAnimateElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGAnimateElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGAnimateElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGAnimateElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGAnimateElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGAnimateElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGAnimateElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGAnimateElement.md#isequalnode)
- [isSameNode](input._internal_.SVGAnimateElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGAnimateElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGAnimateElement.md#lookupprefix)
- [matches](input._internal_.SVGAnimateElement.md#matches)
- [normalize](input._internal_.SVGAnimateElement.md#normalize)
- [prepend](input._internal_.SVGAnimateElement.md#prepend)
- [querySelector](input._internal_.SVGAnimateElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGAnimateElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGAnimateElement.md#releasepointercapture)
- [remove](input._internal_.SVGAnimateElement.md#remove)
- [removeAttribute](input._internal_.SVGAnimateElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGAnimateElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGAnimateElement.md#removeattributenode)
- [removeChild](input._internal_.SVGAnimateElement.md#removechild)
- [removeEventListener](input._internal_.SVGAnimateElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGAnimateElement.md#replacechild)
- [replaceChildren](input._internal_.SVGAnimateElement.md#replacechildren)
- [replaceWith](input._internal_.SVGAnimateElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGAnimateElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGAnimateElement.md#requestpointerlock)
- [scroll](input._internal_.SVGAnimateElement.md#scroll)
- [scrollBy](input._internal_.SVGAnimateElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGAnimateElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGAnimateElement.md#scrollto)
- [setAttribute](input._internal_.SVGAnimateElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGAnimateElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGAnimateElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGAnimateElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGAnimateElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGAnimateElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGAnimateElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGAnimateElement`](../modules/input._internal_.md#svganimateelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
