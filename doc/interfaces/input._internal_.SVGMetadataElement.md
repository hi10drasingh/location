[Droom Google Location Plugin - v1.0.13](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGMetadataElement

# Interface: SVGMetadataElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGMetadataElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGMetadataElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGMetadataElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGMetadataElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGMetadataElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGMetadataElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGMetadataElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGMetadataElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGMetadataElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGMetadataElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGMetadataElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGMetadataElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGMetadataElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGMetadataElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGMetadataElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGMetadataElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGMetadataElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGMetadataElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGMetadataElement.md#text_node)
- [ariaAtomic](input._internal_.SVGMetadataElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGMetadataElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGMetadataElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGMetadataElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGMetadataElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGMetadataElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGMetadataElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGMetadataElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGMetadataElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGMetadataElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGMetadataElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGMetadataElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGMetadataElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGMetadataElement.md#arialabel)
- [ariaLevel](input._internal_.SVGMetadataElement.md#arialevel)
- [ariaLive](input._internal_.SVGMetadataElement.md#arialive)
- [ariaModal](input._internal_.SVGMetadataElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGMetadataElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGMetadataElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGMetadataElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGMetadataElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGMetadataElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGMetadataElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGMetadataElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGMetadataElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGMetadataElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGMetadataElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGMetadataElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGMetadataElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGMetadataElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGMetadataElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGMetadataElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGMetadataElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGMetadataElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGMetadataElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGMetadataElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGMetadataElement.md#assignedslot)
- [attributes](input._internal_.SVGMetadataElement.md#attributes)
- [autofocus](input._internal_.SVGMetadataElement.md#autofocus)
- [baseURI](input._internal_.SVGMetadataElement.md#baseuri)
- [childElementCount](input._internal_.SVGMetadataElement.md#childelementcount)
- [childNodes](input._internal_.SVGMetadataElement.md#childnodes)
- [children](input._internal_.SVGMetadataElement.md#children)
- [classList](input._internal_.SVGMetadataElement.md#classlist)
- [className](input._internal_.SVGMetadataElement.md#classname)
- [clientHeight](input._internal_.SVGMetadataElement.md#clientheight)
- [clientLeft](input._internal_.SVGMetadataElement.md#clientleft)
- [clientTop](input._internal_.SVGMetadataElement.md#clienttop)
- [clientWidth](input._internal_.SVGMetadataElement.md#clientwidth)
- [dataset](input._internal_.SVGMetadataElement.md#dataset)
- [firstChild](input._internal_.SVGMetadataElement.md#firstchild)
- [firstElementChild](input._internal_.SVGMetadataElement.md#firstelementchild)
- [id](input._internal_.SVGMetadataElement.md#id)
- [innerHTML](input._internal_.SVGMetadataElement.md#innerhtml)
- [isConnected](input._internal_.SVGMetadataElement.md#isconnected)
- [lastChild](input._internal_.SVGMetadataElement.md#lastchild)
- [lastElementChild](input._internal_.SVGMetadataElement.md#lastelementchild)
- [localName](input._internal_.SVGMetadataElement.md#localname)
- [namespaceURI](input._internal_.SVGMetadataElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGMetadataElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGMetadataElement.md#nextsibling)
- [nodeName](input._internal_.SVGMetadataElement.md#nodename)
- [nodeType](input._internal_.SVGMetadataElement.md#nodetype)
- [nodeValue](input._internal_.SVGMetadataElement.md#nodevalue)
- [nonce](input._internal_.SVGMetadataElement.md#nonce)
- [onabort](input._internal_.SVGMetadataElement.md#onabort)
- [onanimationcancel](input._internal_.SVGMetadataElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGMetadataElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGMetadataElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGMetadataElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGMetadataElement.md#onauxclick)
- [onblur](input._internal_.SVGMetadataElement.md#onblur)
- [oncanplay](input._internal_.SVGMetadataElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGMetadataElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGMetadataElement.md#onchange)
- [onclick](input._internal_.SVGMetadataElement.md#onclick)
- [onclose](input._internal_.SVGMetadataElement.md#onclose)
- [oncontextmenu](input._internal_.SVGMetadataElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGMetadataElement.md#oncopy)
- [oncuechange](input._internal_.SVGMetadataElement.md#oncuechange)
- [oncut](input._internal_.SVGMetadataElement.md#oncut)
- [ondblclick](input._internal_.SVGMetadataElement.md#ondblclick)
- [ondrag](input._internal_.SVGMetadataElement.md#ondrag)
- [ondragend](input._internal_.SVGMetadataElement.md#ondragend)
- [ondragenter](input._internal_.SVGMetadataElement.md#ondragenter)
- [ondragleave](input._internal_.SVGMetadataElement.md#ondragleave)
- [ondragover](input._internal_.SVGMetadataElement.md#ondragover)
- [ondragstart](input._internal_.SVGMetadataElement.md#ondragstart)
- [ondrop](input._internal_.SVGMetadataElement.md#ondrop)
- [ondurationchange](input._internal_.SVGMetadataElement.md#ondurationchange)
- [onemptied](input._internal_.SVGMetadataElement.md#onemptied)
- [onended](input._internal_.SVGMetadataElement.md#onended)
- [onerror](input._internal_.SVGMetadataElement.md#onerror)
- [onfocus](input._internal_.SVGMetadataElement.md#onfocus)
- [onformdata](input._internal_.SVGMetadataElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGMetadataElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGMetadataElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGMetadataElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGMetadataElement.md#oninput)
- [oninvalid](input._internal_.SVGMetadataElement.md#oninvalid)
- [onkeydown](input._internal_.SVGMetadataElement.md#onkeydown)
- [onkeypress](input._internal_.SVGMetadataElement.md#onkeypress)
- [onkeyup](input._internal_.SVGMetadataElement.md#onkeyup)
- [onload](input._internal_.SVGMetadataElement.md#onload)
- [onloadeddata](input._internal_.SVGMetadataElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGMetadataElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGMetadataElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGMetadataElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGMetadataElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGMetadataElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGMetadataElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGMetadataElement.md#onmousemove)
- [onmouseout](input._internal_.SVGMetadataElement.md#onmouseout)
- [onmouseover](input._internal_.SVGMetadataElement.md#onmouseover)
- [onmouseup](input._internal_.SVGMetadataElement.md#onmouseup)
- [onpaste](input._internal_.SVGMetadataElement.md#onpaste)
- [onpause](input._internal_.SVGMetadataElement.md#onpause)
- [onplay](input._internal_.SVGMetadataElement.md#onplay)
- [onplaying](input._internal_.SVGMetadataElement.md#onplaying)
- [onpointercancel](input._internal_.SVGMetadataElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGMetadataElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGMetadataElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGMetadataElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGMetadataElement.md#onpointermove)
- [onpointerout](input._internal_.SVGMetadataElement.md#onpointerout)
- [onpointerover](input._internal_.SVGMetadataElement.md#onpointerover)
- [onpointerup](input._internal_.SVGMetadataElement.md#onpointerup)
- [onprogress](input._internal_.SVGMetadataElement.md#onprogress)
- [onratechange](input._internal_.SVGMetadataElement.md#onratechange)
- [onreset](input._internal_.SVGMetadataElement.md#onreset)
- [onresize](input._internal_.SVGMetadataElement.md#onresize)
- [onscroll](input._internal_.SVGMetadataElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGMetadataElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGMetadataElement.md#onseeked)
- [onseeking](input._internal_.SVGMetadataElement.md#onseeking)
- [onselect](input._internal_.SVGMetadataElement.md#onselect)
- [onselectionchange](input._internal_.SVGMetadataElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGMetadataElement.md#onselectstart)
- [onslotchange](input._internal_.SVGMetadataElement.md#onslotchange)
- [onstalled](input._internal_.SVGMetadataElement.md#onstalled)
- [onsubmit](input._internal_.SVGMetadataElement.md#onsubmit)
- [onsuspend](input._internal_.SVGMetadataElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGMetadataElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGMetadataElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGMetadataElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGMetadataElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGMetadataElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGMetadataElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGMetadataElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGMetadataElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGMetadataElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGMetadataElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGMetadataElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGMetadataElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGMetadataElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGMetadataElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGMetadataElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGMetadataElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGMetadataElement.md#onwheel)
- [outerHTML](input._internal_.SVGMetadataElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGMetadataElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGMetadataElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGMetadataElement.md#parentelement)
- [parentNode](input._internal_.SVGMetadataElement.md#parentnode)
- [part](input._internal_.SVGMetadataElement.md#part)
- [prefix](input._internal_.SVGMetadataElement.md#prefix)
- [previousElementSibling](input._internal_.SVGMetadataElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGMetadataElement.md#previoussibling)
- [scrollHeight](input._internal_.SVGMetadataElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGMetadataElement.md#scrollleft)
- [scrollTop](input._internal_.SVGMetadataElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGMetadataElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGMetadataElement.md#shadowroot)
- [slot](input._internal_.SVGMetadataElement.md#slot)
- [style](input._internal_.SVGMetadataElement.md#style)
- [tabIndex](input._internal_.SVGMetadataElement.md#tabindex)
- [tagName](input._internal_.SVGMetadataElement.md#tagname)
- [textContent](input._internal_.SVGMetadataElement.md#textcontent)
- [viewportElement](input._internal_.SVGMetadataElement.md#viewportelement)

### Methods

- [addEventListener](input._internal_.SVGMetadataElement.md#addeventlistener)
- [after](input._internal_.SVGMetadataElement.md#after)
- [animate](input._internal_.SVGMetadataElement.md#animate)
- [append](input._internal_.SVGMetadataElement.md#append)
- [appendChild](input._internal_.SVGMetadataElement.md#appendchild)
- [attachShadow](input._internal_.SVGMetadataElement.md#attachshadow)
- [before](input._internal_.SVGMetadataElement.md#before)
- [blur](input._internal_.SVGMetadataElement.md#blur)
- [cloneNode](input._internal_.SVGMetadataElement.md#clonenode)
- [closest](input._internal_.SVGMetadataElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGMetadataElement.md#comparedocumentposition)
- [contains](input._internal_.SVGMetadataElement.md#contains)
- [dispatchEvent](input._internal_.SVGMetadataElement.md#dispatchevent)
- [focus](input._internal_.SVGMetadataElement.md#focus)
- [getAnimations](input._internal_.SVGMetadataElement.md#getanimations)
- [getAttribute](input._internal_.SVGMetadataElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGMetadataElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGMetadataElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGMetadataElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGMetadataElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.SVGMetadataElement.md#getboundingclientrect)
- [getClientRects](input._internal_.SVGMetadataElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGMetadataElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGMetadataElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGMetadataElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGMetadataElement.md#getrootnode)
- [hasAttribute](input._internal_.SVGMetadataElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGMetadataElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGMetadataElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGMetadataElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGMetadataElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGMetadataElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGMetadataElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGMetadataElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGMetadataElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGMetadataElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGMetadataElement.md#isequalnode)
- [isSameNode](input._internal_.SVGMetadataElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGMetadataElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGMetadataElement.md#lookupprefix)
- [matches](input._internal_.SVGMetadataElement.md#matches)
- [normalize](input._internal_.SVGMetadataElement.md#normalize)
- [prepend](input._internal_.SVGMetadataElement.md#prepend)
- [querySelector](input._internal_.SVGMetadataElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGMetadataElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGMetadataElement.md#releasepointercapture)
- [remove](input._internal_.SVGMetadataElement.md#remove)
- [removeAttribute](input._internal_.SVGMetadataElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGMetadataElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGMetadataElement.md#removeattributenode)
- [removeChild](input._internal_.SVGMetadataElement.md#removechild)
- [removeEventListener](input._internal_.SVGMetadataElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGMetadataElement.md#replacechild)
- [replaceChildren](input._internal_.SVGMetadataElement.md#replacechildren)
- [replaceWith](input._internal_.SVGMetadataElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGMetadataElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGMetadataElement.md#requestpointerlock)
- [scroll](input._internal_.SVGMetadataElement.md#scroll)
- [scrollBy](input._internal_.SVGMetadataElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGMetadataElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGMetadataElement.md#scrollto)
- [setAttribute](input._internal_.SVGMetadataElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGMetadataElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGMetadataElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGMetadataElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGMetadataElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGMetadataElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGMetadataElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGMetadataElement`](../modules/input._internal_.md#svgmetadataelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
