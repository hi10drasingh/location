[Droom Google Location Plugin - v1.0.10](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGFEDropShadowElement

# Interface: SVGFEDropShadowElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGFEDropShadowElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGFEDropShadowElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGFEDropShadowElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGFEDropShadowElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGFEDropShadowElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGFEDropShadowElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGFEDropShadowElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGFEDropShadowElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGFEDropShadowElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGFEDropShadowElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGFEDropShadowElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGFEDropShadowElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGFEDropShadowElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGFEDropShadowElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGFEDropShadowElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGFEDropShadowElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGFEDropShadowElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGFEDropShadowElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGFEDropShadowElement.md#text_node)
- [ariaAtomic](input._internal_.SVGFEDropShadowElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGFEDropShadowElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGFEDropShadowElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGFEDropShadowElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGFEDropShadowElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGFEDropShadowElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGFEDropShadowElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGFEDropShadowElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGFEDropShadowElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGFEDropShadowElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGFEDropShadowElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGFEDropShadowElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGFEDropShadowElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGFEDropShadowElement.md#arialabel)
- [ariaLevel](input._internal_.SVGFEDropShadowElement.md#arialevel)
- [ariaLive](input._internal_.SVGFEDropShadowElement.md#arialive)
- [ariaModal](input._internal_.SVGFEDropShadowElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGFEDropShadowElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGFEDropShadowElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGFEDropShadowElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGFEDropShadowElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGFEDropShadowElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGFEDropShadowElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGFEDropShadowElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGFEDropShadowElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGFEDropShadowElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGFEDropShadowElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGFEDropShadowElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGFEDropShadowElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGFEDropShadowElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGFEDropShadowElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGFEDropShadowElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGFEDropShadowElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGFEDropShadowElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGFEDropShadowElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGFEDropShadowElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGFEDropShadowElement.md#assignedslot)
- [attributes](input._internal_.SVGFEDropShadowElement.md#attributes)
- [autofocus](input._internal_.SVGFEDropShadowElement.md#autofocus)
- [baseURI](input._internal_.SVGFEDropShadowElement.md#baseuri)
- [childElementCount](input._internal_.SVGFEDropShadowElement.md#childelementcount)
- [childNodes](input._internal_.SVGFEDropShadowElement.md#childnodes)
- [children](input._internal_.SVGFEDropShadowElement.md#children)
- [classList](input._internal_.SVGFEDropShadowElement.md#classlist)
- [className](input._internal_.SVGFEDropShadowElement.md#classname)
- [clientHeight](input._internal_.SVGFEDropShadowElement.md#clientheight)
- [clientLeft](input._internal_.SVGFEDropShadowElement.md#clientleft)
- [clientTop](input._internal_.SVGFEDropShadowElement.md#clienttop)
- [clientWidth](input._internal_.SVGFEDropShadowElement.md#clientwidth)
- [dataset](input._internal_.SVGFEDropShadowElement.md#dataset)
- [dx](input._internal_.SVGFEDropShadowElement.md#dx)
- [dy](input._internal_.SVGFEDropShadowElement.md#dy)
- [firstChild](input._internal_.SVGFEDropShadowElement.md#firstchild)
- [firstElementChild](input._internal_.SVGFEDropShadowElement.md#firstelementchild)
- [height](input._internal_.SVGFEDropShadowElement.md#height)
- [id](input._internal_.SVGFEDropShadowElement.md#id)
- [in1](input._internal_.SVGFEDropShadowElement.md#in1)
- [innerHTML](input._internal_.SVGFEDropShadowElement.md#innerhtml)
- [isConnected](input._internal_.SVGFEDropShadowElement.md#isconnected)
- [lastChild](input._internal_.SVGFEDropShadowElement.md#lastchild)
- [lastElementChild](input._internal_.SVGFEDropShadowElement.md#lastelementchild)
- [localName](input._internal_.SVGFEDropShadowElement.md#localname)
- [namespaceURI](input._internal_.SVGFEDropShadowElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGFEDropShadowElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGFEDropShadowElement.md#nextsibling)
- [nodeName](input._internal_.SVGFEDropShadowElement.md#nodename)
- [nodeType](input._internal_.SVGFEDropShadowElement.md#nodetype)
- [nodeValue](input._internal_.SVGFEDropShadowElement.md#nodevalue)
- [nonce](input._internal_.SVGFEDropShadowElement.md#nonce)
- [onabort](input._internal_.SVGFEDropShadowElement.md#onabort)
- [onanimationcancel](input._internal_.SVGFEDropShadowElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGFEDropShadowElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGFEDropShadowElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGFEDropShadowElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGFEDropShadowElement.md#onauxclick)
- [onblur](input._internal_.SVGFEDropShadowElement.md#onblur)
- [oncanplay](input._internal_.SVGFEDropShadowElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGFEDropShadowElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGFEDropShadowElement.md#onchange)
- [onclick](input._internal_.SVGFEDropShadowElement.md#onclick)
- [onclose](input._internal_.SVGFEDropShadowElement.md#onclose)
- [oncontextmenu](input._internal_.SVGFEDropShadowElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGFEDropShadowElement.md#oncopy)
- [oncuechange](input._internal_.SVGFEDropShadowElement.md#oncuechange)
- [oncut](input._internal_.SVGFEDropShadowElement.md#oncut)
- [ondblclick](input._internal_.SVGFEDropShadowElement.md#ondblclick)
- [ondrag](input._internal_.SVGFEDropShadowElement.md#ondrag)
- [ondragend](input._internal_.SVGFEDropShadowElement.md#ondragend)
- [ondragenter](input._internal_.SVGFEDropShadowElement.md#ondragenter)
- [ondragleave](input._internal_.SVGFEDropShadowElement.md#ondragleave)
- [ondragover](input._internal_.SVGFEDropShadowElement.md#ondragover)
- [ondragstart](input._internal_.SVGFEDropShadowElement.md#ondragstart)
- [ondrop](input._internal_.SVGFEDropShadowElement.md#ondrop)
- [ondurationchange](input._internal_.SVGFEDropShadowElement.md#ondurationchange)
- [onemptied](input._internal_.SVGFEDropShadowElement.md#onemptied)
- [onended](input._internal_.SVGFEDropShadowElement.md#onended)
- [onerror](input._internal_.SVGFEDropShadowElement.md#onerror)
- [onfocus](input._internal_.SVGFEDropShadowElement.md#onfocus)
- [onformdata](input._internal_.SVGFEDropShadowElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGFEDropShadowElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGFEDropShadowElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGFEDropShadowElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGFEDropShadowElement.md#oninput)
- [oninvalid](input._internal_.SVGFEDropShadowElement.md#oninvalid)
- [onkeydown](input._internal_.SVGFEDropShadowElement.md#onkeydown)
- [onkeypress](input._internal_.SVGFEDropShadowElement.md#onkeypress)
- [onkeyup](input._internal_.SVGFEDropShadowElement.md#onkeyup)
- [onload](input._internal_.SVGFEDropShadowElement.md#onload)
- [onloadeddata](input._internal_.SVGFEDropShadowElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGFEDropShadowElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGFEDropShadowElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGFEDropShadowElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGFEDropShadowElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGFEDropShadowElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGFEDropShadowElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGFEDropShadowElement.md#onmousemove)
- [onmouseout](input._internal_.SVGFEDropShadowElement.md#onmouseout)
- [onmouseover](input._internal_.SVGFEDropShadowElement.md#onmouseover)
- [onmouseup](input._internal_.SVGFEDropShadowElement.md#onmouseup)
- [onpaste](input._internal_.SVGFEDropShadowElement.md#onpaste)
- [onpause](input._internal_.SVGFEDropShadowElement.md#onpause)
- [onplay](input._internal_.SVGFEDropShadowElement.md#onplay)
- [onplaying](input._internal_.SVGFEDropShadowElement.md#onplaying)
- [onpointercancel](input._internal_.SVGFEDropShadowElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGFEDropShadowElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGFEDropShadowElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGFEDropShadowElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGFEDropShadowElement.md#onpointermove)
- [onpointerout](input._internal_.SVGFEDropShadowElement.md#onpointerout)
- [onpointerover](input._internal_.SVGFEDropShadowElement.md#onpointerover)
- [onpointerup](input._internal_.SVGFEDropShadowElement.md#onpointerup)
- [onprogress](input._internal_.SVGFEDropShadowElement.md#onprogress)
- [onratechange](input._internal_.SVGFEDropShadowElement.md#onratechange)
- [onreset](input._internal_.SVGFEDropShadowElement.md#onreset)
- [onresize](input._internal_.SVGFEDropShadowElement.md#onresize)
- [onscroll](input._internal_.SVGFEDropShadowElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGFEDropShadowElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGFEDropShadowElement.md#onseeked)
- [onseeking](input._internal_.SVGFEDropShadowElement.md#onseeking)
- [onselect](input._internal_.SVGFEDropShadowElement.md#onselect)
- [onselectionchange](input._internal_.SVGFEDropShadowElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGFEDropShadowElement.md#onselectstart)
- [onslotchange](input._internal_.SVGFEDropShadowElement.md#onslotchange)
- [onstalled](input._internal_.SVGFEDropShadowElement.md#onstalled)
- [onsubmit](input._internal_.SVGFEDropShadowElement.md#onsubmit)
- [onsuspend](input._internal_.SVGFEDropShadowElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGFEDropShadowElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGFEDropShadowElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGFEDropShadowElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGFEDropShadowElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGFEDropShadowElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGFEDropShadowElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGFEDropShadowElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGFEDropShadowElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGFEDropShadowElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGFEDropShadowElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGFEDropShadowElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGFEDropShadowElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGFEDropShadowElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGFEDropShadowElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGFEDropShadowElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGFEDropShadowElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGFEDropShadowElement.md#onwheel)
- [outerHTML](input._internal_.SVGFEDropShadowElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGFEDropShadowElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGFEDropShadowElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGFEDropShadowElement.md#parentelement)
- [parentNode](input._internal_.SVGFEDropShadowElement.md#parentnode)
- [part](input._internal_.SVGFEDropShadowElement.md#part)
- [prefix](input._internal_.SVGFEDropShadowElement.md#prefix)
- [previousElementSibling](input._internal_.SVGFEDropShadowElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGFEDropShadowElement.md#previoussibling)
- [result](input._internal_.SVGFEDropShadowElement.md#result)
- [scrollHeight](input._internal_.SVGFEDropShadowElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGFEDropShadowElement.md#scrollleft)
- [scrollTop](input._internal_.SVGFEDropShadowElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGFEDropShadowElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGFEDropShadowElement.md#shadowroot)
- [slot](input._internal_.SVGFEDropShadowElement.md#slot)
- [stdDeviationX](input._internal_.SVGFEDropShadowElement.md#stddeviationx)
- [stdDeviationY](input._internal_.SVGFEDropShadowElement.md#stddeviationy)
- [style](input._internal_.SVGFEDropShadowElement.md#style)
- [tabIndex](input._internal_.SVGFEDropShadowElement.md#tabindex)
- [tagName](input._internal_.SVGFEDropShadowElement.md#tagname)
- [textContent](input._internal_.SVGFEDropShadowElement.md#textcontent)
- [viewportElement](input._internal_.SVGFEDropShadowElement.md#viewportelement)
- [width](input._internal_.SVGFEDropShadowElement.md#width)
- [x](input._internal_.SVGFEDropShadowElement.md#x)
- [y](input._internal_.SVGFEDropShadowElement.md#y)

### Methods

- [addEventListener](input._internal_.SVGFEDropShadowElement.md#addeventlistener)
- [after](input._internal_.SVGFEDropShadowElement.md#after)
- [animate](input._internal_.SVGFEDropShadowElement.md#animate)
- [append](input._internal_.SVGFEDropShadowElement.md#append)
- [appendChild](input._internal_.SVGFEDropShadowElement.md#appendchild)
- [attachShadow](input._internal_.SVGFEDropShadowElement.md#attachshadow)
- [before](input._internal_.SVGFEDropShadowElement.md#before)
- [blur](input._internal_.SVGFEDropShadowElement.md#blur)
- [cloneNode](input._internal_.SVGFEDropShadowElement.md#clonenode)
- [closest](input._internal_.SVGFEDropShadowElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGFEDropShadowElement.md#comparedocumentposition)
- [contains](input._internal_.SVGFEDropShadowElement.md#contains)
- [dispatchEvent](input._internal_.SVGFEDropShadowElement.md#dispatchevent)
- [focus](input._internal_.SVGFEDropShadowElement.md#focus)
- [getAnimations](input._internal_.SVGFEDropShadowElement.md#getanimations)
- [getAttribute](input._internal_.SVGFEDropShadowElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGFEDropShadowElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGFEDropShadowElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGFEDropShadowElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGFEDropShadowElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.SVGFEDropShadowElement.md#getboundingclientrect)
- [getClientRects](input._internal_.SVGFEDropShadowElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGFEDropShadowElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGFEDropShadowElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGFEDropShadowElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGFEDropShadowElement.md#getrootnode)
- [hasAttribute](input._internal_.SVGFEDropShadowElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGFEDropShadowElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGFEDropShadowElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGFEDropShadowElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGFEDropShadowElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGFEDropShadowElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGFEDropShadowElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGFEDropShadowElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGFEDropShadowElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGFEDropShadowElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGFEDropShadowElement.md#isequalnode)
- [isSameNode](input._internal_.SVGFEDropShadowElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGFEDropShadowElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGFEDropShadowElement.md#lookupprefix)
- [matches](input._internal_.SVGFEDropShadowElement.md#matches)
- [normalize](input._internal_.SVGFEDropShadowElement.md#normalize)
- [prepend](input._internal_.SVGFEDropShadowElement.md#prepend)
- [querySelector](input._internal_.SVGFEDropShadowElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGFEDropShadowElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGFEDropShadowElement.md#releasepointercapture)
- [remove](input._internal_.SVGFEDropShadowElement.md#remove)
- [removeAttribute](input._internal_.SVGFEDropShadowElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGFEDropShadowElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGFEDropShadowElement.md#removeattributenode)
- [removeChild](input._internal_.SVGFEDropShadowElement.md#removechild)
- [removeEventListener](input._internal_.SVGFEDropShadowElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGFEDropShadowElement.md#replacechild)
- [replaceChildren](input._internal_.SVGFEDropShadowElement.md#replacechildren)
- [replaceWith](input._internal_.SVGFEDropShadowElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGFEDropShadowElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGFEDropShadowElement.md#requestpointerlock)
- [scroll](input._internal_.SVGFEDropShadowElement.md#scroll)
- [scrollBy](input._internal_.SVGFEDropShadowElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGFEDropShadowElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGFEDropShadowElement.md#scrollto)
- [setAttribute](input._internal_.SVGFEDropShadowElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGFEDropShadowElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGFEDropShadowElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGFEDropShadowElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGFEDropShadowElement.md#setpointercapture)
- [setStdDeviation](input._internal_.SVGFEDropShadowElement.md#setstddeviation)
- [toggleAttribute](input._internal_.SVGFEDropShadowElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGFEDropShadowElement.md#webkitmatchesselector)
...
• `Readonly` **dx**: [`SVGAnimatedNumber`](../modules/input._internal_.md#svganimatednumber)
...
• `Readonly` **dy**: [`SVGAnimatedNumber`](../modules/input._internal_.md#svganimatednumber)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGFEDropShadowElement`](../modules/input._internal_.md#svgfedropshadowelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
