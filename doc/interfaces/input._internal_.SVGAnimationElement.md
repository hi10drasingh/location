[Droom Google Location Plugin - v1.0.16](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGAnimationElement

# Interface: SVGAnimationElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGAnimationElement

## Hierarchy

- [`SVGElement`](../modules/input._internal_.md#svgelement)

- [`SVGTests`](input._internal_.SVGTests.md)
...
- [ATTRIBUTE\_NODE](input._internal_.SVGAnimationElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGAnimationElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGAnimationElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGAnimationElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGAnimationElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGAnimationElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGAnimationElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGAnimationElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGAnimationElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGAnimationElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGAnimationElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGAnimationElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGAnimationElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGAnimationElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGAnimationElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGAnimationElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGAnimationElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGAnimationElement.md#text_node)
- [ariaAtomic](input._internal_.SVGAnimationElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGAnimationElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGAnimationElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGAnimationElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGAnimationElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGAnimationElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGAnimationElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGAnimationElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGAnimationElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGAnimationElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGAnimationElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGAnimationElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGAnimationElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGAnimationElement.md#arialabel)
- [ariaLevel](input._internal_.SVGAnimationElement.md#arialevel)
- [ariaLive](input._internal_.SVGAnimationElement.md#arialive)
- [ariaModal](input._internal_.SVGAnimationElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGAnimationElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGAnimationElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGAnimationElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGAnimationElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGAnimationElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGAnimationElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGAnimationElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGAnimationElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGAnimationElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGAnimationElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGAnimationElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGAnimationElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGAnimationElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGAnimationElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGAnimationElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGAnimationElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGAnimationElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGAnimationElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGAnimationElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGAnimationElement.md#assignedslot)
- [attributes](input._internal_.SVGAnimationElement.md#attributes)
- [autofocus](input._internal_.SVGAnimationElement.md#autofocus)
- [baseURI](input._internal_.SVGAnimationElement.md#baseuri)
- [childElementCount](input._internal_.SVGAnimationElement.md#childelementcount)
- [childNodes](input._internal_.SVGAnimationElement.md#childnodes)
- [children](input._internal_.SVGAnimationElement.md#children)
- [classList](input._internal_.SVGAnimationElement.md#classlist)
- [className](input._internal_.SVGAnimationElement.md#classname)
- [clientHeight](input._internal_.SVGAnimationElement.md#clientheight)
- [clientLeft](input._internal_.SVGAnimationElement.md#clientleft)
- [clientTop](input._internal_.SVGAnimationElement.md#clienttop)
- [clientWidth](input._internal_.SVGAnimationElement.md#clientwidth)
- [dataset](input._internal_.SVGAnimationElement.md#dataset)
- [firstChild](input._internal_.SVGAnimationElement.md#firstchild)
- [firstElementChild](input._internal_.SVGAnimationElement.md#firstelementchild)
- [id](input._internal_.SVGAnimationElement.md#id)
- [innerHTML](input._internal_.SVGAnimationElement.md#innerhtml)
- [isConnected](input._internal_.SVGAnimationElement.md#isconnected)
- [lastChild](input._internal_.SVGAnimationElement.md#lastchild)
- [lastElementChild](input._internal_.SVGAnimationElement.md#lastelementchild)
- [localName](input._internal_.SVGAnimationElement.md#localname)
- [namespaceURI](input._internal_.SVGAnimationElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGAnimationElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGAnimationElement.md#nextsibling)
- [nodeName](input._internal_.SVGAnimationElement.md#nodename)
- [nodeType](input._internal_.SVGAnimationElement.md#nodetype)
- [nodeValue](input._internal_.SVGAnimationElement.md#nodevalue)
- [nonce](input._internal_.SVGAnimationElement.md#nonce)
- [onabort](input._internal_.SVGAnimationElement.md#onabort)
- [onanimationcancel](input._internal_.SVGAnimationElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGAnimationElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGAnimationElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGAnimationElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGAnimationElement.md#onauxclick)
- [onblur](input._internal_.SVGAnimationElement.md#onblur)
- [oncanplay](input._internal_.SVGAnimationElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGAnimationElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGAnimationElement.md#onchange)
- [onclick](input._internal_.SVGAnimationElement.md#onclick)
- [onclose](input._internal_.SVGAnimationElement.md#onclose)
- [oncontextmenu](input._internal_.SVGAnimationElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGAnimationElement.md#oncopy)
- [oncuechange](input._internal_.SVGAnimationElement.md#oncuechange)
- [oncut](input._internal_.SVGAnimationElement.md#oncut)
- [ondblclick](input._internal_.SVGAnimationElement.md#ondblclick)
- [ondrag](input._internal_.SVGAnimationElement.md#ondrag)
- [ondragend](input._internal_.SVGAnimationElement.md#ondragend)
- [ondragenter](input._internal_.SVGAnimationElement.md#ondragenter)
- [ondragleave](input._internal_.SVGAnimationElement.md#ondragleave)
- [ondragover](input._internal_.SVGAnimationElement.md#ondragover)
- [ondragstart](input._internal_.SVGAnimationElement.md#ondragstart)
- [ondrop](input._internal_.SVGAnimationElement.md#ondrop)
- [ondurationchange](input._internal_.SVGAnimationElement.md#ondurationchange)
- [onemptied](input._internal_.SVGAnimationElement.md#onemptied)
- [onended](input._internal_.SVGAnimationElement.md#onended)
- [onerror](input._internal_.SVGAnimationElement.md#onerror)
- [onfocus](input._internal_.SVGAnimationElement.md#onfocus)
- [onformdata](input._internal_.SVGAnimationElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGAnimationElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGAnimationElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGAnimationElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGAnimationElement.md#oninput)
- [oninvalid](input._internal_.SVGAnimationElement.md#oninvalid)
- [onkeydown](input._internal_.SVGAnimationElement.md#onkeydown)
- [onkeypress](input._internal_.SVGAnimationElement.md#onkeypress)
- [onkeyup](input._internal_.SVGAnimationElement.md#onkeyup)
- [onload](input._internal_.SVGAnimationElement.md#onload)
- [onloadeddata](input._internal_.SVGAnimationElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGAnimationElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGAnimationElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGAnimationElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGAnimationElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGAnimationElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGAnimationElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGAnimationElement.md#onmousemove)
- [onmouseout](input._internal_.SVGAnimationElement.md#onmouseout)
- [onmouseover](input._internal_.SVGAnimationElement.md#onmouseover)
- [onmouseup](input._internal_.SVGAnimationElement.md#onmouseup)
- [onpaste](input._internal_.SVGAnimationElement.md#onpaste)
- [onpause](input._internal_.SVGAnimationElement.md#onpause)
- [onplay](input._internal_.SVGAnimationElement.md#onplay)
- [onplaying](input._internal_.SVGAnimationElement.md#onplaying)
- [onpointercancel](input._internal_.SVGAnimationElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGAnimationElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGAnimationElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGAnimationElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGAnimationElement.md#onpointermove)
- [onpointerout](input._internal_.SVGAnimationElement.md#onpointerout)
- [onpointerover](input._internal_.SVGAnimationElement.md#onpointerover)
- [onpointerup](input._internal_.SVGAnimationElement.md#onpointerup)
- [onprogress](input._internal_.SVGAnimationElement.md#onprogress)
- [onratechange](input._internal_.SVGAnimationElement.md#onratechange)
- [onreset](input._internal_.SVGAnimationElement.md#onreset)
- [onresize](input._internal_.SVGAnimationElement.md#onresize)
- [onscroll](input._internal_.SVGAnimationElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGAnimationElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGAnimationElement.md#onseeked)
- [onseeking](input._internal_.SVGAnimationElement.md#onseeking)
- [onselect](input._internal_.SVGAnimationElement.md#onselect)
- [onselectionchange](input._internal_.SVGAnimationElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGAnimationElement.md#onselectstart)
- [onslotchange](input._internal_.SVGAnimationElement.md#onslotchange)
- [onstalled](input._internal_.SVGAnimationElement.md#onstalled)
- [onsubmit](input._internal_.SVGAnimationElement.md#onsubmit)
- [onsuspend](input._internal_.SVGAnimationElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGAnimationElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGAnimationElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGAnimationElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGAnimationElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGAnimationElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGAnimationElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGAnimationElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGAnimationElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGAnimationElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGAnimationElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGAnimationElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGAnimationElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGAnimationElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGAnimationElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGAnimationElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGAnimationElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGAnimationElement.md#onwheel)
- [outerHTML](input._internal_.SVGAnimationElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGAnimationElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGAnimationElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGAnimationElement.md#parentelement)
- [parentNode](input._internal_.SVGAnimationElement.md#parentnode)
- [part](input._internal_.SVGAnimationElement.md#part)
- [prefix](input._internal_.SVGAnimationElement.md#prefix)
- [previousElementSibling](input._internal_.SVGAnimationElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGAnimationElement.md#previoussibling)
- [requiredExtensions](input._internal_.SVGAnimationElement.md#requiredextensions)
- [scrollHeight](input._internal_.SVGAnimationElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGAnimationElement.md#scrollleft)
- [scrollTop](input._internal_.SVGAnimationElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGAnimationElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGAnimationElement.md#shadowroot)
- [slot](input._internal_.SVGAnimationElement.md#slot)
- [style](input._internal_.SVGAnimationElement.md#style)
- [systemLanguage](input._internal_.SVGAnimationElement.md#systemlanguage)
- [tabIndex](input._internal_.SVGAnimationElement.md#tabindex)
- [tagName](input._internal_.SVGAnimationElement.md#tagname)
- [targetElement](input._internal_.SVGAnimationElement.md#targetelement)
- [textContent](input._internal_.SVGAnimationElement.md#textcontent)
- [viewportElement](input._internal_.SVGAnimationElement.md#viewportelement)

### Methods

- [addEventListener](input._internal_.SVGAnimationElement.md#addeventlistener)
- [after](input._internal_.SVGAnimationElement.md#after)
- [animate](input._internal_.SVGAnimationElement.md#animate)
- [append](input._internal_.SVGAnimationElement.md#append)
- [appendChild](input._internal_.SVGAnimationElement.md#appendchild)
- [attachShadow](input._internal_.SVGAnimationElement.md#attachshadow)
- [before](input._internal_.SVGAnimationElement.md#before)
- [beginElement](input._internal_.SVGAnimationElement.md#beginelement)
- [beginElementAt](input._internal_.SVGAnimationElement.md#beginelementat)
- [blur](input._internal_.SVGAnimationElement.md#blur)
- [cloneNode](input._internal_.SVGAnimationElement.md#clonenode)
- [closest](input._internal_.SVGAnimationElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGAnimationElement.md#comparedocumentposition)
- [contains](input._internal_.SVGAnimationElement.md#contains)
- [dispatchEvent](input._internal_.SVGAnimationElement.md#dispatchevent)
- [endElement](input._internal_.SVGAnimationElement.md#endelement)
- [endElementAt](input._internal_.SVGAnimationElement.md#endelementat)
- [focus](input._internal_.SVGAnimationElement.md#focus)
- [getAnimations](input._internal_.SVGAnimationElement.md#getanimations)
- [getAttribute](input._internal_.SVGAnimationElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGAnimationElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGAnimationElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGAnimationElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGAnimationElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.SVGAnimationElement.md#getboundingclientrect)
- [getClientRects](input._internal_.SVGAnimationElement.md#getclientrects)
- [getCurrentTime](input._internal_.SVGAnimationElement.md#getcurrenttime)
- [getElementsByClassName](input._internal_.SVGAnimationElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGAnimationElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGAnimationElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGAnimationElement.md#getrootnode)
- [getSimpleDuration](input._internal_.SVGAnimationElement.md#getsimpleduration)
- [getStartTime](input._internal_.SVGAnimationElement.md#getstarttime)
- [hasAttribute](input._internal_.SVGAnimationElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGAnimationElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGAnimationElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGAnimationElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGAnimationElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGAnimationElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGAnimationElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGAnimationElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGAnimationElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGAnimationElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGAnimationElement.md#isequalnode)
- [isSameNode](input._internal_.SVGAnimationElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGAnimationElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGAnimationElement.md#lookupprefix)
- [matches](input._internal_.SVGAnimationElement.md#matches)
- [normalize](input._internal_.SVGAnimationElement.md#normalize)
- [prepend](input._internal_.SVGAnimationElement.md#prepend)
- [querySelector](input._internal_.SVGAnimationElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGAnimationElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGAnimationElement.md#releasepointercapture)
- [remove](input._internal_.SVGAnimationElement.md#remove)
- [removeAttribute](input._internal_.SVGAnimationElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGAnimationElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGAnimationElement.md#removeattributenode)
- [removeChild](input._internal_.SVGAnimationElement.md#removechild)
- [removeEventListener](input._internal_.SVGAnimationElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGAnimationElement.md#replacechild)
- [replaceChildren](input._internal_.SVGAnimationElement.md#replacechildren)
- [replaceWith](input._internal_.SVGAnimationElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGAnimationElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGAnimationElement.md#requestpointerlock)
- [scroll](input._internal_.SVGAnimationElement.md#scroll)
- [scrollBy](input._internal_.SVGAnimationElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGAnimationElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGAnimationElement.md#scrollto)
- [setAttribute](input._internal_.SVGAnimationElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGAnimationElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGAnimationElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGAnimationElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGAnimationElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGAnimationElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGAnimationElement.md#webkitmatchesselector)
...
[SVGTests](input._internal_.SVGTests.md).[requiredExtensions](input._internal_.SVGTests.md#requiredextensions)
...
[SVGTests](input._internal_.SVGTests.md).[systemLanguage](input._internal_.SVGTests.md#systemlanguage)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGAnimationElement`](../modules/input._internal_.md#svganimationelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
