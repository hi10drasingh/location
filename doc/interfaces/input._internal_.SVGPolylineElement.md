[Droom Google Location Plugin - v1.0.13](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGPolylineElement

# Interface: SVGPolylineElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGPolylineElement
...
- [`SVGAnimatedPoints`](input._internal_.SVGAnimatedPoints.md)
...
- [ATTRIBUTE\_NODE](input._internal_.SVGPolylineElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGPolylineElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGPolylineElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGPolylineElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGPolylineElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGPolylineElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGPolylineElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGPolylineElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGPolylineElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGPolylineElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGPolylineElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGPolylineElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGPolylineElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGPolylineElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGPolylineElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGPolylineElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGPolylineElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGPolylineElement.md#text_node)
- [animatedPoints](input._internal_.SVGPolylineElement.md#animatedpoints)
- [ariaAtomic](input._internal_.SVGPolylineElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGPolylineElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGPolylineElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGPolylineElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGPolylineElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGPolylineElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGPolylineElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGPolylineElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGPolylineElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGPolylineElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGPolylineElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGPolylineElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGPolylineElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGPolylineElement.md#arialabel)
- [ariaLevel](input._internal_.SVGPolylineElement.md#arialevel)
- [ariaLive](input._internal_.SVGPolylineElement.md#arialive)
- [ariaModal](input._internal_.SVGPolylineElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGPolylineElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGPolylineElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGPolylineElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGPolylineElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGPolylineElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGPolylineElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGPolylineElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGPolylineElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGPolylineElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGPolylineElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGPolylineElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGPolylineElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGPolylineElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGPolylineElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGPolylineElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGPolylineElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGPolylineElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGPolylineElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGPolylineElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGPolylineElement.md#assignedslot)
- [attributes](input._internal_.SVGPolylineElement.md#attributes)
- [autofocus](input._internal_.SVGPolylineElement.md#autofocus)
- [baseURI](input._internal_.SVGPolylineElement.md#baseuri)
- [childElementCount](input._internal_.SVGPolylineElement.md#childelementcount)
- [childNodes](input._internal_.SVGPolylineElement.md#childnodes)
- [children](input._internal_.SVGPolylineElement.md#children)
- [classList](input._internal_.SVGPolylineElement.md#classlist)
- [className](input._internal_.SVGPolylineElement.md#classname)
- [clientHeight](input._internal_.SVGPolylineElement.md#clientheight)
- [clientLeft](input._internal_.SVGPolylineElement.md#clientleft)
- [clientTop](input._internal_.SVGPolylineElement.md#clienttop)
- [clientWidth](input._internal_.SVGPolylineElement.md#clientwidth)
- [dataset](input._internal_.SVGPolylineElement.md#dataset)
- [firstChild](input._internal_.SVGPolylineElement.md#firstchild)
- [firstElementChild](input._internal_.SVGPolylineElement.md#firstelementchild)
- [id](input._internal_.SVGPolylineElement.md#id)
- [innerHTML](input._internal_.SVGPolylineElement.md#innerhtml)
- [isConnected](input._internal_.SVGPolylineElement.md#isconnected)
- [lastChild](input._internal_.SVGPolylineElement.md#lastchild)
- [lastElementChild](input._internal_.SVGPolylineElement.md#lastelementchild)
- [localName](input._internal_.SVGPolylineElement.md#localname)
- [namespaceURI](input._internal_.SVGPolylineElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGPolylineElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGPolylineElement.md#nextsibling)
- [nodeName](input._internal_.SVGPolylineElement.md#nodename)
- [nodeType](input._internal_.SVGPolylineElement.md#nodetype)
- [nodeValue](input._internal_.SVGPolylineElement.md#nodevalue)
- [nonce](input._internal_.SVGPolylineElement.md#nonce)
- [onabort](input._internal_.SVGPolylineElement.md#onabort)
- [onanimationcancel](input._internal_.SVGPolylineElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGPolylineElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGPolylineElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGPolylineElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGPolylineElement.md#onauxclick)
- [onblur](input._internal_.SVGPolylineElement.md#onblur)
- [oncanplay](input._internal_.SVGPolylineElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGPolylineElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGPolylineElement.md#onchange)
- [onclick](input._internal_.SVGPolylineElement.md#onclick)
- [onclose](input._internal_.SVGPolylineElement.md#onclose)
- [oncontextmenu](input._internal_.SVGPolylineElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGPolylineElement.md#oncopy)
- [oncuechange](input._internal_.SVGPolylineElement.md#oncuechange)
- [oncut](input._internal_.SVGPolylineElement.md#oncut)
- [ondblclick](input._internal_.SVGPolylineElement.md#ondblclick)
- [ondrag](input._internal_.SVGPolylineElement.md#ondrag)
- [ondragend](input._internal_.SVGPolylineElement.md#ondragend)
- [ondragenter](input._internal_.SVGPolylineElement.md#ondragenter)
- [ondragleave](input._internal_.SVGPolylineElement.md#ondragleave)
- [ondragover](input._internal_.SVGPolylineElement.md#ondragover)
- [ondragstart](input._internal_.SVGPolylineElement.md#ondragstart)
- [ondrop](input._internal_.SVGPolylineElement.md#ondrop)
- [ondurationchange](input._internal_.SVGPolylineElement.md#ondurationchange)
- [onemptied](input._internal_.SVGPolylineElement.md#onemptied)
- [onended](input._internal_.SVGPolylineElement.md#onended)
- [onerror](input._internal_.SVGPolylineElement.md#onerror)
- [onfocus](input._internal_.SVGPolylineElement.md#onfocus)
- [onformdata](input._internal_.SVGPolylineElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGPolylineElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGPolylineElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGPolylineElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGPolylineElement.md#oninput)
- [oninvalid](input._internal_.SVGPolylineElement.md#oninvalid)
- [onkeydown](input._internal_.SVGPolylineElement.md#onkeydown)
- [onkeypress](input._internal_.SVGPolylineElement.md#onkeypress)
- [onkeyup](input._internal_.SVGPolylineElement.md#onkeyup)
- [onload](input._internal_.SVGPolylineElement.md#onload)
- [onloadeddata](input._internal_.SVGPolylineElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGPolylineElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGPolylineElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGPolylineElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGPolylineElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGPolylineElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGPolylineElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGPolylineElement.md#onmousemove)
- [onmouseout](input._internal_.SVGPolylineElement.md#onmouseout)
- [onmouseover](input._internal_.SVGPolylineElement.md#onmouseover)
- [onmouseup](input._internal_.SVGPolylineElement.md#onmouseup)
- [onpaste](input._internal_.SVGPolylineElement.md#onpaste)
- [onpause](input._internal_.SVGPolylineElement.md#onpause)
- [onplay](input._internal_.SVGPolylineElement.md#onplay)
- [onplaying](input._internal_.SVGPolylineElement.md#onplaying)
- [onpointercancel](input._internal_.SVGPolylineElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGPolylineElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGPolylineElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGPolylineElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGPolylineElement.md#onpointermove)
- [onpointerout](input._internal_.SVGPolylineElement.md#onpointerout)
- [onpointerover](input._internal_.SVGPolylineElement.md#onpointerover)
- [onpointerup](input._internal_.SVGPolylineElement.md#onpointerup)
- [onprogress](input._internal_.SVGPolylineElement.md#onprogress)
- [onratechange](input._internal_.SVGPolylineElement.md#onratechange)
- [onreset](input._internal_.SVGPolylineElement.md#onreset)
- [onresize](input._internal_.SVGPolylineElement.md#onresize)
- [onscroll](input._internal_.SVGPolylineElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGPolylineElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGPolylineElement.md#onseeked)
- [onseeking](input._internal_.SVGPolylineElement.md#onseeking)
- [onselect](input._internal_.SVGPolylineElement.md#onselect)
- [onselectionchange](input._internal_.SVGPolylineElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGPolylineElement.md#onselectstart)
- [onslotchange](input._internal_.SVGPolylineElement.md#onslotchange)
- [onstalled](input._internal_.SVGPolylineElement.md#onstalled)
- [onsubmit](input._internal_.SVGPolylineElement.md#onsubmit)
- [onsuspend](input._internal_.SVGPolylineElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGPolylineElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGPolylineElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGPolylineElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGPolylineElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGPolylineElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGPolylineElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGPolylineElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGPolylineElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGPolylineElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGPolylineElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGPolylineElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGPolylineElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGPolylineElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGPolylineElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGPolylineElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGPolylineElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGPolylineElement.md#onwheel)
- [outerHTML](input._internal_.SVGPolylineElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGPolylineElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGPolylineElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGPolylineElement.md#parentelement)
- [parentNode](input._internal_.SVGPolylineElement.md#parentnode)
- [part](input._internal_.SVGPolylineElement.md#part)
- [pathLength](input._internal_.SVGPolylineElement.md#pathlength)
- [points](input._internal_.SVGPolylineElement.md#points)
- [prefix](input._internal_.SVGPolylineElement.md#prefix)
- [previousElementSibling](input._internal_.SVGPolylineElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGPolylineElement.md#previoussibling)
- [requiredExtensions](input._internal_.SVGPolylineElement.md#requiredextensions)
- [scrollHeight](input._internal_.SVGPolylineElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGPolylineElement.md#scrollleft)
- [scrollTop](input._internal_.SVGPolylineElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGPolylineElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGPolylineElement.md#shadowroot)
- [slot](input._internal_.SVGPolylineElement.md#slot)
- [style](input._internal_.SVGPolylineElement.md#style)
- [systemLanguage](input._internal_.SVGPolylineElement.md#systemlanguage)
- [tabIndex](input._internal_.SVGPolylineElement.md#tabindex)
- [tagName](input._internal_.SVGPolylineElement.md#tagname)
- [textContent](input._internal_.SVGPolylineElement.md#textcontent)
- [transform](input._internal_.SVGPolylineElement.md#transform)
- [viewportElement](input._internal_.SVGPolylineElement.md#viewportelement)

### Methods

- [addEventListener](input._internal_.SVGPolylineElement.md#addeventlistener)
- [after](input._internal_.SVGPolylineElement.md#after)
- [animate](input._internal_.SVGPolylineElement.md#animate)
- [append](input._internal_.SVGPolylineElement.md#append)
- [appendChild](input._internal_.SVGPolylineElement.md#appendchild)
- [attachShadow](input._internal_.SVGPolylineElement.md#attachshadow)
- [before](input._internal_.SVGPolylineElement.md#before)
- [blur](input._internal_.SVGPolylineElement.md#blur)
- [cloneNode](input._internal_.SVGPolylineElement.md#clonenode)
- [closest](input._internal_.SVGPolylineElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGPolylineElement.md#comparedocumentposition)
- [contains](input._internal_.SVGPolylineElement.md#contains)
- [dispatchEvent](input._internal_.SVGPolylineElement.md#dispatchevent)
- [focus](input._internal_.SVGPolylineElement.md#focus)
- [getAnimations](input._internal_.SVGPolylineElement.md#getanimations)
- [getAttribute](input._internal_.SVGPolylineElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGPolylineElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGPolylineElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGPolylineElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGPolylineElement.md#getattributenodens)
- [getBBox](input._internal_.SVGPolylineElement.md#getbbox)
- [getBoundingClientRect](input._internal_.SVGPolylineElement.md#getboundingclientrect)
- [getCTM](input._internal_.SVGPolylineElement.md#getctm)
- [getClientRects](input._internal_.SVGPolylineElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGPolylineElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGPolylineElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGPolylineElement.md#getelementsbytagnamens)
- [getPointAtLength](input._internal_.SVGPolylineElement.md#getpointatlength)
- [getRootNode](input._internal_.SVGPolylineElement.md#getrootnode)
- [getScreenCTM](input._internal_.SVGPolylineElement.md#getscreenctm)
- [getTotalLength](input._internal_.SVGPolylineElement.md#gettotallength)
- [hasAttribute](input._internal_.SVGPolylineElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGPolylineElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGPolylineElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGPolylineElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGPolylineElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGPolylineElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGPolylineElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGPolylineElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGPolylineElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGPolylineElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGPolylineElement.md#isequalnode)
- [isPointInFill](input._internal_.SVGPolylineElement.md#ispointinfill)
- [isPointInStroke](input._internal_.SVGPolylineElement.md#ispointinstroke)
- [isSameNode](input._internal_.SVGPolylineElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGPolylineElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGPolylineElement.md#lookupprefix)
- [matches](input._internal_.SVGPolylineElement.md#matches)
- [normalize](input._internal_.SVGPolylineElement.md#normalize)
- [prepend](input._internal_.SVGPolylineElement.md#prepend)
- [querySelector](input._internal_.SVGPolylineElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGPolylineElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGPolylineElement.md#releasepointercapture)
- [remove](input._internal_.SVGPolylineElement.md#remove)
- [removeAttribute](input._internal_.SVGPolylineElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGPolylineElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGPolylineElement.md#removeattributenode)
- [removeChild](input._internal_.SVGPolylineElement.md#removechild)
- [removeEventListener](input._internal_.SVGPolylineElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGPolylineElement.md#replacechild)
- [replaceChildren](input._internal_.SVGPolylineElement.md#replacechildren)
- [replaceWith](input._internal_.SVGPolylineElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGPolylineElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGPolylineElement.md#requestpointerlock)
- [scroll](input._internal_.SVGPolylineElement.md#scroll)
- [scrollBy](input._internal_.SVGPolylineElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGPolylineElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGPolylineElement.md#scrollto)
- [setAttribute](input._internal_.SVGPolylineElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGPolylineElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGPolylineElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGPolylineElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGPolylineElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGPolylineElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGPolylineElement.md#webkitmatchesselector)
...
[SVGAnimatedPoints](input._internal_.SVGAnimatedPoints.md).[animatedPoints](input._internal_.SVGAnimatedPoints.md#animatedpoints)
...
[SVGAnimatedPoints](input._internal_.SVGAnimatedPoints.md).[points](input._internal_.SVGAnimatedPoints.md#points)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGPolylineElement`](../modules/input._internal_.md#svgpolylineelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
