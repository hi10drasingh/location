[Droom Google Location Plugin - v1.0.11](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGPathElement

# Interface: SVGPathElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGPathElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGPathElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGPathElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGPathElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGPathElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGPathElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGPathElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGPathElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGPathElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGPathElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGPathElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGPathElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGPathElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGPathElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGPathElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGPathElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGPathElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGPathElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGPathElement.md#text_node)
- [ariaAtomic](input._internal_.SVGPathElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGPathElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGPathElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGPathElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGPathElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGPathElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGPathElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGPathElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGPathElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGPathElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGPathElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGPathElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGPathElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGPathElement.md#arialabel)
- [ariaLevel](input._internal_.SVGPathElement.md#arialevel)
- [ariaLive](input._internal_.SVGPathElement.md#arialive)
- [ariaModal](input._internal_.SVGPathElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGPathElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGPathElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGPathElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGPathElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGPathElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGPathElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGPathElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGPathElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGPathElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGPathElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGPathElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGPathElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGPathElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGPathElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGPathElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGPathElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGPathElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGPathElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGPathElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGPathElement.md#assignedslot)
- [attributes](input._internal_.SVGPathElement.md#attributes)
- [autofocus](input._internal_.SVGPathElement.md#autofocus)
- [baseURI](input._internal_.SVGPathElement.md#baseuri)
- [childElementCount](input._internal_.SVGPathElement.md#childelementcount)
- [childNodes](input._internal_.SVGPathElement.md#childnodes)
- [children](input._internal_.SVGPathElement.md#children)
- [classList](input._internal_.SVGPathElement.md#classlist)
- [className](input._internal_.SVGPathElement.md#classname)
- [clientHeight](input._internal_.SVGPathElement.md#clientheight)
- [clientLeft](input._internal_.SVGPathElement.md#clientleft)
- [clientTop](input._internal_.SVGPathElement.md#clienttop)
- [clientWidth](input._internal_.SVGPathElement.md#clientwidth)
- [dataset](input._internal_.SVGPathElement.md#dataset)
- [firstChild](input._internal_.SVGPathElement.md#firstchild)
- [firstElementChild](input._internal_.SVGPathElement.md#firstelementchild)
- [id](input._internal_.SVGPathElement.md#id)
- [innerHTML](input._internal_.SVGPathElement.md#innerhtml)
- [isConnected](input._internal_.SVGPathElement.md#isconnected)
- [lastChild](input._internal_.SVGPathElement.md#lastchild)
- [lastElementChild](input._internal_.SVGPathElement.md#lastelementchild)
- [localName](input._internal_.SVGPathElement.md#localname)
- [namespaceURI](input._internal_.SVGPathElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGPathElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGPathElement.md#nextsibling)
- [nodeName](input._internal_.SVGPathElement.md#nodename)
- [nodeType](input._internal_.SVGPathElement.md#nodetype)
- [nodeValue](input._internal_.SVGPathElement.md#nodevalue)
- [nonce](input._internal_.SVGPathElement.md#nonce)
- [onabort](input._internal_.SVGPathElement.md#onabort)
- [onanimationcancel](input._internal_.SVGPathElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGPathElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGPathElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGPathElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGPathElement.md#onauxclick)
- [onblur](input._internal_.SVGPathElement.md#onblur)
- [oncanplay](input._internal_.SVGPathElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGPathElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGPathElement.md#onchange)
- [onclick](input._internal_.SVGPathElement.md#onclick)
- [onclose](input._internal_.SVGPathElement.md#onclose)
- [oncontextmenu](input._internal_.SVGPathElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGPathElement.md#oncopy)
- [oncuechange](input._internal_.SVGPathElement.md#oncuechange)
- [oncut](input._internal_.SVGPathElement.md#oncut)
- [ondblclick](input._internal_.SVGPathElement.md#ondblclick)
- [ondrag](input._internal_.SVGPathElement.md#ondrag)
- [ondragend](input._internal_.SVGPathElement.md#ondragend)
- [ondragenter](input._internal_.SVGPathElement.md#ondragenter)
- [ondragleave](input._internal_.SVGPathElement.md#ondragleave)
- [ondragover](input._internal_.SVGPathElement.md#ondragover)
- [ondragstart](input._internal_.SVGPathElement.md#ondragstart)
- [ondrop](input._internal_.SVGPathElement.md#ondrop)
- [ondurationchange](input._internal_.SVGPathElement.md#ondurationchange)
- [onemptied](input._internal_.SVGPathElement.md#onemptied)
- [onended](input._internal_.SVGPathElement.md#onended)
- [onerror](input._internal_.SVGPathElement.md#onerror)
- [onfocus](input._internal_.SVGPathElement.md#onfocus)
- [onformdata](input._internal_.SVGPathElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGPathElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGPathElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGPathElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGPathElement.md#oninput)
- [oninvalid](input._internal_.SVGPathElement.md#oninvalid)
- [onkeydown](input._internal_.SVGPathElement.md#onkeydown)
- [onkeypress](input._internal_.SVGPathElement.md#onkeypress)
- [onkeyup](input._internal_.SVGPathElement.md#onkeyup)
- [onload](input._internal_.SVGPathElement.md#onload)
- [onloadeddata](input._internal_.SVGPathElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGPathElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGPathElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGPathElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGPathElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGPathElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGPathElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGPathElement.md#onmousemove)
- [onmouseout](input._internal_.SVGPathElement.md#onmouseout)
- [onmouseover](input._internal_.SVGPathElement.md#onmouseover)
- [onmouseup](input._internal_.SVGPathElement.md#onmouseup)
- [onpaste](input._internal_.SVGPathElement.md#onpaste)
- [onpause](input._internal_.SVGPathElement.md#onpause)
- [onplay](input._internal_.SVGPathElement.md#onplay)
- [onplaying](input._internal_.SVGPathElement.md#onplaying)
- [onpointercancel](input._internal_.SVGPathElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGPathElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGPathElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGPathElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGPathElement.md#onpointermove)
- [onpointerout](input._internal_.SVGPathElement.md#onpointerout)
- [onpointerover](input._internal_.SVGPathElement.md#onpointerover)
- [onpointerup](input._internal_.SVGPathElement.md#onpointerup)
- [onprogress](input._internal_.SVGPathElement.md#onprogress)
- [onratechange](input._internal_.SVGPathElement.md#onratechange)
- [onreset](input._internal_.SVGPathElement.md#onreset)
- [onresize](input._internal_.SVGPathElement.md#onresize)
- [onscroll](input._internal_.SVGPathElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGPathElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGPathElement.md#onseeked)
- [onseeking](input._internal_.SVGPathElement.md#onseeking)
- [onselect](input._internal_.SVGPathElement.md#onselect)
- [onselectionchange](input._internal_.SVGPathElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGPathElement.md#onselectstart)
- [onslotchange](input._internal_.SVGPathElement.md#onslotchange)
- [onstalled](input._internal_.SVGPathElement.md#onstalled)
- [onsubmit](input._internal_.SVGPathElement.md#onsubmit)
- [onsuspend](input._internal_.SVGPathElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGPathElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGPathElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGPathElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGPathElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGPathElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGPathElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGPathElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGPathElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGPathElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGPathElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGPathElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGPathElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGPathElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGPathElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGPathElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGPathElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGPathElement.md#onwheel)
- [outerHTML](input._internal_.SVGPathElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGPathElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGPathElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGPathElement.md#parentelement)
- [parentNode](input._internal_.SVGPathElement.md#parentnode)
- [part](input._internal_.SVGPathElement.md#part)
- [pathLength](input._internal_.SVGPathElement.md#pathlength)
- [prefix](input._internal_.SVGPathElement.md#prefix)
- [previousElementSibling](input._internal_.SVGPathElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGPathElement.md#previoussibling)
- [requiredExtensions](input._internal_.SVGPathElement.md#requiredextensions)
- [scrollHeight](input._internal_.SVGPathElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGPathElement.md#scrollleft)
- [scrollTop](input._internal_.SVGPathElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGPathElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGPathElement.md#shadowroot)
- [slot](input._internal_.SVGPathElement.md#slot)
- [style](input._internal_.SVGPathElement.md#style)
- [systemLanguage](input._internal_.SVGPathElement.md#systemlanguage)
- [tabIndex](input._internal_.SVGPathElement.md#tabindex)
- [tagName](input._internal_.SVGPathElement.md#tagname)
- [textContent](input._internal_.SVGPathElement.md#textcontent)
- [transform](input._internal_.SVGPathElement.md#transform)
- [viewportElement](input._internal_.SVGPathElement.md#viewportelement)

### Methods

- [addEventListener](input._internal_.SVGPathElement.md#addeventlistener)
- [after](input._internal_.SVGPathElement.md#after)
- [animate](input._internal_.SVGPathElement.md#animate)
- [append](input._internal_.SVGPathElement.md#append)
- [appendChild](input._internal_.SVGPathElement.md#appendchild)
- [attachShadow](input._internal_.SVGPathElement.md#attachshadow)
- [before](input._internal_.SVGPathElement.md#before)
- [blur](input._internal_.SVGPathElement.md#blur)
- [cloneNode](input._internal_.SVGPathElement.md#clonenode)
- [closest](input._internal_.SVGPathElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGPathElement.md#comparedocumentposition)
- [contains](input._internal_.SVGPathElement.md#contains)
- [dispatchEvent](input._internal_.SVGPathElement.md#dispatchevent)
- [focus](input._internal_.SVGPathElement.md#focus)
- [getAnimations](input._internal_.SVGPathElement.md#getanimations)
- [getAttribute](input._internal_.SVGPathElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGPathElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGPathElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGPathElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGPathElement.md#getattributenodens)
- [getBBox](input._internal_.SVGPathElement.md#getbbox)
- [getBoundingClientRect](input._internal_.SVGPathElement.md#getboundingclientrect)
- [getCTM](input._internal_.SVGPathElement.md#getctm)
- [getClientRects](input._internal_.SVGPathElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGPathElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGPathElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGPathElement.md#getelementsbytagnamens)
- [getPointAtLength](input._internal_.SVGPathElement.md#getpointatlength)
- [getRootNode](input._internal_.SVGPathElement.md#getrootnode)
- [getScreenCTM](input._internal_.SVGPathElement.md#getscreenctm)
- [getTotalLength](input._internal_.SVGPathElement.md#gettotallength)
- [hasAttribute](input._internal_.SVGPathElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGPathElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGPathElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGPathElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGPathElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGPathElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGPathElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGPathElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGPathElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGPathElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGPathElement.md#isequalnode)
- [isPointInFill](input._internal_.SVGPathElement.md#ispointinfill)
- [isPointInStroke](input._internal_.SVGPathElement.md#ispointinstroke)
- [isSameNode](input._internal_.SVGPathElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGPathElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGPathElement.md#lookupprefix)
- [matches](input._internal_.SVGPathElement.md#matches)
- [normalize](input._internal_.SVGPathElement.md#normalize)
- [prepend](input._internal_.SVGPathElement.md#prepend)
- [querySelector](input._internal_.SVGPathElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGPathElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGPathElement.md#releasepointercapture)
- [remove](input._internal_.SVGPathElement.md#remove)
- [removeAttribute](input._internal_.SVGPathElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGPathElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGPathElement.md#removeattributenode)
- [removeChild](input._internal_.SVGPathElement.md#removechild)
- [removeEventListener](input._internal_.SVGPathElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGPathElement.md#replacechild)
- [replaceChildren](input._internal_.SVGPathElement.md#replacechildren)
- [replaceWith](input._internal_.SVGPathElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGPathElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGPathElement.md#requestpointerlock)
- [scroll](input._internal_.SVGPathElement.md#scroll)
- [scrollBy](input._internal_.SVGPathElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGPathElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGPathElement.md#scrollto)
- [setAttribute](input._internal_.SVGPathElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGPathElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGPathElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGPathElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGPathElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGPathElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGPathElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGPathElement`](../modules/input._internal_.md#svgpathelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
