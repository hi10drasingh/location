[Droom Google Location Plugin - v1.0.10](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLSourceElement

# Interface: HTMLSourceElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLSourceElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLSourceElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLSourceElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLSourceElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLSourceElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLSourceElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLSourceElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLSourceElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLSourceElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLSourceElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLSourceElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLSourceElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLSourceElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLSourceElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLSourceElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLSourceElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLSourceElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLSourceElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLSourceElement.md#text_node)
- [accessKey](input._internal_.HTMLSourceElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLSourceElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLSourceElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLSourceElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLSourceElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLSourceElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLSourceElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLSourceElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLSourceElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLSourceElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLSourceElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLSourceElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLSourceElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLSourceElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLSourceElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLSourceElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLSourceElement.md#arialevel)
- [ariaLive](input._internal_.HTMLSourceElement.md#arialive)
- [ariaModal](input._internal_.HTMLSourceElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLSourceElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLSourceElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLSourceElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLSourceElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLSourceElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLSourceElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLSourceElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLSourceElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLSourceElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLSourceElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLSourceElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLSourceElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLSourceElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLSourceElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLSourceElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLSourceElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLSourceElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLSourceElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLSourceElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLSourceElement.md#assignedslot)
- [attributes](input._internal_.HTMLSourceElement.md#attributes)
- [autocapitalize](input._internal_.HTMLSourceElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLSourceElement.md#autofocus)
- [baseURI](input._internal_.HTMLSourceElement.md#baseuri)
- [childElementCount](input._internal_.HTMLSourceElement.md#childelementcount)
- [childNodes](input._internal_.HTMLSourceElement.md#childnodes)
- [children](input._internal_.HTMLSourceElement.md#children)
- [classList](input._internal_.HTMLSourceElement.md#classlist)
- [className](input._internal_.HTMLSourceElement.md#classname)
- [clientHeight](input._internal_.HTMLSourceElement.md#clientheight)
- [clientLeft](input._internal_.HTMLSourceElement.md#clientleft)
- [clientTop](input._internal_.HTMLSourceElement.md#clienttop)
- [clientWidth](input._internal_.HTMLSourceElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLSourceElement.md#contenteditable)
- [dataset](input._internal_.HTMLSourceElement.md#dataset)
- [dir](input._internal_.HTMLSourceElement.md#dir)
- [draggable](input._internal_.HTMLSourceElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLSourceElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLSourceElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLSourceElement.md#firstelementchild)
- [height](input._internal_.HTMLSourceElement.md#height)
- [hidden](input._internal_.HTMLSourceElement.md#hidden)
- [id](input._internal_.HTMLSourceElement.md#id)
- [innerHTML](input._internal_.HTMLSourceElement.md#innerhtml)
- [innerText](input._internal_.HTMLSourceElement.md#innertext)
- [inputMode](input._internal_.HTMLSourceElement.md#inputmode)
- [isConnected](input._internal_.HTMLSourceElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLSourceElement.md#iscontenteditable)
- [lang](input._internal_.HTMLSourceElement.md#lang)
- [lastChild](input._internal_.HTMLSourceElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLSourceElement.md#lastelementchild)
- [localName](input._internal_.HTMLSourceElement.md#localname)
- [media](input._internal_.HTMLSourceElement.md#media)
- [namespaceURI](input._internal_.HTMLSourceElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLSourceElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLSourceElement.md#nextsibling)
- [nodeName](input._internal_.HTMLSourceElement.md#nodename)
- [nodeType](input._internal_.HTMLSourceElement.md#nodetype)
- [nodeValue](input._internal_.HTMLSourceElement.md#nodevalue)
- [nonce](input._internal_.HTMLSourceElement.md#nonce)
- [offsetHeight](input._internal_.HTMLSourceElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLSourceElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLSourceElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLSourceElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLSourceElement.md#offsetwidth)
- [onabort](input._internal_.HTMLSourceElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLSourceElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLSourceElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLSourceElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLSourceElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLSourceElement.md#onauxclick)
- [onblur](input._internal_.HTMLSourceElement.md#onblur)
- [oncanplay](input._internal_.HTMLSourceElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLSourceElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLSourceElement.md#onchange)
- [onclick](input._internal_.HTMLSourceElement.md#onclick)
- [onclose](input._internal_.HTMLSourceElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLSourceElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLSourceElement.md#oncopy)
- [oncuechange](input._internal_.HTMLSourceElement.md#oncuechange)
- [oncut](input._internal_.HTMLSourceElement.md#oncut)
- [ondblclick](input._internal_.HTMLSourceElement.md#ondblclick)
- [ondrag](input._internal_.HTMLSourceElement.md#ondrag)
- [ondragend](input._internal_.HTMLSourceElement.md#ondragend)
- [ondragenter](input._internal_.HTMLSourceElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLSourceElement.md#ondragleave)
- [ondragover](input._internal_.HTMLSourceElement.md#ondragover)
- [ondragstart](input._internal_.HTMLSourceElement.md#ondragstart)
- [ondrop](input._internal_.HTMLSourceElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLSourceElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLSourceElement.md#onemptied)
- [onended](input._internal_.HTMLSourceElement.md#onended)
- [onerror](input._internal_.HTMLSourceElement.md#onerror)
- [onfocus](input._internal_.HTMLSourceElement.md#onfocus)
- [onformdata](input._internal_.HTMLSourceElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLSourceElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLSourceElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLSourceElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLSourceElement.md#oninput)
- [oninvalid](input._internal_.HTMLSourceElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLSourceElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLSourceElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLSourceElement.md#onkeyup)
- [onload](input._internal_.HTMLSourceElement.md#onload)
- [onloadeddata](input._internal_.HTMLSourceElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLSourceElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLSourceElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLSourceElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLSourceElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLSourceElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLSourceElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLSourceElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLSourceElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLSourceElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLSourceElement.md#onmouseup)
- [onpaste](input._internal_.HTMLSourceElement.md#onpaste)
- [onpause](input._internal_.HTMLSourceElement.md#onpause)
- [onplay](input._internal_.HTMLSourceElement.md#onplay)
- [onplaying](input._internal_.HTMLSourceElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLSourceElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLSourceElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLSourceElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLSourceElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLSourceElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLSourceElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLSourceElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLSourceElement.md#onpointerup)
- [onprogress](input._internal_.HTMLSourceElement.md#onprogress)
- [onratechange](input._internal_.HTMLSourceElement.md#onratechange)
- [onreset](input._internal_.HTMLSourceElement.md#onreset)
- [onresize](input._internal_.HTMLSourceElement.md#onresize)
- [onscroll](input._internal_.HTMLSourceElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLSourceElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLSourceElement.md#onseeked)
- [onseeking](input._internal_.HTMLSourceElement.md#onseeking)
- [onselect](input._internal_.HTMLSourceElement.md#onselect)
- [onselectionchange](input._internal_.HTMLSourceElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLSourceElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLSourceElement.md#onslotchange)
- [onstalled](input._internal_.HTMLSourceElement.md#onstalled)
- [onsubmit](input._internal_.HTMLSourceElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLSourceElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLSourceElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLSourceElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLSourceElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLSourceElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLSourceElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLSourceElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLSourceElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLSourceElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLSourceElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLSourceElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLSourceElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLSourceElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLSourceElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLSourceElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLSourceElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLSourceElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLSourceElement.md#onwheel)
- [outerHTML](input._internal_.HTMLSourceElement.md#outerhtml)
- [outerText](input._internal_.HTMLSourceElement.md#outertext)
- [ownerDocument](input._internal_.HTMLSourceElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLSourceElement.md#parentelement)
- [parentNode](input._internal_.HTMLSourceElement.md#parentnode)
- [part](input._internal_.HTMLSourceElement.md#part)
- [prefix](input._internal_.HTMLSourceElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLSourceElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLSourceElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLSourceElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLSourceElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLSourceElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLSourceElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLSourceElement.md#shadowroot)
- [sizes](input._internal_.HTMLSourceElement.md#sizes)
- [slot](input._internal_.HTMLSourceElement.md#slot)
- [spellcheck](input._internal_.HTMLSourceElement.md#spellcheck)
- [src](input._internal_.HTMLSourceElement.md#src)
- [srcset](input._internal_.HTMLSourceElement.md#srcset)
- [style](input._internal_.HTMLSourceElement.md#style)
- [tabIndex](input._internal_.HTMLSourceElement.md#tabindex)
- [tagName](input._internal_.HTMLSourceElement.md#tagname)
- [textContent](input._internal_.HTMLSourceElement.md#textcontent)
- [title](input._internal_.HTMLSourceElement.md#title)
- [translate](input._internal_.HTMLSourceElement.md#translate)
- [type](input._internal_.HTMLSourceElement.md#type)
- [width](input._internal_.HTMLSourceElement.md#width)

### Methods

- [addEventListener](input._internal_.HTMLSourceElement.md#addeventlistener)
- [after](input._internal_.HTMLSourceElement.md#after)
- [animate](input._internal_.HTMLSourceElement.md#animate)
- [append](input._internal_.HTMLSourceElement.md#append)
- [appendChild](input._internal_.HTMLSourceElement.md#appendchild)
- [attachInternals](input._internal_.HTMLSourceElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLSourceElement.md#attachshadow)
- [before](input._internal_.HTMLSourceElement.md#before)
- [blur](input._internal_.HTMLSourceElement.md#blur)
- [click](input._internal_.HTMLSourceElement.md#click)
- [cloneNode](input._internal_.HTMLSourceElement.md#clonenode)
- [closest](input._internal_.HTMLSourceElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLSourceElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLSourceElement.md#contains)
- [dispatchEvent](input._internal_.HTMLSourceElement.md#dispatchevent)
- [focus](input._internal_.HTMLSourceElement.md#focus)
- [getAnimations](input._internal_.HTMLSourceElement.md#getanimations)
- [getAttribute](input._internal_.HTMLSourceElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLSourceElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLSourceElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLSourceElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLSourceElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLSourceElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLSourceElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLSourceElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLSourceElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLSourceElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLSourceElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLSourceElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLSourceElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLSourceElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLSourceElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLSourceElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLSourceElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLSourceElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLSourceElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLSourceElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLSourceElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLSourceElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLSourceElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLSourceElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLSourceElement.md#lookupprefix)
- [matches](input._internal_.HTMLSourceElement.md#matches)
- [normalize](input._internal_.HTMLSourceElement.md#normalize)
- [prepend](input._internal_.HTMLSourceElement.md#prepend)
- [querySelector](input._internal_.HTMLSourceElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLSourceElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLSourceElement.md#releasepointercapture)
- [remove](input._internal_.HTMLSourceElement.md#remove)
- [removeAttribute](input._internal_.HTMLSourceElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLSourceElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLSourceElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLSourceElement.md#removechild)
- [removeEventListener](input._internal_.HTMLSourceElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLSourceElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLSourceElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLSourceElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLSourceElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLSourceElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLSourceElement.md#scroll)
- [scrollBy](input._internal_.HTMLSourceElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLSourceElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLSourceElement.md#scrollto)
- [setAttribute](input._internal_.HTMLSourceElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLSourceElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLSourceElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLSourceElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLSourceElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLSourceElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLSourceElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLSourceElement`](../modules/input._internal_.md#htmlsourceelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
