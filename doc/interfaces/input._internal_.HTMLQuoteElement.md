[Droom Google Location Plugin - v1.0.15](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLQuoteElement

# Interface: HTMLQuoteElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLQuoteElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLQuoteElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLQuoteElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLQuoteElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLQuoteElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLQuoteElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLQuoteElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLQuoteElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLQuoteElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLQuoteElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLQuoteElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLQuoteElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLQuoteElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLQuoteElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLQuoteElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLQuoteElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLQuoteElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLQuoteElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLQuoteElement.md#text_node)
- [accessKey](input._internal_.HTMLQuoteElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLQuoteElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLQuoteElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLQuoteElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLQuoteElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLQuoteElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLQuoteElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLQuoteElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLQuoteElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLQuoteElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLQuoteElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLQuoteElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLQuoteElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLQuoteElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLQuoteElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLQuoteElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLQuoteElement.md#arialevel)
- [ariaLive](input._internal_.HTMLQuoteElement.md#arialive)
- [ariaModal](input._internal_.HTMLQuoteElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLQuoteElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLQuoteElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLQuoteElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLQuoteElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLQuoteElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLQuoteElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLQuoteElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLQuoteElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLQuoteElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLQuoteElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLQuoteElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLQuoteElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLQuoteElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLQuoteElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLQuoteElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLQuoteElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLQuoteElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLQuoteElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLQuoteElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLQuoteElement.md#assignedslot)
- [attributes](input._internal_.HTMLQuoteElement.md#attributes)
- [autocapitalize](input._internal_.HTMLQuoteElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLQuoteElement.md#autofocus)
- [baseURI](input._internal_.HTMLQuoteElement.md#baseuri)
- [childElementCount](input._internal_.HTMLQuoteElement.md#childelementcount)
- [childNodes](input._internal_.HTMLQuoteElement.md#childnodes)
- [children](input._internal_.HTMLQuoteElement.md#children)
- [cite](input._internal_.HTMLQuoteElement.md#cite)
- [classList](input._internal_.HTMLQuoteElement.md#classlist)
- [className](input._internal_.HTMLQuoteElement.md#classname)
- [clientHeight](input._internal_.HTMLQuoteElement.md#clientheight)
- [clientLeft](input._internal_.HTMLQuoteElement.md#clientleft)
- [clientTop](input._internal_.HTMLQuoteElement.md#clienttop)
- [clientWidth](input._internal_.HTMLQuoteElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLQuoteElement.md#contenteditable)
- [dataset](input._internal_.HTMLQuoteElement.md#dataset)
- [dir](input._internal_.HTMLQuoteElement.md#dir)
- [draggable](input._internal_.HTMLQuoteElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLQuoteElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLQuoteElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLQuoteElement.md#firstelementchild)
- [hidden](input._internal_.HTMLQuoteElement.md#hidden)
- [id](input._internal_.HTMLQuoteElement.md#id)
- [innerHTML](input._internal_.HTMLQuoteElement.md#innerhtml)
- [innerText](input._internal_.HTMLQuoteElement.md#innertext)
- [inputMode](input._internal_.HTMLQuoteElement.md#inputmode)
- [isConnected](input._internal_.HTMLQuoteElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLQuoteElement.md#iscontenteditable)
- [lang](input._internal_.HTMLQuoteElement.md#lang)
- [lastChild](input._internal_.HTMLQuoteElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLQuoteElement.md#lastelementchild)
- [localName](input._internal_.HTMLQuoteElement.md#localname)
- [namespaceURI](input._internal_.HTMLQuoteElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLQuoteElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLQuoteElement.md#nextsibling)
- [nodeName](input._internal_.HTMLQuoteElement.md#nodename)
- [nodeType](input._internal_.HTMLQuoteElement.md#nodetype)
- [nodeValue](input._internal_.HTMLQuoteElement.md#nodevalue)
- [nonce](input._internal_.HTMLQuoteElement.md#nonce)
- [offsetHeight](input._internal_.HTMLQuoteElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLQuoteElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLQuoteElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLQuoteElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLQuoteElement.md#offsetwidth)
- [onabort](input._internal_.HTMLQuoteElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLQuoteElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLQuoteElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLQuoteElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLQuoteElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLQuoteElement.md#onauxclick)
- [onblur](input._internal_.HTMLQuoteElement.md#onblur)
- [oncanplay](input._internal_.HTMLQuoteElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLQuoteElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLQuoteElement.md#onchange)
- [onclick](input._internal_.HTMLQuoteElement.md#onclick)
- [onclose](input._internal_.HTMLQuoteElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLQuoteElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLQuoteElement.md#oncopy)
- [oncuechange](input._internal_.HTMLQuoteElement.md#oncuechange)
- [oncut](input._internal_.HTMLQuoteElement.md#oncut)
- [ondblclick](input._internal_.HTMLQuoteElement.md#ondblclick)
- [ondrag](input._internal_.HTMLQuoteElement.md#ondrag)
- [ondragend](input._internal_.HTMLQuoteElement.md#ondragend)
- [ondragenter](input._internal_.HTMLQuoteElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLQuoteElement.md#ondragleave)
- [ondragover](input._internal_.HTMLQuoteElement.md#ondragover)
- [ondragstart](input._internal_.HTMLQuoteElement.md#ondragstart)
- [ondrop](input._internal_.HTMLQuoteElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLQuoteElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLQuoteElement.md#onemptied)
- [onended](input._internal_.HTMLQuoteElement.md#onended)
- [onerror](input._internal_.HTMLQuoteElement.md#onerror)
- [onfocus](input._internal_.HTMLQuoteElement.md#onfocus)
- [onformdata](input._internal_.HTMLQuoteElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLQuoteElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLQuoteElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLQuoteElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLQuoteElement.md#oninput)
- [oninvalid](input._internal_.HTMLQuoteElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLQuoteElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLQuoteElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLQuoteElement.md#onkeyup)
- [onload](input._internal_.HTMLQuoteElement.md#onload)
- [onloadeddata](input._internal_.HTMLQuoteElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLQuoteElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLQuoteElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLQuoteElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLQuoteElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLQuoteElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLQuoteElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLQuoteElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLQuoteElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLQuoteElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLQuoteElement.md#onmouseup)
- [onpaste](input._internal_.HTMLQuoteElement.md#onpaste)
- [onpause](input._internal_.HTMLQuoteElement.md#onpause)
- [onplay](input._internal_.HTMLQuoteElement.md#onplay)
- [onplaying](input._internal_.HTMLQuoteElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLQuoteElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLQuoteElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLQuoteElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLQuoteElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLQuoteElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLQuoteElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLQuoteElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLQuoteElement.md#onpointerup)
- [onprogress](input._internal_.HTMLQuoteElement.md#onprogress)
- [onratechange](input._internal_.HTMLQuoteElement.md#onratechange)
- [onreset](input._internal_.HTMLQuoteElement.md#onreset)
- [onresize](input._internal_.HTMLQuoteElement.md#onresize)
- [onscroll](input._internal_.HTMLQuoteElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLQuoteElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLQuoteElement.md#onseeked)
- [onseeking](input._internal_.HTMLQuoteElement.md#onseeking)
- [onselect](input._internal_.HTMLQuoteElement.md#onselect)
- [onselectionchange](input._internal_.HTMLQuoteElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLQuoteElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLQuoteElement.md#onslotchange)
- [onstalled](input._internal_.HTMLQuoteElement.md#onstalled)
- [onsubmit](input._internal_.HTMLQuoteElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLQuoteElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLQuoteElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLQuoteElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLQuoteElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLQuoteElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLQuoteElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLQuoteElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLQuoteElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLQuoteElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLQuoteElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLQuoteElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLQuoteElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLQuoteElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLQuoteElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLQuoteElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLQuoteElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLQuoteElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLQuoteElement.md#onwheel)
- [outerHTML](input._internal_.HTMLQuoteElement.md#outerhtml)
- [outerText](input._internal_.HTMLQuoteElement.md#outertext)
- [ownerDocument](input._internal_.HTMLQuoteElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLQuoteElement.md#parentelement)
- [parentNode](input._internal_.HTMLQuoteElement.md#parentnode)
- [part](input._internal_.HTMLQuoteElement.md#part)
- [prefix](input._internal_.HTMLQuoteElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLQuoteElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLQuoteElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLQuoteElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLQuoteElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLQuoteElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLQuoteElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLQuoteElement.md#shadowroot)
- [slot](input._internal_.HTMLQuoteElement.md#slot)
- [spellcheck](input._internal_.HTMLQuoteElement.md#spellcheck)
- [style](input._internal_.HTMLQuoteElement.md#style)
- [tabIndex](input._internal_.HTMLQuoteElement.md#tabindex)
- [tagName](input._internal_.HTMLQuoteElement.md#tagname)
- [textContent](input._internal_.HTMLQuoteElement.md#textcontent)
- [title](input._internal_.HTMLQuoteElement.md#title)
- [translate](input._internal_.HTMLQuoteElement.md#translate)

### Methods

- [addEventListener](input._internal_.HTMLQuoteElement.md#addeventlistener)
- [after](input._internal_.HTMLQuoteElement.md#after)
- [animate](input._internal_.HTMLQuoteElement.md#animate)
- [append](input._internal_.HTMLQuoteElement.md#append)
- [appendChild](input._internal_.HTMLQuoteElement.md#appendchild)
- [attachInternals](input._internal_.HTMLQuoteElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLQuoteElement.md#attachshadow)
- [before](input._internal_.HTMLQuoteElement.md#before)
- [blur](input._internal_.HTMLQuoteElement.md#blur)
- [click](input._internal_.HTMLQuoteElement.md#click)
- [cloneNode](input._internal_.HTMLQuoteElement.md#clonenode)
- [closest](input._internal_.HTMLQuoteElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLQuoteElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLQuoteElement.md#contains)
- [dispatchEvent](input._internal_.HTMLQuoteElement.md#dispatchevent)
- [focus](input._internal_.HTMLQuoteElement.md#focus)
- [getAnimations](input._internal_.HTMLQuoteElement.md#getanimations)
- [getAttribute](input._internal_.HTMLQuoteElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLQuoteElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLQuoteElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLQuoteElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLQuoteElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLQuoteElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLQuoteElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLQuoteElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLQuoteElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLQuoteElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLQuoteElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLQuoteElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLQuoteElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLQuoteElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLQuoteElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLQuoteElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLQuoteElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLQuoteElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLQuoteElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLQuoteElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLQuoteElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLQuoteElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLQuoteElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLQuoteElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLQuoteElement.md#lookupprefix)
- [matches](input._internal_.HTMLQuoteElement.md#matches)
- [normalize](input._internal_.HTMLQuoteElement.md#normalize)
- [prepend](input._internal_.HTMLQuoteElement.md#prepend)
- [querySelector](input._internal_.HTMLQuoteElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLQuoteElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLQuoteElement.md#releasepointercapture)
- [remove](input._internal_.HTMLQuoteElement.md#remove)
- [removeAttribute](input._internal_.HTMLQuoteElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLQuoteElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLQuoteElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLQuoteElement.md#removechild)
- [removeEventListener](input._internal_.HTMLQuoteElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLQuoteElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLQuoteElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLQuoteElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLQuoteElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLQuoteElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLQuoteElement.md#scroll)
- [scrollBy](input._internal_.HTMLQuoteElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLQuoteElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLQuoteElement.md#scrollto)
- [setAttribute](input._internal_.HTMLQuoteElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLQuoteElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLQuoteElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLQuoteElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLQuoteElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLQuoteElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLQuoteElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLQuoteElement`](../modules/input._internal_.md#htmlquoteelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
