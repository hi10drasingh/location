[Droom Google Location Plugin - v1.0.15](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLHeadingElement

# Interface: HTMLHeadingElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLHeadingElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLHeadingElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLHeadingElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLHeadingElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLHeadingElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLHeadingElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLHeadingElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLHeadingElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLHeadingElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLHeadingElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLHeadingElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLHeadingElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLHeadingElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLHeadingElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLHeadingElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLHeadingElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLHeadingElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLHeadingElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLHeadingElement.md#text_node)
- [accessKey](input._internal_.HTMLHeadingElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLHeadingElement.md#accesskeylabel)
- [align](input._internal_.HTMLHeadingElement.md#align)
- [ariaAtomic](input._internal_.HTMLHeadingElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLHeadingElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLHeadingElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLHeadingElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLHeadingElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLHeadingElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLHeadingElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLHeadingElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLHeadingElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLHeadingElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLHeadingElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLHeadingElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLHeadingElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLHeadingElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLHeadingElement.md#arialevel)
- [ariaLive](input._internal_.HTMLHeadingElement.md#arialive)
- [ariaModal](input._internal_.HTMLHeadingElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLHeadingElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLHeadingElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLHeadingElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLHeadingElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLHeadingElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLHeadingElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLHeadingElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLHeadingElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLHeadingElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLHeadingElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLHeadingElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLHeadingElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLHeadingElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLHeadingElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLHeadingElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLHeadingElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLHeadingElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLHeadingElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLHeadingElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLHeadingElement.md#assignedslot)
- [attributes](input._internal_.HTMLHeadingElement.md#attributes)
- [autocapitalize](input._internal_.HTMLHeadingElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLHeadingElement.md#autofocus)
- [baseURI](input._internal_.HTMLHeadingElement.md#baseuri)
- [childElementCount](input._internal_.HTMLHeadingElement.md#childelementcount)
- [childNodes](input._internal_.HTMLHeadingElement.md#childnodes)
- [children](input._internal_.HTMLHeadingElement.md#children)
- [classList](input._internal_.HTMLHeadingElement.md#classlist)
- [className](input._internal_.HTMLHeadingElement.md#classname)
- [clientHeight](input._internal_.HTMLHeadingElement.md#clientheight)
- [clientLeft](input._internal_.HTMLHeadingElement.md#clientleft)
- [clientTop](input._internal_.HTMLHeadingElement.md#clienttop)
- [clientWidth](input._internal_.HTMLHeadingElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLHeadingElement.md#contenteditable)
- [dataset](input._internal_.HTMLHeadingElement.md#dataset)
- [dir](input._internal_.HTMLHeadingElement.md#dir)
- [draggable](input._internal_.HTMLHeadingElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLHeadingElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLHeadingElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLHeadingElement.md#firstelementchild)
- [hidden](input._internal_.HTMLHeadingElement.md#hidden)
- [id](input._internal_.HTMLHeadingElement.md#id)
- [innerHTML](input._internal_.HTMLHeadingElement.md#innerhtml)
- [innerText](input._internal_.HTMLHeadingElement.md#innertext)
- [inputMode](input._internal_.HTMLHeadingElement.md#inputmode)
- [isConnected](input._internal_.HTMLHeadingElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLHeadingElement.md#iscontenteditable)
- [lang](input._internal_.HTMLHeadingElement.md#lang)
- [lastChild](input._internal_.HTMLHeadingElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLHeadingElement.md#lastelementchild)
- [localName](input._internal_.HTMLHeadingElement.md#localname)
- [namespaceURI](input._internal_.HTMLHeadingElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLHeadingElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLHeadingElement.md#nextsibling)
- [nodeName](input._internal_.HTMLHeadingElement.md#nodename)
- [nodeType](input._internal_.HTMLHeadingElement.md#nodetype)
- [nodeValue](input._internal_.HTMLHeadingElement.md#nodevalue)
- [nonce](input._internal_.HTMLHeadingElement.md#nonce)
- [offsetHeight](input._internal_.HTMLHeadingElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLHeadingElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLHeadingElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLHeadingElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLHeadingElement.md#offsetwidth)
- [onabort](input._internal_.HTMLHeadingElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLHeadingElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLHeadingElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLHeadingElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLHeadingElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLHeadingElement.md#onauxclick)
- [onblur](input._internal_.HTMLHeadingElement.md#onblur)
- [oncanplay](input._internal_.HTMLHeadingElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLHeadingElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLHeadingElement.md#onchange)
- [onclick](input._internal_.HTMLHeadingElement.md#onclick)
- [onclose](input._internal_.HTMLHeadingElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLHeadingElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLHeadingElement.md#oncopy)
- [oncuechange](input._internal_.HTMLHeadingElement.md#oncuechange)
- [oncut](input._internal_.HTMLHeadingElement.md#oncut)
- [ondblclick](input._internal_.HTMLHeadingElement.md#ondblclick)
- [ondrag](input._internal_.HTMLHeadingElement.md#ondrag)
- [ondragend](input._internal_.HTMLHeadingElement.md#ondragend)
- [ondragenter](input._internal_.HTMLHeadingElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLHeadingElement.md#ondragleave)
- [ondragover](input._internal_.HTMLHeadingElement.md#ondragover)
- [ondragstart](input._internal_.HTMLHeadingElement.md#ondragstart)
- [ondrop](input._internal_.HTMLHeadingElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLHeadingElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLHeadingElement.md#onemptied)
- [onended](input._internal_.HTMLHeadingElement.md#onended)
- [onerror](input._internal_.HTMLHeadingElement.md#onerror)
- [onfocus](input._internal_.HTMLHeadingElement.md#onfocus)
- [onformdata](input._internal_.HTMLHeadingElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLHeadingElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLHeadingElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLHeadingElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLHeadingElement.md#oninput)
- [oninvalid](input._internal_.HTMLHeadingElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLHeadingElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLHeadingElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLHeadingElement.md#onkeyup)
- [onload](input._internal_.HTMLHeadingElement.md#onload)
- [onloadeddata](input._internal_.HTMLHeadingElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLHeadingElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLHeadingElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLHeadingElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLHeadingElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLHeadingElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLHeadingElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLHeadingElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLHeadingElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLHeadingElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLHeadingElement.md#onmouseup)
- [onpaste](input._internal_.HTMLHeadingElement.md#onpaste)
- [onpause](input._internal_.HTMLHeadingElement.md#onpause)
- [onplay](input._internal_.HTMLHeadingElement.md#onplay)
- [onplaying](input._internal_.HTMLHeadingElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLHeadingElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLHeadingElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLHeadingElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLHeadingElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLHeadingElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLHeadingElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLHeadingElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLHeadingElement.md#onpointerup)
- [onprogress](input._internal_.HTMLHeadingElement.md#onprogress)
- [onratechange](input._internal_.HTMLHeadingElement.md#onratechange)
- [onreset](input._internal_.HTMLHeadingElement.md#onreset)
- [onresize](input._internal_.HTMLHeadingElement.md#onresize)
- [onscroll](input._internal_.HTMLHeadingElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLHeadingElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLHeadingElement.md#onseeked)
- [onseeking](input._internal_.HTMLHeadingElement.md#onseeking)
- [onselect](input._internal_.HTMLHeadingElement.md#onselect)
- [onselectionchange](input._internal_.HTMLHeadingElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLHeadingElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLHeadingElement.md#onslotchange)
- [onstalled](input._internal_.HTMLHeadingElement.md#onstalled)
- [onsubmit](input._internal_.HTMLHeadingElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLHeadingElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLHeadingElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLHeadingElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLHeadingElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLHeadingElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLHeadingElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLHeadingElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLHeadingElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLHeadingElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLHeadingElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLHeadingElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLHeadingElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLHeadingElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLHeadingElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLHeadingElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLHeadingElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLHeadingElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLHeadingElement.md#onwheel)
- [outerHTML](input._internal_.HTMLHeadingElement.md#outerhtml)
- [outerText](input._internal_.HTMLHeadingElement.md#outertext)
- [ownerDocument](input._internal_.HTMLHeadingElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLHeadingElement.md#parentelement)
- [parentNode](input._internal_.HTMLHeadingElement.md#parentnode)
- [part](input._internal_.HTMLHeadingElement.md#part)
- [prefix](input._internal_.HTMLHeadingElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLHeadingElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLHeadingElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLHeadingElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLHeadingElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLHeadingElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLHeadingElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLHeadingElement.md#shadowroot)
- [slot](input._internal_.HTMLHeadingElement.md#slot)
- [spellcheck](input._internal_.HTMLHeadingElement.md#spellcheck)
- [style](input._internal_.HTMLHeadingElement.md#style)
- [tabIndex](input._internal_.HTMLHeadingElement.md#tabindex)
- [tagName](input._internal_.HTMLHeadingElement.md#tagname)
- [textContent](input._internal_.HTMLHeadingElement.md#textcontent)
- [title](input._internal_.HTMLHeadingElement.md#title)
- [translate](input._internal_.HTMLHeadingElement.md#translate)

### Methods

- [addEventListener](input._internal_.HTMLHeadingElement.md#addeventlistener)
- [after](input._internal_.HTMLHeadingElement.md#after)
- [animate](input._internal_.HTMLHeadingElement.md#animate)
- [append](input._internal_.HTMLHeadingElement.md#append)
- [appendChild](input._internal_.HTMLHeadingElement.md#appendchild)
- [attachInternals](input._internal_.HTMLHeadingElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLHeadingElement.md#attachshadow)
- [before](input._internal_.HTMLHeadingElement.md#before)
- [blur](input._internal_.HTMLHeadingElement.md#blur)
- [click](input._internal_.HTMLHeadingElement.md#click)
- [cloneNode](input._internal_.HTMLHeadingElement.md#clonenode)
- [closest](input._internal_.HTMLHeadingElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLHeadingElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLHeadingElement.md#contains)
- [dispatchEvent](input._internal_.HTMLHeadingElement.md#dispatchevent)
- [focus](input._internal_.HTMLHeadingElement.md#focus)
- [getAnimations](input._internal_.HTMLHeadingElement.md#getanimations)
- [getAttribute](input._internal_.HTMLHeadingElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLHeadingElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLHeadingElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLHeadingElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLHeadingElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLHeadingElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLHeadingElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLHeadingElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLHeadingElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLHeadingElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLHeadingElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLHeadingElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLHeadingElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLHeadingElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLHeadingElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLHeadingElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLHeadingElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLHeadingElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLHeadingElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLHeadingElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLHeadingElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLHeadingElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLHeadingElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLHeadingElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLHeadingElement.md#lookupprefix)
- [matches](input._internal_.HTMLHeadingElement.md#matches)
- [normalize](input._internal_.HTMLHeadingElement.md#normalize)
- [prepend](input._internal_.HTMLHeadingElement.md#prepend)
- [querySelector](input._internal_.HTMLHeadingElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLHeadingElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLHeadingElement.md#releasepointercapture)
- [remove](input._internal_.HTMLHeadingElement.md#remove)
- [removeAttribute](input._internal_.HTMLHeadingElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLHeadingElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLHeadingElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLHeadingElement.md#removechild)
- [removeEventListener](input._internal_.HTMLHeadingElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLHeadingElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLHeadingElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLHeadingElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLHeadingElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLHeadingElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLHeadingElement.md#scroll)
- [scrollBy](input._internal_.HTMLHeadingElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLHeadingElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLHeadingElement.md#scrollto)
- [setAttribute](input._internal_.HTMLHeadingElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLHeadingElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLHeadingElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLHeadingElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLHeadingElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLHeadingElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLHeadingElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLHeadingElement`](../modules/input._internal_.md#htmlheadingelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
