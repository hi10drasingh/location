[Droom Google Location Plugin - v1.0.16](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLElement

# Interface: HTMLElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLElement
...
- [`ElementCSSInlineStyle`](input._internal_.ElementCSSInlineStyle.md)

- [`ElementContentEditable`](input._internal_.ElementContentEditable.md)

- [`GlobalEventHandlers`](input._internal_.GlobalEventHandlers.md)

- [`HTMLOrSVGElement`](input._internal_.HTMLOrSVGElement.md)
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLElement.md#text_node)
- [accessKey](input._internal_.HTMLElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLElement.md#arialevel)
- [ariaLive](input._internal_.HTMLElement.md#arialive)
- [ariaModal](input._internal_.HTMLElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLElement.md#assignedslot)
- [attributes](input._internal_.HTMLElement.md#attributes)
- [autocapitalize](input._internal_.HTMLElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLElement.md#autofocus)
- [baseURI](input._internal_.HTMLElement.md#baseuri)
- [childElementCount](input._internal_.HTMLElement.md#childelementcount)
- [childNodes](input._internal_.HTMLElement.md#childnodes)
- [children](input._internal_.HTMLElement.md#children)
- [classList](input._internal_.HTMLElement.md#classlist)
- [className](input._internal_.HTMLElement.md#classname)
- [clientHeight](input._internal_.HTMLElement.md#clientheight)
- [clientLeft](input._internal_.HTMLElement.md#clientleft)
- [clientTop](input._internal_.HTMLElement.md#clienttop)
- [clientWidth](input._internal_.HTMLElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLElement.md#contenteditable)
- [dataset](input._internal_.HTMLElement.md#dataset)
- [dir](input._internal_.HTMLElement.md#dir)
- [draggable](input._internal_.HTMLElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLElement.md#firstelementchild)
- [hidden](input._internal_.HTMLElement.md#hidden)
- [id](input._internal_.HTMLElement.md#id)
- [innerHTML](input._internal_.HTMLElement.md#innerhtml)
- [innerText](input._internal_.HTMLElement.md#innertext)
- [inputMode](input._internal_.HTMLElement.md#inputmode)
- [isConnected](input._internal_.HTMLElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLElement.md#iscontenteditable)
- [lang](input._internal_.HTMLElement.md#lang)
- [lastChild](input._internal_.HTMLElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLElement.md#lastelementchild)
- [localName](input._internal_.HTMLElement.md#localname)
- [namespaceURI](input._internal_.HTMLElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLElement.md#nextsibling)
- [nodeName](input._internal_.HTMLElement.md#nodename)
- [nodeType](input._internal_.HTMLElement.md#nodetype)
- [nodeValue](input._internal_.HTMLElement.md#nodevalue)
- [nonce](input._internal_.HTMLElement.md#nonce)
- [offsetHeight](input._internal_.HTMLElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLElement.md#offsetwidth)
- [onabort](input._internal_.HTMLElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLElement.md#onauxclick)
- [onblur](input._internal_.HTMLElement.md#onblur)
- [oncanplay](input._internal_.HTMLElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLElement.md#onchange)
- [onclick](input._internal_.HTMLElement.md#onclick)
- [onclose](input._internal_.HTMLElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLElement.md#oncopy)
- [oncuechange](input._internal_.HTMLElement.md#oncuechange)
- [oncut](input._internal_.HTMLElement.md#oncut)
- [ondblclick](input._internal_.HTMLElement.md#ondblclick)
- [ondrag](input._internal_.HTMLElement.md#ondrag)
- [ondragend](input._internal_.HTMLElement.md#ondragend)
- [ondragenter](input._internal_.HTMLElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLElement.md#ondragleave)
- [ondragover](input._internal_.HTMLElement.md#ondragover)
- [ondragstart](input._internal_.HTMLElement.md#ondragstart)
- [ondrop](input._internal_.HTMLElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLElement.md#onemptied)
- [onended](input._internal_.HTMLElement.md#onended)
- [onerror](input._internal_.HTMLElement.md#onerror)
- [onfocus](input._internal_.HTMLElement.md#onfocus)
- [onformdata](input._internal_.HTMLElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLElement.md#oninput)
- [oninvalid](input._internal_.HTMLElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLElement.md#onkeyup)
- [onload](input._internal_.HTMLElement.md#onload)
- [onloadeddata](input._internal_.HTMLElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLElement.md#onmouseup)
- [onpaste](input._internal_.HTMLElement.md#onpaste)
- [onpause](input._internal_.HTMLElement.md#onpause)
- [onplay](input._internal_.HTMLElement.md#onplay)
- [onplaying](input._internal_.HTMLElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLElement.md#onpointerup)
- [onprogress](input._internal_.HTMLElement.md#onprogress)
- [onratechange](input._internal_.HTMLElement.md#onratechange)
- [onreset](input._internal_.HTMLElement.md#onreset)
- [onresize](input._internal_.HTMLElement.md#onresize)
- [onscroll](input._internal_.HTMLElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLElement.md#onseeked)
- [onseeking](input._internal_.HTMLElement.md#onseeking)
- [onselect](input._internal_.HTMLElement.md#onselect)
- [onselectionchange](input._internal_.HTMLElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLElement.md#onslotchange)
- [onstalled](input._internal_.HTMLElement.md#onstalled)
- [onsubmit](input._internal_.HTMLElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLElement.md#onwheel)
- [outerHTML](input._internal_.HTMLElement.md#outerhtml)
- [outerText](input._internal_.HTMLElement.md#outertext)
- [ownerDocument](input._internal_.HTMLElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLElement.md#parentelement)
- [parentNode](input._internal_.HTMLElement.md#parentnode)
- [part](input._internal_.HTMLElement.md#part)
- [prefix](input._internal_.HTMLElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLElement.md#shadowroot)
- [slot](input._internal_.HTMLElement.md#slot)
- [spellcheck](input._internal_.HTMLElement.md#spellcheck)
- [style](input._internal_.HTMLElement.md#style)
- [tabIndex](input._internal_.HTMLElement.md#tabindex)
- [tagName](input._internal_.HTMLElement.md#tagname)
- [textContent](input._internal_.HTMLElement.md#textcontent)
- [title](input._internal_.HTMLElement.md#title)
- [translate](input._internal_.HTMLElement.md#translate)

### Methods

- [addEventListener](input._internal_.HTMLElement.md#addeventlistener)
- [after](input._internal_.HTMLElement.md#after)
- [animate](input._internal_.HTMLElement.md#animate)
- [append](input._internal_.HTMLElement.md#append)
- [appendChild](input._internal_.HTMLElement.md#appendchild)
- [attachInternals](input._internal_.HTMLElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLElement.md#attachshadow)
- [before](input._internal_.HTMLElement.md#before)
- [blur](input._internal_.HTMLElement.md#blur)
- [click](input._internal_.HTMLElement.md#click)
- [cloneNode](input._internal_.HTMLElement.md#clonenode)
- [closest](input._internal_.HTMLElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLElement.md#contains)
- [dispatchEvent](input._internal_.HTMLElement.md#dispatchevent)
- [focus](input._internal_.HTMLElement.md#focus)
- [getAnimations](input._internal_.HTMLElement.md#getanimations)
- [getAttribute](input._internal_.HTMLElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLElement.md#lookupprefix)
- [matches](input._internal_.HTMLElement.md#matches)
- [normalize](input._internal_.HTMLElement.md#normalize)
- [prepend](input._internal_.HTMLElement.md#prepend)
- [querySelector](input._internal_.HTMLElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLElement.md#releasepointercapture)
- [remove](input._internal_.HTMLElement.md#remove)
- [removeAttribute](input._internal_.HTMLElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLElement.md#removechild)
- [removeEventListener](input._internal_.HTMLElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLElement.md#scroll)
- [scrollBy](input._internal_.HTMLElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLElement.md#scrollto)
- [setAttribute](input._internal_.HTMLElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLElement.md#webkitmatchesselector)
...
[HTMLOrSVGElement](input._internal_.HTMLOrSVGElement.md).[autofocus](input._internal_.HTMLOrSVGElement.md#autofocus)
...
[ElementContentEditable](input._internal_.ElementContentEditable.md).[contentEditable](input._internal_.ElementContentEditable.md#contenteditable)
...
[HTMLOrSVGElement](input._internal_.HTMLOrSVGElement.md).[dataset](input._internal_.HTMLOrSVGElement.md#dataset)
...
[ElementContentEditable](input._internal_.ElementContentEditable.md).[enterKeyHint](input._internal_.ElementContentEditable.md#enterkeyhint)
...
[ElementContentEditable](input._internal_.ElementContentEditable.md).[inputMode](input._internal_.ElementContentEditable.md#inputmode)
...
[ElementContentEditable](input._internal_.ElementContentEditable.md).[isContentEditable](input._internal_.ElementContentEditable.md#iscontenteditable)
...
[HTMLOrSVGElement](input._internal_.HTMLOrSVGElement.md).[nonce](input._internal_.HTMLOrSVGElement.md#nonce)
...
[ElementCSSInlineStyle](input._internal_.ElementCSSInlineStyle.md).[style](input._internal_.ElementCSSInlineStyle.md#style)
...
[HTMLOrSVGElement](input._internal_.HTMLOrSVGElement.md).[tabIndex](input._internal_.HTMLOrSVGElement.md#tabindex)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLElement`](../modules/input._internal_.md#htmlelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
...
[HTMLOrSVGElement](input._internal_.HTMLOrSVGElement.md).[blur](input._internal_.HTMLOrSVGElement.md#blur)
...
[HTMLOrSVGElement](input._internal_.HTMLOrSVGElement.md).[focus](input._internal_.HTMLOrSVGElement.md#focus)
