[Droom Google Location Plugin - v1.0.15](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGAnimateTransformElement

# Interface: SVGAnimateTransformElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGAnimateTransformElement

## Hierarchy

- [`SVGAnimationElement`](../modules/input._internal_.md#svganimationelement)
...
- [ATTRIBUTE\_NODE](input._internal_.SVGAnimateTransformElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGAnimateTransformElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGAnimateTransformElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGAnimateTransformElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGAnimateTransformElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGAnimateTransformElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGAnimateTransformElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGAnimateTransformElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGAnimateTransformElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGAnimateTransformElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGAnimateTransformElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGAnimateTransformElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGAnimateTransformElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGAnimateTransformElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGAnimateTransformElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGAnimateTransformElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGAnimateTransformElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGAnimateTransformElement.md#text_node)
- [ariaAtomic](input._internal_.SVGAnimateTransformElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGAnimateTransformElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGAnimateTransformElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGAnimateTransformElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGAnimateTransformElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGAnimateTransformElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGAnimateTransformElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGAnimateTransformElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGAnimateTransformElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGAnimateTransformElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGAnimateTransformElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGAnimateTransformElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGAnimateTransformElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGAnimateTransformElement.md#arialabel)
- [ariaLevel](input._internal_.SVGAnimateTransformElement.md#arialevel)
- [ariaLive](input._internal_.SVGAnimateTransformElement.md#arialive)
- [ariaModal](input._internal_.SVGAnimateTransformElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGAnimateTransformElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGAnimateTransformElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGAnimateTransformElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGAnimateTransformElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGAnimateTransformElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGAnimateTransformElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGAnimateTransformElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGAnimateTransformElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGAnimateTransformElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGAnimateTransformElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGAnimateTransformElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGAnimateTransformElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGAnimateTransformElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGAnimateTransformElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGAnimateTransformElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGAnimateTransformElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGAnimateTransformElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGAnimateTransformElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGAnimateTransformElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGAnimateTransformElement.md#assignedslot)
- [attributes](input._internal_.SVGAnimateTransformElement.md#attributes)
- [autofocus](input._internal_.SVGAnimateTransformElement.md#autofocus)
- [baseURI](input._internal_.SVGAnimateTransformElement.md#baseuri)
- [childElementCount](input._internal_.SVGAnimateTransformElement.md#childelementcount)
- [childNodes](input._internal_.SVGAnimateTransformElement.md#childnodes)
- [children](input._internal_.SVGAnimateTransformElement.md#children)
- [classList](input._internal_.SVGAnimateTransformElement.md#classlist)
- [className](input._internal_.SVGAnimateTransformElement.md#classname)
- [clientHeight](input._internal_.SVGAnimateTransformElement.md#clientheight)
- [clientLeft](input._internal_.SVGAnimateTransformElement.md#clientleft)
- [clientTop](input._internal_.SVGAnimateTransformElement.md#clienttop)
- [clientWidth](input._internal_.SVGAnimateTransformElement.md#clientwidth)
- [dataset](input._internal_.SVGAnimateTransformElement.md#dataset)
- [firstChild](input._internal_.SVGAnimateTransformElement.md#firstchild)
- [firstElementChild](input._internal_.SVGAnimateTransformElement.md#firstelementchild)
- [id](input._internal_.SVGAnimateTransformElement.md#id)
- [innerHTML](input._internal_.SVGAnimateTransformElement.md#innerhtml)
- [isConnected](input._internal_.SVGAnimateTransformElement.md#isconnected)
- [lastChild](input._internal_.SVGAnimateTransformElement.md#lastchild)
- [lastElementChild](input._internal_.SVGAnimateTransformElement.md#lastelementchild)
- [localName](input._internal_.SVGAnimateTransformElement.md#localname)
- [namespaceURI](input._internal_.SVGAnimateTransformElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGAnimateTransformElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGAnimateTransformElement.md#nextsibling)
- [nodeName](input._internal_.SVGAnimateTransformElement.md#nodename)
- [nodeType](input._internal_.SVGAnimateTransformElement.md#nodetype)
- [nodeValue](input._internal_.SVGAnimateTransformElement.md#nodevalue)
- [nonce](input._internal_.SVGAnimateTransformElement.md#nonce)
- [onabort](input._internal_.SVGAnimateTransformElement.md#onabort)
- [onanimationcancel](input._internal_.SVGAnimateTransformElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGAnimateTransformElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGAnimateTransformElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGAnimateTransformElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGAnimateTransformElement.md#onauxclick)
- [onblur](input._internal_.SVGAnimateTransformElement.md#onblur)
- [oncanplay](input._internal_.SVGAnimateTransformElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGAnimateTransformElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGAnimateTransformElement.md#onchange)
- [onclick](input._internal_.SVGAnimateTransformElement.md#onclick)
- [onclose](input._internal_.SVGAnimateTransformElement.md#onclose)
- [oncontextmenu](input._internal_.SVGAnimateTransformElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGAnimateTransformElement.md#oncopy)
- [oncuechange](input._internal_.SVGAnimateTransformElement.md#oncuechange)
- [oncut](input._internal_.SVGAnimateTransformElement.md#oncut)
- [ondblclick](input._internal_.SVGAnimateTransformElement.md#ondblclick)
- [ondrag](input._internal_.SVGAnimateTransformElement.md#ondrag)
- [ondragend](input._internal_.SVGAnimateTransformElement.md#ondragend)
- [ondragenter](input._internal_.SVGAnimateTransformElement.md#ondragenter)
- [ondragleave](input._internal_.SVGAnimateTransformElement.md#ondragleave)
- [ondragover](input._internal_.SVGAnimateTransformElement.md#ondragover)
- [ondragstart](input._internal_.SVGAnimateTransformElement.md#ondragstart)
- [ondrop](input._internal_.SVGAnimateTransformElement.md#ondrop)
- [ondurationchange](input._internal_.SVGAnimateTransformElement.md#ondurationchange)
- [onemptied](input._internal_.SVGAnimateTransformElement.md#onemptied)
- [onended](input._internal_.SVGAnimateTransformElement.md#onended)
- [onerror](input._internal_.SVGAnimateTransformElement.md#onerror)
- [onfocus](input._internal_.SVGAnimateTransformElement.md#onfocus)
- [onformdata](input._internal_.SVGAnimateTransformElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGAnimateTransformElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGAnimateTransformElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGAnimateTransformElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGAnimateTransformElement.md#oninput)
- [oninvalid](input._internal_.SVGAnimateTransformElement.md#oninvalid)
- [onkeydown](input._internal_.SVGAnimateTransformElement.md#onkeydown)
- [onkeypress](input._internal_.SVGAnimateTransformElement.md#onkeypress)
- [onkeyup](input._internal_.SVGAnimateTransformElement.md#onkeyup)
- [onload](input._internal_.SVGAnimateTransformElement.md#onload)
- [onloadeddata](input._internal_.SVGAnimateTransformElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGAnimateTransformElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGAnimateTransformElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGAnimateTransformElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGAnimateTransformElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGAnimateTransformElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGAnimateTransformElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGAnimateTransformElement.md#onmousemove)
- [onmouseout](input._internal_.SVGAnimateTransformElement.md#onmouseout)
- [onmouseover](input._internal_.SVGAnimateTransformElement.md#onmouseover)
- [onmouseup](input._internal_.SVGAnimateTransformElement.md#onmouseup)
- [onpaste](input._internal_.SVGAnimateTransformElement.md#onpaste)
- [onpause](input._internal_.SVGAnimateTransformElement.md#onpause)
- [onplay](input._internal_.SVGAnimateTransformElement.md#onplay)
- [onplaying](input._internal_.SVGAnimateTransformElement.md#onplaying)
- [onpointercancel](input._internal_.SVGAnimateTransformElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGAnimateTransformElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGAnimateTransformElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGAnimateTransformElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGAnimateTransformElement.md#onpointermove)
- [onpointerout](input._internal_.SVGAnimateTransformElement.md#onpointerout)
- [onpointerover](input._internal_.SVGAnimateTransformElement.md#onpointerover)
- [onpointerup](input._internal_.SVGAnimateTransformElement.md#onpointerup)
- [onprogress](input._internal_.SVGAnimateTransformElement.md#onprogress)
- [onratechange](input._internal_.SVGAnimateTransformElement.md#onratechange)
- [onreset](input._internal_.SVGAnimateTransformElement.md#onreset)
- [onresize](input._internal_.SVGAnimateTransformElement.md#onresize)
- [onscroll](input._internal_.SVGAnimateTransformElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGAnimateTransformElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGAnimateTransformElement.md#onseeked)
- [onseeking](input._internal_.SVGAnimateTransformElement.md#onseeking)
- [onselect](input._internal_.SVGAnimateTransformElement.md#onselect)
- [onselectionchange](input._internal_.SVGAnimateTransformElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGAnimateTransformElement.md#onselectstart)
- [onslotchange](input._internal_.SVGAnimateTransformElement.md#onslotchange)
- [onstalled](input._internal_.SVGAnimateTransformElement.md#onstalled)
- [onsubmit](input._internal_.SVGAnimateTransformElement.md#onsubmit)
- [onsuspend](input._internal_.SVGAnimateTransformElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGAnimateTransformElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGAnimateTransformElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGAnimateTransformElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGAnimateTransformElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGAnimateTransformElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGAnimateTransformElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGAnimateTransformElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGAnimateTransformElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGAnimateTransformElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGAnimateTransformElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGAnimateTransformElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGAnimateTransformElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGAnimateTransformElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGAnimateTransformElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGAnimateTransformElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGAnimateTransformElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGAnimateTransformElement.md#onwheel)
- [outerHTML](input._internal_.SVGAnimateTransformElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGAnimateTransformElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGAnimateTransformElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGAnimateTransformElement.md#parentelement)
- [parentNode](input._internal_.SVGAnimateTransformElement.md#parentnode)
- [part](input._internal_.SVGAnimateTransformElement.md#part)
- [prefix](input._internal_.SVGAnimateTransformElement.md#prefix)
- [previousElementSibling](input._internal_.SVGAnimateTransformElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGAnimateTransformElement.md#previoussibling)
- [requiredExtensions](input._internal_.SVGAnimateTransformElement.md#requiredextensions)
- [scrollHeight](input._internal_.SVGAnimateTransformElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGAnimateTransformElement.md#scrollleft)
- [scrollTop](input._internal_.SVGAnimateTransformElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGAnimateTransformElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGAnimateTransformElement.md#shadowroot)
- [slot](input._internal_.SVGAnimateTransformElement.md#slot)
- [style](input._internal_.SVGAnimateTransformElement.md#style)
- [systemLanguage](input._internal_.SVGAnimateTransformElement.md#systemlanguage)
- [tabIndex](input._internal_.SVGAnimateTransformElement.md#tabindex)
- [tagName](input._internal_.SVGAnimateTransformElement.md#tagname)
- [targetElement](input._internal_.SVGAnimateTransformElement.md#targetelement)
- [textContent](input._internal_.SVGAnimateTransformElement.md#textcontent)
- [viewportElement](input._internal_.SVGAnimateTransformElement.md#viewportelement)

### Methods

- [addEventListener](input._internal_.SVGAnimateTransformElement.md#addeventlistener)
- [after](input._internal_.SVGAnimateTransformElement.md#after)
- [animate](input._internal_.SVGAnimateTransformElement.md#animate)
- [append](input._internal_.SVGAnimateTransformElement.md#append)
- [appendChild](input._internal_.SVGAnimateTransformElement.md#appendchild)
- [attachShadow](input._internal_.SVGAnimateTransformElement.md#attachshadow)
- [before](input._internal_.SVGAnimateTransformElement.md#before)
- [beginElement](input._internal_.SVGAnimateTransformElement.md#beginelement)
- [beginElementAt](input._internal_.SVGAnimateTransformElement.md#beginelementat)
- [blur](input._internal_.SVGAnimateTransformElement.md#blur)
- [cloneNode](input._internal_.SVGAnimateTransformElement.md#clonenode)
- [closest](input._internal_.SVGAnimateTransformElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGAnimateTransformElement.md#comparedocumentposition)
- [contains](input._internal_.SVGAnimateTransformElement.md#contains)
- [dispatchEvent](input._internal_.SVGAnimateTransformElement.md#dispatchevent)
- [endElement](input._internal_.SVGAnimateTransformElement.md#endelement)
- [endElementAt](input._internal_.SVGAnimateTransformElement.md#endelementat)
- [focus](input._internal_.SVGAnimateTransformElement.md#focus)
- [getAnimations](input._internal_.SVGAnimateTransformElement.md#getanimations)
- [getAttribute](input._internal_.SVGAnimateTransformElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGAnimateTransformElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGAnimateTransformElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGAnimateTransformElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGAnimateTransformElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.SVGAnimateTransformElement.md#getboundingclientrect)
- [getClientRects](input._internal_.SVGAnimateTransformElement.md#getclientrects)
- [getCurrentTime](input._internal_.SVGAnimateTransformElement.md#getcurrenttime)
- [getElementsByClassName](input._internal_.SVGAnimateTransformElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGAnimateTransformElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGAnimateTransformElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGAnimateTransformElement.md#getrootnode)
- [getSimpleDuration](input._internal_.SVGAnimateTransformElement.md#getsimpleduration)
- [getStartTime](input._internal_.SVGAnimateTransformElement.md#getstarttime)
- [hasAttribute](input._internal_.SVGAnimateTransformElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGAnimateTransformElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGAnimateTransformElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGAnimateTransformElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGAnimateTransformElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGAnimateTransformElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGAnimateTransformElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGAnimateTransformElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGAnimateTransformElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGAnimateTransformElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGAnimateTransformElement.md#isequalnode)
- [isSameNode](input._internal_.SVGAnimateTransformElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGAnimateTransformElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGAnimateTransformElement.md#lookupprefix)
- [matches](input._internal_.SVGAnimateTransformElement.md#matches)
- [normalize](input._internal_.SVGAnimateTransformElement.md#normalize)
- [prepend](input._internal_.SVGAnimateTransformElement.md#prepend)
- [querySelector](input._internal_.SVGAnimateTransformElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGAnimateTransformElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGAnimateTransformElement.md#releasepointercapture)
- [remove](input._internal_.SVGAnimateTransformElement.md#remove)
- [removeAttribute](input._internal_.SVGAnimateTransformElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGAnimateTransformElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGAnimateTransformElement.md#removeattributenode)
- [removeChild](input._internal_.SVGAnimateTransformElement.md#removechild)
- [removeEventListener](input._internal_.SVGAnimateTransformElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGAnimateTransformElement.md#replacechild)
- [replaceChildren](input._internal_.SVGAnimateTransformElement.md#replacechildren)
- [replaceWith](input._internal_.SVGAnimateTransformElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGAnimateTransformElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGAnimateTransformElement.md#requestpointerlock)
- [scroll](input._internal_.SVGAnimateTransformElement.md#scroll)
- [scrollBy](input._internal_.SVGAnimateTransformElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGAnimateTransformElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGAnimateTransformElement.md#scrollto)
- [setAttribute](input._internal_.SVGAnimateTransformElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGAnimateTransformElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGAnimateTransformElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGAnimateTransformElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGAnimateTransformElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGAnimateTransformElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGAnimateTransformElement.md#webkitmatchesselector)
...
• `Readonly` **targetElement**: ``null`` \| [`SVGElement`](../modules/input._internal_.md#svgelement)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGAnimateTransformElement`](../modules/input._internal_.md#svganimatetransformelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
