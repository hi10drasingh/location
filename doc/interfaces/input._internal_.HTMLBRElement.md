[Droom Google Location Plugin - v1.0.16](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLBRElement

# Interface: HTMLBRElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLBRElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLBRElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLBRElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLBRElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLBRElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLBRElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLBRElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLBRElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLBRElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLBRElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLBRElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLBRElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLBRElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLBRElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLBRElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLBRElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLBRElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLBRElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLBRElement.md#text_node)
- [accessKey](input._internal_.HTMLBRElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLBRElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLBRElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLBRElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLBRElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLBRElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLBRElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLBRElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLBRElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLBRElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLBRElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLBRElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLBRElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLBRElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLBRElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLBRElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLBRElement.md#arialevel)
- [ariaLive](input._internal_.HTMLBRElement.md#arialive)
- [ariaModal](input._internal_.HTMLBRElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLBRElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLBRElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLBRElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLBRElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLBRElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLBRElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLBRElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLBRElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLBRElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLBRElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLBRElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLBRElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLBRElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLBRElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLBRElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLBRElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLBRElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLBRElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLBRElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLBRElement.md#assignedslot)
- [attributes](input._internal_.HTMLBRElement.md#attributes)
- [autocapitalize](input._internal_.HTMLBRElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLBRElement.md#autofocus)
- [baseURI](input._internal_.HTMLBRElement.md#baseuri)
- [childElementCount](input._internal_.HTMLBRElement.md#childelementcount)
- [childNodes](input._internal_.HTMLBRElement.md#childnodes)
- [children](input._internal_.HTMLBRElement.md#children)
- [classList](input._internal_.HTMLBRElement.md#classlist)
- [className](input._internal_.HTMLBRElement.md#classname)
- [clear](input._internal_.HTMLBRElement.md#clear)
- [clientHeight](input._internal_.HTMLBRElement.md#clientheight)
- [clientLeft](input._internal_.HTMLBRElement.md#clientleft)
- [clientTop](input._internal_.HTMLBRElement.md#clienttop)
- [clientWidth](input._internal_.HTMLBRElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLBRElement.md#contenteditable)
- [dataset](input._internal_.HTMLBRElement.md#dataset)
- [dir](input._internal_.HTMLBRElement.md#dir)
- [draggable](input._internal_.HTMLBRElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLBRElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLBRElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLBRElement.md#firstelementchild)
- [hidden](input._internal_.HTMLBRElement.md#hidden)
- [id](input._internal_.HTMLBRElement.md#id)
- [innerHTML](input._internal_.HTMLBRElement.md#innerhtml)
- [innerText](input._internal_.HTMLBRElement.md#innertext)
- [inputMode](input._internal_.HTMLBRElement.md#inputmode)
- [isConnected](input._internal_.HTMLBRElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLBRElement.md#iscontenteditable)
- [lang](input._internal_.HTMLBRElement.md#lang)
- [lastChild](input._internal_.HTMLBRElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLBRElement.md#lastelementchild)
- [localName](input._internal_.HTMLBRElement.md#localname)
- [namespaceURI](input._internal_.HTMLBRElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLBRElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLBRElement.md#nextsibling)
- [nodeName](input._internal_.HTMLBRElement.md#nodename)
- [nodeType](input._internal_.HTMLBRElement.md#nodetype)
- [nodeValue](input._internal_.HTMLBRElement.md#nodevalue)
- [nonce](input._internal_.HTMLBRElement.md#nonce)
- [offsetHeight](input._internal_.HTMLBRElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLBRElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLBRElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLBRElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLBRElement.md#offsetwidth)
- [onabort](input._internal_.HTMLBRElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLBRElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLBRElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLBRElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLBRElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLBRElement.md#onauxclick)
- [onblur](input._internal_.HTMLBRElement.md#onblur)
- [oncanplay](input._internal_.HTMLBRElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLBRElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLBRElement.md#onchange)
- [onclick](input._internal_.HTMLBRElement.md#onclick)
- [onclose](input._internal_.HTMLBRElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLBRElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLBRElement.md#oncopy)
- [oncuechange](input._internal_.HTMLBRElement.md#oncuechange)
- [oncut](input._internal_.HTMLBRElement.md#oncut)
- [ondblclick](input._internal_.HTMLBRElement.md#ondblclick)
- [ondrag](input._internal_.HTMLBRElement.md#ondrag)
- [ondragend](input._internal_.HTMLBRElement.md#ondragend)
- [ondragenter](input._internal_.HTMLBRElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLBRElement.md#ondragleave)
- [ondragover](input._internal_.HTMLBRElement.md#ondragover)
- [ondragstart](input._internal_.HTMLBRElement.md#ondragstart)
- [ondrop](input._internal_.HTMLBRElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLBRElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLBRElement.md#onemptied)
- [onended](input._internal_.HTMLBRElement.md#onended)
- [onerror](input._internal_.HTMLBRElement.md#onerror)
- [onfocus](input._internal_.HTMLBRElement.md#onfocus)
- [onformdata](input._internal_.HTMLBRElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLBRElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLBRElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLBRElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLBRElement.md#oninput)
- [oninvalid](input._internal_.HTMLBRElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLBRElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLBRElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLBRElement.md#onkeyup)
- [onload](input._internal_.HTMLBRElement.md#onload)
- [onloadeddata](input._internal_.HTMLBRElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLBRElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLBRElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLBRElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLBRElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLBRElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLBRElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLBRElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLBRElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLBRElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLBRElement.md#onmouseup)
- [onpaste](input._internal_.HTMLBRElement.md#onpaste)
- [onpause](input._internal_.HTMLBRElement.md#onpause)
- [onplay](input._internal_.HTMLBRElement.md#onplay)
- [onplaying](input._internal_.HTMLBRElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLBRElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLBRElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLBRElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLBRElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLBRElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLBRElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLBRElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLBRElement.md#onpointerup)
- [onprogress](input._internal_.HTMLBRElement.md#onprogress)
- [onratechange](input._internal_.HTMLBRElement.md#onratechange)
- [onreset](input._internal_.HTMLBRElement.md#onreset)
- [onresize](input._internal_.HTMLBRElement.md#onresize)
- [onscroll](input._internal_.HTMLBRElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLBRElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLBRElement.md#onseeked)
- [onseeking](input._internal_.HTMLBRElement.md#onseeking)
- [onselect](input._internal_.HTMLBRElement.md#onselect)
- [onselectionchange](input._internal_.HTMLBRElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLBRElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLBRElement.md#onslotchange)
- [onstalled](input._internal_.HTMLBRElement.md#onstalled)
- [onsubmit](input._internal_.HTMLBRElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLBRElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLBRElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLBRElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLBRElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLBRElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLBRElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLBRElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLBRElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLBRElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLBRElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLBRElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLBRElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLBRElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLBRElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLBRElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLBRElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLBRElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLBRElement.md#onwheel)
- [outerHTML](input._internal_.HTMLBRElement.md#outerhtml)
- [outerText](input._internal_.HTMLBRElement.md#outertext)
- [ownerDocument](input._internal_.HTMLBRElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLBRElement.md#parentelement)
- [parentNode](input._internal_.HTMLBRElement.md#parentnode)
- [part](input._internal_.HTMLBRElement.md#part)
- [prefix](input._internal_.HTMLBRElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLBRElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLBRElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLBRElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLBRElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLBRElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLBRElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLBRElement.md#shadowroot)
- [slot](input._internal_.HTMLBRElement.md#slot)
- [spellcheck](input._internal_.HTMLBRElement.md#spellcheck)
- [style](input._internal_.HTMLBRElement.md#style)
- [tabIndex](input._internal_.HTMLBRElement.md#tabindex)
- [tagName](input._internal_.HTMLBRElement.md#tagname)
- [textContent](input._internal_.HTMLBRElement.md#textcontent)
- [title](input._internal_.HTMLBRElement.md#title)
- [translate](input._internal_.HTMLBRElement.md#translate)

### Methods

- [addEventListener](input._internal_.HTMLBRElement.md#addeventlistener)
- [after](input._internal_.HTMLBRElement.md#after)
- [animate](input._internal_.HTMLBRElement.md#animate)
- [append](input._internal_.HTMLBRElement.md#append)
- [appendChild](input._internal_.HTMLBRElement.md#appendchild)
- [attachInternals](input._internal_.HTMLBRElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLBRElement.md#attachshadow)
- [before](input._internal_.HTMLBRElement.md#before)
- [blur](input._internal_.HTMLBRElement.md#blur)
- [click](input._internal_.HTMLBRElement.md#click)
- [cloneNode](input._internal_.HTMLBRElement.md#clonenode)
- [closest](input._internal_.HTMLBRElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLBRElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLBRElement.md#contains)
- [dispatchEvent](input._internal_.HTMLBRElement.md#dispatchevent)
- [focus](input._internal_.HTMLBRElement.md#focus)
- [getAnimations](input._internal_.HTMLBRElement.md#getanimations)
- [getAttribute](input._internal_.HTMLBRElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLBRElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLBRElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLBRElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLBRElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLBRElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLBRElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLBRElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLBRElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLBRElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLBRElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLBRElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLBRElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLBRElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLBRElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLBRElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLBRElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLBRElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLBRElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLBRElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLBRElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLBRElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLBRElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLBRElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLBRElement.md#lookupprefix)
- [matches](input._internal_.HTMLBRElement.md#matches)
- [normalize](input._internal_.HTMLBRElement.md#normalize)
- [prepend](input._internal_.HTMLBRElement.md#prepend)
- [querySelector](input._internal_.HTMLBRElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLBRElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLBRElement.md#releasepointercapture)
- [remove](input._internal_.HTMLBRElement.md#remove)
- [removeAttribute](input._internal_.HTMLBRElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLBRElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLBRElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLBRElement.md#removechild)
- [removeEventListener](input._internal_.HTMLBRElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLBRElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLBRElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLBRElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLBRElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLBRElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLBRElement.md#scroll)
- [scrollBy](input._internal_.HTMLBRElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLBRElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLBRElement.md#scrollto)
- [setAttribute](input._internal_.HTMLBRElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLBRElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLBRElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLBRElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLBRElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLBRElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLBRElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLBRElement`](../modules/input._internal_.md#htmlbrelement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
