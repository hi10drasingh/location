[Droom Google Location Plugin - v1.0.10](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGGradientElement

# Interface: SVGGradientElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGGradientElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGGradientElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGGradientElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGGradientElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGGradientElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGGradientElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGGradientElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGGradientElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGGradientElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGGradientElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGGradientElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGGradientElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGGradientElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGGradientElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGGradientElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGGradientElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGGradientElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGGradientElement.md#processing_instruction_node)
- [SVG\_SPREADMETHOD\_PAD](input._internal_.SVGGradientElement.md#svg_spreadmethod_pad)
- [SVG\_SPREADMETHOD\_REFLECT](input._internal_.SVGGradientElement.md#svg_spreadmethod_reflect)
- [SVG\_SPREADMETHOD\_REPEAT](input._internal_.SVGGradientElement.md#svg_spreadmethod_repeat)
- [SVG\_SPREADMETHOD\_UNKNOWN](input._internal_.SVGGradientElement.md#svg_spreadmethod_unknown)
- [TEXT\_NODE](input._internal_.SVGGradientElement.md#text_node)
- [ariaAtomic](input._internal_.SVGGradientElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGGradientElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGGradientElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGGradientElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGGradientElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGGradientElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGGradientElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGGradientElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGGradientElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGGradientElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGGradientElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGGradientElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGGradientElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGGradientElement.md#arialabel)
- [ariaLevel](input._internal_.SVGGradientElement.md#arialevel)
- [ariaLive](input._internal_.SVGGradientElement.md#arialive)
- [ariaModal](input._internal_.SVGGradientElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGGradientElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGGradientElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGGradientElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGGradientElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGGradientElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGGradientElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGGradientElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGGradientElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGGradientElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGGradientElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGGradientElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGGradientElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGGradientElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGGradientElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGGradientElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGGradientElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGGradientElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGGradientElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGGradientElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGGradientElement.md#assignedslot)
- [attributes](input._internal_.SVGGradientElement.md#attributes)
- [autofocus](input._internal_.SVGGradientElement.md#autofocus)
- [baseURI](input._internal_.SVGGradientElement.md#baseuri)
- [childElementCount](input._internal_.SVGGradientElement.md#childelementcount)
- [childNodes](input._internal_.SVGGradientElement.md#childnodes)
- [children](input._internal_.SVGGradientElement.md#children)
- [classList](input._internal_.SVGGradientElement.md#classlist)
- [className](input._internal_.SVGGradientElement.md#classname)
- [clientHeight](input._internal_.SVGGradientElement.md#clientheight)
- [clientLeft](input._internal_.SVGGradientElement.md#clientleft)
- [clientTop](input._internal_.SVGGradientElement.md#clienttop)
- [clientWidth](input._internal_.SVGGradientElement.md#clientwidth)
- [dataset](input._internal_.SVGGradientElement.md#dataset)
- [firstChild](input._internal_.SVGGradientElement.md#firstchild)
- [firstElementChild](input._internal_.SVGGradientElement.md#firstelementchild)
- [gradientTransform](input._internal_.SVGGradientElement.md#gradienttransform)
- [gradientUnits](input._internal_.SVGGradientElement.md#gradientunits)
- [href](input._internal_.SVGGradientElement.md#href)
- [id](input._internal_.SVGGradientElement.md#id)
- [innerHTML](input._internal_.SVGGradientElement.md#innerhtml)
- [isConnected](input._internal_.SVGGradientElement.md#isconnected)
- [lastChild](input._internal_.SVGGradientElement.md#lastchild)
- [lastElementChild](input._internal_.SVGGradientElement.md#lastelementchild)
- [localName](input._internal_.SVGGradientElement.md#localname)
- [namespaceURI](input._internal_.SVGGradientElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGGradientElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGGradientElement.md#nextsibling)
- [nodeName](input._internal_.SVGGradientElement.md#nodename)
- [nodeType](input._internal_.SVGGradientElement.md#nodetype)
- [nodeValue](input._internal_.SVGGradientElement.md#nodevalue)
- [nonce](input._internal_.SVGGradientElement.md#nonce)
- [onabort](input._internal_.SVGGradientElement.md#onabort)
- [onanimationcancel](input._internal_.SVGGradientElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGGradientElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGGradientElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGGradientElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGGradientElement.md#onauxclick)
- [onblur](input._internal_.SVGGradientElement.md#onblur)
- [oncanplay](input._internal_.SVGGradientElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGGradientElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGGradientElement.md#onchange)
- [onclick](input._internal_.SVGGradientElement.md#onclick)
- [onclose](input._internal_.SVGGradientElement.md#onclose)
- [oncontextmenu](input._internal_.SVGGradientElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGGradientElement.md#oncopy)
- [oncuechange](input._internal_.SVGGradientElement.md#oncuechange)
- [oncut](input._internal_.SVGGradientElement.md#oncut)
- [ondblclick](input._internal_.SVGGradientElement.md#ondblclick)
- [ondrag](input._internal_.SVGGradientElement.md#ondrag)
- [ondragend](input._internal_.SVGGradientElement.md#ondragend)
- [ondragenter](input._internal_.SVGGradientElement.md#ondragenter)
- [ondragleave](input._internal_.SVGGradientElement.md#ondragleave)
- [ondragover](input._internal_.SVGGradientElement.md#ondragover)
- [ondragstart](input._internal_.SVGGradientElement.md#ondragstart)
- [ondrop](input._internal_.SVGGradientElement.md#ondrop)
- [ondurationchange](input._internal_.SVGGradientElement.md#ondurationchange)
- [onemptied](input._internal_.SVGGradientElement.md#onemptied)
- [onended](input._internal_.SVGGradientElement.md#onended)
- [onerror](input._internal_.SVGGradientElement.md#onerror)
- [onfocus](input._internal_.SVGGradientElement.md#onfocus)
- [onformdata](input._internal_.SVGGradientElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGGradientElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGGradientElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGGradientElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGGradientElement.md#oninput)
- [oninvalid](input._internal_.SVGGradientElement.md#oninvalid)
- [onkeydown](input._internal_.SVGGradientElement.md#onkeydown)
- [onkeypress](input._internal_.SVGGradientElement.md#onkeypress)
- [onkeyup](input._internal_.SVGGradientElement.md#onkeyup)
- [onload](input._internal_.SVGGradientElement.md#onload)
- [onloadeddata](input._internal_.SVGGradientElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGGradientElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGGradientElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGGradientElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGGradientElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGGradientElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGGradientElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGGradientElement.md#onmousemove)
- [onmouseout](input._internal_.SVGGradientElement.md#onmouseout)
- [onmouseover](input._internal_.SVGGradientElement.md#onmouseover)
- [onmouseup](input._internal_.SVGGradientElement.md#onmouseup)
- [onpaste](input._internal_.SVGGradientElement.md#onpaste)
- [onpause](input._internal_.SVGGradientElement.md#onpause)
- [onplay](input._internal_.SVGGradientElement.md#onplay)
- [onplaying](input._internal_.SVGGradientElement.md#onplaying)
- [onpointercancel](input._internal_.SVGGradientElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGGradientElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGGradientElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGGradientElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGGradientElement.md#onpointermove)
- [onpointerout](input._internal_.SVGGradientElement.md#onpointerout)
- [onpointerover](input._internal_.SVGGradientElement.md#onpointerover)
- [onpointerup](input._internal_.SVGGradientElement.md#onpointerup)
- [onprogress](input._internal_.SVGGradientElement.md#onprogress)
- [onratechange](input._internal_.SVGGradientElement.md#onratechange)
- [onreset](input._internal_.SVGGradientElement.md#onreset)
- [onresize](input._internal_.SVGGradientElement.md#onresize)
- [onscroll](input._internal_.SVGGradientElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGGradientElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGGradientElement.md#onseeked)
- [onseeking](input._internal_.SVGGradientElement.md#onseeking)
- [onselect](input._internal_.SVGGradientElement.md#onselect)
- [onselectionchange](input._internal_.SVGGradientElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGGradientElement.md#onselectstart)
- [onslotchange](input._internal_.SVGGradientElement.md#onslotchange)
- [onstalled](input._internal_.SVGGradientElement.md#onstalled)
- [onsubmit](input._internal_.SVGGradientElement.md#onsubmit)
- [onsuspend](input._internal_.SVGGradientElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGGradientElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGGradientElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGGradientElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGGradientElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGGradientElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGGradientElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGGradientElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGGradientElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGGradientElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGGradientElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGGradientElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGGradientElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGGradientElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGGradientElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGGradientElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGGradientElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGGradientElement.md#onwheel)
- [outerHTML](input._internal_.SVGGradientElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGGradientElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGGradientElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGGradientElement.md#parentelement)
- [parentNode](input._internal_.SVGGradientElement.md#parentnode)
- [part](input._internal_.SVGGradientElement.md#part)
- [prefix](input._internal_.SVGGradientElement.md#prefix)
- [previousElementSibling](input._internal_.SVGGradientElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGGradientElement.md#previoussibling)
- [scrollHeight](input._internal_.SVGGradientElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGGradientElement.md#scrollleft)
- [scrollTop](input._internal_.SVGGradientElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGGradientElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGGradientElement.md#shadowroot)
- [slot](input._internal_.SVGGradientElement.md#slot)
- [spreadMethod](input._internal_.SVGGradientElement.md#spreadmethod)
- [style](input._internal_.SVGGradientElement.md#style)
- [tabIndex](input._internal_.SVGGradientElement.md#tabindex)
- [tagName](input._internal_.SVGGradientElement.md#tagname)
- [textContent](input._internal_.SVGGradientElement.md#textcontent)
- [viewportElement](input._internal_.SVGGradientElement.md#viewportelement)

### Methods

- [addEventListener](input._internal_.SVGGradientElement.md#addeventlistener)
- [after](input._internal_.SVGGradientElement.md#after)
- [animate](input._internal_.SVGGradientElement.md#animate)
- [append](input._internal_.SVGGradientElement.md#append)
- [appendChild](input._internal_.SVGGradientElement.md#appendchild)
- [attachShadow](input._internal_.SVGGradientElement.md#attachshadow)
- [before](input._internal_.SVGGradientElement.md#before)
- [blur](input._internal_.SVGGradientElement.md#blur)
- [cloneNode](input._internal_.SVGGradientElement.md#clonenode)
- [closest](input._internal_.SVGGradientElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGGradientElement.md#comparedocumentposition)
- [contains](input._internal_.SVGGradientElement.md#contains)
- [dispatchEvent](input._internal_.SVGGradientElement.md#dispatchevent)
- [focus](input._internal_.SVGGradientElement.md#focus)
- [getAnimations](input._internal_.SVGGradientElement.md#getanimations)
- [getAttribute](input._internal_.SVGGradientElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGGradientElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGGradientElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGGradientElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGGradientElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.SVGGradientElement.md#getboundingclientrect)
- [getClientRects](input._internal_.SVGGradientElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGGradientElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGGradientElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGGradientElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.SVGGradientElement.md#getrootnode)
- [hasAttribute](input._internal_.SVGGradientElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGGradientElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGGradientElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGGradientElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGGradientElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGGradientElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGGradientElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGGradientElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGGradientElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGGradientElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGGradientElement.md#isequalnode)
- [isSameNode](input._internal_.SVGGradientElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGGradientElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGGradientElement.md#lookupprefix)
- [matches](input._internal_.SVGGradientElement.md#matches)
- [normalize](input._internal_.SVGGradientElement.md#normalize)
- [prepend](input._internal_.SVGGradientElement.md#prepend)
- [querySelector](input._internal_.SVGGradientElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGGradientElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGGradientElement.md#releasepointercapture)
- [remove](input._internal_.SVGGradientElement.md#remove)
- [removeAttribute](input._internal_.SVGGradientElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGGradientElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGGradientElement.md#removeattributenode)
- [removeChild](input._internal_.SVGGradientElement.md#removechild)
- [removeEventListener](input._internal_.SVGGradientElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGGradientElement.md#replacechild)
- [replaceChildren](input._internal_.SVGGradientElement.md#replacechildren)
- [replaceWith](input._internal_.SVGGradientElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGGradientElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGGradientElement.md#requestpointerlock)
- [scroll](input._internal_.SVGGradientElement.md#scroll)
- [scrollBy](input._internal_.SVGGradientElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGGradientElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGGradientElement.md#scrollto)
- [setAttribute](input._internal_.SVGGradientElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGGradientElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGGradientElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGGradientElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGGradientElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGGradientElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGGradientElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGGradientElement`](../modules/input._internal_.md#svggradientelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
