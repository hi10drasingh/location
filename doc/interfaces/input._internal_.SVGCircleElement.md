[Droom Google Location Plugin - v1.0.15](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / SVGCircleElement

# Interface: SVGCircleElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).SVGCircleElement
...
- [ATTRIBUTE\_NODE](input._internal_.SVGCircleElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.SVGCircleElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.SVGCircleElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.SVGCircleElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.SVGCircleElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.SVGCircleElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.SVGCircleElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.SVGCircleElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.SVGCircleElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.SVGCircleElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.SVGCircleElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.SVGCircleElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.SVGCircleElement.md#element_node)
- [ENTITY\_NODE](input._internal_.SVGCircleElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.SVGCircleElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.SVGCircleElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.SVGCircleElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.SVGCircleElement.md#text_node)
- [ariaAtomic](input._internal_.SVGCircleElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.SVGCircleElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.SVGCircleElement.md#ariabusy)
- [ariaChecked](input._internal_.SVGCircleElement.md#ariachecked)
- [ariaColCount](input._internal_.SVGCircleElement.md#ariacolcount)
- [ariaColIndex](input._internal_.SVGCircleElement.md#ariacolindex)
- [ariaColSpan](input._internal_.SVGCircleElement.md#ariacolspan)
- [ariaCurrent](input._internal_.SVGCircleElement.md#ariacurrent)
- [ariaDisabled](input._internal_.SVGCircleElement.md#ariadisabled)
- [ariaExpanded](input._internal_.SVGCircleElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.SVGCircleElement.md#ariahaspopup)
- [ariaHidden](input._internal_.SVGCircleElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.SVGCircleElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.SVGCircleElement.md#arialabel)
- [ariaLevel](input._internal_.SVGCircleElement.md#arialevel)
- [ariaLive](input._internal_.SVGCircleElement.md#arialive)
- [ariaModal](input._internal_.SVGCircleElement.md#ariamodal)
- [ariaMultiLine](input._internal_.SVGCircleElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.SVGCircleElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.SVGCircleElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.SVGCircleElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.SVGCircleElement.md#ariaposinset)
- [ariaPressed](input._internal_.SVGCircleElement.md#ariapressed)
- [ariaReadOnly](input._internal_.SVGCircleElement.md#ariareadonly)
- [ariaRequired](input._internal_.SVGCircleElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.SVGCircleElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.SVGCircleElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.SVGCircleElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.SVGCircleElement.md#ariarowspan)
- [ariaSelected](input._internal_.SVGCircleElement.md#ariaselected)
- [ariaSetSize](input._internal_.SVGCircleElement.md#ariasetsize)
- [ariaSort](input._internal_.SVGCircleElement.md#ariasort)
- [ariaValueMax](input._internal_.SVGCircleElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.SVGCircleElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.SVGCircleElement.md#ariavaluenow)
- [ariaValueText](input._internal_.SVGCircleElement.md#ariavaluetext)
- [assignedSlot](input._internal_.SVGCircleElement.md#assignedslot)
- [attributes](input._internal_.SVGCircleElement.md#attributes)
- [autofocus](input._internal_.SVGCircleElement.md#autofocus)
- [baseURI](input._internal_.SVGCircleElement.md#baseuri)
- [childElementCount](input._internal_.SVGCircleElement.md#childelementcount)
- [childNodes](input._internal_.SVGCircleElement.md#childnodes)
- [children](input._internal_.SVGCircleElement.md#children)
- [classList](input._internal_.SVGCircleElement.md#classlist)
- [className](input._internal_.SVGCircleElement.md#classname)
- [clientHeight](input._internal_.SVGCircleElement.md#clientheight)
- [clientLeft](input._internal_.SVGCircleElement.md#clientleft)
- [clientTop](input._internal_.SVGCircleElement.md#clienttop)
- [clientWidth](input._internal_.SVGCircleElement.md#clientwidth)
- [cx](input._internal_.SVGCircleElement.md#cx)
- [cy](input._internal_.SVGCircleElement.md#cy)
- [dataset](input._internal_.SVGCircleElement.md#dataset)
- [firstChild](input._internal_.SVGCircleElement.md#firstchild)
- [firstElementChild](input._internal_.SVGCircleElement.md#firstelementchild)
- [id](input._internal_.SVGCircleElement.md#id)
- [innerHTML](input._internal_.SVGCircleElement.md#innerhtml)
- [isConnected](input._internal_.SVGCircleElement.md#isconnected)
- [lastChild](input._internal_.SVGCircleElement.md#lastchild)
- [lastElementChild](input._internal_.SVGCircleElement.md#lastelementchild)
- [localName](input._internal_.SVGCircleElement.md#localname)
- [namespaceURI](input._internal_.SVGCircleElement.md#namespaceuri)
- [nextElementSibling](input._internal_.SVGCircleElement.md#nextelementsibling)
- [nextSibling](input._internal_.SVGCircleElement.md#nextsibling)
- [nodeName](input._internal_.SVGCircleElement.md#nodename)
- [nodeType](input._internal_.SVGCircleElement.md#nodetype)
- [nodeValue](input._internal_.SVGCircleElement.md#nodevalue)
- [nonce](input._internal_.SVGCircleElement.md#nonce)
- [onabort](input._internal_.SVGCircleElement.md#onabort)
- [onanimationcancel](input._internal_.SVGCircleElement.md#onanimationcancel)
- [onanimationend](input._internal_.SVGCircleElement.md#onanimationend)
- [onanimationiteration](input._internal_.SVGCircleElement.md#onanimationiteration)
- [onanimationstart](input._internal_.SVGCircleElement.md#onanimationstart)
- [onauxclick](input._internal_.SVGCircleElement.md#onauxclick)
- [onblur](input._internal_.SVGCircleElement.md#onblur)
- [oncanplay](input._internal_.SVGCircleElement.md#oncanplay)
- [oncanplaythrough](input._internal_.SVGCircleElement.md#oncanplaythrough)
- [onchange](input._internal_.SVGCircleElement.md#onchange)
- [onclick](input._internal_.SVGCircleElement.md#onclick)
- [onclose](input._internal_.SVGCircleElement.md#onclose)
- [oncontextmenu](input._internal_.SVGCircleElement.md#oncontextmenu)
- [oncopy](input._internal_.SVGCircleElement.md#oncopy)
- [oncuechange](input._internal_.SVGCircleElement.md#oncuechange)
- [oncut](input._internal_.SVGCircleElement.md#oncut)
- [ondblclick](input._internal_.SVGCircleElement.md#ondblclick)
- [ondrag](input._internal_.SVGCircleElement.md#ondrag)
- [ondragend](input._internal_.SVGCircleElement.md#ondragend)
- [ondragenter](input._internal_.SVGCircleElement.md#ondragenter)
- [ondragleave](input._internal_.SVGCircleElement.md#ondragleave)
- [ondragover](input._internal_.SVGCircleElement.md#ondragover)
- [ondragstart](input._internal_.SVGCircleElement.md#ondragstart)
- [ondrop](input._internal_.SVGCircleElement.md#ondrop)
- [ondurationchange](input._internal_.SVGCircleElement.md#ondurationchange)
- [onemptied](input._internal_.SVGCircleElement.md#onemptied)
- [onended](input._internal_.SVGCircleElement.md#onended)
- [onerror](input._internal_.SVGCircleElement.md#onerror)
- [onfocus](input._internal_.SVGCircleElement.md#onfocus)
- [onformdata](input._internal_.SVGCircleElement.md#onformdata)
- [onfullscreenchange](input._internal_.SVGCircleElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.SVGCircleElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.SVGCircleElement.md#ongotpointercapture)
- [oninput](input._internal_.SVGCircleElement.md#oninput)
- [oninvalid](input._internal_.SVGCircleElement.md#oninvalid)
- [onkeydown](input._internal_.SVGCircleElement.md#onkeydown)
- [onkeypress](input._internal_.SVGCircleElement.md#onkeypress)
- [onkeyup](input._internal_.SVGCircleElement.md#onkeyup)
- [onload](input._internal_.SVGCircleElement.md#onload)
- [onloadeddata](input._internal_.SVGCircleElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.SVGCircleElement.md#onloadedmetadata)
- [onloadstart](input._internal_.SVGCircleElement.md#onloadstart)
- [onlostpointercapture](input._internal_.SVGCircleElement.md#onlostpointercapture)
- [onmousedown](input._internal_.SVGCircleElement.md#onmousedown)
- [onmouseenter](input._internal_.SVGCircleElement.md#onmouseenter)
- [onmouseleave](input._internal_.SVGCircleElement.md#onmouseleave)
- [onmousemove](input._internal_.SVGCircleElement.md#onmousemove)
- [onmouseout](input._internal_.SVGCircleElement.md#onmouseout)
- [onmouseover](input._internal_.SVGCircleElement.md#onmouseover)
- [onmouseup](input._internal_.SVGCircleElement.md#onmouseup)
- [onpaste](input._internal_.SVGCircleElement.md#onpaste)
- [onpause](input._internal_.SVGCircleElement.md#onpause)
- [onplay](input._internal_.SVGCircleElement.md#onplay)
- [onplaying](input._internal_.SVGCircleElement.md#onplaying)
- [onpointercancel](input._internal_.SVGCircleElement.md#onpointercancel)
- [onpointerdown](input._internal_.SVGCircleElement.md#onpointerdown)
- [onpointerenter](input._internal_.SVGCircleElement.md#onpointerenter)
- [onpointerleave](input._internal_.SVGCircleElement.md#onpointerleave)
- [onpointermove](input._internal_.SVGCircleElement.md#onpointermove)
- [onpointerout](input._internal_.SVGCircleElement.md#onpointerout)
- [onpointerover](input._internal_.SVGCircleElement.md#onpointerover)
- [onpointerup](input._internal_.SVGCircleElement.md#onpointerup)
- [onprogress](input._internal_.SVGCircleElement.md#onprogress)
- [onratechange](input._internal_.SVGCircleElement.md#onratechange)
- [onreset](input._internal_.SVGCircleElement.md#onreset)
- [onresize](input._internal_.SVGCircleElement.md#onresize)
- [onscroll](input._internal_.SVGCircleElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.SVGCircleElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.SVGCircleElement.md#onseeked)
- [onseeking](input._internal_.SVGCircleElement.md#onseeking)
- [onselect](input._internal_.SVGCircleElement.md#onselect)
- [onselectionchange](input._internal_.SVGCircleElement.md#onselectionchange)
- [onselectstart](input._internal_.SVGCircleElement.md#onselectstart)
- [onslotchange](input._internal_.SVGCircleElement.md#onslotchange)
- [onstalled](input._internal_.SVGCircleElement.md#onstalled)
- [onsubmit](input._internal_.SVGCircleElement.md#onsubmit)
- [onsuspend](input._internal_.SVGCircleElement.md#onsuspend)
- [ontimeupdate](input._internal_.SVGCircleElement.md#ontimeupdate)
- [ontoggle](input._internal_.SVGCircleElement.md#ontoggle)
- [ontouchcancel](input._internal_.SVGCircleElement.md#ontouchcancel)
- [ontouchend](input._internal_.SVGCircleElement.md#ontouchend)
- [ontouchmove](input._internal_.SVGCircleElement.md#ontouchmove)
- [ontouchstart](input._internal_.SVGCircleElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.SVGCircleElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.SVGCircleElement.md#ontransitionend)
- [ontransitionrun](input._internal_.SVGCircleElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.SVGCircleElement.md#ontransitionstart)
- [onvolumechange](input._internal_.SVGCircleElement.md#onvolumechange)
- [onwaiting](input._internal_.SVGCircleElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.SVGCircleElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.SVGCircleElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.SVGCircleElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.SVGCircleElement.md#onwebkittransitionend)
- [onwheel](input._internal_.SVGCircleElement.md#onwheel)
- [outerHTML](input._internal_.SVGCircleElement.md#outerhtml)
- [ownerDocument](input._internal_.SVGCircleElement.md#ownerdocument)
- [ownerSVGElement](input._internal_.SVGCircleElement.md#ownersvgelement)
- [parentElement](input._internal_.SVGCircleElement.md#parentelement)
- [parentNode](input._internal_.SVGCircleElement.md#parentnode)
- [part](input._internal_.SVGCircleElement.md#part)
- [pathLength](input._internal_.SVGCircleElement.md#pathlength)
- [prefix](input._internal_.SVGCircleElement.md#prefix)
- [previousElementSibling](input._internal_.SVGCircleElement.md#previouselementsibling)
- [previousSibling](input._internal_.SVGCircleElement.md#previoussibling)
- [r](input._internal_.SVGCircleElement.md#r)
- [requiredExtensions](input._internal_.SVGCircleElement.md#requiredextensions)
- [scrollHeight](input._internal_.SVGCircleElement.md#scrollheight)
- [scrollLeft](input._internal_.SVGCircleElement.md#scrollleft)
- [scrollTop](input._internal_.SVGCircleElement.md#scrolltop)
- [scrollWidth](input._internal_.SVGCircleElement.md#scrollwidth)
- [shadowRoot](input._internal_.SVGCircleElement.md#shadowroot)
- [slot](input._internal_.SVGCircleElement.md#slot)
- [style](input._internal_.SVGCircleElement.md#style)
- [systemLanguage](input._internal_.SVGCircleElement.md#systemlanguage)
- [tabIndex](input._internal_.SVGCircleElement.md#tabindex)
- [tagName](input._internal_.SVGCircleElement.md#tagname)
- [textContent](input._internal_.SVGCircleElement.md#textcontent)
- [transform](input._internal_.SVGCircleElement.md#transform)
- [viewportElement](input._internal_.SVGCircleElement.md#viewportelement)

### Methods

- [addEventListener](input._internal_.SVGCircleElement.md#addeventlistener)
- [after](input._internal_.SVGCircleElement.md#after)
- [animate](input._internal_.SVGCircleElement.md#animate)
- [append](input._internal_.SVGCircleElement.md#append)
- [appendChild](input._internal_.SVGCircleElement.md#appendchild)
- [attachShadow](input._internal_.SVGCircleElement.md#attachshadow)
- [before](input._internal_.SVGCircleElement.md#before)
- [blur](input._internal_.SVGCircleElement.md#blur)
- [cloneNode](input._internal_.SVGCircleElement.md#clonenode)
- [closest](input._internal_.SVGCircleElement.md#closest)
- [compareDocumentPosition](input._internal_.SVGCircleElement.md#comparedocumentposition)
- [contains](input._internal_.SVGCircleElement.md#contains)
- [dispatchEvent](input._internal_.SVGCircleElement.md#dispatchevent)
- [focus](input._internal_.SVGCircleElement.md#focus)
- [getAnimations](input._internal_.SVGCircleElement.md#getanimations)
- [getAttribute](input._internal_.SVGCircleElement.md#getattribute)
- [getAttributeNS](input._internal_.SVGCircleElement.md#getattributens)
- [getAttributeNames](input._internal_.SVGCircleElement.md#getattributenames)
- [getAttributeNode](input._internal_.SVGCircleElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.SVGCircleElement.md#getattributenodens)
- [getBBox](input._internal_.SVGCircleElement.md#getbbox)
- [getBoundingClientRect](input._internal_.SVGCircleElement.md#getboundingclientrect)
- [getCTM](input._internal_.SVGCircleElement.md#getctm)
- [getClientRects](input._internal_.SVGCircleElement.md#getclientrects)
- [getElementsByClassName](input._internal_.SVGCircleElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.SVGCircleElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.SVGCircleElement.md#getelementsbytagnamens)
- [getPointAtLength](input._internal_.SVGCircleElement.md#getpointatlength)
- [getRootNode](input._internal_.SVGCircleElement.md#getrootnode)
- [getScreenCTM](input._internal_.SVGCircleElement.md#getscreenctm)
- [getTotalLength](input._internal_.SVGCircleElement.md#gettotallength)
- [hasAttribute](input._internal_.SVGCircleElement.md#hasattribute)
- [hasAttributeNS](input._internal_.SVGCircleElement.md#hasattributens)
- [hasAttributes](input._internal_.SVGCircleElement.md#hasattributes)
- [hasChildNodes](input._internal_.SVGCircleElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.SVGCircleElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.SVGCircleElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.SVGCircleElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.SVGCircleElement.md#insertadjacenttext)
- [insertBefore](input._internal_.SVGCircleElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.SVGCircleElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.SVGCircleElement.md#isequalnode)
- [isPointInFill](input._internal_.SVGCircleElement.md#ispointinfill)
- [isPointInStroke](input._internal_.SVGCircleElement.md#ispointinstroke)
- [isSameNode](input._internal_.SVGCircleElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.SVGCircleElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.SVGCircleElement.md#lookupprefix)
- [matches](input._internal_.SVGCircleElement.md#matches)
- [normalize](input._internal_.SVGCircleElement.md#normalize)
- [prepend](input._internal_.SVGCircleElement.md#prepend)
- [querySelector](input._internal_.SVGCircleElement.md#queryselector)
- [querySelectorAll](input._internal_.SVGCircleElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.SVGCircleElement.md#releasepointercapture)
- [remove](input._internal_.SVGCircleElement.md#remove)
- [removeAttribute](input._internal_.SVGCircleElement.md#removeattribute)
- [removeAttributeNS](input._internal_.SVGCircleElement.md#removeattributens)
- [removeAttributeNode](input._internal_.SVGCircleElement.md#removeattributenode)
- [removeChild](input._internal_.SVGCircleElement.md#removechild)
- [removeEventListener](input._internal_.SVGCircleElement.md#removeeventlistener)
- [replaceChild](input._internal_.SVGCircleElement.md#replacechild)
- [replaceChildren](input._internal_.SVGCircleElement.md#replacechildren)
- [replaceWith](input._internal_.SVGCircleElement.md#replacewith)
- [requestFullscreen](input._internal_.SVGCircleElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.SVGCircleElement.md#requestpointerlock)
- [scroll](input._internal_.SVGCircleElement.md#scroll)
- [scrollBy](input._internal_.SVGCircleElement.md#scrollby)
- [scrollIntoView](input._internal_.SVGCircleElement.md#scrollintoview)
- [scrollTo](input._internal_.SVGCircleElement.md#scrollto)
- [setAttribute](input._internal_.SVGCircleElement.md#setattribute)
- [setAttributeNS](input._internal_.SVGCircleElement.md#setattributens)
- [setAttributeNode](input._internal_.SVGCircleElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.SVGCircleElement.md#setattributenodens)
- [setPointerCapture](input._internal_.SVGCircleElement.md#setpointercapture)
- [toggleAttribute](input._internal_.SVGCircleElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.SVGCircleElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`SVGCircleElement`](../modules/input._internal_.md#svgcircleelement), `ev`: [`SVGElementEventMap`](input._internal_.SVGElementEventMap.md)[`K`]) => `any` |
