[Droom Google Location Plugin - v1.0.16](../README.md) / [Exports](../modules.md) / [input](../modules/input.md) / [<internal\>](../modules/input._internal_.md) / HTMLLIElement

# Interface: HTMLLIElement

[input](../modules/input.md).[<internal>](../modules/input._internal_.md).HTMLLIElement
...
- [ATTRIBUTE\_NODE](input._internal_.HTMLLIElement.md#attribute_node)
- [CDATA\_SECTION\_NODE](input._internal_.HTMLLIElement.md#cdata_section_node)
- [COMMENT\_NODE](input._internal_.HTMLLIElement.md#comment_node)
- [DOCUMENT\_FRAGMENT\_NODE](input._internal_.HTMLLIElement.md#document_fragment_node)
- [DOCUMENT\_NODE](input._internal_.HTMLLIElement.md#document_node)
- [DOCUMENT\_POSITION\_CONTAINED\_BY](input._internal_.HTMLLIElement.md#document_position_contained_by)
- [DOCUMENT\_POSITION\_CONTAINS](input._internal_.HTMLLIElement.md#document_position_contains)
- [DOCUMENT\_POSITION\_DISCONNECTED](input._internal_.HTMLLIElement.md#document_position_disconnected)
- [DOCUMENT\_POSITION\_FOLLOWING](input._internal_.HTMLLIElement.md#document_position_following)
- [DOCUMENT\_POSITION\_IMPLEMENTATION\_SPECIFIC](input._internal_.HTMLLIElement.md#document_position_implementation_specific)
- [DOCUMENT\_POSITION\_PRECEDING](input._internal_.HTMLLIElement.md#document_position_preceding)
- [DOCUMENT\_TYPE\_NODE](input._internal_.HTMLLIElement.md#document_type_node)
- [ELEMENT\_NODE](input._internal_.HTMLLIElement.md#element_node)
- [ENTITY\_NODE](input._internal_.HTMLLIElement.md#entity_node)
- [ENTITY\_REFERENCE\_NODE](input._internal_.HTMLLIElement.md#entity_reference_node)
- [NOTATION\_NODE](input._internal_.HTMLLIElement.md#notation_node)
- [PROCESSING\_INSTRUCTION\_NODE](input._internal_.HTMLLIElement.md#processing_instruction_node)
- [TEXT\_NODE](input._internal_.HTMLLIElement.md#text_node)
- [accessKey](input._internal_.HTMLLIElement.md#accesskey)
- [accessKeyLabel](input._internal_.HTMLLIElement.md#accesskeylabel)
- [ariaAtomic](input._internal_.HTMLLIElement.md#ariaatomic)
- [ariaAutoComplete](input._internal_.HTMLLIElement.md#ariaautocomplete)
- [ariaBusy](input._internal_.HTMLLIElement.md#ariabusy)
- [ariaChecked](input._internal_.HTMLLIElement.md#ariachecked)
- [ariaColCount](input._internal_.HTMLLIElement.md#ariacolcount)
- [ariaColIndex](input._internal_.HTMLLIElement.md#ariacolindex)
- [ariaColSpan](input._internal_.HTMLLIElement.md#ariacolspan)
- [ariaCurrent](input._internal_.HTMLLIElement.md#ariacurrent)
- [ariaDisabled](input._internal_.HTMLLIElement.md#ariadisabled)
- [ariaExpanded](input._internal_.HTMLLIElement.md#ariaexpanded)
- [ariaHasPopup](input._internal_.HTMLLIElement.md#ariahaspopup)
- [ariaHidden](input._internal_.HTMLLIElement.md#ariahidden)
- [ariaKeyShortcuts](input._internal_.HTMLLIElement.md#ariakeyshortcuts)
- [ariaLabel](input._internal_.HTMLLIElement.md#arialabel)
- [ariaLevel](input._internal_.HTMLLIElement.md#arialevel)
- [ariaLive](input._internal_.HTMLLIElement.md#arialive)
- [ariaModal](input._internal_.HTMLLIElement.md#ariamodal)
- [ariaMultiLine](input._internal_.HTMLLIElement.md#ariamultiline)
- [ariaMultiSelectable](input._internal_.HTMLLIElement.md#ariamultiselectable)
- [ariaOrientation](input._internal_.HTMLLIElement.md#ariaorientation)
- [ariaPlaceholder](input._internal_.HTMLLIElement.md#ariaplaceholder)
- [ariaPosInSet](input._internal_.HTMLLIElement.md#ariaposinset)
- [ariaPressed](input._internal_.HTMLLIElement.md#ariapressed)
- [ariaReadOnly](input._internal_.HTMLLIElement.md#ariareadonly)
- [ariaRequired](input._internal_.HTMLLIElement.md#ariarequired)
- [ariaRoleDescription](input._internal_.HTMLLIElement.md#ariaroledescription)
- [ariaRowCount](input._internal_.HTMLLIElement.md#ariarowcount)
- [ariaRowIndex](input._internal_.HTMLLIElement.md#ariarowindex)
- [ariaRowSpan](input._internal_.HTMLLIElement.md#ariarowspan)
- [ariaSelected](input._internal_.HTMLLIElement.md#ariaselected)
- [ariaSetSize](input._internal_.HTMLLIElement.md#ariasetsize)
- [ariaSort](input._internal_.HTMLLIElement.md#ariasort)
- [ariaValueMax](input._internal_.HTMLLIElement.md#ariavaluemax)
- [ariaValueMin](input._internal_.HTMLLIElement.md#ariavaluemin)
- [ariaValueNow](input._internal_.HTMLLIElement.md#ariavaluenow)
- [ariaValueText](input._internal_.HTMLLIElement.md#ariavaluetext)
- [assignedSlot](input._internal_.HTMLLIElement.md#assignedslot)
- [attributes](input._internal_.HTMLLIElement.md#attributes)
- [autocapitalize](input._internal_.HTMLLIElement.md#autocapitalize)
- [autofocus](input._internal_.HTMLLIElement.md#autofocus)
- [baseURI](input._internal_.HTMLLIElement.md#baseuri)
- [childElementCount](input._internal_.HTMLLIElement.md#childelementcount)
- [childNodes](input._internal_.HTMLLIElement.md#childnodes)
- [children](input._internal_.HTMLLIElement.md#children)
- [classList](input._internal_.HTMLLIElement.md#classlist)
- [className](input._internal_.HTMLLIElement.md#classname)
- [clientHeight](input._internal_.HTMLLIElement.md#clientheight)
- [clientLeft](input._internal_.HTMLLIElement.md#clientleft)
- [clientTop](input._internal_.HTMLLIElement.md#clienttop)
- [clientWidth](input._internal_.HTMLLIElement.md#clientwidth)
- [contentEditable](input._internal_.HTMLLIElement.md#contenteditable)
- [dataset](input._internal_.HTMLLIElement.md#dataset)
- [dir](input._internal_.HTMLLIElement.md#dir)
- [draggable](input._internal_.HTMLLIElement.md#draggable)
- [enterKeyHint](input._internal_.HTMLLIElement.md#enterkeyhint)
- [firstChild](input._internal_.HTMLLIElement.md#firstchild)
- [firstElementChild](input._internal_.HTMLLIElement.md#firstelementchild)
- [hidden](input._internal_.HTMLLIElement.md#hidden)
- [id](input._internal_.HTMLLIElement.md#id)
- [innerHTML](input._internal_.HTMLLIElement.md#innerhtml)
- [innerText](input._internal_.HTMLLIElement.md#innertext)
- [inputMode](input._internal_.HTMLLIElement.md#inputmode)
- [isConnected](input._internal_.HTMLLIElement.md#isconnected)
- [isContentEditable](input._internal_.HTMLLIElement.md#iscontenteditable)
- [lang](input._internal_.HTMLLIElement.md#lang)
- [lastChild](input._internal_.HTMLLIElement.md#lastchild)
- [lastElementChild](input._internal_.HTMLLIElement.md#lastelementchild)
- [localName](input._internal_.HTMLLIElement.md#localname)
- [namespaceURI](input._internal_.HTMLLIElement.md#namespaceuri)
- [nextElementSibling](input._internal_.HTMLLIElement.md#nextelementsibling)
- [nextSibling](input._internal_.HTMLLIElement.md#nextsibling)
- [nodeName](input._internal_.HTMLLIElement.md#nodename)
- [nodeType](input._internal_.HTMLLIElement.md#nodetype)
- [nodeValue](input._internal_.HTMLLIElement.md#nodevalue)
- [nonce](input._internal_.HTMLLIElement.md#nonce)
- [offsetHeight](input._internal_.HTMLLIElement.md#offsetheight)
- [offsetLeft](input._internal_.HTMLLIElement.md#offsetleft)
- [offsetParent](input._internal_.HTMLLIElement.md#offsetparent)
- [offsetTop](input._internal_.HTMLLIElement.md#offsettop)
- [offsetWidth](input._internal_.HTMLLIElement.md#offsetwidth)
- [onabort](input._internal_.HTMLLIElement.md#onabort)
- [onanimationcancel](input._internal_.HTMLLIElement.md#onanimationcancel)
- [onanimationend](input._internal_.HTMLLIElement.md#onanimationend)
- [onanimationiteration](input._internal_.HTMLLIElement.md#onanimationiteration)
- [onanimationstart](input._internal_.HTMLLIElement.md#onanimationstart)
- [onauxclick](input._internal_.HTMLLIElement.md#onauxclick)
- [onblur](input._internal_.HTMLLIElement.md#onblur)
- [oncanplay](input._internal_.HTMLLIElement.md#oncanplay)
- [oncanplaythrough](input._internal_.HTMLLIElement.md#oncanplaythrough)
- [onchange](input._internal_.HTMLLIElement.md#onchange)
- [onclick](input._internal_.HTMLLIElement.md#onclick)
- [onclose](input._internal_.HTMLLIElement.md#onclose)
- [oncontextmenu](input._internal_.HTMLLIElement.md#oncontextmenu)
- [oncopy](input._internal_.HTMLLIElement.md#oncopy)
- [oncuechange](input._internal_.HTMLLIElement.md#oncuechange)
- [oncut](input._internal_.HTMLLIElement.md#oncut)
- [ondblclick](input._internal_.HTMLLIElement.md#ondblclick)
- [ondrag](input._internal_.HTMLLIElement.md#ondrag)
- [ondragend](input._internal_.HTMLLIElement.md#ondragend)
- [ondragenter](input._internal_.HTMLLIElement.md#ondragenter)
- [ondragleave](input._internal_.HTMLLIElement.md#ondragleave)
- [ondragover](input._internal_.HTMLLIElement.md#ondragover)
- [ondragstart](input._internal_.HTMLLIElement.md#ondragstart)
- [ondrop](input._internal_.HTMLLIElement.md#ondrop)
- [ondurationchange](input._internal_.HTMLLIElement.md#ondurationchange)
- [onemptied](input._internal_.HTMLLIElement.md#onemptied)
- [onended](input._internal_.HTMLLIElement.md#onended)
- [onerror](input._internal_.HTMLLIElement.md#onerror)
- [onfocus](input._internal_.HTMLLIElement.md#onfocus)
- [onformdata](input._internal_.HTMLLIElement.md#onformdata)
- [onfullscreenchange](input._internal_.HTMLLIElement.md#onfullscreenchange)
- [onfullscreenerror](input._internal_.HTMLLIElement.md#onfullscreenerror)
- [ongotpointercapture](input._internal_.HTMLLIElement.md#ongotpointercapture)
- [oninput](input._internal_.HTMLLIElement.md#oninput)
- [oninvalid](input._internal_.HTMLLIElement.md#oninvalid)
- [onkeydown](input._internal_.HTMLLIElement.md#onkeydown)
- [onkeypress](input._internal_.HTMLLIElement.md#onkeypress)
- [onkeyup](input._internal_.HTMLLIElement.md#onkeyup)
- [onload](input._internal_.HTMLLIElement.md#onload)
- [onloadeddata](input._internal_.HTMLLIElement.md#onloadeddata)
- [onloadedmetadata](input._internal_.HTMLLIElement.md#onloadedmetadata)
- [onloadstart](input._internal_.HTMLLIElement.md#onloadstart)
- [onlostpointercapture](input._internal_.HTMLLIElement.md#onlostpointercapture)
- [onmousedown](input._internal_.HTMLLIElement.md#onmousedown)
- [onmouseenter](input._internal_.HTMLLIElement.md#onmouseenter)
- [onmouseleave](input._internal_.HTMLLIElement.md#onmouseleave)
- [onmousemove](input._internal_.HTMLLIElement.md#onmousemove)
- [onmouseout](input._internal_.HTMLLIElement.md#onmouseout)
- [onmouseover](input._internal_.HTMLLIElement.md#onmouseover)
- [onmouseup](input._internal_.HTMLLIElement.md#onmouseup)
- [onpaste](input._internal_.HTMLLIElement.md#onpaste)
- [onpause](input._internal_.HTMLLIElement.md#onpause)
- [onplay](input._internal_.HTMLLIElement.md#onplay)
- [onplaying](input._internal_.HTMLLIElement.md#onplaying)
- [onpointercancel](input._internal_.HTMLLIElement.md#onpointercancel)
- [onpointerdown](input._internal_.HTMLLIElement.md#onpointerdown)
- [onpointerenter](input._internal_.HTMLLIElement.md#onpointerenter)
- [onpointerleave](input._internal_.HTMLLIElement.md#onpointerleave)
- [onpointermove](input._internal_.HTMLLIElement.md#onpointermove)
- [onpointerout](input._internal_.HTMLLIElement.md#onpointerout)
- [onpointerover](input._internal_.HTMLLIElement.md#onpointerover)
- [onpointerup](input._internal_.HTMLLIElement.md#onpointerup)
- [onprogress](input._internal_.HTMLLIElement.md#onprogress)
- [onratechange](input._internal_.HTMLLIElement.md#onratechange)
- [onreset](input._internal_.HTMLLIElement.md#onreset)
- [onresize](input._internal_.HTMLLIElement.md#onresize)
- [onscroll](input._internal_.HTMLLIElement.md#onscroll)
- [onsecuritypolicyviolation](input._internal_.HTMLLIElement.md#onsecuritypolicyviolation)
- [onseeked](input._internal_.HTMLLIElement.md#onseeked)
- [onseeking](input._internal_.HTMLLIElement.md#onseeking)
- [onselect](input._internal_.HTMLLIElement.md#onselect)
- [onselectionchange](input._internal_.HTMLLIElement.md#onselectionchange)
- [onselectstart](input._internal_.HTMLLIElement.md#onselectstart)
- [onslotchange](input._internal_.HTMLLIElement.md#onslotchange)
- [onstalled](input._internal_.HTMLLIElement.md#onstalled)
- [onsubmit](input._internal_.HTMLLIElement.md#onsubmit)
- [onsuspend](input._internal_.HTMLLIElement.md#onsuspend)
- [ontimeupdate](input._internal_.HTMLLIElement.md#ontimeupdate)
- [ontoggle](input._internal_.HTMLLIElement.md#ontoggle)
- [ontouchcancel](input._internal_.HTMLLIElement.md#ontouchcancel)
- [ontouchend](input._internal_.HTMLLIElement.md#ontouchend)
- [ontouchmove](input._internal_.HTMLLIElement.md#ontouchmove)
- [ontouchstart](input._internal_.HTMLLIElement.md#ontouchstart)
- [ontransitioncancel](input._internal_.HTMLLIElement.md#ontransitioncancel)
- [ontransitionend](input._internal_.HTMLLIElement.md#ontransitionend)
- [ontransitionrun](input._internal_.HTMLLIElement.md#ontransitionrun)
- [ontransitionstart](input._internal_.HTMLLIElement.md#ontransitionstart)
- [onvolumechange](input._internal_.HTMLLIElement.md#onvolumechange)
- [onwaiting](input._internal_.HTMLLIElement.md#onwaiting)
- [onwebkitanimationend](input._internal_.HTMLLIElement.md#onwebkitanimationend)
- [onwebkitanimationiteration](input._internal_.HTMLLIElement.md#onwebkitanimationiteration)
- [onwebkitanimationstart](input._internal_.HTMLLIElement.md#onwebkitanimationstart)
- [onwebkittransitionend](input._internal_.HTMLLIElement.md#onwebkittransitionend)
- [onwheel](input._internal_.HTMLLIElement.md#onwheel)
- [outerHTML](input._internal_.HTMLLIElement.md#outerhtml)
- [outerText](input._internal_.HTMLLIElement.md#outertext)
- [ownerDocument](input._internal_.HTMLLIElement.md#ownerdocument)
- [parentElement](input._internal_.HTMLLIElement.md#parentelement)
- [parentNode](input._internal_.HTMLLIElement.md#parentnode)
- [part](input._internal_.HTMLLIElement.md#part)
- [prefix](input._internal_.HTMLLIElement.md#prefix)
- [previousElementSibling](input._internal_.HTMLLIElement.md#previouselementsibling)
- [previousSibling](input._internal_.HTMLLIElement.md#previoussibling)
- [scrollHeight](input._internal_.HTMLLIElement.md#scrollheight)
- [scrollLeft](input._internal_.HTMLLIElement.md#scrollleft)
- [scrollTop](input._internal_.HTMLLIElement.md#scrolltop)
- [scrollWidth](input._internal_.HTMLLIElement.md#scrollwidth)
- [shadowRoot](input._internal_.HTMLLIElement.md#shadowroot)
- [slot](input._internal_.HTMLLIElement.md#slot)
- [spellcheck](input._internal_.HTMLLIElement.md#spellcheck)
- [style](input._internal_.HTMLLIElement.md#style)
- [tabIndex](input._internal_.HTMLLIElement.md#tabindex)
- [tagName](input._internal_.HTMLLIElement.md#tagname)
- [textContent](input._internal_.HTMLLIElement.md#textcontent)
- [title](input._internal_.HTMLLIElement.md#title)
- [translate](input._internal_.HTMLLIElement.md#translate)
- [type](input._internal_.HTMLLIElement.md#type)
- [value](input._internal_.HTMLLIElement.md#value)

### Methods

- [addEventListener](input._internal_.HTMLLIElement.md#addeventlistener)
- [after](input._internal_.HTMLLIElement.md#after)
- [animate](input._internal_.HTMLLIElement.md#animate)
- [append](input._internal_.HTMLLIElement.md#append)
- [appendChild](input._internal_.HTMLLIElement.md#appendchild)
- [attachInternals](input._internal_.HTMLLIElement.md#attachinternals)
- [attachShadow](input._internal_.HTMLLIElement.md#attachshadow)
- [before](input._internal_.HTMLLIElement.md#before)
- [blur](input._internal_.HTMLLIElement.md#blur)
- [click](input._internal_.HTMLLIElement.md#click)
- [cloneNode](input._internal_.HTMLLIElement.md#clonenode)
- [closest](input._internal_.HTMLLIElement.md#closest)
- [compareDocumentPosition](input._internal_.HTMLLIElement.md#comparedocumentposition)
- [contains](input._internal_.HTMLLIElement.md#contains)
- [dispatchEvent](input._internal_.HTMLLIElement.md#dispatchevent)
- [focus](input._internal_.HTMLLIElement.md#focus)
- [getAnimations](input._internal_.HTMLLIElement.md#getanimations)
- [getAttribute](input._internal_.HTMLLIElement.md#getattribute)
- [getAttributeNS](input._internal_.HTMLLIElement.md#getattributens)
- [getAttributeNames](input._internal_.HTMLLIElement.md#getattributenames)
- [getAttributeNode](input._internal_.HTMLLIElement.md#getattributenode)
- [getAttributeNodeNS](input._internal_.HTMLLIElement.md#getattributenodens)
- [getBoundingClientRect](input._internal_.HTMLLIElement.md#getboundingclientrect)
- [getClientRects](input._internal_.HTMLLIElement.md#getclientrects)
- [getElementsByClassName](input._internal_.HTMLLIElement.md#getelementsbyclassname)
- [getElementsByTagName](input._internal_.HTMLLIElement.md#getelementsbytagname)
- [getElementsByTagNameNS](input._internal_.HTMLLIElement.md#getelementsbytagnamens)
- [getRootNode](input._internal_.HTMLLIElement.md#getrootnode)
- [hasAttribute](input._internal_.HTMLLIElement.md#hasattribute)
- [hasAttributeNS](input._internal_.HTMLLIElement.md#hasattributens)
- [hasAttributes](input._internal_.HTMLLIElement.md#hasattributes)
- [hasChildNodes](input._internal_.HTMLLIElement.md#haschildnodes)
- [hasPointerCapture](input._internal_.HTMLLIElement.md#haspointercapture)
- [insertAdjacentElement](input._internal_.HTMLLIElement.md#insertadjacentelement)
- [insertAdjacentHTML](input._internal_.HTMLLIElement.md#insertadjacenthtml)
- [insertAdjacentText](input._internal_.HTMLLIElement.md#insertadjacenttext)
- [insertBefore](input._internal_.HTMLLIElement.md#insertbefore)
- [isDefaultNamespace](input._internal_.HTMLLIElement.md#isdefaultnamespace)
- [isEqualNode](input._internal_.HTMLLIElement.md#isequalnode)
- [isSameNode](input._internal_.HTMLLIElement.md#issamenode)
- [lookupNamespaceURI](input._internal_.HTMLLIElement.md#lookupnamespaceuri)
- [lookupPrefix](input._internal_.HTMLLIElement.md#lookupprefix)
- [matches](input._internal_.HTMLLIElement.md#matches)
- [normalize](input._internal_.HTMLLIElement.md#normalize)
- [prepend](input._internal_.HTMLLIElement.md#prepend)
- [querySelector](input._internal_.HTMLLIElement.md#queryselector)
- [querySelectorAll](input._internal_.HTMLLIElement.md#queryselectorall)
- [releasePointerCapture](input._internal_.HTMLLIElement.md#releasepointercapture)
- [remove](input._internal_.HTMLLIElement.md#remove)
- [removeAttribute](input._internal_.HTMLLIElement.md#removeattribute)
- [removeAttributeNS](input._internal_.HTMLLIElement.md#removeattributens)
- [removeAttributeNode](input._internal_.HTMLLIElement.md#removeattributenode)
- [removeChild](input._internal_.HTMLLIElement.md#removechild)
- [removeEventListener](input._internal_.HTMLLIElement.md#removeeventlistener)
- [replaceChild](input._internal_.HTMLLIElement.md#replacechild)
- [replaceChildren](input._internal_.HTMLLIElement.md#replacechildren)
- [replaceWith](input._internal_.HTMLLIElement.md#replacewith)
- [requestFullscreen](input._internal_.HTMLLIElement.md#requestfullscreen)
- [requestPointerLock](input._internal_.HTMLLIElement.md#requestpointerlock)
- [scroll](input._internal_.HTMLLIElement.md#scroll)
- [scrollBy](input._internal_.HTMLLIElement.md#scrollby)
- [scrollIntoView](input._internal_.HTMLLIElement.md#scrollintoview)
- [scrollTo](input._internal_.HTMLLIElement.md#scrollto)
- [setAttribute](input._internal_.HTMLLIElement.md#setattribute)
- [setAttributeNS](input._internal_.HTMLLIElement.md#setattributens)
- [setAttributeNode](input._internal_.HTMLLIElement.md#setattributenode)
- [setAttributeNodeNS](input._internal_.HTMLLIElement.md#setattributenodens)
- [setPointerCapture](input._internal_.HTMLLIElement.md#setpointercapture)
- [toggleAttribute](input._internal_.HTMLLIElement.md#toggleattribute)
- [webkitMatchesSelector](input._internal_.HTMLLIElement.md#webkitmatchesselector)
...
| :------ | :------ |
| `type` | `K` |
| `listener` | (`this`: [`HTMLLIElement`](../modules/input._internal_.md#htmllielement), `ev`: [`HTMLElementEventMap`](input._internal_.HTMLElementEventMap.md)[`K`]) => `any` |
