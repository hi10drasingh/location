[Droom Google Location Plugin - v1.0.8](../README.md) / [Exports](../modules.md) / persist/user
...
[src/persist/user.ts:77](https://github.com/hitendrarao/location/blob/a1211a7/src/persist/user.ts#L77)
...
[src/persist/user.ts:24](https://github.com/hitendrarao/location/blob/a1211a7/src/persist/user.ts#L24)
...
[src/persist/user.ts:41](https://github.com/hitendrarao/location/blob/a1211a7/src/persist/user.ts#L41)
