[Droom Google Location Plugin - v1.0.11](../README.md) / [Exports](../modules.md) / interface/input
...
[src/interface/input.ts:4](https://github.com/hitendrarao/location/blob/4dc7506/src/interface/input.ts#L4)
...
[src/interface/input.ts:9](https://github.com/hitendrarao/location/blob/4dc7506/src/interface/input.ts#L9)
